...
description: "บทความนี้อธิบายถึงวิธีการที่คุณสามารถกำหนด 365 Dynamics Microsoft สำหรับการดำเนินงาน"
author: RobinARH
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
บทความนี้อธิบายถึงวิธีการที่คุณสามารถกำหนด 365 Dynamics Microsoft สำหรับการดำเนินงาน

มีการตั้งค่าส่วนบุคคลใน 365 Dynamics Microsoft สำหรับการดำเนินงานหลายชนิด การทำให้เป็นแบบส่วนบุคคลบางรายการเป็นการเลือกข้อมูลที่คุณเลือกในรายการของตัวเลือกในหน้าการตั้งค่า ตั้งค่าส่วนบุคคลบางอย่างโดยนัย ตัวอย่าง 365 Dynamics สำหรับการดำเนินการเก็บของความกว้างของคอลัมน์ในตารางถ้าคุณปรับปรุงเหล่านั้น และแท็บด่วนรัฐขยาย/ยุบ การทำให้เป็นแบบส่วนบุคคลอื่นๆเป็นการตั้งค่าแบบชัดแจ้ง สำหรับการทำให้เป็นแบบส่วนบุคคลที่ชัดแจ้ง คุณป้อนโหมดการทำให้เป็นแบบส่วนบุคคลที่มีการโต้ตอบ และปรับเปลี่ยนลักษณะที่ปรากฏของหน้าโดยการจัดการวิธีที่องค์ประกอบปรากฏ หรือดำเนินการบนหน้าโดยตรง 

มีทั้งหมดตั้งค่าส่วนบุคคล ทุกชนิด ที่ผู้ใช้ทำให้ใน 365 Dynamics สำหรับการดำเนินงานสำหรับผู้ใช้นั้นเท่านั้น โดยไม่คำนึงถึงบริษัทที่ผู้ใช้โต้ตอบกับ การเปลี่ยนแปลงที่ผู้ใช้ทำในหน้าไม่มีผลต่อผู้ใช้รายอื่นในระบบ

## <a name="systemwide-options-for-the-current-user"></a>ตัวเลือกของ Systemwide สำหรับผู้ใช้ปัจจุบัน
...
-   **การกำหนดลักษณะ:**ที่นี่คุณสามารถเลือกค่าเริ่มต้นสำหรับแต่ละครั้งที่คุณเปิด 365 Dynamics สำหรับการดำเนินงาน รวมทั้งบริษัท เพจเริ่มต้น และโหมดมุมมอง/แก้ไขค่าเริ่มต้น (ซึ่งกำหนดถ้าหน้าถูกล็อคสำหรับการดู หรือเปิดเพื่อแก้ไขแต่ละครั้งที่ คุณเปิดแฟ้ม) ได้ คุณยังจะพบภาษา โซนเวลา และวันที่ เวลา และตัวเลือกรูปแบบตัวเลขอีกด้วย สุดท้าย หน้านี้ประกอบด้วยจำนวนของการกำหนดลักษณะเบ็ดเตล็ดที่จะเปลี่ยนแปลงจากนำออกใช้เพื่อนำออกใช้
...
**คอลัมน์กริด:** คุณสามารถปรับปรุงความกว้างของคอลัมน์ในรายการได้ โดยการเลือกแถบปรับขนาดไปทางซ้ายหรือขวาของส่วนหัวของคอลัมน์ และการเลื่อนไปทางซ้ายหรือขวาไปยังความกว้างที่ต้องการ Dynamics 365 สำหรับการดำเนินงานจะจัดเก็บความกว้างคุณจะชอบ และแสดงคอลัมน์นั้น มีความกว้างนั้นทุกครั้งที่คุณเปิดหน้ากับรายการนั้น 

**FastTabs:** หน้าบางหน้ามีส่วนที่ขยายออกได้ซึ่งเรียกว่า FastTabs Dynamics 365 สำหรับการดำเนินงานจะจัดเก็บแท็บด่วนที่คุณได้ขยาย และแท็บด่วนที่คุณมียุบ แต่ละครั้งที่คุณกลับไปยังหน้า FastTabs เหล่านั้นจะถูกขยายหรือถูกยุบตามที่คุณใช้ครั้งล่าสุด ในบทความนี้ เราจะอธิบายวิธีการเปลี่ยนลำดับของหัวข้อ FastTab ของคุณ ในบางกรณี การยุบแท็บด่วนอาจช่วยปรับปรุงประสิทธิภาพการทำงานเนื่องจาก 365 Dynamics สำหรับการดำเนินงานจะไม่จำเป็นต้องกู้คืนข้อมูลสำหรับแท็บด่วนนั้นจนกว่าจะถูกขยายแท็บด่วน 

**กล่องแสดงข้อมูลย่อ:** หน้าบางหน้ามีส่วนที่เรียกว่า บานหน้าต่างกล่องแสดงข้อมูลย่อ บานหน้าต่างนี้ประกอบด้วยข้อมูลแบบอ่านอย่างเดียวที่เกี่ยวข้องกับชื่อเรื่องปัจจุบันของหน้า แต่ละส่วนในบานหน้าต่างกล่องแสดงข้อมูลย่อถูกเรียกว่ากล่องแสดงข้อมูลย่อ คุณสามารถขยาย หรือยุบเป็นกล่องแสดงข้อมูลย่อ และ 365 Dynamics สำหรับการดำเนินงานจะจัดเก็บการกำหนดลักษณะของคุณ ในบางกรณี การยุบเป็นกล่องแสดงข้อมูลย่ออาจเพิ่มประสิทธิภาพเพราะว่า 365 Dynamics สำหรับการดำเนินงานจะไม่จำเป็นต้องกู้คืนข้อมูลสำหรับกล่องแสดงข้อมูลย่อนั้นจนกว่ากล่องแสดงข้อมูลย่อขยาย
...
ทุกๆคนและทุกๆบริษัทมีมุมมองที่ต่างกันว่าข้อมูลใดสำคัญที่สุดต่อพวกเขา หรือข้อมูลใดที่ไม่จำเป็นสำหรับวิธีการดำเนินธุรกิจของพวกเขา ความสามารถในการปรับแต่งวิธีการข้อมูลของคุณถูกสั่ง มีด้วย หรือแม้แต่คีย์จะทำให้ประสบการณ์ใช้งานส่วนบุคคล และประสิทธิภาพของ Dynamics 365 สำหรับการดำเนินงานถูกซ่อนอยู่ 

การตั้งค่าส่วนบุคคลที่ชัดเจนจะตั้งค่าส่วนบุคคลเหล่านั้นที่ทำเพื่อเปลี่ยนลักษณะที่ปรากฏหรือลักษณะการทำงานขององค์ประกอบหรือหน้า โดยการเลือกเมนูการตั้งค่าส่วนบุคคลประสงค์อย่างชัดเจน ชนิดพื้นฐานที่สุดของการตั้งค่าส่วนบุคคลที่ชัดเจนคือ ตำแหน่งที่คุณคลิกขวาที่องค์ประกอบ แล้วเลือก**ตั้ง** (โปรดสังเกตว่า บางองค์ประกอบบนเพจของคุณสามารถส่วนบุคคลเท่านั้น) เมื่อคุณเลือกวิธีการตั้งค่าส่วนบุคคลนี้ คุณจะเห็นหน้าต่างคุณสมบัติขององค์ประกอบ 

[![คุณสมบัติขององค์ประกอบที่เป็นแบบส่วนบุคคล](./media/personalization-element-properties.jpg)](./media/personalization-element-properties.jpg) 
...
[![เครื่องมือการตั้งค่าส่วนบุคคล](./media/personalization-personalizationtoolbar.jpg)](./media/personalization-personalizationtoolbar.jpg)

แถบเครื่องมือการตั้งค่าส่วนบุคคลมีหมายเลขของการดำเนินการตั้งค่าส่วนบุคคล เลือกเครื่องมือ **เลือก** เมื่อคุณต้องการเลือกและเปลี่ยนคุณสมบัติขององค์ประกอบหลายรายการ ครั้งละหนึ่งรายการ ก่อนอื่น ให้คลิกเครื่องมือเลือก แล้วคลิกองค์ประกอบที่มีคุณสมบัติที่คุณต้องการปรับเปลี่ยน เมื่อคุณเลือกองค์ประกอบ หน้าต่างคุณสมบัติขององค์ประกอบจะเปิด และคุณสามารถปรับเปลี่ยนคุณสมบัติใดๆสำหรับองค์ประกอบนั้น คุณสามารถทำซ้ำกระบวนการสำหรับองค์ประกอบอื่นๆในแบบฟอร์มของคุณซึ่งสามารถกำหนดเป็นส่วนบุคคลได้ ในบางกรณี คุณจะเลือกองค์ประกอบและพบว่าคุณสมบัติบางอย่างไม่สามารถปรับเปลี่ยนได้ ซึ่งหมายความว่าขึ้นอยู่กับวิธีองค์ประกอบปัจจุบันใช้ 365 Dynamics สำหรับการดำเนินงานไม่สามารถช่วยให้คุณสามารถเปลี่ยนแปลงคุณสมบัตินั้น ตัวอย่างเช่น คุณไม่สามารถซ่อนฟิลด์ที่จำเป็นได้ 

เลือกเครื่องมือ **ย้าย** เมื่อคุณต้องการเลือกและย้ายองค์ประกอบไปยังตำแหน่งอื่นภายในกลุ่มขององค์ประกอบปัจจุบัน (คุณไม่สามารถย้ายองค์ประกอบไปภายนอกกลุ่มหลัก) ก่อนอื่น ให้คลิกเครื่องมือเลือก แล้วคลิกองค์ประกอบที่มีคุณสมบัติที่คุณต้องการย้าย เมื่อคุณคลิกองค์ประกอบที่คุณต้องการย้าย 365 Dynamics สำหรับการดำเนินงานจะสแกนแบบฟอร์มเพื่อทำความเข้าใจซึ่งองค์ประกอบนี้สามารถเคลื่อนย้าย และสร้างชุดของ "พื้นที่สำหรับปล่อย" ที่แสดงเป็นตัวหนา สีเส้นอยู่ถัดจากพื้นที่ที่องค์ประกอบสามารถถูกลบขณะที่คุณลากองค์ประกอบนั้นไปรอบ ๆ ภายในกลุ่มปัจจุบัน 

เลือกเครื่องมือ **ซ่อน** เพื่อเลือกและซ่อนองค์ประกอบ เมื่อต้องการซ่อนองค์ประกอบ เพียงแค่เลือกเครื่องมือการซ่อน และคลิกองค์ประกอบที่คุณต้องการซ่อน เมื่อคุณเลือกเครื่องมือการซ่อน จะทำให้มองเห็นองค์ประกอบที่ถูกซ่อนอยู่ในขณะนี้ทั้งหมด และมีการแสดงในตู้บรรจุสินค้าสีเทาเพื่อให้คุณสามารถเลือกองค์ประกอบที่จะยกเลิกการซ่อนได้ เลือกเครื่องมือการเลือกเพื่อดูลักษณะของหน้าที่มีการซ่อนองค์ประกอบที่เลือก เลือกเครื่องมือ **สรุป** เมื่อคุณต้องการให้ฟิลด์ตัวเลขหรือสตริงแสดงในพื้นที่สรุป FastTab เครื่องมือสรุปจะใช้กับฟิลด์ที่มีอยู่ภายในส่วน FastTab เท่านั้น เมื่อคุณเลือกเครื่องมือสรุป 365 Dynamics สำหรับการดำเนินงานจะแสดงเขตข้อมูลทั้งหมดที่ได้เลือกเป็นเขตข้อมูลที่สรุป โดยการล้อมรอบเหล่านั้นในคอนเทนเนอร์ที่มีโทนสีเทา คุณสามารถเพิ่มและลบฟิลด์ในเชิงโต้ตอบจาก FastTab สรุป โดยการคลิกฟิลด์ 

เลือก**ข้าม**เครื่องมือเพื่อเอาองค์ประกอบออกจากลำดับแท็บแป้นพิมพ์ของหน้า เมื่อคุณเลือกเครื่องมือข้าม องค์ประกอบที่ถูกข้ามในขณะนี้ทั้งหมดจะแสดงขึ้นในคอนเทนเนอร์แรเงาเพื่อให้คุณสามารถเลือกเหล่านั้นอีกครั้งเพื่อทำให้เป็นส่วนหนึ่งของลำดับการแท็บด้วยการเลือกองค์ประกอบข้ามไป 
...
เลือก**จัดการ**ปุ่มเพื่อดูรายการของตัวเลือกการจัดการที่เกี่ยวข้องกับการตั้งค่าส่วนบุคคลทั้งหมดสำหรับเพจปัจจุบัน 

เลือก**ล้าง**เพื่อรีเซ็ตหน้าค่าเริ่มต้น สถานะการติดตั้ง การตั้งค่าส่วนบุคคลทั้งหมดบนเพจปัจจุบันจะถูกล้างข้อมูลออก ไม่มีการเลิกทำการดำเนินการ ใช้ตัวเลือกนี้เพื่อให้มีเฉพาะ เมื่อคุณมั่นใจว่า คุณต้องการตั้งค่าเพจของคุณ 
...
ด้วยแถบเครื่องมือการทำให้เป็นแบบส่วนบุคคล การบันทึกเป็นแบบไม่ชัดเจน การทำให้เป็นแบบส่วนบุคคลของคุณมีผลในทันทีเมื่อคุณดำเนินการ และไม่จำเป็นต้องคลิกปุ่ม **บันทึก** ในบางกรณี คุณจะเห็นไอคอนแม่กุญแจที่อยู่ถัดจากองค์ประกอบเมื่อคุณเลือกเครื่องมือ ซึ่งหมายความ ว่า ในใบสั่งสำหรับเพจที่ทำงานได้อย่างถูกต้องเป็น คุณไม่สามารถปรับเปลี่ยนคุณสมบัติที่เกี่ยวข้องกับเครื่องมือที่เลือก เมื่อมีการเปิดแถบเครื่องมือการทำให้เป็นแบบส่วนบุคคล หน้าจะกลายเป็นแบบไม่มีการโต้ตอบ คุณไม่สามารถป้อนข้อมูล หรือขยาย หรือยุบส่วนได้
...
บางพื้นที่ทำงานประกอบด้วยป้ายการตรวจนับ (แบบเรียงต่อกัน ด้วยตัวเลขนั้น) ที่คุณต้องการดูบนแดชบอร์ดของคุณ ในพื้นที่ทำงาน รูปประจำตัวนับการคลิกขวา และเลือก**ตั้ง** เลือก **ตรึงที่แดชบอร์ด** ในครั้งต่อไปที่คุณนำทางไปยัง (และรีเฟรช) แดชบอร์ดที่เลือก คุณจะเห็นการตรวจนับที่ด้านล่างของไทล์การนำทางของพื้นที่ทำงานในแดชบอร์ด
