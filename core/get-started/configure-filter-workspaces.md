...
[![ตั้งค่าคอนฟิก และกรองพื้นที่ทำงาน](./media/configure-and-filter-workspaces.png)](./media/configure-and-filter-workspaces.png)   
...
[![ตั้งค่าคอนฟิก-my-พื้นที่ทำงาน](./media/configure-my-workspace.png)](./media/configure-my-workspace.png)
...
[![พื้นที่ตัวกรอง](./media/workspace-filter.png)](./media/workspace-filter.png) 

เมื่อคุณคลิกเพื่อเปิดตัวกรอง ตัวเลือกต่างๆ จะถูกแสดง 

[![พื้นที่ทำงานตัวกรองขยาย](./media/workspace-filter-expanded.png)](./media/workspace-filter-expanded.png) 
...
[![ตัวกรองพื้นที่ส่วน](./media/workspace-section-filters.png)](./media/workspace-section-filters.png) 
