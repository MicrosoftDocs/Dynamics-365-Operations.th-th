...
<span data-ttu-id="8e752-107">สมุดรายวันที่ใช้เพื่อบันทึกผลกระทบทางการเงินของเหตุการณ์ทางบัญชีในระบบบัญชี</span><span class="sxs-lookup"><span data-stu-id="8e752-107">A journal that is used to record the financial consequences of accounting events in an accounting system.</span></span>
...
<span data-ttu-id="8e752-119">จำนวนวันในรอบระยะเวลาที่ใช้ในการรายงานยอดดุลการชำระเงินของลูกค้าที่พ้นกำหนดชำระ</span><span class="sxs-lookup"><span data-stu-id="8e752-119">The number of days in a time period used to report an overdue customer payment balance.</span></span>
...
<span data-ttu-id="8e752-132">รอบระยะเวลาที่จะได้รับคุณภาพหรือคุณลักษณะสูงสุดของผลิตภัณฑ์</span><span class="sxs-lookup"><span data-stu-id="8e752-132">The time period in which to obtain the optimum quality or characteristic of a product.</span></span>
...
###### <a name="budget-cycle-time-span"></a><span data-ttu-id="8e752-145">**ระยะเวลาวงจรงบประมาณ**</span><span class="sxs-lookup"><span data-stu-id="8e752-145">**budget cycle time span**</span></span>
...
###### <a name="capacity-load"></a><span data-ttu-id="8e752-159">**การใช้กำลังการผลิต**</span><span class="sxs-lookup"><span data-stu-id="8e752-159">**capacity load**</span></span>
...
###### <a name="cogs-cost-of-goods-sold"></a><span data-ttu-id="8e752-172">**COGS (ต้นทุนขาย)**</span><span class="sxs-lookup"><span data-stu-id="8e752-172">**COGS (cost of goods sold)**</span></span>
...
###### <a name="delivery-note"></a><span data-ttu-id="8e752-200">**บันทึกการจัดส่ง**</span><span class="sxs-lookup"><span data-stu-id="8e752-200">**delivery note**</span></span>
...
<span data-ttu-id="8e752-213">ผลิตภัณฑ์ที่ระบุได้ไม่ซ้ำกัน</span><span class="sxs-lookup"><span data-stu-id="8e752-213">A uniquely identifiable product.</span></span>
...
<span data-ttu-id="8e752-226">การตั้งค่าแอพลิเคชันด้วยตนเองโดยการเพิ่มฟังก์ชันไปยังโค้ดที่มีอยู่</span><span class="sxs-lookup"><span data-stu-id="8e752-226">Customizing an application by adding functionality to existing code.</span></span>
...
<span data-ttu-id="8e752-239">ชนิดของคัมบังที่จะใช้เมื่อกำหนดจำนวนคัมบังให้กับกฎคัมบังเป็นค่าคงที่</span><span class="sxs-lookup"><span data-stu-id="8e752-239">A type of kanban that is used when the number of kanbans that are assigned to a kanban rule is constant.</span></span>
...
###### <a name="intercompany"></a><span data-ttu-id="8e752-252">**ระหว่างบริษัท**</span><span class="sxs-lookup"><span data-stu-id="8e752-252">**intercompany**</span></span>
...
###### <a name="kanban-job"></a><span data-ttu-id="8e752-265">**งานคัมบัง**</span><span class="sxs-lookup"><span data-stu-id="8e752-265">**kanban job**</span></span>
...
###### <a name="license-code"></a><span data-ttu-id="8e752-278">**รหัสลิขสิทธิ์**</span><span class="sxs-lookup"><span data-stu-id="8e752-278">**license code**</span></span>
...
###### <a name="nbv-net-book-value"></a><span data-ttu-id="8e752-292">**NBV (มูลค่าตามบัญชีสุทธิ)**</span><span class="sxs-lookup"><span data-stu-id="8e752-292">**NBV (net book value)**</span></span>
...
###### <a name="package"></a><span data-ttu-id="8e752-304">**แพคเกจ**</span><span class="sxs-lookup"><span data-stu-id="8e752-304">**package**</span></span>
...
###### <a name="preparer"></a><span data-ttu-id="8e752-317">**ผู้จัดเตรียม**</span><span class="sxs-lookup"><span data-stu-id="8e752-317">**preparer**</span></span>
...
###### <a name="product-variant"></a><span data-ttu-id="8e752-331">**ผลิตภัณฑ์ย่อย**</span><span class="sxs-lookup"><span data-stu-id="8e752-331">**product variant**</span></span>
...
<span data-ttu-id="8e752-344">นโยบายที่อนุมัติให้ฝ่ายต่างๆ สามารถแก้ไขเงื่อนไขข้อตกลงการซื้อ</span><span class="sxs-lookup"><span data-stu-id="8e752-344">A policy that authorizes parties to modify purchase agreement terms.</span></span>
...
<span data-ttu-id="8e752-356">เอกสารทางธุรกิจที่แสดงสรุปข้อมูลของผลิตภัณฑ์ที่ผู้ซื้อได้รับจากผู้จัดจำหน่าย</span><span class="sxs-lookup"><span data-stu-id="8e752-356">A business document that documents a summary of the products a buyer receives from a vendor.</span></span>
...
<span data-ttu-id="8e752-393">ปริมาณผลิตภัณฑ์ที่ระบุในรายการเอกสารต้นทางที่สร้างข้อกำหนดการเชื่อมโยงความต้องการกับการจัดซื้อ</span><span class="sxs-lookup"><span data-stu-id="8e752-393">The product quantity documented on a source document line that creates a pegging requirement.</span></span>
...
<span data-ttu-id="8e752-405">เครื่องมือที่มีการติดตั้งไว้ล่วงหน้าใน Finance and Operations</span><span class="sxs-lookup"><span data-stu-id="8e752-405">A tool that is pre-installed in Finance and Operations.</span></span> <span data-ttu-id="8e752-406">เมื่อมีการบันทึก จะเป็นการบันทึกเหตุการณ์ทั้งหมดที่ผู้ใช้ป้อนในส่วนติดต่อผู้ใช้ของ Finance and Operations ที่ได้รับการดำเนินการกับเซิร์ฟเวอร์ ซึ่งรวมถึงการเพิ่มค่า การเปลี่ยนแปลงการตั้งค่า การลบข้อมูล เป็นต้น</span><span class="sxs-lookup"><span data-stu-id="8e752-406">When recording, it records all events that the user enters in the Finance and Operations user interface that get executed against the server—including values added, settings changed, data removed, etc.</span></span>

###### <a name="task-recording"></a><span data-ttu-id="8e752-407">**การบันทึกงาน**</span><span class="sxs-lookup"><span data-stu-id="8e752-407">**Task recording**</span></span>

<span data-ttu-id="8e752-408">ไฟล์ที่ประกอบด้วยการดำเนินการและคำอธิบายที่ถูกรวบรวมไว้เมื่อมีการเรียกใช้ตัวบันทึกงานใน Finance and Operations</span><span class="sxs-lookup"><span data-stu-id="8e752-408">A file that contains the actions and annotations that are captured when Task recorder is run in Finance and Operations.</span></span>

###### <a name="three-way-matching-policy"></a><span data-ttu-id="8e752-409">**นโยบายการจับคู่สามทาง**</span><span class="sxs-lookup"><span data-stu-id="8e752-409">**three-way matching policy**</span></span>

<span data-ttu-id="8e752-410">นโยบายการจับคู่ที่จำเป็นต้องมีราคาในใบแจ้งหนี้ของผู้จัดจำหน่ายอย่างน้อยหนึ่งรายการเพื่อจับคู่กับราคาในใบสั่งซื้ออย่างน้อยหนึ่งรายการ และจำเป็นต้องมีปริมาณในใบแจ้งหนี้ของผู้จัดจำหน่ายอย่างน้อยหนึ่งรายการเพื่อจับคู่กับปริมาณในใบรับสินค้าอย่างน้อยหนึ่งรายการ</span><span class="sxs-lookup"><span data-stu-id="8e752-410">A matching policy that requires one or more vendor invoice prices to match with one or more purchase order prices and that requires one or more vendor invoice quantities to match with one or more product receipt quantities.</span></span>

###### <a name="transfer-batch"></a><span data-ttu-id="8e752-411">**ชุดงานโอนย้าย**</span><span class="sxs-lookup"><span data-stu-id="8e752-411">**transfer batch**</span></span>

<span data-ttu-id="8e752-412">ปริมาณของสินค้าหนึ่งรายการขึ้นไปที่โอนย้ายหรือที่สามารถโอนย้ายได้</span><span class="sxs-lookup"><span data-stu-id="8e752-412">The quantity of one or more items that is transferred or that can be transferred.</span></span>

###### <a name="two-way-matching-policy"></a><span data-ttu-id="8e752-413">**นโยบายการจับคู่สองทาง**</span><span class="sxs-lookup"><span data-stu-id="8e752-413">**two-way matching policy**</span></span>

<span data-ttu-id="8e752-414">นโยบายการจับคู่ที่จำเป็นต้องมีราคาในใบแจ้งหนี้ของผู้จัดจำหน่ายอย่างน้อยหนึ่งรายการเพื่อจับคู่กับราคาในใบสั่งซื้ออย่างน้อยหนึ่งรายการขึ้นไป</span><span class="sxs-lookup"><span data-stu-id="8e752-414">A matching policy that requires one or more vendor invoice prices to match with one or more purchase order prices.</span></span>

### <a name="v"></a><span data-ttu-id="8e752-415">**ถ**</span><span class="sxs-lookup"><span data-stu-id="8e752-415">**V**</span></span>

###### <a name="value-stream"></a><span data-ttu-id="8e752-416">**สายธารคุณค่า**</span><span class="sxs-lookup"><span data-stu-id="8e752-416">**value stream**</span></span>

<span data-ttu-id="8e752-417">หน่วยปฏิบัติงานที่ควบคุมขั้นตอนการผลิตหนึ่งขั้นตอนขึ้นไป</span><span class="sxs-lookup"><span data-stu-id="8e752-417">An operating unit that controls one or more production flows.</span></span>

###### <a name="variant-configuration-technology"></a><span data-ttu-id="8e752-418">**เทคโนโลยีการจัดโครงแบบผันแปร**</span><span class="sxs-lookup"><span data-stu-id="8e752-418">**variant configuration technology**</span></span>

<span data-ttu-id="8e752-419">วิธีการในการสร้างแบบจำลองผลิตภัณฑ์หลัก และค้นหาการตั้งค่าคอนฟิกผลิตภัณฑ์ย่อย</span><span class="sxs-lookup"><span data-stu-id="8e752-419">A method of modeling product masters and searching for product variant configurations.</span></span>

###### <a name="vat-value-added-tax"></a><span data-ttu-id="8e752-420">**VAT (ภาษีมูลค่าเพิ่ม)**</span><span class="sxs-lookup"><span data-stu-id="8e752-420">**VAT (value-added tax)**</span></span>

<span data-ttu-id="8e752-421">ภาษีสำหรับผลิตภัณฑ์ในแต่ละขั้นตอนของการผลิตโดยยึดตามมูลค่าเพิ่มในระหว่างระยะนั้น</span><span class="sxs-lookup"><span data-stu-id="8e752-421">A tax on products at each stage of their production based on the value added during that stage.</span></span>

###### <a name="vendor-catalog"></a><span data-ttu-id="8e752-422">**แค็ตตาล็อกของผู้จัดจำหน่าย**</span><span class="sxs-lookup"><span data-stu-id="8e752-422">**vendor catalog**</span></span>

<span data-ttu-id="8e752-423">การแสดงรายการของข้อเสนอของผลิตภัณฑ์ที่พร้อมใช้งานสำหรับการซื้อจากผู้จัดจำหน่าย</span><span class="sxs-lookup"><span data-stu-id="8e752-423">A listing of product offerings that are available for purchase from a vendor.</span></span>

###### <a name="vendor-invoice"></a><span data-ttu-id="8e752-424">**ใบแจ้งหนี้ของผู้จัดจำหน่าย**</span><span class="sxs-lookup"><span data-stu-id="8e752-424">**vendor invoice**</span></span>

<span data-ttu-id="8e752-425">เอกสารต้นทางที่แสดงคำขอการชำระเงินจากผู้จัดจำหน่าย</span><span class="sxs-lookup"><span data-stu-id="8e752-425">A source document that documents a vendor payment request.</span></span> <span data-ttu-id="8e752-426">ใบแจ้งหนี้ของผู้จัดจำหน่ายสามารถอ้างอิงถึงใบสั่งซื้อหนึ่งรายการขึ้นไป</span><span class="sxs-lookup"><span data-stu-id="8e752-426">A vendor invoice can refer to one or more purchase orders.</span></span> <span data-ttu-id="8e752-427">เมื่อใบแจ้งหนี้ของผู้จัดจำหน่ายได้รับอนุมัติ สามารถดำเนินการการชำระเงินกับผู้จัดจำหน่ายได้</span><span class="sxs-lookup"><span data-stu-id="8e752-427">When the vendor invoice is authorized, a payment can be made to the vendor.</span></span>

### <a name="w"></a><span data-ttu-id="8e752-428">**ท**</span><span class="sxs-lookup"><span data-stu-id="8e752-428">**W**</span></span>

###### <a name="work-cell"></a><span data-ttu-id="8e752-429">**เซลล์ทำงาน**</span><span class="sxs-lookup"><span data-stu-id="8e752-429">**work cell**</span></span>

<span data-ttu-id="8e752-430">กลุ่มทรัพยากรที่เข้าร่วมในกิจกรรมของขั้นตอนการผลิต</span><span class="sxs-lookup"><span data-stu-id="8e752-430">A resource group that participates in a production flow activity.</span></span>

###### <a name="worker"></a><span data-ttu-id="8e752-431">**ผู้ปฏิบัติงาน**</span><span class="sxs-lookup"><span data-stu-id="8e752-431">**worker**</span></span>

<span data-ttu-id="8e752-432">บุคคลที่รับบทบาทของพนักงานหรือผู้รับเหมาและรับชำระเงินเพื่อแลกเปลี่ยนกับบริการ</span><span class="sxs-lookup"><span data-stu-id="8e752-432">A person who assumes the role of an employee or a contractor and is paid in exchange for services.</span></span>

###### <a name="workspace"></a><span data-ttu-id="8e752-433">**พื้นที่ทำงาน**</span><span class="sxs-lookup"><span data-stu-id="8e752-433">**workspace**</span></span>

<span data-ttu-id="8e752-434">หน้าซึ่งแสดงภาพรวมของหนึ่งในกิจกรรมที่ผู้ใช้ดำเนินงาน</span><span class="sxs-lookup"><span data-stu-id="8e752-434">A page that provides an overview of one of the activities that the user performs.</span></span> <span data-ttu-id="8e752-435">หน้านี้ใช้ไทล์ รายการ และแผนภูมิเพื่อแสดงงานที่ค้างอยู่และข้อมูลที่เกี่ยวข้องจากหลายแหล่งข้อมูล และหน้านี้จะจัดการการดำเนินงานที่เกิดขึ้นบ่อยครั้งที่เกี่ยวข้องกับข้อมูลนี้</span><span class="sxs-lookup"><span data-stu-id="8e752-435">The page uses tiles, lists, and charts to display pending work and related data from multiple sources, and the page surfaces frequent tasks related to this data.</span></span> <span data-ttu-id="8e752-436">ไทล์ต่างๆ ที่มีการแสดงในส่วนสรุปของพื้นที่ทำงานยังมีการแสดงในส่วนที่เกี่ยวข้องในแดชบอร์ดด้วย</span><span class="sxs-lookup"><span data-stu-id="8e752-436">Tiles shown in the summary section of the workspace are also displayed in the related section in the dashboard.</span></span>
