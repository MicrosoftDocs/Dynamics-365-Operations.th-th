...
description: "บทความนี้อธิบายระบบลำดับงานใน 365 Dynamics Microsoft สำหรับการดำเนินงาน"
author: sericks007
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
บทความนี้อธิบายระบบลำดับงานใน 365 Dynamics Microsoft สำหรับการดำเนินงาน
...
ลำดับงานเป็นระบบที่ติดตั้งมากับ 365 Dynamics สำหรับการดำเนินงาน และที่ทำงานบน Application Object Server (AOS) ระบบลำดับงานมีฟังก์ชันที่คุณสามารถใช้สร้างลำดับงานหรือกระบวนการทางธุรกิจแต่ละรายการ
