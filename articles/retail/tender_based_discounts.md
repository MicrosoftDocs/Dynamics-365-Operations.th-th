...
ผู้ค้าปลีกมักจะเลือกที่จะแยกผลิตภัณฑ์บางอย่าง เช่น สินค้าใหม่ หรือสินค้าตามความต้องการ ออกจากส่วนลด อย่างไรก็ตาม พวกเขาอาจยังคงต้องการใช้ส่วนลดที่ใช้ในการชำระเงิน ตัวอย่างเช่น ผู้ค้าปลีกตั้งค่าคอนฟิก Retail เพื่อให้ไม่อนุญาตให้มีส่วนลดตามสินค้าหรือส่วนลดแบบกำหนดเอง อย่างไรก็ตาม ถ้าลูกค้าชำระเงินโดยใช้การชำระเงินที่ต้องการ Retail ยังคงใช้ส่วนลดที่ใช้ในการชำระเงิน หากต้องการตั้งค่า Retail ในลักษณะนี้ ผู้ค้าปลีกต้องปิดตัวเลือก **ป้องกันส่วนลดทั้งหมด** และ **ป้องกันส่วนลดที่ใช้ในการชำระเงิน** และเปิดตัวเลือก **ป้องกันส่วนลดของการขายปลีก** และ **ป้องกันส่วนลดแบบกำหนดเอง** ตัวเลือกอยู่บนหน้า **ผลิตภัณฑ์ที่นำออกใช้** บนแท็บ **Retail**

> [!NOTE]
> เมื่อมีการเปิดใช้งานการตั้งค่าคอนฟิก **ป้องกันส่วนลดทั้งหมด** จะไม่มีการใช้ส่วนลดกับผลิตภัณฑ์ จะไม่มีการใช้แม้แต่ส่วนลดที่ใช้ในการชำระเงิน
