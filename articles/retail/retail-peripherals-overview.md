...
<li>OPOS</li>
<li>เครือข่าย
<blockquote>[!NOTE] สามารถตั้งค่าได้เพียงลิ้นชักเดียว ถ้า <strong>ใช้กะที่ใช้ร่วมกัน</strong> ถูกตั้งค่าคอนฟิกไว้ในลิ้นชัก</blockquote>
</li>
</ul>
</td>
</tr>
...
<blockquote>[!NOTE] สำหรับเครื่องพิมพ์ของ Windows บนเครือข่าย ผู้ใช้ของสถานีฮาร์ดแวร์จะต้องมีสิทธิ์ในการเข้าถึงเครื่องพิมพ์</blockquote>
</li>
<li>เครือข่าย</li>
</ul>
</td>
...
<li>OPOS</li>
<li>เครือข่าย
<blockquote>[!NOTE] สามารถตั้งค่าได้เพียงลิ้นชักเดียวสำหรับแต่ละโพร์ไฟล์ฮาร์ดแวร์ ถ้า <strong>ใช้กะที่ใช้ร่วมกัน</strong> ถูกตั้งค่าคอนฟิกไว้ในลิ้นชัก</blockquote>
</li>
</ul>
</td>
</tr>
...
> [!NOTE]
> สำหรับ Microsoft Dynamics 365 for Retail รุ่น 1611 ไม่มีการใช้งานโพรไฟล์สถานีฮาร์ดแวร์อีกต่อไป ในขณะนี้ แอตทริบิวต์ที่คุณตั้งค่าไว้ในโพรไฟล์สถานีฮาร์ดแวร์ก่อนหน้านี้จะเป็นส่วนหนึ่งของสถานีฮาร์ดแวร์เอง
