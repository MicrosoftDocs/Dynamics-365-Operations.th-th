...
description: หัวข้อนี้อธิบายวิธีการตั้งค่าโหมดของการจัดส่งและค่าธรรมเนียมสำหรับใบสั่งศูนย์บริการใน Dynamics 365 Retail
author: josaw1
manager: AnnBe
ms.date: 04/26/2018
ms.topic: article
...
ms.locfileid: "2019504"
---
# <a name="configure-call-center-delivery-modes-and-charges"></a>ตั้งค่าคอนฟิกศูนย์บริการ โหมดการจัดส่ง และค่าธรรมเนียม

[!INCLUDE [banner](includes/banner.md)]

เมื่อใบสั่งขายถูกวางใน Dynamics 365 Retail หากบุคคลที่ป้อนใบสั่งขายถูกเชื่อมโยงไปยังช่องทางศูนย์บริการ ตรรกะและกฎจะถูกใช้เพื่อตรวจสอบโหมดของการจัดส่ง (โหมดการจัดส่ง) และคำนวณค่าธรรมเนียมสำหรับใบสั่ง
