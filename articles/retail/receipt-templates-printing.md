...
description: บทความนี้อธิบายวิธีการแก้ไขโครงร่างแบบฟอร์มเพื่อควบคุมวิธีพิมพ์ใบเสร็จ ใบแจ้งหนี้ และเอกสารอื่นๆ ได้ รวมถึงการออกแบบโครงร่างแบบฟอร์มที่คุณสามารถใช้เพื่อสร้าง  Dynamics 365 Retail รวมตัวออกแบบโครงร่างฟอร์มที่คุณสามารถใช้ เพื่อสร้างหรือปรับเปลี่ยนชนิดต่างๆ ของโครงร่างฟอร์มได้อย่างง่ายดาย
...
ms.locfileid: "2025136"
---
# <a name="set-up-and-design-receipt-formats"></a>ตั้งค่าและออกแบบรูปแบบใบเสร็จ

[!include [banner](includes/banner.md)]

บทความนี้อธิบายวิธีการแก้ไขโครงร่างแบบฟอร์มเพื่อควบคุมวิธีพิมพ์ใบเสร็จ ใบแจ้งหนี้ และเอกสารอื่นๆ ได้ รวมถึงการออกแบบโครงร่างแบบฟอร์มที่คุณสามารถใช้เพื่อสร้าง  Dynamics 365 Retail ประกอบด้วยโปรแกรมออกแบบโครงร่างแบบฟอร์มที่คุณสามารถใช้เพื่อสร้างและแก้ไขโครงร่างแบบฟอร์มชนิดต่าง ๆ ได้อย่างง่ายดาย
...
5. หลังจากการติดตั้งเสร็จสิ้นป้อนชื่อผู้ใช้การขายปลึกและรหัสผ่านของคุณและจากนั้นคลิก **ลงชื่อเข้าใช้** เพื่อเริ่มต้นตัวออกแบบ
