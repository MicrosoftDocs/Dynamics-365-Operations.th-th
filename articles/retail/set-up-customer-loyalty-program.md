...
โปรแกรมตอบแทนลูกค้าสมาชิกสามารถช่วยเพิ่มความภักดีของลูกค้าได้ โดยการให้รางวัลลูกค้าสำหรับการโต้ตอบของพวกเขากับแบรนด์ของผู้ค้าปลีก ใน Microsoft Dynamics 365 for Retail คุณสามารถตั้งค่าโปรแกรมตอบแทนลูกค้าสมาชิกแบบง่ายหรือซับซ้อนที่ใช้ทั่วทั้งของนิติบุคคลในช่องทางการขายปลีกใดๆ  หัวข้อนี้อธิบายความสามารถของสมาชิกภายใน Microsoft Dynamics 365 for Retail และขั้นตอนการตั้งค่าที่สอดคล้องกัน เพื่อช่วยให้ผู้ค้าปลีกสามารถเริ่มต้นใช้งานกับโปรแกรมตอบแทนลูกค้าสมาชิกของพวกเขาได้อย่างง่ายดาย
...
คุณต้องตั้งค่าส่วนประกอบต่างๆ เพื่อเปิดใช้งานลักษณะการทำงานสำหรับสมาชิกใน Dynamics 365 for Retail  แผนภาพต่อไปนี้แสดงให้เห็นถึงส่วนประกอบของลูกค้าสมาชิกและวิธีที่ส่วนประกอบมีความสัมพันธ์กัน

![ลำดับกระบวนการตั้งค่าสมาชิก](./media/loyaltyprocess.gif "คอมโพเนนต์สมาชิก และวิธีที่มีความสัมพันธ์กัน")
...
|--------------------------------------|-------------|-----------|
| 1050 (ข้อมูลสมาชิก)           | รันกระบวนการนี้เพื่อส่งข้อมูลการตั้งค่าคอนฟิกสำหรับสมาชิกจาก Dynamics 365 for Retail ไปยังร้านขายปลีก เป็นความคิดที่ดีที่จะจัดกำหนดการกระบวนการนี้เพื่อที่จะรันบ่อย เพื่อให้ข้อมูลสมาชิกถูกส่งไปยังร้านค้าทั้งหมด | กำหนดการกระจาย |
...
![การตั้งค่าบัตรสมาชิก](./media/LoyaltyCardSetup.png "การตั้งค่าบัตรสมาชิก")
...
- การจัดส่งฟรีหรือได้รับส่วนลด เป็นหนึ่งปัจจัยที่จูงใจอย่างยิ่งสำหรับลูกค้าเมื่อต้องการซื้อออนไลน์ ในการเปิดใช้งานผู้ค้าปลีกเพื่อตั้งค่าการส่งเสริมการขายสำหรับการจัดส่ง ในการนำออกใช้ 10.0 เราได้แนะนำชนิดใหม่ของโปรโมชันที่มีชื่อว่า "ส่วนลดขีดจำกัดการจัดส่ง" ที่ผู้ค้าปลีกสามารถกำหนดขีดจำกัด ซึ่งเมื่อตรงตามนั้น จะคัดเลือกลูกค้าสำหรับการจัดส่งฟรี หรือได้รับส่วนลด ตัวอย่างเช่น ใช้ $35 สำหรับ 'การจัดส่งสองวัน' ฟรี หรือ 'การจัดส่งสองวัน' ฟรีสำหรับลูกค้าสมาชิกทั้งหมด ส่วนลดเหล่านี้จะใช้กับค่าธรรมเนียมการจัดส่งที่ใช้กับใบสั่งเท่านั้น เนื่องจากผู้ค้าปลีกสามารถตั้งค่าค่าธรรมเนียมได้หลายชนิด เช่น การจัดการหรือการติดตั้ง ผู้ค้าปลีกจำเป็นต้องระบุว่าค่าธรรมเนียมใดที่จะถือเป็นค่าธรรมเนียมการจัดส่ง การตั้งค่าคอนฟิกนี้จะมีชื่อว่า "รหัสค่าธรรมเนียมการจัดส่ง" และจะพร้อมใช้งานในแท็บ **ใบสั่งของลูกค้า** บนหน้า **พารามิเตอร์การขายปลีก** ส่วนลดนี้ใช้ได้กับส่วนลดมาตรฐานที่มีอยู่ทั้งหมด เช่น การอนุญาตให้ผู้ค้าปลีกจำกัดส่วนลดเหล่านี้ที่มีคูปองเพื่อให้เฉพาะลูกค้าที่มีคูปองสามารถได้รับส่วนลดเหล่านี้ นอกจากนี้ ส่วนลดเหล่านี้ยังใช้ประโยชน์ความสามารถกลุ่มราคาเพื่อกำหนดสิทธิ์ของส่วนลดดังกล่าวได้อีกด้วย ตัวอย่างเช่น ผู้ค้าปลีกสามารถเลือกที่จะรันโปรโมชันเหล่านี้เฉพาะในช่องทางออนไลน์ และ/หรือระหว่างช่องทางสำหรับกลุ่มลูกค้าเฉพาะ เช่น ลูกค้าสมาชิก หลังจากใบสั่งรายการที่มีวิธีการจัดส่งที่ระบุตรงตามขีดจำกัดที่กำหนดไว้ ส่วนลดจัดส่งจะได้รับการนำไปใช้และลดค่าธรรมเนียมการจัดส่งตามการตั้งค่าส่วนลด 

> [!NOTE]
> ซึ่งแตกต่างจากส่วนลดแบบครั้งคราว เช่น ส่วนลดปริมาณ ส่วนลดอย่างง่าย ส่วนลดสำหรับการซื้อคละกัน และส่วนลดจำกัด ส่วนลดจัดส่งจะไม่สร้างรายการส่วนลด จำเป็นต้องมีการแก้ไขค่าธรรมเนียมการจัดส่งโดยตรง
