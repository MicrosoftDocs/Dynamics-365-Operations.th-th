...
หัวข้อนี้แสดงภาพรวมของการชำระเงินผ่านช่องทาง omni ใน Dynamics 365 Retail ซึ่งรวมถึงรายการที่ครอบคลุมของสถานการณ์จำลองที่สนับสนุน ข้อมูลเกี่ยวกับฟังก์ชัน การตั้งค่า และการแก้ไขปัญหาเบื้องต้น และคำอธิบายเกี่ยวกับปัญหาทั่วไปบางอย่าง
