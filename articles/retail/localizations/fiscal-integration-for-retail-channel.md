...
4. CRT รันผู้ให้บริการเอกสารทางบัญชีที่สร้างเอกสารทางบัญชี (ตัวอย่างเช่น เอกสาร XML) ที่แสดงธุรกรรมหรืออีเวนท์ของการค้าปลีก
...
ธุรกรรมทางบัญชีถูกโอนย้ายไปยัง Retail Headquarters โดย *P-job* พร้อมกับธุรกรรมการขายปลีก บน FastTab **ธุรกรรมทางบัญชี** ของหน้า **ธุรกรรมร้านค้าปลีก** คุณสามารถดูธุรกรรมทางบัญชีที่เชื่อมโยงกับธุรกรรมการขายปลีกได้
...
- [ฟังก์ชันเครื่องบันทึกเงินสดสำหรับฝรั่งเศส](emea-fra-cash-registers.md)
- [ฟังก์ชันเครื่องบันทึกเงินสดสำหรับนอร์เวย์](emea-nor-cash-registers.md)
- [ตัวอย่างสำหรับสำหรับการรวมระบบ Retail POS กับหน่วยการควบคุมสำหรับสวีเดน](./retail-sdk-control-unit-sample.md)
