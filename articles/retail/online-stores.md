...
description: บทความนี้ให้ข้อมูลเกี่ยวกับร้านค้าออนไลน์ Retail และวิธีการตั้งค่าใน Dynamics 365 Retail
author: kfend
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
ms.locfileid: "2017977"
---
# <a name="set-up-online-stores"></a>ตั้งค่าร้านค้าออนไลน์

[!include [banner](includes/banner.md)]

บทความนี้ให้ข้อมูลเกี่ยวกับร้านค้าออนไลน์ Retail และวิธีการตั้งค่าใน Dynamics 365 Retail
