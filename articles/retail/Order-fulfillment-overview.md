...
รูปแบบรายการการเบิกสินค้าถูกตั้งค่าคอนฟิกใน Retail และถูกเพิ่มไปยังโพรไฟล์ใบรับของ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการตั้งค่าโพรไฟล์ใบเสร็จ ดู [เท็มเพลตใบเสร็จและการพิมพ์](https://docs.microsoft.com/dynamics365/unified-operations/retail/receipt-templates-printing)
...
การดำเนินการนี้ทำเครื่องหมายรายการเป็นบรรจุแล้วหรือบรรจุแล้วบางส่วน และพิมพ์บันทึกการจัดส่ง คุณสามารถพิมพ์บันทึกการจัดส่งเพื่อตรวจสอบผลิตภัณฑ์ที่มีการบรรจุพร้อมกัน รูปแบบบันทึกการจัดส่งถูกตั้งค่าคอนฟิกใน Retail และถูกเพิ่มไปยังโพรไฟล์ใบรับ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการตั้งค่าโพรไฟล์ใบเสร็จ ดู [เท็มเพลตใบเสร็จและการพิมพ์](https://docs.microsoft.com/dynamics365/unified-operations/retail/receipt-templates-printing)
