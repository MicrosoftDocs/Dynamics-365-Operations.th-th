...
รูปแบบรายการการเลือกถูกตั้งค่าคอนฟิกใน Dynamics 365 for Retail และถูกเพิ่มไปยังโพรไฟล์ใบรับ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการตั้งค่าโพรไฟล์ใบเสร็จ ดู [เท็มเพลตใบเสร็จและการพิมพ์](https://docs.microsoft.com/dynamics365/unified-operations/retail/receipt-templates-printing)
...
หลังจากที่มีการดำเนินการกระบวนการเบิกสินค้าตามจริง สามารถทำเครื่องหมายรายการเป็น **เบิกสินค้าแล้ว** ได้ การเลือกรายการและการทำเครื่องหมายเป็น **เลือกแล้ว** ดำเนินการเรียกใช้แบบเรียลไทม์เพื่อปรับปรุงรายการใบสั่งใน Dynamics 365 for Retail หลังจากที่มีการทำเครื่องหมายรายการเป็น **เบิกสินค้าแล้ว** ณ จุดขายหน้าร้าน สถานะในฝ่ายสนับสนุนจะถูกอัพเดตด้วยเป็น **เบิกสินค้าแล้ว** และธุรกรรมสินค้าคงคลังแสดงว่า ปริมาณที่ระบุได้ถูกลดลงแล้ว
...
การดำเนินการนี้ทำเครื่องหมายรายการเป็นบรรจุแล้วหรือบรรจุแล้วบางส่วน และพิมพ์บันทึกการจัดส่ง คุณสามารถพิมพ์บันทึกการจัดส่งเพื่อตรวจสอบผลิตภัณฑ์ที่มีการบรรจุพร้อมกัน รูปแบบสลิปบรรจุถูกตั้งค่าคอนฟิกใน Dynamics 365 for Retail และถูกเพิ่มไปยังโพรไฟล์ใบรับ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการตั้งค่าโพรไฟล์ใบเสร็จ ดู [เท็มเพลตใบเสร็จและการพิมพ์](https://docs.microsoft.com/dynamics365/unified-operations/retail/receipt-templates-printing)
