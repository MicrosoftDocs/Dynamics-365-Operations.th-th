...
> [!NOTE]
> สำหรับคำแนะนำในการติดตั้งเฉพาะ ดูที่ [การตั้งค่าคอนฟิกและการติดตั้งสถานีฮาร์ดแวร์ขายปลีก](retail-hardware-station-configuration-installation.md) และ [การดาวน์โหลด/การติดตั้งการบริการตนเองของ Retail Modern POS และการเปิดใช้งานอุปกรณ์ของ Modern POS และ Cloud POS](retail-modern-pos-device-activation.md)
