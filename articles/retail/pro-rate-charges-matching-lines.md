...
หัวข้อนี้อธิบายถึงฟังก์ชันสำหรับการจัดกลุ่มค่าธรรมเนียมอัตโนมัติในระดับส่วนหัว และการคิดตามสัดส่วนกับรายการขายปลีก ฟังก์ชันนี้จะพร้อมใช้งานสำหรับธุรกรรมที่ถูกสร้างขึ้นที่การขายหน้าร้าน (POS) ในรุ่นการขายปลีก 10.0.1 และการขายที่ถูกสร้างขึ้นในศูนย์บริการในรุ่นการขายปลีก 10.0.2
...
ในรุ่นของการขายปลีกที่เป็นรุ่นก่อนหน้ารุ่น 10.0.1 ค่าธรรมเนียมอัตโนมัติระดับส่วนหน้าที่มีโหมดเฉพาะของของความสัมพันธ์การจัดส่งการจัดส่งจะถูกคำนวณเฉพาะเมื่อมีการจับคู่กับวิธีการจัดส่งที่ถูกกำหนดไว้ในส่วนหัวของใบสั่งขาย
