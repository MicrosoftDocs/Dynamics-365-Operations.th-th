...
description: หัวข้อนี้อธิบายถึงความแตกต่างที่สำคัญระหว่าง Retail Modern POS และ Cloud POS ซึ่งยังอธิบายปัจจัยต่างๆ ที่ผู้ค้าปลีกที่กำลังใช้งาน Dynamics 365 Retail ควรพิจารณเพื่อช่วยให้พวกเขาเลือกสิ่งที่ดีที่สุดสำหรับความต้องการของพวกเขา
author: jblucher
manager: AnnBe
ms.date: 10/12/2017
ms.topic: article
...
ms.locfileid: "2025920"
---
# <a name="choose-between-retail-modern-pos-mpos-and-cloud-pos"></a>เลือกระหว่าง Retail Modern POS (MPOS) และ Cloud POS

[!include [banner](includes/banner.md)]

หัวข้อนี้ให้ผู้ใช้มีพื้นหลังเพิ่มเติม เคล็ดลับ และคำแนะนำสำหรับปัจจัยที่พวกเขาควรพิจารณา เมื่อพวกเขาทำการปรับใช้ Dynamics 365 Retail โดยการตรวจทานและการทำตามคำแนะนำนี้ เป็นส่วนหนึ่งของกระบวนการปรับใช้ ผู้ใช้งานระบบสามารถหลีกเลี่ยงปัญหาที่อาจส่งผลกระทบต่อประสิทธิภาพการทำงานหรือความพึงพอใจของผู้ใช้
...
- **iOS/Android** – บนแพลตฟอร์มเหล่านี้ แอพลิเคชันทำหน้าที่เป็นโฮสต์สำหรับรหัสแอพลิเคชัน CPOS กล่าวคือ โค้ดของแอปพลิเคชันมาจากเซิร์ฟเวอร์ CPOS ใน Microsoft Azure หรือ Retail Store Scale Unit (RSSU) สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [ภาพรวม Retail Store Scale Unit](https://docs.microsoft.com/dynamics365/unified-operations/retail/dev-itpro/retail-store-system-begin)
...
| MPOS สำหรับ iOS หรือ Android | Cloud หรือ RSSU | ไม่ใช่                |
| Cloud POS               | Cloud หรือ RSSU | ไม่ใช่                |

#### <a name="retail-server"></a>เซิร์ฟเวอร์ระบบการขายปลีก

เซิร์ฟเวอร์การขายปลีกคือส่วนประกอบที่โฮสต์ CRT CRT ประกอบด้วยตรรกะทางธุรกิจทั้งหมดที่ POS ใช้ และให้การเข้าถึงฐานข้อมูลช่องทาง ในขณะที่พวกเขาออนไลน์ ไคลเอนต์ POS ทั้งหมดในร้านค้าใช้เซิร์ฟเวอร์การขายปลีก จะสามารถปรับใช้เซิร์ฟเวอร์การขายปลีกใน cloud หรือ ในร้านค้า (RSSU) ได้ อย่างใดอย่างหนึ่ง
