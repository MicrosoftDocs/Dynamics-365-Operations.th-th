...
description: หัวข้อนี้อธิบายถึงความแตกต่างที่สำคัญระหว่าง Retail Modern POS และ Cloud POS ซึ่งยังอธิบายปัจจัยต่างๆ ที่ผู้ค้าปลีกที่กำลังใช้งาน Microsoft Dynamics 365 for Retail ควรพิจารณา เพื่อช่วยให้พวกเขาเลือกสิ่งที่ดีที่สุดสำหรับความต้องการของพวกเขา
author: jblucher
manager: AnnBe
ms.date: 10/12/2017
ms.topic: article
