...
description: "หัวข้อนี้อธิบายถึงศูนย์บริการ–ฟังก์ชันเฉพาะสำหรับแค็ตตาล็อกใน Microsoft Dynamics 365 for Retail"
author: josaw1
manager: AnnBe
ms.date: 05/15/2018
ms.topic: article
...
หัวข้อนี้อธิบายถึงศูนย์บริการ–ฟังก์ชันเฉพาะที่เชื่อมโยงกับความสามารถของแค็ตตาล็อกใน Microsoft Dynamics 365 for Retail  

สามารถใช้ลักษณะการทำงานของแค็ตตาล็อกที่พบใน Dynamics 365 for Retail สำหรับวัตถุประสงค์ต่างๆ ได้ ในขั้นแรก ลักษณะการทำงานของแค็ตตาล็อกถูกสร้างเพื่อสนับสนุนการรวมกับพาณิชย์อิเล็กทรอนิกส์ของบุคคลที่สาม การตั้งค่าแค็ตตาล็อกอนุญาตให้บริษัทสามารถสร้างกลุ่มผลิตภัณฑ์และแอททริบิวต์ที่ไม่สามารถเผยแพร่จากภายนอกสำหรับปริมาณการใช้ โดยโซลูชันพาณิชย์อิเล็กทรอนิกส์ของบุคคลที่สาม  

เมื่อมีการเพิ่มการสนับสนุนช่องทางศูนย์บริการไปยัง Dynamics 365 for Retail แนวคิดแค็ตตาล็อกถูกขยายออกเพื่อเพิ่มความสามารถเพิ่มเติมสำหรับการสนับสนุนและการจัดการลักษณะการทำงาน ที่เกี่ยวข้องกับแค็ตตาล็อกการตลาดโดยตรงกับผู้บริโภคดั้งเดิม บริษัทโดยตรงกับผู้บริโภคมักจะผลิตแค็ตตาล็อกที่พิมพ์ ซึ่งจากนั้นจะถูกส่งไปยังลูกค้าอย่างน้อยหนึ่งเซ็กเมนต์ โดยทั่วไป แค็ตตาล็อกเหล่านี้จะมีโปรโมชันหรือข้อเสนอเฉพาะที่จะได้รับการจ่ายเงิน ถ้าลูกค้าแสดงรหัสประจำตัวของแค็ตตาล็อกในขณะของการสร้างใบสั่ง 
...
ไปยัง **การขายปลีก** > **แค็ตตาล็อกและการจัดประเภท** > **แค็ตตาล็อกทั้งหมด** เพื่อตั้งค่าคอนฟิกแค็ตตาล็อกของคุณ

เมื่อคุณสร้างแค็ตตาล็อกใหม่ อันดับแรกคุณต้องลิงก์แค็ตตาล็อกไปยังช่องทางขายปลีกอย่างน้อยหนึ่งช่องทาง ซึ่งทำได้ในแท็บด่วน **ช่องทางการขายปลีก** บนแบบฟอร์ม **การตั้งค่าแค็ตตาล็อก** คลิก **เพิ่ม** และเลือกช่องทางการขายปลีกหนึ่งช่องทางขึ้นไป เฉพาะรายการที่เชื่อมโยงกับช่องทางเลือกของคุณ [การจัดประเภท](https://docs.microsoft.com/en-us/dynamics365/unified-operations/retail/assortments) สามารถถูกใช้ได้ เมื่อสร้างแค็ตตาล็อก

เมื่อต้องการเพิ่มผลิตภัณฑ์ไปยังแค็ตตาล็อก ลำดับชั้นการนำทางต้องถูกเลือก ลำดับชั้นการนำทางจะสนับสนุนโครงสร้างประเภทสำหรับแค็ตตาล็อก คุณต้องเลือกจากหนึ่งในลำดับชั้นการนำทางที่เชื่อมโยงกับช่องทางการขายปลีกที่เลือกบน FastTab **ช่องทางการขายปลีก** ของหน้า **แค็ตตาล็อก** หากมีการนำทางช่องทางไม่เชื่อมโยงกับช่องสัญญาณก่อนหน้านี้ ถ้าช่องทางการนำทางไม่ได้ถูกเชื่อมโยงกับช่องทางก่อนหน้านี้ ไปยัง **การขายปลีก** > **การตั้งค่าช่องทาง** > **ประเภทช่องทางและคุณลักษณะของผลิตภัณฑ์** เพื่อลิงก์ค่าเริ่มต้นลำดับชั้นการนำทางไปยังช่องทางการขายปลีกแต่ละช่องทางของคุณ
...
เมื่อต้องการตั้งค่าคอนฟิกราคาเฉพาะของแค็ตตาล็อก เลือกตัวเลือก **กลุ่มราคา** จากแท็บ **แค็ตตาล็อก** เพื่อเชื่อมโยงกลุ่มราคาหนึ่งรายการขึ้นไปกับแค็ตตาล็อก ข้อตกลงทางค้า สมุดรายวันการปรับปรุงราคา และส่วนลดขั้นสูงของการขายปลีกทั้งหมด (ขีดจำกัด ปริมาณ การคละกัน) ที่มีการเชื่อมโยงกับกลุ่มราคาเดียวกัน จะถูกนำไปใช้เมื่อลูกค้าสั่งจากแค็ตตาล็อกนี้
