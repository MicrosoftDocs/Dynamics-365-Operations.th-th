...
description: หัวข้อนี้อธิบายแนวคิดสำหรับการสร้างและการจัดการราคาขายใน Dynamics 365 Retail
...
ms.locfileid: "2934782"
---
# <a name="retail-sales-price-management"></a>การจัดการราคาขายของการขายปลีก

[!include [banner](includes/banner.md)]

หัวข้อนี้ให้ข้อมูลเกี่ยวกับกระบวนการของการสร้างและการจัดการราคาขายใน Dynamics 365 Retail ซึ่งมุ่งเน้นในแนวคิดที่เกี่ยวข้องในกระบวนการนี้ และผลกระทบของตัวเลือกการตั้งค่าคอนฟิกต่างๆ สำหรับราคาขาย
...
เมื่อเส้นประสีแดงในภาพประกอบแสดงขึ้น Retail จะสนับสนุนฟังก์ชัน Microsoft Dynamics 365 หลักของกลุ่มราคาที่ถูกตั้งค่าโดยตรงที่ลูกค้า อย่างไรก็ตาม ในกรณีนี้ คุณได้รับข้อตกลงทางการค้าราคาขายเท่านั้น ถ้าคุณต้องการใช้ราคาเฉพาะลูกค้า เราขอแนะนำให้คุณไม่ตั้งค่ากลุ่มราคาในลูกค้าโดยตรง คุณควรใช้สังกัดแทน
...
ราคาฐานและราคาข้อตกลงทางการค้าเป็นส่วนของ Microsoft Dynamics 365 หลัก และพร้อมใช้งาน ถึงแม้ว่าคุณจะไม่ใช้ Retail ฟังก์ชันการปรับปรุงราคาจะพร้อมใช้งานเฉพาะในการขายปลีก ส่วนต่อไปให้ข้อมูลเพิ่มเติมเกี่ยวกับตัวเลือกเหล่านี้แต่ละตัวเลือกสำหรับการตั้งค่าราคา และอธิบายวิธีทำงานร่วมกันของตัวเลือก
...
โดยใช้สมุดรายวันข้อตกลงทางการค้า คุณสามารถสร้างข้อตกลงทางการค้าของราคาขายสำหรับผลิตภัณฑ์แต่ละรายการได้ ใน Microsoft Dynamics 365 มีขอบเขตลูกค้าสามรายการสำหรับข้อตกลงทางการค้าของราคาขาย: **ตาราง** **กลุ่ม** และ **ทั้งหมด** ขอบเขตของลูกค้ากำหนดลูกค้าที่มีการใช้ข้อตกลงทางการค้าราคาขายที่กำหนด
...
กลไกการกำหนดราคาขายปลีก **ไม่สนับสนุน** คุณลักษณะการกำหนดราคาต่อไปนี้:

- ไม่สนับสนุนการตั้งค่าราคาตามมิติการจัดเก็บไซต์ หรือมิติการจัดเก็บไซต์และคลังสินค้า ถ้าคุณระบุเฉพาะมิติไซต์ในข้อตกลงทางการค้า การกำหนดราคาขายปลีกจะไม่สนใจไซต์และใช้ข้อตกลงทางการค้ากับไซต์ทั้งหมด ถ้าคุณระบุทั้งไซต์และคลังสินค้า ลักษณะการทำงานจะไม่ถูกกำหนด/ไม่ถูกทดสอบ เนื่องจากคาดว่าผู้ค้าปลีกใช้กลุ่มราคาร้านค้าเพื่อควบคุมราคาสำหรับร้านค้า/คลังสินค้าแต่ละแห่ง
- ไม่สนับสนุนการกำหนดราคาตามแอททริบิวต์
...
## <a name="pricing-api-enhancements"></a>การเพิ่มประสิทธิภาพของ API สำหรับการกำหนดราคา
...
ในรุ่นที่กำลังจะเกิดขึ้นของ Retail Application Programming Interface (API) ของ **GetActivePrices** จะส่งคืนราคาที่มีส่วนลดอย่างง่าย (ตัวอย่างเช่น ส่วนลดต่อรายการเดียวที่ไม่ขึ้นอยู่กับสินค้าอื่นๆ ในรถเข็น) ด้วยวิธีนี้ ราคาที่แสดงอยู่จะใกล้กับยอดเงินจริงที่ลูกค้าจะชำระให้กับสินค้า API นี้จะรวมส่วนลดอย่างง่ายทุกชนิด: ส่วนลดที่ยึดตามรายได้ ที่ยึดตามความภักดี ที่ยึดตามแค็ตตาล็อก และที่ยึดตามช่องทาง นอกจากนี้ API จะส่งคืนชื่อและข้อมูลที่มีผลบังคับใช้สำหรับส่วนลดที่ถูกใช้ เพื่อให้ร้านค้าปลีกสามารถให้คำอธิบายโดยละเอียดเพิ่มเติมเกี่ยวกับราคา และสร้างความรู้สึกของการเร่งด่วน ถ้าการมีผลบังคับใช้ของส่วนลดจะหมดอายุในไม่ช้า
