...
ms.locfileid: "1594081"
---
# <a name="retail-sales-price-management"></a>การจัดการราคาขายของการขายปลีก

[!include [banner](includes/banner.md)]

หัวข้อนี้ให้ข้อมูลเกี่ยวกับกระบวนการของการสร้างและการจัดการราคาขายใน Microsoft Dynamics 365 for Retail ซึ่งมุ่งเน้นในแนวคิดที่เกี่ยวข้องในกระบวนการนี้ และผลกระทบของตัวเลือกการตั้งค่าคอนฟิกต่างๆ สำหรับราคาขาย
...
ราคาเป็นหนึ่งในปัจจัยที่สำคัญที่สุดซึ่งควบคุมการตัดสินใจซื้อของลูกค้าหลายราย และลูกค้าหลายรายเปรียบเทียบราคาในไซต์ต่างๆ ก่อนที่พวกเขาจะทำการซื้อ เพื่อให้มั่นใจว่าพวกเขาจะให้ราคาเชิงกลยุทธ์ ร้านค้าปลีกต้องคอยเฝ้าดูคู่แข่งของพวกเขาและรันโปรโมชั่นบ่อยๆ ดังนั้น เพื่อช่วยให้ร้านค้าปลีกเหล่านี้ดึงดูดลูกค้า จึงเป็นเรื่องสำคัญมากที่การค้นหาผลิตภัณฑ์ คุณลักษณะของการเรียกดู รายการ และหน้ารายละเอียดของผลิตภัณฑ์ จะแสดงราคาที่ถูกต้องมากที่สุด
