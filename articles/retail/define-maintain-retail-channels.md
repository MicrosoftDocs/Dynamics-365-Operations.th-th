...
11. ตั้งค่าพนักงาน
    ...
    > [!NOTE]
    > นอกจากนี้ คุณต้องกำหนดสิทธิ์ที่เหมาะสมให้กับผู้ปฏิบัติงาน เพื่อให้พวกเขาสามารถลงชื่อเข้าใช้และทำงานได้โดยใช้ Dynamics 365 for Retail สำหรับระบบ Retail POS
