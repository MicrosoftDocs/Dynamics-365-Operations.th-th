...
Windows, iOS และ Android ยังอนุญาตให้เปิดของแอปได้อย่างราบรื่นมากขึ้น ตามการเชื่อมโยงโพรโทคอลของแอป ถ้าแอปของคุณไม่ได้ถูกตั้งค่าคอนฟิกเพื่อจัดการเปิดจากเว็บเบราเซอร์อยู่แล้ว คุณอาจต้องการนักพัฒนาเพื่อตั้งค่าคอนฟิกนี้
...
- สำหรับ Android ดู [ลิงค์การจัดการแอป Android](https://developer.android.com/training/app-links/)
...
| Modern POS ใน Android | ✓\*                | ✓               | X              | \* เปิดในแท็บเบราเซอร์ใหม่        |
...
1. ในสำนักงานใหญ่ ไปที่ **การขายปลีก \> การตั้งค่าช่องทาง \> การตั้งค่า POS \> POS \> โครงร่างหน้าจอ**
