...
ใน Microsoft Dynamics 365 for Retail กระบวนการลงรายการบัญชีใบแจ้งยอดถูกใช้ไปยังลูกค้าองค์กรสำหรับธุรกรรมที่เกิดขึ้นใน Cloud point of sale (POS) หรือ Modern POS (MPOS) กระบวนการลงรายการบัญชีใบแจ้งยอดจะใช้กำหนดการกระจายในการดึงชุดธุรกรรม POS ไปยังไคลเอนต์สำนักงานใหญ่ (HQ) พารามิเตอร์ที่กำหนดไว้ในหน้า **พารามิเตอร์การขายปลีก** และ **ร้านค้า** จะใช้เพื่อเลือกธุรกรรมที่จะดึงไปยังใบแจ้งยอดแต่ละรายการ
...
- การขายแบบ Retail ที่ซึ่งลูกค้าถูกเพิ่มไปยังธุรกรรมใน Microsoft Dynamics 365 for Retail POS สร้างใบสั่งขายที่แยกต่างหากและใบแจ้งหนี้ รายการหนึ่งสำหรับลูกค้าที่ไม่ซ้ำกันแต่ละราย
