...
สำหรับข้อมูลเกี่ยวกับวัตถุประสงค์ของตัวเลือกเหล่านี้ที่เหลือ ดู [ภาพรวมของเค้าร่างการค้นหาใน SharePoint Server 2013](https://technet.microsoft.com/library/jj219669.aspx)
