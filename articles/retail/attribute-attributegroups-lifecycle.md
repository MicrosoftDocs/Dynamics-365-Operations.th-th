...
การตั้งค่าตัวกรองสำหรับแอททริบิวต์ช่วยให้คุณสามารถกำหนดวิธีการแสดงตัวกรองสำหรับแอททริบิวต์ใน retail POS ในการเข้าถึงการตั้งค่าตัวกรองสำหรับแอททริบิวต์ บนเพจ **แอททริบิวต์** เลือกแอททริบิวต์ และจากนั้น บนบานหน้าต่างการดำเนินการ เลือก **การตั้งค่าตัวกรอง**
...
6. บน FastTab ต่อไปนี้ อัพเดตค่าของแอททริบิวต์ที่จำเป็น:
    ...
    > [!NOTE]
    > ถ้ามีการสร้างสื่อผลิตภัณฑ์ที่ใช้ร่วมกัน และคุณลักษณะของผลิตภัณฑ์ที่ใช้ร่วมกัน จะมีการนำไปใช้กับผลิตภัณฑ์ขายปลีกทั้งหมด
