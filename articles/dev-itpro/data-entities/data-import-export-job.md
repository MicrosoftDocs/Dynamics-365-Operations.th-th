...
> [!NOTE]
> งานการนำเข้าหรือการส่งออกสามารถรันแบบอะซิงโครนัสได้โดยการเลือกปุ่ม **นำเข้า** หรือ **ส่งออก** การรันแบบอะซิงโครนัสใช้กรอบงานแบบอะซิงโครนัสใน Finance and Operations ซึ่งจะแตกต่างจากกรอบงานชุดงาน อย่างไรก็ตาม เช่นเดียวกับกรอบงานชุดงาน กรอบงานแบบอะซิงโครนัสยังสามารถผ่านการควบคุมปริมาณได้ด้วย และดังนั้น งานอาจไม่ได้ดำเนินการในทันที งานยังสามารถถูกรันแบบซิงโครนัสได้โดยเลือก **นำเข้าเดี๋ยวนี้** หรือ **ส่งออกเดี๋ยวนี้** การดำเนินการนี้เริ่มต้นงานโดยทันที และจะมีประโยชน์ ถ้าแบบอะซิงโครนัสหรือชุดงานไม่ได้เริ่มต้นเนื่องจากการควบคุมปริมาณ นอกจากนี้ ยังสามารถดำเนินงานในชุดงานโดยการเลือกตัวเลือก **รันในชุดงาน** ได้ด้วย ทรัพยากรชุดงานขึ้นอยู่กับการควบคุมปริมาณ ดังนั้น ชุดงานจึงไม่อาจเริ่มต้นได้โดยทันที ตัวเลือกแบบอะซิงโครนัสมีประโยชน์ เมื่อผู้ใช้โต้ตอบกับส่วนติดต่อผู้ใช้โดยตรง และไม่ใช่ผู้ใช้ขั้นสูงเพื่อให้เข้าใจถึงการจัดกำหนดการชุดงาน การใช้ชุดงานคือตัวเลือกสำรอง ถ้าจำเป็นต้องส่งออกหรือนำเข้าจำนวนมาก สามารถจัดกำหนดการชุดงานเพื่อรันในกลุ่มชุดงานเฉพาะ ซึ่งอนุญาตการควบคุมเพิ่มเติมจากมุมมองที่สร้างสมดุลในการโหลด ถ้าแบบอะซิงโครนัสและชุดงานทั้งสองนั้นผ่านการควบคุมปริมาณเนื่องจากการใช้ประโยชน์ทรัพยากรสูงบนระบบ จากนั้น เนื่องจากการแก้ปัญหาในทันที สามารถใช้รุ่นแบบซิงโครนัสของการนำเข้า/การส่งออกได้ ตัวเลือกแบบซิงโครนัสจะเริ่มต้นในทันที และจะบล็อคส่วนติดต่อผู้ใช้เนื่องจากการดำเนินการแบบซิงโครนัส หน้าต่างเบราเซอร์ต้องยังคงเปิด เมื่ออยู่ในระหว่างดำเนินการแบบซิงโครนัส
...
การทำงานต้องเปิดใช้งานในการจัดการลักษณะการทำงาน จากนั้นคุณจึงสามารถเข้าถึงได้จาก **การจัดการข้อมูล \> การล้างข้อมูลประวัติงาน**
...
-   **จำนวนของชั่วโมงในการดำเนินงาน** – โดยขึ้นอยู่กับจำนวนของประวัติที่จะถูกล้างข้อมูล เวลาการดำเนินการทั้งหมดสำหรับงานการล้างข้อมูลอาจแตกต่างกันไปตั้งแต่สองสามนาทีถึงสองสามชั่วโมง เนื่องจากการล้างข้อมูลของตารางดังกล่าวต้องทำเมื่อไม่มีกิจกรรมการจัดการข้อมูลอื่นๆ ในระบบ จึงกลายเป็นสิ่งสำคัญเพื่อให้แน่ใจว่างานการล้างข้อมูลดำเนินการและเสร็จสิ้นก่อนที่จะเริ่มกิจกรรมทางธุรกิจ
