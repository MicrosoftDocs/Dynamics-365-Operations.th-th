...
ในการนำเข้าข้อมูลจากไฟล์ขาเข้าโดยใช้กรอบงานการรายงานทางอิเล็กทรอนิกส์ (ER) คุณต้องตั้งค่าคอนฟิกรูปแบบ ER ที่สนับสนุนการนำเข้า แล้วจากนั้น รันการแม็ปแบบจำลองของชนิด **ปลายทาง** ที่ใช้รูปแบบนั้นเป็นแหล่งข้อมูล ในการนำเข้าข้อมูล คุณต้องนำทางไปยังไฟล์ที่คุณต้องการนำเข้า สามารถเลือกไฟล์ขาเข้าได้ด้วยตนเองโดยผู้ใช้ ด้วยความสามารถ ER ใหม่ในการสนับสนุนข้อมูลการนำเข้าจาก Microsoft SharePoint กระบวนการนี้สามารถถูกตั้งค่าคอนฟิกให้เป็นแบบอัตโนมัติได้ คุณสามารถใช้การตั้งค่าคอนฟิก ER เพื่อดำเนินการนำเข้าข้อมูลจากไฟล์ที่ถูกจัดเก็บในโฟลเดอร์ Microsoft SharePoint ได้ หัวข้อนี้อธิบายวิธีการนำเข้าจาก SharePoint ไปยัง Microsoft Dynamics 365 for Finance and Operations ให้เสร็จสมบูรณ์ ตัวอย่างใช้ธุรกรรมผู้จัดจำหน่ายเป็นข้อมูลธุรกิจ
...
เล่นคู่มืองาน **ER นำเข้าข้อมูลจากไฟล์ Microsoft Excel** ซึ่งเป็นส่วนหนึ่งของกระบวนการทางธุรกิจ **7.5.4.3 IT จัดหา/พัฒนาส่วนประกอบของบริการ/โซลูชันด้านไอที (10677)** คู่มืองานเหล่านี้อธิบายคุณเกี่ยวกับกระบวนการในการออกแบบ และการใช้การตั้งค่าคอนฟิก ER เพื่อนำเข้าธุรกรรมผู้จัดจำหน่ายในเชิงโต้ตอบจากไฟล์ Microsoft Excel สำหรับข้อมูลเพิ่มเติม ดู [แยกวิเคราะห์เอกสารขาเข้าใน Microsoft Excel](parse-incoming-documents-excel.md) หลังจากที่คุณเสร็จสิ้นคู่มืองาน คุณจะมีตั้งค่าต่อไปนี้
...
## <a name="configure-access-to-sharepoint-for-file-storage"></a>ตั้งค่าคอนฟิกการเข้าถึง SharePoint สำหรับหน่วยจัดเก็บไฟล์
ในการจัดเก็บไฟล์การรายงานทางอิเล็กทรอนิกส์ในตำแหน่งที่ตั้ง SharePoint คุณต้องตั้งค่าคอนฟิกการเข้าถึงอินสแตนซ์ของเซิร์ฟเวอร์ SharePoint ที่จะใช้โดยบริษัทปัจจุบัน ในตัวอย่างนี้ บริษัทคือ USMF สำหรับคำแนะนำ ดู [ตั้งค่าคอนฟิกที่จัดเก็บ SharePoint](../../fin-and-ops/organization-administration/configure-document-management.md#configure-sharepoint-storage)

1. ทำตามขั้นตอนให้เสร็จสมบูรณ์ใน [ตั้งค่าคอนฟิกที่จัดเก็บ SharePoint](../../fin-and-ops/organization-administration/configure-document-management.md#configure-sharepoint-storage)
2. เปิดไซต์ SharePoint ที่มีการตั้งค่าคอนฟิก
...
4. ใน Finance and Operations ไปที่ **การจัดการองค์กร > การจัดการเอกสาร > ชนิดเอกสาร**
5. สร้างชนิดเอกสารต่อไปนี้ที่จะใช้ในการเข้าถึงโฟลเดอร์ SharePoint ที่คุณเพิ่งสร้างขึ้น สำหรับคำแนะนำ ดู [ตั้งค่าคอนฟิกชนิดเอกสาร](../../fin-and-ops/organization-administration/configure-document-management.md#configure-document-types)
...
5. เลือกโฟลเดอร์ SharePoint ทั้งหมดที่คุณสร้างไว้ก่อนหน้านี้
...
2. ใน Finance and Operations บนหน้า **สถานะของไฟล์สำหรับแหล่งที่มา** เลือก **รีเฟรช** เพื่อรีเฟรชหน้า หมายเหตุ ไฟล์ Excel ที่ถูกอัพโหลดไปยัง SharePoint ปรากฏขึ้นบนหน้านี้โดยมีสถานะ **พร้อม** สถานะต่อไปนี้ได้รับการสนับสนุนในขณะนี้:
...
3. เลือก **รัน** เพื่อรันการแม็ปแบบจำลองที่เลือก เนื่องจากคุณตั้งค่าคอนฟิกแหล่งที่มาของไฟล์สำหรับรูปแบบ ER คุณสามารถเปลี่ยนการตั้งค่าของตัวเลือก **แหล่งที่มาของไฟล์** ได้ หากจำเป็น ถ้าคุณรักษาการตั้งค่าของตัวเลือกนี้ ไฟล์ .xslx จะถูกนำเข้าจากแหล่งข้อมูลที่ตั้งค่าคอนฟิก (โฟลเดอร์ SharePoint ในตัวอย่างนี้)
...
4. การแม็ปแบบจำลองสามารถรันแบบอัตโนมัติได้ในโหมดชุดงาน ในกรณีนี้ ทุกครั้งที่ชุดงานรันในรูปแบบ ER นี้ ไฟล์เดียวจะถูกนำเข้าจากแหล่งที่มาของไฟล์ที่ตั้งค่าคอนฟิก

    เมื่อไฟล์ถูกนำเข้าเสร็จเรียบร้อยแล้วจากโฟลเดอร์ SharePoint จะมีการลบออกจากโฟลเดอร์นั้น และย้ายไปยังโฟลเดอร์สำหรับไฟล์ที่นำเข้าเสร็จเรียบร้อยแล้ว หรือไปยังโฟลเดอร์ไปที่ไฟล์ที่นำเข้าโดยมีคำเตือน มิฉะนั้น จะมีการย้ายไปยังโฟลเดอร์สำหรับไฟล์ที่ล้มเหลว หรือยังคงอยู่ในโฟลเดอร์นี้ ถ้าไม่ได้ติดตั้งโฟลเดอร์สำหรับไฟล์ที่ล้มเหลว 
...
9. ป้อนรหัสใบสำคัญ เช่น **V-00002** และจากนั้น เลือก **ตกลง**
    ...
    หมายเหตุ Infolog ประกอบด้วยการแจ้งเตือนว่า มีไฟล์อยู่ในโฟลเดอร์ SharePoint ซึ่งประกอบด้วยบัญชีผู้จัดจำหน่ายที่ไม่ถูกต้อง และไม่สามารถนำเข้าได้
...
10. ในหน้า **สถานะของไฟล์สำหรับแหล่งที่มา** เลือก **รีเฟรช** และจากนั้น ในส่วน **ไฟล์** ตรวจทานรายการของไฟล์
   ...
   ส่วน **ล็อกแหล่งที่มาสำหรับรูปแบบการนำเข้า** บ่งชี้ว่ากระบวนการนำเข้าล้มเหลว และไฟล์อยู่ในโฟลเดอร์ SharePoint ข้อผิดพลาดของไฟล์ (ไม่มีการเลือกกล่องกาเครื่องหมาย **ถูกลบ** ) ถ้าคุณแก้ไขไฟล์นี้บน SharePoint ด้วยการเพิ่มรหัสผู้จัดจำหน่ายที่เหมาะสม แล้วจึงย้ายไปยังโฟลเดอร์ SharePoint ต้นทาง (หลัก) ของการนำเข้าไฟล์ คุณสามารถนำเข้าไฟล์ได้อีกครั้ง

11. ใน Finance and Operations เลือก **บัญชีเจ้าหนี้** \> **งานประจำงวด** \> **ภาษี 1099** \> **การชำระเงินของผู้จัดจำหน่ายสำหรับ 1099** ป้อนค่าที่ถูกต้องในฟิลด์ **วันที่เริ่มต้น** และ **วันที่สิ้นสุด** และจากนั้นเลือก **ธุรกรรม 1099 แบบกำหนดเอง**
