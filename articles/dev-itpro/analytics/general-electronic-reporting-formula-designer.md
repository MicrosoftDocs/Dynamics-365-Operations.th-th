...
-   ข้อมูลที่เปลี่ยนแปลงที่ได้รับมาจากฐานข้อมูลของ Microsoft Dynamics 365 สำหรับการเงินและการดำเนินงาน และที่ควรถูกเติมในแบบจำลองข้อมูล ER ซึ่งมีวัตถุประสงค์เพื่อใช้เป็นแหล่งข้อมูลสำหรับรูปแบบ ER (การกรอง การจัดกลุ่ม การแปลงชนิดข้อมูล เป็นต้น)
...
-   จากแหล่งข้อมูลของการเงินและการดำเนินงานและพารามิเตอร์เวลาการดำเนินงาน จนถึงแบบจำลองข้อมูล ER
-   จากแบบจำลองข้อมูล ER เป็นรูปแบบ ER
-   จากแหล่งข้อมูลของการเงินและการดำเนินงานและพารามิเตอร์เวลาการดำเนินงาน จนถึงรูปแบบ ER

ภาพต่อไปนี้แสดงการออกแบบนิพจน์ชนิดนี้ ในตัวอย่างนี้ นิพจน์ส่งคืนค่าของฟิลด์ **Intrastat.AmountMST** ของตาราง **อินทราสแทต** ของการเงินและการดำเนินงาน หลังจากที่ค่าถูกปัดเศษเป็นทศนิยมสองตำแหน่ง [![picture-expression-binding](./media/picture-expression-binding.jpg)](./media/picture-expression-binding.jpg) ภาพประกอบต่อไปนี้แสดงวิธีการใช้นิพจน์ชนิดนี้ ในตัวอย่างนี้ ผลลัพธ์ของนิพจน์ที่ได้รับการออกแบบจะถูกเก็บไว้ในส่วนประกอบ **Transaction.InvoicedAmount** ของแบบจำลองข้อมูล **แบบจำลองการรายงานภาษี** [![picture-expression-binding2](./media/picture-expression-binding2.jpg)](./media/picture-expression-binding2.jpg) ระหว่างดำเนินการ สูตรที่ออกแบบ **ปัด (Intrastat.AmountMST, 2)** จะปัดเศษค่าของ **AmountMST** สำหรับแต่ละเรกคอร์ดของ **อินทราสแทต** เป็นตารางทศนิยมสองตำแหน่ง และปัดเศษค่าเป็น **Transaction.InvoicedAmount** ส่วนประกอบของแบบจำลองข้อมูล **การรายงานภาษี**
...
โปรดทราบว่า มีการใช้ไวยากรณ์ต่อไปนี้ในการเรียกวิธีการ Dynamics 365 สำหรับแหล่งข้อมูลการดำเนินงานที่มีพารามิเตอร์:

- วิธี isLanguageRTL ของแหล่งข้อมูลระบบที่มี EN-US พารามิเตอร์ของชนิดข้อมูลแบบสตริง ต้องถูกอ้างอิงถึงในนิพจน์ ER ดังต่อไปนี้: System.'isLanguageRTL'("EN-US")
- เครื่องหมายอัญประกาศไม่จำเป็น เมื่อชื่อของวิธีการประกอบด้วยสัญลักษณ์ที่เป็นอักษรและตัวเลขเท่านั้น จะจำเป็นสำหรับวิธีการตาราง เมื่อชื่อประกอบด้วยวงเล็บ

เมื่อมีการเพิ่มแหล่งข้อมูลของระบบไปยังการแมป ER ซึ่งอ้างถึง Dynamics 365 สำหรับคลาสแอพลิเคชันการดำเนินการสากล นิพจน์ส่งคืนค่าบูลีนเป็น เท็จ นิพจน์ที่ปรับเปลี่ยนแล้ว System.’ isLanguageRTL'("AR") ส่งกลับค่าบูลีนเป็น จริง

หมายเหตุว่า สามารถกำหนดการผ่านพารามิเตอร์วิธีการดังกล่าวได้โดยมีข้อจำกัดต่อไปนี้:

- ค่าคงเท่านั้นที่สามารถส่งผ่านไปยังวิธีการดังกล่าว ค่าจะถูกกำหนดในขณะออกแบบ
- ชนิดข้อมูล (พื้นฐาน) ดั้งเดิมเท่านั้น จะได้รับการสนับสนุนสำหรับพารามิเตอร์ดังกล่าว (จำนวนเต็ม จำนวนจริง บูลีน สตริง เป็นต้น)
...
| DATETODATETIME (วัน)                      | แปลงค่าวันที่ที่ระบุเป็นค่าวันที่และเวลา                                                                                                                                                                                                                                                                                                            | **DATETODATETIME (CompInfo ' getCurrentDate()')** คืนวันที่รอบเวลาการเงินและการดำเนินการปัจจุบัน 24/12/2558 เป็น **24/12/2558 12:00:00 น.** ในตัวอย่างนี้ **CompInfo** เป็นแหล่งข้อมูล ER ของชนิด **การเงินและการดำเนินการ/ตาราง** ที่อ้างอิงถึงตาราง CompanyInfo |
| NOW ()                                     | ส่งคืนวันที่และเวลาของเซิร์ฟเวอร์แอพลิเคชันการเงินและการดำเนินการปัจจุบัน เป็นค่าวันที่และเวลา                                                                                                                                                                                                                                                             |                                                                                                                                                                                                                                                                                                       |
...
| DATETIMEFORMAT (วันที่เวลา รูปแบบ)          | แปลงค่าวันที่และเวลาที่ระบุเป็นสตริงในรูปแบบที่ระบุ (สำหรับข้อมูลเกี่ยวกับรูปแบบที่สนับสนุน ดู [มาตรฐาน](https://msdn.microsoft.com/en-us/library/az4se3k1(v=vs.110).aspx) และ [กำหนดเอง](https://msdn.microsoft.com/en-us/library/8kb3ddd4(v=vs.110).aspx))                                                                        | **DATETIMEFORMAT (NOW(), "dd-MM-yyyy")** ส่งคืนวันที่ของเซิร์ฟเวอร์แอพลิเคชันการเงินและการดำเนินการปัจจุบัน 24/12/2558 เป็น **"24/12/2558"** ตามรูปแบบกำหนดเองที่ระบุไว้                                                                                                          |
| DATETIMEFORMAT (วันที่เวลา รูปแบบ วัฒนธรรม) | แปลงค่าวันที่และเวลาที่ระบุเป็นสตริงในรูปแบบที่ระบุและ [วัฒนธรรม](https://msdn.microsoft.com/en-us/goglobal/bb896001.aspx) (สำหรับข้อมูลเกี่ยวกับรูปแบบที่สนับสนุน ดู [มาตรฐาน](https://msdn.microsoft.com/en-us/library/az4se3k1(v=vs.110).aspx) และ [กำหนดเอง](https://msdn.microsoft.com/en-us/library/8kb3ddd4(v=vs.110).aspx)) | **DATETIMEFORMAT (NOW(), "d", "de")** ส่งคืนวันที่ของเซิร์ฟเวอร์แอพลิเคชันการเงินและการดำเนินการปัจจุบัน 24/12/2558 เป็น **"24/12/2558"** ตามรูปแบบภาษาเยอรมันที่เลือก                                                                                                             |
| SESSIONTODAY ()                            | ส่งคืนวันที่ของเซิร์ฟเวอร์แอพลิเคชันการเงินและการดำเนินการปัจจุบัน เป็นค่าวันที่                                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                                       |
...
|--------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| DATETODATETIME (วัน)                 | แปลงค่าวันที่ที่ระบุเป็นค่าวันที่และเวลา           | **DATETODATETIME (CompInfo ' getCurrentDate()')** คืนวันที่รอบเวลาการเงินและการดำเนินการปัจจุบัน 24/12/2558 เป็น **24/12/2558 12:00:00 น.** ในตัวอย่างนี้ **CompInfo** เป็นแหล่งข้อมูล ER ของชนิด **การเงินและการดำเนินการ/ตาราง** ที่อ้างอิงถึงตาราง **CompanyInfo**                                                                                                                       |
| DATEVALUE (สตริง, รูปแบบ)              | ส่งคืนการแสดงวันที่ของสตริงโดยใช้รูปแบบที่ระบุ       | **DATEVALUE ("21-Dec-2016", "dd-MMM-yyyy")** ส่งกลับค่าวันที่ 21/12/2559 ตามรูปแบบที่กำหนดเองที่ระบุและรูปแบบภาษา **EN-US** ของแอพลิเคชันเริ่มต้น                                                                                                                       |
| DATEVALUE (สตริง, รูปแบบ, รูปแบบภาษา)              | ส่งคืนการแสดงวันที่ของสตริงโดยใช้รูปแบบและรูปแบบภาษาที่ระบุ       | **DATEVALUE ("21-Gen-2016", "dd-MMM-yyyy", "IT")** ส่งกลับวัน 21/01/2559 ตามรูปแบบภาษาและรูปแบบกำหนดเองที่ระบุ จะมีการแสดงข้อยกเว้นสำหรับการเรียกฟังก์ชันนี้ **DATEVALUE ("21-Gen-2016", "dd-MMM-yyyy", "EN-US")** ซึ่งแจ้งให้ทราบว่า สตริงที่กำหนดให้ไม่ได้รับรู้เป็นวันที่ถูกต้อง                                                                                                                       |
| DATETIMEVALUE (สตริง, รูปแบบ)              | ส่งคืนการแสดงเวลาและวันที่ของสตริงโดยใช้รูปแบบที่ระบุ       | **DATETIMEVALUE ("21-ธ.ค.-2559 02:55:00" "dd-MMM-yyyy hh:mm:ss")** ส่งคืน 2:55:00 น.ของวันที่ 21 ธ.ค. 2559 ตามรูปแบบกำหนดเองที่ระบุและรูปแบบภาษา **EN-US** ของแอพลิเคชันเริ่มต้น                                                                                                                       |
| DATETIMEVALUE (สตริง, รูปแบบ, รูปแบบภาษา)              | ส่งคืนการแสดงเวลาและวันที่ของสตริงโดยใช้รูปแบบและรูปแบบภาษาที่ระบุ       | **DATETIMEVALUE ("21-Gen-2016 02:55:00", "dd-MMM-yyyy hh:mm:ss", “IT”)** ส่งคืน 2:55:00 น.ของวันที่ 21 ธ.ค. 2559 ตามรูปแบบกำหนดเองที่ระบุและรูปแบบภาษา จะมีการแสดงข้อยกเว้นสำหรับการเรียกฟังก์ชันนี้ **DATETIMEVALUE ("21-Gen-2016 02:55:00", "dd-MMM-yyyy hh:mm:ss", “EN-US”)** ซึ่งแจ้งให้ทราบว่า สตริงที่กำหนดให้ไม่ได้รับรู้เป็นเวลาและวันที่ที่ถูกต้อง                                                                                                                       |
...
| ฟังก์ชัน             | คำอธิบาย                                                                                                                                                                                                                                     | ตัวอย่าง                                                                                                                                             |
|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| ค่า (สตริง) | แปลงสายอักขระที่ระบุเป็นตัวเลข เครื่องหมายจุลภาคและอักขระจุด (.) ถือเป็นตัวแบ่งทศนิยม และยุติภังค์นำหน้า (-) จะถูกใช้เป็นเครื่องหมายลบ ถ้าพบอักขระอื่น ๆ ที่ไม่ใช่ตัวเลขในสตริงที่ระบุ ข้อผิดพลาดจะปรากฏ                                                                                  | **ค่า ("1 234,56")** แสดงข้อยกเว้น   |
| ค่าหมายเลข (สตริง ตัวแบ่งทศนิยม ตัวแบ่งการจัดกลุ่มตัวเลข) | แปลงสายอักขระที่ระบุเป็นตัวเลข ใช้เพื่อแยกจำนวนเต็มและเศษส่วนของจำนวนทศนิยม และหน่วยพันที่ระบุใช้สัญลักษณ์ตัวคั่น                                                                                  | **ค่าหมายเลข ("1 234,56" "" ")** ส่งกลับค่า **1234.56**    |
| INTVALUE (สตริง) | ส่งกลับการแสดงจำนวนเต็มของสตริง ส่วนทศนิยมที่พร้อมใช้งานใด ๆ จะถูกตัดออก                                                                                  | **INTVALUE ("100.77")** ส่งกลับค่า **100** |
| INTVALUE (ตัวเลข) | ส่งกลับการแสดงจำนวนเต็มของตัวเลข ส่วนทศนิยมที่พร้อมใช้งานใด ๆ จะถูกตัดออก                                                                                  | **INTVALUE (-100.77)** ส่งกลับค่า **-100** |
| INT64VALUE (สตริง) | ส่งกลับการแสดง int64 ของสตริง ส่วนทศนิยมที่พร้อมใช้งานใด ๆ จะถูกตัดออก                                                                                  | **INT64VALUE (“22565422744”)** ส่งคืน **22565422744** |
| INT64VALUE (หมายเลข) | ส่งกลับการแสดง int64 ของตัวเลข ส่วนทศนิยมที่พร้อมใช้งานใด ๆ จะถูกตัดออก                                                                                  | **INT64VALUE (22565422744.00)** ส่งคืน **22565422744** |
...
<tr class="odd">
<td>TEXT (ข้อมูล)</td>
<td>ส่งคืนข้อมูลป้อนเข้าที่ระบุ ซึ่งจะถูกแปลงเป็นสตริงข้อความที่ถูกจัดรูปแบบ ตามการตั้งค่าตำแหน่งที่ตั้งของเซิร์ฟเวอร์ของอินสแตนซ์การเงินและการดำเนินการปัจจุบัน สำหรับค่าชนิด <strong>จริง</strong> การแปลงสตริงจะถูกจำกัดเป็นทศนิยมสองตำแหน่ง</td>
<td>ถ้าตำแหน่งที่ตั้งของเซิร์ฟเวอร์ของอินสแตนซ์การเงินและการดำเนินการ ถูกกำหนดเป็น <strong>EN-US</strong> <strong>TEXT (NOW ())</strong>  จะส่งคืนวันที่รอบเวลาของการเงินและการดำเนินการปัจจุบัน 17/12/2558 เป็นสตริงข้อความ <strong>&quot;17/12/2558 07:59:23 น.&quot;</strong> <strong>TEXT (1/3)</strong> ส่งกลับค่า <strong>&quot;0.33&quot;</strong></td>
</tr>
<tr class="even">
...
นี่คือสูตรที่สามารถออกแบบ: รูปแบบ (CONCATENATE (@&quot;SYS70894&quot;, &quot; &quot;, @&quot;SYS18389&quot;), แบบจำลอง Customer.Name, DATETIMEFORMAT (แบบจำลอง ProcessingDate, &quot;d&quot;)) ถ้ามีการรายงานการประมวลผลสำหรับ <strong>ลูกค้าขายปลีก Litware</strong> เมื่อ 17 ธันวาคม 2015 ในวัฒนธรรม <strong>EN-US</strong> และภาษา <strong>EN-US</strong> สูตรนี้ต่อไปนี้ส่งคืนข้อความต่อไปนี้ ซึ่งสามารถแสดงเป็นข้อความข้อยกเว้นสำหรับผู้ใช้: &quot;ไม่มีสิ่งที่จะพิมพ์ Customer Litware Retail ถูกระงับเมื่อ 17/12/2558&quot; ถ้ารายงานเดียวกันถูกประมวลผลสำหรับ<strong> Litware Retail customer</strong> เมื่อ 17 ธันวาคม 2015 ในรูปแบบภาษา <strong>DE</strong> และภาษา <strong>DE</strong> สูตรนี้จะคืนค่าข้อความต่อไปนี้ ซึ่งใช้รูปแบบวันที่ที่แตกต่างกัน: &quot;Nichts zu drucken Debitor 'Litware Retail' wird für 17.12.2015 gesperrt&quot; <strong>หมายเหตุ:</strong> ไวยากรณ์ต่อไปนี้จะถูกใช้ในสูตร ER สำหรับป้ายชื่อ:
<ul>
...
<a href="./media/ER-data-model-enumeration-values.PNG"><img src="./media/ER-data-model-enumeration-values.PNG" alt="Available values for data model enumeration" class="alignnone wp-image-290681 size-full" width="397" height="136" /></a> ตัวอย่างต่อไปนี้แสดง:
<ul><li>การแจงนับแบบจำลอง <strong>ReportDirection</strong> ที่ถูกแทรกลงในรายงาน ให้เป็นแหล่งข้อมูล <strong>$Direction</strong></li>
<li>นิพจน์ ER <strong>$IsArrivals</strong> ถูกออกแบบมาเพื่อใช้การแจงนับแบบจำลองให้เป็นพารามิเตอร์ของฟังก์ชันนี้ ค่าของนิพจน์นี้คือ <strong>จริง</strong>
...
| ฟังก์ชัน             | คำอธิบาย                                                                                                                                                                                                                                     | ตัวอย่าง                                                                                                                                             |
|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| TEXT (ข้อมูล) | ส่งคืนข้อมูลป้อนเข้าที่ระบุ ซึ่งจะถูกแปลงเป็นสตริงข้อความที่ถูกจัดรูปแบบ ตามการตั้งค่าตำแหน่งที่ตั้งของเซิร์ฟเวอร์ของอินสแตนซ์การเงินและการดำเนินการปัจจุบัน
สำหรับค่าชนิด จริง การแปลงสตริงจะถูกจำกัดเป็นทศนิยมสองตำแหน่ง| ถ้าตำแหน่งที่ตั้งของเซิร์ฟเวอร์ของอินสแตนซ์การเงินและการดำเนินการ ถูกกำหนดเป็น **EN-US, TEXT (NOW ())** วันที่รอบเวลาของการเงินและการดำเนินการปัจจุบัน 17/12/2558 จะถูกส่งคืนเป็นสตริงข้อความ **"17/12/2558 07:59:23 น."**
**TEXT (1/3) ส่งคืน "0.33"** |
| QRCODE (สตริง) | แสดงรูปภาพคิวอาร์โค้ดในรูปแบบฐานสอง base64 สำหรับสตริงที่ระบุ | **QRCODE ("ข้อความตัวอย่าง")** ส่งกลับค่า **U2FtcGxlIHRleHQ =**   |

### <a name="data-collection-functions"></a>ฟังก์ชันการรวบรวมข้อมูล

| ฟังก์ชัน             | คำอธิบาย                                                                                                                                                                                                                                     | ตัวอย่าง                                                                                                                                             |
|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| FORMATELEMENTNAME () | ส่งคืนชื่อขององค์ประกอบของรูปแบบปัจจุบัน ส่งคืนสตริงที่ว่างเมื่อแฟล็ก **รวมบรวมรายละเอียดผลลัพธ์** ของไฟล์ปัจจุบันถูกปิด| อ้างอิงถึง **ER ใช้ข้อมูลของผลลัพธ์รูปแบบสำหรับการตรวจนับและการรวม** (ส่วนหนึ่งของกระบวนการทางธุรกิจ **ส่วนประกอบ Acquire/Develop IT service/solution**) คู่มืองานเพื่อเรียนรู้ข้อมูลเพิ่มเติมเกี่ยวกับการใช้ฟังก์ชันเหล่านี้ |
| SUMIFS (สตริงคีย์สำหรับการรวม, criteria range1 string, criteria value1 string \[, criteria range2 string, criteria value2 string, …\]) |ส่งคืนผลรวมของค่าของโหนด (ที่มีชื่อที่กำหนดไว้เป็นคีย์) ของ XML ซึ่งถูกรวบรวมในระหว่างการดำเนินการสำหรับรูปแบบนี้ และเป็นไปตามเงื่อนไขที่ป้อน (คู่ของช่วงและค่า) ส่งค่าเป็นศูนย์เมื่อแฟล็ก **รวมบรวมรายละเอียดผลลัพธ์**ของไฟล์ปัจจุบันถูกปิด |            |
| SUMIF (สตริงคีย์สำหรับการรวม สตริงช่วงเกณฑ์ สตริงค่าเกณฑ์) | ส่งคืนผลรวมของค่าของโหนด (ที่มีชื่อที่กำหนดไว้เป็นคีย์) ของ XML ซึ่งถูกรวบรวมในระหว่างการดำเนินการสำหรับรูปแบบนี้ และเป็นไปตามเงื่อนไขที่ป้อน (ช่วงและค่า) ส่งค่าเป็นศูนย์เมื่อแฟล็ก **รวมบรวมรายละเอียดผลลัพธ์**ของไฟล์ปัจจุบันถูกปิด|           |
| COUNTIFS (criteria range1 string, criteria value1 string \[, criteria range2 string, criteria value2 string, …\]) | ส่งคืนหมายเลขของโหนดของ XML ซึ่งถูกรวบรวมในระหว่างการดำเนินการสำหรับรูปแบบนี้ และเป็นไปตามเงื่อนไขที่ป้อน (คู่ของช่วงและค่า) ส่งค่าเป็นศูนย์เมื่อแฟล็ก **รวมบรวมรายละเอียดผลลัพธ์**ของไฟล์ปัจจุบันถูกปิด|     |
| COUNTIF (สตริช่วงเกณฑ์ สตริงค่าเกณฑ์) | ส่งคืนหมายเลขของโหนดของ XML ซึ่งถูกรวบรวมในระหว่างการดำเนินการสำหรับรูปแบบนี้ และเป็นไปตามเงื่อนไขที่ป้อน (ช่วงและค่า) ส่งค่าเป็นศูนย์เมื่อแฟล็ก **รวมบรวมรายละเอียดผลลัพธ์**ของไฟล์ปัจจุบันถูกปิด|          |
| COLLECTEDLIST (criteria range1 string, criteria value1 string \[, criteria range2 string, criteria value2 string, …\]) | ส่งคืนรายการของค่าของโหนดของ XML ซึ่งถูกรวบรวมในระหว่างการดำเนินการสำหรับรูปแบบนี้ และเป็นไปตามเงื่อนไขที่ป้อน (ช่วงและค่า) ส่งคืนรายการที่ว่างเมื่อแฟล็ก **รวบรวมรายละเอียดผลลัพธ์**ของไฟล์ปัจจุบันถูกปิด|               |   
...
| ฟังก์ชัน                                                                         | คำอธิบาย                                                                                                                                                                                                                                                        | ตัวอย่าง                                                                                                                                                                                                                                                                                                       |
|----------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CONVERTCURRENCY (ยอดเงิน สกุลเงินต้นทาง สกุลเงินเป้าหมาย วัน บริษัท)        | แปลงยอดเงินที่ระบุจากสกุลเงินต้นทางเป็นสกุลเงินเป้าหมาย โดยใช้การตั้งค่าของบริษัทการเงินและการดำเนินการที่ระบุในวันที่ที่ระบุ                                                                            | **CONVERTCURRENCY (1, "EUR", "USD", TODAY(), "DEMF")** ส่งกลับค่าหนึ่งยูโรที่เทียบเท่ากับดอลลาร์สหรัฐฯ ในวันรอบเวลาปัจจุบัน ตามการตั้งค่าสำหรับบริษัท DEMF                                                                                                                                  |
| ROUNDAMOUNT (หมายเลข ทศนิยม กฎการปัดเศษ)                                       | การปัดเศษยอดเงินที่ระบุตามกฎการปัดเศษที่ระบุและจำนวนตำแหน่งทศนิยมที่ระบุ **หมายเหตุ:** ต้องมีการระบุกฎการปัดเศษเป็นค่าการแจงนับ **RoundOffType** ของการเงินและการดำเนินการ                          | ถ้าพารามิเตอร์ **model.RoundOff** ถูกตั้งค่าเป็น ****Downward****, **ROUNDAMOUNT (1000.787, 2, model.RoundOff)** ส่งกลับค่า **1000.78** ถ้าพารามิเตอร์ **model.RoundOff** ถูกกำหนดเป็น **ปกติ** หรือ **ปัดขึ้น**, **ROUNDAMOUNT (1000.787, 2 model.RoundOff)** จะส่งกลับค่า **1000.79** |
...
| GetCurrentCompany ()                                                             | ส่งคืนการแสดงข้อความของรหัสนิติบุคคล (บริษัท) ที่ผู้ใช้ลงชื่อเข้าใช้ในปัจจุบัน                                                                                                                                                                                                                    | **GETCURRENTCOMPANY ()** ส่งกลับค่า **USMF** สำหรับผู้ใช้ที่ล็อกอินไปยังบริษัทการเงินและการดำเนินงาน **ระบบความบันเทิง Contoso USA**                                                                                                                                                                                                                                                                                                              |
...
| FA\_BALANCE (รหัสสินทรัพย์ถาวร รหัสแบบจำลองค่า ปีการรายงาน วันที่รายงาน) | ส่งคืนคอนเทนเนอร์ข้อมูลที่เตรียมไว้ของยอดดุลสินทรัพย์ถาวร ต้องมีการระบุปีที่รายงานเป็นค่าของการแจงนับของการเงินและการดำเนินการ **AssetYear**                                                                                           | FA\_SUM ("COMP-000001", “Current”, AxEnumAssetYear.ThisYear, SESSIONTODAY ()) ส่งคืนคอนเทนเนอร์ข้อมูลที่เตรียมไว้ของยอดดุลสำหรับสินทรัพย์ถาวร "COMP-000001" ที่มีแบบจำลองมูลค่า “Current” ใน 365 ปัจจุบัน สำหรับวันที่รอบเวลาของการเงินและการดำเนินการ                                                                |
| TABLENAME2ID (สตริง)                                                       | ส่งคืนการแสดงจำนวนเต็มของรหัสตารางเป็นชื่อตารางที่กำหนด                                                                                                                                                                      | **TABLENAME2ID ("อินทราสแทต")** ส่งกลับค่า **1510**                                                                                                                                                                                                                                                                   |
| ISVALIDCHARACTERISO7064 (สตริง)                                                       | ส่งกลับค่าบูลีน **จริง** เมื่อสตริงที่กำหนดแสดงถึงหมายเลขบัญชีธนาคารระหว่างประเทศที่ถูกต้อง (IBAN) มิฉะนั้น ส่งกลับค่าบูลีน **เท็จ**                                                                                                                                                                      | **ISVALIDCHARACTERISO7064 ("AT61 1904 3002 3457 3201")** ส่งกลับค่า **จริง** **ISVALIDCHARACTERISO7064 ("AT61")** ส่งกลับค่า **เท็จ**                                                                                                                                                                                                                                                                   |
