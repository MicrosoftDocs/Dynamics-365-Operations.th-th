...
|                                                                       |               <strong>การรายงานทางการเงิน</strong>                |                                      <strong>ข้อมูลเชิงลึกทางการเงิน</strong>                                      |
|-----------------------------------------------------------------------|-------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|
|                 <strong>แก้ไขรายงานเริ่มต้น</strong>                 |                                ใช่                                |                                                      หมายเลข                                                       |
|                  <strong>สร้างรายงานใหม่</strong>                  |                                ใช่                                |                                                      หมายเลข                                                       |
|                    <strong>พิมพ์รายงาน</strong>                     |                                ใช่                                |                                                      หมายเลข                                                       |
|                   <strong>ส่งออกไปที่ Excel</strong>                    |                                ใช่                                |                           ข้อมูลดิบในการส่งออกที่จำกัดไปยัง Excel ไม่ใช่รายงานที่มีการจัดรูปแบบ                           |
|  <strong>สนับสนุนลำดับชั้นรายงาน/ลำดับชั้นขององค์กร</strong>  |                                ใช่                                |                                                      หมายเลข                                                       |
|               <strong>รายงานเกี่ยวกับข้อมูลบัญชีแยกประเภทย่อย</strong>               |               ใช่ จำกัดเฉพาะผู้จัดจำหน่าย ลูกค้า                |                 ใช่ ผู้จัดจำหน่าย ลูกค้า กลุ่มผู้จัดจำหน่าย/ลูกค้า ที่อยู่ผู้จัดจำหน่าย/ลูกค้า เป็นต้น                 |
|                  <strong>สกุลเงินการรายงาน</strong>                  |    ใช่ สกุลเงินทางบัญชี และแปลเป็นสกุลเงินการรายงาน    |                                          ไม่ สกุลเงินทางบัญชีเท่านั้น                                          |
|                       <strong>ความปลอดภัย</strong>                       | ใช่ สอดคล้องกับ Finance and Operations และความปลอดภัยลำดับการรายงาน | รายงานการดูที่จำกัดสำหรับบริษัททั้งหมด (โดยไม่คำนึงถึงความปลอดภัยใน Finance and Operations) หรือบริษัทที่ใช้งานอยู่เท่านั้น |
| <strong>สนับสนุนผังบัญชีและปีบัญชีต่างๆ</strong> |                                ใช่                                |                                                      หมายเลข                                                       |
|               <strong>รายงานเกี่ยวกับข้อมูลภายนอก</strong>                |                                หมายเลข                                 |                                                      หมายเลข                                                       |
|                <strong>สนับสนุนการรวมบัญชี</strong>                |                                ใช่                                |                   รายงานความสามารถที่จำกัดในหลายบริษัท แต่ใช้สกุลเงินทางบัญชีเท่านั้น                   |
...
จะมีการสื่อสารลักษณะการทำงานใหม่โดยใช้เว็บไซต์แผนการทำงาน เมื่องานเริ่มต้น: https://roadmap.dynamics.com/
