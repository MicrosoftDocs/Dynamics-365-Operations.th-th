...
ms.locfileid: "1849640"
---
# <a name="financial-insights"></a>ข้อมูลเชิงลึกทางการเงิน

[!include [banner](../includes/banner.md)]

**ข้อมูลเชิงลึกทางการเงิน** ใช้ Microsoft Power BI เพื่อรวมตัวบ่งชี้ประสิทธิภาพหลักทางการเงิน (KPIs) แผนภูมิ และงบการเงิน จำเป็นต้องมีฝัง Power BI ใน Microsoft Dynamics 365 Finance and Operations โฟกัสของ **ข้อมูลเชิงลึกทางการเงิน** คือการรายงานเชิงวิเคราะห์ บทบาททั่วทั้งองค์กรสามารถดู ค้นคว้า เข้าใจ และดำเนินการได้ 
...
| **ความปลอดภัย**                                             | ใช่ สอดคล้องกับ Finance and Operations และความปลอดภัยลำดับการรายงาน | รายงานการดูที่จำกัดสำหรับบริษัททั้งหมด (โดยไม่คำนึงถึงความปลอดภัยใน Finance and Operations) หรือบริษัทที่ใช้งานอยู่เท่านั้น |
