...
14. เลือก **ทดสอบ** อีกครั้ง เพื่อทดสอบนิพจน์ที่ตั้งค่าคอนฟิกอีกครั้ง
    ...
    ![หน้าตัวออกแบบสูตร](media/GER-BaselineSample-DefineProcessingDTExpression.PNG "ภาพหน้าจอของหน้าตัวออกแบบสูตร")
...
ความสามารถ ER ใหม่ช่วยให้คุณสามารถส่งออกการตั้งค่าพื้นฐานสำหรับรูปแบบ ER ที่เลือกจากสภาพแวดล้อม Finance and Operations ปัจจุบัน และจัดเก็บเป็นไฟล์ XML 
...
มีการนำเข้าการตั้งค่าพื้นฐานที่ส่งออกไปยังสภาพแวดล้อม Finance and Operations ที่แตกต่างกัน ต้องมีการนำเข้าสภาพแวดล้อมเป็นรูปแบบ ER ก่อน จากนั้น คุณสามารถนำเข้าการตั้งค่าพื้นฐาน
