...
เพื่อรับการรายงานทางการเงินของ Finance and Operations รุ่น 7.2.6.0 คุณสามารถดาวน์โหลด KB 4052514 ได้จาก <https://fix.lcs.dynamics.com/Issue/Resolved?kb=4052514>
...
[![รีเซ็ต Data Mart](./media/Integration.png)](./media/Integration.png)

> [!NOTE]
> ตรวจสอบว่า งานรีเซ็ต mart ของข้อมูลทั้งหมดได้ทำการโหลดครั้งแรกเสร็จสมบูรณ์ ก่อนที่คุณเริ่มต้นการรีเซ็ต คุณสามารถยืนยันรายการนี้ได้โดยการค้นหาค่าในคอลัมน์รันไทม์ล่าสุด โดยการเลือก **เครื่องมือ** &gt; **สถานะการรวม** ได้
...
[![ดูสถานะของการรวม](./media/New-integration.PNG)](./media/New-integration.PNG)

> [!NOTE]
> การรีเซ็ตเสร็จสิ้นเมื่อการแม็ปทั้งหมดแสดงสถานะเป็น RanToCompletion และหน้าต่างสถานะการรวมแสดงข้อความว่า "การรวมเสร็จสมบูรณ์" ในมุมล่างซ้าย
...
ดาวน์โหลดแพคเกจ MinorVersionDataUpgrade.zip ล่าสุด สำหรับคำแนะนำเกี่ยวกับวิธีการค้นหาและดาวน์โหลดรุ่นที่ถูกต้องของแพคเกจการอัพเกรดข้อมูล ดู[ดาวน์โหลดแพคเกจสามารถปรับใช้ได้ในการอัพเกรดข้อมูลล่าสุด](..\migration-upgrade\upgrade-data-to-latest-update.md#download-the-latest-data-upgrade-deployable-package) 

ไม่จำเป็นต้องอัพเกรดเพื่อที่จะดาวน์โหลดแพคเกจ MinorVersionDataUpgrade.zip ดังนั้น คุณเพิ่งได้ทำตามขั้นตอนในส่วน "ดาวน์โหลดแพคเกจสามารถปรับใช้ได้ในการอัพเกรดข้อมูลล่าสุด" ของหัวข้อดังกล่าว คุณสามารถข้ามขั้นตอนอื่นๆ ทั้งหมดในหัวข้อได้
