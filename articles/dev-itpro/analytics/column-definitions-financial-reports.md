...
| UPT                     | จำกัดยอดเงินในคอลัมน์ เพื่อให้เฉพาะธุรกรรมที่ลงรายการบัญชีถูกรวม ถ้าธุรกรรมเหล่านี้พร้อมใช้งาน<p><strong>หมายเหตุ:</strong> ไม่ใช่บริการข้อมูลทั้งหมดที่สนับสนุนธุรกรรมที่ไม่ลงรายการบัญชี สำหรับข้อมูลเพิ่มเติม ดูที่ <a href='https://go.microsoft.com/fwlink/?LinkID=162565'>คำแนะนำการรวมข้อมูล</a> สำหรับระบบ ERP Microsoft Dynamics ของคุณ</p> |
...
| -        | A-C                 | หักลบยอดเงินในคอลัมน์ A จากยอดเงินในคอลัมน์ C<p><strong>หมายเหตุ:</strong> คุณสามารถใช้เครื่องหมายลบ (-) เพื่อกลับเครื่องหมายในคอลัมน์ ตัวอย่างเช่น ใช้ <strong>-A+B</strong> เพื่อเพิ่มการย้อนกลับของยอดเงินในคอลัมน์ A ไปยังยอดเงินในคอลัมน์ B</p> |
