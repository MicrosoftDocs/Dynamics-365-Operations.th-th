...
-   พื้นที่ส่วนหัวของคำนิยามคอลัมน์ประกอบด้วยข้อความส่วนหัว และการจัดรูปแบบที่ปรากฏในรายงาน หัวข้อสามารถใช้กับคอลัมน์เดียวของข้อมูล สามารถครอบคลุมหลายคอลัมน์ หรือสามารถใช้กับคอลัมน์แบบมีเงื่อนไข คำนิยามคอลัมน์สามารถรวมแถวหัวข้อคอลัมน์มากเท่าที่คุณต้องการ **หมายเหตุ:** ส่วนหัวคอลัมน์ใช้กับแต่ละคอลัมน์ข้อมูลในรายงาน ส่วนหัวของรายงานนำไปใช้กับรายงานทั้งหมด คุณกำหนดส่วนหัวของรายงานในแท็บ **ส่วนหัวและส่วนท้าย** ของข้อกำหนดของรายงาน
...
ผู้ออกแบบรายงานสามารถสร้างส่วนหัวของคอลัมน์โดยอัตโนมัติ โดยอาศัยรหัสข้อความอัตโนมัติ รหัสข้อความอัตโนมัติเป็นตัวแปรที่จะมีการอัพเดทุกครั้งที่มีการสร้างรายงาน ส่วนหัวของคอลัมน์ใดๆ สามารถรวมรหัสเหล่านี้เพื่อระบุข้อมูลรายงานที่แตกต่างกัน เช่น วันหรือหมายเลขรอบระยะเวลา ดังนั้น คุณสามารถใช้คำนิยามคอลัมน์หนึ่งสำหรับหลายข้อกำหนดของรายงาน รอบระยะเวลา และแผนภูมิการรายงาน เนื่องจากรหัสข้อความอัตโนมัติขึ้นอยู่กับข้อมูลปฏิทินจากแถวรายละเอียดของคำนิยามคอลัมน์ ได้รับการสนับสนุนเฉพาะสำหรับคอลัมน์ <strong>CALC</strong> <strong>ดีมอนตัวกรอง</strong> และ <strong>WKS</strong> วิธีการที่รหัสข้อความอัตโนมัติปรากฏในเซลล์ส่วนหัวของคอลัมน์มีผลต่อการปรากฏข้อมูลในรายงาน ในกล่องโต้ตอบ <strong>ส่วนหัวของคอลัมน์</strong> รหัสข้อความอัตโนมัติปรากฏขึ้นในกรณีผสม ดังนั้น ข้อความปรากฏขึ้นในกรณีผสมในรายงาน ตัวอย่างเช่น ในปีปฏิทินมาตรฐาน <strong>@CalMonthLong</strong> แยกเดือน <strong>7</strong> ไปที่ <strong>กรกฎาคม</strong> ถ้าชื่อเดือนควรเป็นตัวพิมพ์ใหญ่ (ตัวอย่างเช่น <strong>กรกฎาคม</strong>) ป้อนรหัสข้อความอัตโนมัติในอักขระตัวพิมพ์ใหญ่ในฟิลด์ <strong>ข้อความส่วนหัวของคอลัมน์</strong> ตัวอย่างเช่น ป้อน <strong>@CALMONTHLONG</strong> คุณสามารถรวมรหัสและข้อความ ตัวอย่างเช่น คุณสามารถป้อนข้อความส่วนหัวข้อต่อไปนี้: <strong>รอบระยะเวลา @FiscalPeriod-@FiscalYear จาก @StartDate ถึง @EndDate</strong> ส่วนหัวของรายงานที่สร้างขึ้นคล้ายคลึงกับข้อความต่อไปนี้: <strong>รอบระยะเวลา 1-02 ตั้งแต่วันที่ 01/01/02 ถึงวันที่ 31/01/02</strong> <strong>หมายเหตุ:</strong> รูปแบบของบางข้อความ เช่น วันที่แบบยาว ขึ้นอยู่กับการตั้งค่าภูมิภาคของคุณบนเซิร์ฟเวอร์ Dynamics 365 for Finance and Operations เพื่อเปลี่ยนการตั้งค่าเหล่านี้ คลิกปุ่ม <strong>เริ่มต้น</strong> คลิก <strong>แผงควบคุม</strong> แล้วคลิก <strong>ภูมิภาคและภาษา</strong> ตารางต่อไปนี้แสดงรายการตัวเลือกข้อความอัตโนมัติที่พร้อมใช้งานสำหรับส่วนหัวของคอลัมน์
...
|----------------------------------------------|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|         สกุลเงิน ธรรมชาติ/ต้นทาง         | <strong>เยน</strong> |                                                                   <strong>Y6,000</strong> – ผลลัพธ์แสดงเฉพาะธุรกรรมที่ป้อนเป็น JPY                                                                   |
| สกุลเงินหลักจากข้อมูลบริษัท | <strong>เยน</strong> |          <strong>$60 *</strong> – ผลลัพธ์แสดงเฉพาะธุรกรรมที่ป้อนเป็น JPY และแสดงธุรกรรมเหล่านั้นในเป็น USD <strong>หมายเหตุ:</strong> อัตราการแปลงคือ ประมาณ 100 JPY ต่อ USD           |
| สกุลเงินที่ใช้สำหรับข้อมูลบริษัท |        ว่าง         | <strong>$2,310\*\</strong>* – ผลลัพธ์แสดงข้อมูลทั้งหมดในสกุลเงินที่ใช้ซึ่งระบุในข้อมูลบริษัท <strong>หมายเหตุ:</strong> ยอดเงินนี้เป็นผลรวมของธุรกรรมทั้งหมดในสกุลเงินที่ใช้ |
|         สกุลเงิน ธรรมชาติ/ต้นทาง         |        ว่าง         |                                                       <strong>$2250</strong> – ผลลัพธ์แสดงยอดเงินทั้งหมดในสกุลเงินซึ่งธุรกรรมมีการดำเนินการ                                                        |

### <a name="calculation-column-in-a-column-definition"></a>คอลัมน์การคำนวณในคำนิยามคอลัมน์

ชนิดคอลัมน์ของ **CALC** ในคำนิยามคอลัมน์ สนับสนุนการคำนวณที่ซับซ้อนในเซลล์ <strong>สูตร</strong> และสามารถรวมตัวดำเนินการ <strong>+</strong> <strong>-</strong> <strong>\</strong> และ **/* และยังรวมคำสั่ง <strong>IF/THEN/ELSE</strong> ด้วย คอลัมน์คำนวณยังสามารถอ้างอิงไปคอลัมน์อื่น แม้แต่คอลัมน์ในลำดับต่อไป นอกจากนี้ คอลัมน์การคำนวณอาจประกอบด้วยปีบัญชี และรอบระยะเวลาเพื่อสนับสนุนส่วนหัวสำหรับคอลัมน์ สูตรการคำนวณสามารถมีความยาวถึง 1,024 อักขระ เมื่อแสดงผลลัพธ์จากการคำนวณด่วนเป็นเปอร์เซ็นต์ ใช้รูปแบบพิเศษแทน <strong>หมายเหตุ:</strong> ผลลัพธ์ของสูตรการคำนวณไม่รวมค่าในช่วงคอลัมน์ที่ไม่ได้พิมพ์ ตัวอย่างเช่น <strong>A:D</strong> พิมพ์ <strong>0</strong> (ศูนย์) ในขณะที่คำนวณค่า <strong>A+B+C</strong> สำหรับค่าที่ไม่ได้การพิมพ์
