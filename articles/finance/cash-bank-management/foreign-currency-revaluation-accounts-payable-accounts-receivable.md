...
ความผันผวนของอัตราแลกเปลี่ยนทำให้มูลค่าตามทฤษฎี (มูลค่าตามบัญชี) ของธุรกรรมลูกค้าที่เปิดค้างไว้ที่เป็นสกุลเงินต่างประเทศเปลี่ยนแปลงเมื่อเวลาผ่านไป หัวข้อนี้ให้ข้อมูลเกี่ยวกับการประเมินค่าใหม่ตามสกุลเงินต่างประเทศเพื่อปรับปรุงมูลค่าของเปิดธุรกรรมในบัญชีเจ้าหนี้และบัญชีลูกหนี้ 
