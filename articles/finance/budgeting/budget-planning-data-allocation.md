...
description: บทความนี้อธิบายวิธีการปันส่วนต่างๆ ที่พร้อมให้ใช้งานใน Microsoft Dynamics 365 Finance
author: panolte
ms.date: 03/05/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8901473"
---
# <a name="budget-planning-data-allocation"></a>การปันส่วนข้อมูลของการวางแผนงบประมาณ

[!include [banner](../includes/banner.md)]

บทความนี้อธิบายวิธีการปันส่วนต่างๆ ที่พร้อมให้ใช้งานใน Microsoft Dynamics 365 Finance  
...
[![วิธีการปันส่วน ปันส่วนให้กับมิติ](./media/allocatetodimensions.jpg)](./media/allocatetodimensions.jpg)
...
![แผนภูมิการรวม](./media/aggregatechart-300x230.png)
**การรวม** – รายการแผนงบประมาณจะถูกรวมจากสถานการณ์จำลองแผนงบประมาณต้นทาง ในแผนงบประมาณ (ข้อมูลรอง) ที่เกี่ยวข้อง ไปยังสถานการณ์จำลองปลายทางในแผนงบประมาณหลัก วิธีการนี้ทำให้ยอดเงินงบประมาณที่จัดเตรียมไว้ในระดับที่ต่ำกว่าในองค์กร มีการรวมบัญชีในระดับสูงกว่า          

[![แผนภูมิการกระจาย](./media/distributechart-300x230.png)](./media/distributechart.png)
...
[![กฎการปันส่วนบัญชีแยกประเภท](./media/ledgerallocationrules-300x202.png)](./media/ledgerallocationrules.png)
...
[![สำเนาจากแผนงบประมาณ](./media/copyfrombudgetplan-187x300.png)](./media/copyfrombudgetplan.png)
