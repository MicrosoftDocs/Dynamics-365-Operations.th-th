...
> [!NOTE]
> ถ้าการคำนวณนี้ถูกปรับเปลี่ยนในระหว่างวงจรงบประมาณ การเปลี่ยนแปลงจะไม่ส่งผลต่อเอกสารที่ผ่านการตรวจสอบการควบคุมงบประมาณก่อนหน้านี้ และได้มีการลงรายการบัญชีแล้วหรือเสร็จสมบูรณ์แล้ว ในการนำออกใช้แอปพลิเคชัน 10.0.17 คุณลักษณะ **ติดตามเฉพาะยอดเงินในการคำนวณงบประมาณที่มีอยู่** สามารถใช้งานได้กับลูกค้าที่จํากัด คุณลักษณะนี้ช่วยให้คุณสามารถเปลี่ยนแปลงข้อมูลที่ติดตามในตาราง BudgetSourceTracking เมื่อเปิดคุณลักษณะนี้ ยอดเงินจะถูกจัดเก็บเฉพาะเมื่อเลือกที่จะใช้ในการคํานวณงบประมาณที่มีอยู่เท่านั้น หากต้องการร้องขอให้เปิดใช้งาน **ติดตามเฉพาะยอดเงินในการคำนวณงบประมาณที่มีอยู่** โปรดติดต่อฝ่ายสนับสนุน 
