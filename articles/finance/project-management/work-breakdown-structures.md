---
title: ภาพรวมของโครงสร้างการแบ่งงาน
...
ms.locfileid: "2174408"
---
# <a name="work-breakdown-structures-overview"></a>ภาพรวมของโครงสร้างการแบ่งงาน
...
การสร้าง WBS เป็นกระบวนการที่ดำเนินการมากซึ่งโดยปกติแล้วใช้ระยะเวลานาน และจำเป็นต้องทำงานร่วมกันและขอข้อมูลจากบุคคลที่หลากหลาย หัวข้อนี้อธิบายวิธีการใช้ว่าคุณสามารถใช้การปรับปรุง WBS ได้ตรงกับความต้องการสำหรับการประเมินและการติดตามได้อย่างไร
...
**การจัดกำหนดการงาน** ปัจจัยต่อไปนี้กำหนดการจัดกำหนดการงานระดับงานโหนดปลายสุด:
...
*<strong><em>กฎการจัดกำหนดการ</em></strong>* เมื่อความช่วยเหลือของการจัดกำหนดการแบบอัตโนมัติเปิดอยู่ กฎต่อไปนี้จะนำไปใช้กับการจัดกำหนดการงานสำหรับงานโหนดปลายสุด:
...
ในบางกรณี คุณอาจต้องการให้ต่างจากกฎเหล่านี้ได้ คุณสามารถปิดการจัดกำหนดการอัตโนมัติเพื่อป้องกัน Finance จากการตั้งค่าโดยอัตโนมัติหรือแก้ไขคุณสมบัติของงานโหนดปลายสุดใดๆ  เมื่อคุณป้อนข้อมูลสำหรับงานที่ทำให้เกิดการละเมิดกฎใด ๆ ของกฎการจัดกำหนดการ ไอคอนข้อผิดพลาดการจัดกำหนดการจะถูกแสดงสำหรับงาน ถ้าคุณไม่ต้องการจัดกำหนดการข้อผิดพลาดที่ถูกแสดง คลิก **ข้อผิดพลาดในการจัดกำหนดการจะถูกแสดง** เพื่อปิดคุณลักษณะ 
...
**แก้ไขข้อผิดพลาดการจัดกำหนดการทั้งหมด** ถ้าคุณต้องการให้ Finance แก้ไขข้อผิดพลาดเกี่ยวกับการจัดกำหนดการทั้งหมดใน WBS บนบานหน้าต่างการดำเนินการ ให้เลือก **แก้ไขส่วนต่างของการจัดกำหนดการทั้งหมด** 
...
Finance ใช้ 0:100 ตามกฎรายได้เมื่อจะลงจุดค่าที่วางแผนไว้ ภายใต้กฎนี้ มูลค่าของงานจะถูกลงรายการบัญชีงาน ณ วันที่สิ้นสุด จะไม่มีค่าถูกลงรายการบัญชีจนกว่างานจะเสร็จสมบูรณ์ 100 เปอร์เซ็นต์ 
...
Finance ใช้ 0:100 ตามกฎรายได้เมื่อจะลงจุดค่าที่ได้รับ ภายใต้กฎนี้ มูลค่าของงานจะถูกลงรายการบัญชีงาน ณ วันที่สิ้นสุด จะไม่มีค่าถูกลงรายการบัญชีจนกว่างานจะเสร็จสมบูรณ์ 100 เปอร์เซ็นต์ 
