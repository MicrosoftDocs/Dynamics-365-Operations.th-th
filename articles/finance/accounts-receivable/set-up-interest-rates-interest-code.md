...
- **เปอร์เซ็นต์** ได้รับเลือกในฟิลด์ **คำนวณดอกเบี้ยตาม** ในหน้า **ตั้งค่ารหัสดอกเบี้ย**
...
> [!NOTE] 
> อัลกอริทึมใหม่ที่จะเพิ่มการคํานวณดอกเบี้ยตั๋วเงินโดยใช้การจัดการลักษณะการงาน หากต้องการใช้อัลกอริทึมนี้ ให้เปิดใช้งานคุณลักษณะ **(GBL) เพื่อให้สามารถคํานวณดอกเบี้ยต่อวันได้ เป็นเปอร์เซ็นต์ต่อปีหารด้วย 365** สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการเปิดใช้งานคุณลักษณะนี้ ดูที่ [ภาพรวมของการจัดการคุณลักษณะ](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)
> 
> สูตรการคํานวณยอดเงินของดอกเบี้ยตั๋วเงิน คือ: 
>  
> ยอดเงินของดอกเบี้ยตั๋วเงิน = ยอดเงินที่ค้างชำระ * % ดอกเบี้ยรายปี / 365 * จํานวนวันล่าช้า
>  
> คุณลักษณะนี้พร้อมใช้งานในรุ่น 10.0.18 และรุ่นที่ใหม่กว่า    
