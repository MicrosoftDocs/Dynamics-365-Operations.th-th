...
[![ตัวเลือกลงรายการบัญชีการแก้ไขใบแจ้งหนี้ในบัญชีลูกหนี้ตั้งค่าเป็นใช่](./media/25_rev-rec-scenarios.png)](./media/25_rev-rec-scenarios.png)
...
ใบสั่งขายจะได้รับการออกใบแจ้งหนี้อีกครั้งสำหรับบสินค้าที่เพิ่มเข้ามา ยอดรวมของใบแจ้งหนี้ที่แสดงให้กับลูกค้าจะเป็น $300.00 + ภาษี $19.50 = $319.50 ภาพประกอบต่อไปนี้จะแสดงรายการบัญชีที่ลงรายการบัญชีไว้
