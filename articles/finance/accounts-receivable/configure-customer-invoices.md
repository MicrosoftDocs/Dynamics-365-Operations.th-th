...
## <a name="post-to-revenue-account-for-sales-order-lines-that-have-no-price"></a>ลงรายการบัญชีไปยังบัญชีรายได้สำหรับรายการใบสั่งขายที่ไม่มีราคา
คุณจะมีตัวเลือกในการอัปเดตบัญชี **รายได้** ใน **บัญชีแยกประเภททั่วไป** สำหรับรายการบัญชีใบสั่งขายที่ไม่มีราคา เมื่อต้องการตั้งค่าหรือดูข้อมูลนี้ ให้ไปที่พารามิเตอร์ **ลงรายการบัญชีไปยังบัญชีรายได้สำหรับรายการใบแจ้งหนี้ใบสั่งขายที่มีราคาเป็นศูนย์** บนแท็บ **บัญชีแยกประเภทและภาษีขาย** ของหน้า **พารามิเตอร์บัญชีลูกหนี้** (**บัญชีลูกหนี้ > การตั้งค่า > พารามิเตอร์บัญชีลูกหนี้**) เลือก **ใช่** เพื่ออัปเดตบัญชี **รายได้** สำหรับรายการใบแจ้งหนี้ใบสั่งขายที่ไม่มีราคา บัญชีรายได้มีการกำหนดในหน้าพารามิเตอร์ **การลงรายการบัญชีสินค้าคงคลัง** บนแท็บข้อกำหนดบัญชี **ใบสั่งขาย** หากไม่ได้เลือกตัวเลือกนี้ รายการที่ไม่มีข้อมูลราคาจะไม่ถูกลงรายการบัญชีไปยังบัญชี **รายได้**
