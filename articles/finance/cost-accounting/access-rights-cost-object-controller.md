...
description: บทความนี้แสดงข้อมูลเกี่ยวกับสิทธิ์การเข้าถึงสำหรับตัวควบคุมออบเจ็กต์ต้นทุน
author: AndersGirke
ms.date: 06/24/2017
ms.topic: article
ms.prod: ''
...
| เสมียนบัญชีต้นทุน   | การดำเนินงาน   |
| ตัวควบคุมออบเจ็กต์ต้นทุน  | สมาชิกทีมงาน |

บทความนี้อธิบายวิธีการกำหนดบทบาท **ตัวควบคุมออบเจ็กต์ต้นทุน** ให้กับผู้จัดการ
...
> - บทความนี้แสดงข้อกำหนดเบื้องต้นที่ต้องมีอยู่ในตำแหน่งก่อนที่คุณสามารถใช้การพื้นที่ทำงาน **การควบคุมต้นทุน**
