...
description: บทความนี้แสดงข้อมูลเกี่ยวกับลำดับชั้นของมิติ คุณใช้ลำดับชั้นของมิติเพื่อกำหนดโครงสร้างรายงาน นโยบายต้นทุน และการตั้งค่าความปลอดภัยในการบัญชีต้นทุน
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848648"
---
# <a name="dimension-hierarchy"></a>ลำดับชั้นของมิติ

[!include [banner](../includes/banner.md)]

บทความนี้แสดงข้อมูลเกี่ยวกับลำดับชั้นของมิติ คุณใช้ลำดับชั้นของมิติเพื่อกำหนดโครงสร้างรายงาน นโยบายต้นทุน และการตั้งค่าความปลอดภัยในการบัญชีต้นทุน  
...
- พื้นที่ทำงาน **การควบคุมต้นทุน** (แอปพลิเคชันมือถือ):
