...
description: บทความนี้แสดงข้อมูลเกี่ยวกับพื้นที่ทำงานการควบคุมต้นทุน พื้นที่ทำงานนี้จะเป็นจุดศูนย์กลาง ที่ซึ่งผู้จัดการที่รับผิดชอบการควบคุมออบเจ็กต์ต้นทุนหรือชุดของออบเจ็กต์ต้นทุนภายในมิติหรือระหว่างมิติ สามารถเข้าถึงรายงานได้
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
| ฟิลด์                  | คำอธิบาย |
|------------------------|-------------|
| รอบระยะเวลาปฏิทินทางการเงิน | เลือกรอบระยะเวลาปฏิทินทางการบัญชี เพื่อมอบหมายรหัสที่ใช้คำนวณค่าโสหุ้ย<blockquote>**หมายเหตุ:**<br>รอบระยะเวลาทางบัญชีที่ระบุไว้ในฟิลด์ มาจากปฏิทินทางบัญชีที่เชื่อมโยงกับบัญชีแยกประเภทการบัญชีต้นทุน</blockquote> |
...
| ฟิลด์                 | คำอธิบาย |
|-----------------------|-------------|
| ต้นทุนคงที่            | ชนิดของคอลัมน์นี้แสดงต้นทุนคงที่ ตามรหัสการคำนวณค่าโสหุ้ยที่เลือก<blockquote>**หมายเหตุ:**<br>ชนิดของคอลัมน์นี้จะแสดงยอดดุล เฉพาะเมื่อรหัสการคำนวณค่าโสหุ้ยถูกเลือกสำหรับรอบระยะเวลาทางบัญชี</blockquote> |
| ต้นทุนผันแปร         | ชนิดของคอลัมน์นี้แสดงต้นทุนผันแปร ตามรหัสการคำนวณค่าโสหุ้ยที่เลือก<blockquote>**หมายเหตุ:**<br>ชนิดของคอลัมน์นี้จะแสดงยอดดุล เฉพาะเมื่อรหัสการคำนวณค่าโสหุ้ยถูกเลือกสำหรับรอบระยะเวลาทางบัญชี</blockquote> |
| ต้นทุนคงที่ + ผันแปร | ชนิดของคอลัมน์นี้แสดงต้นทุนคงที่และต้นทุนผันแปร ตามรหัสการคำนวณค่าโสหุ้ยที่เลือก<blockquote>**หมายเหตุ:**<br>ชนิดของคอลัมน์นี้จะแสดงยอดดุล เฉพาะเมื่อรหัสการคำนวณค่าโสหุ้ยถูกเลือกสำหรับรอบระยะเวลาทางบัญชี</blockquote> |
| รวมต้นทุน            | ชนิดคอลัมน์นี้แสดงต้นทุนรวม (ต้นทุนที่ไม่ได้จัดประเภท ต้นทุนคงที่ และต้นทุนผันแปร)<blockquote>**หมายเหตุ:**<br>ชนิดของคอลัมน์จะแสดงยอดดุลตลอดเวลา</blockquote> |
| ต้นทุนที่ไม่ได้จัดประเภท     | ชนิดของคอลัมน์นี้แสดงต้นทุนที่ไม่ได้จัดประเภท<blockquote>**หมายเหตุ:**<br>คอลัมน์นี้สามารถใช้เพื่อตรวจสอบว่า ต้นทุนทั้งหมดได้ถูกจัดประเภทอย่างถูกต้องตามการคำนวณค่าโสหุ้ยหรือไม่ หรือกฎพฤติกรรมของต้นทุนต้องถูกปรับปรุงหรือไม่</blockquote> |
...
| ฟิลด์                     | คำอธิบาย |
|---------------------------|-------------|
| งบประมาณ                    | จะมีการแสดงยอดดุลงบประมาณสำหรับแต่ละคอลัมน์ที่เลือก<blockquote>**หมายเหตุ:**<br>ยอดดุลจะเป็นไปตามเวอร์ชันของงบประมาณที่ถูกเลือกบนแท็บด่วน **การกรองข้อมูล**</blockquote> |
...
| ขีดจำกัดรอบระยะเวลาผลต่าง | กำหนดขีดจำกัดสำหรับผลต่างในยอดเงินสำหรับรอบระยะเวลาปัจจุบัน ถ้าเกินขีดจำกัด รายการจะถูกเน้นด้วยสีแดงในพื้นที่ทำงาน **การควบคุมต้นทุน**<blockquote>**หมายเหตุ:**<br>ฟิลด์นี้ใช้ได้เฉพาะกับองค์ประกอบต้นทุนที่แสดงถึงค่าใช้จ่าย</blockquote> |
...
| ขีดจำกัดผลต่างเป็น %      | ตั้งค่าขีดจำกัดสำหรับผลต่างในหน่วยเปอร์เซ็นต์ ถ้าเกินขีดจำกัด รายการจะถูกเน้นด้วยสีแดงในพื้นที่ทำงาน **การควบคุมต้นทุน**<blockquote>**หมายเหตุ:**<br>ขีดจำกัดแบบเปอร์เซ็นต์เดียวกันใช้กับรอบระยะเวลาและปีปัจจุบัน</blockquote> |
