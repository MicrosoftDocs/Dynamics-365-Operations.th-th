...
description: บทความนี้แสดงภาพรวมของตัวเลือกข้อเสนอการชำระเงิน และรวมถึงตัวอย่างที่แสดงวิธีการทำงานของข้อเสนอการชำระเงิน
author: abruer
ms.date: 04/04/2018
ms.topic: article
ms.prod: ''
...
บทความนี้แสดงภาพรวมของตัวเลือกข้อเสนอการชำระเงิน และรวมถึงตัวอย่างที่แสดงวิธีการทำงานของข้อเสนอการชำระเงิน ข้อเสนอการชำระเงินมักจะใช้เพื่อสร้างการชำระเงินของผู้จัดจำหน่าย เนื่องจากการสอบถามสามารถนำมาใช้เพื่อเลือกใบแจ้งหนี้ของผู้จัดจำหน่ายสำหรับการชำระเงินอย่างรวดเร็ว โดยยึดตามเงื่อนไข เช่น วันครบกำหนด ส่วนลดเงินสด และเงื่อนไขอื่นๆ 
...
- **วันทำงานที่มีการชำระเงิน** – ป้อนวันของสัปดาห์ที่ควรจะได้รับการจ่ายเงิน ฟิลด์นี้จะใช้เฉพาะเมื่อตั้งค่าวิธีการจ่ายเงินเป็น **สัปดาห์** เท่านั้น จำนวนเงินของใบแจ้งหนี้สำหรับการชำระเงินจะรวมในวันที่ระบุของสัปดาห์สำหรับการชำระเงิน
...
เดือนเมษายนเลือก **วันที่ครบกำหนดและส่วนลดเงินสด** เป็นชนิดข้อเสนอ เธอป้อนช่วงวันที่ตั้งแต่ 26 มิถุนายนถึง 10 กรกฎาคม ใบแจ้งหนี้ต่อไปนี้จะรวมอยู่ในข้อเสนอ:
