...
เวิร์กโฟลว์ติดตามกระบวนการเวิร์กโฟลว์มาตรฐาน ผู้อนุมัติถูกส่งตรงไปยังหน้า **ผู้จัดจำหน่าย** ที่เขาหรือเธอสามารถตรวจสอบการเปลี่ยนแปลงในหน้า **การเปลี่ยนแปลงที่เสนอ** ได้ และจากนั้น เลือก **ลำดับงาน \> อนุมัติ** เพื่ออนุมัติลำดับงาน หลังจากการอนุมัติทั้งหมดเสร็จสมบูรณ์ ฟิลด์จะได้รับการอัปเดตเป็นค่าที่คุณนำเสนอ
