...
---
# <a name="setup-options-for-vendor-invoice-automation-preview"></a>ตั้งค่าตัวเลือกสำหรับระบบอัตโนมัติของใบแจ้งหนี้ของผู้จัดจำหน่าย (พรีวิว)
...
- พารามิเตอร์สำหรับงานเบื้องหลังของระบบอัตโนมัติของกระบวนการ กรอบงานระบบอัตโนมัติของกระบวนการถูกใช้เพื่อส่งใบแจ้งหนี้ของผู้จัดจำหน่ายที่นำเข้าไปยังระบบลำดับงาน นอกจากนี้ ยังใช้ในการจับคู่รายการใบรับสินค้าที่ลงรายการบัญชีกับรายการใบแจ้งหนี้ของผู้จัดจำหน่ายที่ค้างอยู่โดยอัตโนมัติ กระบวนการทางธุรกิจที่แตกต่างกันใช้กรอบงานนี้เพื่อกำหนดความถี่ในการรันกระบวนการที่เลือก ความถี่ที่พร้อมใช้งานสำหรับกระบวนการเบื้องหลัง **จับคู่ใบรับสินค้ากับบรรทัดใบแจ้งหนี้** และ **ส่งใบแจ้งหนี้ของผู้จัดจำหน่ายไปยังลำดับงาน** ได้แก่ **ชั่วโมง** และ **รายวัน**
...
- **ตรวจสอบความถูกต้องเฉพาะเมื่อปริมาณการรับสินค้าที่ตรงกันเท่ากับปริมาณในใบแจ้งหนี้** – ถ้าคุณเลือกตัวเลือกนี้ การจับคู่ใบแจ้งหนี้จะถูกตรวจสอบความถูกต้องโดยอัตโนมัติ เมื่อปริมาณการรับสินค้าที่จับคู่ของบรรทัดใบแจ้งหนี้เท่ากับปริมาณในใบแจ้งหนี้ของบรรทัดใบแจ้งหนี้เท่านั้น ถ้ายกเลิกการเลือกตัวเลือกนี้ ระบบจะตรวจสอบความถูกต้องของการจับคู่ใบแจ้งหนี้ทุกครั้งที่ระบบจะจับคู่รายการใบรับสินค้ากับบรรทัดใบแจ้งหนี้โดยอัตโนมัติ
