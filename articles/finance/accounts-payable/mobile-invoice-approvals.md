...
<a name="prerequisites"></a><span data-ttu-id="efb26-109">ข้อกำหนดเบื้องต้น</span><span class="sxs-lookup"><span data-stu-id="efb26-109">Prerequisites</span></span>
-------------
...
<span data-ttu-id="efb26-147">โดยเป็นคำแนะนำทั่วไป เมื่อทำงานกับตัวออกแบบเคลื่อนที่ ต้องแน่ใจว่าได้ 'เผยแพร่' การเปลี่ยนแปลงแล้วเพื่อป้องกันการสูญเสียการอัพเดต</span><span class="sxs-lookup"><span data-stu-id="efb26-147">As a general guidance, when working with the mobile designer, make sure to 'publish' the changes to prevent losing the updates.</span></span>
...
<li><span data-ttu-id="efb26-165">ยอดเงิน 1099</span><span class="sxs-lookup"><span data-stu-id="efb26-165">1099 amount</span></span></li>
</ol></td>
</tr>
<tr class="odd">
...
1.  <span data-ttu-id="efb26-180">ในเบราว์เซอร์ และลงชื่อเข้าใช้ไปยังแอพลิเคชัน</span><span class="sxs-lookup"><span data-stu-id="efb26-180">In a browser, and sign in to the application.</span></span>
...
10. <span data-ttu-id="efb26-237">คลิก **เสร็จสิ้น** เพื่อออกจากโหมดแก้ไข</span><span class="sxs-lookup"><span data-stu-id="efb26-237">Click **Done** to exit edit mode.</span></span>
...
3. <span data-ttu-id="efb26-252">คลิกปุ่ม **แก้ไข** เพื่อเริ่มการทำงานของโหมดแก้ไขในพื้นที่ทำงาน</span><span class="sxs-lookup"><span data-stu-id="efb26-252">Click the **Edit** button to start edit mode in the workspace.</span></span>
...
### <a name="vendor-invoice-attachments"></a><span data-ttu-id="efb26-315">เอกสารแนบใบแจ้งหนี้ของผู้จัดจำหน่าย</span><span class="sxs-lookup"><span data-stu-id="efb26-315">Vendor invoice attachments</span></span>
...
2.  <span data-ttu-id="efb26-363">อัปโหลดไฟล์รหัสไปยังพื้นที่ทำงานโดยเลือกแท็บ **ตรรกะ** เพื่อบันทึกทับรหัสก่อนหน้า</span><span class="sxs-lookup"><span data-stu-id="efb26-363">Upload the code file to the workspace by selecting the **Logic** tab to overwrite the previous code</span></span>
3.  <span data-ttu-id="efb26-364">คลิก **เสร็จสิ้น** เพื่อออกจากโหมดแก้ไข</span><span class="sxs-lookup"><span data-stu-id="efb26-364">Click **Done** to exit edit mode.</span></span>
4.  <span data-ttu-id="efb26-365">คลิก **ย้อนกลับ** และจากนั้น **เสร็จสิ้น** เพื่อออกจากพื้นที่ทำงาน</span><span class="sxs-lookup"><span data-stu-id="efb26-365">Click **Back** and then **Done** to exit the workspace</span></span>
5.  <span data-ttu-id="efb26-366">คลิก **เผยแพร่พื้นที่ทำงาน** เพื่อบันทึกงานของคุณ</span><span class="sxs-lookup"><span data-stu-id="efb26-366">Click **Publish workspace** to save your work</span></span>

### <a name="validation"></a><span data-ttu-id="efb26-367">การตรวจสอบความถูกต้อง</span><span class="sxs-lookup"><span data-stu-id="efb26-367">Validation</span></span>

<span data-ttu-id="efb26-368">จากอุปกรณ์เคลื่อนที่ของคุณ เปิดแอพ และเชื่อมต่อกับอินสแตนซ์ของคุณ</span><span class="sxs-lookup"><span data-stu-id="efb26-368">From your mobile device, open the app, and connect to your instance.</span></span> <span data-ttu-id="efb26-369">ตรวจสอบให้แน่ใจว่าคุณลงชื่อเข้าใช้ไปยังบริษัทที่ใบแจ้งหนี้ของผู้จัดจำหน่ายมีการกำหนดให้กับคุณสำหรับการตรวจทาน</span><span class="sxs-lookup"><span data-stu-id="efb26-369">Make sure that you sign in to the company where vendor invoices are assigned to you for review.</span></span> <span data-ttu-id="efb26-370">คุณควรจะสามารถดำเนินการต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="efb26-370">You should be able to perform the following actions:</span></span>

-   <span data-ttu-id="efb26-371">ดูพื้นที่ทำงาน **การอนุมัติของฉัน**</span><span class="sxs-lookup"><span data-stu-id="efb26-371">See the **My approvals** workspace.</span></span>
-   <span data-ttu-id="efb26-372">เข้าถึงรายละเอียดข้อมูลพื้นที่ทำงาน **การอนุมัติของฉัน** และดูหน้า **ใบแจ้งหนี้ของผู้จัดจำหน่ายของฉัน**</span><span class="sxs-lookup"><span data-stu-id="efb26-372">Drill into the **My approvals** workspace and see the **My vendor invoices** page.</span></span>
-   <span data-ttu-id="efb26-373">เข้าถึงรายละเอียดข้อมูลหน้า **ใบแจ้งหนี้ของผู้จัดจำหน่ายของฉัน** และดูรายการของใบแจ้งหนี้ที่กำหนดให้กับคุณ</span><span class="sxs-lookup"><span data-stu-id="efb26-373">Drill into the **My vendor invoices** page and see the list of invoices that are assigned to you.</span></span>
-   <span data-ttu-id="efb26-374">เข้าถึงรายละเอียดข้อมูลของหนึ่งในใบแจ้งหนี้เหล่านี้ และดูรายละเอียดส่วนหัวของใบแจ้งหนี้และรายละเอียดรายการ</span><span class="sxs-lookup"><span data-stu-id="efb26-374">Drill into one of the invoices, and see the invoice header details and line details.</span></span>
-   <span data-ttu-id="efb26-375">บนหน้ารายละเอียด ดูการเชื่อมโยงไปยังเอกสารแนบ และใช้การเชื่อมโยงนี้เพื่อนำทางไปยังรายการเอกสารแนบ และดูเอกสารแนบ</span><span class="sxs-lookup"><span data-stu-id="efb26-375">On the details page, see a link to attachments, and use this link to navigate to the attachments list and view the attachments.</span></span>
-   <span data-ttu-id="efb26-376">บนหน้ารายละเอียด ดูการเชื่อมโยงไปยังหน้า **ดูการบัญชี** และใช้การเชื่อมโยงนี้เพื่อนำทางไปยังหน้าการกระจาย และดูการกระจาย</span><span class="sxs-lookup"><span data-stu-id="efb26-376">On the details page, see a link to the **View accounting** page, and use this link to navigate to the distributions page and view the distributions.</span></span>
-   <span data-ttu-id="efb26-377">บนหน้ารายละเอียด คลิกเมนู **การดำเนินการ** ที่ด้านล่าง และทำการดำเนินการลำดับงานที่สามารถใช้กับขั้นตอนของลำดับงาน</span><span class="sxs-lookup"><span data-stu-id="efb26-377">On the details page, click the **Actions** menu at the bottom, and perform workflow actions that are applicable to the workflow step.</span></span>

## <a name="designing-a-complex-invoice-approval-scenario-for-fabrikam"></a><span data-ttu-id="efb26-378">การออกแบบสถานการณ์จำลองการอนุมัติใบแจ้งหนี้ที่ซับซัอนสำหรับ Fabrikam</span><span class="sxs-lookup"><span data-stu-id="efb26-378">Designing a complex invoice approval scenario for Fabrikam</span></span>
<table>
<colgroup>
<col width="50%" />
<col width="50%" />
...
<thead>
<tr class="header">
<th><span data-ttu-id="efb26-379">แอททริบิวต์สถานการณ์จำลอง</span><span class="sxs-lookup"><span data-stu-id="efb26-379">Scenario attribute</span></span></th>
<th><span data-ttu-id="efb26-380">รับสาย</span><span class="sxs-lookup"><span data-stu-id="efb26-380">Answer</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><span data-ttu-id="efb26-381">ฟิลด์ใดบ้างจากส่วนหัวของใบแจ้งหนี้ที่ผู้ใช้จะต้องการดูในประสบการณ์การใช้งานมือถือและในลำดับใด</span><span class="sxs-lookup"><span data-stu-id="efb26-381">What fields from the invoice header will the user want to see in the mobile experience, and in what order?</span></span></td>
<td><ol>
<li><span data-ttu-id="efb26-382">ชื่อผู้จัดจำหน่าย</span><span class="sxs-lookup"><span data-stu-id="efb26-382">Vendor name</span></span></li>
<li><span data-ttu-id="efb26-383">จำนวนเงินในใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="efb26-383">Invoice amount</span></span></li>
<li><span data-ttu-id="efb26-384">บัญชีใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="efb26-384">Invoice account</span></span></li>
<li><span data-ttu-id="efb26-385">หมายเลขใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="efb26-385">Invoice number</span></span></li>
<li><span data-ttu-id="efb26-386">วันที่ในใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="efb26-386">Invoice date</span></span></li>
<li><span data-ttu-id="efb26-387">คำอธิบายใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="efb26-387">Invoice description</span></span></li>
<li><span data-ttu-id="efb26-388">วันที่ครบกำหนด</span><span class="sxs-lookup"><span data-stu-id="efb26-388">Due date</span></span></li>
<li><span data-ttu-id="efb26-389">สกุลเงินในใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="efb26-389">Invoice currency</span></span></li>
</ol></td>
</tr>
<tr class="even">
<td><span data-ttu-id="efb26-390">ฟิลด์ใดบ้างจากรายการใบแจ้งหนี้ที่ผู้ใช้จะต้องการดูในประสบการณ์การใช้งานมือถือและในลำดับใด</span><span class="sxs-lookup"><span data-stu-id="efb26-390">What fields from the invoice lines will the user want to see in the mobile experience, and in what order?</span></span></td>
<td><ol>
<li><span data-ttu-id="efb26-391">ประเภทการจัดซื้อ</span><span class="sxs-lookup"><span data-stu-id="efb26-391">Procurement category</span></span></li>
<li><span data-ttu-id="efb26-392">ปริมาณ</span><span class="sxs-lookup"><span data-stu-id="efb26-392">Quantity</span></span></li>
<li><span data-ttu-id="efb26-393">ราคาต่อหน่วย</span><span class="sxs-lookup"><span data-stu-id="efb26-393">Unit price</span></span></li>
<li><span data-ttu-id="efb26-394">ยอดเงินสุทธิของรายการ</span><span class="sxs-lookup"><span data-stu-id="efb26-394">Line net amount</span></span></li>
<li><span data-ttu-id="efb26-395">ยอดเงิน 1099</span><span class="sxs-lookup"><span data-stu-id="efb26-395">1099 amount</span></span></li>
</ol></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="efb26-396">มีบรรทัดใบแจ้งหนี้ในใบแจ้งหนี้จำนวนเท่าใด</span><span class="sxs-lookup"><span data-stu-id="efb26-396">How many invoice lines are there in an invoice?</span></span> <span data-ttu-id="efb26-397">ใช้กฎ 80-20 และปรับให้เหมาะสมกับ 80 เปอร์เซ็นต์</span><span class="sxs-lookup"><span data-stu-id="efb26-397">Apply the 80-20 rule here, and optimize for the 80 percent.</span></span></td>
<td><span data-ttu-id="efb26-398">5</span><span class="sxs-lookup"><span data-stu-id="efb26-398">5</span></span></td>
</tr>
<tr class="even">
<td><span data-ttu-id="efb26-399">ผู้ใช้จะต้องการดูการกระจายการลงบัญชี (การกำหนดรหัสใบแจ้งหนี้) บนอุปกรณ์เคลื่อนที่ในระหว่างการตรวจทานหรือไม่</span><span class="sxs-lookup"><span data-stu-id="efb26-399">Will users want to see accounting distributions (invoice coding) on the mobile device during reviews?</span></span></td>
<td><span data-ttu-id="efb26-400">ใช่</span><span class="sxs-lookup"><span data-stu-id="efb26-400">Yes</span></span></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="efb26-401">มีการกระจายการลงบัญชี (ราคารวม ภาษีขาย ค่าธรรมเนียม และอื่น ๆ) สำหรับรายการใบแจ้งหนี้จำนวนเท่าใด</span><span class="sxs-lookup"><span data-stu-id="efb26-401">How many accounting distributions (extended price, sales tax, charges, and so on) are there for an invoice line?</span></span> <span data-ttu-id="efb26-402">ใช้กฎ 80-20 อีกครั้ง</span><span class="sxs-lookup"><span data-stu-id="efb26-402">Again, apply the 80-20 rule.</span></span></td>
<td><span data-ttu-id="efb26-403">ราคารวม: 2 ภาษีขาย: 2 ค่าธรรมเนียม: 2</span><span class="sxs-lookup"><span data-stu-id="efb26-403">Extended price: 2 Sales tax: 2 Charges: 2</span></span></td>
</tr>
<tr class="even">
<td><span data-ttu-id="efb26-404">ใบแจ้งหนี้มีการกระจายการลงบัญชีในส่วนหัวของใบแจ้งหนี้ด้วยหรือไม่</span><span class="sxs-lookup"><span data-stu-id="efb26-404">Do the invoices also have accounting distributions on the invoice header?</span></span> <span data-ttu-id="efb26-405">ถ้าเป็นเช่นนั้น กระจายการลงบัญชีเหล่านี้ควรพร้อมใช้งานบนอุปกรณ์หรือไม่</span><span class="sxs-lookup"><span data-stu-id="efb26-405">If so, should these accounting distributions be available on the device?</span></span></td>
<td><span data-ttu-id="efb26-406">ไม่ได้ใช้</span><span class="sxs-lookup"><span data-stu-id="efb26-406">Not used</span></span></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="efb26-407">ผู้ใช้จะต้องการดูเอกสารแนบสำหรับใบแจ้งหนี้บนอุปกรณ์หรือไม่</span><span class="sxs-lookup"><span data-stu-id="efb26-407">Will users want to see attachments for the invoice on the device?</span></span></td>
<td><span data-ttu-id="efb26-408">ใช่</span><span class="sxs-lookup"><span data-stu-id="efb26-408">Yes</span></span></td>
</tr>
</tbody>
</table>

### <a name="next-steps"></a><span data-ttu-id="efb26-409">ขั้นตอนถัดไป</span><span class="sxs-lookup"><span data-stu-id="efb26-409">Next steps</span></span>

<span data-ttu-id="efb26-410">คุณสามารถทำการเปลี่ยนแปลงต่อไปนี้ให้เสร็จสิ้นได้สำหรับสถานการณ์จำลอง 1 ขึ้นอยู่กับความต้องการสำหรับสถานการณ์จำลอง 2</span><span class="sxs-lookup"><span data-stu-id="efb26-410">The following variations can be done for scenario 1, based on the requirements for scenario 2.</span></span> <span data-ttu-id="efb26-411">คุณสามารถใช้ส่วนนี้เพื่อปรับปรุงประสบการณ์การใช้งานของแอพบนมือถือของคุณ</span><span class="sxs-lookup"><span data-stu-id="efb26-411">You can use this section to improve your mobile app experience.</span></span>

1.  <span data-ttu-id="efb26-412">เนื่องจากควรมีรายการในใบแจ้งหนี้เพิ่มเติมในสถานการณ์จำลอง 2 การเปลี่ยนแปลงการออกแบบต่อไปนี้จะช่วยปรับประสบการณ์ผู้ใช้บนอุปกรณ์เคลื่อนที่ให้เหมาะสม:</span><span class="sxs-lookup"><span data-stu-id="efb26-412">Because more invoice lines are expected in scenario 2, the following changes to the design will help optimize the user experience on the mobile device:</span></span>
    1.  <span data-ttu-id="efb26-413">แทนการดูรายการในใบแจ้งหนี้บนหน้ารายละเอียด (เช่นในสถานการณ์จำลอง 1) ผู้ใช้สามารถเลือกที่จะดูรายการบนหน้าบนมือถือแยกต่างหากได้</span><span class="sxs-lookup"><span data-stu-id="efb26-413">Instead of viewing invoice lines on the details page (as in scenario 1), users can choose to view lines on a separate mobile page.</span></span>
    2.  <span data-ttu-id="efb26-414">เนื่องจากต้องการรายการในใบแจ้งหนี้มากกว่าหนึ่งรายการในสถานการณ์จำลองนี้ ถ้าหน้า **VendMobileInvoiceAllDistributionTree** ถูกใช้ในการออกแบบหน้าการกระจายสำหรับอุปกรณ์เคลื่อนที่ (ดังเช่นในสถานการณ์จำลอง 1) ผู้ใช้อาจสับสนที่จะสร้างเชื่อมโยงรายการกับการกระจาย</span><span class="sxs-lookup"><span data-stu-id="efb26-414">Because more than one invoice line is expected in this scenario, if the **VendMobileInvoiceAllDistributionTree** page is used to design the distributions page for mobile (as in scenario 1), it might be confusing for the user to correlate lines to distributions.</span></span> <span data-ttu-id="efb26-415">ดังนั้น ใช้หน้า **VendMobileInvoiceLineDistributionTree** เพื่อออกแบบหน้าการกระจาย</span><span class="sxs-lookup"><span data-stu-id="efb26-415">Therefore, use the **VendMobileInvoiceLineDistributionTree** page to design the distributions page.</span></span>
    3.  <span data-ttu-id="efb26-416">ทางที่ดีที่สุดคือการกระจายควรแสดงอยู่ในบริบทของรายการในใบแจ้งหนี้ในสถานการณ์จำลองนี้</span><span class="sxs-lookup"><span data-stu-id="efb26-416">Ideally, the distributions should be shown in the context of an invoice line in this scenario.</span></span> <span data-ttu-id="efb26-417">ดังนั้น โปรดตรวจสอบให้แน่ใจว่าผู้ใช้สามารถเข้าถึงรายการเพื่อดูหน้าการกระจาย</span><span class="sxs-lookup"><span data-stu-id="efb26-417">Therefore, make sure that the user can drill into a line to see the distributions page.</span></span> <span data-ttu-id="efb26-418">ใช้ความสามารถในการเชื่อมโยงหน้าเพื่อสร้างการเจาะลึก เช่นเดียวกับที่คุณดำเนินการกับส่วนหัวและหน้ารายละเอียดในสถานการณ์จำลอง 1</span><span class="sxs-lookup"><span data-stu-id="efb26-418">Use the page link capability to establish the drill-through, just as you did for the header and details pages in scenario 1.</span></span>

2.  <span data-ttu-id="efb26-419">เนื่องจากคาดว่าจะมีชนิดยอดเงินมากกว่าหนึ่งชนิดในการกระจายในสถานการณ์จำลอง 2 (ภาษีขาย ค่าธรรมเนียม และอื่น ๆ) จึงควรแสดงคำอธิบายของชนิดยอดเงิน</span><span class="sxs-lookup"><span data-stu-id="efb26-419">Because more than one amount type is expected on the distributions in scenario 2 (sales tax, charges, and so on), it will be useful to show the description of the amount type.</span></span> <span data-ttu-id="efb26-420">(เราละเว้นข้อมูลนี้ในสถานการณ์จำลอง 1)</span><span class="sxs-lookup"><span data-stu-id="efb26-420">(We omitted this information in scenario 1.)</span></span>
