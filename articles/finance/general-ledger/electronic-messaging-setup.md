...
description: บทความนี้แสดงข้อมูลเกี่ยวกับวิธีการตั้งค่าฟังก์ชันข้อความทางอิเล็กทรอนิกส์ (EM)
author: AdamTrukawka
ms.date: 11/18/2021
ms.topic: article
ms.prod: ''
...
- [เติมข้อมูลเรกคอร์ดจากหลายบริษัท](#multiple-companies-populate)
...
| การสอบถามของผู้ใช้             | <p>ถ้าคุณตั้งค่าการสอบถามโดยเลือก **แก้ไขการสอบถาม** เหนือกริด และระบุเงื่อนไขที่ต้องใช้กับตารางหลักที่เลือกซึ่งกรอกข้อมูลไว้ กล่องกาเครื่องหมายนี้จะถูกเลือกไว้โดยอัตโนมัติ มิฉะนั้น เรกคอร์ดทั้งหมดจะถูกเติมข้อมูลจากแหล่งข้อมูลตารางหลักที่เลือก</p><p>เมื่อคุณลักษณะ **การสอบถามระหว่างบริษัทเพื่อเติมข้อมูลเรกคอร์ด** ถูกเปิดใช้งานอยู่ในพื้นที่ทำงาน **การจัดการคุณลักษณะ** และต้องรวบรวมเรกคอร์ดจากหลายบริษัท ให้เพิ่มบรรทัดให้กับนิติบุคคลเพิ่มเติมแต่ละแห่งที่ต้องรวมอยู่ในการรายงาน สำหรับแต่ละบรรทัดใหม่ ให้เลือก **แก้ไขการสอบถาม** และระบุเงื่อนไขที่เกี่ยวข้องกับนิติบุคคลที่ระบุในฟิลด์ **บริษัท** ในบรรทัดโดยเฉพาะ เมื่อคุณดำเนินการเสร็จสิ้นแล้ว กริด **การตั้งค่าแหล่งข้อมูล** จะมีรายการของนิติบุคคลทั้งหมดที่ต้องรวมอยู่ในการรายงาน</p> |

## <a name="populate-records-from-multiple-companies"></a><a id="multiple-companies-populate"></a>เติมข้อมูลเรกคอร์ดจากหลายบริษัท

ถ้าบริษัทของคุณต้องรายงานจากนิติบุคคลหลายแห่งในฐานข้อมูล Finance เดียวกัน ให้ตั้งค่า [การดำเนินการเติมข้อมูลเรกคอร์ด](#populate) สำหรับนิติบุคคลทั้งหมดที่ต้องมีข้อมูลรวมอยู่ในการรายงาน

หากต้องการเปิดใช้งานความสามารถนี้ในสภาพแวดล้อม Finance ของคุณ ให้ทำตามขั้นตอนเหล่านี้ 

1. ไปที่ **พื้นที่ทำงาน** \> **การจัดการคุณลักษณะ**
2. ค้นหาและเลือกคุณลักษณะ **การสอบถามข้ามบริษทสำหรับการดำเนินการเติมข้อมูลเรกคอร์ด** ในรายการ
3. เลือก **เปิดใช้งาน** 

หากต้องการตั้งค่า [การดำเนินการเติมข้อมูลเรกคอร์ด](#populate) สำหรับหลายบริษัทที่ต้องรวมข้อมูลไว้ในการรายงาน ให้ปฏิบัติตามขั้นตอนเหล่านี้

1. ไปยัง **ภาษี** \> **ตั้งค่า** \> **ข้อความอิเล็กทรอนิกส์** \> **การดำเนินการเติมข้อมูลเรกคอร์ด**

    เมื่อเปิดใช้งานคุณลักษณะ **การสอบถามข้ามบริษทสำหรับการดำเนินการเติมข้อมูลเรกคอร์ด** ตาราง **การตั้งค่าแหล่งข้อมูล** บนหน้า **การดำเนินการเติมข้อมูลเรกคอร์ด** จะมีฟิลด์ **บริษัท** สำหรับเรกคอร์ดที่มีอยู่ซึ่งสร้างขึ้นในระหว่างการตั้งค่าทั่วไปของ [การดำเนินการเติมข้อมูลเรกคอร์ด](#populate) ฟิลด์นี้จะแสดงตัวระบุของนิติบุคคลปัจจุบัน

2. ในตาราง **การตั้งค่าแหล่งข้อมูล** ให้เพิ่มรายการสำหรับนิติบุคคลของบริษัทในเครือแต่ละแห่งที่ต้องรวมอยู่ในการรายงาน และตั้งค่าฟิลด์ต่อไปนี้

    | ชื่อฟิลด์             | ค่า |
    |------------------------|-------|
    | ชื่อ                   | ป้อนค่าข้อความที่จะช่วยให้คุณเข้าใจที่มาของเรกคอร์ดนี้ ตัวอย่าง ป้อน **ชื่อแหล่งข้อมูล - บริษัทในเครือ 1** |
    | ชนิดของรายการข้อความ      | เลือกชนิดรายการข้อความที่ต้องใช้ในการประมวลผล EM ของคุณ |
    | ชนิดบัญชี           | ระบุชนิดบัญชีที่ต้องใช้ในการประมวลผล EM ของคุณ ถ้าการประมวลผล EM ของคุณไม่มีชนิดบัญชีที่ระบุ ให้เลือก **ทั้งหมด** |
    | ชื่อตารางหลัก      | ระบุชื่อของตารางหลักที่ต้องใช้ในการประมวลผล EM ของคุณ |
    | ฟิลด์หมายเลขเอกสาร  | ระบุฟิลด์ที่มีหมายเลขเอกสารในเรกคอร์ดของการประมวลผล EM ของคุณ |
    | ฟิลด์วันที่ในเอกสาร    | ระบุฟิลด์ที่มีวันที่เอกสารในเรกคอร์ดของการประมวลผล EM ของคุณ |
    | ฟิลด์บัญชีของเอกสาร | ระบุฟิลด์ที่มีบัญชีเอกสารในเรกคอร์ดของการประมวลผล EM ของคุณ |
    | บริษัท                | เลือกรหัสของนิติบุคคลบริษัทในเครือ |
    | การสอบถามของผู้ใช้             | กล่องกาเครื่องหมายนี้จะถูกเลือกโดยอัตโนมัติเมื่อคุณกําหนดเกณฑ์โดยการเลือก **แก้ไขการสอบถาม** |

3. สำหรับแต่ละรายการใหม่ ให้เลือก **แก้ไขการสอบถาม** และระบุเกณฑ์ที่เกี่ยวข้องกับนิติบุคคลที่ระบุในฟิลด์ **บริษัท** ในรายการ

## <a name="web-applications"></a><a id="applications"></a>เว็บแอปพลิเคชัน

ใช้การตั้งค่าเว็บแอปพลิเคชันเพื่อตั้งค่าเว็บแอปพลิเคชัน เพื่อให้สนับสนุน Open Authorization (OAuth) 2.0 OAuth คือมาตรฐานแบบเปิดที่ให้ผู้ใช้มีสิทธิ์ "การเข้าถึงที่ได้รับมอบหมายที่ปลอดภัย" ไปยังแอปพลิเคชันในนามของพวกเขา โดยไม่มีการแบ่งปันข้อมูลประจำตัวการเข้าถึงของพวกเขา นอกจากนี้ คุณยังสามารถไปยังกระบวนการตรวจสอบได้โดยการเรียกรหัสการตรวจสอบและโทเคนการเข้าถึง คุณสามารถตั้งค่าการตั้งค่าเว็บแอปพลิเคชันได้ โดยการไปที่ **ภาษี** \> **การตั้งค่า** \> **ข้อความอิเล็กทรอนิกส์** \> **เว็บแอปพลิเคชัน**

ตารางต่อไปนี้อธิบายถึงฟิลด์ในหน้า **เว็บแอปพลิเคชัน**

| ฟิลด์                        | คำอธิบาย |
|------------------------------|-------------|
| ชื่อแอปพลิเคชัน             | ป้อนชื่อสำหรับเว็บแอปพลิเคชัน |
| คำอธิบาย                  | ป้อนคำอธิบายของเว็บแอปพลิเคชัน |
| URL ฐาน                     | ป้อนที่อยู่อินเทอร์เน็ตฐานของเว็บแอปพลิเคชัน |
...
| รหัสไคลเอ็นต์                    | ป้อนรหัสไคลเอ็นต์ของเว็บแอปพลิเคชัน |
| ข้อมูลลับไคลเอ็นต์                | ป้อนความลับไคลเอ็นต์ของเว็บแอปพลิเคชัน |
| โทเคนเซิร์ฟเวอร์                 | ป้อนโทเคนเซิร์ฟเวอร์ของเว็บแอปพลิเคชัน |
...
| ขอบเขตที่อนุญาต                | ขอบเขตที่ได้รับสำหรับคำขอไปยังแอปพลิเคชัน ฟิลด์นี้มีการอัปเดตโดยอัตโนมัติ |
| โทเคนการเข้าถึงจะหมดอายุใน  | เวลาที่เหลืออยู่ก่อนที่โทเคนการเข้าถึงจะหมดอายุ ฟิลด์นี้มีการอัปเดตโดยอัตโนมัติ | 
...
นอกจากนี้ ปุ่มต่อไปนี้จะพร้อมใช้งานในบานหน้าต่างการดำเนินการของหน้า **เว็บแอปพลิเคชัน** เพื่อสนับสนุนกระบวนการตรวจสอบ:

- **รับรหัสการตรวจสอบ** – เริ่มต้นการตรวจสอบของเว็บแอปพลิเคชัน ฟังก์ชันนี้ใช้รูปแบบ ER ที่ระบุไว้ในฟิลด์ **การแม็ปรูปแบบการตรวจสอบ** เพื่อสร้างการร้องขอการตรวจสอบ
...
เมื่อโทเคนการเข้าถึงไปยังเว็บแอปพลิเคชันถูกเก็บอยู่ในฐานข้อมูลของระบบในรูปแบบที่เข้ารหัส จึงจะสามารถใช้สำหรับคำขอไปยังบริการเว็บได้ สำหรับวัตถุประสงค์ด้านความปลอดภัย การเข้าถึงไปยังโทเคนต้องถูกจำกัดบทบาทความปลอดภัยที่ต้องได้รับอนุญาตให้แก้ไขคำขอดังกล่าว ถ้าบุคคลภายนอกกลุ่มความปลอดภัยพยายามระบุคำขอ พวกเขาจะได้รับข้อผิดพลาดที่ระบุว่า พวกเขาจะไม่ได้รับอนุญาตให้รทำงานร่วมกันโดยใช้เว็บแอปพลิเคชันที่เลือก เมื่อต้องการตั้งค่าบทบาทความปลอดภัย ที่มีสิทธิ์ในการเข้าถึงโทเคน ใช้แท็บด่วน **บทบาทความปลอดภัย** บนหน้า **เว็บแอปพลิเคชัน** เมื่อไม่มีการกำหนดบทบาทความปลอดภัยสำหรับเว็บแอปพลิเคชัน ผู้ดูแลระบบเท่านั้นจะสามารถทำงานร่วมกันโดยการใช้เว็บแอปพลิเคชันนี้ได้

สำหรับแต่ละการดำเนินการที่มีเว็บแอปพลเคิชันที่เลือก แท็บด่วน **ล็อกการดำเนินการ** จะบันทึกข้อมูลเกี่ยวกับผู้ใช้ และวันที่และเวลา
...
| ที่อยู่อินเทอร์เน็ต               | <p>ป้อนที่อยู่อินเทอร์เน็ตของบริการเว็บ ถ้ามีการระบุเว็บแอปพลิเคชันสำหรับบริการเว็บ และถ้าที่อยู่อินเทอร์เน็ตของบริการเว็บควรจะเหมือนกับที่อยู่อินเทอร์เน็ตที่ถูกกำหนดไว้สำหรับเว็บแอปพลิเคชันนั้น เลือก **คัดลอก URL ฐาน** จากนั้น URL ฐานของเว็บแอปพลิเคชันจะถูกคัดลอกไปยังฟิลด์นี้</p><p>**คําเตือน:** บริการของบุคคลที่สามหรือบริการอื่นๆ ที่คุณตั้งค่าคอนฟิกที่นี่ ไม่ต้องการใบรับรอง และอาจไม่ตรงกับมาตรฐานความเป็นส่วนตัวของ Microsoft คุณควรทบทวนเอกสารสิทธิส่วนบุคคลของบริการแต่ละฉบับ และร่วมกับผู้ให้บริการแต่ละแห่ง เพื่อเรียนรู้เพิ่มเติมเกี่ยวกับระดับของการปฏิบัติตามกฎระเบียบที่บริการนั้นให้ คุณรับผิดชอบในการตรวจสอบให้แน่ใจว่าบริการเหล่านี้เป็นไปตามความปลอดภัย ความเป็นส่วนตัว และมาตรฐานทางกฎหมายของคุณ คุณต้องรับความเสี่ยงในการใช้บริการนี้ Microsoft ไม่ให้การรับประกันโดยชัดแจ้ง การรับรอง หรือเงื่อนไขอื่นๆ เราขอแนะนาเป็นอย่างยิ่งให้คุณใช้บริการที่รักษาความปลอดภัยและการเชื่อมต่อที่ได้รับอนุญาตเท่านั้น เช่น HTTPS</p> |
| ใบรับรอง                    | เลือกประกาศนียบัตร Azure Key Vault ที่มีการตั้งค่าไว้ก่อนหน้านี้ |
| เว็บแอปพลิเคชัน                | เลือกแอปพลิเคชันเว็บที่มีการตั้งค่าไว้ก่อนหน้านี้ |
...
| ยอมรับการเข้ารหัส                | ระบุค่า ยอมรับการเข้ารหัส ส่วนหัว HTTP ของการยอมรับการเข้ารหัสจะโฆษณาการเข้ารหัสเนื้อหาที่ไคลเอ็นต์สามารถทำความเข้าใจได้ การเข้ารหัสเนื้อหานี้โดยปกติจะเป็นอัลกอริทึมการบีบอัด |
...
| ฟิลด์                                     | คำอธิบาย |
|-------------------------------------------|-------------|
| ชนิดการดำเนินการ                               | เลือกชนิดของการดำเนินการ สำหรับข้อมูลเกี่ยวกับตัวเลือกที่พร้อมใช้งาน ดูส่วน [ชนิดการดำเนินการประมวลผลข้อความ](#action-types) ในส่วนท้ายของบทความนี้ |
| การแมปรูปแบบ                            | เลือกรูปแบบ ER ที่ควรเรียกสำหรับการดำเนินการ ฟิลด์นี้จะพร้อมใช้งานเฉพาะสำหรับการดำเนินการของชนิด **การส่งออกการรายงานทางอิเล็กทรอนิกส์** **การนำเข้าการรายงานทางอิเล็กทรอนิกส์** และ **การส่งออกการรายงานทางอิเล็กทรอนิกส์** |
...
| ชื่อไฟล์ที่จะส่ง                         | ป้อนชื่อของสิ่งที่แนบกับข้อความอิเล็กทรอนิกส์ที่ต้องส่งโดยการดำเนินการนี้ ถ้าสิ่งที่แนบหลายฉบับมีชื่อไฟล์ต้นฉบับเดียวกัน ระบบจะส่งเอกสารล่าสุด ถ้าไม่พบสิ่งที่แนบที่มีชื่อไฟล์เดิมที่ระบุ ระบบจะส่งคำขอโดยไม่มีเนื้อหา ฟิลด์นี้จะพร้อมใช้งานเฉพาะสำหรับการดำเนินการของชนิด **บริการเว็บ** |
