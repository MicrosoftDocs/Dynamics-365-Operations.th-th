...
description: บทความนี้แสดงข้อมูลเกี่ยวกับฟังก์ชันการหักภาษี ณ ที่จ่ายแบบสากลและวิธีการตั้งค่า ฟังก์ชันการหักภาษี ณ ที่จ่ายแบบสากลถูกปรับปรุงสำหรับธุรกรรมของผู้จัดจำหน่ายและลูกค้า เพื่อให้ภาษีหัก ณ ที่จ่ายมีการคำนวณที่ระดับสินค้า
author: kailiang
ms.date: 01/12/2021
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8846841"
---
# <a name="global-withholding-tax"></a>ภาษีหัก ณ ที่จ่ายทั่วโลก

[!include [banner](../includes/banner.md)]

บทความนี้แสดงข้อมูลเกี่ยวกับฟังก์ชันการหักภาษี ณ ที่จ่ายแบบสากลและอธิบายวิธีการตั้งค่า ฟังก์ชันใหม่มีอยู่ในรุ่น 10.0.17 และรุ่นที่ใหม่กว่า
