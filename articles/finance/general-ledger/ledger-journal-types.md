...
description: บทความนี้อธิบายถึงชนิดของสมุดรายวันที่คุณสามารถตั้งค่าสำหรับสมุดรายวันทางการเงิน
author: kweekley
ms.date: 10/10/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8901326"
---
# <a name="ledger-journal-types"></a>ชนิดสมุดรายวันบัญชีแยกประเภท

[!include [banner](../includes/banner.md)]

บทความนี้อธิบายถึงชนิดของสมุดรายวันที่คุณสามารถตั้งค่าสำหรับสมุดรายวันทางการเงิน ใช้หน้า **ชื่อสมุดรายวัน** เพื่อตั้งค่าสมุดรายวันที่คุณสามารถใช้ไดใน Dynamics 365 Finance
