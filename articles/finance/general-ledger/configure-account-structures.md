...
description: บทความนี้แสดงข้อมูลเกี่ยวกับโครงสร้างทางบัญชีและมิติทางการเงิน
author: aprilolson
ms.date: 10/14/2022
ms.topic: article
ms.prod: ''
...
เกณฑ์: ที่ซึ่งบัญชีหลักอยู่ระหว่าง 400000 และ 499999 จากนั้น เพิ่มลูกค้า ต้องไม่ว่างเปล่า

|ลูกค้า         |
|-----------------|
|\* |

ในตัวอย่างแบบง่ายนี้ ค่าและช่องว่างทั้งหมดได้รับอนุญาต ดังนั้น \* และ "&nbsp;" จึงมีการใช้
...
## <a name="more-than-seven-criteria-needed"></a>จำเป็นต้องใช้เงื่อนไขมากกว่าเจ็ดรายการ

ถ้าคุณมีเงื่อนไขมากกว่าเจ็ดรายการที่จำเป็น คุณสามารถเพิ่มไปที่รายการถัดไปได้ต่อ คุณจะสังเกตเห็นว่า เมื่อทำงานในส่วน **รายละเอียดค่าที่อนุญาต** ที่เงื่อนไข **+ เพิ่มใหม่** คือไม่มีการใช้งานอีกต่อไป หลังจากป้อนเกณฑ์ที่เจ็ด นี่เป็นเพราะปัจจัยหลายอย่าง เช่น: 
 - ความกว้างคอลัมน์ 
...
> [!NOTE]
> การอัปเกรดจาก Microsoft Dynamics AX 2012 ที่มีการระบุเกณฑ์มากกว่าเจ็ดเกณฑ์จะไม่ได้รับการสนับสนุน โดยต้องมีการแก้ไขก่อนที่คุณจะดําเนินการอัปเกรดเป็นแอปการเงินและการดําเนินงานให้เสร็จสมบูรณ์ 
...
- ทำให้บัญชีหลักเป็นอันดับแรก หรือใกล้กับด้านหน้าของโครงสร้างทางบัญชีมากที่เป็นไปได้ เพื่อให้ผู้ใช้ได้รับประสบการณ์ที่แนะนำที่ดีที่สุดที่พวกเขาสามารถได้รับ ในระหว่างรายการบัญชี
  ...
  - ตรวจสอบโซลูชันของบุคคลที่สามใดๆ ที่คุณตั้งใจจะใช้บัญชีหลักสนับสนุนในตําแหน่งแรก
...
เมื่อคุณพอใจกับการตั้งค่าใหม่ของคุณหรือการเปลี่ยนแปลงไปยังโครงสร้างทางบัญชี คุณต้องเปิดใช้งาน ถ้ามีการกำหนดโครงสร้างทางบัญชีให้กับบัญชีแยกประเภท การเปิดใช้งานนี้อาจเป็นกระบวนการที่รันเป็นเวลานาน เนื่องจากธุรกรรมที่ไม่ลงรายการบัญชีทั้งหมดในระบบต้องถูกซิงค์กับโครงสร้างใหม่ ธุรกรรมที่ลงรายการบัญชีไม่ได้รับผลกระทบกับการเปลี่ยนแปลงโครงสร้างทางบัญชี ในฐานะเป็นแอปพลิเคชันรุ่น 10.0.31 คุณลักษณะใหม่ที่ชื่อ **การเพิ่มประสิทธิภาพการทำงานของการเปิดใช้งานโครงสร้างทางบัญชี** มีอยู่ในการจัดการคุณลักษณะ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับคุณลักษณะใหม่นี้ในการเปิดใช้งานโครงสร้างทางบัญชี โปรดดูที่ [การเพิ่มประสิทธิภาพการทำงานของการเปิดใช้งานโครงสร้างทางบัญชี](account-structure-improvement.md) 
