...
description: บทความนี้จะให้ข้อมูลเกี่ยวกับสกุลเงินคู่ ที่ซึ่งสกุลเงินที่รายงานถูกใช้เป็นสกุลเงินทางบัญชีที่สองสำหรับ Microsoft Dynamics 365 Finance
author: kweekley
ms.date: 04/17/2020
ms.topic: article
ms.prod: ''
...
หลังจากการอัพเกรด คุณต้องทำตามขั้นตอนที่เฉพาะเจาะจงให้เสร็จสมบูรณ์ สำหรับการจัดการเงินสดและธนาคารและสินทรัพย์ถาวร ดังนั้น ต้องแน่ใจว่าคุณได้อ่านและทำความเข้าใจส่วนที่เกี่ยวข้องของบทความนี้
...
- กระบวนการสำหรับการประเมินค่าใหม่ตามสกุลเงินต่างประเทศ ถูกรประเมินค่ายอดเงินใหม่ในสกุลเงินการรายงานแล้ว อย่างไรก็ตาม ขณะนี้ ยอดในสกุลเงินการรายงานถูกคำนวณโดยใช้ยอดสกุลเงินของธุรกรรม ตามที่อธิบายไว้ในส่วน [ลงรายการบัญชีกระบวนการ](#posting-process) ก่อนหน้านี้ในบทความนี้
