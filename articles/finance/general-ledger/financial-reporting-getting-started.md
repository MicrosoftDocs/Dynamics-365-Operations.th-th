...
* เวลาที่กำหนดบนคอมพิวเตอร์เฉพาะที่ของคุณเมื่อคุณลงชื่อเข้าสู่ระบบ ต้องอยู่ภายในห้านาทีของเวลาบนเซิร์ฟเวอร์ การรายงานทางการเงิน ถ้าเวลามีความแตกต่างมากกว่าห้านาที ระบบจะไม่อนุญาตให้คุณลงชื่อเข้าใช้ 
...
เปิดตัวแสดงเหตุการณ์อีกครั้ง และคุณจะเห็นล็อกเหล่านี้ภายใต้ **Microsoft > Dynamics**: * MR-Client * MR-DVT * MR-Integration * MR-Logger * MR-Reporting * MR_SchedulerTasks * MR-Sql * MR-TraceManager
