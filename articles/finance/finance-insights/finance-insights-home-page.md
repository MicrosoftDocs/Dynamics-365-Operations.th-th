...
ต้องมีสภาพแวดล้อมของ Sandbox ระดับ 2 (หลายกล่อง) เพื่อแสดงตัวอย่างข้อมูลเชิงลึกของการเงิน สำหรับข้อมูลประวัติความเป็นมาเกี่ยวกับสภาพแวดล้อม ดูที่ [การวางแผนสภาพแวดล้อม](../../fin-ops-core/fin-ops/imp-lifecycle/environment-planning.md)
...
คุณต้องทำขั้นตอนการตั้งค่าคอนฟิกบางอย่างให้เสร็จสมบูรณ์ก่อนจึงจะสามารถใช้ข้อมูลเชิงลึกทางการเงิน สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการตั้งค่า Finance Insights นี้ ดูที่
  - สำหรับรุ่นไม่เกิน 10.0.19: [การตั้งค่าคอนฟิกสำหรับ Finance insights - ไม่เกินรุ่น 10.0.19](configure-for-fin-insites.md)
