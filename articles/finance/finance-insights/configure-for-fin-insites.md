...
ข้อมูลเชิงลึก Finance รวมฟังก์ชันจาก Microsoft Dynamics 365 Finance พร้อมกับ Common Data Service, Azure และ AI Builder เพื่อให้เครื่องมือการคาดการณ์ที่มีประสิทธิภาพสำหรับองค์กรของคุณ หัวข้อนี้จะอธิบายขั้นตอนการตั้งค่าคอนฟิกที่จะช่วยให้ระบบของคุณสามารถใช้ความสามารถที่มีอยู่ในข้อมูลเชิงลึก Finance ได้
...
## <a name="configure-common-data-service"></a>ตั้งค่าคอนฟิก Common Data Service
...
1. เปิด [ศูนย์การจัดการ Power Platform](https://admin.powerplatform.microsoft.com/) และปฏิบัติตามขั้นตอนต่อไปนี้เพื่อสร้างสภาพแวดล้อม Common Data Service ใหม่ในผู้เช่า Active Directory เดียวกัน:
    ...
    11. จดบันทึกรหัสองค์กร Common Data Service
    ...
    16. ตั้งค่าฟิลด์ **รหัสข้อมูลอ้างอิงของอินสแตนซ์** เป็นค่ารหัสองค์กร Common Data Service ที่คุณได้ทำบันทึกย่อไว้ก่อนหน้านี้
    17. ในแถบที่อยู่ของเบราว์เซอร์ ให้จดบันทึก URL ขององค์กร Common Data Service ตัวอย่างเช่น URL อาจเป็น `https://org42b2b3d3.crm.dynamics.com`
...
### <a name="enter-the-common-data-service-directory-id-and-the-users-azure-ad-object-id"></a>ป้อนรหัสไดเรกทอรี Common Data Service และรหัสวัตถุ Azure AD ของผู้ใช้

1. ป้อนรหัสไดเรกทอรี Common Data Service:

    1. เปิด [พอร์ทัล Azure](https://portal.azure.com)
    2. ลงชื่อเข้าใช้โดยใช้รหัสผู้ใช้ที่ใช้ในการสร้างสภาพแวดล้อม Common Data Service
...
> [!NOTE]
> ตรวจสอบให้แน่ใจว่าคุณได้สร้างทรัพยากรต่อไปนี้ในอินสแตนซ์ Azure AD ที่เหมือนกันกับสภาพแวดล้อม Common Data Service คุณไม่สามารถใช้ทรัพยากรจากอินสแตนซ์ Azure AD อื่นได้
...
4. บนหน้ารายละเอียด add-in  **รับข้อมูลเชิงลึก** ให้ป้อนค่าต่อไปนี้
    ...
    | มูลค่า                                                    | คำอธิบาย |
    |----------------------------------------------------------|-------------|
    | URL ขององค์กร CDS                                     | URL ขององค์กร Common Data Service ของอินสแตนซ์ Common Data Service เมื่อต้องการค้นหาค่านี้ ให้เปิด [พอร์ทัล Power Apps](https://make.powerapps.com) เลือกปุ่ม **การตั้งค่า** (สัญลักษณ์เกียร์) ที่มุมบนขวา ให้เลือก **การตั้งค่าขั้นสูง** และคัดลอก URL (URL ลงท้ายด้วย "dynamics.com") |
    | รหัสองค์กร CDS                                               | รหัสสภาพแวดล้อมของอินสแตนซ์ Common Data Service เมื่อต้องการค้นหาค่านี้ ให้เปิด [พอร์ทัล Power Apps](https://make.powerapps.com) เลือกปุ่ม **การตั้งค่า** (สัญลักษณ์เกียร์) ที่มุมบนขวา ให้เลือก **การเลือกกำหนด \> ทรัพยากรนักพัฒนา \> ข้อมูลอ้างอิงของอินสแตนซ์** และคัดลอกค่า **รหัส** |
    | รหัสผู้เช่าของ CDS (รหัสไดเรกทอรีจาก AAD)               | รหัสผู้เช่าของอินสแตนซ์ Common Data Service เมื่อต้องการค้นหาค่านี้ ให้เปิด [พอร์ทัล Azure](https://portal.azure.com) ไปที่ **Azure Active Directory** และคัดลอกค่า **รหัสผู้เช่า** |
    | ระบุรหัสออบเจ็กต์ผู้ใช้ที่มีบทบาทผู้ดูแลระบบ | รหัสออบเจ็กต์ผู้ใช้ Azure AD ของผู้ใช้ใน Common Data Service ผู้ใช้นี้ต้องเป็นผู้ดูแลระบบของอินสแตนซ์ Common Data Service เมื่อต้องการค้นหาค่านี้ ให้เปิด [พอร์ทัล Azure](https://portal.azure.com) ไปที่ **Azure Active Directory \> ผู้ใช้** เลือกผู้ใช้ และจากนั้น ในส่วน **รหัสประจำตัว** ให้คัดลอกค่า **รหัสออบเจ็กต์** |
    | นี่เป็นสภาพแวดล้อม CDS เริ่มต้นสำหรับผู้เช่าหรือไม่      | ถ้าอินสแตนซ์ Common Data Service เป็นอินสแตนซ์การผลิตแรกที่สร้างขึ้น ให้เลือกกล่องกาเครื่องหมายนี้ ถ้ามีการสร้างอินสแตนซ์ Common Data Service ด้วยตนเอง ให้ยกเลิกการเลือกกล่องกาเครื่องหมายนี้ |
