...
description: บทความนี้จะอธิบายถึงฟังก์ชันสมุดบัญชีปัจจุบันในสินทรัพย์ถาวร ฟังก์ชันนี้ขึ้นอยู่กับฟังก์ชันรูปแบบมูลค่าที่มีให้ในรุ่นก่อน และยังรวมถึงฟังก์ชันทั้งหมดที่ระบุไว้ก่อนหน้านี้ในสมุดบัญชีค่าเสื่อมราคาเท่านั้น
author: moaamer
ms.date: 06/20/2017
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8855504"
---
# <a name="depreciation-book-upgrade-overview"></a>ภาพรวมการอัปเกรดของสมุดบัญชีค่าเสื่อมราคา

[!include [banner](../includes/banner.md)]

บทความนี้จะอธิบายถึงฟังก์ชันสมุดบัญชีปัจจุบันในสินทรัพย์ถาวร ฟังก์ชันนี้ขึ้นอยู่กับฟังก์ชันรูปแบบมูลค่าที่มีให้ในรุ่นก่อน และยังรวมถึงฟังก์ชันทั้งหมดที่ระบุไว้ก่อนหน้านี้ในสมุดบัญชีค่าเสื่อมราคาเท่านั้น ฟังก์ชันแบบจำลองค่าและฟังก์ชันหนังสือการคิดค่าเสื่อมราคาได้ถูกผสานเป็นแนวคิดเดียวซึ่งรู้จักกันว่าเป็นหนังสือ ฟังก์ชันของสมุดบัญชีช่วยให้คุณสามารถใช้หน้าชุดเดียว การสอบถาม และรายงานต่างๆ ขององค์กรในกระบวนการสินทรัพย์ถาวรทั้งหมดได้ บทความนี้มีบางสิ่งที่คุณควรพิจารณาก่อนที่จะอัปเกรด 
