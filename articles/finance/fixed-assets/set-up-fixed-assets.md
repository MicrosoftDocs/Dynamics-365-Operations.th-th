...
description: บทความนี้แสดงภาพรวมของการตั้งค่าโมดูลสินทรัพย์ถาวร
author: moaamer
ms.date: 06/08/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8910155"
---
# <a name="set-up-fixed-assets"></a>ตั้งค่าสินทรัพย์ถาวร

[!include [banner](../includes/banner.md)]

บทความนี้แสดงภาพรวมของการตั้งค่าโมดูล **สินทรัพย์ถาวร** 
...
ตัวเลือกในหน้า **พารามิเตอร์สินทรัพย์ถาวร** ช่วยให้คุณสามารถเปิดหรือปิดฟังก์ชันการล็อคได้ คุณลักษณะนี้เปิดใช้งานใน **พื้นที่ทำงานการจัดการคุณลักษณะ**
...
พารามิเตอร์ **สมุดสินทรัพย์ล็อคในสมุดรายวันค่าเสื่อมราคา** ช่วยให้คุณสามารถล็อคสมุดบัญชีสินทรัพย์ในสมุดรายวันค่าเสื่อมราคาได้ เมื่อลงรายการบัญชีธุรกรรมค่าเสื่อมราคา ระบบจะตรวจสอบว่าไม่ได้เพิ่มสมุดบัญชีสินทรัพย์เดียวกันเข้าในสมุดรายวันค่าเสื่อมราคามากกว่าหนึ่งเล่ม ถ้ามี สมุดบัญชีสินทรัพย์นั้นจะถูกล็อค และการลงรายการบัญชีจะหยุด หากรหัสสมุดบัญชีสินทรัพย์อยู่ในสมุดรายวันที่ล็อค รหัสสินทรัพย์จะถูกปลดล็อคโดยอัตโนมัติเมื่อการลงรายการบัญชีสมุดรายวันต้นฉบับเสร็จสมบูรณ์ คุณยังสามารถปลดล็อคสมุดรายวันด้วยตนเองได้ 
