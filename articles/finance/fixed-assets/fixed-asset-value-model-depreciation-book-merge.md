...
หัวข้อนี้จะอธิบายถึงฟังก์ชันสมุดบัญชีปัจจุบันในสินทรัพย์ถาวร ฟังก์ชันนี้ขึ้นอยู่กับฟังก์ชันรูปแบบมูลค่าที่มีให้ในรุ่นก่อน และยังรวมถึงฟังก์ชันทั้งหมดที่ระบุไว้ก่อนหน้านี้ในสมุดบัญชีค่าเสื่อมราคาเท่านั้น

ฟังก์ชันของสมุดบัญชีช่วยให้คุณสามารถใช้หน้าชุดเดียว การสอบถาม และรายงานต่างๆ ขององค์กรในกระบวนการสินทรัพย์ถาวรทั้งหมดได้ ตารางในหัวข้อนี้อธิบายฟังก์ชันก่อนหน้านี้สำหรับสมุดบัญชีค่าเสื่อมราคาและรูปแบบมูลค่าร่วมกับฟังก์ชันปัจจุบันสำหรับสมุดบัญชี
...
|--------------------------------------------------|---------------------------------|---------------------------------|---------------------------------------------------------|
| ลงรายการบัญชีที่บัญชีแยกประเภท                                   | ไม่เคย                           | เสมอ                          | ตัวเลือกเพื่อลงรายการบัญชีที่บัญชีแยกประเภท                                |
...
| ชื่อสมุดรายวัน                                    | ชื่อสมุดรายวันบัญชีค่าเสื่อมราคา | บัญชีแยกประเภททั่วไป - ชื่อรายงานสมุดรายวัน              | บัญชีแยกประเภททั่วไป - ชื่อรายงานสมุดรายวัน                                      |
| สมุดบัญชีที่ได้รับ                                    | ไม่อนุญาต                     | ได้รับอนุญาต                         | ได้รับอนุญาต                                                 |
