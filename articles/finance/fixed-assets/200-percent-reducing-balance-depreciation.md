...
description: หัวข้อนี้แสดงภาพรวมวิธีการที่ยอดดุลลดลง 200 เปอร์เซ็นต์ของค่าเสื่อมราคา
author: moaamer
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ตัวเลือก **ปฏิทิน** อัปเดตค่าเสื่อมราคาโดยยึดวันที่ 1 มกราคมของทุกปีเป็นหลัก โดยทั่วไป ค่าเสื่อมราคาคือมูลค่าตามบัญชีสุทธิลบด้วยมูลค่าซาก ในตัวอย่างถัดไปของหัวข้อนี้ ฐานการคิดค่าเสื่อมราคาคือตัวเศษในนิพจน์แรกบนคอลัมน์การคำนวณ 
