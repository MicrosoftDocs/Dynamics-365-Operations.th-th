...
description: บทความนี้อธิบายแบบแผนสินทรัพย์ที่ให้เช่า
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
บทความนี้อธิบายแบบแผนสินทรัพย์ที่ให้เช่า แบบแผนการเช่าใช้ในการระบุวันที่เริ่มต้นของสมุดบัญชีการเช่า หากแบบแผนการเช่าได้รับการตั้งค่าเป็น **ไม่มี** วันที่เริ่มต้นจะเหมือนกับวันที่เริ่มต้นของการเช่า (กล่าวคือ ค่าของฟิลด์ **วันที่เริ่มต้นการเช่า** ) หากแบบแผนการเช่าได้รับการตั้งค่าเป็น **เต็มเดือน** วันที่เริ่มต้นคือวันแรกของเดือนที่เป็นวันที่เริ่มต้นของสัญญาเช่า
