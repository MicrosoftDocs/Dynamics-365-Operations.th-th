...
description: บทความนี้จะอธิบายถึงฟังก์ชันที่บันทึกการด้อยค่าของสินทรัพย์ และปรับปรุงตารางเวลาการคิดค่าเสื่อมราคาสินทรัพย์ของสัญญาเช่าดำเนินงานการเข้ารหัสมาตรฐานทางบัญชี หัวข้อ 842 (ASC 842) การเช่าดำเนินงาน
author: moaamer
ms.date: 12/03/2021
ms.topic: article
ms.prod: ''
...
6. ตั้งค่าตัวเลือก **แสดงตัวอย่าง** เพื่อดูงบดุลสินทรัพย์ที่เสนอและรายการทางการเงินก่อนที่จะมีการสร้างหรือลงรายการบัญชี
7. ตั้งค่าตัวเลือก **การปิดบัญชี** เป็น **ใช่** เพื่อปิดสมุดบัญชีการเช่า คุณสามารถยกเลิกการดําเนินการนี้โดยใช้สถานะ **เปิดสัญญาเช่าอีกครั้ง** ไม่สามารถลงรายการบัญชีรายการกับการเช่าที่ปิดแล้ว และไม่สามารถปรับปรุงการเช่าที่ปิดได้ 
8. เลือก **ลงรายการบัญชี** เพื่อสร้างหรือลงรายการบัญชีการด้อยค่าของสินทรัพย์

    > [!NOTE]
    > หลังจากลงรายการบัญชีธุรกรรมการด้อยค่าของสินทรัพย์แล้ว ระบบจะสร้างสมุดบัญชีรุ่นใหม่

    > หากสัญญาเช่ามีการจัดประเภทเป็นสัญญาเช่าดำเนินงาน ค่าเสื่อมราคารายเดือนหลังการด้อยค่าของสินทรัพย์จะคํานวณโดยใช้ค่าเสื่อมราคาแบบเส้นตรง

9. ถ้าต้องการดูกำหนดการค่าเสื่อมราคาสินทรัพย์ที่ด้อยค่า ให้เปิดหน้า กำหนดการคิดค่าเสื่อมราคาสินทรัพย์สำหรับสมุดบัญชีสัญญาเช่า ในขณะนี้สินทรัพย์จะถูกคิดค่าเสื่อมราคาตามจำนวนเดือนที่คุณป้อนไว้ในฟิลด์ของ **รอบระยะเวลาที่เหลือ**
10. ถ้าต้องการดูรายการสมุดรายวันค่าใช้จ่ายการด้อยค่า ให้เลือก **สมุดรายวันการเช่าสินทรัพย์** ในบานหน้าต่างการดำเนินการของสมุดบัญชีค่าเช่าที่บกพร่อง ระบบจะสร้างรายการสมุดรายวันที่เดบิตบัญชีการลงรายการบัญชีค่าใช้จ่ายการด้อยค่าและเครดิตบัญชีการลงรายการบัญชีสินทรัพย์ที่ให้เช่า 
11. ถ้าต้องการดูมูลค่าที่ถือครองใหม่ของสิทธิ์การใช้สินทรัพย์ ให้เลือก **ธุรกรรมสินทรัพย์** ในบานหน้าต่างการดำเนินการของสมุดบัญชีการเช่า
...
1. หลังจากที่คุณสร้างการเช่าตามที่อธิบายไว้ก่อนหน้านี้ในบทความนี้ ให้ไปที่สมุดบัญชีการเช่า และยืนยันกำหนดการชำระเงิน ลงรายการบัญชีสมุดรายวันการรับรู้เริ่มต้นแล้ว สิทธิ์การใช้สินทรัพย์และหนี้สินสัญญาเช่าควรเป็น $70,235.81 สำหรับตัวอย่างนี้ การเช่ามีการจัดประเภทเป็นสัญญาเช่าดำเนินงานภายใต้ ASC 842
...
5. บนหน้า **พารามิเตอร์การด้อยค่าของสินทรัพย์** ให้ป้อนรายละเอียดต่อไปนี้
    ...
    | งวดที่เหลือ      | 84       |
    | ลงรายการบัญชี                   | ใช่      |
    | แสดงตัวอย่างก่อนการลงรายการบัญชี | ไม่       |
    | ปิดสมุดบัญชี             | ไม่       |
