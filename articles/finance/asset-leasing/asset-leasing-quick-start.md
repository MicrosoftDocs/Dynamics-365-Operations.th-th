...
- **การคำนวณการเช่าและการจัดประเภทตามมาตรฐานการบัญชี** -การคำนวณการเช่าและการจัดประเภทระบุมาตรฐานการบัญชีที่จะใช้ในการประเมินค่าเริ่มต้นและครั้งต่อๆ ไป รวมทั้งการทดสอบการจัดประเภทที่กำหนดว่าชนิดการเช่าจะเป็นอย่างไร การเช่าอาจเป็นสัญญาเช่าการเงิน สัญญาเช่าดำเนินงาน สัญญาเช่าระยะสั้น หรือสัญญาเช่ามูลค่าต่ำ ระบบยังคำนวณมูลค่าปัจจุบันของการชำระค่าเช่าขั้นต่ำในอนาคตสำหรับวัตถุประสงค์ของการประเมินค่าและการจัดประเภท

- **ธุรกรรมการเช่า** - การเช่าสินทรัพย์สนับสนุนการรับรู้เริ่มต้นของสิทธิ์การใช้สินทรัพย์สำหรับการเช่าในงบดุล รวมถึงการวัดที่ตามมาสำหรับการเช่างบดุลเปิดหรือการเช่างบดุลปิด ธุรกรรมการรับรู้เริ่มต้นจะวัดมูลค่าปัจจุบันของการชำระค่าเช่าขั้นต่ำในอนาคต ข้อมูลนี้จะใช้ในการกำหนดมูลค่าของสิทธิ์การใช้สินทรัพย์ และหนี้สินสัญญาเช่า ซึ่งส่งผลกระทบต่องบดุลขององค์กร การประเมินผลการทำธุรกรรมการเช่ารายเดือนในเวลาต่อมาจะเกี่ยวข้องกับการสะสมดอกเบี้ยในหนี้สินสัญญาเช่า ซึ่งจะเพิ่มหนี้สินสัญญาเช่า นอกจากนี้ยังมีการวัดผลรายการคงค้างของการชำระค่าเช่าที่ลดหนี้สินสัญญาเช่า และที่จะจ่ายให้แก่ผู้ให้เช่าในเวลาต่อมา การวัดผลรวมถึงการตัดบัญชีของสิทธิ์การใช้สินทรัพย์
...
การเช่าสินทรัพย์แม็บข้อมูลการเช่า กำหนดการชำระเงิน วันที่เริ่มต้นและวันที่สิ้นสุด และความถี่ในการชำระเงิน นอกจากนี้ยังมีการคำนวณสำหรับมูลค่าปัจจุบัน การชำระค่าเช่ารายเดือน ดอกเบี้ย และการตัดบัญชีการเช่า โดยอัตโนมัติ ระบบทำการทดสอบการจัดประเภทการเช่า ทั้งนี้ขึ้นอยู่กับการตั้งค่าคอนฟิก ระบบยังสร้างและลงรายการบัญชีธุรกรรมการเช่าที่สัมพันธ์กัน ซึ่งยึดตามกรอบงานที่กำหนดโดยมาตรฐานการบัญชีที่คุณกำลังติดตาม
...
- **อัตราดอกเบี้ยเงินกู้ส่วนเพิ่ม** - นี่คืออัตราดอกเบี้ยที่จะใช้ในการคำนวณมูลค่าปัจจุบัน ระบบจะใช้อัตราโดยปริยายถ้ากำหนดไว้ในข้อมูลการเช่าเพื่อคำนวณมูลค่าปัจจุบันของการชำระค่าเช่า ถ้าไม่ได้กำหนดอัตราโดยปริยาย ระบบจะใช้อัตราดอกเบี้ยเงินกู้ส่วนเพิ่ม
...
- **ช่วงการทบต้น** - นี่แสดงถึงรอบระยะเวลาที่ดอกเบี้ยถูกทบรวมต่อปี การทำเช่นนี้อาจเป็นรายเดือน (12 รอบระยะเวลาต่อปี) รายไตรมาส (4 รอบระยะเวลาต่อปี) รายครึ่งปี (2 รอบระยะเวลาต่อปี) หรือเป็นรายปี (1 รอบระยะเวลาต่อปี) จำนวนของรอบระยะเวลาจะได้รับการพิจารณาในการคำนวณมูลค่าปัจจุบัน
...
- **กำหนดการชำระเงิน** -นี่คือมูลค่าปัจจุบันที่คำนวณได้ ตามระยะเวลาที่ครอบคลุมโดยการชำระค่าเช่า จำนวนของการชำระเงิน รอบระยะเวลาการทบต้น และชนิดเงินรายปี
...
- **เดือน** - ซึ่งแสดงจำนวนเดือนในปฏิทินตามระยะเวลาของการเช่า ยอดการชำระเงินคือยอดเงินที่ต้องชำระตามที่กำหนดไว้ในความถี่ในการชำระเงิน มูลค่าปัจจุบันที่คำนวณได้คือการชำระค่าเช่าตามมูลค่าปัจจุบันสำหรับแต่ละรอบระยะเวลา การทบต้น และอัตราดอกเบี้ยเงินกู้ส่วนเพิ่ม

> [!NOTE] 
> มูลค่าปัจจุบันคำนวณตามสมการกระแสเงินสดส่วนลด
...
- **ขีดจำกัด** - ใช้ในการทดสอบการจัดประเภทการเช่าเพื่อตรวจสอบว่าสินทรัพย์มีการจัดประเภทเป็นอย่างใดอย่างหนึ่งต่อไปนี้:
  ...
  - **มูลค่าปัจจุบัน** - นี่คือเปอร์เซ็นต์ของมูลค่ายุติธรรมของสินทรัพย์ที่จะใช้ในการทดสอบการจัดประเภท ระบบจะจัดประเภทการเช่าเป็นการเงินถ้ามีการตั้งค่าชนิดการเช่าเป็นอัตโนมัติ และถ้ามูลค่าปัจจุบันของการชำระค่าเช่าในอนาคตเหนือมูลค่ายุติธรรมของสินทรัพย์มากกว่าหรือเท่ากับเปอร์เซ็นต์ที่กำหนดไว้ที่นี่
...
การทดสอบการจัดประเภทรวมถึงการโอนความเป็นเจ้าของ ตัวเลือกการซื้อ ระยะเวลาการเช่า มูลค่าปัจจุบัน และสินทรัพย์ที่ไม่ซ้ำกัน แผนภาพต่อไปนี้แสดงให้เห็นถึงการทดสอบการจัดประเภทการเช่า
...
|     สัญญาเช่าการเงินภายใต้ IFRS และ US GAAP        |     สิทธิ์การใช้สินทรัพย์      |     หนี้สินสัญญาเช่าดำเนินงาน       |
...
|     ชนิดข้อมูล                                          |     เดบิต                     |     เครดิต                            |
|-----------------------------------------------    |-----------------------------  |------------------------------------   |
|     รายการหนี้สินสัญญาเช่าดำเนินงานภายใต้ US GAAP ASC 842    |     ค่าใช้จ่ายดอกเบี้ย          |     หนี้สินสัญญาเช่าดำเนินงาน         |
...
สิทธิ์การใช้สินทรัพย์จะคิดค่าเสื่อมราคา แล้วแต่ว่าจำนวนใดจะน้อยกว่า - อายุการใช้งานของสินทรัพย์หรือระยะเวลาของสัญญาเช่า วิธีการในการคำนวณค่าเสื่อมราคาสำหรับ US GAAP (ASC 842) จะขึ้นอยู่กับความแตกต่างระหว่างค่าใช้จ่ายการเช่าแบบเส้นตรงและดอกเบี้ย ดอกเบี้ยในสัญญาเช่าการเงินจะถูกคำนวณโดยใช้วิธีการแบบเส้นตรงมาตรฐาน การคิดค่าเสื่อมราคาตามสัญญาเช่ามีผลกระทบต่องบกำไรขาดทุนโดยเดบิตดอกเบี้ยจ่าย งบดุลได้รับผลกระทบจากการเครดิตบัญชีสิทธิ์การใช้สินทรัพย์สำหรับสัญญาเช่าทางการเงินที่สะสม สำหรับสัญญาเช่าดำเนินงาน ค่าเสื่อมราคาจะถูกเครดิตให้กับบัญชีค่าใช้จ่ายในการเช่า ถ้าการเช่าถูกลิงค์กับสินทรัพย์ถาวร ธุรกรรมค่าเสื่อมราคาจะมีการดำเนินการจากโมดูลบัญชีสินทรัพย์ถาวรเท่านั้น 
