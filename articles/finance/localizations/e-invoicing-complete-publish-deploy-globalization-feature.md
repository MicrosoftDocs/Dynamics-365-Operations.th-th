...
description: หัวข้อนี้แสดงข้อมูลทั่วไปเกี่ยวกับวงจรการใช้ของคุณลักษณะมาตรฐานโลก
author: dkalyuzh
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
...
- **ร่าง** – เมื่อรุ่นของคุณลักษณะอยู่ในสถานะนี้ คุณสามารถแก้ไขแอททริบิวต์การตั้งค่าคอนฟิกและอาร์ทิแฟกต์ใดๆ (ตัวอย่างเช่น การตั้งค่าคอนฟิกรูปแบบไฟล์) ได้
