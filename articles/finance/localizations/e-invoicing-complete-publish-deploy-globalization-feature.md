...
3. เลือก **ปรับใช้** แล้วจากนั้น เลือกตัวเลือกใดตัวเลือกหนึ่งหรือทั้งคู่ต่อไปนี้ เพื่อกําหนดเป้าหมายของการปรับใช้
    ...
    - **แอปพลิเคชันที่เชื่อมต่อ** – รายการนี้เป็นตัวเลือก แต่ต้องใช้หากคุณต้องการให้มีการเขียนการตั้งค่าคอนฟิกที่กำหนดโดยการตั้งค่าแอปพลิเคชันในอินสแตนซ์ของ Microsoft Dynamics 365 Finance หรือ Dynamics 365 Supply Chain Management ที่เคยมีการเชื่อมโยงไว้ก่อนหน้านี้ การข้ามการปรับใช้งานชนิดนี้ต้องมีการตั้งค่าคอนฟิกพารามิเตอร์ที่กําหนดด้วยตนเองในการตั้งค่าแอปพลิเคชันของ Finance หรือ Supply Chain Management
    - **สภาพแวดล้อมการบริการ** – รายการนี้จะปรับใช้งานรุ่นของคุณลักษณะการออกใบแจ้งหนี้อิเล็กทรอนิกกับสภาพแวดล้อมการบริการ การออกใบแจ้งหนี้อิเล็กทรอนิกส์พร้อมแล้วที่จะรับและประมวลผลเอกสารอิเล็กทรอนิกส์ที่ Finance หรือ Supply Chain Management ส่ง
