...
ส่วนนี้จะเสริมส่วน [การตั้งค่าคอนฟิกเฉพาะประเทศของการตั้งค่าแอปพลิเคชัน](e-invoicing-get-started.md#country-specific-configuration-of-application-setup) ของหัวข้อ "เริ่มต้นใช้งานการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์"
