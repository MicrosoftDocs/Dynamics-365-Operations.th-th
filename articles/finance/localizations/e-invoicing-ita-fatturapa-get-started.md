...
- เพิ่มลิงก์จากใบรับรองที่ต้องการลงในสภาพแวดล้อมบริการ ใบรับรองที่ต้องใช้ ได้แก่ ใบรับรองลายเซ็นดิจิทัล ผู้ให้บริการออกใบรับรอง (CA) และใบรับรองของไคลเอ็นต์ สำหรับข้อมูลเพิ่มเติม ให้ดูที่ส่วน [สร้างข้อมูลลับของใบรับรองดิจิทัล](e-invoicing-get-started-service-administration.md#create-a-digital-certificate-secret) ของบทความ "เริ่มต้นใช้งานการจัดการบริการการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์"
...
3. ในส่วน **ไปป์ไลน์การประมวลผล** ให้ไปที่การกระบวนการต่างๆ และตั้งค่าฟิลด์ที่ต้องใช้ทั้งหมดดังนี้:
    ...
    - สำหรับการดำเนินการ **ส่ง** ตั้งค่าฟิลด์ **ที่อยู่ URL** และ **ใบรับรอง** ค่าของฟิลด์ **ใบรับรอง** คือกลุ่มใบรับรอง กลุ่มแรกคือใบรับรอง CA ราก (caentrate.cer) และกลุ่มที่สองคือใบรับรองของไคลเอ็นต์
...
4. สร้างการลงทะเบียนแอปสำหรับบริการพร็อกซี SDI
    ...
    6. บันทึก **รหัสแอปพลิเคชัน** (รหัสไคลเอ็นต์) และค่า **รหัสออบเจ็กต์** ของแอป
...
3. ตั้งค่าคอนฟิกบริการ
    ...
    2. ในโฟลเดอร์ **src\\FattureService** ให้เปิดไฟล์ **appsettings.json** และตั้งค่าพารามิเตอร์ต่อไปนี้:
        ...
        - **KeyVaultUri** – ระบุที่อยู่ของ Key Vault ที่จัดเก็บใบรับรองของไคลเอ็นต์สำหรับบริการการออกใบแจ้งหนี้
...
17. เลือกกล่องกาเครื่องหมาย **ต้องการ SSL** จากนั้นในกลุ่มฟิลด์ **ใบรับรองของไคลเอ็นต์** ให้เลือกตัวเลือก **ต้องการ**
