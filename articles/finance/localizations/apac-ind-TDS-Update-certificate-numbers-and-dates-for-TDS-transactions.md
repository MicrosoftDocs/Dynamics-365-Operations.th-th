---
title: อัปเดตหมายเลขและวันที่ในใบรับรองสำหรับธุรกรรม TDS
description: บทความนี้อธิบายวิธีการอัพเดตหมายเลขและวันที่ของใบรับรองที่จะได้รับคืน ซึ่งถูกบันทึกสำหรับผู้จัดจำหน่าย ลูกค้า และบัญชีแยกประเภท สำหรับภาษีที่หักที่ต้นทาง (TDS)
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8904454"
---
# <a name="update-certificate-numbers-and-dates-for-tds-transactions"></a>อัปเดตหมายเลขและวันที่ในใบรับรองสำหรับธุรกรรม TDS

[!include [banner](../includes/banner.md)]

บทความนี้อธิบายวิธีการอัพเดตหมายเลขและวันที่ของใบรับรองที่จะได้รับคืน ซึ่งถูกบันทึกสำหรับผู้จัดจำหน่าย ลูกค้า และบัญชีแยกประเภท สำหรับภาษีที่หักที่ต้นทาง (TDS) คุณสามารถดูใบรับรองสำหรับธุรกรรม TDS ในหน้า **ใบรับรองที่จะได้รับคืน** คุณสามารถอัพเดตใบรับรองได้โดยใช้หน้า **อัพเดตใบรับรอง**
