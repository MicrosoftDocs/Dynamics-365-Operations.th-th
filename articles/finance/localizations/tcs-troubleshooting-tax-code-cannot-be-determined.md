...
description: บทความนี้อธิบายวิธีการแก้ไขข้อผิดพลาด "ไม่สามารถกําหนดรหัสภาษี" ของบริการคํานวณภาษี
author: hangwan
ms.date: 03/25/2022
...
ms.locfileid: "8877872"
---
# <a name="tax-code-cannot-be-determined"></a>ไม่สามารถกําหนดรหัสภาษี

[!include [banner](../includes/banner.md)]

บทความนี้อธิบายขั้นตอนการแก้ไขปัญหาที่คุณสามารถทำได้หากคุณได้รับข้อผิดพลาด "ไม่สามารถกําหนดรหัสภาษี" ของบริการคํานวณภาษี
...
1. ดำเนินการตามแต่ละขั้นตอนในส่วน [แก้ไขปัญหา](#troubleshoot) ของบทความนี้ และแก้ไขการตั้งค่าได้ตามที่ต้องการ ถ้ากําหนดกลุ่มภาษีและกลุ่มภาษีสินค้าไม่ถูกต้อง ให้ดู [ไม่พบผลลัพธ์ที่ตรงกัน](tcs-troubleshooting-no-matching-result.md)
