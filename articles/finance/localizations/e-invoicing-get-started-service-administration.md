...
2. ในโครงการ บนแดชบอร์ดสภาพแวดล้อม ให้เลือกโครงการปรับใช้ LCS ของคุณ โครงการที่คุณเลือกต้องรันอยู่
...
6. ในเขตข้อมูล **รหัสผู้เช่า AAD** ป้อนรหัสผู้เช่าของบัญชีสมัครสมาชิก Azure ของคุณ
...
6. ในเขตข้อมูล **ข้อมูลลับของที่จัดเก็บโทเค็น SAS** ให้เลือกชื่อของความลับของบัญชีจัดเก็บที่ต้องใช้เพื่อตรวจสอบสิทธิ์ในการเข้าถึงบัญชีที่เก็บข้อมูล
...
### <a name="enable-flighting-keys"></a>เปิดใช้งานคีย์การสลับ

เปิดใช้งานคีย์การสลับสำหรับ Microsoft Dynamics 365 Finance หรือ Microsoft Dynamics 365 Supply Chain Management รุ่น 10.0.17 หรือรุ่นก่อนหน้า 
...
2. ปฏิบัติการตามคำสั่ง IISreset สำหรับของ AOS ทั้งหมด
