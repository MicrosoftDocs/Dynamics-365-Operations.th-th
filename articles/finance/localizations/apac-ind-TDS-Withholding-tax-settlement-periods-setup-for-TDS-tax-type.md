---
title: ตั้งค่าระยะเวลาการชำระภาษีหัก ณ ที่จ่ายสำหรับชนิดภาษี TDS
description: บทความนี้อธิบายวิธีการตั้งค่ารอบระยะเวลาการชำระเงินสำหรับระยะเวลาการชำระเงินของภาษีที่หักที่ต้นทาง (TDS)
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8846568"
---
# <a name="set-up-withholding-tax-settlement-periods-for-the-tds-tax-type"></a>ตั้งค่าระยะเวลาการชำระภาษีหัก ณ ที่จ่ายสำหรับชนิดภาษี TDS

[!include [banner](../includes/banner.md)]

บทความนี้อธิบายวิธีการตั้งค่ารอบระยะเวลาการชำระเงินสำหรับระยะเวลาการชำระเงินของภาษีที่หักที่ต้นทาง (TDS)
