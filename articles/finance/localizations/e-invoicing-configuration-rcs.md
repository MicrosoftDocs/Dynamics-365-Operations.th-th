...
ms.locfileid: "7779681"
---
# <a name="configure-electronic-invoicing-in-regulatory-configuration-services-rcs"></a>ตั้งค่าคอนฟิกการออกใบแจ้งหนี้อิเล็กทรอนิกส์ใน Regulatory Configuration Services (RCS)

[!include [banner](../includes/banner.md)]

หัวข้อนี้มีข้อมูลเกี่ยวกับความสามารถในการตั้งค่าคอนฟิกของการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ใน Dynamics 365 Regulatory Configuration Services (RCS)

ซึ่งจะผ่านความสามารถในการตั้งค่าคอนฟิกที่การออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ช่วยคุณในการปฏิบัติตามข้อกําหนดทางธุรกิจและระเบียบบังคับของใบแจ้งหนี้อิเล็กทรอนิกส์ โดยไม่ต้องกําหนดรหัสใดๆ และในสถานการณ์ที่ใบแจ้งหนี้ทางอิเล็กทรอนิกส์ต้องได้รับการอนุมัติทางอิเล็กทรอนิกส์โดยเว็บผู้ให้บริการ ความสามารถในการตั้งค่าคอนฟิกยังช่วยคุณในการปฏิบัติตามข้อกําหนดสำหรับการแลกเปลี่ยนข้อความกับเว็บผู้ให้บริการ โดยไม่ต้องกําหนดรหัสใดๆ

## <a name="electronic-reporting"></a>การรายงานทางอิเล็กทรอนิกส์

การรายงานทางอิเล็กทรอนิกส์ (ER) สนับสนุนการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์

การแม็ปรูปแบบข้อมูลและรูปแบบเป็นส่วนประกอบที่ตั้งค่าคอนฟิกได้ ซึ่งถูกสร้างขึ้นและเก็บรักษาโดยใช้ ER และถูกใช้ในการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ ตัวออกแบบรูปแบบ ER คือเครื่องมือในการสร้างและการรักษารูปแบบไฟล์ ซึ่งใช้ในการตั้งค่าคอนฟิกคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์
...
### <a name="generally-available-features"></a>คุณลักษณะการพร้อมใช้งานโดยทั่วไป

ตารางต่อไปนี้แสดงคุณลักษณะการการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ที่พร้อมใช้งานโดยทั่วไป
...
| บราซิล         | การนําเข้า NF-e ของบราซิลจากอีเมล (BR) | แบบจำลองเอกสารทางการเงิน 55 |
...
| ยุโรป         | ใบแจ้งหนี้ของผู้จัดจำหน่าย PEPPOL                | ใบแจ้งหนี้ของผู้จัดจำหน่ายในการนําเข้าของ PEPPOL |
| ซาอุดีอาระเบีย   | ใบแจ้งหนี้ทางอิเล็กทรอนิกส์ของซาอุดีอาระเบีย (SA)| ใบแจ้งหนี้การขายและใบแจ้งหนี้โครงการ |
...
- **รูปแบบ**: รูปแบบช่วยให้คุณสามารถตั้งค่าคอนฟิกสิ่งที่การออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ต้องสร้าง เมื่อเอกสารอิเล็กทรอนิกส์กลายเป็นใบแจ้งหนี้อิเล็กทรอนิกส์ รูปแบบจะรวมการตั้งค่าคอนฟิกรูปแบบของใบแจ้งหนี้อิเล็กทรอนิกส์ และสำหรับไฟล์และข้อความที่ใช้ในการส่งการร้องขอและรับการตอบสนอง เมื่อต้องมีการสื่อสารกับบริการเว็บภายนอก
- **การดำเนินการ**: การดำเนินการช่วยให้คุณสามารถตั้งค่าคอนฟิกวิธีการที่การออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์สร้างการแปลงเอกสารอิเล็กทรอนิกส์ที่ Finance และ Supply Chain Management ส่งเข้าสู่ใบแจ้งหนี้อิเล็กทรอนิกส์
- **กฎการนำไปใช้ได้**: กฎการนำไปใช้ได้ช่วยให้คุณสามารถตั้งค่าคอนฟิกบริบทที่การออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ต้องพิจารณา เพื่อประมวลผลคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์
- **ตัวแปร**: ตัวแปรช่วยให้คุณสามารถตั้งค่าคอนฟิกการสนับสนุนสำหรับการสร้างตรรกะการตั้งค่าคอนฟิกได้ ตัวแปรสามารถใช้เป็นข้อมูลป้อนเข้าของค่าเพื่อทำการดำเนินการเฉพาะ หรือสามารถทำงานเป็นการแลกเปลี่ยนค่าระหว่าง Finance และ Supply Chain Management และการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์
- **การแม็ปแบบจำลองเอกสารอิเล็กทรอนิกส์**: การแม็ปแบบจำลองเอกสารอิเล็กทรอนิกส์ช่วยให้คุณสามารถตั้งค่าคอนฟิกการแม็ปแบบจำลอง ER ได้ การแม็ปแบบจำลองจะกําหนดการแม็ปข้อมูลของใบแจ้งหนี้นามธรรมที่ถูกรวมไว้ในการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ เมื่อมีการส่งเอกสารอิเล็กทรอนิกส์
...
- **ชนิดการตอบสนอง**: ชนิดการตอบสนองช่วยให้คุณสามารถตั้งค่าคอนฟิกสิ่งที่การออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ต้องอัพเดตใน Finance และ Supply Chain Management เป็นผลลัพธ์ของการประมวลผลใบแจ้งหนี้ทางอิเล็กทรอนิกส์
...
#### <a name="saudi-arabian-sa-electronic-invoice-sales-and-project-invoices-for-saudi-arabia"></a>ใบแจ้งหนี้อิเล็กทรอนิกส์ของซาอุดิอาระเบีย (SA): ใบแจ้งหนี้การขายและโครงการสำหรับซาอุดิอาระเบีย

- ใบแจ้งหนี้การขายอิเลคทรอนิคส์ (SA)
- ใบแจ้งหนี้อิเลคทรอนิคส์ของโครงการ (SA)

นอกจากการตั้งค่าคอนฟิกรูปแบบ ER ที่พร้อมใช้งานสำเร็จรูปเพื่อใช้กับบริการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์แล้ว คุณยังสามารถสร้างการตั้งค่าคอนฟิกรูปแบบ ER ของคุณเองได้ อย่างไรก็ตาม การตั้งค่าคอนฟิกรูปแบบที่สร้างขึ้นเพื่อใช้กับคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ ไม่สนับสนุนการอ้างอิงโดยตรงไปยังตารางการเงินหรือ Supply Chain Management หรือข้อมูลเมตาที่สอดคล้องกันใดๆ สนับสนุนเฉพาะการอ้างอิงไปยังการแม็ปแบบโมเดล ER เท่านั้น
...
| ลงชื่อในเอกสาร xml                             | ลงชื่อในเอกสาร xml พร้อมด้วยลายเซ็นดิจิทัล                                   | พร้อมใช้งานโดยทั่วไป  |
| ลงชื่อในเอกสาร json สำหรับหน่วยงานด้านภาษีของอียิปต์ | ลงชื่อในเอกสาร json พร้อมด้วยลายเซ็นดิจิทัลสำหรับหน่วยงานจัดเก็บภาษีของอียิปต์       | พร้อมใช้งานโดยทั่วไป  |
| รวมกับบริการ ETA ของอียิปต์           | สื่อสารกับหน่วยงานจัดเก็บภาษีของอียิปต์                                     | พร้อมใช้งานโดยทั่วไป  |
| เรียกบริการ Brazilian SEFAZ                  | รวมกับบริการ SEFAZ ของบราซิลเพื่อการส่งเอกสารทางการเงิน       | พร้อมใช้งานโดยทั่วไป  |
...
กฎการใช้งานคืออนุประโยคที่สามารถตั้งค่าคอนฟิกได้ ซึ่งกําหนดในระดับลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ กฎได้รับการตั้งค่าคอนฟิกเพื่อให้บริบทเกี่ยวกับการปฏิบัติการคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์โดยผ่านชุดความสามารถการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์

เมื่อเอกสารทางธุรกิจจากฝ่ายการเงินหรือ Supply Chain Management ถูกส่งไปยังการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ เอกสารธุรกิจจะไม่มีการอ้างอิงที่ชัดเจน ซึ่งอนุญาตให้ตั้งค่าความสามารถการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์เพื่อเรียกใช้คุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์เฉพาะเพื่อประมวลผลการส่ง

อย่างไรก็ตาม เมื่อตั้งค่าคอนฟิกอย่างถูกต้อง เอกสารธุรกิจจะมีองค์ประกอบที่จําเป็นที่อนุญาตให้ออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์แก้ไขปัญหาว่าต้องเลือกคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ใด แล้วจึงสร้างใบแจ้งหนี้อิเล็กทรอนิกส์

กฎการใช้งานอนุญาตให้ตั้งค่าความสามารถออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์เพื่อค้นหาคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ที่แน่นอนซึ่งต้องใช้ในการประมวลผลการส่ง โดยการจับคู่เนื้อหาจากเอกสารทางธุรกิจที่ส่งกับอนุประโยคจากกฎการใช้งาน

ตัวอย่างเช่น คุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์สองรายการที่มีกฎการใช้งานที่เกี่ยวข้องจะถูกปรับใช้ไว้ในชุดความสามารถการออกใบแจ้งหนี้อิเล็กทรอนิกส์

| คุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ | กฎการนำไปใช้ได้        |
|------------------------------|--------------------------- |
| A                            | <p>ประเทศ = BR</p><p>และ</p><p>นิติบุคคล = BRMF</p>  |
| B                            | <p>ประเทศ = MX</p><p>และ</p><p>นิติบุคคล = MXMF</p>  |

หากเอกสารทางธุรกิจจากฝ่ายการเงินหรือ Supply Chain Management ถูกส่งไปยังชุดความสามารถการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ เอกสารธุรกิจจะมีแอททริบิวต์ต่อไปนี้

- ประเทศ = BR
- นิติบุคคล = BRMF

ชุดความสามารถออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์จะเลือกคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ **A** เพื่อประมวลผลการส่งและสร้างใบแจ้งหนี้อิเล็กทรอนิกส์

ในลักษณะเดียวกัน หากเอกสารทางธุรกิจประกอบด้วย:

- ประเทศ = MX
- นิติบุคคล = MXMF

คุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ **B** ถูกเลือกเพื่อสร้างใบแจ้งหนี้อิเล็กทรอนิกส์

การตั้งค่าคอนฟิกของกฎการใช้งานต้องไม่ชัดเจน ซึ่งหมายความว่าคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์สองรายการหรือมากกว่าไม่สามารถมีอนุประโยคเดียวกันได้ มิฉะนั้นลักษณะการออกใบแจ้งหนี้นี้จะไม่มีการเลือก ถ้ามีการทำซ้ำลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ เพื่อหลีกเลี่ยงความคลุมเครือ ให้ใช้อนุประโยคเพิ่มเติมเพื่ออนุญาตให้ตั้งค่าความสามารถการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์เพื่อแยกแยะระหว่างลักษณะการงานการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์สองลักษณะ

ตัวอย่างเช่น พิจารณาลักษณะการคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ **C** คุณลักษณะนี้เป็นสําเนาของลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ **A**

| คุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ | กฎการนำไปใช้ได้        |
|------------------------------|--------------------------- |
| A                            | <p>ประเทศ = BR</p><p>และ</p><p>นิติบุคคล = BRMF</p>  |
| C                            | <p>ประเทศ = BR</p><p>และ</p><p>นิติบุคคล = BRMF</p>  |

ในตัวอย่างนี้ คุณลักษณะ **C** อยู่หน้าการส่งเอกสารทางธุรกิจที่ประกอบด้วยสิ่งต่อไปนี้:

- ประเทศ = BR
- นิติบุคคล = BRMF

ความสามารถการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ไม่สามารถแยกแยะว่าต้องใช้คุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ใดเพื่อประมวลผลการส่ง เนื่องจากการส่งมีอนุประโยคที่เหมือนกันทุกข้อ

หากต้องการสร้างความแตกต่างระหว่างลักษณะการใช้งานสองลักษณะผ่านกฎการใช้งาน คุณต้องเพิ่มอนุประโยคใหม่เข้าในหนึ่งในลักษณะการคุณลักษณะเพื่ออนุญาตให้ตั้งค่าความสามารถออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์เพื่อเลือกลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ที่เหมาะสมได้

| คุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ | กฎการนำไปใช้ได้        |
|------------------------------|--------------------------- |
| A                            | <p>ประเทศ = BR</p><p>และ</p><p>นิติบุคคล = BRMF</p>  |
| C                            | <p>ประเทศ = BR</p><p>และ</p><p>นิติบุคคล = BRMF</p><p>และ</p><p>แบบจำลอง=55</p>  |

เพื่อสนับสนุนการสร้างอนุประโยคที่ซับซ้อนมากขึ้น ทรัพยากรที่พร้อมใช้งานมีดังนี้:

ตัวดำเนินการตามตรรกะ:
- และ
- หรือ
...
ความสามารถในการจัดกลุ่มและยกเลิกการจัดกลุ่มอนุประโยค
ตัวอย่างมีลักษณะดังนี้

| คุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์ | กฎการนำไปใช้ได้        |
|------------------------------|--------------------------- |
| C                            | <p>ประเทศ = BR</p><p>และ</p><p>( นิติบุคคล = BRMF</p><p>หรือ</p><p>แบบจำลอง=55)</p>  |
...
- **เผยแพร่แล้ว** – ถ้ารุ่นของคุณลักษณะอยู่ในสถานะนี้ ได้มีการเผยแพร่ไปยังการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์แล้ว คุณไม่สามารถแก้ไขรุ่นของคุณลักษณะหรือส่วนประกอบ ER ใดๆ ได้อีกต่อไป
...
- **สภาพแวดล้อมบริการ** – เมื่อเป้าหมายของการปรับใช้เป็นสภาพแวดล้อมบริการ รุ่นของคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์จะถูกเผยแพร่ไปยังสภาพแวดล้อมบริการ การออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์พร้อมแล้วที่จะรับและประมวลผลเอกสารอิเล็กทรอนิกส์ที่ Finance และ Supply Chain Management ส่ง
...
ใน RCS คุณใช้คำสั่ง **ยกเลิกปรับใช้** เพื่อลบรุ่นของคุณลักษณะการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์เฉพาะออกจากสภาพแวดล้อมบริการในการออกใบแจ้งหนี้ทางอิเล็กทรอนิกส์
