...
ตารางต่อไปนี้แสดงฟิลด์ที่รวมอยู่ในการรายงานอินทราสแทตภาษาฝรั่งเศสในรูปแบบ INSUNIC 330 ตารางยังบ่งชี้ระดับรายงานของฟิลด์ด้วย ฟิลด์อาจเป็น **4** (แบบง่าย) **1** (เต็ม) หรือทั้งสองอย่าง

| **ฟิลด์**                   | **ระดับรายงาน** |
|-----------------------------|------------------|
| รอบระยะเวลาของการอ้างอิง         | 4, 1              | 
| จำนวนของการรายงาน       | 4, 1              |
| หมายเลขรายการ                 | 4, 1              |
| รหัสประเทศ ISO (FR)       | 4, 1              | 
| รหัสเพิ่มเติม          | 4, 1              | 
| หมายเลข Siren                | 4, 1              | 
| รหัส VAT ของลูกค้า        | 4, 1              | 
| รหัสคำสั่ง              | 4, 1              |
| ชนิดธุรกรรม            | 4, 1              | 
| ระดับข้อผูกมัด            | 4, 1              |
| รหัสโภคภัณฑ์              | 1                | 
...
| ชนิดของธุรกรรม       | 1                | 
| ประเทศของผู้ผลิต      | 1                | 
| ประเทศของผู้ผลิต - นำเข้า | 1                | 
| ปลายทางสุดท้าย - ส่งออก | 1                | 
| มูลค่าในใบแจ้งหนี้               | 4, 1              | 
| ค่าทางสถิติ           | 1                |
| น้ำหนักสุทธิ                  | 1                | 
| หน่วยเพิ่มเติม            | 1                |
| รหัสการขนส่ง              | 1                | 
...
ตารางยังบ่งชี้ระดับรายงานของฟิลด์ด้วย ฟิลด์อาจเป็น **4** (แบบง่าย) **1** (เต็ม) หรือทั้งสองอย่าง
...
2.  ใน Dynamics 365 Finance ให้ไปที่ **ภาษี** > **การตั้งค่า** >  **การค้าต่างประเทศ** > **พารามิเตอร์การค้าต่างประเทศ** และปฏิบัติตามขั้นตอนต่อไปนี้:
    ...
    6. ในฟิลด์ **ระดับข้อผูกมัดของการส่งออก** ให้ป้อนระดับของรายละเอียดเกี่ยวกับรายงานการส่งออก ระดับที่คุณเลือกจะมีผลกระทบต่อบรรทัดที่แสดงในรายงาน สำหรับข้อมูลเพิ่มเติม ให้ดูที่ตารางที่ช่วงเริ่มต้นของบทความนี้
...
8.  สร้างรายงาน DEB:
    ...
    1. ไปที่ **ภาษี** > **ประกาศต่างๆ** > **การค้าต่างประเทศ** > **อินทราสแทต**:
