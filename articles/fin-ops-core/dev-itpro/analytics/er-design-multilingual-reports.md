...
เมื่อคุณตั้งค่าคอนฟิกแบบจำลองข้อมูล ER คุณสามารถเพิ่มป้ายชื่อ ER ได้ แอททริบิวต์ **ป้ายชื่อ** และ **คำอธิบาย** ของรายการแบบจำลอง ฟิลด์ของแบบจำลองทั้งหมด และค่าการแจงนับแบบจำลอง <a id="LinkModelEnum"></a>ทั้งหมดสามารถเชื่อมโยงกับป้ายชื่อ ER ซึ่งถูกเพิ่มเข้าในแบบจำลองข้อมูล ER ได้

![การให้การแปลสำหรับแอททริบิวต์คำอธิบายในโปรแกรมออกแบบแบบจำลองข้อมูล ER](./media/er-multilingual-labels-refer.png)
...
> [!NOTE]
> นอกจากนี้ คุณยังสามารถเชื่อมโยงแอททริบิวต์เหล่านี้ไปยังป้ายชื่อ ER ของแบบจำลองข้อมูล ER หลัก ซึ่งใช้ป้ายชื่อของแบบจำลองซ้ำในรูปแบบ ER ทุกรูปแบบที่มีการตั้งค่าคอนฟิกสำหรับแบบจำลองข้อมูล ER นี้
