...
เมื่อต้องการเรียนรู้เพิ่มเติมเกี่ยวกับคุณลักษณะนี้ ให้ดำเนินการตัวอย่างในหัวข้อนี้ให้เสร็จสมบูรณ์ ตัวอย่างนี้แสดงวิธีการอัพเดตแม่แบบ เพื่อกรอกข้อมูลในฟิลด์ในฟอร์มใบแจ้งหนี้ข้อความอิสระที่สร้างขึ้น
...
1.  ลงชื่อเข้าใช้อินสแตนซ์ของ Microsoft Dynamics 365 Finance เป็นผู้ดูแลระบบ
2.  ดำเนินการขั้นตอนต่อไปนี้ให้เสร็จสมบูรณ์จากตัวอย่างในหัวข้อ [ภาพรวมของการจัดการเอกสารทางธุรกิจ](er-business-document-management.md):
