...
---
# <a name="NUMSEQVALUE">ฟังก์ชัน NUMSEQVALUE ER</a>
...
ในรูปแบบ ER ของคุณ คุณสามารถกำหนดแหล่งข้อมูล **AskNumSeq** ของชนิด *พารามิเตอร์ป้อนเข้าของผู้ใช้* แหล่งข้อมูลนี้อ้างอิงถึงชนิดข้อมูลแบบขยาย (EDT) ของ **คำอธิบาย** ถัดไป คุณกำหนดแหล่งข้อมูล **NumSeq** ของชนิดของ *ฟิลด์ที่คำนวณได้* แหล่งข้อมูลนี้ประกอบด้วยนิพจน์ `NUMSEQVALUE (AskNumSeq)` เมื่อแหล่งข้อมูล **NumSeq** ถูกเรียก จะส่งกลับค่าที่สร้างขึ้นใหม่ของลำดับหมายเลขที่ระบุไว้ในขณะทำงานโดยการป้อนรหัสในกล่องโต้ตอบ มีการร้องขอลำดับหมายเลขสำหรับชนิดขอบเขตของ **บริษัท** รหัสบริษัทจะถูกจัดหาโดยบริบทที่มีการรันรูปแบบ ER
...
- แหล่งข้อมูล **NumSeq** ของชนิดของ *ฟิลด์ที่คำนวณได้* แหล่งข้อมูลนี้ประกอบด้วยนิพจน์ `NUMSEQVALUE ( LedgerParameters.'numRefJournalNum()'.NumberSequenceId)`
...
- แหล่งข้อมูล **NumSeq** ของชนิดของ *ฟิลด์ที่คำนวณได้* แหล่งข้อมูลนี้ประกอบด้วยนิพจน์ `NUMSEQVALUE ("Gene_1", enumScope.Company, "")`
