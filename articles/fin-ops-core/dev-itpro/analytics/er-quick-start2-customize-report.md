...
รุ่น 1.1.1 ของการตั้งค่าคอนฟิกรูปแบบ ER **BACS (UK แบบกำหนดเอง)** ถูกสร้างขึ้น รุ่นนี้มีสถานะของ **แบบร่าง** และสามารถแก้ไขได้ เนื้อหาปัจจุบันของรูปแบบ ER แบบกำหนดเองของคุณตรงกับเนื้อหาของรูปแบบที่ Microsoft ให้ไว้
