...
description: หัวข้อนี้จะให้ข้อมูลเกี่ยวกับวิธีการออกแบบรูปแบบการรายงานทางอิเล็กทรอนิกส์ (ER) ที่จะกรอกข้อมูลในเทมเพลต PDF
author: NickSelin
ms.date: 02/28/2022
ms.topic: article
ms.prod: ''
...
- ถ้าแอททริบิวต์ **ชื่อ** ว่างเปล่า และนิพจน์ **ชื่อ** ส่งคืนสตริงที่ว่างเปล่าในเวลาที่ใช้งาน ข้อยกเว้นจะเกิดขึ้นในเวลาที่ใช้เพื่อแจ้งเตือนผู้ใช้ว่าไม่พบฟิลด์ PDF ในเทมเพลต PDF ที่ใช้ในการกรอกข้อมูลในเอกสาร PDF
