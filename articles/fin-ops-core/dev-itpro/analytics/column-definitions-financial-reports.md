...
1. ใน Report Designer คลิก **คำนิยามคอลัมน์** แล้วเปิดคำนิยามคอลัมน์เพื่อแก้ไข
...
คุณสามารถใช้กล่องโต้ตอบ **ส่วนหัวของคอลัมน์** เพื่อเพิ่ม แก้ไข และลบส่วนหัวที่ปรากฏที่ด้านบนของคอลัมน์ในรายงาน ตารางต่อไปนี้อธิบายถึงฟิลด์ในกล่องโต้ตอบ **ส่วนหัวของคอลัมน์**

| ฟิลด์                 | คำอธิบาย |
|-----------------------|-------------|
| ข้อความส่วนหัวของคอลัมน์    | ข้อความนี้ปรากฏในส่วนหัวของคอลัมน์ คุณสามารถพิมพ์ข้อความโดยตรงลงในฟิลด์นี้ หรือคลิก **แทรกข้อความอัตโนมัติ** เพื่อเลือกตัวเลือกที่อัปเดตส่วนหัวของคอลัมน์ทุกครั้งที่มีการสร้างรายงาน เพื่อรวมหลายรหัสข้อความอัตโนมัติ คลิก **แทรกข้อความอัตโนมัติ** อีกครั้ง แล้วคลิกรหัสอื่นในรายการ |
...
เซลล์ **ควบคุมการพิมพ์** สามารถประกอบด้วยรหัสที่ปรับปรุงการแสดงผล หรือคุณลักษณะการพิมพ์ของคอลัมน์ รหัสควบคุมการพิมพ์มีอยู่สองชนิด: รหัสควบคุมการพิมพ์แบบปกติ และรหัสตัวควบคุมการพิมพ์แบบมีเงื่อนไข
...
1. ใน Report Designer เปิดคำนิยามคอลัมน์เพื่อแก้ไข
2. ดับเบิลคลิกที่เซลล์ **ควบคุมการพิมพ์**
...
> [!TIP]
> คุณยังสามารถป้อนรหัสการพิมพ์โดยตรงในเซลล์ **ควบคุมการพิมพ์** แยกหลายรหัสควบคุมการพิมพ์ด้วยเครื่องหมายจุลภาค
...
1. ใน Report Designer เปิดคำนิยามคอลัมน์เพื่อแก้ไข
2. ในคอลัมน์ที่เหมาะสม ดับเบิลคลิกที่เซลล์ในแถว **ชนิดคอลัมน์**
...
1. ใน Report Designer เปิดคำนิยามคอลัมน์เพื่อแก้ไข
2. ในคอลัมน์ **FD** ดับเบิลคลิกที่เซลล์ในแถว **รอบระยะเวลาที่ครอบคลุม** และเลือกตัวเลือกในรายการ

### <a name="attribute-filter-in-a-column-definition"></a>ตัวกรองแอตทริบิวต์ในคำนิยามคอลัมน์

แอตทริบิวต์เป็นค่าข้อมูลทางการเงินที่กำหนดบัญชี หรือธุรกรรมเพิ่มเติม แอตทริบิวต์บัญชีรวม **สินทรัพย์** **หนี้สิน** **รายได้** และ **ค่าใช้จ่าย** แอตทริบิวต์ธุรกรรมรวม **คำอธิบายธุรกรรม** และ **วันที่ใช้ในธุรกรรม** การสนับสนุนแอตทริบิวต์อาจแตกต่างกันระหว่าง Microsoft Dynamics 365 Finanace เซลล์ **ตัวกรองแอตทริบิวต์** จำกัดข้อมูลในคอลัมน์ **FD** ไปยังค่าหรือช่วงที่เฉพาะสำหรับประเภทแอตทริบิวต์ ถึงแม้ว่าคุณลักษณะนี้สามารถใช้ร่วมกับคอลัมน์ **ATTR** แต่คอลัมน์ **ATTR** ไม่จำเป็นต้องใช้ ในคอลัมน์ **ดีมอนตัวกรอง** มีขีดจำกัดในบัญชี หรือธุรกรรมที่รายงานจะรวมจากตัวกรองแอตทริบิวต์
...
1. ใน Report Designer เปิดคำนิยามคอลัมน์เพื่อแก้ไข
2. ดับเบิลคลิกที่เซลล์ **ตัวกรองแอตทริบิวต์** สำหรับคอลัมน์ **FD**
3. ในกล่องโต้ตอบ **ตัวกรองแอตทริบิวต์** ดับเบิลคลิกที่เซลล์ในคอลัมน์ **แอตทริบิวต์** จากนั้น เลือกชนิดตัวกรอง
...
1. ใน Report Designer เปิดคำนิยามคอลัมน์เพื่อแก้ไข
2. ดับเบิลคลิกที่เซลล์ **ตัวกรองมิติ** สำหรับคอลัมน์ **FD**
...
1. ใน Report Designer เปิดคำนิยามคอลัมน์เพื่อแก้ไข
2. ดับเบิลคลิกที่เซลล์ **การแสดงสกุลเงิน** ในคอลัมน์ **FD** ที่เหมาะสม และจากนั้นเลือกตัวเลือกสำหรับการแสดงข้อมูลสกุลเงิน: **สกุลเงินทางบัญชีของบัญชีแยกประเภท** **การรายงานบัญชีแยกประเภท** สกุลเงินธุรกรรม หรือเลือกที่จะแปลเป็นสกุลเงินการรายงานที่แตกต่างกัน
...
### <a name="example-for-currency-display-and-currency-filter-cells"></a>ตัวอย่างสำหรับเซลล์การแสดงสกุลเงิน และตัวกรองสกุลเงิน
