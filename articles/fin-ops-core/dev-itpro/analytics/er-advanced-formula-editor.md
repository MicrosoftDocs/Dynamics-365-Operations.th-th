...
[![กล่องโต้ตอบพารามิเตอร์ผู้ใช้ เปิดใช้งานพารามิเตอร์เครื่องมือแก้ไขสูตรขั้นสูงที่เน้น](./media/ER-AdvEditor-Activate.png)](./media/ER-AdvEditor-Activate.png)

> [!NOTE]
> พึงระวังว่าพารามิเตอร์นี้เฉพาะผู้ใช้และเฉพาะบริษัท

เริ่มต้นใน Microsoft Dynamics 365 Finance รุ่น 10.0.19 คุณสามารถควบคุมตัวแก้ไขสูตร ER ที่เสนอไว้ตามค่าเริ่มต้น ปฏิบัติตามขั้นตอนต่อไปนี้เพื่อเปิดใช้งานตัวแก้ไขสูตรขั้นสูงของผู้ใช้และบริษัททั้งหมดของอินสแตนซ์การเงินปัจจุบัน

1.  เปิดพื้นที่ทำงาน **การจัดการคุณลักษณะ**
2.  ค้นหาและเลือกคุณลักษณะ **ตั้งค่าเครื่องมือแก้ไขขั้นสูง ER เป็นเครื่องมือเริ่มต้นของผู้ใช้ทั้งหมด** ในรายการ แล้วเลือก **เปิดใช้งานทันที**
3.  ไปที่ **การจัดการองค์กร** > **การรายงานทางอิเล็กทรอนิกส์** > **การตั้งค่าคอนฟิก**
4.  ในหน้า **การตั้งค่าคอนฟิก** บนบานหน้าต่างการดำเนินการ บนแท็บ **การตั้งค่าคอนฟิก** ในกลุ่ม **การตั้งค่าล่วงหน้า** เลือก **พารามิเตอร์ผู้ใช้**
5.  ในกล่องโต้ตอบ **พารามิเตอร์ผู้ใช้** ให้ค้นหาพารามิเตอร์ **ปิดใช้งานเครื่องมือแก้ไขสูตรขั้นสูง** และตรวจสอบว่ามีการตั้งค่าเป็น **ไม่**

[![กล่องโต้ตอบพารามิเตอร์ผู้ใช้ ปิดใช้งานพารามิเตอร์เครื่องมือแก้ไขสูตรขั้นสูงที่เน้น](./media/ER-AdvEditor-Activate2.png)](./media/ER-AdvEditor-Activate2.png)

> [!NOTE]
> ค่าของพารามิเตอร์ **เปิดใช้งานเครื่องมือแก้ไขสูตรขั้นสูง** และ **ปิดใช้งานเครื่องมือแก้ไขสูตรขั้นสูง** จะถูกแยกไว้โดยผู้ใช้แต่ละคน และเสนอในกล่องโต้ตอบ **พารามิเตอร์ผู้ใช้** ทั้งนี้ขึ้นอยู่กับสถานะของคุณลักษณะ **ตั้งค่าเครื่องมือแก้ไขขั้นสูง ER เป็นเครื่องมือเริ่มต้นของผู้ใช้ทั้งหมด**
...
[![GIF เครื่องมือแก้ไขสูตรขั้นสูง ER ที่แสดงรายการที่เลือกและการเปลี่ยนการเยื้อง](./media/ER-AdvEditor-Indentation.gif)](./media/ER-AdvEditor-Indentation.gif)
...
[![GIF เครื่องมือแก้ไขสูตรขั้นสูง ER ที่แสดงการทริกเกอร์ IntelliSense](./media/ER-AdvEditor-Intelisense.gif)](./media/ER-AdvEditor-Intelisense.gif)
...
[![GIF เครื่องมือแก้ไขสูตรขั้นสูง ER ที่แสดงเครื่องมือแก้ไขที่ให้การเสร็จสมบูรณ์ของรหัสโดยอัตโนมัติ](./media/ER-AdvEditor-CodeCompletion.gif)](./media/ER-AdvEditor-CodeCompletion.gif)
...
[![GIF เครื่องมือแก้ไขสูตรขั้นสูง ER ที่แสดงวิธีการระบุที่ตั้งส่วนของนิพจน์โดยใช้ชุดแบบสีของข้อความสั่ง](./media/ER-AdvEditor-Goto.gif)](./media/ER-AdvEditor-Goto.gif)
...
[![GIF เครื่องมือแก้ไขสูตรขั้นสูง ER ที่แสดงรหัสที่แสดง](./media/ER-AdvEditor-ToggleFold.gif)](./media/ER-AdvEditor-ToggleFold.gif)
...
[![GIF เครื่องมือแก้ไขสูตรขั้นสูง ER ที่แสดงการค้นหาและแทนที่](./media/ER-AdvEditor-Find.gif)](./media/ER-AdvEditor-Find.gif)
...
[![GIF เครื่องมือแก้ไขสูตรขั้นสูง ER ที่แสดงการเพิ่มแหล่งข้อมูลและวางฟังก์ชัน](./media/ER-AdvEditor-PasteValue.gif)](./media/ER-AdvEditor-PasteValue.gif)
...
[![เครื่องมือแก้ไขสูตร ER](./media/ER-AdvEditor-SyntaxColorization.png)](./media/ER-AdvEditor-SyntaxColorization.png)
