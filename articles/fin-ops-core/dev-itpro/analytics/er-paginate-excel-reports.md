...
description: หัวข้อนี้จะอธิบายถึงวิธีการออกแบบรูปแบบการรายงานทางอิเล็กทรอนิกส์ (ER) ที่แบ่งหน้าเอกสารที่สร้างใน Microsoft Excel
author: NickSelin
ms.date: 09/14/2021
ms.topic: article
ms.prod: ''
...
หัวข้อนี้อธิบายวิธีการของผู้ใช้ในบทบาทที่ปรึกษาด้านการทำงานการรายงานทางอิเล็กทรอนิกส์หรือผู้ดูแลระบบสามารถตั้งค่าคอนฟิกรูปแบบ [การรายงานทางอิเล็กทรอนิกส์ (ER)](general-electronic-reporting.md) เพื่อสร้างเอกสารขาออกใน Microsoft Excel และจัดการการแบ่งหน้าเอกสาร
...
สามารถดำเนินงานกระบวนงานในหัวข้อนี้ให้เสร็จสมบูรณ์ได้ในบริษัท **DEMF** ไม่จำเป็นต้องมีการเขียนโค้ด ก่อนที่คุณจะเริ่มต้น ต้องดาวน์โหลดและบันทึกไฟล์ต่อไปนี้
...
1. ปฏิบัติตามขั้นตอนในส่วน [แทนที่แม่แบบ Excel ปัจจุบันในรูปแบบ ER ที่กำหนดเอง](#replace-template) ของหัวข้อนี้ อย่างไรก็ตาม ในขั้นตอนที่ 7 ให้เลือกไฟล์ **ERIntrastatReportDemo2.xlsx**
...
1. ให้ตรวจสอบให้แน่ใจว่าคุณมี 24 ธุรกรรมบนหน้า **อินทราสแทต** ทำซ้ำขั้นตอนในส่วน [สร้างรายงานการควบคุมการรายงานภาษีอินทราสแทต](#generate-intrastat-control-report) ของหัวข้อนี้เพื่อสร้างและตรวจสอบรายงานการควบคุม
