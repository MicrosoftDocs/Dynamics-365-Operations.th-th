---
title: เลื่อนการดำเนินการขององค์ประกอบลำดับในรูปแบบการรายงานทางอิเล็กทรอนิกส์
description: บทความนี้จะอธิบายวิธีการเลื่อนการดำเนินการขององค์ประกอบลำดับในรูปแบบการรายงานทางอิเล็กทรอนิกส์ (ER)
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
...
ขั้นตอนต่อไปนี้อธิบายวิธีการที่ผู้ใช้ในผู้ดูแลระบบหรือที่ปรึกษาด้านการทำงานของการรายงานทางอิเล็กทรอนิกส์ [บทบาท](../sysadmin/tasks/assign-users-security-roles.md) สามารถตั้งค่าคอนฟิกรูปแบบ ER ที่มีองค์ประกอบลำดับซึ่งลำดับการดำเนินการแตกต่างจากใบสั่งในลำดับชั้นของรูปแบบ
...
ถ้าคุณยังไม่ได้ทำให้ตัวอย่างเสร็จสมบูรณ์ในบทความ [การเลื่อนการดำเนินการขององค์ประกอบXML ในรูปแบบ ER](er-defer-xml-element.md#Example) ให้ดาวน์โหลด [การกำหนดค่าคอนฟิก](general-electronic-reporting.md#Configuration) ต่อไปนี้ของโซลูชัน ER ตัวอย่าง
...
| การตั้งค่าคอนฟิกการแมปแบบจำลอง ER | [การแมปเพื่อเรียนรู้องค์ประกอบที่เลื่อน.เวอร์ชั่น.1.1.xml](https://download.microsoft.com/download/c/9/c/c9c4b9dd-b700-4385-a087-a84ce9fc1d0f/Mappingtolearndeferredelements.version.1.1.xml) |

ก่อนที่คุณจะเริ่มต้น คุณต้องดาวน์โหลดและบันทึกการตั้งค่าคอนฟิกต่อไปนี้ของโซลูชัน ER ตัวอย่าง

| คำอธิบายเนื้อหา     |ชื่อไฟล์ |
|-------------------------|----------|
| การตั้งค่าคอนฟิกรูปแบบ ER | [จัดรูปแบบเพื่อเรียนรู้ลำดับที่เลื่อน.เวอร์ชั่น.1.1.xml](https://download.microsoft.com/download/0/f/5/0f55c341-8285-4d92-a46d-475d9a010927/Formattolearndeferredsequences.version.1.1.xml) |
...
### <a name="review-the-imported-model-mapping"></a>ตรวจทานการแมปแบบจำลองที่นำเข้า
...
9. ตรวจสอบวิธีการผูกแหล่งข้อมูลที่ตั้งค่าคอนฟิกกับแบบจำลองข้อมูลและวิธีการที่จะเปิดเผยข้อมูลที่เข้าถึงเพื่อให้มีอยู่ในรูปแบบ ER:
    ...
    ![หน้าตัวออกแบบการแมปแบบจำลอง](./media/ER-DeferredSequence-ModelMapping.png)
...
4. บนแท็บ **การแมป** ให้ตรวจทานรายละเอียดต่อไปนี้:
    ...
    ![แท็บการแมปบนหน้าตัวออกแบบรูปแบบ](./media/ER-DeferredSequence-Format2.png)
...
2. ดาวน์โหลดไฟล์ที่เว็บเบราเซอร์นำเสนอและเปิดสำหรับการตรวจทาน
    ...
    ![ไฟล์รายงานตัวอย่างที่ดาวน์โหลด](./media/ER-DeferredSequence-Run.png)
...
13. ดาวน์โหลดแและตรวจทานไฟล์ที่เว็บเบราว์เซอร์นำเสนอ
    ...
    ![ไฟล์ที่ดาวน์โหลด - มูลค่าภาษีรวม](./media/ER-DeferredSequence-Run1.png)
...
17. ดาวน์โหลดแและตรวจทานไฟล์ที่เว็บเบราว์เซอร์นำเสนอ
    ...
    ![ไฟล์ที่ดาวน์โหลดที่มีสูตรที่แก้ไข](./media/ER-DeferredSequence-Run2.png)
...
4. ดาวน์โหลดแและตรวจทานไฟล์ที่เว็บเบราว์เซอร์นำเสนอ
    ...
    ![ไฟล์ที่ดาวน์โหลดเพื่อรวมในส่วนหัวของรายงาน](./media/ER-DeferredSequence-Run3.png)
...
4. ดาวน์โหลดแและตรวจทานไฟล์ที่เว็บเบราว์เซอร์นำเสนอ
    ...
    ![ไฟล์ที่ดาวน์โหลด - การดำเนินการที่เลื่อน](./media/ER-DeferredSequence-Run4.png)
