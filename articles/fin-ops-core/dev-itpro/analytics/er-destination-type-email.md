...
## <a name="enable-an-email-destination"></a>เปิดใช้งานปลายทางของอีเมล

เมื่อต้องการส่งไฟล์เอาท์พุทหนึ่งไฟล์ขึ้นไปทางอีเมล ให้ปฏิบัติตามขั้นตอนเหล่านี้

1. บนหน้า **ปลายทางการรายงานทางอิเล็กทรอนิกส์** บน FastTab **ปลายทางของไฟล์** ให้เลือกส่วนประกอบหรือกลุ่มของส่วนประกอบในกริด
2. เลือก **การตั้งค่า** และจากนั้น ในกล่องโต้ตอบ **การตั้งค่าปลายทาง** บนแท็บ **อีเมล** ให้ตั้งค่าตัวเลือก **เปิดใช้งาน** เป็น **ใช่**
...
### <a name="email-content"></a>เนื้อหาอีเมล

คุณสามารถแก้ไขชื่อเรื่องและเนื้อหาของข้อความอีเมลได้
...
### <a name="email-addresses"></a>ที่อยู่อีเมล

คุณสามารถระบุผู้ส่งอีเมลและผู้รับอีเมลได้ ตามค่าเริ่มต้น อีเมลจะถูกส่งในนามของผู้ใช้ปัจจุบัน เมื่อต้องการระบุผู้ส่งอีเมลอื่น คุณต้องตั้งค่าคอนฟิกฟิลด์ **จาก**

> [!NOTE]
> เมื่อมีการตั้งค่าคอนฟิกปลายทางอีเมล ฟิลด์ **จาก** จะมองเห็นได้เฉพาะกับผู้ใช้ที่มีสิทธิ์ความปลอดภัย `ERFormatDestinationSenderEmailConfigure` **ตั้งค่าคอนฟิกที่อยู่อีเมลของผู้ส่งสำหรับปลายทางรูปแบบ ER**
>
...
หากต้องการระบุผู้รับอีเมล คุณต้องตั้งค่าคอนฟิกฟิลด์ **ถึง** และฟิลด์ **Cc** (ไม่จำเป็นต้องระบุ)

คุณสามารถตั้งค่าคอนฟิกที่อยู่อีเมลสำหรับ ER ได้สองวิธี คุณสามารถดำเนินการตั้งค่าคอนฟิกให้เสร็จสมบูรณ์ได้ในลักษณะเดียวกับคุณลักษณะการจัดการการพิมพ์ หรือคุณสามารถแก้ไขที่อยู่อีเมลโดยใช้การอ้างอิงโดยตรงไปยังการตั้งค่าคอนฟิก ER ผ่านสูตร

## <a name="email-address-types"></a>ชนิดของที่อยู่อีเมล

ถ้าคุณเลือก **แก้ไข** ถัดจากฟิลด์ **จาก** **ถึง** หรือ **Cc** ในกล่องโต้ตอบ **การตั้งค่าปลายทาง** กล่องโต้ตอบ **อีเมลจาก** **อีเมลถึง** หรือ **อีเมล cc** จะปรากฏขึ้น ที่นั่น คุณสามารถตั้งค่าคอนฟิกผู้ส่งอีเมลและผู้รับอีเมลได้ เลือก **เพิ่ม** และจากนั้นคุณสามารถเลือกชนิดของที่อยู่อีเมลที่จะใช้ อีเมลสองชนิดที่ได้รับการสนับสนุน: **อีเมลการจัดการการพิมพ์** และ **อีเมลการตั้งค่าคอนฟิก**
...
ถ้าคุณเลือก **อีเมลการจัดการการพิมพ์** เป็นชนิดที่อยู่อีเมล คุณสามารถป้อนที่อยู่อีเมลคงที่ในกล่องโต้ตอบ **อีเมลจาก** **อีเมลถึง** หรือ **อีเมล cc** โดยการตั้งค่าฟิลด์ต่อไปนี้:
