...
[![ตั้งค่าคอนฟิกบัญชีแอททริบิวต์แหล่งที่มาของอีเมล](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)
