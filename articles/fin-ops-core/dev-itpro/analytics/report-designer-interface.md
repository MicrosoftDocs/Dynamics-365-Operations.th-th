...
description: บทความนี้อธิบายถึงวิธีการนำทางไปยัง Report Designer และวิธีการใช้ตัวเลือกต่างๆ เพื่อให้ตรงกับความต้องการเฉพาะของคุณ
author: aprilolson
ms.date: 11/22/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9802754"
---
# <a name="report-designer-interface"></a>อินเทอร์เฟสของโปรแกรมออกแบบรายงาน

[!include [banner](../includes/banner.md)]

บทความนี้อธิบายถึงวิธีการนำทางไปยัง Report Designer และวิธีการใช้ตัวเลือกต่างๆ เพื่อให้ตรงกับความต้องการเฉพาะของคุณ

## <a name="report-designer-menu-commands"></a>คำสั่งเมนูของ Report Designer
...
| ปิด                             | ปิดบล็อคส่วนประกอบปัจจุบัน |
...
| ดูรายงาน                       | เปิดรุ่นล่าสุดของรายงานที่สร้างขึ้นมา คำสั่งนี้จะพร้อมใช้งานจากข้อกำหนดของรายงานถ้าคุณได้สร้างรายงานอย่างน้อยหนึ่งรายการ |
...
| คำนิยามแผนภูมิการรายงานล่าสุด | แสดงรายการของคำนิยามแผนภูมิรายงานที่ถูกสร้างหรือปรับเปลี่ยนเมื่อเร็วๆนี้ จากนั้นคุณจึงสามารถเลือกคำนิยามแผนภูมิรายงานในรายการได้ |
...
| ลิงก์แถว                              | เปิดกล่องโต้ตอบ **แถวลิงค์** ซึ่งคุณสามารถระบุแหล่งที่มาสำหรับลิงค์ข้อมูลในคำนิยามแถวและคำนิยามแผนภูมิรายงาน คำสั่งนี้จะพร้อมใช้งานจากคำนิยามแถว |
| การปรับปรุงรายการปัดเศษ                    | เปิดกล่องโต้ตอบ **การปรับปรุงการปัดเศษ** ซึ่งคุณสามารถระบุพารามิเตอร์สำหรับการปัดเศษ คำสั่งนี้จะพร้อมใช้งานจากคำนิยามแถว |
| จัดการชุดมิติ                  | เปิดกล่องโต้ตอบ **เซ็ตมิติ** ซึ่งคุณสามารถสร้างและปรับเปลี่ยนเซ็ตมิติ คำสั่งนี้จะพร้อมใช้งานจากคำนิยามแถวหรือคำนิยามแผนภูมิรายงาน |
...
| นำเข้าลำดับชั้นของชุดมิติ         | เปิดกล่องโต้ตอบ **ลำดับชั้นของเซ็ตมิติ** ซึ่งคุณสามารถนำเข้าลำดับชั้นของเซ็ตมิติจากข้อมูลทางการเงิน คำสั่งนี้จะพร้อมใช้งานจากคำนิยามแผนภูมิรายงานสำหรับ ..\\มิติทางการเงิน\\ระบบที่อิงมิติ |
...
| แถบสถานะ      | แสดงหรือซ่อนข้อมูลสถานะในหน้าต่าง **Report Designer** |
...
| คำสั่ง               | คำอธิบาย |
|-----------------------|-------------|
| รูปแบบและการจัดรูปแบบ | เปิดกล่องโต้ตอบ **ลักษณะและการจัดรูปแบบ** ซึ่งคุณสามารถสร้างและปรับเปลี่ยนรูปแบบสำหรับข้อความในคำนิยามแถวและคำนิยามคอลัมน์ คำสั่งนี้จะพร้อมใช้งานจากคำนิยามแถวหรือคำนิยามคอลัมน์ |
...
| กลุ่มบล็อคส่วนประกอบ | เปิดกล่องโต้ตอบ **กลุ่มบล็อคส่วนประกอบ** ซึ่งคุณสามารถสร้าง ปรับเปลี่ยน นำเข้า และส่งออกกลุ่มบล็อคส่วนประกอบ |
...
## <a name="report-designer-toolbar-buttons"></a>ปุ่มแถบเครื่องมือของ Report Designer
...
| [![ปุ่มคำนิยามแผนภูมิการรายงาน](./media/treec130389.png)](./media/treec130389.png)             | แสดงคำนิยามแผนภูมิรายงานที่กำหนดให้กับข้อกำหนดของรายงานที่ใช้งานอยู่ |
