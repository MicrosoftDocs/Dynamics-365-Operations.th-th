...
description: หัวข้อนี้อธิบายวิธีการนําเข้าข้อมูลจากไฟล์ที่เลือกด้วยตนเองในโหมดชุดงาน
author: NickSelin
ms.date: 01/07/2022
ms.topic: article
ms.prod: ''
...
หัวข้อนี้อธิบายวิธีการนําเข้าข้อมูลจากไฟล์ที่เลือกด้วยตนเองในโหมดชุดงาน ตัวอย่างใช้ธุรกรรมผู้จัดจำหน่ายเป็นข้อมูลธุรกิจ ขั้นตอนของตัวอย่างเหล่านี้สามารถดำเนินการให้เสร็จสมบูรณ์ในบริษัท **USMF** ไม่จำเป็นต้องมีการเขียนโค้ด
...
2. ใช้ตัวเลือก ER [โหลดจากไฟล์ XML](er-defer-sequence-element.md#import-the-sample-er-configurations) เพื่อนําเข้าการตั้งค่าคอนฟิก ER ที่ดาวน์โหลดมาไปยังอินสแตนซ์ Dynamics 365 Finance ของคุณในลำดับต่อไปนี้:
