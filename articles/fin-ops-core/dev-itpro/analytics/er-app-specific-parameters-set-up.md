...
6.  ในฟิลด์ **รหัส** ของเรกคอร์ดใหม่ ให้เลือกลูกศรแบบหล่นลง เพื่อเปิดการค้นหา
    ...
    ![หน้าพารามิเตอร์เฉพาะของแอพลิเคชันของ ER การค้นหาฟิลด์รหัส](./media/GER-AppSpecParms-LookupForm-CodeFldPicker.PNG)
...
8.  ในฟิลด์ **ผลลัพธ์การค้นหา** ของเรกคอร์ดใหม่ ให้เลือกลูกศรแบบหล่นลง เพื่อเปิดการค้นหา การค้นหาจะแสดงรายการของค่าสำหรับการแจงนับรูปแบบ TaxationLevel สำหรับการเลือก
    ...
    ![หน้าพารามิเตอร์เฉพาะแอพลิเคชัน ER ผลลัพธ์การค้นหาที่แสดงในภาษาเยอรมันที่ต้องการ](./media/GER-AppSpecParms-LookupForm-LookupFldPicker.PNG)
...
15. เลือก **เพิ่ม** อีกครั้ง แล้วปฏิบัติตามขั้นตอนต่อไปนี้
    ...
    ![หน้าพารามิเตอร์เฉพาะแอพลิเคชัน ER FastTab เงื่อนไขที่มีเรกคอร์ดสุดท้ายของ อื่นๆ](./media/GER-AppSpecParms-LookupForm-RulesSet.PNG)
...
7.  ในฟิลด์ **รหัส** ของเรกคอร์ดใหม่ ให้เลือกลูกศรแบบหล่นลง เพื่อเปิดการค้นหา
    ...
    ![หน้าพารามิเตอร์เฉพาะแอพลิเคชัน ER การค้นหาฟิลด์รหัสที่แสดงรายการรหัสภาษีของบริษัท USMF](./media/GER-AppSpecParms-LookupForm-CodeFldPicker2.PNG)
...
1.  ใช้รายการเมนู **ERSolutionAppSpecificParametersDesigner** ที่มีอยู่ใหม่ หรือใช้รายการเมนู **ERSolutionAppSpecificParametersDesigner** ของคุณเอง
    ...
    ![หน้า Visual Studio บานหน้าต่างคุณสมบัติ](./media/GER-AppSpecParms-LookupForm-Access1.PNG)
...
2.  ทำตามขั้นตอนเหล่านี้
    ...
    1.  สร้างปุ่มรายการเมนูใหม่ และเชื่อมโยงไปยังเรกคอร์ดที่เกี่ยวข้องจากตาราง **ERSolutionTable** โดยตั้งค่าคุณสมบัติ **แหล่งข้อมูล** เป็น **ERSolutionTable**
        ...
        ![หน้า Visual Studio บานหน้าต่างการออกแบบ](./media/GER-AppSpecParms-LookupForm-Access2.PNG)
