---
title: ส่วนประกอบรายงานองค์กรใน Report Designer
description: บทความนี้อธิบายถึงวิธีการจัดระเบียบรายงานที่มีอยู่ บล็อคส่วนประกอบ และออบเจ็กต์ในตัวออกแบบรายงาน
author: aprilolson
ms.date: 11/22/2022
ms.topic: article
ms.prod: ''
...
คุณสามารถเปลี่ยนชื่อโฟลเดอร์ รายงาน บล็อคส่วนประกอบ และออบเจ็กต์อื่นๆ ใน Report Designer เพื่อช่วยในการจัดระเบียบแฟ้มต่างๆของคุณ ขึ้นอยู่กับชนิดขอออบเจ็กต์ที่คุณเปลี่ยนชื่อ คุณอาจต้องอัพเดตการเชื่อมโยงกับออบเจ็กต์นั้น
...
ใน Report Designer คุณจะสามารถเปลี่ยนชื่อโฟลเดอร์ ข้อกำหนดของรายงาน คำนิยามแถว คำนิยามคอลัมน์ และคำนิยามแผนภูมิการรายงาน
...
> [NOTE] ถ้าคุณได้จัดกำหนดการรายงานเพื่อให้มีการสร้างขึ้นขณะตั้งค่าช่วง คุณสามารถแทนการตั้งค่าเหล่านี้ และสร้างรายงานได้ทันที
...
<tbody>
<tr>
<td>แทนที่การตั้งค่าบริษัท รายละเอียด และวันที่จากคำนิยามรายงานแต่ละรายการ</td>
<td>เลือกกล่องกาเครื่องหมายนี้เพื่อแทนข้อกำหนดการรายงานแต่ละรายงานในกลุ่มการรายงานนี้ สำหรับการสร้างรายงานเหล่านี้เท่านั้น</td>
</tr>
<tr>
<td>ชื่อบริษัท</td>
...
<td>สกุลเงินการรายงานเพิ่มเติมใดๆ ที่ถูกตั้งค่าคอนฟิกในระบบ Microsoft Dynamics 365 Finance ของคุณถูกแสดงรายการที่นี่ เลือกกล่องกาเครื่องหมายนี้ เพื่อสร้างรายงานเพิ่มเติมในสกุลเงินที่ระบุ เพื่อดูรายงานเหล่านี้ใน Web Viewer คลิกปุ่ม <strong>สกุลเงิน</strong> และจากนั้นเลือกสกุลเงิน</td>
</tr>
<tr>
