...
## <a name="Transformation">การจัดรูปแบบข้อมูล</a>
...
## <a name="Validation">กระบวนการควบคุมขั้นตอน</a>
...
## <a name="Enabled">การควบคุมเนื้อหาเอกสาร</a>
...
## <a name="TestFormula">การตรวจสอบความถูกต้องของสูตรที่ตั้งค่าคอนฟิก</a>
