...
description: บทความนี้อธิบายวิธีการออกแบบการตั้งค่าคอนฟิกการรายงานทางอิเล็กทรอนิกส์ เพื่อนำเข้าข้อมูลลงในแอป Microsoft Dynamics 365 Finance จากไฟล์ภายนอก
author: kfend
ms.date: 03/24/2021
...
9. คลิก แก้ไขสูตร
    ...
    เมื่อการตรวจสอบอย่างน้อยหนึ่งรายการล้มเหลวสำหรับธุรกรรมเดี่ยวที่นำเข้า ธุรกรรมนี้จะถูกทำเครื่องหมายเป็นล้มเหลวโดยแอตทริบิวต์แหล่งข้อมูล '$failed'  
