...
8. ในฟิลด์เวอร์ชัน ให้พิมพ์ '[7.1.1541.3036,8)'
    * [7.1.1541.3036,8)  
    * การขึ้นต่อกันที่คุณป้อนจะถูกประเมินเมื่อมีการดาวน์โหลดการตั้งค่าคอนฟิกนี้จากที่เก็บ ER ใด ๆ เวอร์ชันการตั้งค่าคอนฟิกนี้จะถูกดาวน์โหลดจากที่เก็บ ER เมื่อเวอร์ชัน 1 ของการตั้งค่าคอนฟิก 'แบบจำลองข้อมูลตัวอย่าง' มีอยู่หรือถูกดาวน์โหลดล่วงหน้าอย่างใดอย่างหนึ่ง ถ้าจะมีการดาวน์โหลดล่วงหน้า ถ้ามีการดาวน์โหลดล่วงหน้า จะต้องดำเนินการให้เสร็จสมบูรณ์ใน Finance and Operations เวอร์ชัน 7.1.1541.3036 หรือใหม่กว่านั้น แต่ต้องไม่เกินเวอร์ชันหลัก 8   
9. คลิก บันทึก
10. ปิดหน้า
...
19. ในฟิลด์เวอร์ชัน ให้พิมพ์ '[7.0.1265.3015,7.1)'
    * [7.0.1265.3015,7.1)  
    * การขึ้นต่อกันจะถูกประเมินเมื่อมีการดาวน์โหลดการตั้งค่าคอนฟิกจากที่เก็บ ER ใด ๆ เวอร์ชันการตั้งค่าคอนฟิกนี้จะถูกดาวน์โหลดจากที่เก็บ ER เมื่อเวอร์ชัน 1 ของการตั้งค่าคอนฟิก 'แบบจำลองข้อมูลตัวอย่าง' มีอยู่หรือถูกดาวน์โหลดล่วงหน้าอย่างใดอย่างหนึ่ง ถ้าจะมีการดาวน์โหลดล่วงหน้า หากมีการดาวน์โหลดล่วงหน้า ต้องทำให้เสร็จสมบูรณ์ใน Microsoft Dynamics 365 for Finance and Operations Enterprise edition รุ่นนั้นต้องเป็น 7.0.1265.3015 หรือใหม่กว่า แต่ต้องไม่เกินรุ่นรอง 1   
20. คลิก บันทึก
21. ปิดหน้า
...
26. ในแผนภูมิ ขยาย 'แบบจำลองข้อมูลตัวอย่าง'
    * หมายเหตุว่าการตั้งค่าคอนฟิกการแม็ป 'การแม็ปตัวอย่าง' ของแบบจำลองจะถูกดึงข้อมูลพร้อมกับการตั้งค่าคอนฟิกแบบจำลองของข้อมูลที่เลือก ไฟล์ทั้งสองจะถูกดึงข้อมูลพร้อมกันเนื่องจาก 'การแม็ปตัวอย่าง' ถูกกำหนดเป็นการใช้งานแบบจำลองข้อมูลที่เลือก และใช้ได้กับแอพลิเคชั่น การตั้งค่าคอนฟิก 'การแม็ปตัวอย่าง (สำรอง)' จะถูกดึงข้อมูลเนื่องจากไม่ตรงตามเงื่อนไขของเวอร์ชันของแอพลิเคชันที่กำหนด   
    * ถ้าคุณลงชื่อเข้าใช้ Finance and Operations ให้ลงทะเบียนผู้ให้บริการเดียวกัน เข้าสู่โครงการ LCS เดียวกัน และดึงข้อมูลการตั้งค่าคอนฟิกแบบจำลองข้อมูลเดียวกัน การตั้งค่าคอนฟิก 'การแม็ปตัวอย่าง (สำรอง)' จะดาวน์โหลด ในขณะที่การตั้งค่าคอนฟิก 'การแม็ปตัวอย่าง' จะถูกข้ามไป  
