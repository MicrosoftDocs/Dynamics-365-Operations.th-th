...
ms.locfileid: "6345823"
---
# <a name="financial-analysis"></a>การวิเคราะห์ทางการเงิน

[!include [banner](../includes/banner.md)]

**การวิเคราะห์ทางการเงิน** ใช้ Microsoft Power BI เพื่อรวมตัวบ่งชี้ประสิทธิภาพหลักทางการเงิน (KPIs) แผนภูมิ และงบการเงิน Power BI จะถูกฝังลงในแอพพลิเคชัน จุดมุ่งหมายสำคัญของ **การวิเคราะห์ทางการเงิน** คือการรายงานเชิงวิเคราะห์ บทบาททั่วทั้งองค์กรสามารถดู ค้นคว้า เข้าใจ และดำเนินการได้ 

**การวิเคราะห์ทางการเงิน** รวมข้อมูลจากบัญชีแยกประเภททั่วไปและบัญชีแยกประเภทย่อย เพื่อให้ภาพรวมที่สมบูรณ์มากขึ้นของความสมบูรณ์ทางการเงินขององค์กร
...
ในปัจจุบัน **การวิเคราะห์ทางการเงิน** ใช้เพื่อดูข้อมูลสำหรับนิติบุคคลที่ใช้งานอยู่หรือนิติบุคคลทั้งหมด ในการนำออกใช้ในอนาคต พื้นที่ทำงานจะเกี่ยวข้องกับตำแหน่งที่คุณสามารถใช้ Power BI เพื่อแก้ไขและสร้างภาพ

พื้นที่ทำงาน **ภาพรวมของ CFO** แสดงภาพเดียวกันเป็น **การวิเคราะห์ทางการเงิน** แต่ให้ความสำคัญในการอนุญาตให้คุณสามารถดูและกรองข้อมูลในรายงานที่มีอยู่ได้ ในการนำออกใช้ในอนาคต คุณจะสามารถเพิ่มภาพใหม่ไปยังพื้นที่ทำงาน **การวิเคราะห์ทางการเงิน** ได้ ภาพใหม่ยังอาจจะพร้อมใช้งานในพื้นที่ทำงานที่ให้ความสำคัญกับบทบาทอื่นอีกด้วย เช่น ผู้จัดการโครงการ หรือผู้จัดการบัญชีเจ้าหนี้ พื้นที่ทำงาน **ภาพรวมของ CFO** จะแสดงข้อมูลสำหรับนิติบุคคลทั้งหมดต่อ โดยไม่คำนึงถึงนิติบุคคลที่บทบาทมีสิทธิเข้าถึง

## <a name="dynamics-365-finance-setup"></a>การติดตั้ง Dynamics 365 Finance
**บัญชีแยกประเภททั่วไป**

ชนิดบัญชีหลักและประเภทบัญชีหลัก จะใช้เพื่อกรอกข้อมูลในบัญชีหลักเริ่มต้นที่เหมาะสมบนงบการเงิน **งบดุล** และงบการเงิน **งบกำไรขาดทุน** ต่างๆ ใน **การวิเคราะห์ทางการเงิน**
...
เพื่อให้ปรากฏในงบการเงิน และเพื่อให้สามารถรวมอยู่ในภาพอื่นๆ ที่หลากหลาย เช่น KPIs บัญชีหลักแต่ละบัญชีต้องถูกกำหนดประเภทบัญชีหลัก ประเภทบัญชีหลักได้รับการปรับปรุงเพื่อให้มีลำดับการแสดงผล มีการใช้ลำดับการแสดงผลโดยเฉพาะอย่างยิ่งในงบการเงินใน **การวิเคราะห์ทางการเงิน** หลังจากที่คุณแก้ไข หรือเพิ่มประเภทบัญชีหลักใหม่ คุณสามารถเปลี่ยนค่า **ลำดับการแสดงผล** เพื่อกำหนดลำดับที่ประเภทบัญชีหลักควรถูกแสดงในงบการเงินได้ ถ้าคุณต้องเปลี่ยนลำดับการแสดงผลสำหรับประเภทบัญชีหลักหลายประเภท คุณสามารถเปิดข้อมูลใน Excel เพื่อแก้ไขและเผยแพร่การเปลี่ยนแปลงในแอพพลิเคชั่นได้อย่างรวดเร็ว

## <a name="entity-store"></a>ที่จัดเก็บเอนทิตี้
ข้อมูลสำหรับ **การวิเคราะห์ทางการเงิน** ได้รับการดึงมาจากร้านค้าเอนทิตี (**การจัดการระบบ** \> **การตั้งค่า** \> **การจัดเก็บเอนทิตี**) ถ้าคุณเปิดพื้นที่ทำงาน **ภาพรวมของ CFO** หรือ **การวิเคราะห์ทางการเงิน** และข้อความเตือนต่อไปนี้ปรากฏในภาพ คุณต้องอัพเดตเอนทิตี

![คำเตือน](./media/Cantdisplay.png)

คุณต้องอัพเดตเอนทิตีต่อไปนี้เพื่อดูข้อมูลในพื้นที่ทำงาน **การวิเคราะห์ทางการเงิน**:

- ข้อมูลธุรกรรมของการรายงานทางการเงินรุ่น 3 
- สินเชื่อและการเรียกเก็บเงิน V2
...
| ภาษี                                    | บทบาท | คำอธิบาย |
|-----------------------------------------|-------|------------|
| ดูการวิเคราะห์ทางการเงินของบริษัทปัจจุบัน | <ul><li>นักบัญชี</li><li>ผู้จัดการฝ่ายบัญชี</li><li>หัวหน้างานฝ่ายบัญชี</li><li>ผู้ตรวจสอบบัญชี</li><li>ผู้จัดการงบประมาณ</li><li>ประธานเจ้าหน้าที่บริหาร</li><li>ประธานเจ้าหน้าที่ฝ่ายการเงิน</li><li>ผู้ควบคุมการเงิน</li></ul> | หน้าที่นี้ให้การเข้าถึงไปยังการวิเคราะห์ทางการเงิน โดยค่าเริ่มต้น บริษัทที่ใช้งานอยู่จะถูกใช้เป็นตัวกรองข้อมูล คุณไม่สามารถเพิ่มนิติบุคคลอื่นๆ ได้ |
| ดูการวิเคราะห์ทางการเงินของบริษัททั้งหมด   | ใน Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition 7.3 หน้าที่นี้ไม่ได้กำหนดให้กับบทบาท ในรุ่นถัดไป หน้าที่นี้จะถูกกำหนดให้กับบทบาทประธานเจ้าหน้าที่ฝ่ายการเงิน | หน้าที่นี้ให้การเข้าถึงรายการเมนูสำหรับพื้นที่ทำงานของภาพรวมของ CFO โดยค่าเริ่มต้น บริษัทที่ใช้งานอยู่จะถูกใช้เป็นตัวกรองข้อมูล อย่างไรก็ตาม คุณสามารถเพิ่มนิติบุคคลทั้งหมด โดยไม่คำนึงถึงว่าผู้ใช้มีสิทธิ์เข้าถึงนิติบุคคลอื่นๆ หรือไม่ |


## <a name="financial-reporting-vs-financial-analysis"></a>การรายงานทางการเงิน เทียบกับการวิเคราะห์ทางการเงิน
ถึงแม้ว่า **การวิเคราะห์ทางการเงิน** จะประกอบด้วย งบการเงิน แต่ไม่ใช่การแทนที่สำหรับรายงานทางการเงินในแอปพลิเคชัน งบการเงินเริ่มต้นใน **การวิเคราะห์ทางการเงิน** จะจำกัดอยู่ในขอบเขต และไม่รวมชนิดทั้งหมดของงบการเงิน การรายงานทางการเงินยังคงเป็นเครื่องมือหลักในการออกแบบ การสร้าง และการสร้างงบการเงินตามกฎหมาย
...
> [!IMPORTANT] 
> ถ้าคุณสรุปธุรกรรมสำหรับผู้จัดจำหน่ายหรือลูกค้าหลายรายในใบสำคัญเดียว โดยใช้สมุดรายวันทางการเงิน ข้อมูลจะไม่ถูกต้อง กระบวนการรายงานไม่สามารถระบุว่าผู้จัดจำหน่ายหรือลูกค้ารายใดที่เกี่ยวข้องกับบัญชีแยกประเภทเฉพาะในรายการสมุดรายวัน เนื่องจากข้อมูลดังกล่าวไม่ได้มีการจัดเก็บอยู่ที่ใดเลย ดังนั้น เราจึงไม่แนะนำให้คุณป้อนผู้ขาย ลูกค้า สินทรัพย์ถาวร หรือโครงการหลายรายการในใบสำคัญเดียวกัน
...
![ปุ่มดูข้อมูลสรุปงบทดลอง](./media/trial-balance4.png)
...
![ปุ่มดูรายละเอียดย้อนกลับของงบทดลอง](./media/trial-balance5.png)
...
![ขีดจำกัดข้อมูล](./media/data-limit.png)
...
ข้อมูลในทรัพยากรต่อไปนี้ไม่จำเป็นต้องใช้เพื่อเปิดใช้งานรายงานแบบฝังตัวสำหรับพื้นที่ทำงาน **การวิเคราะห์ทางการเงิน** ในสภาพแวดล้อมการทำงานจริง ตรงกันข้าม สิ่งเหล่านี้จะมีประโยชน์สำหรับกล่องสำหรับการพัฒนาและกรณีที่คุณต้องการฝังรายงาน Power BI ของคุณเอง

- [การเข้าถึงพื้นที่ทำงานวิเคราะห์และรายงานเกี่ยวกับสภาพแวดล้อมแบบ 1 กล่อง](/archive/blogs/dynamicsaxbi/accessing-analytical-workspaces-on-1box-environment)

- [เพิ่มการวิเคราะห์ไปยังพื้นที่ทำงานโดยใช้ Power BI Embedded](/dynamics365/unified-operations/dev-itpro/analytics/add-analytics-tab-workspaces)
