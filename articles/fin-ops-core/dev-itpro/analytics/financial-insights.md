...
## <a name="dynamics-365-finance-setup"></a>การตั้งค่า Dynamics 365 Finance
...
## <a name="entity-store"></a>ที่จัดเก็บเอนทิตี
...
คุณสามารถกำหนดชุดงานที่เกิดซ้ำเพื่ออัพเดตข้อมูลอย่างสม่ำเสมอในเอนทิตีได้ เนื่องจากแต่ละเอนทิตีถูกสร้างอย่างสมบูรณ์ในระหว่างการอัพเดต เลือกเวลาและความถี่ของการปรับปรุงเอนทิตีอย่างรอบคอบ เอนทิตีหลักที่ใช้สำหรับงบการเงินคือ เอนทิตี FinancialReportingTransactionData ดังนั้น คุณอาจตัดสินใจที่จะอัพเดตเอนทิตีนั้นบ่อยขึ้น
...
| **สนับสนุนลำดับชั้นรายงาน/ลำดับชั้นขององค์กร**   | ใช่                                                               | ไม่ |
...
| **ความปลอดภัย**                                             | ใช่ สอดคล้องกับแผนความปลอดภัยของการรายงานทางการเงิน | รายงานการดูที่จำกัดสำหรับบริษัททั้งหมด (โดยไม่คำนึงถึงความปลอดภัยในการเงินและการดำเนินงาน) หรือบริษัทที่ใช้งานอยู่เท่านั้น |
| **สนับสนุนผังบัญชีและปีบัญชีต่างๆ** | ใช่                                                               | ไม่ |
| **รายงานเกี่ยวกับข้อมูลภายนอก**                              | ไม่                                                                | ไม่ |
