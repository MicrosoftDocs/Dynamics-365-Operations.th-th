...
ms.locfileid: "9843809"
---
# <a name="configure-action-dependent-er-destinations"></a>ตั้งค่าคอนฟิกปลายทาง ER ที่ขึ้นอยู่กับการดำเนินการ

[!include [banner](../includes/banner.md)]

คุณสามารถตั้งค่าคอนฟิก [ปลายทาง](electronic-reporting-destinations.md) สำหรับส่วนประกอบเอาท์พุท (โฟลเดอร์ หรือไฟล์) ของ [การตั้งค่าคอนฟิก](general-electronic-reporting.md) รูปแบบ [การรายงานทางอิเล็กทรอนิกส์ (ER)](general-electronic-reporting.md#Configuration) ที่ใช้เพื่อสร้างเอกสารขาออก ผู้ใช้ที่รันรูปแบบ ER ชนิดนี้ และผู้มีสิทธิการเข้าถึงที่เหมาะสม ยังสามารถเปลี่ยนการตั้งค่าปลายทางที่ตั้งค่าคอนฟิกขณะรันไทม์ด้วย
...
ถ้าสามารถใช้รูปแบบ ER เป็นเทมเพลตรายงานต่างๆ ของเอกสารที่เลือก ปลายทาง ER ทั้งหมดของเทมเพลตรายงาน ER ที่เกี่ยวข้องทั้งหมดจะแสดงขึ้นในกล่องโต้ตอบและพร้อมใช้งานเฉพาะการปรับปรุงด้วยตนเองในช่วงรันไทม์

หากไม่มีเทมเพลตรายงาน [SQL Server Reporting Services (SSRS)](SSRS-report.md) ที่ใช้กับเอกสารที่เลือก การเลือกมาตรฐานของปลายทางการจัดการการพิมพ์จะถูกซ่อนไว้แบบไดนามิก

ใน Finance เวอร์ชัน **10.0.31** คุณสามารถเปลี่ยนปลายทาง ER ที่มอบหมายด้วยตนเองขณะรันไทม์ของเอกสารทางธุรกิจต่อไปนี้:

- รายงานสรุปยอดบัญชีลูกค้า
- ดอกเบี้ยตั๋วเงิน
- บันทึกจดหมายเรียกเก็บเงิน
- ใบแจ้งการชำระเงินของลูกค้า
- ใบแจ้งการชำระเงินของผู้จัดจำหน่าย

เมื่อต้องการเรียกใช้ความสามารถเพื่อเปลี่ยนปลายทาง ER ขณะรันไทม์ ให้เปิดใช้งานคุณลักษณะ **อนุญาติการปรับปรุงปลายทาง ER ขณะรันไทม์** ในพื้นที่ทำงาน [การจัดการคุณลักษณะ](../../fin-ops/get-started/feature-management/feature-management-overview.md#the-feature-management-workspace)

> [!IMPORTANT]
> สำหรับรายงาน **ใบแจ้งการชำระเงินของลูกค้า** และ **ใบแจ้งการชำระเงินของผู้จัดจำหน่าย** ความสามารถในการเปลี่ยนแปลงปลายทาง ER ด้วยตนเองจะใช้งานได้เฉพาะเมื่อเปิดใช้งานเที่ยวบิน **ForcePrintJobSettings** เท่านั้น

[![การปรับปรุงปลายทาง ER ขณะรันไทม์](./media/ERdestinaiotnChangeUI.jpg)](./media/ERdestinaiotnChangeUI.jpg)

> [!NOTE]
> เมื่อตั้งค่าตัวเลือก **ใช้ปลายทางการจัดการงานพิมพ์** เป็น **ใช่** ระบบจะใช้ปลายทาง ER เริ่มต้นที่ตั้งค่าคอนฟิกไว้ให้กับรายงาน ER เฉพาะ การเปลี่ยนแปลงด้วยตนเองทั้งหมดในกล่องโต้ตอบจะถูกละเว้น ตั้งค่าตัวเลือก **ใช้ปลายทางการจัดการการพิมพ์** เป็น **ไม่** เพื่อประมวลผลเอกสารไปยังปลายทาง ER ที่กําหนดในกล่องโต้ตอบทันที ก่อนที่คุณจะรันรายงาน

เอกสารธุรกิจต่อไปนี้ไม่ถือว่ามีการเลือกการรันโดยผู้ใช้อย่างชัดแจ้งเมื่อรันใหม่:
...
ระบบจะใช้ตรรกะต่อไปนี้เพื่อตัดสินว่าจะใช้การดำเนินการใดในระหว่างที่มีการประมวลผลรายงานก่อนหน้านี้

- ถ้าเปิดใช้งานเที่ยวบิน **ForcePrintJobSettings**:

    - หากตั้งค่าตัวเลือก **ใช้ปลายทางการจัดการการพิมพ์** เป็น **ใช่** จะใช้การดำเนินการ **พิมพ์**
    - หากตั้งค่าตัวเลือก **ใช้ปลายทางการจัดการการพิมพ์** เป็น **ไม่** จะใช้การดำเนินการ **ดู**

- ถ้าไม่ได้เปิดใช้งานเที่ยวบิน **ForcePrintJobSettings**:

    - หากตั้งค่าตัวเลือก **ใช้ปลายทางการจัดการการพิมพ์** เป็น **ใช่** การดำเนินการ **พิมพ์** จะถูกใช้สำหรับรายงาน **ใบแจ้งการชำระเงินของลูกค้า** และ **ใบแจ้งการชำระเงินของผู้จัดจำหน่าย**
    - ถ้าตัวเลือก **ใช้ปลายทางการจัดการการพิมพ์** ได้รับการตั้งค่าเป็น **ไม่** เทมเพลตรายงาน SSRS เริ่มต้นจะถูกใช้เสมอสำหรับรายงาน **ใบแจ้งการชำระเงินของลูกค้า** และ **ใบแจ้งการชำระเงินของผู้จัดจำหน่าย** โดยไม่คำนึงถึงการตั้งค่า ER ใดๆ ที่ตั้งค่าคอนฟิกไว้
    - การดำเนินการ **พิมพ์** จะใช้กับรายงาน **รายงานสรุปยอดบัญชีลูกค้า** **ดอกเบี้ยตั๋วเงิน** และ **บันทึกจดหมายเรียกเก็บเงิน** เสมอ

ในตรรกะก่อนหน้านี้ การดำเนินการ **พิมพ์** หรือ **ดู** สามารถใช้เพื่อตั้งค่าคอนฟิกปลายทางรายงาน ER ที่ขึ้นอยู่กับการปฏิบัติการได้ ขณะรันไทม์ เฉพาะปลายทาง ER ที่ตั้งค่าคอนฟิกไว้สำหรับการดำเนินการเฉพาะเท่านั้นที่จะถูกกรองในกล่องโต้ตอบ
