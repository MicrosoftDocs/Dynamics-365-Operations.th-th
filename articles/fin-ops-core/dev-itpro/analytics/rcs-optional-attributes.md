---
title: นำเข้าไฟล์ในรูปแบบ XML ที่มีแอตทริบิวต์ตัวเลือก
description: บทความนี้แสดงข้อมูลเกี่ยวกับการออกแบบรูปแบบ ER ซึ่งระบุแอตทริบิวต์ XML เพื่อแยกเอกสารอิเล็กทรอนิกส์ขาเข้าในรูปแบบ XML
author: kfend
ms.date: 07/03/2019
ms.topic: article
ms.prod: ''
...
13.    ในแผนภูมิ เลือก **XML\แอตทริบิวต์**
...
> [!NOTE]
> ไม่มีการนำเข้าไฟล์ที่เลือก เนื่องจากการออกแบบรูปแบบสันนิษฐานการมีอยู่ของแอตทริบิวต์ 'รหัส' สำหรับองค์ประกอบ 'เอกสาร' แต่ไฟล์ที่นำเข้าจะไม่มีแอตทริบิวต์ดังกล่าว

## <a name="modify-format-structure-to-handle-xml-attribute-as-optional"></a>แก้ไขโครงสร้างรูปแบบเพื่อจัดการแอตทริบิวต์ xml เป็นตัวเลือก
1. ปิดหน้า
2. ในแผนภูมิ ให้ขยาย **root\document**
3. ในแผนภูมิ ให้เลือก **root\document\id**
4. ในฟิลด์ **สตริงที่ว่างสำหรับแอตทริบิวต์ที่ขาดหายไป** เลือก **ใช่**
5. คลิก **บันทึก**
...
4. คลิก **ตกลง**
5. ตรวจทานไฟล์ที่สร้างขึ้น โปรดทราบว่ามีการนำเข้าไฟล์ที่เหมือนกัน เนื่องจากในขณะนี้การออกแบบรูปแบบพิจารณาถึงแอตทริบิวต์ 'รหัส' สำหรับองค์ประกอบ 'เอกสาร' เป็นตัวเลือก
