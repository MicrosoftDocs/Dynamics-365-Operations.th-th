...
> [!NOTE]
> พารามิเตอร์ **ชนิดเอกสาร SharePoint** กำหนดโฟลเดอร์ SharePoint เป็นที่จัดเก็บชั่วคราวสำหรับแม่แบบที่สามารถแก้ไขได้โดยใช้ Microsoft Excel หรือ Word คุณต้องตั้งค่าพารามิเตอร์นี้หากคุณวางแผนที่จะใช้แอปพลิเคชันเดสก์ท็อป Office เหล่านี้เพื่อแก้ไขแม่แบบ สำหรับข้อมูลเพิ่มเติม ดู [แก้ไขแม่แบบในแอปพลิเคชันเดสก์ท็อป Office](#EditInOfficeDesktopApp) คุณสามารถทำให้พารามิเตอร์นี้ว่างหากคุณวางแผนที่จะแก้ไขแม่แบบโดยใช้ฟังก์ชันการทำงานใน  Office 365 เท่านั้น สำหรับข้อมูลเพิ่มเติม ดูที่ [การแก้ไขแม่แบบใน Office 365](#EditInOffice365)
...
**โปรแกรมแก้ไขเท็มเพลต BDM** จะถูกเปิดขึ้น เท็มเพลตที่เลือกจะพร้อมใช้งานสำหรับการแก้ไขแบบออนไลน์โดยใช้ Office 365

![หน้าพื้นที่ทำงานของการจัดการเอกสารทางธุรกิจ](./media/BDM-Overview-EditingLayout1.png)

### <a name=""></a><a name="EditInOffice365">แก้ไขแม่แบบใน Office 365</a>

คุณสามารถปรับเปลี่ยนแม่แบบที่ใช้ Office 365 ได้ ตัวอย่างเช่น ใน Office Online เปลี่ยนแบบอักษรของพร้อมท์ฟิลด์ในส่วนหัวของเท็มเพลตจาก **ปกติ** เป็น **ตัวหนา** การเปลี่ยนแปลงเหล่านี้จะถูกจัดเก็บโดยอัตโนมัติในเท็มเพลตที่สามารถแก้ไขได้ซึ่งจัดเก็บไว้ในที่เก็บข้อมูลของเท็มเพลตหลัก (โดยค่าเริ่มต้นคือ ที่เก็บข้อมูล Azure blob) สิ่งนี้ถูกกำหนดค่าไว้สำหรับกรอบงาน ER
...
#### <a name="i-selected-edit-document-but-instead-of-opening-the-bdm-template-editor-page-in-finance-and-operations-i-have-been-sent-to-the-office-365-web-page"></a>ได้เลือก **แก้ไขเอกสาร** แต่แทนที่จะเปิดหน้า **ตัวแก้ไขแม่แบบ BDM** ใน Finance and Operations และถูกส่งไปยังหน้าเว็บ Office 365 
นี่เป็นปัญหาการเปลี่ยนเส้นทางของ Office 365 ที่เป็นที่รับทราบแล้ว นี่จะเกิดขึ้นเมื่อคุณลงชื่อเข้าใช้ Office 365 ครั้งแรก เมื่อต้องการแก้ไขปัญหานี้ ให้เลือกปุ่ม **ย้อนกลับ** ของเบราว์เซอร์ เพื่อนำทางกลับไปยังหน้าก่อนหน้า
