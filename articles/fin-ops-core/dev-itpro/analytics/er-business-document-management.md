...
### <a name="SetupBdmParameters">ตั้งค่าพารามิเตอร์</a>
...
### <a name="EditInOffice365">แก้ไขแม่แบบใน Office 365</a>

คุณสามารถปรับเปลี่ยนแม่แบบที่ใช้ Office 365 ได้ ตัวอย่างเช่น ใน Office Online เปลี่ยนแบบอักษรของพร้อมท์ฟิลด์ในส่วนหัวของเท็มเพลตจาก **ปกติ** เป็น **ตัวหนา** การเปลี่ยนแปลงเหล่านี้จะถูกจัดเก็บโดยอัตโนมัติในแม่แบบที่สามารถแก้ไขได้ซึ่งจัดเก็บไว้ในที่เก็บข้อมูลแม่แบบหลัก (โดยค่าเริ่มต้นคือที่เก็บข้อมูล Azure blob) สิ่งนี้ถูกกำหนดค่าไว้สำหรับกรอบงาน ER

![หน้าตัวแก้ไขเท็มเพลตการจัดการเอกสารทางธุรกิจ](./media/BDM-Overview-EditingLayout2.png)

### <a name="EditInOfficeDesktopApp">แก้ไขเท็มเพลตในแอพลิเคชันบนเดสก์ท็อปของ Office</a>
