...
>[!NOTE]
> นอกจากนี้คุณต้องเปิดใช้งาน **ประสบการณ์ใช้งาน UI ที่เหมือนสำนักงานสำหรับการจัดการเอกสารทางธุรกิจ** สำหรับการใช้อินเทอร์เฟซการจัดการเอกสารทางธุรกิจใหม่
...
ตัวเลือก **เอกสารใหม่** พร้อมใช้งานเสมอสำหรับแม่แบบในการตั้งค่าคอนฟิกรูปแบบ ER ซึ่งให้โดยผู้ให้บริการอื่น (Microsoft ในตัวอย่างนี้) เมื่อคุณคลิก **เอกสารใหม่**  คุณจะเห็นแม่แบบทั้งหมดที่เป็นเจ้าของโดยผู้ให้บริการปัจจุบันและรายอื่นๆ หลังจากที่คุณเลือกแม่แบบ แม่แบบจะถูกเปิดสำหรับการแก้ไข จากนั้น เท็มเพลตที่แก้ไขจะถูกจัดเก็บไว้ในการตั้งค่าคอนฟิกรูปแบบ ER ใหม่ที่สร้างขึ้นโดยอัตโนมัติ
...
#### <a name="i-selected-edit-document-but-instead-of-opening-the-bdm-template-editor-page-in-finance-and-operations-i-have-been-sent-to-the-office-365-web-page"></a>ฉันเลือก **แก้ไขเอกสาร** แต่แทนที่จะเปิดหน้า **โปรแกรมแก้ไขแม่แบบ BDM** ใน Finance and Operations ฉันถูกส่งไปยังเว็บเพจ Office 365
