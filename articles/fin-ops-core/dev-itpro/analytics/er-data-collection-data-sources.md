...
description: หัวข้อนี้อธิบายวิธีการใช้แหล่งข้อมูล DATA COLLECTION ในรูปแบบการรายงานทางอิเล็กทรอนิกส์ (ER)
author: NickSelin
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
3. [ตรวจทานการแม็ปแบบจำลองที่นำเข้า](er-defer-sequence-element.md#review-the-imported-model-mapping)
...
1. ในหน้า **ตัวออกแบบรูปแบบ** ในแท็บ **การแม็ป** ให้เลือก **เพิ่มราก**
...
3. บนแท็บ **การแม็ป** ให้เลือก **แก้ไขสูตร**
