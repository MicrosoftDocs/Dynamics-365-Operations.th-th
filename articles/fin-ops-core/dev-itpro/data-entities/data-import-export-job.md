...
การเปลี่ยนแปลงหลักอย่างหนึ่งสำหรับฟังก์ชันล้างข้อมูล คือการใช้ชุดงานของระบบสำหรับการล้างข้อมูลประวัติ การใช้ชุดงานของระบบจะช่วยให้แอป Finance and Operations สามารถให้ชุดงานล้างข้อมูลมีการจัดกำหนดการ และรันโดยอัตโนมัติในทันทีที่ระบบพร้อม ไม่จำเป็นต้องจัดกำหนดการชุดงานด้วยตนเองอีกต่อไป ในโหมดการดำเนินการเริ่มต้นนี้ ชุดงานจะดำเนินการทุกชั่วโมง เริ่มต้นที่เที่ยงคืน และจะเก็บประวัติการดำเนินการสำหรับ 7 วันล่าสุด ประวัติการลบออกจะถูกเก็บถาวรสำหรับการดึงข้อมูลในอนาคต เริ่มต้นด้วยเวอร์ชัน 10.0.20 คุณลักษณะนี้จะเปิดใช้งานอยู่เสมอ
