...
คุณอาจได้รับข้อความแสดงข้อผิดพลาดต่อไปนี้เมื่อคุณพยายามรันความล้มเหลวในการซิงค์แรกเริ่มบนการแม็ป **ลูกค้า V3 - บัญชี** **ใบสั่งขาย** หรือการแม็ปใดๆ ที่มีฟิลด์การค้นหามากกว่า 10 ฟิลด์
...
เนื่องจากข้อจํากัดการค้นหาในการสอบถาม การซิงค์เริ่มต้นจะล้มเหลวเมื่อการแม็ปเอนทิตีมีการค้นหามากกว่า 10 รายการ สำหรับข้อมูลเพิ่มเติม ดูที่ [ดึงข้อมูลเรกคอร์ดตารางที่เกี่ยวข้องด้วยการสอบถาม](/powerapps/developer/common-data-service/webapi/retrieve-related-entities-query)
...
5. เพิ่มฟิลด์การค้นหาทั้งหมดกลับไปยังแผนผัง บันทึกแผนผัง และรันแผนผังด้วย **ข้ามการซิงค์เริ่มต้น**
...
คุณอาจได้รับข้อความแสดงข้อผิดพลาดต่อไปนี้เมื่อคุณพยายามรันชื่อเริ่มต้นของที่อยู่ไปรษณีย์ของฝ่ายและที่อยู่อิเล็กทรอนิกส์ของฝ่าย:

*ไม่พบหมายเลขฝ่ายใน Dataverse*

มีช่วงที่ตั้งค่าบน **DirPartyCDSEntity** ในแอป Finance and Operations ที่กรองฝ่ายที่มีชนิด **บุคคล** และ **องค์กร** ซึ่งอาจส่งผลให้การซิงค์เริ่มต้นของการแม็ป **ฝ่าย CDS – msdyn_parties** จะไม่ซิงค์ฝ่ายในชนิดอื่น รวมถึง **นิติบุคคล** และ **หน่วยปฏิบัติงาน** เมื่อการซิงโครไนส์แรกเริ่มรัน **ที่อยู่ไปรษณีย์ของฝ่าย CDS (msdyn_partypostaladdresses)** หรือ **ผู้ติดต่อฝ่าย V3 (msdyn_partyelectronicaddresses)** คุณอาจได้รับข้อผิดพลาด

เราพยายามแก้ไขเพื่อลบช่วงชนิดฝ่ายในเอนทิตี Finance and Operations เพื่อให้ฝ่ายทุกชนิดสามารถซิงโครไนส์กับ Dataverse เสร็จเรียบร้อย

## <a name="are-there-any-performance-issues-while-running-initial-sync-for-customers-or-contacts-data"></a>มีปัญหาเกี่ยวกับประสิทธิภาพการรันการซิงค์เริ่มต้นกับลูกค้าหรือผู้ติดต่อหรือไม่

หากคุณรันการซิงโครไนส์แรกเริ่มให้กับข้อมูล **ลูกค้า** และแม็ป **ลูกค้า** รันอยู่ จากนั้นคุณจึงรันการซิงโครไนส์แรกเริ่มกับข้อมูล **ผู้ติดต่อ** อาจมีปัญหาเกี่ยวกับประสิทธิภาพระหว่างการแทรกและอัพเดตตาราง **LogisticsPostalAddress** และ **LogisticsElectronicAddress** ของที่อยู่ **ผู้ติดต่อ** ที่อยู่ไปรษณีย์สากลและตารางที่อยู่อิเล็กทรอนิกส์เดียวกันมีการติดตาม **CustCustomerV3Entity** และ **VendVendorV2Entity** และการรวมแบบสองทิศทางพยายามสร้างการสอบถามเพิ่มเติมเพื่อเขียนข้อมูลอีกด้านหนึ่ง หากคุณรันการซิงค์แรกเริ่มของ **ลูกค้า** แล้ว ให้หยุดแม็ปที่เกี่ยวข้องขณะรันการซิงค์ข้อมูล **ผู้ติดต่อ** เริ่มแรก ทำสิ่งเดียวกันนี้กับข้อมูล **ผู้จัดจำหน่าย** เมื่อการซิงโครไนส์แรกเริ่มเสร็จสิ้น คุณสามารถรันแม็ปทั้งหมดได้โดยข้ามการซิงโครไนส์แรกเริ่ม
