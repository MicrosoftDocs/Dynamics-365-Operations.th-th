---
title: แพคเกจการประสานรวมของโปรแกรมประยุกต์การรวมแบบสองทิศทางที่แยกต่างหาก
description: แพคเกจการประสานรวมของโปรแกรมประยุกต์การรวมแบบสองทิศทางไม่ใช่แพคเกจเดียวอีกต่อไป แต่ถูกแยกออกเป็นแพคเกจที่เล็กลง หัวข้อนี้อธิบายโซลูชันและแม็ปกับแต่ละแพคเกจมี และการขึ้นต่อกันกับแพคเกจอื่นๆ
...
ms.locfileid: "7924877"
---
# <a name="separated-dual-write-application-orchestration-package"></a>แพคเกจการประสานรวมของโปรแกรมประยุกต์การรวมแบบสองทิศทางที่แยกต่างหาก

[!include [banner](../../includes/banner.md)]

[!include [rename-banner](~/includes/cc-data-platform-banner.md)]

แพคเกจการประสานรวมของโปรแกรมประยุกต์การรวมแบบสองทิศทางเป็นแพคเกจเดียวที่มีโซลูชันต่อไปนี้:
...
- Dynamics 365 Finance and Operations ทั่วไป
- Dynamics 365 Company
- อัตราแลกเปลี่ยนสกุลเงิน
- Field Service Common

เนื่องจากเป็นแพคเกจเดียว แพคเกจนี้จะสร้างสถานการณ์ "ทั้งหมดหรือไม่มี" ให้กับลูกค้า อย่างไรก็ตาม ขณะนี้ Microsoft แยกผลิตภัณฑ์ออกเป็นแพคเกจที่เล็กลง ดังนั้น คุณจึงสามารถเลือกเฉพาะแพคเกจของโซลูชันที่ลูกค้าต้องการ ตัวอย่างเช่น ถ้าคุณเป็นลูกค้า Microsoft Dynamics 365 Supply Chain Management และไม่ต้องการรวมเข้ากับ Dynamics 365 Human Resources, Notes และการจัดการสินทรัพย์ คุณสามารถแยกโซลูชันเหล่านั้นออกจากโซลูชันที่ติดตั้ง เนื่องจากชื่อโซลูชัน ผู้เผยแพร่ และรุ่นแผนผังที่อยู่ภายใต้ยังคงเหมือนเดิม การเปลี่ยนแปลงนี้จึงไม่ใช่การแบ่ง การติดตั้งที่มีอยู่จะถูกอัปเกรด

![แพคเกจที่แยกต่างหาก](media/separated-package-1.png)

หัวข้อนี้อธิบายโซลูชันและแม็ปกับแต่ละแพคเกจมี และการขึ้นต่อกันกับแพคเกจอื่นๆ

## <a name="dual-write-application-core"></a>โปรแกรมประยุกต์การรวมแบบสองทิศทางหลัก

แพคเกจหลักของโปรแกรมประยุกต์การรวมแบบสองทิศทางจะช่วยให้ผู้ใช้สามารถติดตั้งและตั้งค่าคอนฟิกการรวมแบบสองทิศทางโดยไม่มีแอปการมีส่วนร่วมของลูกค้าใดๆ ซึ่งประกอบด้วยห้าโซลูชันต่อไปนี้

| ชื่อเฉพาะ                           | ชื่อที่แสดง                               |
|---------------------------------------|--------------------------------------------|
| Dynamics365Company                    | Dynamics 365 Company                       |
| Dynamics365FinanceAndOperationsCommon | Dynamics 365 Finance and Operations ทั่วไป |
| CurrencyExchangeRates                 | อัตราแลกเปลี่ยนสกุลเงิน                    |
| msdyn_DualWriteAppCoreMaps            | แผนผังเอนทิตีหลักของโปรแกรมประยุกต์การรวมแบบสองทิศทาง   |
| msdyn_DualWriteAppCoreAnchor          | จุดยึดหลักของโปรแกรมประยุกต์การรวมแบบสองทิศทาง        |

แผนผังต่อไปนี้จะพร้อมใช้งานในแพคเกจนี้

| แอป Finance and Operations     | แอป Customer Engagement                    |
|---------------------------------|---------------------------------------------|
...
แพคเกจหลักของโปรแกรมประยุกต์การรวมแบบสองทิศทางไม่มีการขึ้นต่อกันกับแพคเกจอื่น
...
แพคเกจ Human Resources ของการรวมแบบสองทิศทางจะขึ้นอยู่กับแพคเกจของโปรแกรมประยุกต์การรวมแบบสองทิศทางหลัก ดังนั้น คุณจึงควรติดตั้งแพคเกจโปรแกรมประยุกต์การรวมแบบสองทิศทางหลักก่อนที่จะติดตั้งแพคเกจ Human Resources ของการรวมแบบสองทิศทาง
...
| msdyn_Dynamics365SupplyChainExtendedMaps   | แม็ปเอนทิตี Dynamics 365 Supply Chain Management เพิ่มเติม |
...
- แพคเกจโปรแกรมประยุกต์การรวมแบบสองทิศทางหลัก
...
| msdyn_Dynamics365FinanceExtendedMaps   | แม็ปเอนทิตี Dynamics 365 Finance เพิ่มเติม |
| FieldServiceCommon                     | Field Service Common                      |
| msdyn_Dynamics365FinanceExtendedAnchor | จุดยึด Dynamics 365 Finance เพิ่มเติม      |
...
แพคเกจ Finance ของการรวมแบบสองทิศทางจะขึ้นอยู่กับแพคเกจของโปรแกรมประยุกต์การรวมแบบสองทิศทางหลัก ดังนั้น คุณจึงควรติดตั้งแพคเกจโปรแกรมประยุกต์การรวมแบบสองทิศทางหลักก่อนที่จะติดตั้งแพคเกจ Finance ของการรวมแบบสองทิศทาง
...
| msdyn_Dynamics365NotesMaps   | แม็ปเอนทิตี Dynamics 365 Notes |
...
| msdyn_DualWriteAssetManagementMaps   | แม็ปเอนทิตี Dynamics 365 การจัดการสินทรัพย์ |
...
แพคเกจการจัดการสินทรัพย์ของการรวมแบบสองทิศทางจะขึ้นอยู่กับแพคเกจของโปรแกรมประยุกต์การรวมแบบสองทิศทางหลัก ดังนั้น คุณจึงควรติดตั้งแพคเกจโปรแกรมประยุกต์การรวมแบบสองทิศทางหลักก่อนที่จะติดตั้งแพคเกจการจัดการสินทรัพย์ของการรวมแบบสองทิศทาง
