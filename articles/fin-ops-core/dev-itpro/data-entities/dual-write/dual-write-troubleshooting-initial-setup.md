...
หัวข้อนี้แสดงข้อมูลเกี่ยวกับการแก้ไขปัญหาสำหรับการรวมแบบสองทิศทางระหว่างแอป Finance and Operations และ Common Data Service กล่าวคือ จะให้ข้อมูลซึ่งช่วยให้คุณสามารถแก้ไขปัญหาที่อาจเกิดขึ้นในระหว่างการตั้งค่าเริ่มต้นของการรวมแบบสองทิศทาง
...
คุณต้องมีข้อมูลประจำตัวของผู้ดูแลระบบผู้เช่า Azure AD เพื่อเชื่อมโยงสภาพแวดล้อม Finance and Operations และ Common Data Service หลังจากที่คุณเชื่อมโยงสภาพแวดล้อมแล้ว ผู้ใช้สามารถลงชื่อเข้าใช้ได้โดยใช้ข้อมูลประจำตัวของบัญชีผู้ใช้และปรับปรุงแม็ปเอนทิตี้ที่มีอยู่

## <a name="error-when-you-open-the-link-to-common-data-service-page"></a>ข้อผิดพลาดเมื่อคุณเปิดลิงค์ไปยังหน้า Common Data Service

**ข้อมูลประจำตัวที่จำเป็นในแก้ปัญหา:** ผู้ดูแลระบบผู้เช่า Azure AD

คุณอาจได้รับข้อความแสดงข้อผิดพลาดต่อไปนี้ เมื่อคุณเปิด **ลิงค์ไปยังหน้า Common Data Service** ในแอป Finance and Operations:
...
2. เลือก **ยอมรับ** เพื่อระบุว่าคุณกำลังให้ความยินยอมในการติดตั้งแอปที่มีรหัส **33976c19-1db5-4c02-810e-c243db79efde** ในผู้เช่าของคุณ
    ...
    > [!TIP]
    > ต้องใช้แอปนี้ในการเชื่อมโยงแอป Common Data Service และแอป Finance and Operations ถ้าคุณมีปัญหาในขั้นตอนนี้ ให้เปิดเบราว์เซอร์ของคุณในโหมดที่ไม่ระบุตัวตน (ใน Google Chrome) หรือโหมด InPrivate (ใน Microsoft Edge)
...
## <a name="find-the-limit-on-the-number-of-legal-entities-or-companies-that-can-be-linked-for-dual-write"></a>ค้นหาขีดจำกัดของจำนวนนิติบุคคลหรือบริษัทที่สามารถเชื่อมโยงสำหรับการรวมแบบสองทิศทาง
...
ขีดจำกัดปัจจุบันเมื่อคุณเชื่อมโยงสภาพแวดล้อมคือนิติบุคคลประมาณ 40 ราย ข้อผิดพลาดนี้จะเกิดขึ้น ถ้าคุณพยายามเปิดใช้งานแผนที่ และมีการเชื่อมโยงนิติบุคคลมากกว่า 40 รายระหว่างสภาพแวดล้อม
