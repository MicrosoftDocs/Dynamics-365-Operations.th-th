...
|---|---|
| FONewParty.csv | ไฟล์นี้จะช่วยสร้างเรกคอร์ด **ฝ่าย** ใหม่ภายในแอป Finance and Operations |
...
| ImportFONewElectronicAddress.csv | ไฟล์นี้ช่วยสร้างเรกคอร์ด **ที่อยู่ทางอิเล็กทรอนิกส์** ใหม่ในแอป Finance and Operations |
...
8. นําเข้าเรกคอร์ด **ฝ่าย** ลงในแอป Finance and Operations
    ...
    2. แปลงไฟล์ **FONewParty.csv** เป็นไฟล์ Excel และนําเข้าไฟล์ Excel ไปยังแอป Finance and Operations หรือหากการนําเข้า CSV ใช้ได้ คุณสามารถนําเข้าไฟล์ .csv ได้โดยตรง ขั้นตอนนี้อาจใช้เวลาสองสามชั่วโมงจึงจะเสร็จ ขึ้นอยู่กับปริมาณข้อมูล สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [ภาพรวมของงานนำเข้าและส่งออกข้อมูล](../data-import-export-job.md)
...
10. เมื่อต้องการอัปเดตแอป Finance and Operations ด้วยข้อมูลนี้ คุณต้องแปลงไฟล์ .csv เป็นเวิร์กบุ๊ก Excel และ [นําเข้าไปยังแอป Finance and Operations](../data-import-export-job.md) หรือหากการนําเข้า CSV ใช้ได้ คุณสามารถนําเข้าไฟล์ .csv ได้โดยตรง ขั้นตอนนี้อาจใช้เวลาสองสามชั่วโมงจึงจะเสร็จ ขึ้นอยู่กับปริมาณ
...
2. ขั้นตอนที่ 7-1 ถึง 7-9 จะเรียกข้อมูลจากทั้งแอป Finance and Operations และแอปการมีส่วนร่วมของลูกค้าและลำดับขั้นข้อมูลสำหรับการอัปเกรด
3. ขั้นตอนที่ 8 ถึง 9 จะเปรียบเทียบหมายเลขฝ่ายสำหรับเรกคอร์ด **บัญชี**, **ผู้ติดต่อ** และ **ผู้จัดจำหน่าย** ระหว่างแอป Finance and Operations กับแอปการมีส่วนร่วมของลูกค้า เรกคอร์ดที่ไม่มีหมายเลขฝ่ายจะถูกข้าม
4. ขั้นตอนที่ 10 จะสร้างไฟล์ .csv สองไฟล์ต่อเรกคอร์ดฝ่ายที่ต้องสร้างในแอปการมีส่วนร่วมของลูกค้าและแอป Finance and Operations
...
1. ขั้นตอนที่ 1-1 ถึง 1-10 จะเรียกข้อมูลจากทั้งแอป Finance and Operations และแอปการมีส่วนร่วมของลูกค้าและลำดับขั้นข้อมูลสำหรับการอัปเกรด
...
5. ขั้นตอนที่ 5-1 สร้างไฟล์ .csv สำหรับแอปการมีส่วนร่วมของลูกค้าเพื่อสร้างข้อมูลที่อยู่ทั้งหมดตามแอป Finance and Operations และแอปการมีส่วนร่วมของลูกค้า
...
3. ขั้นตอนที่ 3 ผสานข้อมูลที่อยู่อิเล็กทรอนิกส์หลักจากแอปการมีส่วนร่วมของลูกค้าและแอป Finance and Operations
4. ขั้นตอนที่ 4 สร้างไฟล์ .csv
    ...
    - สร้างข้อมูลที่อยู่อิเล็กทรอนิกส์ใหม่สำหรับแอปการมีส่วนร่วมของลูกค้าโดยยึดตามที่อยู่อิเล็กทรอนิกส์ ที่อยู่ของบัญชี ผู้ติดต่อ และผู้จัดส่งในแอป Finance and Operations
