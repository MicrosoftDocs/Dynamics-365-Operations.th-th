...
Dataverse ผลิตภัณฑ์เฉพาะที่นำออกใช้ | ผลิตภัณฑ์ | เอนทิตี้ **ผลิตภัณฑ์** ประกอบด้วยฟิลด์ที่กำหนดผลิตภัณฑ์ โดยรวมถึงผลิตภัณฑ์แต่ละรายการ (ผลิตภัณฑ์ที่มีผลิตภัณฑ์ชนิดย่อย) และผลิตภัณฑ์ย่อย ตารางต่อไปนี้แสดงการแม็ป
...
สีของผลิตภัณฑ์หลัก | msdyn_sharedproductcolors | เอนทิตี้ **สีผลิตภัณฑ์ที่ใช้ร่วมกัน** บ่งชี้สีที่ผลิตภัณฑ์หลักที่ระบุสามารถมีได้ แนวคิดนี้ถูกย้ายไปที่ Dataverse เพื่อให้ข้อมูลสอดคล้องกัน
ขนาดของผลิตภัณฑ์หลัก | msdyn_sharedproductsizes | เอนทิตี้ **ขนาดผลิตภัณฑ์ที่ใช้ร่วมกัน** บ่งชี้ขนาดที่ผลิตภัณฑ์หลักที่ระบุสามารถมีได้ แนวคิดนี้ถูกย้ายไปที่ Dataverse เพื่อให้ข้อมูลสอดคล้องกัน
ลักษณะของผลิตภัณฑ์หลัก | msdyn_sharedproductstyles | เอนทิตี้ **ลักษณะผลิตภัณฑ์ที่ใช้ร่วมกัน** บ่งชี้ลักษณะที่ผลิตภัณฑ์หลักที่ระบุสามารถมีได้ แนวคิดนี้ถูกย้ายไปที่ Dataverse เพื่อให้ข้อมูลสอดคล้องกัน
การตั้งค่าคอนฟิกผลิตภัณฑ์หลัก | msdyn_sharedproductconfigurations | เอนทิตี้ **การตั้งค่าคอนฟิกของผลิตภัณฑ์ที่ใช้ร่วมกัน** บ่งชี้การตั้งค่าคอนฟิกที่ผลิตภัณฑ์หลักที่ระบุสามารถมีได้ แนวคิดนี้ถูกย้ายไปที่ Dataverse เพื่อให้ข้อมูลสอดคล้องกัน
...
การจัดประเภทตามลำดับชั้นของผลิตภัณฑ์ | msdyn_productcategoryhierarhies | คุณใช้ลำดับชั้นของผลิตภัณฑ์เพื่อจัดประเภทหรือจัดกลุ่มผลิตภัณฑ์ ลำดับชั้นประเภทพร้อมใช้งานใน Dataverse โดยใช้เอนทิตี้ลำดับชั้นประเภทของผลิตภัณฑ์ 
...
ในแบบจำลองนี้ ผลิตภัณฑ์จะแสดงด้วยตารางสองชุดใน Dataverse: **ผลิตภัณฑ์** และ **msdyn\_sharedproductdetails** ในขณะที่เอนทิตี้แรกประกอบด้วยคำนิยามของผลิตภัณฑ์ (ตัวระบุเฉพาะสำหรับ ผลิตภัณฑ์ ชื่อผลิตภัณฑ์ และคำอธิบาย) เอนทิตี้ที่สองประกอบด้วยฟิลด์ที่จัดเก็บอยู่ในระดับผลิตภัณฑ์ การรวมกันของสองตารางเหล่านี้จะใช้ในการกำหนดผลิตภัณฑ์ตามแนวคิดของหน่วยการเก็บสต็อกสินค้า (SKU) ผลิตภัณฑ์ที่นำออกใช้แต่ละรายการจะมีข้อมูลอยู่ในตารางดังกล่าว (ผลิตภัณฑ์และรายละเอียดผลิตภัณฑ์ที่ใช้ร่วมกัน) เพื่อติดตามผลิตภัณฑ์ทั้งหมด (ที่นำออกใช้และไม่นำออกใช้) เอนทิตี **ผลิตภัณฑ์สากล** จะถูกนำมาใช้ 
...
โปรดทราบว่าการซิงโครไนส์ผลิตภัณฑ์เกิดขึ้นจากแอป Finance and Operations ไปยัง Dataverse ซึ่งหมายความว่าค่าของฟิลด์เอนทิตี้ของผลิตภัณฑ์สามารถเปลี่ยนได้ ใน Dataverse แต่เมื่อการซิงโครไนส์ถูกทริกเกอร์ (เมื่อมีการปรับเปลี่ยนฟิลด์ของผลิตภัณฑ์ในแอป Finance and Operations) ซึ่งจะเขียนทับค่าใน Dataverse 
...
เมื่อการเขียนแบบคู่ถูกเปิดใช้งาน ผลิตภัณฑ์จากแอป Finance and Operations จะถูกซิงโครไนส์กับ Dataverse และแอปที่เป็นแบบโมเดลอื่นๆ ใน Dynamics 365 ผลิตภัณฑ์ที่สร้างขึ้นใน Dataverse และแอป Dynamics 365 อื่นๆ ก่อนที่การเขียนแบบคู่ถูกนำออกใช้ จะไม่ได้รับการปรับปรุงหรือจับคู่กับข้อมูลผลิตภัณฑ์จากแอป Finance and Operations
...
ถ้ามีการเก็บผลิตภัณฑ์เดียวกัน (ทับซ้อนกัน/ตรงกัน) ใน Finance and Operations และ Dataverse และแอป Dynamics 365 อื่นๆ เมื่อเปิดใช้งานการเขียนแบบคู่ การซิงโครไนส์ของผลิตภัณฑ์จาก Finance and Operations จะเกิดขึ้น และเรกคอร์ดที่ซ้ำกันจะปรากฏขึ้นใน Dataverse สำหรับผลิตภัณฑ์เดียวกัน
ถ้าต้องการหลีกเลี่ยงสถานการณ์ก่อนหน้านี้ ถ้าแอป Dynamics 365 อื่นๆ มีผลิตภัณฑ์ที่ทับซ้อนกัน/จับคู่ กับ Finance and Operations แล้วผู้ดูแลระบบจะเปิดใช้งานการเขียนแบบคู่ ต้องรีบูตฟิลด์ **บริษัท** (ตัวอย่างเช่น:"USMF") และ **msdyn_productnumber** (ตัวอย่าง: "1234:Black:S") ก่อนดำเนินการซิงโครไนซ์ของผลิตภัณฑ์ กล่าวคือ ฟิลด์เหล่านี้สองฟิลด์ในผลิตภัณฑ์ใน Dataverse ต้องถูกกรอกข้อมูลกับบริษัทที่เกี่ยวข้องใน Finance and Operations ซึ่งผลิตภัณฑ์จำเป็นต้องตรงกับและมีหมายเลขผลิตภัณฑ์ 
