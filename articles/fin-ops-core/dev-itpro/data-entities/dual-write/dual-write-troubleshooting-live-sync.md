...
หัวข้อนี้แสดงข้อมูลเกี่ยวกับการแก้ไขปัญหาสำหรับการรวมแบบสองทิศทางระหว่างแอป Finance and Operations และ Microsoft Dataverse กล่าวคือ จะแสดงข้อมูลที่สามารถช่วยคุณแก้ไขปัญหาเกี่ยวกับการซิงโครไนส์ที่เริ่มใช้งานจริง
...
คุณอาจได้รับข้อความแสดงข้อผิดพลาดต่อไปนี้ เมื่อคุณพยายามบันทึกข้อมูลตารางในแอป Finance and Operations:
...
เมื่อต้องการแก้ไขปัญหานี้ ตรวจสอบให้แน่ใจว่ามีข้อมูลอ้างอิงของข้อกำหนดเบื้องต้นอยู่ในทั้งแอป Finance and Operations และ Dataverse ตัวอย่างเช่น ถ้าเรกคอร์ดลูกค้าเป็นของกลุ่มลูกค้าหนึ่งๆ โปรดตรวจสอบให้แน่ใจว่ามีเรกคอร์ดกลุ่มลูกค้าอยู่ใน Dataverse
...
คุณอาจได้รับข้อความแสดงข้อผิดพลาด "คำขอไม่ถูกต้อง" เมื่อคุณสร้างข้อมูลในแอป Finance and Operations
...
2. ในแอปการมีส่วนร่วมของลูกค้า ลงชื่อเข้าใช้ในสภาพแวดล้อม ไปที่ **การตั้งค่า \> การรักษาความปลอดภัย** และค้นหาทีมงานของหน่วยธุรกิจที่ถูกแม็ป
...
ข้อผิดพลาดนี้จะเกิดขึ้นหากสภาพแวดล้อม Dataverse ถูกรีเซ็ตอย่างไม่ถูกต้องเมื่อคุณพยายามที่จะสร้างข้อมูลในแอป Finance and Operations

> [!IMPORTANT]
> ถ้าคุณเชื่อมโยงสภาพแวดล้อมใหม่แล้ว คุณต้องหยุดการแม็ปเอนทิตีทั้งหมดก่อนที่คุณจะปฏิบัติตามขั้นตอนการลดระดับความเสี่ยงต่อไป

เมื่อต้องการแก้ไขปัญหา คุณต้องปฏิบัติตามขั้นตอนทั้งในแอป Dataverse และ Finance and Operations ให้เสร็จสมบูรณ์

1. ในแอป Finance and Operations ให้ทำตามขั้นตอนเหล่านี้:

    1. เปิดเอนทิตี **DualWriteProjectConfigurationEntity** โดยใช้ add-in ของ Excel เมื่อต้องการใช้ Add in ให้เปิดใช้งานโหมดการออกแบบใน Add in ของ Excel ของ Finance and Operations และเพิ่ม **DualWriteProjectConfigurationEntity** ลงในเวิร์กชีต สำหรับข้อมูลเพิ่มเติม ให้ดู [ดูและอัปเดตข้อมูลเอนทิตีด้วย Excel](../../office-integration/use-excel-add-in.md)
    2. เลือกและลบเรกคอร์ดที่มีปัญหาในแผนผังการรวมแบบสองทิศทางและโครงการ จะมีสองเรกคอร์ดสำหรับทุกแผนผังการรวมแบบสองทิศทาง
    3. เผยแพร่การเปลี่ยนแปลงโดยใช้ Add-in ของ Excel ขั้นตอนนี้สําคัญเนื่องจากขั้นตอนนี้จะลบเรกคอร์ดออกจากเอนทิตีและตารางพื้นฐาน
    4. เพื่อช่วยป้องกันข้อผิดพลาดเมื่อคุณเชื่อมโยงสภาพแวดล้อม Finance and Operations หรือ Dataverse อีกครั้ง ให้ตรวจสอบให้แน่ใจว่าไม่มีการตั้งค่าคอนฟิกการรวมแบบสองทิศทางอยู่
...
3. ในแอป Finance and Operations ให้ทำตามขั้นตอนเหล่านี้:
...
## <a name="data-from-finance-and-operations-apps-isnt-synced-to-dataverse"></a>ข้อมูลจากแอป Finance and Operations ไม่ซิงค์กับ Dataverse

ในระหว่างการซิงโครไนส์ที่เริ่มใช้งานจริง คุณอาจพบปัญหาที่มีการซิงค์ข้อมูลจากแอป Finance and Operations ไปยัง Dataverse เพียงบางส่วนเท่านั้น หรือข้อมูลไม่ซิงค์เลย
...
+ เหตุการณ์ทางธุรกิจต้องลงทะเบียนสำหรับแหล่งข้อมูลที่แม็ป แหล่งข้อมูลบางแหล่งอาจใช้ตัวเชื่อมภายนอกและอาจถูกเลือกเป็นอ่านอย่างเดียวในแอป Finance and Operations แหล่งข้อมูลเหล่านี้ไม่มีการติดตาม
+ การเปลี่ยนแปลงจะถูกทริกเกอร์เฉพาะเมื่อการแก้ไขอยู่ในฟิลด์ที่แม็ปเท่านั้น การแก้ไขฟิลด์ที่ยกเลิกการแม็ปจะไม่ทริกเกอร์การรวมแบบสองทิศทาง
+ ตรวจสอบให้แน่ใจว่าการประเมินตัวกรองให้ผลลัพธ์ที่ถูกต้อง

### <a name="troubleshooting-steps"></a>ขั้นตอนการแก้ไขปัญหา

1. ตรวจทานการแม็ปฟิลด์ในหน้าการดูแลระบบการรวมแบบสองทิศทาง หากฟิลด์ไม่ได้แม็ปจากแอป Finance and Operations ไปยัง Dataverse ฟิลด์จะไม่มีการติดตาม ตัวอย่างเช่น ในภาพประกอบต่อไปนี้ ฟิลด์ **คำอธิบาย**  จะถูกติดตามจากแอป Dataverse แต่ไม่ใช่จากแอป Finance and Operations ไม่มีการติดตามการเปลี่ยนแปลงกับฟิลด์ภายในแอป Finance and Operations
...
6. เริ่มต้นการแม็ป คุณควรเห็นตารางใหม่ (**LogisticsPostalAddress** ในตัวอย่างนี้) ที่คุณเริ่มติดตามโดยใช้คอลัมน์ **RefTableName** ของแถวที่ค่า **refentityname** เท่ากับ **smmContactPersonCDSV2Entity** ในตาราง **BusinessEventsDefinition**

## <a name="error-when-you-create-a-record-where-multiple-records-are-sent-from-a-finance-and-operations-app-to-dataverse-in-the-same-batch"></a>เกิดข้อผิดพลาดเมื่อคุณสร้างเรกคอร์ดที่มีการส่งหลายเรกคอร์ดจากแอป Finance and Operations ไปยัง Dataverse ในชุดงานเดียวกัน

สำหรับธุรกรรมใดๆ แอป Finance and Operations จะสร้างข้อมูลในชุดงานและส่งข้อมูลเป็นชุดงานไปยัง Dataverse หากมีการสร้างสองเรกคอร์ดเป็นส่วนหนึ่งของธุรกรรมเดียวกัน และทั้งสองเรกคอร์ดอ้างอิงกัน คุณอาจได้รับข้อความแสดงข้อผิดพลาดที่มีลักษณะคล้ายกับตัวอย่างต่อไปนี้ในแอป Finance and Operations:
...
เมื่อต้องการแก้ไขปัญหา ให้สร้างความสัมพันธ์เอนทิตีในแอป Finance and Operations เพื่อระบุว่าทั้งสองเอนทิตี้เกี่ยวข้องกัน และมีการจัดการ เรกคอร์ดที่เกี่ยวข้องในธุรกรรมเดียวกัน

## <a name="enable-verbose-logging-of-error-messages"></a>เปิดใช้งานการบันทึก verbose ของข้อความแสดงข้อผิดพลาด

ในแอป Finance and Operations คุณอาจพบข้อผิดพลาดที่เกี่ยวข้องกับสภาพแวดล้อม Dataverse ข้อความแสดงข้อผิดพลาดอาจไม่มีข้อความทั้งหมดของข้อความหรือข้อมูลที่เกี่ยวข้องอื่นๆ หากต้องการได้รับข้อมูลเพิ่มเติม คุณสามารถเปิดใช้งานการบันทึก verbose โดยการตั้งค่าแฟล็ก **IsDebugMods** ที่มีอยู่ในเอนทิตี **DualWriteProjectConfigurationEntity** ในการตั้งค่าคอนฟิกโครงการทั้งหมดในแอป Finance and Operations
...
คุณอาจได้รับข้อความแสดงข้อผิดพลาดต่อไปนี้เมื่อคุณพยายามเพิ่มที่อยู่ของลูกค้าหรือผู้ติดต่อในแอป Finance and Operations หรือ Dataverse:
...
เมื่อสร้างลูกค้าขึ้นใน Dataverse ระบบจะสร้างหมายเลขฝ่ายใหม่ ข้อความแสดงข้อผิดพลาดจะปรากฏขึ้นเมื่อเรกคอร์ดลูกค้าและฝ่ายถูกซิงค์กับแอป Finance and Operations แต่มีเรกคอร์ดลูกค้าที่มีหมายเลขฝ่ายแตกต่างกันอยู่แล้ว
...
ใน Dataverse จะมีลำดับหมายเลขในตาราง **msdyn_party** เมื่อสร้างบัญชีใน Dataverse ฝ่ายใหม่จะถูกสร้างขึ้น (ตัวอย่างเช่น **ฝ่าย-001** ของชนิด **องค์กร**) ข้อมูลนี้จะถูกส่งไปยังแอป Finance and Operations ถ้ามีการรีเซ็ตสภาพแวดล้อม Dataverse หรือสภาพแวดล้อม Finance and Operations เชื่อมโยงกับสภาพแวดล้อม Dataverse อื่น จากนั้นมีการสร้างเรกคอร์ดผู้ติดต่อใหม่ใน Dataverse ค่าฝ่ายใหม่ที่เริ่มต้นด้วย **ฝ่าย-001** จะถูกสร้างขึ้น เวลานี้ เรกคอร์ดฝ่ายที่สร้างจะเป็น **ฝ่าย-001** ของชนิด **บุคคล** เมื่อซิงค์ข้อมูลนี้แล้ว แอป Finance and Operations จะแสดงข้อความแสดงข้อผิดพลาดก่อนหน้านี้ เนื่องจากมีเรกคอร์ดฝ่าย **ฝ่าย-001** ของชนิด **องค์กร** อยู่แล้ว
...
## <a name="performance-issue-with-customer-or-contact-mappings"></a>ปัญหาประสิทธิภาพการแม็ปลูกค้าหรือผู้ติดต่อ
...
3. เริ่มต้นการแม็ป คุณควรดูเรกคอร์ดในเอนทิตี **smmContactPersonCDSV2Entity** และ **CustCustomerV3Entity** และตาราง **BusinessEventsDefinition** และประสิทธิภาพอาจปรับปรุงเป็นระยะๆ
