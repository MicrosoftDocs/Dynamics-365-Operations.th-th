...
ms.locfileid: "3997587"
---
# <a name="bootstrap-with-company-data-faq"></a><span data-ttu-id="1c124-103">ปลุกเครื่องด้วยคำถามที่ถามบ่อยเกี่ยวกับข้อมูลของบริษัท</span><span class="sxs-lookup"><span data-stu-id="1c124-103">Bootstrap with company data FAQ</span></span>
 
[!include [banner](../../includes/banner.md)]


## <a name="why-do-i-need-bootstrapping"></a><span data-ttu-id="1c124-104">เพราะเหตุใดฉันจึงต้องปลุกเครื่อง</span><span class="sxs-lookup"><span data-stu-id="1c124-104">Why do I need bootstrapping?</span></span> 
<span data-ttu-id="1c124-105">คุณอาจมีอินสแตนซ์ของ Common Data Service หรือแอป Dynamics 365 ที่มีอยู่ที่มีข้อมูลธุรกิจ และคุณต้องการเปิดใช้งานการเชื่อมต่อแบบการเขียนแบบสองครั้ง</span><span class="sxs-lookup"><span data-stu-id="1c124-105">You might have an existing Common Data Service or other Dynamics 365 app instance with business data, and you want to enable dual-write connection against it.</span></span> <span data-ttu-id="1c124-106">ในกรณีนี้ คุณจำเป็นต้องปลุกเครื่องข้อมูลของ Common Data Service หรือแอป Dynamics 365 ด้วยข้อมูลของบริษัทก่อนที่จะเปิดใช้งานการเชื่อมต่อแบบการเขียนแบบสองครั้ง</span><span class="sxs-lookup"><span data-stu-id="1c124-106">In this case, you need to bootstrap Common Data Service or other Dynamics 365 app data with company information before enabling dual-write connection.</span></span>  
 
## <a name="when-should-i-use-bootstrapping"></a><span data-ttu-id="1c124-107">ฉันควรใช้การปลุกเครื่องเมื่อใด</span><span class="sxs-lookup"><span data-stu-id="1c124-107">When should I use bootstrapping?</span></span> 
<span data-ttu-id="1c124-108">คุณควรใช้การปลุกเครื่องก่อนที่จะเปิดใช้งานแผนผังเอนทิตีที่มีการเขียนแบบสองครั้ง (ระหว่างขั้นตอนที่ 5)</span><span class="sxs-lookup"><span data-stu-id="1c124-108">You should use bootstrapping before enabling dual-write entity maps (during step #5).</span></span>  
1. <span data-ttu-id="1c124-109">เมื่อต้องการตั้งค่าการเชื่อมต่อแบบการเขียนสองครั้งระหว่างอินสแตนซ์ของแอป Finance and Operations และ Common Data Service และแอป Dynamics 365 อื่นๆ ให้ล็อกอินไปยังแอป Finance and Operations ในฐานะผู้ดูแลระบบ</span><span class="sxs-lookup"><span data-stu-id="1c124-109">To setup the dual-write connection between instances of your Finance and Operations app and the Common Data Service or other Dynamics 365 app, log in to the Finance and Operations app as an administrator.</span></span> 
2. <span data-ttu-id="1c124-110">ไปที่โมดูล **การจัดการข้อมูล** แล้วคลิกปุ่มแบบ **การเขียนแบบสองครั้ง**</span><span class="sxs-lookup"><span data-stu-id="1c124-110">Go to the **Data Management** module and click the **Dual-Write** button.</span></span> <span data-ttu-id="1c124-111">ขั้นตอนนี้จะเป็นการเรียกใช้ **ตัวรวมข้อมูล**</span><span class="sxs-lookup"><span data-stu-id="1c124-111">This launches the **Data Integrator**.</span></span> 
3. <span data-ttu-id="1c124-112">สร้างการเชื่อมต่อแบบการเขียนสองครั้งสำหรับบริษัทหนึ่งแห่งขึ้นไป</span><span class="sxs-lookup"><span data-stu-id="1c124-112">Create the dual-write connection for one or more companies.</span></span>  
    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="1c124-113">![สร้างการเชื่อมต่อแบบการเขียนสองครั้ง](media/dual-write-boot-1.png)</span><span class="sxs-lookup"><span data-stu-id="1c124-113">![Create dual-write connection](media/dual-write-boot-1.png)</span></span>
4. <span data-ttu-id="1c124-114">เปิดใช้งานแผนผังเอนทิตี **Cdm_companies**</span><span class="sxs-lookup"><span data-stu-id="1c124-114">Enable the **Cdm_companies** entity map.</span></span> <span data-ttu-id="1c124-115">นี่จะเป็นการซิงโครไนส์บริษัทจากแอป Finance and Operations ไปยัง Common Data Service</span><span class="sxs-lookup"><span data-stu-id="1c124-115">This synchronizes companies from the Finance and Operations app to Common Data Service.</span></span>  
    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="1c124-116">![เปิดใช้งานแผนผังเอนทิตี](media/dual-write-boot-2.png)</span><span class="sxs-lookup"><span data-stu-id="1c124-116">![Enable the entity map](media/dual-write-boot-2.png)</span></span>
5. <span data-ttu-id="1c124-117">รันรหัสการปลุกเครื่องตัวอย่างบนอินสแตนซ์ Common Data Service หรือแอป Dynamics 365 อื่นๆ</span><span class="sxs-lookup"><span data-stu-id="1c124-117">Run the sample bootstrapping code on the Common Data Service or other Dynamics 365 app instance.</span></span>  
6. <span data-ttu-id="1c124-118">เมื่อปลุกเครื่องเสร็จแล้วและระบบพร้อมสำหรับการซิงค์สด ให้เปิดใช้งานแผนผังเอนทิตี</span><span class="sxs-lookup"><span data-stu-id="1c124-118">When the bootstrapping is done and the system is ready for the live sync, enable the entity maps.</span></span>  

    <span data-ttu-id="1c124-119">การเปิดใช้งานแผนผังเอนทิตีจะเป็นการทริกเกอร์การซิงค์ข้อมูลเริ่มต้นสำหรับแผนผังเอนทิตีที่เปิดใช้งาน</span><span class="sxs-lookup"><span data-stu-id="1c124-119">Enabling the entity maps triggers the initial data sync for the enabled entity maps.</span></span> <span data-ttu-id="1c124-120">ข้อมูลที่เกี่ยวข้องกับบริษัทที่เลือกบนการเชื่อมต่อแบบการเขียนสองครั้งจะถูกซิงโครไนส์ระหว่างแอป Finance and Operations และ Common Data Service</span><span class="sxs-lookup"><span data-stu-id="1c124-120">The data corresponding to the companies chosen on the dual-write connection is synchronized between the Finance and Operations app and Common Data Service.</span></span> 
 
## <a name="how-to-i-use-the-code-sample"></a><span data-ttu-id="1c124-121">ฉันจะใช้ตัวอย่างรหัสได้อย่างไร</span><span class="sxs-lookup"><span data-stu-id="1c124-121">How to I use the code sample?</span></span>
<span data-ttu-id="1c124-122">รหัสตัวอย่างเป็นแอปพลิเคชัน C# ที่คุณสามารถโหลดได้ใน Visual Studio</span><span class="sxs-lookup"><span data-stu-id="1c124-122">The sample code is a C# application that you can load in Visual Studio.</span></span> <span data-ttu-id="1c124-123">ซึ่งจะใช้การอ้างอิงแพ็คเกจ NuGet บน Common Data Service SDK ซึ่งคุณสามารถรีเฟรชผ่านเครื่องมือ Visual Studio มาตรฐาน</span><span class="sxs-lookup"><span data-stu-id="1c124-123">It takes NuGet package dependencies on the Common Data Service SDK, that you can refresh through standard Visual Studio tooling.</span></span> 

<span data-ttu-id="1c124-124">หลังจากที่แตกไฟล์และเปิดโซลูชันใน Visual Studio และคืนค่าแพ็คเกจ NuGet แล้ว ให้ค้นหา **TODO** ในรหัส</span><span class="sxs-lookup"><span data-stu-id="1c124-124">After unzipping and opening the solution in Visual Studio and restoring the NuGet packages, search for **TODO** in the code.</span></span> <span data-ttu-id="1c124-125">การตัดสินใจแต่ละครั้งที่คุณต้องทำเกี่ยวกับวิธีการที่คุณต้องการปลุกเครื่องข้อมูลของบริษัทจะถูกจดจำโดย **TODO** ด้วยรหัสตัวอย่างสำหรับการใช้งานที่มีมาตรฐาน</span><span class="sxs-lookup"><span data-stu-id="1c124-125">Each decision you need to make about how you want to bootstrap company information is noted by a **TODO** , with sample code for a canonical implementation.</span></span> 

<span data-ttu-id="1c124-126">รหัสตัวอย่างจะแสดงวิธีการใดวิธีการหนึ่งที่คุณสามารถจัดประเภทเรกคอร์ดเอนทิตีตามบริษัท</span><span class="sxs-lookup"><span data-stu-id="1c124-126">The sample code shows only one of many ways you might categorize entity records by company.</span></span> <span data-ttu-id="1c124-127">ด้วยการเปลี่ยนแปลงตรรกะในส่วน **TODO** คุณสามารถสร้างการจัดประเภทที่กำหนดเองของคุณได้</span><span class="sxs-lookup"><span data-stu-id="1c124-127">By changing the logic in the **TODO** sections, you can create your custom categorization.</span></span> 
 
## <a name="what-should-i-expect"></a><span data-ttu-id="1c124-128">ฉันควรคาดหวังอะไร</span><span class="sxs-lookup"><span data-stu-id="1c124-128">What should I expect?</span></span>
<span data-ttu-id="1c124-129">โดยค่าเริ่มต้น แอปพลิเคชันตัวอย่างจะช่วยให้คุณสามารถระบุพจนานุกรมของการแม็ปรหัสจากหน่วยธุรกิจไปยังบริษัทได้</span><span class="sxs-lookup"><span data-stu-id="1c124-129">By default, the sample application lets you provide a dictionary of business unit-to-company code mappings.</span></span> <span data-ttu-id="1c124-130">เอนทิตีใดๆ ที่คุณปลุกเครื่องด้วยฟิลด์ **OwningBusinessUnit** จะถูกตั้งค่าให้ใช้บริษัทที่ระบุโดยอัตโนมัติ</span><span class="sxs-lookup"><span data-stu-id="1c124-130">Any entity you bootstrap with an **OwningBusinessUnit** field is automatically set to use the specified company.</span></span> <span data-ttu-id="1c124-131">เอนทิตีใดๆ ที่ไม่มีฟิลด์ **OwningBusinessUnit** เช่น ผลิตภัณฑ์ จะตั้งค่าบริษัทตามการแม็ปกับมูลค่าหน่วยธุรกิจที่ว่างเปล่า</span><span class="sxs-lookup"><span data-stu-id="1c124-131">Any entity without an **OwningBusinessUnit** field, such as product, will set the company based on the mapping with an empty business unit value.</span></span>

<span data-ttu-id="1c124-132">แอปพลิเคชันคอนโซลกำหนดให้ต้องมีหนึ่งพารามิเตอร์ ไม่ว่าจะเป็น **–simulate** หรือ **–apply**</span><span class="sxs-lookup"><span data-stu-id="1c124-132">The console application expects one parameter, either **–simulate** or **–apply**.</span></span> <span data-ttu-id="1c124-133">ถ้าคุณใช้พารามิเตอร์บรรทัดคำสั่ง **–simulate** จะไม่มีการอัพเดตข้อมูล</span><span class="sxs-lookup"><span data-stu-id="1c124-133">If you use the **–simulate** command line parameter, then no data is updated.</span></span> <span data-ttu-id="1c124-134">เฉพาะไฟล์ **simulation_<entityname>.csv** เท่านั้นที่จะถูกสร้างขึ้นในไดเรกทอรีเดียวกันกับเครื่องมือ จะมีการอัพเดตหนึ่งไฟล์สำหรับแต่ละเอนทิตี</span><span class="sxs-lookup"><span data-stu-id="1c124-134">Only **simulation_<entityname>.csv** files are generated in the same directory as the tool, one for each entity that would have been updated.</span></span> <span data-ttu-id="1c124-135">คุณสามารถตรวจทานไฟล์เหล่านี้ซ้ำได้ในขณะที่ทำงานเพื่อให้แน่ใจว่ารหัสจะอัพเดตค่าบริษัทตามที่คาดไว้</span><span class="sxs-lookup"><span data-stu-id="1c124-135">You can iteratively review these files while working to ensure the code updates company values as expected.</span></span> 

<span data-ttu-id="1c124-136">เมื่อคุณอัพเดตที่จำลองขึ้นเสร็จแล้ว ให้ใช้พารามิเตอร์ **–apply**</span><span class="sxs-lookup"><span data-stu-id="1c124-136">When you finish with the simulated updates, then use the **–apply** parameter.</span></span> <span data-ttu-id="1c124-137">การทำเช่นนี้จะเป็นการอัพเดตเรกคอร์ดทั้งหมดที่มีค่าของบริษัทที่ไม่ถูกต้องในชุดงานเรกคอร์ด 1000 รายการในแต่ละครั้ง (โดยค่าเริ่มต้น)</span><span class="sxs-lookup"><span data-stu-id="1c124-137">This updates all records that currently have an incorrect company value, in batches of 1000 records at a time (by default).</span></span> <span data-ttu-id="1c124-138">รหัสจะเหมือนตามที่ระบุ ซึ่งหมายความว่าคุณสามารถรันใหม่ได้และจะมีการอัพเดตเฉพาะบริษัทที่กำหนดอย่างไม่ถูกต้องเท่านั้น</span><span class="sxs-lookup"><span data-stu-id="1c124-138">The code is idempotent as provided, meaning you can re-run it and only the incorrectly assigned companies will be updated.</span></span> <span data-ttu-id="1c124-139">เมื่อรันโดยใช้ **–apply** รหัสจะแสดงผลลัพธ์การเปลี่ยนแปลงที่เกิดขึ้นเป็นไฟล์ CSV ซึ่งมีชื่อ **applied_<entityname>.csv**</span><span class="sxs-lookup"><span data-stu-id="1c124-139">When running with **–apply** , the code outputs CSV files of the changes made, which are named **applied_<entityname>.csv**.</span></span> 
