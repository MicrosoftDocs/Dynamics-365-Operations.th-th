...
ฟิลด์ใหม่ได้ถูกเพิ่มลงในเอนทิตี **ใบสั่ง** และแสดงขึ้นบนหน้า ฟิลด์เหล่านี้ส่วนใหญ่จะปรากฏบนแท็บ **การรวม** ใน Sales เมื่อต้องการเรียนรู้เพิ่มเติมเกี่ยวกับวิธีการแม็ปฟิลด์สถานะ ดูที่ [ตั้งค่าการแม็ปสำหรับฟิลด์สถานะของใบสั่งขาย](sales-status-map.md)
