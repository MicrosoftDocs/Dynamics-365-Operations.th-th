...
description: บทความนี้แสดงข้อมูลเกี่ยวกับผู้ที่มีแนวโน้มจะเป็นลูกค้าจนถึงเงินสดในการรวมแบบสองทิศทาง
...
[ส่วนหัวของใบแจ้งหนี้การขาย V2](mapping-reference.md#118) | ใบแจ้งหนี้ | ตารางส่วนหัวของใบแจ้งหนี้การขาย V2 ในแอปการเงินและการดำเนินงาน มีใบแจ้งหนี้สำหรับใบสั่งขายและใบแจ้งหนี้ข้อความอิสระ ตัวกรองจะใช้ใน Dataverse สำหรับการรวมแบบสองทิศทางซึ่งจะกรองเอกสารใบแจ้งหนี้ข้อความอิสระใดๆ ออกไป |
