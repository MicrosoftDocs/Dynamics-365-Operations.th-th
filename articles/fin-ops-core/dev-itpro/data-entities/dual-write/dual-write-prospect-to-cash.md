...
ฟิลด์ใหม่ได้ถูกเพิ่มลงในเอนทิตี **ใบสั่ง** และแสดงขึ้นบนหน้า ฟิลด์เหล่านี้ส่วนใหญ่จะปรากฏบนแท็บ **การรวม** ใน Sales มีฟิลด์พิเศษอยู่สองสามฟิลด์ดังนี้:

+ ฟิลด์ **สถานะการประมวลผล** แสดงสถานะการประมวลผลของใบสั่งใน Supply Chain Management ฟิลด์นี้จะถูกล็อคและแสดงเฉพาะสถานะของใบสั่งจาก Supply Chain Management ค่าที่พร้อมใช้งานมีดังต่อไปนี้

    + **เปิดใช้งาน** – สถานะหลังจากใบสั่งถูกเรียกใช้ใน Sales โดยการใช้ปุ่ม **เรียกใช้**
    + **วันที่ยืนยัน**
    + **จัดส่งแล้ว**
    + **ออกใบแจ้งหนี้แล้ว**
    + **จัดส่งสินค้าแล้วบางส่วน**
    + **ออกใบแจ้งหนี้แล้วบางส่วน**
    + **เบิกสินค้าแล้ว**
    + **ยกเลิก**

    ตารางต่อไปนี้แสดงวิธีการแม็ปสถานะการประมวลผลกับค่า **รหัสสถานะ CRM**

    | สถานะการประมวลผล           | รหัสสถานะ CRM    |
    |-----------------------------|--------------------|
    | ที่ใช้งานอยู่                      | ใหม่/ค้างอยู่/ระงับ |
    | ยืนยันแล้ว/เบิกสินค้าแล้ว            | กำลังดำเนินการ        |
    | จัดส่งสินค้าแล้วบางส่วน         | บางส่วน            |
    | จัดส่งแล้ว                   | เสร็จสมบูรณ์           |
    | ออกใบแจ้งหนี้แล้ว/ออกใบแจ้งหนี้แล้วบางส่วน | ออกใบแจ้งหนี้แล้ว           |
    | ยกเลิก                    | ไม่มีเงิน           |
