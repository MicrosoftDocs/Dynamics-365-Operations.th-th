...
2. ค้นหาเอนทิตี้ที่ขาดฟิลด์ จัดทำบันทึกย่อของเอนทิตี้เป้าหมาย ตารางการแบ่งระยะ ชื่อเอนทิตี้ และค่าคอลัมน์อื่นๆ
3. ถ้ากลุ่มการประมวลผลใดๆ ของคุณขึ้นอยู่กับเอนทิตี้นี้ ให้ใช้การดำเนินการที่เหมาะสมสำหรับกลุ่มการประมวลผล ก่อนที่คุณจะลบเอนทิตี้
4. ลบเอนทิตี้ที่ขาดฟิลด์
5. เลือก **สร้าง** และเพิ่มเอนทิตี้กลับ ระบุค่าที่คุณได้บันทึกไว้ในขั้นตอนที่2
6. เปิดหน้า **การแม็ปเอนทิตี้** จากหน้า **การรวมแบบสองทิศทาง** ในแอป Finance and Operations
7. เลือก **รีเฟรชรายการเอนทิตี้** เพื่อเติมข้อมูลในฟิลด์โดยอัตโนมัติในการแม็ปเอนทิตี้
