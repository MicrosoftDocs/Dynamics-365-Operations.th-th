...
4. เปิดแอป Finance and Operations นําทางไปยังโมดูลการจัดการข้อมูลและเลือกแท็บการรวมแบบสองทิศทาง หน้าการจัดการการรวมแบบสองทิศทางจะเปิดขึ้น

5. นําโซลูชันทั้งสองที่ติดตั้งในขั้นตอนที่ 2 และ 3 ไปใช้โดยใช้ฟังก์ชัน [Apply Solution](link-your-environment.md)

6. หยุดแผนผังต่อไปนี้ เนื่องจากไม่ต้องใช้อีกต่อไป แต่ให้รันแผนผัง `Contacts V2 (msdyn_contactforparties)` แทน
...
7. การแม็ปเอนทิตีต่อไปนี้มีการอัพเดตสำหรับฟังก์ชันของฝ่าย ดังนั้น ต้องใช้รุ่นล่าสุดกับการแม็ปเหล่านี้
...
8. ก่อนรันแผนผังข้างต้น คุณต้องอัปเดตคีย์การรวมด้วยตนเองตามที่อธิบายไว้ในขั้นตอนต่อไปนี้ จากนั้น เลือก **บันทึก**
...
11. ถ้าคุณเป็นผู้ใช้การรวมแบบสองทิศทางที่มีอยู่ ให้ปฏิบัติตามคําแนะนําใน [การอัปเกรดไปยังฝ่ายและสมุดที่อยู่สากล](upgrade-party-gab.md) และอัปเกรดข้อมูลของคุณ

12. รันแผนผังตามลำดับต่อไปนี้ ถ้าคุณได้รับข้อผิดพลาดที่ระบุว่า "การตรวจสอบความถูกต้องของโครงการล้มเหลว ฟิลด์ปลายทางที่ขาดหายไป..."แล้วเปิดแผนผังและเลือก **รีเฟรชตาราง** แล้วรันแผนผัง
