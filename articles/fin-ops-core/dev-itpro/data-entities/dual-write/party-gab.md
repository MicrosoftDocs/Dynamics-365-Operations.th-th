...
*ฝ่าย* และ *สมุดที่อยู่สากล* เป็นแนวคิดในโปรแกรมประยุกต์ Finance and Operations ฝ่ายอาจเป็นองค์กรหรือบุคคล ซึ่งมีความสะดวกสบายในการจัดเก็บและจัดการคุณสมบัติของฝ่าย เช่น ชื่อ ภาษา ผู้ติดต่อ และที่อยู่ จากนั้นเมื่อค่าคุณสมบัติเปลี่ยนแปลงในที่เดียว ค่าคุณสมบัติจะสะท้อนอยู่ในทุกที่ซึ่งฝ่ายเกี่ยวข้อง
...
+ **ผู้จัดจำหน่าย** – องค์กรของซัพพลายเออร์ หรือเจ้าของรายเดียวที่จัดหาสินค้าหรือบริการให้กับธุรกิจ ตัวอย่างเช่น หาก Fabrikam ขายวัสดุให้กับ Contoso Fabrikam คือผู้จัดจำหน่ายของ Contoso
...
+ **ลูกค้า** – บุคคลหรือบริษัทที่ซื้อสิ่งต่างๆ จากบริษัท ตัวอย่างเช่น หาก Contoso ซื้อวัสดุจาก Fabrikam จากนั้น Contoso เป็นลูกค้าของ Fabrikam
...
การรวมแบบสองทิศทางไม่สนับสนุนบทบาทของฝ่ายทั้งหมดของแอป Finance and Operations สำหรับรายการของบทบาทฝ่ายทั้งหมด ดู [ภาพรวมสมุดที่อยู่สากล](../../../fin-ops/organization-administration/overview-global-address-book.md)
...
ที่อยู่อิเล็กทรอนิกส์จะพร้อมใช้งานบนกริดนี้เท่านั้น ในรุ่นในอนาคต ฟิลด์ที่อยู่ไปรษณีย์และที่อยู่อิเล็กทรอนิกส์ทั้งหมดจะถูกลบออกจากแท็บอื่น ๆ (ตัวอย่างเช่น แท็บ **สรุป** และ **รายละเอียด**)

## <a name="setup"></a>ตั้งค่า

1. ติดตั้งรุ่นล่าสุด (2.2.2.60 หรือใหม่กว่า) [โซลูชันการประสานกันของแอปพลิเคชันการรวมแบบสองทิศทาง](https://aka.ms/dual-write-app)

2. ติดตั้ง [ฝ่ายการรวมแบบสองทิศทางและโซลูชันสมุดที่อยู่สากล](https://aka.ms/dual-write-gab)

3. หยุดแผนผังต่อไปนี้ เนื่องจากไม่ต้องใช้อีกต่อไป แต่ให้รันแผนผัง `Contacts V2 (msdyn_contactforparties)` แทน
...
4. การแม็ปเอนทิตีต่อไปนี้มีการอัพเดตสำหรับฟังก์ชันของฝ่าย ดังนั้น ต้องใช้รุ่นล่าสุดกับการแม็ปเหล่านี้
...
5. ก่อนรันแผนผังข้างต้น คุณต้องอัปเดตคีย์การรวมด้วยตนเองตามที่อธิบายไว้ในขั้นตอนต่อไปนี้ จากนั้น เลือก **บันทึก**
...
6. ใน Dataverse ขีดจํากัดอักขระของกฎการตรวจหาข้อมูลจะเพิ่มขึ้นจาก 450 เป็น 700 อักขระ ขีดจํากัดนี้ช่วยให้คุณสามารถเพิ่มคีย์หนึ่งคีย์หรือมากกว่าในกฎการตรวจหาข้อมูลซ้อน ขยายกฎการตรวจหาข้อมูลซ้อนสำหรับตาราง **บัญชี** โดยตั้งค่าฟิลด์ต่อไปนี้
...
7. ขยายกฎการตรวจหาข้อมูลซ้อนสำหรับตาราง **ผู้ติดต่อ** โดยตั้งค่าฟิลด์ต่อไปนี้
...
8. ถ้าคุณเป็นผู้ใช้การรวมแบบสองทิศทางที่มีอยู่ ให้ปฏิบัติตามคําแนะนําใน [การอัปเกรดไปยังฝ่ายและสมุดที่อยู่สากล](upgrade-party-gab.md) และอัปเกรดข้อมูลของคุณ

9. รันแผนผังตามลำดับต่อไปนี้ ถ้าคุณได้รับข้อผิดพลาดที่ระบุว่า "การตรวจสอบความถูกต้องของโครงการล้มเหลว ฟิลด์ปลายทางที่ขาดหายไป..."แล้วเปิดแผนผังและเลือก **รีเฟรชตาราง** แล้วรันแผนผัง
...
> [!Note]
> แผนผัง `CDS Contacts V2 (contacts)` คือแผนผังที่คุณหยุดไว้ในขั้นตอนที่ 1 เมื่อคุณพยายามรันแผนผังอื่น แผนที่ 2 เหล่านี้อาจปรากฏในรายชื่อผู้อยู่ในอุปการะ อย่ารันแผนผังเหล่านี้
...
+ ในแอป Finance and Operations เมื่อคุณสร้างลูกค้าพร้อมกับที่อยู่และบันทึกที่อยู่ ที่อยู่อาจไม่ซิงโครไนส์กับตาราง **ที่อยู่** ที่เป็นเพราะปัญหาการจัดลำดับแพลตฟอร์มแบบสองทิศทาง วิธีแก้ไขปัญหา ให้สร้างลูกค้าก่อนแล้วบันทึก จากนั้นเพิ่มที่อยู่
+ ในแอป Finance and Operations เมื่อเรกคอร์ดลูกค้ามีที่อยู่หลักและคุณสร้างผู้ติดต่อใหม่ของลูกค้ารายนั้น เรกคอร์ดผู้ติดต่อจะรับช่วงที่อยู่หลักจากเรกคอร์ดลูกค้าที่เชื่อมโยง ซึ่งจะเกิดขึ้นกับผู้ติดต่อผู้จัดจำหน่ายด้วย Dataverse ไม่สนับสนุนพฤติกรรมนี้อยู่ในขณะนี้ ถ้าเปิดใช้งานการรวมแบบสองทิศทาง ผู้ติดต่อของลูกค้าที่ได้รับสืบทอดที่อยู่หลักมาจากแอป Finance and Operations จะถูกซิงโครไนส์ Dataverse กับที่อยู่ของลูกค้า
+ ที่อยู่อิเล็กทรอนิกส์จากตาราง `msdyn_partyelectronicaddress` ไม่ไหลไปที่ฟิลด์ที่อยู่อิเล็กทรอนิกส์ในตาราง **บัญชี** และ **ผู้ติดต่อ** เราวางแผนที่จะแก้ไขปัญหานี้ในการนำออกใช้ส่วนเพิ่ม ข้อมูลที่มีอยู่บนฟิลด์ที่อยู่อิเล็กทรอนิกส์บนตาราง **บัญชี** และ **ผู้ติดต่อ** จะไม่ถูกบันทึกทับ
...
+ ในแอป Finance and Operations คุณสามารถสร้างเรกคอร์ดผู้ติดต่อจากฟอร์ม **เพิ่มผู้ติดต่อ** เมื่อคุณพยายามสร้างผู้ติดต่อใหม่จากฟอร์ม **ดูผู้ติดต่อ** การดำเนินการจะล้มเหลว นี่เป็นปัญหาที่ทราบ
...
+ คุณไม่สามารถป้อนที่อยู่ไปรษณีย์ที่มีวันที่แบบไปข้างหน้าโดยใช้แอป Finance and Operations พร้อมการรวมแบบสองทิศทาง เนื่องจาก Dataverse ไม่สนับสนุนการมีผลบังคับของวันที่ ถ้าคุณป้อนที่อยู่ไปรษณีย์ที่มีวันที่ในอนาคตโดยใช้แอป Finance and Operations ที่อยู่ดังกล่าวจะซิงโครไนส์กับที่อยู่ Dataverse ทั้งหมดและคุณจะเห็นที่อยู่บนอินเทอร์เฟสผู้ใช้ทันที การอัปเดตใด ๆ ในเรกคอร์ดนี้จะส่งผลให้เกิดข้อผิดพลาดเนื่องจากเป็นการอัปเดตในอนาคตไม่ใช่ปัจจุบันในแอป Finance and Operations
