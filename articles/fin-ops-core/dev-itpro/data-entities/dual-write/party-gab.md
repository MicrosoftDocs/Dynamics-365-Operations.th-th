...
description: บทความนี้จะอธิบายถึงฟังก์ชันฝ่ายและสมุดที่อยู่สากลของการรวมแบบสองทิศทาง
...
ในแอป Customer ในแอปการมีส่วนร่วมของลูกค้า เมื่อผู้ใช้ป้อนที่อยู่บนแท็บ **สรุป** ของหน้า **บัญชี** ฟิลด์ **ที่อยู่ 1** และ **ที่อยู่ 2** จะตรงกับที่อยู่ **ที่จัดส่ง** และที่อยู่ **ใบแจ้งหนี้** ตามลําดับ อย่างไรก็ตาม เมื่อผู้ใช้สร้างที่อยู่ไปรษณีย์ในแอพการเงินและการดําเนินงาน ที่อยู่สองที่อยู่แรกของเรกคอร์ดลูกค้าจะปรากฏขึ้นในฟิลด์ **Address1** และ **Address2** และผู้ใช้มีตัวเลือกเพื่อเปลี่ยนวัตถุประสงค์ของที่อยู่เป็น **การจัดส่ง** และ **ใบแจ้งหนี้**

![แท็บสรุปสำหรับที่อยู่ไปรษณีย์](media/party-gab-image5.png)

คล้ายกัน ฟิลด์ **ที่อยู่ 1** **ที่อยู่ 2** และ **ที่อยู่ 3** บนแท็บ **สรุป** ของหน้า **ผู้ติดต่อ** จะตรงกับที่อยู่ **ธุรกิจ** **การจัดส่ง** และ **ใบแจ้งหนี้** ตามลําดับ
...
ในระหว่างกระบวนการคุณวุฒิสายงานของลูกค้าเป้าหมาย คุณสามารถระบุทั้งหมายเลขโทรศัพท์ธุรกิจและหมายเลขโทรศัพท์เคลื่อนที่ หมายเลขโทรศัพท์ธุรกิจจะถือเป็นหมายเลขโทรศัพท์หลัก ถ้า **IsNoile=No** และหมายเลขโทรศัพท์เคลื่อนที่ถือเป็นหมายเลขโทรศัพท์รองถ้า **IsMobile=Yes**
...
2. ติดตั้งโซลูชันที่เป็นข้อกำหนดเบื้องต้นทั้งหมด ตามที่อธิบายไว้ใน [แพคเกจการประสานรวมของแอปพลิเคชันการรวมแบบสองทิศทางที่แยกต่างหาก](separated-solutions.md)
...
7. การแมปเอนทิตีต่อไปนี้มีการอัปเดตสำหรับฟังก์ชันของฝ่าย ดังนั้น ต้องใช้รุ่นล่าสุดกับการแมปเหล่านี้
    ...
    ---|---|---
    `CDS Parties (msdyn_parties)`| 1.0.0.2 | นี่คือแผนผังใหม่ที่เพิ่มเป็นส่วนหนึ่งของการนำออกใช้นี้
    `Contacts V2 (msdyn_contactforparties)`| 1.0.0.6 | นี่คือแผนผังใหม่ที่เพิ่มเป็นส่วนหนึ่งของการนำออกใช้นี้
    ...
    `CDS postal address history V2 (msdyn_postaladdresses)` | 1.0.0.2 | นี่คือแผนผังใหม่ที่เพิ่มเป็นส่วนหนึ่งของการนำออกใช้นี้
    ...
    `CDS Address roles (msdyn_addressroles)` | 1.0.0.0 | นี่คือแผนผังใหม่ที่เพิ่มเป็นส่วนหนึ่งของการนำออกใช้นี้
...
9. ใน Dataverse ขีดจํากัดอักขระของกฎการตรวจหาข้อมูลจะเพิ่มขึ้นจาก 450 เป็น 700 อักขระ ขีดจํากัดนี้ช่วยให้คุณสามารถเพิ่มคีย์หนึ่งคีย์หรือมากกว่าในกฎการตรวจหาข้อมูลซ้อน ขยายกฎการตรวจหาข้อมูลซ้อนสำหรับตาราง **บัญชี** โดยตั้งค่าฟิลด์ต่อไปนี้
    ...
    | คำอธิบาย | ตรวจสอบเรกคอร์ดบัญชีมีค่าเดียวกันในแอตทริบิวต์ชื่อบัญชี |
...
12. หากคุณเป็นผู้ใช้การรวมแบบสองทิศทางที่มีอยู่ ให้ทำตามขั้นตอนที่ 11 จากนั้นคุณสามารถเรียกใช้แผนผังตามลำดับต่อไปนี้ หากคุณเป็นลูกค้าผู้ใช้การรวมแบบสองทิศทางใหม่ คุณสามารถดําเนินการต่อได้ทันที ถ้าคุณได้รับข้อความแสดงผิดพลาดที่ระบุว่า "การตรวจสอบความถูกต้องของโครงการล้มเหลว ฟิลด์ปลายทางที่ขาดหายไป..." ให้เปิดแผนผังและเลือก **รีเฟรชตาราง** แล้วเรียกใช้แผนผัง
    ...
    [บทบาทที่อยู่ CDS](mapping-reference.md#301) | msdyn_addressroles
...
| [บทบาทที่อยู่ CDS](mapping-reference.md#301) |msdyn\_addressroles|

สำหรับข้อมูลเพิ่มเติม ให้ดูที่  [การอ้างอิงการทำแผนที่แบบสองทิศทาง](mapping-reference.md)

## <a name="address-roles-as-a-multi-select-drop-down-list"></a>บทบาทที่อยู่เป็นรายการดรอปดาวน์แบบเลือกได้หลายตัวเลือก
ที่อยู่ทางไปรษณีย์หรือที่อยู่อิเล็กทรอนิกส์สามารถใช้ในวัตถุประสงค์ได้มากกว่าหนึ่งวัตถุประสงค์ ตัวอย่างเช่น ที่อยู่ทางไปรษณีย์จะสามารถใช้เป็นทั้งที่อยู่ที่เรียกเก็บเงินและที่อยู่ที่จัดส่ง ในกรณีนี้ ผู้ใช้สามารถเลือกทั้ง **ใบแจ้งหนี้** และ **การจัดส่ง** ในรายการดรอปดาวน์ดังที่แสดงในภาพต่อไปนี้ 

![รายการดรอปดาวน์วัตถุประสงค์/บทบาท](media/purpose.png)
...
+ ในแอปการเงินและการดำเนินงาน เมื่อเรกคอร์ดลูกค้ามีที่อยู่หลักและคุณสร้างผู้ติดต่อใหม่ของลูกค้ารายนั้น เรกคอร์ดผู้ติดต่อจะรับช่วงที่อยู่หลักจากเรกคอร์ดลูกค้าที่เชื่อมโยง ซึ่งจะเกิดขึ้นกับผู้ติดต่อผู้จัดจำหน่ายด้วย Dataverse ยังไม่รองรับลักษณะการทำงานนี้ ถ้าเปิดใช้งานการรวมแบบสองทิศทาง ผู้ติดต่อของลูกค้าที่ได้รับสืบทอดที่อยู่หลักมาจากแอปการเงินและการดำเนินงานจะถูกซิงโครไนส์ไปยัง Dataverse พร้อมกับที่อยู่ของลูกค้า
