...
description: หัวข้อนี้อธิบายวิธีการเริ่มต้นใช้งาน Commerce Scale Unit (ระบบคลาวด์) ใน Microsoft Dynamics 365 Commerce
author: AamirAllaq
ms.date: 02/04/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8092218"
---
# <a name="initialize-commerce-scale-unit-cloud"></a>เริ่มต้น Commerce Scale Unit (ระบบคลาวด์)

[!include[banner](../includes/banner.md)]

หัวข้อนี้อธิบายวิธีการเริ่มต้นใช้งาน Commerce Scale Unit (ระบบคลาวด์) ใน Microsoft Dynamics 365 Commerce
...
| ตำแหน่งที่ตั้งสากล | ภูมิภาค              | ความพร้อมใช้งาน        |
|-----------------|---------------------|---------------------|
| AMERICAS        | สหรัฐอเมริกาตะวันออก             | พร้อมใช้งานโดยทั่วไป |
| AMERICAS        | สหรัฐอเมริกาตะวันออกของ 2           | พร้อมใช้งานโดยทั่วไป |
| AMERICAS        | สหรัฐอเมริกาภาคกลางตอนเหนือ    | พร้อมใช้งานโดยทั่วไป |
| AMERICAS        | สหรัฐอเมริกาภาคกลางตอนใต้    | พร้อมใช้งานโดยทั่วไป |
| AMERICAS        | สหรัฐอเมริกากลาง          | พร้อมใช้งานโดยทั่วไป |
| AMERICAS        | สหรัฐอเมริกาตะวันตก             | พร้อมใช้งานโดยทั่วไป |
| AMERICAS        | สหรัฐอเมริกาตะวันตก 2           | พร้อมใช้งานโดยทั่วไป |
| AMERICAS        | แคนาดาตอนกลาง      | กำลังการผลิตมีจำกัด    |
| AMERICAS        | แคนาดาตะวันออก         | กำลังการผลิตมีจำกัด    |
| AMERICAS        | สหรัฐอเมริกาตอนกลางทางตะวันตก     | กำลังการผลิตมีจำกัด    |
| APAC            | ออสเตรเลียตะวันออก      | พร้อมใช้งานโดยทั่วไป |
| APAC            | เอเชียตะวันออกเฉียงใต้      | พร้อมใช้งานโดยทั่วไป |
| APAC            | ญี่ปุ่นตะวันออก          | พร้อมใช้งานโดยทั่วไป |
| APAC            | ญี่ปุ่นตะวันตก          | พร้อมใช้งานโดยทั่วไป |
| APAC            | ออสเตรเลียตะวันออกเฉียงใต้ | กำลังการผลิตมีจำกัด    |
| APAC            | เอเชียตะวันออก           | กำลังการผลิตมีจำกัด    |
| APAC            | อินเดียตอนใต้         | กำลังการผลิตมีจำกัด    |
| APAC            | อินเดียตอนกลาง       | กำลังการผลิตมีจำกัด    |
| EMEA            | ยุโรปตะวันตก         | พร้อมใช้งานโดยทั่วไป |
| EMEA            | ยุโรปเหนือ        | พร้อมใช้งานโดยทั่วไป |
| EMEA            | สหราชอาณาจักรตอนใต้            | กำลังการผลิตมีจำกัด    |
| EMEA            | สหราชอาณาจักรตะวันตก             | กำลังการผลิตมีจำกัด    |

ความจุของการปรับใช้ในภูมิภาคที่มีความจุจํากัดจะถูกจํากัดอย่างมาก การร้องขอการปรับใช้จะมีการประเมินตามแต่ละกรณี ถ้าคุณมีความต้องการทางธุรกิจที่บริษัทต้องการในการใช้งานในภูมิภาคที่มีความจุจํากัด คุณสามารถยื่นคำขอรับการสนับสนุนที่จะเพิ่มให้กับรายการรอได้
