...
บทความนี้อธิบายวิธีการเปิดข้อมูลเอนทิตีใน Microsoft Excel และจากนั้นดู อัปเดต และแก้ไขข้อมูลโดยใช้ Add-in ของ Microsoft Dynamics  Excel เมื่อต้องการเปิดเอนทิตีข้อมูล คุณสามารถเริ่มจาก Excel หรือแอปการเงินและการดำเนินงานได้
...
> [!NOTE]
> หากผู้เช่า Microsoft Azure Active Directory (Azure AD) ของคุณถูกตั้งค่าคอนฟิกให้ใช้ Active Directory Federation Services (AD FS) คุณต้องแน่ใจว่ามีการใช้การอัปเดตเดือนพฤษภาคม 2016 สำหรับ Office เพื่อให้ Add-in ของ Excel สามารถนำคุณเข้าสู่ระบบได้อย่างถูกต้อง

เมื่อต้องการเรียนรู้เพิ่มเติมเกี่ยวกับการใช้ add-in ของ Excel ให้ดูวิดีโอ [สร้างเทมเพลต Excel สำหรับหัวข้อและรูปแบบรายการ](https://youtu.be/RTicLb-6dbI)

## <a name="open-entity-data-in-excel-when-you-start-from-a-finance-and-operations-app"></a>เปิดข้อมูลเอนทิตีใน Excel เมื่อคุณเริ่มการทำงานจากแอปการเงินและการดำเนินงาน
1. ในหน้าของแอปการเงินและการดำเนินงาน ให้เลือก **เปิดใน Microsoft Office**
...
3. ใน Excel เลือก **เปิดใช้งานการแก้ไข** เพื่อเปิดใช้งาน Add-in ของ Excel เพื่อให้เรียกใช้ Add-in ของ Excel จะทำงานในบานหน้าต่างด้านขวาของหน้าต่าง Excel
4. ถ้าคุณกำลังเรียกใช้ Add-in ของ Excel เป็นครั้งแรก เลือก **เชื่อถือ Add-in นี้**
5. ถ้าคุณได้รับการเจ้งเตือนให้เข้าสู่ระบบ ให้เลือก **เข้าสู่ระบบ** และจากนั้นเข้าสู่ระบบโดยใช้ข้อมูลประจำตัวเดียวกับที่คุณใช้เพื่อเข้าสู่แอปการเงินและการดำเนินงาน Add-in ของ Excel จะใช้บริบทการลงชื่อเข้าใช้ก่อนหน้าจากเบราว์เซอร์ และจะลงชื่อเข้าใช้ให้กับคุณโดยอัตโนมัติ ถ้าสามารถทำได้ (หากต้องการทราบข้อมูลเกี่ยวกับเบราเซอร์ที่ใช้ระบบปฏิบัติการ โปรดดู [เบราเซอร์ที่ใช้โดย Add-in ของ Office](/office/dev/add-ins/concepts/browsers-used-by-office-web-add-ins) เพื่อให้แน่ใจว่าการลงชื่อเข้าใช้ประสบความสําเร็จ ให้ตรวจสอบชื่อผู้ใช้ในมุมด้านขวาบนของ Add-in ของ Excel 
...
2. ใน Office Store ค้นหาโดยใช้คำสำคัญ **Dynamics** และเลือก **เพิ่ม** ถัดจาก **Add-in ของ Microsoft Dynamics Office** (the Excel add-in)
3. ถ้าคุณกำลังเรียกใช้ Add-in ของ Excel เป็นครั้งแรก เลือก **เชื่อถือ Add-in นี้** เพื่อเปิดใช้งาน Add-in ของ Excel เพื่อให้เรียกใช้ Add-in ของ Excel จะทำงานในบานหน้าต่างด้านขวาของหน้าต่าง Excel
4. เลือก **เพิ่มข้อมูลเซิร์ฟเวอร์** เพื่อเปิดบานหน้าต่าง **ตัวเลือก**
5. ในเบราเซอร์ของคุณ ให้คัดลอก URL ของอินสแตนซ์ของแอปการเงินและการดำเนินงานเป้าหมายของคุณ วางลงในฟิลด์ **URL ของเซิร์ฟเวอร์** และจากนั้นลบทุกอย่างหลังชื่อโฮสต์ URL ที่เป็นผลลัพธ์ควรมีเพียงชื่อโฮสต์เดียว
...
6. เลือก **ตกลง** แล้วเลือก **ใช่** เพื่อยืนยันการเปลี่ยนแปลง Add-in ของ Excel ถูกรีสตาร์ทและโหลดข้อมูลเมตา
    ...
    ปุ่ม **การออกแบบ** พร้อมใช้งานแล้วในขณะนี้ ถ้า Add-in ของ Excel มีลิงก์ **โหลดแอปเพล็ต** คุณอาจไม่ได้เข้าสู่ระบบในฐานะผู้ใช้ที่ถูกต้อง สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการระบุปัญหานี้ ให้ดูที่ [โหลดแอปเพล็ต](../office-integration/office-integration-troubleshooting.md#issue-the-excel-add-in-loads-but-instead-of-showing-data-it-displays-load-applets-in-the-task-pane)

7. เลือก **ออกแบบ** Add-in ของ Excel ดึงข้อมูลเมตาของเอนทิตี
...
## <a name="view-and-update-entity-data-in-excel"></a>ดูและอัปเดตข้อมูลเอนทิตีใน Excel
หลังจาก Add-in ของ Excel อ่านข้อมูลเอนทิตีลงในสมุดงาน คุณสามารถอัปเดตข้อมูลได้ตลอดเวลาโดยการเลือก **รีเฟรช** ใน Add-in ของ Excel

## <a name="edit-entity-data-in-excel"></a>แก้ไขข้อมูลของเอนทิตีใน Excel
คุณสามารถเปลี่ยนแปลงข้อมูลเอนทิตีได้ตามที่คุณต้องการ แล้วเผยแพร่กลับมาแอปการเงินและการดำเนินงาน โดยการเลือก **เผยแพร่** ใน Add-in ของ Excel เมื่อต้องการแก้ไขเรกคอร์ด เลือกเซลล์ในแผ่นงาน และจากนั้นเปลี่ยนค่าในเซลล์ เมื่อต้องการเพิ่มเรกคอร์ดใหม่ ให้ทำตามขั้นตอนเหล่านี้:
...
4. เมื่อต้องการนำการเปลี่ยนแปลงของคุณไปใช้กับแหล่งข้อมูล เลือก **อัปเดต** แล้วเลือก **เสร็จสิ้น** เพื่อออกจากการออกแบบ
5. ถ้าคุณเพิ่มฟิลด์ (คอลัมน์) แล้ว ให้เลือก **รีเฟรช** เพื่อดึงชุดข้อมูลที่อัปเดตแล้ว

## <a name="change-the-publish-batch-size"></a>เปลี่ยนขนาดชุดงานการเผยแพร่
เมื่อผู้ใช้เผยแพร่การเปลี่ยนแปลงที่เรกคอร์ดข้อมูลโดยใช้ Add-in ของ Excel การอัปเดตจะถูกส่งในชุดงาน ขนาดชุดงานการเผยแพร่เริ่มต้น (และสูงสุด) คือ 100 แถว อย่างไรก็ตาม คุณลักษณะ **อนุญาตการตั้งค่าคอนฟิกขนาดชุดงานที่เผยแพร่ใน Excel Add-in** ช่วยให้คุณมีความยืดหยุ่นในการลดขนาดชุดงานการเผยแพร่ โดยเฉพาะอย่างยิ่งถ้าคุณเห็นการหมดเวลาเมื่อพยายามเผยแพร่การอัปเดตจาก Excel

ผู้ดูแลระบบสามารถระบุขีดจํากัดของขนาดชุดงานที่เผยแพร่ทั่วทั้งระบบในสมุดงาน "เปิดใน Excel" โดยการตั้งค่าฟิลด์ **เผยแพร่ขีดจํากัดชุดงาน** ในส่วน **พารามิเตอร์แอป** ของหน้า **พารามิเตอร์แอป Office**

นอกจากนี้ คุณยังสามารถเปลี่ยนขนาดชุดงานการเผยแพร่ของสมุดงานแต่ละสมุดงานได้โดยใช้ Add-in ของ Excel

1. เปิดสมุดงานใน Excel
2. เลือกปุ่ม **ตัวเลือก** (เกียร์) ที่มุมขวาบนของ Add-in ของ Excel
3. ตั้งค่าฟิลด์ **เผยแพร่ขนาดชุดงาน** ตามต้องการ ค่าที่คุณตั้งค่าต้องน้อยกว่าขีดจํากัดของชุดงานการเผยแพร่ทั่วทั้งระบบ
4. เลือก **ตกลง**
5. บันทึกสมุดงาน ถ้าคุณไม่ได้บันทึกสมุดงานหลังจากที่คุณเปลี่ยนแปลงการตั้งค่า Add-in การเปลี่ยนแปลงเหล่านั้นจะไม่ยังคงอยู่เมื่อเปิดสมุดงานอีกครั้ง

ผู้สร้างเทมเพลตสมุดงาน Excel สามารถใช้ขั้นตอนเดียวกันเพื่อตั้งค่าขนาดชุดงานการเผยแพร่ของเทมเพลตก่อนที่จะอัปโหลดไปยังระบบ
...
- **ลิงค์ "โหลดแอปเพล็ต" ปรากฏขึ้น** – สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการระบุปัญหานี้ ให้ดูที่รายการการแก้ไขปัญหา [โหลดแอปเพล็ต](../office-integration/office-integration-troubleshooting.md#issue-the-excel-add-in-loads-but-instead-of-showing-data-it-displays-load-applets-in-the-task-pane) 
...
- **เว็บเพจที่ว่างเปล่าที่ถูกแสดงขึ้นเหนือ Excel** – ถ้าเว็บเพจที่ว่างเปล่าถูกเปิดขึ้นในระหว่างกระบวนการเข้าสู่ระบบ บัญชีนั้นจำเป็นต้องมี AD FS แต่รุ่นของ Excel ที่กำลังเรียกใช้ Add-in ของ Excel ไม่ใช่รุ่นที่ใหม่พอที่จะโหลดกล่องโต้ตอบการเข้าสู่ระบบได้ เมื่อต้องการแก้ไขปัญหานี้ ให้อัปเดตรุ่นของ Excel ที่คุณใช้อยู่ เมื่อต้องการอัปเดตรุ่นของ Excel เมื่อคุณอยู่ในองค์กรที่อยู่ในช่องทางรอการตัดบัญชี ใช้ [เครื่องมือการปรับใช้ Office](/deployoffice/overview-office-deployment-tool) เพื่อ [ย้ายจากช่องทางรอการตัดบัญชีไปยังช่องทางปัจจุบัน](/deployoffice/overview-update-channels)
- **คุณจะได้รับการหมดเวลาขณะที่คุณเผยแพร่การเปลี่ยนแปลงข้อมูล** – ถ้าคุณได้รับข้อความหมดเวลาขณะคุณพยายามเผยแพร่การเปลี่ยนแปลงข้อมูลไปยังเอนทิตี ให้พิจารณาการลดขนาดชุดงานการเผยแพร่ของสมุดงานที่ได้รับผลกระทบ เอนทิตีที่ทริกเกอร์จํานวนตรรกะที่มากกว่าในการเปลี่ยนแปลงเรกคอร์ด อาจต้องมีการส่งการอัปเดตในชุดงานที่เล็กลงเพื่อช่วยป้องกันการหมดเวลา
