...
description: บทความนี้อธิบายวิธีการเพิ่มกฎใหม่ในโปรแกรมช่วยแนะนำการปรับให้เหมาะสม
author: kamaybac
ms.date: 02/04/2018
ms.topic: article
ms.prod: ''
...
สำหรับข้อมูลเพิ่มเติม ดูวิดีโอ YouTube แบบสั้น: [ผู้แนะนำการเพิ่มประสิทธิภาพใน Dynamics 365 Finance](https://www.youtube.com/watch?v=MRsAzgFCUSQ)
