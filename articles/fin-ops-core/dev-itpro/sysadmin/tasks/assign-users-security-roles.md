...
description: หากต้องการเข้าถึงแอปการเงินและการดำเนินงาน ต้องมีการมอบหมายบทบาทความปลอดภัยให้กับผู้ใช้ก่อน
author: Peakerbl
ms.date: 02/09/2022
...
ms.locfileid: "8105549"
---
# <a name="manage-users-and-security-roles"></a>จัดการบทบาทผู้ใช้และบทบาทความปลอดภัย

[!include [banner](../../includes/banner.md)]

หากต้องการใช้งานฟังก์ชันที่มากกว่าความสามารถทั่วไปในแอปการเงินและการดำเนินงาน ต้องกำหนดบทบาทความปลอดภัยให้กับผู้ใช้ คุณสามารถกําหนดผู้ใช้ให้กับบทบาทโดยอัตโนมัติ ตามกฎและข้อมูลธุรกิจ ไม่รวมผู้ใช้จากการกำหนดบทบาทอัตโนมัติ หรือเพิ่มผู้ใช้ให้กับบทบาทด้วยตนเอง
...
10. ตรวจทานบทบาทที่กำหนดให้กับผู้ใช้ต่างๆ เพื่อยืนยันว่าการสอบถามการกำหนดบทบาทถูกต้อง อัปเดตและเรียกใช้ใหม่ ถ้าจำเป็น

## <a name="exclude-users-from-automatic-role-assignment"></a>ตัดผู้ใช้ออกจากการกำหนดบทบาทโดยอัตโนมัติ
ขั้นตอนนี้อธิบายวิธีการตัดผู้ใช้ออกจากการกำหนดบทบาทอัตโนมัติ
...
## <a name="manually-remove-users-from-roles"></a>เอาผู้ใช้ออกจากบทบาทด้วยตนเอง
ผู้ใช้ที่ถูกกําหนดให้กับบทบาทความปลอดภัยด้วยตนเองต้องถูกเอาออกโดยผู้ดูแลระบบด้วยตนเองด้วย ผู้ใช้เหล่านี้จะไม่ถูกเอาออกจากบทบาทตามกฎสําหรับการกําหนดบทบาทอัตโนมัติ

1. ไปที่ **บานหน้าต่างนำทาง > โมดูล >การจัดการระบบ > ความปลอดภัย > กำหนดผู้ใช้ให้กับบทบาท**
2. เมื่อต้องการเอาผู้ใช้หนึ่งรายออก ให้ปฏิบัติตามขั้นตอนต่อไปนี้
   1. ในแผนภูมิ ให้เลือกบทบาท 
   2. ในพื้นที่ **ผู้ใช้ที่กำหนดให้กับบทบาท** ให้เลือกผู้ใช้ที่ควรถูกเอาออก
   3. เลือก **เอาออก** และจะมีการเอาผู้ใช้ออกจากบทบาท
3. เมื่อต้องการเอาผู้ใช้หลายรายออก ให้ปฏิบัติตามขั้นตอนต่อไปนี้
   1. ในแผนภูมิ ให้เลือกบทบาท 
   2. ในพื้นที่ **ผู้ใช้ที่กำหนดให้กับบทบาท** ให้เลือก **กำหนด/ตัดผู้ใช้ด้วยตนเอง**
   3. ในหน้า **กําหนดผู้ใช้ให้หรือตัดผู้ใช้ออกจากบทบาท** ผู่ใช้ที่ยังไม่ถูกกำหนดบทบาทจะมี **ไม่มี** อยู่ในคอลัมน์ **โหมดการกำหนด** เลือกผู้ใช้ที่ควรตัดออกจากบทบาท
   4. ใน **บานหน้าต่างการดำเนินการ** ให้เลือก **แยกออกจากบทบาท** คอลัมน์ **โหมดการกําหนด** ได้รับการอัปเดตเป็น **ด้วยตนเอง** และตอนนี้ผู้ใช้จะถูกตัดออกจากบทบาท
