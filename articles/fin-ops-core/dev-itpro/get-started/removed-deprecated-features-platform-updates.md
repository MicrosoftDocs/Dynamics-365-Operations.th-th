...
### <a name="explicit-whitelisting-for-self-service-environments"></a>การอนุญาตพิเศษที่ชัดเจนสำหรับสภาพแวดล้อมแบบบริการตนเอง

|   |  |
|------------|--------------------|
| **เหตุผลสำหรับการยกเลิกการใช้/การลบ** | มีการเปลี่ยนกระบวนการสำหรับการอนุญาตพิเศษของ IP บริการตนเองไม่สนับสนุนการอนุญาตพิเศษของ IP อีกต่อไป |
