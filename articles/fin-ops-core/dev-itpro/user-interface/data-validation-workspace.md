...
แท็บสุดท้ายใช้สำหรับรายการงานที่มีรายละเอียด รายการนี้แสดงรายการงานทั้งหมด คุณสามารถกรองรายการงานได้หลายวิธี คลิก **แก้ไขงาน** เพื่อเปลี่ยนสถานะของงานหรือกำหนดงาน คลิก **สิ่งที่แนบ** เพื่อดูเอกสารแนบสำหรับงานนั้น
...
ตัวเลือก **ดำเนินการเสร็จสมบูรณ์โดย** จะถูกเติมโดยอัตโนมัติหลังจากงานนี้เสร็จสมบูรณ์ด้วยชื่อของผู้ปฏิบัติงานที่งานเสร็จสมบูรณ์แล้ว เมื่องานถูกทำเครื่องหมายเป็นเสร็จสมบูรณ์แล้ว ฟิลด์ **วันที่เสร็จสมบูรณ์** จะมีการอัปเดตวันที่ปัจจุบันและเวลาโดยอัตโนมัติ
...
**ชื่อของรายการเมนู** ถูกเชื่อมโยงกับความพยายามในการทำงานและสามารถถูกใช้เพื่อไปที่หน้าที่เกี่ยวข้องได้โดยตรงจากการลิงค์งานในพื้นที่ทำงาน ตัวอย่างเช่น งานการตรวจสอบความถูกต้องของข้อมูลเพื่อเรียกใช้รายงาน **อายุหนี้ของบัญชีเจ้าหนี้** สำหรับบัญชีเจ้าหนี้ที่สามารถถูกเชื่อมโยงกับหน้า **รายงานอายุหนี้ของบัญชีเจ้าหนี้**
