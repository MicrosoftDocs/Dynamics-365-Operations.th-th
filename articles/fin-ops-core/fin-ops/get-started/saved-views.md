...
> [!NOTE]
> มีมุมมองเริ่มต้นส่วนกลางเดียวระหว่างบริษัท ถ้าคุณเปลี่ยนมุมมองเริ่มต้น มุมมองนั้นจะมีการเปิดโดยค่าเริ่มต้น โดยไม่คำนึงถึงนิติบุคคลที่คุณกำลังอยู่ในปัจจุบัน 
...
โปรดทราบว่า ในบางกรณี การสอบถามที่เชื่อมโยงกับมุมมองเริ่มต้นจะไม่ดำเนินการ เมื่อคุณเปิดหน้าเป็นครั้งแรก ตัวอย่างเช่น ถ้าคุณเปิดหน้าผ่านไทล์ การสอบถามของไทล์จะถูกดำเนินการ โดยไม่คำนึงถึงการสอบถามที่เชื่อมโยงกับมุมมองเริ่มต้น นอกจากนี้ ถ้าคุณเปิดหน้าที่มีมุมมอง **มุมมอง** ที่มีการสอบถามที่กำหนดไว้แล้ว การสอบถามดั้งเดิมจะดำเนินการแทนการสอบถามของมุมมองเริ่มต้น ในกรณีนี้ คุณจะได้รับข้อความแสดงข้อมูลเมื่อมีการโหลดมุมมอง ถ้าคุณสลับมุมมองหลังจากการโหลดหน้าแล้ว การสอบถามมุมมองควรจะสามารถรันได้ตามที่คาดไว้ ในรุ่น 10.0.10 และรุ่นที่ใหม่กว่า ข้อความที่ให้ข้อมูลที่คุณได้รับจะมีการดำเนินการที่ฝังอยู่ซึ่งช่วยให้คุณสามารถโหลดการสอบถามของมุมมองเริ่มต้นได้โดยตรง
...
- **เปลี่ยนมุมมองเริ่มต้น** – ใช้การดำเนินการ **ปักหมุดเป็นค่าเริ่มต้น** เพื่อทำให้มุมมองที่เลือกอยู่ในปัจจุบันเป็นมุมมองเริ่มต้นสำหรับหน้านี้
...
5. **รุ่น 10.0.9 และรุ่นที่ใหม่กว่า:** ตรวจสอบว่าควรเผยแพร่มุมมองเป็นมุมมองเริ่มต้นสำหรับผู้ใช้ที่เลือกหรือไม่ เมื่อทำให้มุมมองเป็นค่าเริ่มต้น ผู้ใช้จะเห็นในครั้งต่อไปที่จะเปิดหน้าเป้าหมาย มุมมองเริ่มต้นสากลเดียวของผู้ใช้ที่มีการกำหนดเป้าหมายทั้งหมดจะมีการเปลี่ยนแปลง อย่างไรก็ตาม ผู้ใช้ยังคงสามารถเปลี่ยนมุมมองเริ่มต้นของตนหลังจากที่มีการเผยแพร่เกิดขึ้นได้
6. เพิ่มบทบาทความปลอดภัยที่สอดคล้องกับผู้ใช้ที่ถูกกำหนดเป็นเป้าหมายโดยมุมมองนี้ 
7. **รุ่น10.0.13 และรุ่นที่ใหม่กว่า:** ตรวจสอบว่าคุณต้องการเผยแพร่มุมมองให้กับบทบาทรองของแต่ละบทบาทความปลอดภัยที่เลือกหรือไม่ หากคุณต้องการ ให้เลือกกล่องกาเครื่องหมาย **รวมบทบาทรอง** ในแถวสำหรับบทบาทความปลอดภัยที่เหมาะสม โปรดทราบว่ากล่องกาเครื่องหมายนี้จะไม่พร้อมใช้งานสำหรับบทบาทที่ไม่มีบทบาทรอง
7. เพิ่มนิติบุคคลที่มุมมองนี้ควรจะพร้อมใช้งาน 
8. เลือก **เผยแพร่**

โปรดทราบว่าในบางสภาพแวดล้อม อาจใช้เวลาสักครู่ (จนถึงหนึ่งชั่วโมง) ก่อนที่ผู้ใช้จะเห็นมุมมองที่เผยแพร่

> [!NOTE]
> โปรดระวังความคาดหวังต่อไปนี้ เมื่อคุณเผยแพร่มุมมองไปยังนิติบุคคลห รือเมื่อคุณเผยแพร่มุมมองเป็นมุมมองเริ่มต้น
> - ถ้าคุณเผยแพร่มุมมองเป็นมุมมองเริ่มต้นไปยังนิติบุคคลทั้งหมดหรือบางส่วน คุณจะเปลี่ยนมุมมองเริ่มต้นส่วนกลางเดียวของผู้ใช้ที่มีการกำหนดเป้าหมายทุกคน ถ้าผู้ใช้มีบทบาทที่มีการเผยแพร่มุมมองต่างๆ เป็นมุมมองเริ่มต้น มุมมองล่าสุดที่มีการเผยแพร่จะมีการใช้เป็นมุมมองเริ่มต้นของผู้ใช้ 
> - ถ้าคุณเผยแพร่มุมมองไปยังนิติบุคคล แต่คุณไม่ได้เผยแพร่เป็นมุมมองเริ่มต้น ผู้ใช้จะเห็นมุมมองในตัวเลือกมุมมองสำหรับนิติบุคคลที่ระบุเท่านั้น อย่างไรก็ตาม หลังจากที่มีการโหลดมุมมองเป็นครั้งแรก จะมีตัวเลือกมุมมองของผู้ใช้สำหรับหน้าดังกล่าวเสมอ โดยไม่คำนึงถึงนิติบุคคล 
...
2. บนเมนูแบบหล่นลงของตัวเลือกมุมมอง เลือก **เผยแพร่อีกครั้ง** ถ้าคุณกำลังใช้รุ่น10.0.12 หรือก่อนหน้านี้ คุณต้องเลือก **เผยแพร่** จากนั้น **ใช่** เพื่ออัพเดตมุมมองที่มีอยู่
3. ปรับปรุงชื่อ คำอธิบาย บทบาทความปลอดภัย และนิติบุคคลสำหรับมุมมอง 
4. เลือก **เผยแพร่** 
5. **รุ่น10.0.8 และรุ่นก่อนหน้า:** ถ้าคุณอัพเดตชื่อของมุมมองที่เผยแพร่แล้ว คุณต้องลบมุมมองที่เผยแพร่ที่มีชื่อเก่าด้วย (สำหรับข้อมูลเพิ่มเติม ให้ดูที่ส่วน [การจัดการมุมมองที่เผยแพร่](saved-views.md#managing-published-views) )

**รุ่น10.0.9 และรุ่นที่ใหม่กว่า:** ถ้าคุณเลือกมุมมองที่เผยแพร่นี้ไว้ในครั้งแรกเป็นมุมมองเริ่มต้น มุมมองนี้จะเป็นมุมมองเริ่มต้นสำหรับผู้ใช้อีกครั้ง หลังจากที่คุณเผยแพร่อีกครั้ง
...
**รุ่น 10.0.13 และรุ่นที่ใหม่กว่า:** ทำการเปลี่ยนแปลงที่จำเป็นโดยตรงไปยังมุมมอง เครื่องหมายดอกจัน (\*) ควรปรากฏขึ้นถัดจากชื่อมุมมอง
...
ผู้ใช้ที่สามารถเข้าถึงหน้า **การตั้งค่าส่วนบุคคล** ยังสามารถนำเข้ามุมมองส่วนตัวหรือองค์กรได้โดยใช้ปุ่ม **นำเข้ามุมมอง** ในบานหน้าต่างการดำเนินการ ในรุ่น10.0.12 และรุ่นที่ใหม่กว่า มีการเพิ่มกลไกสำหรับมุมมองการเผยแพร่โดยทันที เมื่อมีการนำเข้า
...
**รุ่น 10.0.13 และรุ่นที่ใหม่กว่า**

คุณลักษณะ **มุมมองที่บันทึก** จะไม่มีการแสดงตัวอย่างอีกต่อไป ตอนนี้พร้อมใช้งานโดยตรงผ่านทางการจัดการคุณลักษณะการทำงานในสภาพแวดล้อมใดๆ

**รุ่น 10.0.9 ถึง 10.0.12**

คุณลักษณะ **มุมมองที่บันทึก** จะพร้อมใช้งานในการจัดการคุณลักษณะในสภาพแวดล้อมต่างๆ โดยตรง เช่นกันกับคุณลักษณะการแสดงตัวอย่างอื่นๆ การเปิดใช้งานคุณลักษณะนี้ในการผลิตจะอยู่ภายใต้ [ข้อกำหนดเพิ่มเติมของข้อตกลงการใช้งาน](https://go.microsoft.com/fwlink/?linkid=2105274)

**10.0.8 / Platform update 32 และก่อนหน้า**

คุณลักษณะ **มุมมองที่บันทึก** สามารถถูกใช้งานในสภาพแวดล้อมระดับ 1 (การพัฒนา/การทดสอบ) และแบบระดับ 2 (Sandbox) เพื่อให้การทดสอบเพิ่มเติมและการออกแบบโดยปฏิบัติตามขั้นตอนต่อไปนี้
