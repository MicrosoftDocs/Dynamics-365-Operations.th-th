...
4. เลือก **เผยแพร่** 
5. **รุ่น10.0.8 และรุ่นก่อนหน้า:** ถ้าคุณอัปเดตชื่อของมุมมองที่เผยแพร่แล้ว คุณต้องลบมุมมองที่เผยแพร่ที่มีชื่อเก่าด้วย (สำหรับข้อมูลเพิ่มเติม ให้ดูที่ส่วน [การจัดการมุมมองที่เผยแพร่](saved-views.md#managing-published-views) )
