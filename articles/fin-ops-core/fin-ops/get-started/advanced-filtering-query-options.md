...
description: บทความนี้อธิบายถึงตัวเลือกในการกรองข้อมูลและการสอบถามสำหรับกล่องโต้ตอบตัวกรอง/เรียงลำดับขั้นสูง และตัวดำเนินการการจับคู่ ในบานหน้าต่างตัวกรองหรือตัวกรองส่วนหัวของคอลัมน์ในกริด
author: jasongre
ms.date: 03/09/2020
ms.topic: article
ms.prod: ''
...
<tr>
<td>"" (ใบเสนอราคาคู่สองใบ)</td>
<td>การจับคู่ค่าว่าง</td>
<td>พิมพ์ใบเสนอราคาคู่ต่อเนื่องสองใบเพื่อกรองค่าว่างในฟิลด์นั้น</td>
