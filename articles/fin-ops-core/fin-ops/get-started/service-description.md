---
title: คำอธิบายบริการของแอปการเงินและการดำเนินงาน
description: หัวข้อนี้จะให้คำอธิบายของบริการสำหรับแอปการเงินและการดำเนินงาน
author: tomhig
ms.date: 04/27/2022
ms.topic: article
...
ms.locfileid: "8656816"
---
# <a name="service-description-for-finance-and-operations-apps"></a>คำอธิบายบริการของแอปการเงินและการดำเนินงาน

[!include[banner](../includes/banner.md)]

แอปการเงินและการดำเนินงานคือซอฟต์แวร์การวางแผนทรัพยากรองค์กร (ERP) เป็นบริการ (SaaS) ที่มีให้ในตัว และสำหรับ [Microsoft Azure](https://azure.microsoft.com/overview/what-is-azure/) บริการการเงินและการดำเนินงานให้องค์กรมีฟังก์ชัน ERP ที่สนับสนุนความต้องการเฉพาะขององค์กร และช่วยองค์กรในการปรับปรุงเป็นสภาพแวดล้อมทางธุรกิจที่เปลี่ยนแปลงอย่างต่อเนื่อง โดยไม่จำเป็นต้องจัดการโครงสร้างพื้นฐาน แอปการเงินและการดำเนินงานอาจประกอบด้วยพื้นที่โซลูชันต่อไปนี้หนึ่งรายการหรือมากกว่า:
...
- [ชุดการพัฒนาซอฟต์แวร์ (SDK) การเงินและการดำเนินงาน](../../dev-itpro/dev-tools/developer-home-page.md) และ [ระบบอัตโนมัติในการสร้าง Azure DevOps](../../dev-itpro/dev-tools/developer-home-page.md#build-automation-using-azure) แบบ [Visual Studio](https://visualstudio.microsoft.com)
...
แบบจำลองการปฏิบัติงานของแอปการเงินและการดำเนินงานจะกําหนดบทบาทและความรับผิดชอบเฉพาะสำหรับลูกค้า, คู่ค้าในการใช้งาน, และ Microsoft ตลอดวงจรการใช้ของบริการ สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [การดําเนินงานของและการให้บริการระบบคลาวด์](../../dev-itpro/lifecycle-services/cloud-operations-servicing.md)
...
Microsoft จัดการบริการการเงินและการดำเนินงานโดยการปรับใช้, การตรวจสอบอย่างต่อเนื่อง, และการให้บริการสภาพแวดล้อม sandbox ของลูกค้าและสภาพแวดล้อมการทำงานจริงในการสมัครใช้งาน Microsoft SaaS การจัดการนี้ประกอบด้วยการปันส่วนโครงสร้างพื้นฐานของระบบที่ต้องใช้เพื่อรันบริการและสื่อสารกับลูกค้าเกี่ยวกับสภาพของบริการในเชิงรุก ความรับผิดชอบประกอบด้วย:
...
- ระบุข้อมูลการใช้งานที่ถูกต้องเกี่ยวกับการใช้งานแอปการเงินและการดำเนินงานใน [ตัวประมาณการสมัครใช้งาน LCS](../../dev-itpro/lifecycle-services/subscription-estimator.md)
...
แอปการเงินและการดำเนินงานจะให้บริการจากภูมิภาค Azure หลายแห่งทั่วโลก แอปการเงินและการดำเนินงานจะให้ฟังก์ชันเพื่อสนับสนุนประเทศ/ภูมิภาคและภาษาแม่ที่แตกต่างกัน สำหรับข้อมูลเพิ่มเติม ดูที่ [คุณลักษณะการแปลเป็นภาษาท้องถิ่นและระเบียบข้อบังคับ](../../dev-itpro/lcs-solutions/country-region.md#localization-and-regulatory-features)

### <a name="countryregion-specific-considerations"></a>ข้อควรพิจารณาเฉพาะประเทศ/ภูมิภาค

- ลูกค้าในอุตสาหกรรมหรือองค์กรเชิงพาณิชย์ที่มีการควบคุมซึ่งประกอบธุรกิจกับหน่วยงานต่างๆ ในฝรั่งเศสที่ต้องการข้อมูลท้องถิ่นควรรีวิว [การเงินและการดำเนินงานในฝรั่งเศส](../../dev-itpro/deployment/france-local-deployment.md)
- ลูกค้าที่มีการดําเนินงานในจีนควรตรวจสอบ [คู่มือการวางแผนกลยุทธ์ Azure ประเทศจีน](/azure/china/) และ [การเงินและการดำเนินงานที่ดําเนินงานโดย 21Vianet ในประเทศจีน](../../dev-itpro/deployment/china-local-deployment.md)
...
สำหรับแอปการเงินและการดำเนินงาน Microsoft จะดําเนินการเป็นผู้ประมวลผล ในฐานะผู้ประมวลผลข้อมูล การเงินและการดำเนินงานจะให้กระบวนการและคุณลักษณะเพื่อช่วยให้ลูกค้าปฏิบัติตามข้อผูกมัด GDPR ในฐานะผู้ควบคุมข้อมูล สำหรับข้อมูลเพิ่มเติม ให้อ้างอิงถึง [ภาพรวม GDPR](../../dev-itpro/gdpr/gdpr-guide.md)
...
ตาม [นโยบายวงจรการใช้ของซอฟต์แวร์](../../dev-itpro/migration-upgrade/versions-update-policy.md) แอปการเงินและการดำเนินงานจะเป็นไปตาม [นโยบายวงจรการใช้งานสมัยใหม่](../../dev-itpro/migration-upgrade/versions-update-policy.md#modern-lifecycle-policy) ของ Microsoft ซึ่งครอบคลุมผลิตภัณฑ์ที่ได้รับบริการและสนับสนุนอย่างต่อเนื่อง 
...
| **ที่ไม่ใช้งานจริง**<br>sandbox ระดับ 2 (หรือสูงกว่า) | สภาพแวดล้อมที่ไม่ใช้งานจริงซึ่งลูกค้าปรับใช้สำหรับการทดสอบการยอมรับของผู้ใช้, การทดสอบการรวม, การฝึกอบรม, การจัดเตรียม, หรือสถานการณ์ก่อนการทำงานจริงอื่นใด | sandbox ระดับ 2 และ sandbox ระดับที่สูงกว่าถูกปรับใช้กับการสมัครใช้งาน SaaS ของการเงินและการดำเนินงาน การเข้าถึงฐานข้อมูล Azure SQL ที่เชื่อมโยงกับสภาพแวดล้อมที่ไม่ใช้งานจริงจะได้รับอนุญาตผ่าน [การเข้าถึงแบบทันเวลา](../../dev-itpro/database/database-just-in-time-jit-access.md) การเข้าถึง Remote Desktop ไม่พร้อมใช้งาน |
...
มีการตรวจสอบแผนและกระบวนงานการกู้คืนจากความเสียหายของ Microsoft อย่างสม่ำเสมอโดยผ่านการตรวจสอบการควบคุมของระบบและองค์กร (SOC) การตรวจสอบการปฏิบัติตามกฎระเบียบเหล่านี้ยืนยันถึงกระบวนการทางเทคนิคและทางขั้นตอนของ Microsoft's DR ซึ่งรวมถึงแอปการเงินและการดำเนินงานของ Dynamics 365 รายงานการตรวจสอบ [การปฏิบัติตามกฎระเบียบ SOC](/compliance/regulatory/offering-soc-2) และรายงานการปฏิบัติตามกฎระเบียบอื่นๆ ทั้งหมดพร้อมใช้งานใน [ข้อเสนอการปฏิบัติตามกฎระเบียบของศูนย์ควบคุมความเชื่อถือของ Microsoft](/compliance/regulatory/offering-home)

## <a name="finance-and-operations-support-offerings"></a>ข้อเสนอการสนับสนุนของการเงินและการดำเนินงาน

การสนับสนุนทางเทคนิคพร้อมใช้งานในตลาดที่ซึ่งมีการให้บริการการเงินและการดำเนินงาน [ประสบการณ์การสนับสนุน](../../dev-itpro/lifecycle-services/lcs-support.md) มีการจัดหาให้ใน LCS หรือแอปการเงินและการดำเนินงาน ยกตัวอย่างเช่น
...
Microsoft เสนอแผนสนับสนุนให้กับลูกค้าการเงินและการดำเนินงานสามแผน: Premier, Professional Direct, และการสนับสนุนที่รวมอยู่ในการสมัครใช้งาน ระดับของการสนับสนุนแตกต่างกันสำหรับแต่ละแผน ตารางต่อไปนี้แสดงการเปรียบเทียบของแผนสามแผน
...
ในเหตุการณ์ของเหตุการณ์ที่เกี่ยวข้องกับแอปการเงินและการดำเนินงาน ลูกค้าส่งตั๋วการสนับสนุนให้กับ Microsoft โดยผ่าน LCS CSS จัดการเหตุการณ์ตามแผนสนับสนุนของลูกค้าและความรุนแรงของเหตุการณ์ตามที่กำหนดไว้โดย CSS
...
- **[ศูนย์ความเชื่อถือ](https://www.microsoft.com/trust-center)** – ดูข้อมูลเกี่ยวกับที่ซึ่งข้อมูลการเงินและการดำเนินงานของคุณถูกจัดเก็บ รวมถึงข้อมูลเพิ่มเติมเกี่ยวกับความเป็นส่วนตัว, การปฏิบัติตามกฎระเบียบ, และกระบวนงานความปลอดภัย
...
เครื่องมือใน LCS ที่ช่วยให้การวิเคราะห์ช่องว่างที่เหมาะสมเสร็จสมบูรณ์สำหรับการใช้งานที่กำหนด โดยการใช้ข้อกำหนดกระบวนการทางธุรกิจจาก American Productivity & Quality Center (APQC) ที่ได้รับการสนับสนุนแอปการเงินและการดำเนินงาน
...
องค์กรธุรกิจที่ใช้แอปแอปการเงินและการดำเนินงานและถูกแสดงโดยผู้เช่าใน Office 365
...
คู่ค้าที่ลูกค้าเลือกที่จะกําหนด, ตั้งค่าคอนฟิก, ดําเนินการ, และจัดการโซลูชันการเงินและการดำเนินงาน

### <a name="incident"></a>เหตุการณ์

ปัญหาที่ลูกค้าพบขณะที่พวกเขาใช้บริการการเงินและการดำเนินงานและที่ลูกค้าส่งตั๋วโดยผ่าน LCS

### <a name="microsoft-customer-support-services-css"></a>บริการสนับสนุนลูกค้าของ Microsoft (CSS)

ทีมสนับสนุนระดับสากลของ Microsoft ที่จัดสรรไว้เพื่อให้บริการคุณภาพสำหรับแอปการเงินและการดำเนินงาน

### <a name="microsoft-dynamics-lifecycle-services-lcs"></a>Microsoft Dynamics Lifecycle Services (LCS)

พอร์ทัลการจัดการสำหรับการจัดการวงจรการใช้ของแอปการเงินและการดำเนินงานจากการทดลอง, ไปยังการใช้งาน, ไปยังการจัดการหลังการใช้งานจริงและการสนับสนุน สำหรับข้อมูลเพิ่มเติม ให้ดู [ทรัพยากร Lifecycle Services](../../dev-itpro/lifecycle-services/lcs.md)
...
สภาพแวดล้อมการเงินและการดำเนินงานที่ลูกค้าใช้ในการจัดการธุรกรรมรายวันที่ "ใช้งานจริง" และกระบวนการทางธุรกิจ
...
สภาพแวดล้อมการเงินและการดำเนินงานของบริการของ Microsoft บนพื้นฐานที่สอดคล้องกันผ่านการอัปเดตบริการ ลูกค้าตั้งค่าปฏิทินการอัปเดตบริการของตนเองตามความต้องการทางธุรกิจ สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [การอัปเดตบริการแบบหนึ่งรุ่น](../../dev-itpro/lifecycle-services/oneversion-overview.md)
...
บุคคลหนึ่งที่ใช้สภาพแวดล้อมการเงินและการดำเนินงานและผู้ที่เกี่ยวข้องกับผู้เช่าของลูกค้า
