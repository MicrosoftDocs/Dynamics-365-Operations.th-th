...
description: บทความนี้จะให้คำอธิบายของบริการสำหรับแอปการเงินและการดำเนินงาน
author: tomhig
ms.date: 04/27/2022
ms.topic: article
...
ms.locfileid: "8847173"
---
# <a name="service-description-for-finance-and-operations-apps"></a>คำอธิบายบริการของแอปการเงินและการดำเนินงาน

[!include[banner](../includes/banner.md)]

แอปการเงินและการดำเนินงานคือซอฟต์แวร์การวางแผนทรัพยากรองค์กร (ERP) เป็นบริการ (SaaS) ที่มีให้ในตัว และสำหรับ [Microsoft Azure](https://azure.microsoft.com/overview/what-is-azure/) บริการ Finance and Operations ให้องค์กรมีฟังก์ชัน ERP ที่สนับสนุนความต้องการเฉพาะขององค์กร และช่วยองค์กรในการปรับปรุงเป็นสภาพแวดล้อมทางธุรกิจที่เปลี่ยนแปลงอย่างต่อเนื่อง โดยไม่จำเป็นต้องจัดการโครงสร้างพื้นฐาน แอปการเงินและการดำเนินงานอาจประกอบด้วยพื้นที่โซลูชันต่อไปนี้หนึ่งรายการหรือมากกว่า:
...
- [ชุดการพัฒนาซอฟต์แวร์ (SDK) Finance and Operations](../../dev-itpro/dev-tools/developer-home-page.md) และ [ระบบอัตโนมัติในการสร้าง Azure DevOps](../../dev-itpro/dev-tools/developer-home-page.md#build-automation-using-azure) แบบ [Visual Studio](https://visualstudio.microsoft.com)
...
Microsoft จัดการบริการ Finance and Operations โดยการปรับใช้, การตรวจสอบอย่างต่อเนื่อง, และการให้บริการสภาพแวดล้อม sandbox ของลูกค้าและสภาพแวดล้อมการทำงานจริงในการสมัครใช้งาน Microsoft SaaS การจัดการนี้ประกอบด้วยการปันส่วนโครงสร้างพื้นฐานของระบบที่ต้องใช้เพื่อรันบริการและสื่อสารกับลูกค้าเกี่ยวกับสภาพของบริการในเชิงรุก ความรับผิดชอบประกอบด้วย:
...
- ระบุข้อมูลการใช้งานที่ถูกต้องเกี่ยวกับการใช้งาน Finance and Operations ใน [ตัวประมาณการสมัครใช้งาน LCS](../../dev-itpro/lifecycle-services/subscription-estimator.md)
...
- ลูกค้าที่มีการดําเนินงานในจีนควรตรวจสอบ [คู่มือการวางแผนกลยุทธ์ Azure ประเทศจีน](/azure/china/) และ [Finance and Operations ที่ดําเนินงานโดย 21Vianet ในประเทศจีน](../../dev-itpro/deployment/china-local-deployment.md)
...
สำหรับแอปการเงินและการดำเนินงาน Microsoft จะดําเนินการเป็นผู้ประมวลผล ในฐานะผู้ประมวลผลข้อมูล Finance and Operations จะให้กระบวนการและคุณลักษณะเพื่อช่วยให้ลูกค้าปฏิบัติตามข้อผูกมัด GDPR ในฐานะผู้ควบคุมข้อมูล สำหรับข้อมูลเพิ่มเติม ให้อ้างอิงถึง [ภาพรวม GDPR](../../dev-itpro/gdpr/gdpr-guide.md)
...
| **ที่ไม่ใช้งานจริง**<br>sandbox ระดับ 2 (หรือสูงกว่า) | สภาพแวดล้อมที่ไม่ใช้งานจริงซึ่งลูกค้าปรับใช้สำหรับการทดสอบการยอมรับของผู้ใช้, การทดสอบการรวม, การฝึกอบรม, การจัดเตรียม, หรือสถานการณ์ก่อนการทำงานจริงอื่นใด | sandbox ระดับ 2 และ sandbox ระดับที่สูงกว่าถูกปรับใช้กับการสมัครใช้งาน SaaS ของ Finance and Operations การเข้าถึงฐานข้อมูล Azure SQL ที่เชื่อมโยงกับสภาพแวดล้อมที่ไม่ใช้งานจริงจะได้รับอนุญาตผ่าน [การเข้าถึงแบบทันเวลา](../../dev-itpro/database/database-just-in-time-jit-access.md) การเข้าถึง Remote Desktop ไม่พร้อมใช้งาน |
...
## <a name="finance-and-operations-support-offerings"></a>ข้อเสนอการสนับสนุนของ Finance and Operations

การสนับสนุนทางเทคนิคพร้อมใช้งานในตลาดที่ซึ่งมีการให้บริการ Finance and Operations [ประสบการณ์การสนับสนุน](../../dev-itpro/lifecycle-services/lcs-support.md) มีการจัดหาให้ใน LCS หรือแอปการเงินและการดำเนินงาน ยกตัวอย่างเช่น
...
Microsoft เสนอแผนสนับสนุนให้กับลูกค้า Finance and Operations สามแผน: Premier, Professional Direct, และการสนับสนุนที่รวมอยู่ในการสมัครใช้งาน ระดับของการสนับสนุนแตกต่างกันสำหรับแต่ละแผน ตารางต่อไปนี้แสดงการเปรียบเทียบของแผนสามแผน
...
สภาพแวดล้อม Finance and Operations ของบริการของ Microsoft บนพื้นฐานที่สอดคล้องกันผ่านการอัปเดตบริการ ลูกค้าตั้งค่าปฏิทินการอัปเดตบริการของตนเองตามความต้องการทางธุรกิจ สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [การอัปเดตบริการแบบหนึ่งรุ่น](../../dev-itpro/lifecycle-services/oneversion-overview.md)
