...
- ลูกค้าที่มีการดําเนินงานในจีนควรตรวจสอบ [คู่มือการวางแผนกลยุทธ์ Azure ประเทศจีน](/azure/china/) และ [Finance and Operations ที่ดําเนินงานโดย 21Vianet ในจีน](../../dev-itpro/deployment/china-local-deployment.md)
...
Microsoft เผยแพร่การอัปเดตบริการแปดรายการไปยังแอป Finance and Operations ทุกปีในเดือนต่อไปนี้:
...
| **ที่ไม่ใช้งานจริง**<br>sandbox ระดับ 2 (หรือสูงกว่า) | สภาพแวดล้อมที่ไม่ใช้งานจริงซึ่งลูกค้าปรับใช้สำหรับการทดสอบการยอมรับของผู้ใช้, การทดสอบการรวม, การฝึกอบรม, การจัดเตรียม, หรือสถานการณ์ก่อนการทำงานจริงอื่นใด | sandbox ระดับ 2 และ sandbox ระดับที่สูงกว่า ถูกปรับใช้กับการสมัครใช้งาน Finance and Operations SaaS การเข้าถึงฐานข้อมูล Azure SQL ที่เชื่อมโยงกับสภาพแวดล้อมที่ไม่ใช้งานจริงจะได้รับอนุญาตผ่าน [การเข้าถึงแบบทันเวลา](../../dev-itpro/database/database-just-in-time-jit-access.md) การเข้าถึง Remote Desktop ไม่พร้อมใช้งาน |
...
| <p>เมื่อเกิดความขัดข้อง Microsoft จะกำหนดว่าต้องดำเนินการย้ายโหนดเมื่อเกิดข้อผิดพลาดสำหรับลูกค้าหรือไม่ และจะมีการสูญเสียข้อมูลหรือไม่ ลูกค้าอาจสูญเสียข้อมูลไม่เกิน 15 นาที ขึ้นอยู่กับลักษณะและช่วงเวลาของการขัดข้อง | ในเหตุการณ์ของการสูญเสียข้อมูล ลูกค้าอาจต้องระบุการลงชื่อออกจากระบบที่เป็นลายลักษณ์อักษรเพื่อทริกเกอร์การย้ายโหนดเมื่อเกิดข้อผิดพลาด |
| เมื่อการย้ายโหนดเมื่อเกิดข้อผิดพลาดเกิดขึ้น บริการที่เกี่ยวข้องจะทำงานในโหมดที่จํากัด ไม่สามารถทริกเกอร์การอัปเดตการบํารุงรักษาในโหมดการย้ายโหนดเมื่อเกิดข้อผิดพลาด | ลูกค้าไม่สามารถร้องขอการปรับใช้แพคเกจหรือคำขอการบำรุงรักษาปกติอื่นๆ ในโหมดการย้ายโหนดเมื่อเกิดข้อผิดพลาดได้ |
| เมื่อศูนย์ข้อมูลกลายเป็นเชิงการปฏิบัติการ Microsoft จะกลับไปยังอินสแตนซ์การใช้งานจริงในภูมิภาค Azure หลักไม่ได้ การดําเนินงานปกติจะดําเนินการต่อ | ลูกค้าอาจต้องออกจากระบบเพื่อย้อนกลับไปยังอินสแตนซ์การใช้งานจริงในภูมิภาค Azure หลัก |
...
ทีมสนับสนุนระดับสากลของ Microsoft ที่จัดสรรไว้เพื่อให้บริการคุณภาพสำหรับแอป Finance and Operations
