...
ระบบวิธีใช้ในผลิตภัณฑ์ดึงบทความจาก Microsoft Docs และเว็บไซต์ที่เชื่อมต่ออื่นๆ นอกจากนี้ยังดึงในคู่มืองานที่จัดเก็บไว้ในตัวทำแบบจำลองกระบวนการทางธุรกิจ (BPM) ใน Microsoft Dynamics Lifecycle Services (LCS)
