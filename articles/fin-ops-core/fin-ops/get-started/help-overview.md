...
description: บทความนี้แสดงภาพรวมของระบบวิธีใช้ของแอปการเงินและการดำเนินงาน
author: edupont04
ms.date: 08/16/2022
ms.topic: overview
ms.prod: ''
...
> [!NOTE]
> ตัวดึงข้อมูล RSS ส่งคืนรายการ 100 หัวข้อการอัปเดตล่าสุด รายการจะเรียงลำดับตามวันที่ แต่อาจใช้เวลาไม่เกินหนึ่งสัปดาห์ก่อนที่บทความล่าสุดที่อัปเดตจะจัดอยู่ในรายการ  
...
ถ้าคุณมีความคิดเห็นหรือคำถามเกี่ยวกับบทความ ฝากความคิดเห็นให้พวกเราที่ด้านล่างของหน้า
...
คุณสามารถจัดสรรและแก้ไขเอกสารได้ เพื่อเริ่มต้นใช้งาน เลือกปุ่ม **แก้ไข** (สัญลักษณ์ดินสอ) บนบทความ วิดีโอต่อไปนี้แสดงวิธีการที่คุณสามารถจัดสรรเอกสารของเรา
