...
Microsoft จัดส่งไลบรารีคู่มืองานสำหรับการนำออกใช้ในเดือนธันวาคม 2017 สำหรับ Dynamics 365 for Finance and Operations ส่วน [การเข้าถึงคู่มืองานจากบานหน้าต่างวิธีใช้](help-overview.md#accessing-task-guides-from-the-help-pane) จะอธิบายวิธีการค้นหาคู่มืองานที่ถูกต้องสำหรับผลิตภัณฑ์ของคุณ
...
คุณสามารถใช้ตัวบันทึกงานเพื่อสร้างคู่มืองานแบบที่คุณกำหนดเองได้ สำหรับข้อมูลเพิ่มเติม ดู [สร้างเอกสารหรือการฝึกอบรมโดยใช้การบันทึกงาน](../../dev-itpro/user-interface/task-recorder-training-docs.md)
