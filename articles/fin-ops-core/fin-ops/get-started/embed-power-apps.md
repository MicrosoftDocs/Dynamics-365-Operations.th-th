...
3. กำหนดค่าแอปที่ฝังไว้:
    ...
    - ฟิลด์ **รหัสของแอป** บ่งชี้ถึงรหัสเฉพาะสากล (GUID) สำหรับแอปพื้นที่ทำงานที่คุณต้องการฝัง ในการดึงค่านี้ ให้หาแอปใน [web.powerapps.com](https://web.powerapps.com) จากนั้นหาในฟิลด์ **รหัสแอป** ภายใต้ **รายละเอียด**
