...
description: บทความนี้แสดงวิธีการสร้างฟิลด์แบบกำหนดเองผ่านอินเทอร์เฟซผู้ใช้เพื่อปรับแต่งแอปพลิเคชันให้เหมาะกับธุรกิจของคุณ
author: jasongre
ms.date: 05/24/2021
ms.topic: article
ms.prod: ''
...
หลังจากที่คุณสร้างฟิลด์แบบกำหนดเอง และแสดงในหน้า คุณอาจต้องการให้มุมมองหน้าที่มีการอัปเดตนี้ที่รวมฟิลด์ใหม่ให้ผู้ใช้อื่นๆ ในระบบ ซึ่งสามารถทำได้ในสองวิธีที่แตกต่างกัน โดยใช้ความสามารถในการตั้งค่าส่วนบุคคลของผลิตภัณฑ์:
