...
วิดีโอนี้แสดงความง่ายดายในการเพิ่มฟิลด์ที่กำหนดเองลงในหน้า: [การเพิ่มฟิลด์ที่กำหนดเอง](https://www.youtube.com/watch?v=gWSGZI9Vtnc)
...
9. การออกจากกล่องโต้ตอบ **สร้างฟิลด์ใหม่** จะนำคุณกลับไปยังกล่องโต้ตอบ **แทรกฟิลด์** ฟิลด์ที่กำหนดเองใดๆ ที่เพิ่งถูกเพิ่ม จะสามารถถูกทำเครื่องหมายในรายการฟิลด์ที่จะแทรกลงในหน้าได้โดยอัตโนมัติ
10. คลิก **แทรก** เพื่อแทรกฟิลด์ที่ทำเครื่องหมายลงในพื้นที่ที่เลือกของหน้า
...
- กระบวนการผลิตที่แนะนำคือ **แผยแพร่ [มุมมองที่บันทึกไว้](saved-views.md)** ด้วยฟิลด์ที่กำหนดเองซึ่งเพิ่มไปยังหน้าไปยังชุดผู้ใช้ที่เหมาะสม ถ้าไม่ได้เปิดใช้งานลักษณะการงานมุมมองที่บันทึกไว้ ผู้ดูแลระบบสามารถใช้การการตั้งค่าส่วนบุคคลกับผู้ใช้ที่ต้องการจากหน้า **การตั้งค่าส่วนบุคคล** สำหรับข้อมูลเพิ่มเติม ให้ดู [ปรับประสบการณ์ผู้ใช้เป็นแบบส่วนตัว](personalize-user-experience.md)
...
นอกจากนี้ ยังเป็นสิ้งสำคัญในการอนุญาตให้สามารถมองเห็นฟิลด์ที่กำหนดเองได้บนเอนทิตี้ข้อมูล เอนทิตี้ข้อมูลจะถูกใช้ในคุณลักษณะ [ภาพรวมการรวม Office](../../dev-itpro/office-integration/office-integration.md) และสำหรับสถานการณ์จำลองการนำเข้า/ส่งออกข้อมูล
...
### <a name="how-can-i-move-custom-fields-between-environments"></a>ฉันจะย้ายฟิลด์ที่กำหนดเองระหว่างสภาพแวดล้อมได้อย่างไร 
