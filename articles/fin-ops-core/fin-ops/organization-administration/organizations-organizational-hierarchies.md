...
คุณสามารถกำหนดชนิดต่อไปนี้ขององค์กรภายใน: นิติบุคคล หน่วยปฏิบัติการ และทีมงาน
...
ประเภทของหน่วยปฏิบัติการ ประกอบด้วยศูนย์ต้นทุน หน่วยธุรกิจ สตรีมค่า แผนก และช่องทางการค้า ตารางต่อไปนี้มีข้อมูลเพิ่มเติมเกี่ยวกับหน่วยปฏิบัติงานแต่ละชนิด
...
> [!NOTE]
> หลังจากเพิ่มหน่วยปฏิบัติงานลงในลำดับชั้นแล้ว จะไม่สามารถลบหน่วยปฏิบัติงานได้ 
...
- [สร้างลำดับชั้นขององค์กร](tasks/create-organization-hierarchy.md)
- [สร้างนิติบุคคล](tasks/create-legal-entity.md)
- [สร้างหน่วยปฏิบัติงาน](tasks/create-operating-unit.md)
