...
องค์ประกอบต่อไปนี้ให้คุณออกแบบลำดับงานที่มีสาขารองหรือสาขาที่เรียกใช้พร้อมกัน
...
หนึ่ง *กิจกรรมคู่ขนาน* เป็นองค์ประกอบลำดับงานที่รวมสาขาลำดับงานสองสาขาขึ้นไปที่เรียกใช้พร้อมกัน

### <a name="subworkflow"></a>ลำดับงานย่อย

หนึ่ง *ลำดับงานย่อย* เป็นลำดับงานที่เรียกใช้ภายในบริบทของลำดับงานอื่น
