...
## <a name="after-importing-addresses-when-i-access-the-records-why-am-i-unable-to-edit-imported-addresses"></a>หลังจากนําเข้าที่อยู่แล้ว เหตุใดเมื่อเข้าถึงเรกคอร์ดแล้วฉันไม่สามารถแก้ไขที่อยู่ที่นําเข้าได้

เมื่อนําเข้าที่อยู่ จะมีฟิลด์ที่มีป้ายชื่อ **IsLocationOwner** ซึ่งบ่งชี้ว่าฝ่ายที่สัมพันธ์กับที่ตั้ง (ที่อยู่) เป็นเจ้าของที่อยู่หรือไม่ หากฝ่ายเป็นเจ้าของที่อยู่ จะสามารถแก้ไขที่อยู่เมื่อเข้าถึงโดยใช้ฝ่ายในสมุดที่อยู่สากลหรือจากแบบฟอร์มเรกคอร์ดหลัก (เช่น ลูกค้า ผู้จัดจำหน่าย หรือผู้ปฏิบัติงาน) หากฝ่ายไม่ใช่เจ้าของที่อยู่ จะไม่สามารถแก้ไขเรกคอร์ดจากแบบฟอร์มที่แสดงรายการไว้ก่อนหน้านี้ เมื่อนําเข้าที่อยู่ **IsLocationOwner** ควรตั้งค่าเป็น **ใช่** หากคุณต้องการให้ที่อยู่สามารถแก้ไขได้โดยใช้ฝ่ายที่เกี่ยวข้อง อย่างไรก็ตาม มีบางครั้งที่นําเข้าฟิลด์นี้อย่างไม่ถูกต้อง เมื่อต้องการแก้ไขปัญหานี้ เจ้าของสถานที่สามารถอัพเดตภายในสมุดที่อยู่สากลจากเรกคอร์ดฝ่ายหรือจากหน้า **ยืนยันเจ้าของสถานที่** เมื่อต้องการอัพเดตเรกคอร์ดฝ่ายเดียว ให้ไปที่ **สมุดที่อยู่สากล > ที่อยู่** เลือก **แก้ไข** เพื่อเปิดใช้หน้า **แก้ไขที่อยู่** เพื่อเปลี่ยนเจ้าของสถานที่ เลือก **เปลี่ยนเจ้าของสถานที่** เพื่อดูเจ้าของสถานที่ก่อนหน้านี้ ที่มีฝ่ายที่เลือกในปัจจุบันเป็นเจ้าของสถานที่ใหม่ หากเจ้าของสถานที่ก่อนหน้านี้ว่างเปล่า แสดงว่าเจ้าของสถานที่ไม่ได้รับการสร้างขึ้น การเลือกตัวเลือก **ขั้นสูง** จะเปิดหน้า **จัดการที่อยู่** ซึ่งสามารถตั้งค่าเจ้าของสถานที่ได้ด้วย เลือกสถานที่ที่จะอัพเดต แล้วเลือก **ตั้งค่าเจ้าของสถานที่** จากเมนู เมื่อต้องการอัพเดตเจ้าของสถานที่หลายเรกคอร์ด ให้ไปที่ **สมุดที่อยู่สากล > สถานที่ > ยืนยันเจ้าของสถานที่** รายการมีที่ตั้งที่เชื่อมโยงกับฝ่ายเดียว แต่ฝ่ายนั้นไม่ใช่เจ้าของ การเลือก **ยืนยันเจ้าของ** จะตั้งค่า **รหัสฝ่ายที่เป็นเจ้าของ** ที่นําเสนอให้เป็นเจ้าของที่อยู่ที่เชื่อมโยง หลังจากตั้งค่าฝ่ายเป็นเจ้าของแล้ว ที่อยู่ที่เชื่อมโยงจะสามารถแก้ไขได้จากเรกคอร์ดฝ่าย เมื่อต้องการเปลี่ยนเจ้าของสถานที่ คุณต้องกําหนดสิทธิ์ **ตั้งค่าเจ้าของสถานที่** ในหน้า **การตั้งค่าคอนฟิกความปลอดภัย**  ผู้ดูแลระบบจะมอบสิทธิ์นี้ตามค่าเริ่มต้น
