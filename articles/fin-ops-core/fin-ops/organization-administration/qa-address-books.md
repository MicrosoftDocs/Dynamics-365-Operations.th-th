---
title: คำถามที่ถามบ่อยเกี่ยวกับสมุดที่อยู่
description: บทความนี้ให้คำตอบของคำถามที่ถามบ่อยที่เกี่ยวข้องกับสมุดที่อยู่
author: msftbrking
ms.date: 02/03/2021
ms.topic: article
ms.prod: ''
...
## <a name="after-i-import-addresses-why-cant-i-edit-the-records"></a>หลังจากที่ฉันนําเข้าที่อยู่แล้ว เพราะเหตุใดฉันจึงไม่สามารถแก้ไขเรกคอร์ดได้

เมื่อคุณนําเข้าที่อยู่ จะมีฟิลด์ที่ชื่อ **IsLocationOwner** ฟิลด์นี้จะบ่งชี้ว่าฝ่ายที่สัมพันธ์กับที่ตั้ง (ที่อยู่) เป็นเจ้าของที่อยู่หรือไม่ หากฝ่ายเป็นเจ้าของที่อยู่ จะสามารถแก้ไขที่อยู่เมื่อใช้ฝ่ายในสมุดที่อยู่สากลหรือจากหน้าเรกคอร์ดหลัก (เช่น ลูกค้า ผู้จัดจำหน่าย หรือผู้ปฏิบัติงาน) ถ้าฝ่ายไม่ใช่เจ้าของที่อยู่ เรกคอร์ดจะไม่สามารถแก้ไขได้ 

เมื่อคุณนําเข้าที่อยู่ ฟิลด์ **IsLocationOwner** ควรตั้งค่าเป็น **ใช่** หากคุณต้องการให้ที่อยู่สามารถแก้ไขได้โดยใช้ฝ่ายที่เกี่ยวข้อง ถ้านําเข้าฟิลด์นี้อย่างไม่ถูกต้อง เจ้าของสถานที่จะสามารถอัปเดตในสมุดที่อยู่สากลได้

สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการเปลี่ยนเจ้าของสถานที่ของที่อยู่ที่นําเข้า โปรดดูที่ [การจัดการเจ้าของสถานที่](./global-address-book-location-owner.md)
