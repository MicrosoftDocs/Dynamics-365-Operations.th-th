...
>[!IMPORTANT]
>ณ วันที่ 1 กรกฎาคม 2020 LinkedIn ไม่สนับสนุน Internet Explorer 11 อีกต่อไป ผู้ใช้ยังสามารถเข้าถึง LinkedIn ด้วย Internet Explorer 11 แต่จะได้รับพร้อมท์ให้อัปเกรดหรือใช้เบราว์เซอร์อื่น สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [เบราว์เซอร์อินเทอร์เน็ตที่สนับสนุนสำหรับ LinkedIn](https://www.linkedin.com/help/linkedin/answer/4135/supported-internet-browsers-for-linkedin)
...
3. บนแท็บ **การเชื่อมต่อ** ให้เลือก **เชื่อมต่อ** ที่อยู่ถัดจาก **LinkedIn** ทำตามคำแนะนำที่จัดเตรียมให้โดย LinkedIn
    ...
    ![[ตั้งค่าการเชื่อมต่อกับ LinkedIn Recruiter จาก Attract](./media/attract-set-up-linkedin-recruiter-connection.png)](./media/attract-set-up-linkedin-recruiter-connection.png)
...
>[!NOTE]
>ถ้าคุณมีสิทธิ์การใช้งานของผู้สรรหาที่กำหนดให้กับคุณ คุณสามารถดูข้อมูลทั้งหมดของผู้สมัครได้<br><br>
>ถ้าคุณมีสิทธิ์การใช้งานผู้จัดการว่าจ้างหรือไม่มีสิทธิ์การใช้งานที่กำหนดให้กับคุณ ต้องตรวจสอบให้แน่ใจว่าคุณได้ลงชื่อออกจาก LinkedIn หรือ LinkedIn Recruiter ก่อนที่จะนำทางไปยังแท็บ LinkedIn สำหรับผู้สมัครใน Attract คุณจะสามารถดูข้อมูลโพรไฟล์สาธารณะพื้นฐานของผู้สมัคร เช่น ชื่อและนามสกุลของพวกเขา

1. ใน Attract ให้เลือก **งาน** หรือ **กลุ่มความสามารถพิเศษ** ด้านซ้ายมือ แล้วเลือกผู้สมัคร

    ![[ดูผู้สมัคร LinkedIn Attract](./media/attract-view-linkedin-candidates.png)](./media/attract-view-linkedin-candidates.png)

2. ในโพรไฟล์ของผู้สมัคร ให้เลือกแท็บ **LinkedIn** คุณสามารถดูโพรไฟล์ของผู้สมัครและประวัติ InMail

   ![ดูข้อมูล LinkedIn ของผู้สมัคร](./media/attract-candidate-linkedin-tab.png)

จากที่นี่ คุณสามารถทำการดำเนินการต่อไปนี้ได้:

- เลือกแท็บ **กิจกรรมการสรรหาบุคลากร** เพื่อดู:
   
   - บันทึกการสรรหาบุคคล (ทั้งสาธารณะและส่วนบุคคล) โดยค่าเริ่มต้น บันทึกเป็นส่วนบุคคลและสามารถมองเห็นได้เฉพาะเจ้าของบันทึกเท่านั้น
   - กิจกรรม InMail (แต่ไม่ใช่เนื้อหา InMail) เลื่อนไปที่ด้านล่างของหน้าเพื่อดูการแลกเปลี่ยน InMail กับผู้ที่มีแนวโน้ม และดูผู้ใช้รายอื่นในองค์กรของคุณว่าใครมีปฏิสัมพันธ์กับผู้ที่มีแนวโน้มของคุณ
   - กิจกรรมการปฏิเสธผู้สมัคร

- เลือก **ส่ง InMail** เพื่อส่ง InMail โดยไม่ต้องออกจาก Attract

- เลือก **บันทึกเป็นงาน** เพื่อบันทึกงานโดยไม่ต้องออกจาก Attract
