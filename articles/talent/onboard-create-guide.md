---
title: สร้างและส่งคู่มือการเตรียมความพร้อมโดยใช้ Dynamics 365 for Talent - Onboard
description: หัวข้อนี้อธิบายวิธีใช้แอป Microsoft Dynamics 365 for Talent - Onboard เพื่อสร้างคู่มือการเตรียมความพร้อมสำหรับพนักงานใหม่ของคุณ งานนี้เป็นขั้นตอนแรกที่จำเป็นในกลยุทธ์การจ้างงานถึงการปลดเกษียณแบบการจัดการทุนมนุษย์ (HCM)
...
ms.locfileid: "1731667"
---
# <a name="create-and-send-an-onboarding-guide-by-using-dynamics-365-for-talent-onboard"></a>สร้างและส่งคู่มือการเตรียมความพร้อมโดยใช้ Dynamics 365 for Talent: การเตรียมความพร้อม

[!include [banner](includes/banner.md)]

Microsoft Dynamics 365 for Talent: การเตรียมความพร้อม ช่วยให้คุณสามารถสร้างคู่มือการเตรียมความพร้อมจากเท็มเพลตที่คุณสร้างขึ้นเองจากเท็มเพลตที่มีอยู่ในแกลเลอรี หรือตั้งแต่แรก
