...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>มีอะไรใหม่หรือเปลี่ยนไปอย่างไรบ้างใน Dynamics 365 Talent (12 พฤศจิกายน 2019)
...
การเปลี่ยนแปลงที่อธิบายไว้ในส่วนนี้นำไปใช้กับการสร้างหมายเลข 8.1.2604 ตัวเลขในวงเล็บในส่วนหัวบางส่วนอ้างอิงถึงหมายเลขที่สนับสนุนใน Microsoft Dynamics Lifecycle Services (LCS)

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>ที่ตั้งสำนักงานไม่ได้รับการอัพเดตโดยผ่านสมุดงาน Excel (369727)

ด้วยการเปลี่ยนแปลงนี้ คุณสามารถอัพเดตที่ตั้งสำนักงานโดยใช้โปรแกรมออกแบบสมุดงาน Office ได้ในขณะนี้
