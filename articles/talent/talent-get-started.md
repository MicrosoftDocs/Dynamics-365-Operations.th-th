...
> [!NOTE] 
> ผลิตภัณฑ์สามอย่างต่อไปนี้มีความเกี่ยวข้องกันอย่างใกล้ชิด: Dynamics 365 Finance; Dynamics 365 Retail; และ Dynamics 365 Talent ฟังก์ชันเดียวกันอาจปรากฏในทั้งสามผลิตภัณฑ์ ดังนั้น ในหัวข้อที่เกี่ยวข้องกับ Retail เป็นหลัก ชื่อผลิตภัณฑ์จะเป็น Dynamics 365 Retail ส่วนในหัวข้อที่เกี่ยวข้องกับ Talent ชื่อผลิตภัณฑ์จะเป็น Dynamics 365 Talent; และในหัวข้อที่เกี่ยวข้องกับผลิตภัณฑ์หลัก ชื่อผลิตภัณฑ์จะเป็น Dynamics 365 Finance หัวข้อที่เขียนขึ้นสำหรับหนึ่งผลิตภัณฑ์อาจนำไปใช้กับฟังก์ชันเดียวกันในผลิตภัณฑ์ที่เกี่ยวข้องได้
