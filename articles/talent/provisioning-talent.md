...
การรวมระหว่าง Talent และสภาพแวดล้อม PowerApps ช่วยให้คุณสามารถรวม และขยายการใช้ข้อมูล Talent ได้โดยใช้เครื่องมือ PowerApps การทำความเข้าใจวัตถุประสงค์ของสภาพแวดล้อม PowerApps จะไม่เพียงช่วยให้คุณสามารถสร้างแอพเพื่อขยาย Talent แต่ยังจะช่วยคุณในการเลือกสภาพแวดล้อมที่ถูกต้อง เมื่อเตรียมใช้งาน Talent สำหรับข้อมูลเกี่ยวกับสภาพแวดล้อม PowerApps รวมถึงขอบเขตของสภาพแวดล้อม การเข้าถึงสภาพแวดล้อม และการสร้างและการเลือกสภาพแวดล้อม ดู [การประกาศสภาพแวดล้อม PowerApps](https://powerapps.microsoft.com/en-us/blog/powerapps-environments/) 

ใช้คำแนะนำต่อไปนี้ เมื่อระบุสภาพแวดล้อม PowerApps เพื่อจัดวาง Talent ลงใน: 

1. ใน LCS เลือก **จัดการสภาพแวดล้อม** หรือไปโดยตรงที่ศูนย์การจัดการ PowerApps ที่ซึ่งคุณสามารถดูสภาพแวดล้อมที่มีอยู่ และสร้างสภาพแวดล้อมใหม่ได้
2. สภาพแวดล้อม Talent เดียวถูกแมปไปยังสภาพแวดล้อม PowerApps เดียว
3. สภาพแวดล้อม PowerApps "มี" แอพลิเคชัน Talent รวมทั้งแอพพลิเคชัน PowerApps ที่สอดคล้องกัน ขั้นตอน และ Common Data Service ถ้ามีการลบสภาพแวดล้อม PowerApps แอพภายในนั้นจะถูกลบเช่นกัน เมื่อเตรียมใช้งานสภาพแวดล้อม Talent "งบทดลอง" หรือ "การผลิต" อย่างใดอย่างหนึ่ง สามารถถูกเตรียมใช้งานได้ เลือกชนิดของสภาพแวดล้อมโดยขึ้นอยู่กับวิธีการใช้สภาพแวดล้อม 
4. การรวมข้อมูลและกลยุทธ์การทดสอบควรถูกพิจารณา เช่น Sandbox UAT หรือการผลิต เราขอแนะนำว่า คุณควรพิจารณาผลกระทบต่างๆ สำหรับการปรับใช้ของคุณ เนื่องจากจะเปลี่ยนสภาพแวดล้อม Talent ที่ถูกแม็ปไปยังสภาพแวดล้อม PowerApps ในภายหลังได้ยาก
5. สภาพแวดล้อม PowerApps ต่อไปนี้ไม่สามารถถูกใช้สำหรับ Talent และสามารถถูกกรองข้อมูลได้จากรายการการเลือกภายใน LCS:
    ...
    - **ภูมิภาคที่ไม่ได้รับการสนับสนุน** - ในขณะนี้ Talent ได้รับการสนับสนุนเฉพาะในภูมิภาคดังต่อไปนี้: สหรัฐอเมริกา ยุโรป สหราชอาณาจักร หรือออสเตรเลีย
