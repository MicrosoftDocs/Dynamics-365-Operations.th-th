...
> [!NOTE]
> ถ้าคุณปรับเปลี่ยนข้อความคำตอบในกลุ่มคำตอบที่ได้ใช้ในแบบสอบถามที่เสร็จสมบูรณ์แล้ว จะประเมินข้อมูลได้ยาก และผลลัพธ์ของแบบสอบถามอาจไม่สามารถ ใช้ได้อีกต่อไป ถ้าคุณต้องเปลี่ยนกลุ่มคำตอบ พิจารณาสร้างกลุ่มคำตอบใหม่แทนการเปลี่ยนแปลงกลุ่มคำตอบที่มีอยู่ คุณไม่สามารถลบกลุ่มคำตอบที่แนบกับคำถามหรือคำตอบ หรือได้ตอบไปแล้วได้
...
> [!TIP]
> เมื่อต้องการประเมินแบบสอบถามโดย ใช้คะแนน แต่ไม่ได้แยกประเภท คุณสามารถเพิ่มคำถามทั้งหมดให้กับกลุ่มผลคะแนนเดียวกัน 
