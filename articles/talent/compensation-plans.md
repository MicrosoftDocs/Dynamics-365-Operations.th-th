...
<li>การดำเนินการสามารถให้แน่ใจว่าการคำนวณจะถูกใช้เมื่อแผนค่าตอบแทนคงที่มีการประมวลผล  ตัวอย่างเช่น การดำเนินการชนิดส่วนของผู้ถือหุ้นจะเปรียบเทียบค่าจ้างพนักงานไปยังจุดอ้างอิงขั้นต่ำสำหรับระดับของพนักงานและให้แน่ใจว่าพนักงานได้รับชำระเงินขั้นต่ำเป็นอย่างน้อย</li>
</ul></td>
</tr>
<tr class="even">
<td>ระดับ</td>
