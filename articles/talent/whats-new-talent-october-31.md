...
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-core-hr-october-31-2018"></a>มีอะไรใหม่หรือเปลี่ยนแปลงใน Dynamics 365 for Talent Core HR (31 ตุลาคม 2018)
...
## <a name="create-links-from-talent-to-finance-and-operations"></a>สร้างลิงค์จาก Talent ไปยัง Finance and Operations
ฟังก์ชันการนำทางใหม่นี้ช่วยให้คุณสามารถเชื่อมโยงจาก Talent ไปยัง Finance and Operations โดยให้การนำทางโดยตรงไปยังหน้า Finance and Operations เมื่อมีการตั้งค่าคอนฟิกลิงค์ คุณสามารถระบุชื่อและกลุ่มของลิงค์ ที่ซึ่งลิงค์ควรแสดงใน Talent และหน้าเป้าหมายควรถูกเปิดภายใน Finance and Operations

#### <a name="coming-soon"></a>เร็วๆ นี้
บริบทของฟิลด์จะถูกเพิ่มในอนาคตเพื่ออนุญาตให้นำทางโดยตรงไปยังเรกคอร์ดที่สอดคล้องกันใน Finance and Operations ตัวอย่างเช่น คุณสามารถใช้ **ลิงค์ไปยังฟิลด์** เพื่อให้บริบทที่จะนำทางโดยตรงไปยังพนักงานหรือตำแหน่งเฉพาะใน Finance and Operations

### <a name="configure-target-systems"></a>ตั้งค่าคอนฟิกระบบปลายทาง

ใน Talent ผู้ดูแลระบบสามารถกำหนดลิงค์ที่จะแสดงถึงพื้นที่ทำงานการดูแลระบบ ส่วนหนึ่งของการตั้งค่าคอนฟิกคือสภาพแวดล้อม Finance and Operations ที่คุณต้องการให้นำทางไป เป็น "เป้าหมาย" ของการเชื่อมโยง คุณทำเช่นนี้โดยการตั้งชื่อระบบปลายทางชื่อ และใส่ URL ของสภาพแวดล้อม Finance and Operations นี่คือตัวอย่างของ URL Finance and Operations ที่คุณจะต้องระบุ: https://devax00124aos.cloud.test.dynamics.com/ หลังจากที่คุณตั้งค่าคอนฟิกระบบเป้าหมายของคุณ คุณสามารถกำหนดการเชื่อมโยงของคุณได้
...
- แสดงชื่อ - กำหนดชื่อที่จะปรากฏเป็นลิงค์ไปยัง Finance and Operations ในขณะนี้ ไม่มีการแปลข้อมูลนี้
...
- ระบบเป้าหมาย - เลือกระบบเป้าหมายที่สร้างโดยใช้ตัวเลือก **ตั้งค่าคอนฟิกระบบเป้าหมาย** นี่จะเป็นสภาพแวดล้อม Finance and Operations ที่จะใช้ เมื่อมีการนำทางโดยใช้การเชื่อมโยง

- ใช้บริษัทปัจจุบันของผู้ใช้ - เลือก **ใช่** ถ้าคุณต้องการใช้บริบทบริษัทปัจจุบันของผู้ใช้ใน เมื่อนำทางไปยัง Finance and Operations ถ้าเลือก **ไม่** จากนั้นคุณจะสามารถเลือกบริษัทที่ควรใช้ได้

- รายการเมนูเป้าหมาย - ป้อนรายการเมนูจาก Finance and Operation ที่การเชื่อมโยงควรใช้ เมื่อมีการนำทาง รายการเมนูที่คุณนำทางโดยตรงไป จะพร้อมใช้งาน เพื่อค้นหารายการเมนูที่จำเป็น เปิด Finance and Operations และเปิดหน้าซึ่งเป็นเป้าหมายของการนำทาง คัดลอกรายการเมนูจาก URL ตัวอย่างเช่น ถ้าคุณต้องการให้การเชื่อมโยงนำคุณไปยังรายการพนักงานใน Finance and Operations ป้อนค่าที่ปรากฏหลังจาก "&mi" ใน URL https://devax00124aos.cloud.test.dynamics.com/?p=USMF&mi=HcmWorkerListPage_Employees รายการเมนูที่จะนำทางไปยังหน้ารายการพนักงานในตัวอย่างนี้คือ: HcmWorkerListPage_Employees
...
- การเชื่อมโยงไปยังฟิลด์ - (เร็วๆ นี้) การเลือกฟิลด์นี้จะอนุญาตให้สำหรับการนำทางโดยตรงจากเรกคอร์ดเดียวใน Talent ไปยังเรกคอร์ดเดียวใน Finance and Operations
...
ผู้ใช้ยังสามารถมีสิทธิ์ความปลอดภัยภายใน Finance and Operations ที่กำหนดให้เข้าถึงหน้าใน Finance and Operations ถ้าไม่ จะปรากฏกล่องโต้ตอบความปลอดภัยเมื่อใช้การเชื่อมโยง
