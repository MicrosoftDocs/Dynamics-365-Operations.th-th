...
1. <span data-ttu-id="3318f-107">ไปที่ ทั่วไป > ทั่วไป > วันที่และเวลาของรอบเวลา</span><span class="sxs-lookup"><span data-stu-id="3318f-107">Go to Common > Common > Session date and time.</span></span>
2. <span data-ttu-id="3318f-108">ในฟิลด์วันที่ ให้ป้อนวันที่</span><span class="sxs-lookup"><span data-stu-id="3318f-108">In the Date field, enter a date.</span></span>
3. <span data-ttu-id="3318f-109">คลิก ตกลง</span><span class="sxs-lookup"><span data-stu-id="3318f-109">Click OK.</span></span>
