...
บทความนี้ให้ภาพรวมของลายเซ็นอิเล็กทรอนิกส์และอธิบายวิธีการที่สามารถใช้งานได้ใน Microsoft Dynamics 365 for Finance and Operations
...
> [!NOTE]
> Finance and Operations ใช้คุณลักษณะ Microsoft SQL Server เพื่อสร้างใบรับรอง และเปิดใช้งานการลงชื่ออิเล็กทรอนิกส์ ไม่จำเป็นต้องใช้ใบรับรองหรือโครงสร้างพื้นฐานคีย์สาธารณะ (PKI) เพิ่มเติม
...
คุณจะต้องป้อนและยืนยันรหัสผ่านที่คุณจะใช้สำหรับการลงชื่อ รหัสผ่านใช้เพื่อป้องกันคีย์ส่วนตัวของคุณและอนุมัติการใช้ใบรับรองของคุณ รหัสผ่านนี้ไม่มีการจัดเก็บไว้ในฐานข้อมูล และบุคคลอื่นไม่สามารถใช้ได้ รวมถึงผู้ดูแลระบบ Finance and Operations
