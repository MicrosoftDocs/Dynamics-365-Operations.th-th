...
หัวข้อนี้ชี้ไปที่เนื้อหาที่จะช่วยให้ผู้ใช้ที่มีความชำนาญและผู้ดูแลระบบตั้งค่าคอนฟิก Microsoft Dynamics 365 for Finance and Operations, Enterprise edition เนื้อหานี้จะช่วยในการตั้งค่าคอนฟิกระบบให้ทำงานได้อย่างราบรื่นและอย่างมีประสิทธิภาพสำหรับธุรกิจและองค์กรของคุณ
...
----------------
ลำดับหมายเลขที่ใช้ในการสร้างตัวระบุเฉพาะที่สามารถอ่านได้สำหรับเร็กคอร์ดข้อมูลหลักและเรกคอร์ดธุรกรรมที่จำเป็นต้องมีตัวระบุ เรกคอร์ดข้อมูลหลักหรือเรกคอร์ดธุรกรรมที่จำเป็นต้องมีตัวระบุจะถูกอ้างเป็น *การอ้างอิง* ก่อนที่คุณจะสามารถสร้างเรกคอร์ดใหม่สำหรับการอ้างอิงได้ คุณต้องตั้งค่าลำดับหมายเลขและเชื่อมโยงกับการอ้างอิงนั้น
...
ก่อนที่คุณตั้งค่าองค์กรและลำดับชั้นขององค์กรใน Finance and Operations ตรวจสอบให้แน่ใจว่า คุณวางแผนว่าจะสร้างแบบจำลองธุรกิจของคุณอย่างไร รูปแบบองค์กรมีผลกระทบที่สำคัญต่อการใช้งานของ Finance and Operations และในกระบวนการทางธุรกิจ
...
-   [สมุดที่อยู่สากล](overview-global-address-book.md)
-   [วางแผนวิธีการตั้งค่าคอนฟิกสมุดที่อยู่สากลและสมุดที่อยู่เพิ่มเติม](plan-configuration-global-address-book-additional-address-books.md)
- [ตั้งค่าคอนฟิกสมุดที่อยู่สากล](tasks/configure-global-address-book.md)
-   [FAQ สมุดที่อยู่](qa-address-books.md)


## <a name="workflow"></a>ลำดับงาน
ลำดับงาน คือระบบที่ติดตั้งไว้พร้อมกับ Finance and Operations ที่คุณสามารถใช้เพื่อสร้าง ลำดับงาน หรือกระบวนการทางธุรกิจแต่ละรายการ เมื่อคุณสร้างลำดับงาน คุณจะต้องกำหนดวิธีการที่เอกสารหมุนเวียนในระบบ และระบุว่าใครต้องทำงานให้เสร็จสมบูรณ์หรืออนุมัติเอกสาร 

-   [ภาพรวมของลำดับงาน](overview-workflow-system.md)
...
ใน Finance and Operations คุณสามารถใช้ลายเซ็นอิเล็กทรอนิกส์สำหรับกระบวนการทางธุรกิจที่สำคัญ บางกระบวนการมีความสามารถด้านลายเซ็นอิเล็กทรอนิกส์ในตัว คุณยังสามารถสร้างข้อกำหนดของลายเซ็นที่กำหนดเองสำหรับตารางฐานข้อมูลและฟิลด์ใดก็ได้ 
...
-   [ภาพรวมการจัดการกรณี](cases.md)
-   [ตั้งค่าคอนฟิกความปลอดภัยของกรณี กระบวนการ และประเภท](plan-case-management.md)
