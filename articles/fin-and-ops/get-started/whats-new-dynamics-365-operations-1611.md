...
<td>คุณลักษณะนี้คือการปรับปรุงประสิทธิภาพการทำงาน <strong>ตัวอย่าง</strong> คุณขายผลิตภัณฑ์ที่มีชื่อว่า เสื้อยืดคอกลม Polo ผลิตภัณฑ์นี้มีสองสี: สีเขียวและสีน้ำเงิน และยังมีสองขนาด: ขนาดเล็กและขนาดกลาง สีและขนาดเป็นมิติของผลิตภัณฑ์ที่ใช้งานอยู่สำหรับเสื้อยืดคอกลม Polo เมื่อคุณป้อนรายการการขายสำหรับเสื้อยืดคอกลม Polo ที่มีขนาดเล็กและสีเขียว คุณไม่จำเป็นต้องป้อนข้อมูลในฟิลด์ <strong>หมายเลขสินค้า</strong> <strong>สี</strong> และ <strong>ขนาด</strong> คุณสามารถสร้างรายการได้โดยทำตามขั้นตอนอย่างใดอย่างหนึ่งต่อไปนี้:
<ul>
...
-   Modern POS ของการขายปลีก และ POS ระบบคลาวด์จะสื่อสารกับเซิร์ฟเวอร์ระบบการขายปลีกในร้านค้าเสมอ
-   สนับสนุน Modern POS ของการขายปลีก และ POS ระบบคลาวด์ที่ไม่มีการเชื่อมต่อ HQ
-   สนับสนุนฐานข้อมูลออฟไลน์เฉพาะ Modern POS ของการขายปลีก (แยกต่างหากกับแต่ละอินสแตนซ์ของ Modern POS ของการขายปลีก) ที่ไม่มีการเชื่อมต่อ HQ
...
-   การเชื่อมต่อกับฐานข้อมูลโดยตรงของ Modern POS ของการขายปลีก กับฐานข้อมูลช่องทางไม่ได้รับการสนับสนุน
...
| ผู้ค้าปลีกดำเนินการ Modern POS ของการขายปลีก ในร้านค้าในสถานที่ และสามารถทำการดำเนินการแบบเรียลไทม์ต่างๆ เช่น ออกใช้บัตรของขวัญเมื่อมีการเชื่อมต่อ | ผู้ค้าปลีกสามารถดำเนินการแบบเรียลไทม์จากระบบร้านค้าเมื่อมีการเชื่อมต่อ                |
...
### <a name="universal-windows-platform-app-for-retail-modern-pos"></a>แอพแพลตฟอร์ม Universal Windows สำหรับ Modern POS ของการขายปลีก

ในปัจจุบัน Modern POS ของการขายปลีก จะพร้อมใช้งานเป็นแอพลิเคชัน Windows 8.1 สำหรับคอมพิวเตอร์เดสก์ท็อปและแท็บเล็ต และเป็นระบบคลาวด์ POS สำหรับเบราเซอร์เดสก์ท็อปหรือแท็บเล็ตเท่านั้น ในรุ่นนี้ Retail Moderns POS ถูกแปลงเป็นแอพแพลตฟอร์ม Universal Windows (UWP) การเปลี่ยนแปลงนี้จะเปิดใช้งาน Modern POS ของการขายปลีก เพื่อรันบนอุปกรณ์ Windows 10 (เดสก์ท็อป แท็บเล็ต หรือโทรศัพท์) และแม้แต่สลับระหว่างมุมมองต่างๆ สำหรับอุปกรณ์ที่เปิดใช้งาน Continuum
...
<tbody>
<tr class="odd">
<td>กำหนดตำแหน่งที่ควรเป็นแหล่งข้อมูลของความต้องการ และควรเป็นแหล่งข้อมูลอย่างไร ในรายการใบสั่งขายโดยตรง <strong>ตัวอย่าง</strong> สร้างรายการใบสั่งขาย และระบุการจัดส่งโดยตรงเป็นชนิดการจัดส่ง ผู้จัดจำหน่ายหลักถูกเพิ่มไปยังรายการใบสั่งขายเป็นจุดแหล่งที่มา</td>
...
<tr class="even">
<td>สร้างสัญญาใบสั่งโดยตรงจากรายการใบสั่งขาย <strong>ตัวอย่าง</strong> สร้างรายการใบสั่งขายที่เป็นต้นทางจากผู้จัดจำหน่ายระหว่างบริษัท ออกจากรายการ วันที่จัดส่งจะถูกคำนวณตามความพร้อมใช้งานในบริษัทจัดหา</td>
