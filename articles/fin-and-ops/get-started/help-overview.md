...
> [!IMPORTANT] 
> ข้อมูลที่คุณป้อนเมื่อคุณเล่นคู่มืองานเป็นจริง ถ้าคุณอยู่ในสภาพแวดล้อมการผลิต ข้อมูลจะถูกป้อนในบริษัทที่คุณกำลังใช้อยู่
...
-   **บันทึกการบันทึกงานไปยัง BPM** – คุณสามารถบันทึกการบันทึกงานของลำดับชั้นในไลบรารี BPM ใน LCS ได้ เมื่อคุณบันทึกการบันทึกงานไปยัง BPM ไดอะแกรมแผนผังลำดับงานจะถูกสร้างและแสดงร่วมกับขั้นตอนของการบันทึก 

    > [!Note]
    > เพื่อแสดงการบันทึกงานในบานหน้าต่างวิธีใช้ของ Finance and Operations และเล่นเป็นคู่มืองาน คุณต้องบันทึกไปยังไลบรารี BPM
...
จากบานหน้าต่าง วิธีใช้ คุณสามารถเข้าถึงบทความที่ใช้ไปยังไคลเอนต์ Finance and Operations ได้ เมื่อคุณเปิดบานหน้าต่างวิธีใช้ และคลิกแท็บ **วิธีใช้** เป็นครั้งแรก คุณจะเห็นบทความที่ใช้กับหน้าที่คุณกำลังอยู่ใน Finance and Operations ถ้าไม่พบบทความ คุณสามารถป้อนคำสำคัญเพื่อจำกัดการค้นหา เมื่อคุณคลิกบทความในบานหน้าต่าง วิธีใช้ เบราเซอร์ของคุณแท็บจะเปิดแท็บใหม่ และแสดงบทความนั้น 
...
| [Lifecycle Services](https://lcs.dynamics.com/en/)\*                      | มีพื้นที่ทำงานที่จัดเก็บบนระบบคลาวด์ที่ลูกค้าและคู่ค้าสามารถใช้เพื่อจัดการโครงการ Finance and Operations จากการขายล่วงหน้า เพื่อจะใช้งานและการดำเนินงาน ไซต์นี้มีประโยชน์ในขั้นตอนการใช้งานทั้งหมด |
...
| [Docs.microsoft.com/previous versions](https://docs.microsoft.com/en-us/previous-versions/dynamics/)                                             | เนื้อหาโฮสต์จากรุ่นก่อน                                                                                                                                                                       |
