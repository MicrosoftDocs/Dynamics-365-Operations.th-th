...
ms.locfileid: "1850986"
---
# <a name="axerd-page-has-been-retired"></a>มีการถอนหน้า AxErd

[!include [banner](../includes/banner.md)]

โชคไม่ดีที่เราต้องเลิกใช้เว็บเพจ AxErd ซึ่งให้ไดอะแกรมความสัมพันธ์ของเอนทิตี (ERDs) สำหรับตาราง Microsoft Dynamics AX 2012 หลายตาราง เราสามารถลงรายการบัญชีได้ทั้งโค้ดต้นฉบับสำหรับโครงการ และไฟล์ HTML สำหรับเว็บเพจใน repo GitHub: https://github.com/Microsoft/ax-2012-doc-tools
