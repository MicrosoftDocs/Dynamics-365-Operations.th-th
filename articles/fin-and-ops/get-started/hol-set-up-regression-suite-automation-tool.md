...
## <a name="configure-azure-devops"></a><span data-ttu-id="41088-123">ตั้งค่าคอนฟิก Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="41088-123">Configure Azure DevOps</span></span>
...
<span data-ttu-id="41088-173">สำหรับโครงการ LCS ของคุณ คุณสามารถใช้การดำเนินงานของลูกค้าที่มีอยู่ หรือโครงการคู่ค้า</span><span class="sxs-lookup"><span data-stu-id="41088-173">For your LCS project, you can use an existing customer implementation or partner project.</span></span>
...
9. <span data-ttu-id="41088-205">กล่องข้อความปรากฏขึ้น ซึ่งกล่าวว่า "คุณกำลังจะเปลี่ยนเส้นทางไปยังไซต์ภายนอกเพื่ออนุมัติให้ LCS เชื่อมต่อกับ Visual Studio Team Services ในนามของคุณ</span><span class="sxs-lookup"><span data-stu-id="41088-205">A message box appears that states, "You are about to be redirected to an eternal site to authorize LCS to connect to Visual Studio Team Services on your behalf.</span></span> <span data-ttu-id="41088-206">ดำเนินการหรือไม่?"</span><span class="sxs-lookup"><span data-stu-id="41088-206">Proceed?"</span></span> <span data-ttu-id="41088-207">เลือก **ใช่**</span><span class="sxs-lookup"><span data-stu-id="41088-207">Select **Yes**.</span></span>
...
8. <span data-ttu-id="41088-270">ถ้าคุณต้องการบันทึกการบันทึกงานเฉพาะที่ และจากนั้น อัปโหลดไปยัง BPM ผ่าน LCS ให้ทำตามขั้นตอนต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="41088-270">If you want to save the task recording locally and then upload it to BPM through LCS, follow these steps:</span></span>
    ...
    3. <span data-ttu-id="41088-275">ไปยังไลบรารี BPM ของ **RSAT** และเลือกกระบวนการทางธุรกิจที่จะบันทึกการบันทึกงาน</span><span class="sxs-lookup"><span data-stu-id="41088-275">Go to the **RSAT** BPM library, and select the business process to save the task recording against.</span></span>
...
## <a name="get-started-with-rsat"></a><span data-ttu-id="41088-352">เริ่มต้นใช้งาน RSAT</span><span class="sxs-lookup"><span data-stu-id="41088-352">Get started with RSAT</span></span>
...
3. <span data-ttu-id="41088-380">เลือกปุ่ม **การตั้งค่า** (สัญลักษณ์รูปเกียร์) ที่มุมขวาบน และจากนั้น ในกล่องโต้ตอบที่ปรากฏขึ้น ให้กรอกข้อมูลในฟิลด์ต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="41088-380">Select the **Settings** button (the gear symbol) in the upper-right corner, and then, in the dialog box that appears, fill in the following fields:</span></span>
    ...
    - <span data-ttu-id="41088-399">**รหัสประจำตัว** – ป้อนรหัสประจำตัวของใบรับรองการพิสูจน์ตัวจริง ดังที่อธิบายไว้ก่อนหน้านี้ในบทช่วยสอนนี้</span><span class="sxs-lookup"><span data-stu-id="41088-399">**Thumbprint** – Enter the thumbprint of the authentication certificate, as described earlier in this tutorial.</span></span>
    - <span data-ttu-id="41088-400">**ไดเรกทอรีการทำงาน** – ระบุตำแหน่งโฟลเดอร์สำหรับจัดเก็บไฟล์การทำงานอัตโนมัติของการทดสอบ เช่น ไฟล์ข้อมูลการทดสอบของ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-400">**Working directory** – Specify the folder location for storing test automation files, such as Excel test data files.</span></span> <span data-ttu-id="41088-401">ตัวอย่างเช่น ป้อน หรือเลือก **C:\\Temp\\RegressionTool**</span><span class="sxs-lookup"><span data-stu-id="41088-401">For example, enter or select **C:\\Temp\\RegressionTool**.</span></span>

        > [!NOTE]
        > <span data-ttu-id="41088-402">ถ้าชื่อของโฟลเดอร์มีช่องว่าง การดำเนินการจะล้มเหลวเนื่องจากไม่พบโฟลเดอร์</span><span class="sxs-lookup"><span data-stu-id="41088-402">If the name of the folder has spaces, execution will fail because the folder can't be found.</span></span> <span data-ttu-id="41088-403">ปัญหานี้เป็นปัญหาที่ทราบ และควรได้รับการแก้ไขในเครื่องมือรุ่นล่าสุด</span><span class="sxs-lookup"><span data-stu-id="41088-403">This issue is a known issue and should be fixed in the latest version of the tool.</span></span>

    - <span data-ttu-id="41088-404">**เบราเซอร์เริ่มต้น** – เลือก **Internet Explorer** หรือ **Google Chrome** อย่างใดอย่างหนึ่ง</span><span class="sxs-lookup"><span data-stu-id="41088-404">**Default browser** – Select either **Internet Explorer** or **Google Chrome**.</span></span> <span data-ttu-id="41088-405">ตรวจสอบให้แน่ใจว่าได้ติดตั้งไดรเวอร์ของเบราว์เซอร์ที่เหมาะสมแล้ว</span><span class="sxs-lookup"><span data-stu-id="41088-405">Make sure that the appropriate browser drivers have been installed.</span></span>
    - <span data-ttu-id="41088-406">**การหมดเวลาของการรันการทดสอบ** – ระบุรอบระยะเวลาการหมดเวลาเป็นนาทีสำหรับการรันการทดสอบ</span><span class="sxs-lookup"><span data-stu-id="41088-406">**Test run timeout** – Specify the time-out period, in minutes, for test runs.</span></span> <span data-ttu-id="41088-407">เมื่อรอบระยะเวลาของการหมดเวลาผ่านไป windows ที่ใช้งานอยู่ทั้งหมดจะถูกปิด และกรณีทดสอบที่ค้างอยู่จะล้มเหลว</span><span class="sxs-lookup"><span data-stu-id="41088-407">When the time-out period elapses, all active windows are closed, and pending test cases fail.</span></span>
    - <span data-ttu-id="41088-408">**การหมดเวลาของการดำเนินการทดสอบ** – ฟิลด์นี้จะควบคุมรอบระยะเวลาการหมดเวลาเป็นนาที สำหรับการร้องขอเซิร์ฟเวอร์ของสภาพแวดล้อม Finance and Operation</span><span class="sxs-lookup"><span data-stu-id="41088-408">**Test action timeout** – This field controls the time-out period, in minutes, for Finance and Operation environment server requests.</span></span> <span data-ttu-id="41088-409">โดยปกติแล้ว ค่าเริ่มต้น (2 นาที) ควรจะเพียงพอ</span><span class="sxs-lookup"><span data-stu-id="41088-409">Usually, the default value (2 minutes) should be enough.</span></span> <span data-ttu-id="41088-410">อย่างไรก็ตาม สำหรับสภาพแวดล้อมที่ช้าลง คุณอาจต้องการเพิ่มค่า ถ้าข้อผิดพลาดที่เกี่ยวข้องกับการหมดเวลาเกิดขึ้น</span><span class="sxs-lookup"><span data-stu-id="41088-410">However, for slower environments, you might want to increase the value if errors that are related to time-outs occur.</span></span>
    - <span data-ttu-id="41088-411">**ชื่อบริษัท** – ป้อนชื่อบริษัทที่จะใช้เป็นบริษัท Finance and Operations เริ่มต้นของคุณ เมื่อมีการสร้างไฟล์พารามิเตอร์ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-411">**Company name** – Enter the company name to use as your default Finance and Operations company when Excel parameter files are created.</span></span> <span data-ttu-id="41088-412">คุณสามารถเปลี่ยนบริษัทได้ในภายหลัง โดยแก้ไขไฟล์พารามิเตอร์ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-412">You can change the company later by editing the Excel parameter file.</span></span>

    ![กล่องโต้ตอบการตั้งค่า](./media/setup_rsa_tool_62.png)

4. <span data-ttu-id="41088-414">เลือก **นำไปใช้** เพื่อนำไปใช้และบันทึกการตั้งค่าของคุณ</span><span class="sxs-lookup"><span data-stu-id="41088-414">Select **Apply** to apply and save your settings.</span></span>

    <span data-ttu-id="41088-415">เมื่อต้องการบันทึกการตั้งค่าปัจจุบันของคุณลงในไฟล์การตั้งค่าคอนฟิกบนคอมพิวเตอร์ของคุณ ให้เลือก **บันทึกเป็น**</span><span class="sxs-lookup"><span data-stu-id="41088-415">To save your current settings to a configuration file on your computer, select **Save as**.</span></span> <span data-ttu-id="41088-416">เมื่อต้องการคืนค่าการตั้งค่าของคุณจากไฟล์การตั้งค่าคอนฟิกบนคอมพิวเตอร์ของคุณ ให้เลือก **เปิด**</span><span class="sxs-lookup"><span data-stu-id="41088-416">To restore your settings from a configuration file on your computer, select **Open**.</span></span>

5. <span data-ttu-id="41088-417">เลือก **ปิด** เพื่อปิดกล่องโต้ตอบ</span><span class="sxs-lookup"><span data-stu-id="41088-417">Select **Close** to close the dialog box.</span></span>

### <a name="load-and-run-test-cases"></a><span data-ttu-id="41088-418">โหลดและรันกรณีการทดสอบ</span><span class="sxs-lookup"><span data-stu-id="41088-418">Load and run test cases</span></span>

1. <span data-ttu-id="41088-419">เลือก **โหลด** เพื่อโหลดแผนการทดสอบ **แผนการทดสอบ RSAT** จากโครงการ Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="41088-419">Select **Load** to load the **RSAT Test Plan** test plan from the Azure DevOps project.</span></span>

    ![ปุ่มโหลด](./media/setup_rsa_tool_64.png)

2. <span data-ttu-id="41088-421">เลือกกรณีการทดสอบ **สร้างผลิตภัณฑ์ใหม่** จากชุดการทดสอบ แล้วเลือก **สร้าง \> สร้างไฟล์การดำเนินการทดสอบและไฟล์พารามิเตอร์**</span><span class="sxs-lookup"><span data-stu-id="41088-421">Select the **Create a new product** test case from the test suite, and then select **New \> Generate Test Execution and Parameter files**.</span></span>

    ![คำสั่งสร้างไฟล์การดำเนินการทดสอบและไฟล์พารามิเตอร์บนเมนูสร้าง](./media/setup_rsa_tool_65.png)

    <span data-ttu-id="41088-423">ไฟล์พารามิเตอร์ของ Excel ถูกสร้างขึ้นในโฟลเดอร์เฉพาะที่ที่คุณระบุไว้ในการตั้งค่าคอนฟิก RSAT (ตัวอย่างเช่น **C:\\Temp\\RegressionTool**)</span><span class="sxs-lookup"><span data-stu-id="41088-423">The Excel parameter file is created in the local folder that you specified in the RSAT configuration (for example, **C:\\Temp\\RegressionTool**).</span></span>

    ![ไฟล์พารามิเตอร์ Excel ถูกสร้างขึ้น](./media/setup_rsa_tool_66.png)

3. <span data-ttu-id="41088-425">ถ้าคุณต้องการบันทึกไฟล์พารามิเตอร์ ให้เลือก **อัปโหลด**</span><span class="sxs-lookup"><span data-stu-id="41088-425">If you want to save the parameter files, select **Upload**.</span></span> <span data-ttu-id="41088-426">ไฟล์การทดสอบระบบอัตโนมัติของกรณีการทดสอบที่เลือกทั้งหมดจะถูกอัปโหลดไปยัง Azure DevOps สำหรับการใช้งานในอนาคต</span><span class="sxs-lookup"><span data-stu-id="41088-426">Test automation files of all selected test cases are uploaded to Azure DevOps for future use.</span></span> <span data-ttu-id="41088-427">(ไฟล์เหล่านี้รวมถึงไฟล์พารามิเตอร์การทดสอบ Excel)</span><span class="sxs-lookup"><span data-stu-id="41088-427">(These files include Excel test parameter files.)</span></span>

    <span data-ttu-id="41088-428">ด้วยวิธีนี้ คุณสามารถเลือก **โหลด** เพื่อโหลดไฟล์พารามิเตอร์ (และไฟล์ระบบอัตโนมัติ) จากกรณีการทดสอบโดยตรงจาก Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="41088-428">In this way, you can select **Load** to load the parameter files (and automation files) from the test case directly from Azure DevOps.</span></span> <span data-ttu-id="41088-429">คุณไม่จำเป็นต้องสร้างไฟล์พารามิเตอร์ใหม่อีกครั้ง</span><span class="sxs-lookup"><span data-stu-id="41088-429">You don't have to regenerate the parameter files.</span></span> <span data-ttu-id="41088-430">วิธีการนี้จะกลายเป็นเรื่องสำคัญในภายหลัง เมื่อคุณต้องการรักษาการปรับเปลี่ยนในไฟล์พารามิเตอร์ และไม่ต้องการให้มีการเขียนทับ</span><span class="sxs-lookup"><span data-stu-id="41088-430">This approach will become important later, when you want to keep the modifications in the parameter file and don't want them to be overwritten.</span></span>

4. <span data-ttu-id="41088-431">เมื่อต้องการตรวจสอบว่ามีการบันทึกไฟล์ระบบอัตโนมัติและไฟล์พารามิเตอร์ไปยัง Azure DevOps ไปที่โครงการ Azure DevOps เลือก **บอร์ด \> รายการงาน** และเลือกกรณีการทดสอบ **สร้างผลิตภัณฑ์ใหม่**</span><span class="sxs-lookup"><span data-stu-id="41088-431">To verify that the automation files and parameter files are saved to Azure DevOps, go to the Azure DevOps project, select **Boards \> Work Items**, and select the **Create a new product** test case.</span></span> <span data-ttu-id="41088-432">บนแท็บ **เอกสารแนบ** คุณควรเห็นไฟล์สี่ไฟล์:</span><span class="sxs-lookup"><span data-stu-id="41088-432">On the **Attachments** tab, you should see four files:</span></span>

    - <span data-ttu-id="41088-433">ไฟล์ระบบอัตโนมัติ **.cs** – C\#</span><span class="sxs-lookup"><span data-stu-id="41088-433">**.cs** – C\# automation file</span></span>
    - <span data-ttu-id="41088-434">**.dll** – คอมไพล์ไฟล์ระบบอัตโนมัติเป็นแอสเซมบลี</span><span class="sxs-lookup"><span data-stu-id="41088-434">**.dll** – Compiled automation file as an assembly</span></span>
    - <span data-ttu-id="41088-435">**.xlsx** – ไฟล์พารามิเตอร์ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-435">**.xlsx** – Excel parameter file</span></span>
    - <span data-ttu-id="41088-436">**.xml** – การบันทึกไฟล์</span><span class="sxs-lookup"><span data-stu-id="41088-436">**.xml** – Recording file</span></span>

    ![ไฟล์บนแท็บเอกสารแนบ](./media/setup_rsa_tool_67.png)

5. <span data-ttu-id="41088-438">เลือกกรณีการทดสอบที่จะรัน แล้วเลือก **รัน**</span><span class="sxs-lookup"><span data-stu-id="41088-438">Select the test case to run, and then select **Run**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="41088-439">ก่อนที่คุณจะรันกรณีการทดสอบ ถ้าคุณกำลังใช้ Internet Explorer เป็นเบราว์เซอร์ ให้ตรวจสอบให้แน่ใจว่ามีการตั้งค่าความละเอียดเดสก์ทอปของคุณเป็น **100%** ที่ **การตั้งค่า Windows Display \> ขนาดและโครงร่าง**</span><span class="sxs-lookup"><span data-stu-id="41088-439">Before you run test cases, if you're using Internet Explorer as the browser, make sure that your desktop resolution is set to **100%** at **Windows Display settings \> Scale and layout**.</span></span> <span data-ttu-id="41088-440">หากคุณไม่สามารถเปลี่ยนการตั้งค่านี้บนเครื่องเสมือน (VM) ให้เปลี่ยนบนไคลเอนต์ (แล็ปท็อป) ที่คุณกำลังพยายามเข้าถึง VM</span><span class="sxs-lookup"><span data-stu-id="41088-440">If you can't change this setting on a virtual machine (VM), change it on the client (laptop) that you're trying to access the VM from.</span></span> <span data-ttu-id="41088-441">จากนั้น การตั้งค่าความละเอียดจะถูกสืบทอดมาจากการตั้งค่าการแสดงผล VM</span><span class="sxs-lookup"><span data-stu-id="41088-441">The resolution settings will then be inherited by the VM display settings.</span></span>

    ![ความละเอียดเดสก์ท็อปที่ถูกตั้งค่าเป็น 100%](./media/setup_rsa_tool_68.png)

6. <span data-ttu-id="41088-443">ถ้าไม่ได้ติดตั้งไดรเวอร์ของเบราว์เซอร์ไว้ในระบบ คุณจะได้รับข้อความแจ้งเตือนที่ระบุว่า "การดำเนินการนี้จำเป็นต้องมีไดรเวอร์ \<ชื่อเบราว์เซอร์\></span><span class="sxs-lookup"><span data-stu-id="41088-443">If the browser drivers aren't installed in the system, you receive a warning message that states, "This operation requires the \<browser name\> driver.</span></span> <span data-ttu-id="41088-444">คุณต้องการดาวน์โหลดและติดตั้งเดี๋ยวนี้โดยอัตโนมัติหรือไม่?"</span><span class="sxs-lookup"><span data-stu-id="41088-444">Do you want to automatically downloads and install it now?"</span></span> <span data-ttu-id="41088-445">เลือก **ใช่**</span><span class="sxs-lookup"><span data-stu-id="41088-445">Select **Yes**.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="41088-448">หากคุณใช้ Chrome เป็นเบราว์เซอร์ และได้รับข้อความแสดงข้อผิดพลาดที่แจ้งว่ารอบเวลาไม่ถูกสร้างได้เนื่องจากรุ่นของ Chrome ไม่ถูกต้อง ให้ดาวน์โหลดไดรเวอร์ Chrome ล่าสุดจาก <http://chromedriver.chromium.org/downloads> ไปยังโฟลเดอร์ **C:\\Program Files (x86)\\Regression Suite Automation Tool\\Common\\External\\Selenium**</span><span class="sxs-lookup"><span data-stu-id="41088-448">If you're using Chrome as the browser and receive an error message that states that the session wasn't created because the Chrome version isn't correct, download the latest Chrome driver from <http://chromedriver.chromium.org/downloads> to the **C:\\Program Files (x86)\\Regression Suite Automation Tool\\Common\\External\\Selenium** folder.</span></span>

    ![ข้อความแสดงข้อผิดพลาดสำหรับ Chrome](./media/setup_rsa_tool_71.png)

    <span data-ttu-id="41088-450">มีการรันกรณีการทดสอบ และมีการปรับปรุงฟิลด์ **ผลลัพธ์**</span><span class="sxs-lookup"><span data-stu-id="41088-450">The test case is run, and the **Result** field is updated.</span></span>

    ![ตัวบ่งชี้ความก้าวหน้า](./media/setup_rsa_tool_72.png)

    <span data-ttu-id="41088-452">ถ้าคุณได้ทำตามบทช่วยสอนนี้ตามที่มีการเขียน กรณีการทดสอบ **สร้างผลิตภัณฑ์ใหม่** จะล้มเหลว เนื่องจากการบันทึกงานสำหรับการสร้างผลิตภัณฑ์ที่บันทึกชื่อผลิตภัณฑ์เป็นค่าที่มีรหัสแบบตายตัว</span><span class="sxs-lookup"><span data-stu-id="41088-452">If you've followed this tutorial as it's written, the **Create a new product** test case will fail, because the task recording for creating a product saved the product name as a hard-coded value.</span></span> <span data-ttu-id="41088-453">ถ้าคุณรันกรณีทดสอบเดียวกันอีกครั้ง คุณควรได้รับข้อความแสดงข้อผิดพลาด เนื่องจากมีผลิตภัณฑ์อยู่แล้ว</span><span class="sxs-lookup"><span data-stu-id="41088-453">If you rerun the same test case, you should receive an error message, because the product already exists.</span></span>

    ![ฟิลด์ผลลัพธ์ที่ถูกตั้งค่าเป็น ล้มเหลว](./media/setup_rsa_tool_72.png)

### <a name="view-the-test-results"></a><span data-ttu-id="41088-455">ดูผลลัพธ์ของการทดสอบ</span><span class="sxs-lookup"><span data-stu-id="41088-455">View the test results</span></span>

1. <span data-ttu-id="41088-456">คลิกสองครั้งที่กรณีการทดสอบที่ล้มเหลว</span><span class="sxs-lookup"><span data-stu-id="41088-456">Double-click the failed test case.</span></span>

    <span data-ttu-id="41088-457">คุณได้รับข้อความแสดงข้อผิดพลาด</span><span class="sxs-lookup"><span data-stu-id="41088-457">You receive an error message.</span></span>

    ![ข้อความแสดงข้อผิดพลาด](./media/setup_rsa_tool_73.png)

2. <span data-ttu-id="41088-459">เลือก **รายละเอียด** เพื่อดูข้อความแสดงข้อผิดพลาดทั้งหมด</span><span class="sxs-lookup"><span data-stu-id="41088-459">Select **Details** to view the whole error message.</span></span>

    ![ข้อความแสดงข้อผิดพลาดทั้งหมด](./media/setup_rsa_tool_74.png)

3. <span data-ttu-id="41088-461">เมื่อต้องการดูรุ่นโดยละเอียดของข้อความแสดงข้อผิดพลาดใน Azure DevOps เลือก **เปิดใน Azure DevOps**</span><span class="sxs-lookup"><span data-stu-id="41088-461">To view a detailed version of the error message in Azure DevOps, select **Open in Azure DevOps**.</span></span> <span data-ttu-id="41088-462">ใน Azure DevOps คุณสามารถดูสถานะของกรณีการทดสอบและข้อความแสดงข้อผิดพลาดโดยละเอียด</span><span class="sxs-lookup"><span data-stu-id="41088-462">In Azure DevOps, you can view the status of the test case and the detailed error message.</span></span>

    ![ข้อความแสดงข้อผิดพลาดโดยละเอียดใน Azure DevOps](./media/setup_rsa_tool_75.png)

4. <span data-ttu-id="41088-464">เมื่อต้องการดูผลการทดสอบโดยตรงในโครงการ Azure DevOps ให้ไปที่ **แผนการทดสอบ \> แผนการทดสอบ \> การรัน**</span><span class="sxs-lookup"><span data-stu-id="41088-464">To view the test results directly in the Azure DevOps project, go to **Test Plans \> Test Plans \> Runs**.</span></span> <span data-ttu-id="41088-465">คลิกสองครั้งที่การรันการทดสอบที่คุณต้องการดูรายละเอียดเพิ่มเติม</span><span class="sxs-lookup"><span data-stu-id="41088-465">Double-click the test run that you want to see more details for.</span></span>

    ![รายการของการรันการทดสอบใน Azure DevOps](./media/setup_rsa_tool_76.png)

5. <span data-ttu-id="41088-467">แท็บ **รันสรุป** จะบ่งชี้ว่ากรณีการทดสอบล้มเหลว แต่ไม่ได้ระบุข้อความแสดงข้อผิดพลาดจริง</span><span class="sxs-lookup"><span data-stu-id="41088-467">The **Run summary** tab indicates that the test case failed, but it doesn't provide the actual error message.</span></span> <span data-ttu-id="41088-468">เมื่อต้องการดูข้อความแสดงข้อผิดพลาดโดยละเอียด ให้เลือกแท็บ **ผลการทดสอบ**</span><span class="sxs-lookup"><span data-stu-id="41088-468">To view the detailed error message, select the **Test results** tab.</span></span>

    ![แท็บรันสรุป](./media/setup_rsa_tool_77.png)

    <span data-ttu-id="41088-470">แท็บ **ผลการทดสอบ** จะให้ข้อมูลกรณีการทดสอบ พร้อมกับผลลัพธ์และข้อความแสดงข้อผิดพลาด</span><span class="sxs-lookup"><span data-stu-id="41088-470">The **Test results** tab provides the test case information, together with the outcome and the error message.</span></span>

    ![แท็บผลการทดสอบ](./media/setup_rsa_tool_78.png)

6. <span data-ttu-id="41088-472">คลิกสองครั้งที่เรกคอร์ดที่เกี่ยวข้องเพื่อดูข้อความแสดงข้อผิดพลาดโดยละเอียด</span><span class="sxs-lookup"><span data-stu-id="41088-472">Double-click the relevant record to view the detailed error message.</span></span>

    ![ข้อความแสดงข้อผิดพลาดโดยละเอียด](./media/setup_rsa_tool_79.png)

    > [!NOTE]
    > <span data-ttu-id="41088-474">นอกจากนี้ ข้อความแสดงข้อผิดพลาดทั้งหมดยังพร้อมใช้งานเฉพาะที่ใน **C:\\Users\\\$YourUserName\\AppData\\Roaming\\regressionTool\\errormsg-.txt**</span><span class="sxs-lookup"><span data-stu-id="41088-474">All error messages are also available locally in **C:\\Users\\\$YourUserName\\AppData\\Roaming\\regressionTool\\errormsg-.txt**.</span></span>

7. <span data-ttu-id="41088-475">นอกจากนี้ คุณยังสามารถส่งออกผลการรันการทดสอบจากระดับแผนทดสอบได้ ด้วยการเลือก **ส่งออก**</span><span class="sxs-lookup"><span data-stu-id="41088-475">You can also export the test run results from the test plan level by selecting **Export**.</span></span>

    ![การส่งออกแผนการทดสอบ](./media/setup_rsa_tool_80.png)

### <a name="modify-the-excel-parameter-file"></a><span data-ttu-id="41088-477">ปรับเปลี่ยนไฟล์พารามิเตอร์ของ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-477">Modify the Excel parameter file</span></span>

1. <span data-ttu-id="41088-478">เปิด RSAT</span><span class="sxs-lookup"><span data-stu-id="41088-478">Open RSAT.</span></span>
2. <span data-ttu-id="41088-479">เลือกกล่องการทดสอบ แล้วจากนั้น เลือก **แก้ไข** เพื่อเปิดไฟล์พารามิเตอร์ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-479">Select the test case, and then select **Edit** to open the Excel parameter file.</span></span>

    <span data-ttu-id="41088-480">บนแผ่นงาน **EcoResProductCreate** โปรดทราบว่าค่าของฟิลด์ **หมายเลขผลิตภัณฑ์** มีรหัสแบบตายตัว</span><span class="sxs-lookup"><span data-stu-id="41088-480">On the **EcoResProductCreate** sheet, notice that the value of the **Product number** field is hard-coded.</span></span> <span data-ttu-id="41088-481">คุณต้องปรับปรุงฟิลด์นี้เป็นหมายเลขผลิตภัณฑ์ใหม่ ก่อนที่คุณจะรันกรณีการทดสอบอีกครั้ง</span><span class="sxs-lookup"><span data-stu-id="41088-481">You must update this field to a new product number before you run the test case again.</span></span>

3. <span data-ttu-id="41088-482">เมื่อต้องการสร้างหมายเลขผลิตภัณฑ์ที่ไม่ซ้ำกันสำหรับการรันแต่ละครั้งโดยไม่ต้องเปิดไฟล์พารามิเตอร์ Excel อีกครั้ง และปรับปรุงหมายเลขผลิตภัณฑ์ด้วยตนเองทุกครั้ง ใช้สูตรของ Excel ต่อไปนี้</span><span class="sxs-lookup"><span data-stu-id="41088-482">To generate a unique product number for each run without having to reopen the Excel parameter file and manually update the product number every time, use the following Excel formula.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="41088-483">นอกจากแท็บ **ทั่วไป** ไฟล์พารามิเตอร์ของ Excel จะมีแท็บข้อมูลสำหรับหน้าแบบฟอร์ม Finance and Operations ทั้งหมดที่กรณีการทดสอบเยี่ยมชม</span><span class="sxs-lookup"><span data-stu-id="41088-483">In addition to the **General** tab, the Excel parameter file contains a data tab for every Finance and Operations form page the test case visits.</span></span>

    ![ฟิลด์หมายเลขผลิตภัณฑ์](./media/setup_rsa_tool_81.png)

4. <span data-ttu-id="41088-485">เลือก **บันทึก** และจากนั้น ปิดสมุดงาน Excel</span><span class="sxs-lookup"><span data-stu-id="41088-485">Select **Save**, and then close the Excel workbook.</span></span>
5. <span data-ttu-id="41088-486">เลือก **อัปโหลด** เพื่อบันทึกไฟล์พารามิเตอร์ของ Excel ไปยัง Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="41088-486">Select **Upload** to save the Excel parameter file to Azure DevOps.</span></span>

    ![ข้อความการอัปโหลดสำเร็จ](./media/setup_rsa_tool_82.png)

    > [!NOTE]
    > <span data-ttu-id="41088-488">เมื่อต้องการรันกรณีการทดสอบในบริบทของผู้ใช้ที่ระบุ ให้ป้อนรหัสอีเมลของผู้ใช้ในฟิลด์ **ผู้ใช้การทดสอบ** บนแท็บ **ทั่วไป** ของไฟล์พารามิเตอร์ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-488">To run test cases in a specific user context, enter the user's email ID in the **Test User** field on the **General** tab of the Excel parameter file.</span></span> <span data-ttu-id="41088-489">ในรุ่นล่าสุดของ RSAT จะมีการปรับปรุงโครงร่างของฟิลด์ในไฟล์พารามิเตอร์ของ Excel แต่แนวคิดยังคงอยู่เหมือนเดิม</span><span class="sxs-lookup"><span data-stu-id="41088-489">In the latest version of RSAT, the layout of the fields in the Excel parameter file has been updated, but the concept remains the same.</span></span>
    >
    > ![ฟิลด์ผู้ใช้การทดสอบ](./media/setup_rsa_tool_83.png)

### <a name="validate-the-results"></a><span data-ttu-id="41088-491">ตรวจสอบความถูกต้องของผลลัพธ์</span><span class="sxs-lookup"><span data-stu-id="41088-491">Validate the results</span></span>

- <span data-ttu-id="41088-492">เลือก **รัน** เพื่อรันกรณีการทดสอบอีกครั้ง และตรวจสอบว่ากรณีการทดสอบผ่าน</span><span class="sxs-lookup"><span data-stu-id="41088-492">Select **Run** to rerun the test case, and verify that the test case has passed.</span></span> <span data-ttu-id="41088-493">คุณสามารถดูผลการทดสอบตามที่อธิบายไว้ในส่วน [ดูผลการทดสอบ](#view-the-test-results)</span><span class="sxs-lookup"><span data-stu-id="41088-493">You can view the test results as described in the [View the test results](#view-the-test-results) section.</span></span>

    ![ฟิลด์ผลลัพธ์ที่ถูกตั้งค่าเป็น ผ่าน](./media/setup_rsa_tool_84.png)

### <a name="chaining-of-test-cases"></a><span data-ttu-id="41088-495">กลุ่มของกรณีการทดสอบ</span><span class="sxs-lookup"><span data-stu-id="41088-495">Chaining of test cases</span></span>

<span data-ttu-id="41088-496">คุณลักษณะที่สำคัญอย่างหนึ่งของ RSAT คือการเชื่อมโยงของกรณีการทดสอบ (นั่นคือ ความสามารถของการทดสอบเพื่อส่งผ่านค่าไปยังการทดสอบอื่นๆ)</span><span class="sxs-lookup"><span data-stu-id="41088-496">One key feature of RSAT is the chaining of test cases (that is, the capability of a test to pass values to other tests).</span></span> <span data-ttu-id="41088-497">กรณีการทดสอบจะรันตามลำดับที่กำหนดในแผนการทดสอบ Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="41088-497">Test cases are run according to their defined order in the Azure DevOps test plan.</span></span> <span data-ttu-id="41088-498">(ลำดับนี้ยังสามารถถูกปรับปรุงได้ในเครื่องมือการทดสอบเอง) ดังนั้น ถ้าคุณต้องการส่งผ่านตัวแปรจากกรณีการทดสอบหนึ่งไปยังอีกกรณีหนึ่ง อาจเป็นเรื่องสำคัญมากที่การทดสอบจะต้องอยู่ในลำดับที่ถูกต้อง</span><span class="sxs-lookup"><span data-stu-id="41088-498">(This order can also be updated in the test tool itself.) Therefore, if you want to pass variables from one test case to another, it's very important that the tests be in the correct order.</span></span>

<span data-ttu-id="41088-499">ในส่วนนี้ คุณจะสร้างตัวแปรที่บันทึกไว้ในกรณีการทดสอบครั้งแรก สร้างกรณีการทดสอบที่สอง และส่งผ่านตัวแปรที่บันทึกไว้จากกรณีการทดสอบครั้งแรกไปยังกรณีการทดสอบครั้งที่สอง</span><span class="sxs-lookup"><span data-stu-id="41088-499">In this section, you will create a saved variable in the first test case, create a second test case, and pass the saved variable from the first test case to the second test case.</span></span> <span data-ttu-id="41088-500">จากนั้น คุณจะสามารถรันกรณีการทดสอบเป็นกรณีการทดสอบที่เชื่อมโยงได้ใน RSAT</span><span class="sxs-lookup"><span data-stu-id="41088-500">You will then run the test cases as a chained test case in RSAT.</span></span>

#### <a name="modify-an-existing-task-recording-to-create-a-saved-variable"></a><span data-ttu-id="41088-501">แก้ไขการบันทึกงานที่มีอยู่ เมื่อต้องการสร้างตัวแปรที่บันทึกไว้</span><span class="sxs-lookup"><span data-stu-id="41088-501">Modify an existing task recording to create a saved variable</span></span>

1. <span data-ttu-id="41088-502">เปิดไคลเอนต์ Finance and Operations</span><span class="sxs-lookup"><span data-stu-id="41088-502">Open the Finance and Operations client.</span></span>
2. <span data-ttu-id="41088-503">เลือกปุ่ม **การตั้งค่า** (สัญลักษณ์เกียร์) แล้วจากนั้น เลือก **ตัวบันทึกงาน**</span><span class="sxs-lookup"><span data-stu-id="41088-503">Select the **Settings** button (the gear symbol), and then select **Task recorder**.</span></span>
3. <span data-ttu-id="41088-504">เลือก **แก้ไขการบันทึก**</span><span class="sxs-lookup"><span data-stu-id="41088-504">Select **Edit Recording**.</span></span>

    ![ปุ่มแก้ไขการบันทึก](./media/setup_rsa_tool_85.png)

4. <span data-ttu-id="41088-506">เลือก **เปิดจาก Lifecycle Services**</span><span class="sxs-lookup"><span data-stu-id="41088-506">Select **Open from Lifecycle Services**.</span></span>

    ![ปุ่มเปิดจาก Lifecycle Services](./media/setup_rsa_tool_86.png)

5. <span data-ttu-id="41088-508">เลือก **เลือกไลบรารี Lifecycle Services**</span><span class="sxs-lookup"><span data-stu-id="41088-508">Select **Select the Lifecycle Services library**.</span></span>

    ![เลือกปุ่มไลบรารี Lifecycle Services](./media/setup_rsa_tool_87.png)

    <span data-ttu-id="41088-510">ไลบรารี BPM ถูกโหลดจาก LCS</span><span class="sxs-lookup"><span data-stu-id="41088-510">BPM libraries are loaded from LCS.</span></span>

    ![ตัวบ่งชี้ความก้าวหน้า](./media/setup_rsa_tool_88.png)

6. <span data-ttu-id="41088-512">หลังจากที่มีการโหลดไลบรารี BPM จาก LCS ให้เลือกไลบรารี BPM ของ **RSAT** และกระบวนการทางธุรกิจ **สร้างผลิตภัณฑ์ใหม่** ที่มีการเชื่อมโยงกับการบันทึกงาน</span><span class="sxs-lookup"><span data-stu-id="41088-512">After the BPM libraries are loaded from LCS, select the **RSAT** BPM library and the **Create a new product** business process that the task recording was associated with.</span></span> <span data-ttu-id="41088-513">จากนั้น เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="41088-513">Then select **OK**.</span></span>

    ![การเลือกไลบรารี BPM และกระบวนการทางธุรกิจ](./media/setup_rsa_tool_89.png)

7. <span data-ttu-id="41088-515">ชื่อของการบันทึกงานที่เหมาะสมถูกป้อนในฟิลด์ **ชื่อของการบันทึก**</span><span class="sxs-lookup"><span data-stu-id="41088-515">The name of the appropriate task recording is entered in the **Recording name** field.</span></span> <span data-ttu-id="41088-516">เลือก **เริ่มต้น**</span><span class="sxs-lookup"><span data-stu-id="41088-516">Select **Start**.</span></span>

    ![ชื่อของการบันทึกงานในฟิลด์ชื่อของการบันทึก](./media/setup_rsa_tool_90.png)

8. <span data-ttu-id="41088-518">ไปที่ **การจัดการข้อมูลผลิตภัณฑ์ \> ผลิตภัณฑ์** และเลือก **สร้าง** เพื่อเปิดหน้าที่การบันทึกงานดั้งเดิม **สร้างผลิตภัณฑ์** ถูกบันทึก</span><span class="sxs-lookup"><span data-stu-id="41088-518">Go to **Product information management \> Products**, and select **New** to open the page where the original task recording, **Create a product**, was recorded.</span></span>
9. <span data-ttu-id="41088-519">เลือก **ขั้นตอนการแทรก**</span><span class="sxs-lookup"><span data-stu-id="41088-519">Select **Insert step**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="41088-520">จะมีการแทรกขั้นตอนใหม่ **หลังจาก** ขั้นตอนที่คุณเลือกไว้ในบานหน้าต่าง</span><span class="sxs-lookup"><span data-stu-id="41088-520">The new step is inserted **after** the step that you selected in the pane.</span></span>

    ![ปุ่มแทรกขั้นตอน](./media/setup_rsa_tool_91.png)

10. <span data-ttu-id="41088-522">คลิกขวาที่ฟิลด์ **หมายเลขผลิตภัณฑ์** แล้วเลือก **ตัวบันทึกงาน \> คัดลอก**</span><span class="sxs-lookup"><span data-stu-id="41088-522">Right-click the **Product number** field, and then select **Task recorder \> Copy**.</span></span>

    ![คัดลอกคำสั่ง](./media/setup_rsa_tool_92.png)

11. <span data-ttu-id="41088-524">มีการเพิ่มขั้นตอนใหม่ในบานหน้าต่าง</span><span class="sxs-lookup"><span data-stu-id="41088-524">A new step is added in the pane.</span></span> <span data-ttu-id="41088-525">จัดทำบันทึกของค่าในฟิลด์ **หมายเลขผลิตภัณฑ์** เนื่องจากคุณจะต้องใช้ในภายหลัง</span><span class="sxs-lookup"><span data-stu-id="41088-525">Make a note of the value in the **Product number** field, because you will need it later.</span></span>

    ![เพิ่มขั้นตอนใหม่แล้ว](./media/setup_rsa_tool_93.png)

12. <span data-ttu-id="41088-527">เลือก **ทำการแก้ไขเสร็จสิ้นแล้ว**</span><span class="sxs-lookup"><span data-stu-id="41088-527">Select **Done editing**.</span></span>
13. <span data-ttu-id="41088-528">เลือก **บันทึกไปยัง Lifecycle Services** และเชื่อมโยงการบันทึกงานใหม่กับไลบรารี BPM เดียวกัน และกระบวนการทางธุรกิจที่เกี่ยวข้องกับการบันทึกงานดั้งเดิม</span><span class="sxs-lookup"><span data-stu-id="41088-528">Select **Save to Lifecycle Services**, and associate the new task recording with the same BPM library and business process that the original task recording was associated with.</span></span> <span data-ttu-id="41088-529">สำหรับข้อมูลเพิ่มเติม ดูส่วน [สร้างการบันทึกงาน และบันทึกไปยังไลบรารี BPM](#create-a-task-recording-and-save-it-to-the-bpm-library)</span><span class="sxs-lookup"><span data-stu-id="41088-529">For more information, see the [Create a task recording and save it to the BPM library](#create-a-task-recording-and-save-it-to-the-bpm-library) section.</span></span>
14. <span data-ttu-id="41088-530">ไปยังไลบรารี BPM และเลือก **ซิงค์กรณีการทดสอบ** เพื่อเขียนทับการบันทึกงานที่แนบอยู่กับกรณีการทดสอบใน Azure DevOps ตามที่อธิบายไว้ในส่วน [ทดสอบการซิงโครไนส์จาก BPM ไปยัง Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops)</span><span class="sxs-lookup"><span data-stu-id="41088-530">Go to the BPM library, and select **Sync testcases** to overwrite the task recording that is attached to the test case in Azure DevOps, as described in the [Test the synchronization from BPM to Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops) section.</span></span>
15. <span data-ttu-id="41088-531">เปิด RSAT และเลือก **โหลด** เพื่อโหลดกรณีการทดสอบทั้งหมดในชุดทดสอบอีกครั้ง</span><span class="sxs-lookup"><span data-stu-id="41088-531">Open RSAT, and select **Load** to reload all the test cases in the test suite.</span></span> <span data-ttu-id="41088-532">คุณต้องสร้างไฟล์ระบบอัตโนมัติและไฟล์พารามิเตอร์อีกครั้งสำหรับกรณีการทดสอบที่เหมาะสม โดยเลือกกรณีการทดสอบ และจากนั้น เลือก **สร้าง \> สร้างไฟล์การดำเนินการและและไฟล์พารามิเตอร์** ตามที่อธิบายไว้ในส่วน [โหลดและรันกรณีการทดสอบ](#load-and-run-test-cases)</span><span class="sxs-lookup"><span data-stu-id="41088-532">You must regenerate the automation and parameter files for the appropriate test case by selecting the test case and then selecting **New \> Generate Test Execution and Parameter files**, as described in the [Load and run test cases](#load-and-run-test-cases) section.</span></span>

    > [!NOTE]
    > <span data-ttu-id="41088-533">ถ้าไฟล์พารามิเตอร์ Excel ถูกเปิดค้างไว้ การสร้างใหม่จะล้มเหลว</span><span class="sxs-lookup"><span data-stu-id="41088-533">If the Excel parameter file was left open, regeneration will fail.</span></span> <span data-ttu-id="41088-534">ดังนั้น โปรดตรวจสอบให้แน่ใจว่ามีการปิดไฟล์พารามิเตอร์ Excel สำหรับกรณีการทดสอบ ก่อนที่คุณจะสร้างไฟล์พารามิเตอร์ Excel ใหม่</span><span class="sxs-lookup"><span data-stu-id="41088-534">Therefore, make sure that the Excel parameter file for the test case is closed before you generate the new Excel parameter file.</span></span>

16. <span data-ttu-id="41088-535">เลือก **แก้ไข** เพื่อเปิดไฟล์พารามิเตอร์ Excel ใหม่</span><span class="sxs-lookup"><span data-stu-id="41088-535">Select **Edit** to open the new Excel parameter file.</span></span> <span data-ttu-id="41088-536">คุณจะเห็นรายการ **ตัวแปรที่บันทึกไว้** ใหม่บนบรรทัดที่ 9</span><span class="sxs-lookup"><span data-stu-id="41088-536">You will see a new **Saved variable** entry on line 9.</span></span> <span data-ttu-id="41088-537">ตัวแปรนี้ **{{EcoResProductCreate\_รหัสประจำตัว\_ProductNumber\_คัดลอก}}** ถูกบันทึกไว้ในไฟล์ XML ของการบันทึกงาน และสามารถใช้ในการทดสอบในเวลาต่อมา</span><span class="sxs-lookup"><span data-stu-id="41088-537">This variable, **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}**, is saved in the task recording's XML file and can be used in subsequent tests.</span></span>

    ![รายการตัวแปรที่บันทึกไว้](./media/setup_rsa_tool_94.png)

#### <a name="create-a-new-test-case"></a><span data-ttu-id="41088-539">สร้างกรณีการทดสอบใหม่</span><span class="sxs-lookup"><span data-stu-id="41088-539">Create a new test case</span></span>

1. <span data-ttu-id="41088-540">ไปที่ไลบรารี BPM ของ **RSAT**</span><span class="sxs-lookup"><span data-stu-id="41088-540">Go to the **RSAT** BPM library.</span></span>
2. <span data-ttu-id="41088-541">เลือกกระบวนการ **กระบวนการทางธุรกิจที่สนับสนุนของตัวอย่าง** และจากนั้น ทางด้านขวา ให้เลือก **โหมดแก้ไข**</span><span class="sxs-lookup"><span data-stu-id="41088-541">Select the **Sample Support Business Process** process, and then, on the right, select **Edit mode**.</span></span>
3. <span data-ttu-id="41088-542">เปลี่ยนค่าของทั้งฟิลด์ **ชื่อ** และฟิลด์ **คำอธิบาย** เพื่อ **นำผลิตภัณฑ์ออกใช้**</span><span class="sxs-lookup"><span data-stu-id="41088-542">Change the value of both the **Name** field and the **Description** field to **Release a product**.</span></span> <span data-ttu-id="41088-543">จากนั้น เลือก **บันทึก**</span><span class="sxs-lookup"><span data-stu-id="41088-543">Then select **Save**.</span></span>

    ![ชื่อและคำอธิบายที่เปลี่ยนไปเพื่อนำผลิตภัณฑ์ออกใช้](./media/setup_rsa_tool_95.png)

#### <a name="create-a-new-task-recording-that-has-a-validate-function"></a><span data-ttu-id="41088-545">สร้างการบันทึกงานใหม่ที่มีฟังก์ชันการตรวจสอบความถูกต้อง</span><span class="sxs-lookup"><span data-stu-id="41088-545">Create a new task recording that has a Validate function</span></span>

- <span data-ttu-id="41088-546">สร้างการบันทึกงานเพื่อนำผลิตภัณฑ์ที่สร้างไว้ก่อนหน้านี้ออกใช้ไปยังนิติบุคคล USRT</span><span class="sxs-lookup"><span data-stu-id="41088-546">Create a task recording to release the product that was created earlier to the USRT legal entity.</span></span> <span data-ttu-id="41088-547">สำหรับข้อมูลเพิ่มเติม ดูส่วน [สร้างการบันทึกงาน และบันทึกไปยังไลบรารี BPM](#create-a-task-recording-and-save-it-to-the-bpm-library)</span><span class="sxs-lookup"><span data-stu-id="41088-547">For more information, see the [Create a task recording and save it to the BPM library](#create-a-task-recording-and-save-it-to-the-bpm-library) section.</span></span>

    > [!NOTE]
    > <span data-ttu-id="41088-548">สำหรับกรณีการทดสอบที่เชื่อมโยง เราขอแนะนำให้คุณค้นหาหรือกรองข้อมูลสำหรับเรกคอร์ดที่คุณต้องการด้วย *การพิมพ์ค่าของฟิลด์ด้วยตนเอง*</span><span class="sxs-lookup"><span data-stu-id="41088-548">For chained test cases, we always recommend that you find or filter for the record that you require by *manually typing the value of the field*.</span></span> <span data-ttu-id="41088-549">ในลักษณะนี้ เครื่องมือนี้จะสามารถกำหนดว่าจะมีการดำเนินการกับเรกคอร์ดที่ต้องใช้ในกรณีการทดสอบในเวลาต่อมา</span><span class="sxs-lookup"><span data-stu-id="41088-549">In that way, the tool can determine the record that the action must be taken against in the subsequent test case.</span></span>

    ![การบันทึกงานใหม่ที่มีฟังก์ชันการตรวจสอบความถูกต้อง](./media/setup_rsa_tool_96.png)

    <span data-ttu-id="41088-551">เมื่อภาพประกอบก่อนหน้านี้แสดงขึ้น หลังจากที่พบผลิตภัณฑ์โดยใช้ตัวกรองด่วน แต่ก่อนที่คุณจะเลือก **นำผลิตภัณฑ์ออกใช้** คุณจะตรวจสอบความถูกต้องของค่าของฟิลด์ **หมายเลขผลิตภัณฑ์** เพื่อให้แน่ใจว่ารหัสผลิตภัณฑ์เป็นรหัสผลิตภัณฑ์ที่สร้างไว้ก่อนหน้านี้</span><span class="sxs-lookup"><span data-stu-id="41088-551">As the preceding illustration shows, after the product is found by using the Quick Filter, but before you select **Release products**, you validate the value of the **Product number** field to make sure that the product ID is the product ID that was created earlier.</span></span> <span data-ttu-id="41088-552">เมื่อต้องการตรวจสอบความถูกต้องของค่า คลิกขวาที่ฟิลด์ **หมายเลขผลิตภัณฑ์** และจากนั้น เลือก **ตัวบันทึกงาน \> ตรวจสอบความถูกต้อง \> ค่าปัจจุบัน**</span><span class="sxs-lookup"><span data-stu-id="41088-552">To validate the value, right-click the **Product number** field, and then select **Task recorder \> Validate \> Current Value**.</span></span>

    ![การตรวจสอบความถูกต้องของค่าปัจจุบัน](./media/setup_rsa_tool_97.png)

#### <a name="save-the-task-recording-to-bpm"></a><span data-ttu-id="41088-554">บันทึกการบันทึกงานไปยัง BPM</span><span class="sxs-lookup"><span data-stu-id="41088-554">Save the task recording to BPM</span></span>

1. <span data-ttu-id="41088-555">หลังจากเสร็จสิ้นการบันทึกงาน เลือก **บันทึกไปยัง Lifecycle Services**</span><span class="sxs-lookup"><span data-stu-id="41088-555">After the task recording is completed, select **Save to Lifecycle Services**.</span></span>

    ![ตัวเลือกบันทึก](./media/setup_rsa_tool_98.png)

2. <span data-ttu-id="41088-557">ข้อมูลไลบรารีถูกโหลดจาก LCS</span><span class="sxs-lookup"><span data-stu-id="41088-557">Library information is loaded from LCS.</span></span>

    ![ตัวบ่งชี้ความก้าวหน้า](./media/setup_rsa_tool_99.png)

3. <span data-ttu-id="41088-559">เลือกไลบรารี BPM เพื่อเชื่อมโยงกับการบันทึกงาน</span><span class="sxs-lookup"><span data-stu-id="41088-559">Select the BPM library to associate the task recording with.</span></span> <span data-ttu-id="41088-560">สำหรับบทช่วยสอนนี้ ให้เลือกไลบรารี BPM ของ **RSAT** ที่สร้างไว้ก่อนหน้านี้ และ **นำผลิตภัณฑ์ออกใช้** ที่กระบวนการทางธุรกิจอยู่ภายใต้</span><span class="sxs-lookup"><span data-stu-id="41088-560">For this tutorial, select the **RSAT** BPM library that was created earlier and the **Release a product** business process under it.</span></span> <span data-ttu-id="41088-561">จากนั้น เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="41088-561">Then select **OK**.</span></span>

#### <a name="sync-bpm-to-azure-devops"></a><span data-ttu-id="41088-562">ซิงค์ BPM กับ Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="41088-562">Sync BPM to Azure DevOps</span></span>

1. <span data-ttu-id="41088-563">ไปยังไลบรารี BPM และเปิดไลบรารี **RSAT**</span><span class="sxs-lookup"><span data-stu-id="41088-563">Go to the BPM library, and open the **RSAT** library.</span></span>
2. <span data-ttu-id="41088-564">เลือก **ซิงค์ VSTS** แล้วจากนั้น **ซิงค์กรณีการทดสอบ**</span><span class="sxs-lookup"><span data-stu-id="41088-564">Select **VSTS sync** and then **Sync test cases**.</span></span> <span data-ttu-id="41088-565">สำหรับข้อมูลเพิ่มเติม ดูส่วน [ทดสอบการซิงโครไนส์จาก BPM ไปยัง Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops)</span><span class="sxs-lookup"><span data-stu-id="41088-565">For more information, see the [Test the synchronization from BPM to Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops) section.</span></span>

    <span data-ttu-id="41088-566">หลังจากการซิงโครไนส์เสร็จสมบูรณ์แล้ว รายการงานใหม่และกรณีการทดสอบที่เกี่ยวข้องสำหรับกระบวนการทางธุรกิจ **นำผลิตภัณฑ์ออกใช้** ใน Azure DevOps ที่ **บอร์ด \> รายการงาน**</span><span class="sxs-lookup"><span data-stu-id="41088-566">After the synchronization is completed, the new work item and the corresponding test case for the **Release a product** business process appear in Azure DevOps at **Boards \> Work Items**.</span></span>

#### <a name="add-the-new-test-case-to-the-existing-test-suite"></a><span data-ttu-id="41088-567">เพิ่มกรณีการทดสอบใหม่ไปยังชุดการทดสอบที่มีอยู่</span><span class="sxs-lookup"><span data-stu-id="41088-567">Add the new test case to the existing test suite</span></span>

1. <span data-ttu-id="41088-568">ไปที่ **แผนการทดสอบ \> แผนการทดสอบ** และเลือกแผน **แผนการทดสอบ RSAT**</span><span class="sxs-lookup"><span data-stu-id="41088-568">Go to **Test plans \> Test plans**, and select the **RSAT Test Plan** plan.</span></span>
2. <span data-ttu-id="41088-569">เลือก **เพิ่มรายการที่มีอยู่**</span><span class="sxs-lookup"><span data-stu-id="41088-569">Select **Add existing**.</span></span>
3. <span data-ttu-id="41088-570">ในหน้า **เพิ่มกรณีการทดสอบไปยังชุด** ให้เลือก **รันการสอบถาม**</span><span class="sxs-lookup"><span data-stu-id="41088-570">On the **Add test cases to suite** page, select **Run query**.</span></span>
4. <span data-ttu-id="41088-571">เลือกกรณีการทดสอบใหม่ที่สร้างขึ้นสำหรับ **นำผลิตภัณฑ์ออกใช้** แล้วจากนั้น เลือก **เพิ่มกรณีการทดสอบ** ที่มุมล่างด้านล่างขวาของหน้า (ปุ่มนี้จะไม่แสดงในภาพประกอบต่อไปนี้)</span><span class="sxs-lookup"><span data-stu-id="41088-571">Select the new test case that was created for **Release a product**, and then select **Add test cases** in the lower-right corner of the page (this button isn't shown in the following illustration).</span></span>

    ![หน้าเพิ่มกรณีการทดสอบไปยังชุด](./media/setup_rsa_tool_100.png)

    <span data-ttu-id="41088-573">ตอนนี้ชุดการทดสอบมีกรณีการทดสอบสองกรณี</span><span class="sxs-lookup"><span data-stu-id="41088-573">The test suite now has two test cases.</span></span>

    ![กรณีการทดสอบสองกรณีในชุดการทดสอบ](./media/setup_rsa_tool_101.png)

#### <a name="load-test-cases-into-rsat"></a><span data-ttu-id="41088-575">โหลดกรณีการทดสอบลงใน RSAT</span><span class="sxs-lookup"><span data-stu-id="41088-575">Load test cases into RSAT</span></span>

1. <span data-ttu-id="41088-576">เปิด RSAT แล้วเลือก **โหลด**</span><span class="sxs-lookup"><span data-stu-id="41088-576">Open RSAT, and select **Load**.</span></span>
2. <span data-ttu-id="41088-577">มีการโหลดกรณีการทดสอบ และคุณได้รับคำเตือนที่ระบุว่า "การดำเนินการนี้จะเขียนทับไฟล์ข้อมูลการทดสอบของ Excel การเปลี่ยนแปลงเฉพาะที่จะสูญหายไป</span><span class="sxs-lookup"><span data-stu-id="41088-577">The test cases are loaded, and you receive a warning that states, "This action will overwrite Excel test data files, local changes will be lost.</span></span> <span data-ttu-id="41088-578">คุณต้องการดำเนินการต่อหรือไม่?"</span><span class="sxs-lookup"><span data-stu-id="41088-578">Do you want to proceed?"</span></span> <span data-ttu-id="41088-579">เลือก **ใช่** เพื่อปรับปรุงไฟล์พารามิเตอร์ Excel ในระบบเฉพาะที่ แต่ไม่ใช่ไฟล์พารามิเตอร์ excel ที่ถูกอัปโหลดไปยัง Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="41088-579">Select **Yes** to update the Excel parameter files in the local system but not the Excel parameter files that were uploaded to Azure DevOps.</span></span>

    ![ข้อความเตือน](./media/setup_rsa_tool_102.png)

    <span data-ttu-id="41088-581">มีการโหลดกรณีการทดสอบทั้งสองกรณี พร้อมกับไฟล์พารามิเตอร์ Excel สำหรับกรณีการทดสอบแรก</span><span class="sxs-lookup"><span data-stu-id="41088-581">Both the test cases are loaded, together with the Excel parameter file for the first test case.</span></span> <span data-ttu-id="41088-582">เนื่องจากคุณเลือก **อัปโหลด** ในการรันครั้งล่าสุด ไฟล์พารามิเตอร์จะถูกดึงมาจาก Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="41088-582">Because you selected **Upload** in the last run, the parameter files are pulled from Azure DevOps.</span></span>

    ![โหลดกรณีการทดสอบแล้ว](./media/setup_rsa_tool_103.png)

3. <span data-ttu-id="41088-584">เลือกเฉพาะกรณีการทดสอบที่สอง แล้วจากนั้น เลือก **สร้าง \> สร้างการดำเนินการทดสอบและไฟล์พารามิเตอร์**</span><span class="sxs-lookup"><span data-stu-id="41088-584">Select only the second test case, and then select **New \> Generate test execution and parameter files**.</span></span>

#### <a name="edit-the-excel-parameter-file"></a><span data-ttu-id="41088-585">แก้ไขไฟล์พารามิเตอร์ของ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-585">Edit the Excel parameter file</span></span>

1. <span data-ttu-id="41088-586">เลือกเฉพาะกรณีการทดสอบที่สอง แล้วจากนั้น เลือก **แก้ไข** เพื่อเปิดไฟล์พารามิเตอร์ Excel ที่สอดคล้องกัน</span><span class="sxs-lookup"><span data-stu-id="41088-586">Select only the second test case, and then select **Edit** to open the corresponding Excel parameter file.</span></span>
2. <span data-ttu-id="41088-587">คัดลอกตัวแปรที่บันทึกไว้ **{{EcoResProductCreate\_รหัสประจำตัว\_ProductNumber\_คัดลอก}}** (ดูส่วน [ปรับเปลี่ยนการบันทึกงานที่มียู่เพื่อสร้างตัวแปรที่บันทึกไว้](#modify-an-existing-task-recording-to-create-a-saved-variable) ) จากกรณีการทดสอบแรก ลงในฟิลด์ทั้งหมดที่มีการใช้หมายเลขผลิตภัณฑ์</span><span class="sxs-lookup"><span data-stu-id="41088-587">Copy the **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}** saved variable (see the [Modify an existing task recording to create a saved variable](#modify-an-existing-task-recording-to-create-a-saved-variable) section) from the first test case into all the fields where the product number is used.</span></span> <span data-ttu-id="41088-588">ในกรณีนี้ คุณคัดลอกตัวแปรไปยังฟิลด์ **หมายเลขผลิตภัณฑ์** และฟิลด์ **ตรวจสอบความถูกต้องของหมายเลขผลิตภัณฑ์** บนแผ่นงาน **EcoResProductListPage**</span><span class="sxs-lookup"><span data-stu-id="41088-588">In this case, you copy the variable into the **Product number** and **Validate Product number** fields on the **EcoResProductListPage** sheet.</span></span>

    ![ฟิลด์หมายเลขผลิตภัณฑ์และฟิลด์ตรวจสอบความถูกต้องของหมายเลขผลิตภัณฑ์](./media/setup_rsa_tool_104.png)

    > [!NOTE]
    > <span data-ttu-id="41088-590">สามารถส่งผ่านตัวแปรระหว่างการทดสอบได้เฉพาะในระหว่างการรันการทดสอบเดียวกันเท่านั้น</span><span class="sxs-lookup"><span data-stu-id="41088-590">Variables can be passed between tests only during the same test run.</span></span> <span data-ttu-id="41088-591">ชื่อของตัวแปรต้องตรงกัน</span><span class="sxs-lookup"><span data-stu-id="41088-591">The names of the variables must match exactly.</span></span>

3. <span data-ttu-id="41088-592">เลือก **บันทึก** และจากนั้น ปิดสมุดงาน Excel</span><span class="sxs-lookup"><span data-stu-id="41088-592">Select **Save**, and then close the Excel workbook.</span></span>
4. <span data-ttu-id="41088-593">เลือก **อัปโหลด** เพื่อบันทึกการเปลี่ยนแปลงที่คุณทำไว้กับไฟล์พารามิเตอร์ Excel</span><span class="sxs-lookup"><span data-stu-id="41088-593">Select **Upload** to save the changes that you made to the Excel parameter file.</span></span>

#### <a name="run-the-chained-test-cases"></a><span data-ttu-id="41088-594">รันกรณีทดสอบที่ถูกเชื่อมโยง</span><span class="sxs-lookup"><span data-stu-id="41088-594">Run the chained test cases</span></span>

1. <span data-ttu-id="41088-595">เลือกกรณีการทดสอบทั้งสองกรณี แล้วเลือก **รัน**</span><span class="sxs-lookup"><span data-stu-id="41088-595">Select both the test cases, and then select **Run**.</span></span>
2. <span data-ttu-id="41088-596">ตรวจสอบว่ากรณีการทดสอบทั้งสองกรณีผ่าน</span><span class="sxs-lookup"><span data-stu-id="41088-596">Verify that both test cases have passed.</span></span>
