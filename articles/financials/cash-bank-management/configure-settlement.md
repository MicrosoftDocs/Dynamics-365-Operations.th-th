...
พารามิเตอร์ต่อไปนี้มีผลกระทบต่อวิธีการประมวลผลการจับคู่ใน Microsoft Dynamics 365 for Finance and Operations, Enterprise edition การชำระเงินเป็นกระบวนการชำระใบแจ้งหนี้เปรียบเทียบกับการชำระเงินหรือใบลดหนี้ พารามิเตอร์เหล่านี้จะอยู่ใน **พื้นที่ชำระ** ของ **หน้าพารามิเตอร์ลูกหนี้** และ **พารามิเตอร์บัญชีเจ้าหนี้**
