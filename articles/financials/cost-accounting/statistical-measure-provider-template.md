...
หน่วยวัดทางสถิติสามารถมีต้นกำเนิดมาจากแหล่งข้อมูลหลายชนิด Microsoft Dynamics 365 for Finance and Operations เป็นแหล่งกำเนิดที่ดีในการแยกหน่วยวัดทางสถิติออกมา คุณสามารถใช้เท็มเพลตผู้ให้บริการหน่วยวัดทางสถิติ เพื่อตั้งค่าคอนฟิกหน่วยวัดทางสถิติที่คุณต้องการดึงข้อมูลได้อย่างง่ายดาย
...
ไปยัง **บัญชีแยกประเภทในการบัญชีต้นทุน** \> **เวอร์ชันจริง** \> **จัดการ** \> **หน่วยวัดทางสถิติ** เพื่อสร้างความสัมพันธ์ สำหรับสถานการณ์จำลองนี้ เลือกตัวเชื่อมต่อ **Dynamics 365 for Finance and Operations – การวัดทางสถิติ** เนื่องจากเราต้องการแยะข้อมูลออกมาจาก Finance and Operations

**แหล่งข้อมูล**

| ชื่อ        | ตัวเชื่อมต่อข้อมูล                                                                     | สมาชิกมิติทางสถิติ |
|-------------|------------------------------------------------------------------------------------|------------------------------|
| FTEs D365FO | Dynamics 365 for Finance and Operations – การวัดทางสถิติ | FTEs                         |
...
| ชื่อ           | ตัวเชื่อมต่อข้อมูล                                                                     | สมาชิกมิติทางสถิติ |
|----------------|------------------------------------------------------------------------------------|------------------------------|
| แพ็ค CC D365FO | Dynamics 365 for Finance and Operations – การประเมินทางสถิติ | แพ็ค CC                      |
