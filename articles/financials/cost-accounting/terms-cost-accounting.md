...
-  Dynamics 365 for Finance and Operations, Enterprise edition (ตั้งค่าคอนฟิกไว้ล่วงหน้า)
...
|  **แหล่งที่มาของข้อมูล** |  **ธุรกรรมที่นำเข้าของตัวเชื่อมต่อข้อมูล** | **ตัวเชื่อมต่อข้อมูลของ Dynamics 365 for Finance and Operations, Enterprise Edition**  | **ตัวเชื่อมต่อข้อมูลของ Dynamics AX**  |
|---|---|---|---|
