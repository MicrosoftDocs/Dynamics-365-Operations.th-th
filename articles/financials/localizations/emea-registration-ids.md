...
| ข้อจำกัดเกี่ยวกับ         | ชนิดของข้อจำกัดที่ใช้กับชนิดทะเบียนภาษี: ไม่มี บุคคล องค์กร|
| ประเภททะเบียน | ตัวระบุการลงทะเบียนที่ไม่ซ้ำกันที่ได้รับการอนุมัติสำหรับการใช้ในประเทศ รายการทั้งหมดของที่สนับสนุนในประเภท Microsoft Dynamics 365 for Finance and Operations อยู่ด้านล่าง |
...
ตารางต่อไปนี้แสดงชนิดการลงทะเบียนที่ได้รับการสนับสนุนใน Finance and Operations ถ้าคุณคุ้นเคยกับฟิลด์ Microsoft Dynamics AX 2012 สำหรับรหัสการลงทะเบียน ตารางนี้ยังแม็ปฟิลด์เหล่านั้นไปยังประเภทการลงทะเบียน Finance and Operations

| ประเภทการลงทะเบียน Finance and Operations         |ประเทศ/ภูมิภาค  | ข้อกำหนด/ฟิลด์ Dynamics AX 2012|
|---------------------------------------------------------------|---------------------|---------------------------------|
