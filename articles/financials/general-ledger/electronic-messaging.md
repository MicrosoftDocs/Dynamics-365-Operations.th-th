...
หัวข้อนี้แสดงภาพรวมและการตั้งค่าข้อมูลสำหรับการส่งข้อความทางอิเล็กทรอนิกส์ใน Microsoft Dynamics 365 for Finance and Operations
...
- **การประมวลผลข้อความอิเล็กทรอนิกส์** – ห่วงโซ่ของการดำเนินการ ที่ถูกเชื่อมโยง หรือไม่ได้ถูกเชื่อมโยง อย่างใดอย่างหนึ่ง ที่ควรถูกรันเพื่อรวบรวมข้อมูลที่จำเป็น สร้างรายงาน เก็บข้อมูลในที่จัดเก็บ Microsoft Azure Blob ส่งต่อรายงานภายนอกระบบ รับการตอบสนองจากภายนอกระบบ และปรับปรุงฐานข้อมูล โดยขึ้นอยู่กับข้อมูลที่ได้รับ
...
- สร้างข้อความด้วยตนเอง และสร้างรายงานตามรูปแบบ ER ที่ส่งออกซึ่งเชื่อมโยงของชนิดหลายชนิด: Microsoft Excel, XML, JavaScript Object Notation (JSON), PDF, ข้อความ, และ Microsoft Word
...
ตารางต่อไปนี้อธิบายถึงฟิลด์ในหน้า **ฟิลด์เพิ่มเติม**
...
| ค่าฟิลด์          | ป้อนค่าของฟิลด์ที่จะใช้ซึ่งสัมพันธ์กับรายการข้อความในระหว่างการรายงาน |
| คำอธิบายฟิลด์    | ป้อนคำอธิบายของฟิลด์ที่จะใช้ซึ่งสัมพันธ์กับรายการข้อความในระหว่างการรายงาน |
...
| ที่อยู่อินเทอร์เน็ต        | ป้อนที่อยู่อินเทอร์เน็ตของบริการเว็บ |
...
- **เติมข้อมูลเรกคอร์ด** – การดำเนินการ **เติมข้อมูลเรกคอร์ด** ต้องถูกตั้งค่าไว้ก่อนหน้านี้ เชื่อมโยงกับการดำเนินการของชนิด **เติมข้อมูลเรกคอร์ด** เพื่อเปิดใช้งานให้ถูกรวมไว้ในการประมวลผล มีการสันนิษฐานว่า มีการใช้ชนิดการดำเนินการนี้สำหรับการดำเนินการแรกในการประมวลผลข้อความ ดังนั้น จะสามารถตั้งค่าได้เฉพาะสถานะผลลัพธ์สำหรับการดำเนินการของชนิดนี้ สถานะเริ่มต้นไม่สามารถตั้งค่าได้
...
- **บริการเว็บ** – ใช้ชนิดนี้สำหรับการดำเนินการที่ควรส่งรายงานที่สร้างขึ้นไปยังบริการเว็บ ชนิดการดำเนินการนี้ไม่ได้ใช้สำหรับการรายงาน Italian Purchase และ Sales Invoices Communication
- **ร้องขอการตรวจสอบ** – ใช้ชนิดนี้เพื่อร้องขอการตรวจสอบจากเซิร์ฟเวอร์

#### <a name="initial-statuses-fasttab"></a>FastTab สถานะเริ่มต้น

> [!NOTE]
> FastTab **สถานะเริ่มต้น** ไม่พร้อมใช้งานสำหรับการดำเนินการที่มีชนิดเริ่มต้นของ **การเติมข้อมูลเรกคอร์ด** หรือ **สร้างข้อความ**
...
FastTab **ดำเนินการ** ช่วยให้คุณสามารถเพิ่มการดำเนินการที่กำหนดไว้ล่วงหน้าไปยังการประมวลผลได้ คุณสามารถระบุว่า การดำเนินการต้องรันแยกกัน หรือสามารถเริ่มต้นได้ด้วยการประมวลผล (การดำเนินการของผู้ใช้ต้องรันโดยแยกต่างหาก)
...
FastTab **ล็อกการดำเนินการ** แสดงข้อมูลเกี่ยวกับการดำเนินการทั้งหมดที่มีการรันสำหรับข้อความที่เลือก
...
FastTab **รายการข้อความ** แสดงรายการข้อความทั้งหมดที่เกี่ยวข้องกับข้อความที่เลือก
