...
ชื่องานคือการเชื่อมโยงหลายมิติไปยังหน้า Microsoft Dynamics 365 for Operations หรือเว็บเพจอื่น ที่ซึ่งผู้ใช้ต้องไปเพื่อทำให้งานเสร็จสมบูรณ์ คุณสามารถตั้งค่าไฮเปอร์ลิงค์นี้โดยใช้ฟิลด์ **ลิงค์งาน** เมื่อคุณแก้ไขหรือสร้างงานได้ 
...
ก่อนที่คุณจะสามารถใช้พื้นที่ทำงาน **การปิดรอบระยะเวลาทางบัญชี** คุณต้องตั้งค่าคอนฟิกกระบวนการใน Microsoft Dynamics 365 for Finance and Operations โดยใช้หน้า **การตั้งค่าคอนฟิกการปิดรอบระยะเวลาทางบัญชี** (คลิก **บัญชีแยกประเภททั่วไป** &gt; **การปิดรอบระยะเวลา** &gt; **การตั้งค่าคอนฟิกการปิดรอบระยะเวลาทางการเงิน**)
...
รายการเมนู **ลิงก์งาน** ถูกเชื่อมโยงกับความพยายามในการทำงาน และสามารถถูกใช้เพื่อไปที่หน้าที่เกี่ยวข้องได้โดยตรงจากการลิงค์งานในพื้นที่ทำงาน ตัวอย่างเช่น งานการปิดเพื่อรันกระบวนการประเมินใหม่ของสกุลเงินสำหรับบัญชีเจ้าหนี้ สามารถเชื่อมโยงไปยังหน้า **การประเมินสกุลเงินต่างประเทศใหม่** ใน Microsoft Dynamics 365 for Finance and Operations คุณยังสามารถลิงค์ไปยัง URL ภายนอกได้อีกด้วย 
