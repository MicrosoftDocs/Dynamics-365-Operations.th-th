...
เมื่อตั้งค่ากฎการกำจัดใน Microsoft Dynamics 365 for Finance and Operations เราขอแนะนำให้คุณสร้างมิติทางการเงินโดยเฉพาะสำหรับวัตถุประสงค์การกำจัด ลูกค้าส่วนใหญ่ตั้งชื่อเป็นคู่ค้าหรือชื่ออื่นที่คล้ายกัน ถ้าคุณเลือกที่จะไม่ใช้มิติทางการเงิน ให้แน่ใจว่ามีบัญชีหลักที่เฉพาะเจาะจงสำหรับธุรกรรมระหว่างบริษัทเท่านั้น 
