...
หัวข้อนี้อธิบายความสามารถใน Microsoft Dynamics 365 for Finance and Operations ที่สามารถช่วยทำให้การประมวลผลสมุดรายวันทั่วไปง่ายขึ้น และยังสามารถช่วยให้มั่นใจว่าข้อมูลที่ถูกต้องที่ถูกจัดเก็บไม่ได้ถูกลดทอน  
...
คุณสามารถค้นหา **จำลองการลงรายการบัญชี** ในเมนู **ตรวจสอบ** สำหรับสมุดรายวันส่วนใหญ่ได้ เมื่อคุณตรวจสอบสมุดรายวันที่ใช้ฟังก์ชัน **ตรวจสอบ** ระบบจะทดสอบสมุดรายวันสำหรับเงื่อนไขข้อผิดพลาดที่เฉพาะเจาะจง ถ้าคุณใช้ฟังก์ชัน **จำลองการลงรายการบัญชี** ระบบจะเรียกใช้กระบวนการเดียวกันทั้งหมดที่ถูกรันในระหว่างการลงรายการบัญชี โดยไม่มีการลงรายการบัญชีสมุดรายวันจริง จากนั้น คุณสามารถทบทวนข้อความการลงรายการบัญชีที่แสดงอยู่ แก้ไขข้อผิดพลาดใดๆ ที่คุณพบ แล้วจากนั้น คลิกเมนู **ลงรายการบัญชี** เพื่อลงรายการบัญชีสมุดรายวัน 
