...
description: เกือบจะทุกบริษัทที่ใช้ฟังก์ชันทางการเงินใน Microsoft Dynamics 365 for Finance and Operations จะต้องมีความสามารถในการสร้างรายงานของงบประมาณเทียบกับข้อมูลจริง บทความนี้อธิบายถึงการกำหนดค่าต่ำสุดที่ต้องใช้เพื่อสร้างงบประมาณใน Finance and Operations หรือโหลดจากโปรแกรมของบริษัทอื่น
...
ms.locfileid: "1834282"
---
# <a name="budgeting-overview"></a>ภาพรวมของงบประมาณ 

[!include [banner](../includes/banner.md)]

เกือบจะทุกบริษัทที่ใช้ฟังก์ชันทางการเงินใน Microsoft Dynamics 365 for Finance and Operations จะต้องมีความสามารถในการสร้างรายงานของงบประมาณเทียบกับข้อมูลจริง บทความนี้อธิบายถึงการกำหนดค่าต่ำสุดที่ต้องใช้เพื่อสร้างงบประมาณใน Finance and Operations หรือโหลดจากโปรแกรมของบริษัทอื่น
