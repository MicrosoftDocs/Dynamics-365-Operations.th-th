...
อินสแตนซ์ลำดับงานที่หยุดดำเนินการ เนื่องจากมีข้อผิดพลาดที่ไม่สามารถกู้คืนได้จะมีสถานะลำดับงานเป็น **ไม่สามารถกู้คืนได้** เมื่อสถานะของลำดับงานในใบแจ้งหนี้ของผู้จัดจำหน่ายคือ **ไม่สามารถกู้คืนได้** คุณสามารถรีเซ็ตเป็น **แบบร่าง** ได้ จากนั้น คุณสามารถแก้ไขใบแจ้งหนี้ของผู้จัดจำหน่ายได้ คุณลักษณะนี้จะพร้อมใช้งาน ถ้าพารามิเตอร์ **รีเซ็ตสถานะแบบร่างของลำดับงานของผู้จัดจำหน่าย** ในหน้า **การจัดการคุณลักษณะ** ถูกเปิด

คุณสามารถใช้หน้า **รีเซ็ตสถานะของลำดับงานของผู้จัดจำหน่าย** เพื่อรีเซ็ตสถานะของลำดับงานเป็น **แบบร่าง** คุณสามารถเปิดหน้านี้ได้จากการนำทาง **งานประจำงวด** หน้าแสดงใบแจ้งหนี้ของผู้จัดจำหน่ายทั้งหมดที่มีสถานะลำดับงานเป็น **ไม่สามารถกู้คืนได้** ในนิติบุคคลปัจจุบัน นอกจากนี้ ยังแสดงผู้ใช้ที่ส่งใบแจ้งหนี้แต่ละใบไปยังลำดับงานและตัวระบุใบแจ้งหนี้ และแสดงลิงค์ไปยังประวัติลำดับงาน ถ้าต้องการรีเซ็ตสถานะของลำดับงานเป็น **แบบร่าง** ให้ทำเครื่องหมายใบแจ้งหนี้หนึ่งใบขึ้นไป แล้วจากนั้นเลือก **ปรับปรุงเป็นแบบร่าง** หลังจากที่มีการรีเซ็ตสถานะของลำดับงานเป็น **แบบร่าง** จะกลายเป็นพร้อมใช้งานสำหรับการแก้ไขบนหน้า **ใบแจ้งหนี้ของผู้จัดจำหน่าย**

คุณสามารถเข้าถึงหน้า **รีเซ็ตสถานะของลำดับงานของใบแจ้งหนี้ของผู้จัดจำหน่าย** เฉพาะเมื่อหน้าที่ด้านความปลอดภัย **รักษาสถานะสำหรับลำดับงานของใบแจ้งหนี้ของผู้จัดจำหน่าย** และสิทธิ์ **รีเซ็ตสถานะสำหรับลำดับงานของใบแจ้งหนี้ของผู้จัดจำหน่าย** ถูกกำหนดให้กับคุณ
