...
<a name="prerequisites"></a><span data-ttu-id="2b7d4-109">ข้อกำหนดเบื้องต้น</span><span class="sxs-lookup"><span data-stu-id="2b7d4-109">Prerequisites</span></span>
-------------
...
<li><span data-ttu-id="2b7d4-158">วันที่ครบกำหนด</span><span class="sxs-lookup"><span data-stu-id="2b7d4-158">Due date</span></span></li>
...
<td><span data-ttu-id="2b7d4-178">ใช่</span><span class="sxs-lookup"><span data-stu-id="2b7d4-178">Yes</span></span></td>
</tr>
</tbody>
</table>
...
10. <span data-ttu-id="2b7d4-236">คลิก **เสร็จสิ้น** เพื่อออกจากโหมดแก้ไข</span><span class="sxs-lookup"><span data-stu-id="2b7d4-236">Click **Done** to exit edit mode.</span></span>
...
13. <span data-ttu-id="2b7d4-279">คลิก **ย้อนกลับ** และจากนั้น **เสร็จสิ้น** เพื่อออกจากพื้นที่ทำงาน</span><span class="sxs-lookup"><span data-stu-id="2b7d4-279">Click **Back** and then **Done** to exit the workspace</span></span>
...
10. <span data-ttu-id="2b7d4-299">คลิก **ย้อนกลับ** และจากนั้น **เสร็จสิ้น** เพื่อออกจากพื้นที่ทำงาน</span><span class="sxs-lookup"><span data-stu-id="2b7d4-299">Click **Back** and then **Done** to exit the workspace</span></span>
...
1.  <span data-ttu-id="2b7d4-356">เปิดไฟล์ .js ที่คุณสร้างไว้ก่อนหน้านี้ และเพิ่มบรรทัดที่เน้นในรหัสต่อไปนี้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-356">Open the .js file that you created earlier, and add the lines that are highlighted in the following code.</span></span> <span data-ttu-id="2b7d4-357">รหัสนี้ทำสองสิ่ง:</span><span class="sxs-lookup"><span data-stu-id="2b7d4-357">This code does two things:</span></span>
    1.  <span data-ttu-id="2b7d4-358">ซึ่งจะช่วยรับประกันว่าผู้ใช้จะไม่สามารถนำทางได้โดยตรงจากพื้นที่ทำงานไปยังหน้า **ดูการบัญชี**</span><span class="sxs-lookup"><span data-stu-id="2b7d4-358">It helps guarantee that users can’t navigate directly from the workspace to the **View accounting** page.</span></span>
    2.  <span data-ttu-id="2b7d4-359">จะสร้างตัวควบคุมการนำทางจากหน้า **รายละเอียดใบแจ้งหนี้** ไปยังหน้า **ดูการบัญชี**</span><span class="sxs-lookup"><span data-stu-id="2b7d4-359">It establishes a navigation control from the **Invoice details** page to the **View accounting** page.</span></span>

> [!NOTE] 
> <span data-ttu-id="2b7d4-360">ชื่อหน้าและตัวควบคุมอื่น ๆ ในรหัสต้องมีชื่อเหมือนกันกับพื้นที่ทำงาน</span><span class="sxs-lookup"><span data-stu-id="2b7d4-360">The name of the pages and other controls in the code must be the same as the names in the workspace.</span></span>
...
2.  <span data-ttu-id="2b7d4-361">อัปโหลดไฟล์รหัสไปยังพื้นที่ทำงานโดยเลือกแท็บ **ตรรกะ** เพื่อบันทึกทับรหัสก่อนหน้า</span><span class="sxs-lookup"><span data-stu-id="2b7d4-361">Upload the code file to the workspace by selecting the **Logic** tab to overwrite the previous code</span></span>
3.  <span data-ttu-id="2b7d4-362">คลิก **เสร็จสิ้น** เพื่อออกจากโหมดแก้ไข</span><span class="sxs-lookup"><span data-stu-id="2b7d4-362">Click **Done** to exit edit mode.</span></span>
4.  <span data-ttu-id="2b7d4-363">คลิก **ย้อนกลับ** และจากนั้น **เสร็จสิ้น** เพื่อออกจากพื้นที่ทำงาน</span><span class="sxs-lookup"><span data-stu-id="2b7d4-363">Click **Back** and then **Done** to exit the workspace</span></span>
5.  <span data-ttu-id="2b7d4-364">คลิก **เผยแพร่พื้นที่ทำงาน** เพื่อบันทึกงานของคุณ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-364">Click **Publish workspace** to save your work</span></span>

### <a name="validation"></a><span data-ttu-id="2b7d4-365">การตรวจสอบความถูกต้อง</span><span class="sxs-lookup"><span data-stu-id="2b7d4-365">Validation</span></span>

<span data-ttu-id="2b7d4-366">จากอุปกรณ์เคลื่อนที่ของคุณ เปิดแอพ และเชื่อมต่อกับอินสแตนซ์ Finance and Operations ของคุณ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-366">From your mobile device, open the app, and connect to your Finance and Operations instance.</span></span> <span data-ttu-id="2b7d4-367">ตรวจสอบให้แน่ใจว่าคุณลงชื่อเข้าใช้ไปยังบริษัทที่ใบแจ้งหนี้ของผู้จัดจำหน่ายมีการกำหนดให้กับคุณสำหรับการตรวจทาน</span><span class="sxs-lookup"><span data-stu-id="2b7d4-367">Make sure that you sign in to the company where vendor invoices are assigned to you for review.</span></span> <span data-ttu-id="2b7d4-368">คุณควรจะสามารถดำเนินการต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="2b7d4-368">You should be able to perform the following actions:</span></span>

-   <span data-ttu-id="2b7d4-369">ดูพื้นที่ทำงาน **การอนุมัติของฉัน**</span><span class="sxs-lookup"><span data-stu-id="2b7d4-369">See the **My approvals** workspace.</span></span>
-   <span data-ttu-id="2b7d4-370">เข้าถึงรายละเอียดข้อมูลพื้นที่ทำงาน **การอนุมัติของฉัน** และดูหน้า **ใบแจ้งหนี้ของผู้จัดจำหน่ายของฉัน**</span><span class="sxs-lookup"><span data-stu-id="2b7d4-370">Drill into the **My approvals** workspace and see the **My vendor invoices** page.</span></span>
-   <span data-ttu-id="2b7d4-371">เข้าถึงรายละเอียดข้อมูลหน้า **ใบแจ้งหนี้ของผู้จัดจำหน่ายของฉัน** และดูรายการของใบแจ้งหนี้ที่กำหนดให้กับคุณ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-371">Drill into the **My vendor invoices** page and see the list of invoices that are assigned to you.</span></span>
-   <span data-ttu-id="2b7d4-372">เข้าถึงรายละเอียดข้อมูลของหนึ่งในใบแจ้งหนี้เหล่านี้ และดูรายละเอียดส่วนหัวของใบแจ้งหนี้และรายละเอียดรายการ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-372">Drill into one of the invoices, and see the invoice header details and line details.</span></span>
-   <span data-ttu-id="2b7d4-373">บนหน้ารายละเอียด ดูการเชื่อมโยงไปยังเอกสารแนบ และใช้การเชื่อมโยงนี้เพื่อนำทางไปยังรายการเอกสารแนบ และดูเอกสารแนบ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-373">On the details page, see a link to attachments, and use this link to navigate to the attachments list and view the attachments.</span></span>
-   <span data-ttu-id="2b7d4-374">บนหน้ารายละเอียด ดูการเชื่อมโยงไปยังหน้า **ดูการบัญชี** และใช้การเชื่อมโยงนี้เพื่อนำทางไปยังหน้าการกระจาย และดูการกระจาย</span><span class="sxs-lookup"><span data-stu-id="2b7d4-374">On the details page, see a link to the **View accounting** page, and use this link to navigate to the distributions page and view the distributions.</span></span>
-   <span data-ttu-id="2b7d4-375">บนหน้ารายละเอียด คลิกเมนู **การดำเนินการ** ที่ด้านล่าง และทำการดำเนินการลำดับงานที่สามารถใช้กับขั้นตอนของลำดับงาน</span><span class="sxs-lookup"><span data-stu-id="2b7d4-375">On the details page, click the **Actions** menu at the bottom, and perform workflow actions that are applicable to the workflow step.</span></span>

## <a name="designing-a-complex-invoice-approval-scenario-for-fabrikam"></a><span data-ttu-id="2b7d4-376">การออกแบบสถานการณ์จำลองการอนุมัติใบแจ้งหนี้ที่ซับซัอนสำหรับ Fabrikam</span><span class="sxs-lookup"><span data-stu-id="2b7d4-376">Designing a complex invoice approval scenario for Fabrikam</span></span>
<table>
<colgroup>
<col width="50%" />
<col width="50%" />
...
<thead>
<tr class="header">
<th><span data-ttu-id="2b7d4-377">แอททริบิวต์สถานการณ์จำลอง</span><span class="sxs-lookup"><span data-stu-id="2b7d4-377">Scenario attribute</span></span></th>
<th><span data-ttu-id="2b7d4-378">รับสาย</span><span class="sxs-lookup"><span data-stu-id="2b7d4-378">Answer</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><span data-ttu-id="2b7d4-379">ฟิลด์ใดบ้างจากส่วนหัวของใบแจ้งหนี้ที่ผู้ใช้จะต้องการดูในประสบการณ์การใช้งานมือถือและในลำดับใด</span><span class="sxs-lookup"><span data-stu-id="2b7d4-379">What fields from the invoice header will the user want to see in the mobile experience, and in what order?</span></span></td>
<td><ol>
<li><span data-ttu-id="2b7d4-380">ชื่อผู้จัดจำหน่าย</span><span class="sxs-lookup"><span data-stu-id="2b7d4-380">Vendor name</span></span></li>
<li><span data-ttu-id="2b7d4-381">จำนวนเงินในใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-381">Invoice amount</span></span></li>
<li><span data-ttu-id="2b7d4-382">บัญชีใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-382">Invoice account</span></span></li>
<li><span data-ttu-id="2b7d4-383">หมายเลขใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-383">Invoice number</span></span></li>
<li><span data-ttu-id="2b7d4-384">วันที่ในใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-384">Invoice date</span></span></li>
<li><span data-ttu-id="2b7d4-385">คำอธิบายใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-385">Invoice description</span></span></li>
<li><span data-ttu-id="2b7d4-386">วันที่ครบกำหนด</span><span class="sxs-lookup"><span data-stu-id="2b7d4-386">Due date</span></span></li>
<li><span data-ttu-id="2b7d4-387">สกุลเงินในใบแจ้งหนี้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-387">Invoice currency</span></span></li>
</ol></td>
</tr>
<tr class="even">
<td><span data-ttu-id="2b7d4-388">ฟิลด์ใดบ้างจากรายการใบแจ้งหนี้ที่ผู้ใช้จะต้องการดูในประสบการณ์การใช้งานมือถือและในลำดับใด</span><span class="sxs-lookup"><span data-stu-id="2b7d4-388">What fields from the invoice lines will the user want to see in the mobile experience, and in what order?</span></span></td>
<td><ol>
<li><span data-ttu-id="2b7d4-389">ประเภทการจัดซื้อ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-389">Procurement category</span></span></li>
<li><span data-ttu-id="2b7d4-390">ปริมาณ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-390">Quantity</span></span></li>
<li><span data-ttu-id="2b7d4-391">ราคาต่อหน่วย</span><span class="sxs-lookup"><span data-stu-id="2b7d4-391">Unit price</span></span></li>
<li><span data-ttu-id="2b7d4-392">ยอดเงินสุทธิของรายการ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-392">Line net amount</span></span></li>
<li><span data-ttu-id="2b7d4-393">ยอดเงิน 1099</span><span class="sxs-lookup"><span data-stu-id="2b7d4-393">1099 amount</span></span></li>
</ol></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="2b7d4-394">มีบรรทัดใบแจ้งหนี้ในใบแจ้งหนี้จำนวนเท่าใด</span><span class="sxs-lookup"><span data-stu-id="2b7d4-394">How many invoice lines are there in an invoice?</span></span> <span data-ttu-id="2b7d4-395">ใช้กฎ 80-20 และปรับให้เหมาะสมกับ 80 เปอร์เซ็นต์</span><span class="sxs-lookup"><span data-stu-id="2b7d4-395">Apply the 80-20 rule here, and optimize for the 80 percent.</span></span></td>
<td><span data-ttu-id="2b7d4-396">5</span><span class="sxs-lookup"><span data-stu-id="2b7d4-396">5</span></span></td>
</tr>
<tr class="even">
<td><span data-ttu-id="2b7d4-397">ผู้ใช้จะต้องการดูการกระจายการลงบัญชี (การกำหนดรหัสใบแจ้งหนี้) บนอุปกรณ์เคลื่อนที่ในระหว่างการตรวจทานหรือไม่</span><span class="sxs-lookup"><span data-stu-id="2b7d4-397">Will users want to see accounting distributions (invoice coding) on the mobile device during reviews?</span></span></td>
<td><span data-ttu-id="2b7d4-398">ใช่</span><span class="sxs-lookup"><span data-stu-id="2b7d4-398">Yes</span></span></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="2b7d4-399">มีการกระจายการลงบัญชี (ราคารวม ภาษีขาย ค่าธรรมเนียม และอื่น ๆ) สำหรับรายการใบแจ้งหนี้จำนวนเท่าใด</span><span class="sxs-lookup"><span data-stu-id="2b7d4-399">How many accounting distributions (extended price, sales tax, charges, and so on) are there for an invoice line?</span></span> <span data-ttu-id="2b7d4-400">ใช้กฎ 80-20 อีกครั้ง</span><span class="sxs-lookup"><span data-stu-id="2b7d4-400">Again, apply the 80-20 rule.</span></span></td>
<td><span data-ttu-id="2b7d4-401">ราคารวม: 2 ภาษีขาย: 2 ค่าธรรมเนียม: 2</span><span class="sxs-lookup"><span data-stu-id="2b7d4-401">Extended price: 2 Sales tax: 2 Charges: 2</span></span></td>
</tr>
<tr class="even">
<td><span data-ttu-id="2b7d4-402">ใบแจ้งหนี้มีการกระจายการลงบัญชีในส่วนหัวของใบแจ้งหนี้ด้วยหรือไม่</span><span class="sxs-lookup"><span data-stu-id="2b7d4-402">Do the invoices also have accounting distributions on the invoice header?</span></span> <span data-ttu-id="2b7d4-403">ถ้าเป็นเช่นนั้น กระจายการลงบัญชีเหล่านี้ควรพร้อมใช้งานบนอุปกรณ์หรือไม่</span><span class="sxs-lookup"><span data-stu-id="2b7d4-403">If so, should these accounting distributions be available on the device?</span></span></td>
<td><span data-ttu-id="2b7d4-404">ไม่ได้ใช้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-404">Not used</span></span></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="2b7d4-405">ผู้ใช้จะต้องการดูเอกสารแนบสำหรับใบแจ้งหนี้บนอุปกรณ์หรือไม่</span><span class="sxs-lookup"><span data-stu-id="2b7d4-405">Will users want to see attachments for the invoice on the device?</span></span></td>
<td><span data-ttu-id="2b7d4-406">ใช่</span><span class="sxs-lookup"><span data-stu-id="2b7d4-406">Yes</span></span></td>
</tr>
</tbody>
</table>

### <a name="next-steps"></a><span data-ttu-id="2b7d4-407">ขั้นตอนถัดไป</span><span class="sxs-lookup"><span data-stu-id="2b7d4-407">Next steps</span></span>

<span data-ttu-id="2b7d4-408">คุณสามารถทำการเปลี่ยนแปลงต่อไปนี้ให้เสร็จสิ้นได้สำหรับสถานการณ์จำลอง 1 ขึ้นอยู่กับความต้องการสำหรับสถานการณ์จำลอง 2</span><span class="sxs-lookup"><span data-stu-id="2b7d4-408">The following variations can be done for scenario 1, based on the requirements for scenario 2.</span></span> <span data-ttu-id="2b7d4-409">คุณสามารถใช้ส่วนนี้เพื่อปรับปรุงประสบการณ์การใช้งานของแอพบนมือถือของคุณ</span><span class="sxs-lookup"><span data-stu-id="2b7d4-409">You can use this section to improve your mobile app experience.</span></span>

1.  <span data-ttu-id="2b7d4-410">เนื่องจากควรมีรายการในใบแจ้งหนี้เพิ่มเติมในสถานการณ์จำลอง 2 การเปลี่ยนแปลงการออกแบบต่อไปนี้จะช่วยปรับประสบการณ์ผู้ใช้บนอุปกรณ์เคลื่อนที่ให้เหมาะสม:</span><span class="sxs-lookup"><span data-stu-id="2b7d4-410">Because more invoice lines are expected in scenario 2, the following changes to the design will help optimize the user experience on the mobile device:</span></span>
    1.  <span data-ttu-id="2b7d4-411">แทนการดูรายการในใบแจ้งหนี้บนหน้ารายละเอียด (เช่นในสถานการณ์จำลอง 1) ผู้ใช้สามารถเลือกที่จะดูรายการบนหน้าบนมือถือแยกต่างหากได้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-411">Instead of viewing invoice lines on the details page (as in scenario 1), users can choose to view lines on a separate mobile page.</span></span>
    2.  <span data-ttu-id="2b7d4-412">เนื่องจากต้องการรายการในใบแจ้งหนี้มากกว่าหนึ่งรายการในสถานการณ์จำลองนี้ ถ้าหน้า **VendMobileInvoiceAllDistributionTree** ถูกใช้ในการออกแบบหน้าการกระจายสำหรับอุปกรณ์เคลื่อนที่ (ดังเช่นในสถานการณ์จำลอง 1) ผู้ใช้อาจสับสนที่จะสร้างเชื่อมโยงรายการกับการกระจาย</span><span class="sxs-lookup"><span data-stu-id="2b7d4-412">Because more than one invoice line is expected in this scenario, if the **VendMobileInvoiceAllDistributionTree** page is used to design the distributions page for mobile (as in scenario 1), it might be confusing for the user to correlate lines to distributions.</span></span> <span data-ttu-id="2b7d4-413">ดังนั้น ใช้หน้า **VendMobileInvoiceLineDistributionTree** เพื่อออกแบบหน้าการกระจาย</span><span class="sxs-lookup"><span data-stu-id="2b7d4-413">Therefore, use the **VendMobileInvoiceLineDistributionTree** page to design the distributions page.</span></span>
    3.  <span data-ttu-id="2b7d4-414">ทางที่ดีที่สุดคือการกระจายควรแสดงอยู่ในบริบทของรายการในใบแจ้งหนี้ในสถานการณ์จำลองนี้</span><span class="sxs-lookup"><span data-stu-id="2b7d4-414">Ideally, the distributions should be shown in the context of an invoice line in this scenario.</span></span> <span data-ttu-id="2b7d4-415">ดังนั้น โปรดตรวจสอบให้แน่ใจว่าผู้ใช้สามารถเข้าถึงรายการเพื่อดูหน้าการกระจาย</span><span class="sxs-lookup"><span data-stu-id="2b7d4-415">Therefore, make sure that the user can drill into a line to see the distributions page.</span></span> <span data-ttu-id="2b7d4-416">ใช้ความสามารถในการเชื่อมโยงหน้าเพื่อสร้างการเจาะลึก เช่นเดียวกับที่คุณดำเนินการกับส่วนหัวและหน้ารายละเอียดในสถานการณ์จำลอง 1</span><span class="sxs-lookup"><span data-stu-id="2b7d4-416">Use the page link capability to establish the drill-through, just as you did for the header and details pages in scenario 1.</span></span>

2.  <span data-ttu-id="2b7d4-417">เนื่องจากคาดว่าจะมีชนิดยอดเงินมากกว่าหนึ่งชนิดในการกระจายในสถานการณ์จำลอง 2 (ภาษีขาย ค่าธรรมเนียม และอื่น ๆ) จึงควรแสดงคำอธิบายของชนิดยอดเงิน</span><span class="sxs-lookup"><span data-stu-id="2b7d4-417">Because more than one amount type is expected on the distributions in scenario 2 (sales tax, charges, and so on), it will be useful to show the description of the amount type.</span></span> <span data-ttu-id="2b7d4-418">(เราละเว้นข้อมูลนี้ในสถานการณ์จำลอง 1)</span><span class="sxs-lookup"><span data-stu-id="2b7d4-418">(We omitted this information in scenario 1.)</span></span>
