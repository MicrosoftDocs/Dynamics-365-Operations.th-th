...
[สร้างใบแจ้งหนี้ข้อความอิสระ](tasks/create-free-text-invoice.md)

[สร้างเท็มเพลตข้อความอิสระ](tasks/create-free-text-invoice-template.md)
...
<li><strong>ทั้งหมด</strong> – เลือกปริมาณทั้งหมดในใบสั่งขายที่ยัง&#39;ไม่ได้อัพเดตด้วยชนิดเอกสารปัจจุบัน</li>
<li><strong>บันทึกการจัดส่ง</strong> – เลือกปริมาณทั้งหมดที่อัพเดตแล้วตามบันทึกการจัดส่ง</li>
<li><strong>ปริมาณที่เบิกสินค้าและผลิตภัณฑ์ที่ไม่ได้เก็บในคลัง</strong> – เลือกปริมาณทั้งหมดที่มีการเบิกสินค้าและปริมาณสินค้าทั้งหมดที่ไม่ได้&#39;เก็บในคลังไว้</li>
</ul></td>
</tr>
<tr class="even">
...
<li>ล้างตัวเลือกนี้เพื่อพิมพ์ใบสั่งขายชั่วคราว <strong>หมายเหตุ:</strong> ถ้าคุณได้ทำข้อตกลงสำหรับกำหนดการชำระเงิน กำหนดการชำระเงินจะไม่&#39;ปรากฏอยู่บนใบสั่งขายชั่วคราว กำหนดการชำระเงินจะแสดงบนใบสั่งขายจริงเท่านั้น</li>
</ul></td>
</tr>
<tr class="odd">
...
<strong>หมายเหตุ:</strong> ฟิลด์ <strong>พิมพ์</strong> จะพร้อมใช้งานเมื่อคุณเลือกเท่านั้นการพิมพ์ <strong>พิมพ์ใบแจ้งหนี้</strong> <strong>พิมพ์การยืนยัน</strong> <strong>พิมพ์รายการเบิกสินค้า</strong> หรือตัวเลือก <strong>พิมพ์บันทึกการจัดส่ง</strong> ตัวอย่างเช่น ในหน้า <strong>การเรียงลำดับแบบฟอร์ม</strong> คุณตั้งค่าระบบให้เรียงลำดับข้อมูลตามบัญชีใบแจ้งหนี้ คุณสามารถเลือก <strong>หลังจาก</strong> การพิมพ์เอกสารในชุดงานที่จะเรียงลำดับตามบัญชีใบแจ้งหนี้ มิฉะนั้น เอกสารจะถูกพิมพ์ก่อนที่การประมวลผลจะเสร็จสมบูรณ์ และเอกสารจะไม่ถูก&#39;เรียงตามลำดับที่ระบุไว้ในหน้า <strong>การเรียงลำดับแบบฟอร์ม</strong></td>
</tr>
<tr class="even">
...
<td>ถ้าคุณกำลัง&#39;ลงรายการบัญชีใบลดหนี้ เลือกตัวเลือกนี้เพื่อรักษาปริมาณคงเหลือในใบสั่ง ถ้าไม่ได้เลือกตัวเลือกนี้ ปริมาณคงเหลือจะตั้งเป็น 0 (ศูนย์)</td>
</tr>
<tr class="even">
<td>อัพเดตบทสรุปสำหรับ</td>
<td>เลือกวิธีใบสั่งขายหลายใบที่ควรสรุป
<ul>
<li><strong>ไม่มี</strong> – ห้าม&#39;สรุปใบสั่งขาย ตัวอย่างเช่น ใบแจ้งหนี้ที่แยกต่างหากจะถูกสร้างสำหรับแต่ละใบสั่งขาย</li>
...
<li><strong>สรุปอัตโนมัติ</strong>– ถ้ามีการระบุการอัพเดตบทสรุปในหน้า <strong>การอัพเดตบทสรุป</strong> สรุปใบสั่งที่เลือกทั้งหมด ตามเงื่อนไขที่ตั้งค่าในหน้า <strong>พารามิเตอร์การอัพเดตบทสรุป</strong> ถ้ายัง&#39;ไม่ได้ระบุการอัพเดตสรุป ใบสั่งจะถูกลงรายการบัญชีแยกต่างหาก</li>
