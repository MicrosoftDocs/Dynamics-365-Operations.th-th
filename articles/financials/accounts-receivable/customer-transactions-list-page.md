...
ปุ่ม **ดูการชำระเงิน** บนบานหน้าต่างการดำเนินการ ให้สิทธิ์การเข้าถึงด่วนไปยังประวัติการชำระเงิน และข้อมูลเพิ่มเติมเกี่ยวกับธุรกรรมการชำระเงินทั้งหมด คุณยังสามารถดูธุรกรรมเพิ่มเติมที่เกี่ยวข้องกับธุรกรรมที่เลือกได้ เนื่องจากเป็นส่วนหนึ่งของการชำระเงินเดียวกัน หรือเนื่องจากเป็นการชำระเงินที่ได้สร้างขึ้นในสมุดรายวันการชำระเงินเดียวกัน
...
4. ในกล่องโต้ตอบ คุณสามารถทำงานต่างๆ ได้ เลือกใบสำคัญหนึ่งรายการขึ้นไป และจากนั้น เลือกหนึ่งในปุ่มต่อไปนี้:
    ...
    - **ดูรายการที่เกี่ยวข้อง** – แสดงธุรกรรมสมุดรายวันการชำระเงินทั้งหมดที่สร้างไว้ในสมุดรายวันการชำระเงินที่เกี่ยวข้องกับเอกสารที่เลือก นอกจากนี้ จะมีการแสดงการชำระเงินทั้งหมดที่เกี่ยวข้องกับการชำระเงินเหล่านั้น ขณะที่คุณกำลังดูการชำระเงินที่เกี่ยวข้อง ป้ายชื่อของปุ่มนี้เปลี่ยนเป็น **ดูการชำระเงิน** เลือก **ดูการชำระเงิน** เพื่อแสดงเฉพาะธุรกรรมที่แสดงขึ้นเมื่อคุณเปิดกล่องโต้ตอบ **ดูการชำระเงิน** ในครั้งแรก
...
มีการเพิ่มปุ่ม **ธุรกรรมทั่วโลก** ไปยังหน้าลูกค้า ปุ่มนี้ช่วยให้คุณสามารถดูธุรกรรมทั้งหมดสำหรับลูกค้าในนิติบุคคลทั้งหมดได้ หน้ารายการ **ธุรกรรมลูกค้า** แสดงธุรกรรมเฉพาะสำหรับนิติบุคคลที่ผู้ใช้มีสิทธิ์เข้าถึง โดยขึ้นอยู่กับการตั้งค่าความปลอดภัยของเขาหรือของเธอ
...
- **เปิด ณ วันที่** – แสดงเฉพาะธุรกรรมที่ยังไม่ได้ชำระเต็มจำนวนแล้ว ณ วันที่ที่คุณระบุ เมื่อคุณเลือกตัวเลือกนี้ คุณสามารถเปลี่ยนวันที่ที่แสดงถัดจากตัวกรอง ธุรกรรมที่มีค่า **วันที่ชำระเงินล่าสุด** หลังจากวันที่ที่คุณระบุถูกแสดงในรายการ แม้ว่าธุรกรรมเหล่านั้นจะถูกชำระเต็มจำนวน ณ วันที่ปัจจุบัน อย่างไรก็ตาม ยอดดุลแสดงถึงยอดดุล ณ วันที่ปัจจุบัน ไม่ใช่ ณ วันที่ที่เลือก

ตัวกรองข้อมูลยังถูกเพิ่มอีกด้วย ซึ่งช่วยให้คุณสามารถซ่อนธุรกรรมการแปลสกุลเงินได้ เพียงเลือกกล่องกาเครื่องหมาย **ซ่อนการประเมินค่าสกุลเงินใหม่**

## <a name="more-easily-modify-due-dates-and-discount-dates"></a>ปรับเปลี่ยนวันที่ให้ส่วนลดและวันที่ครบกำหนดได้ง่ายขึ้น

คุณสามารถปรับปรุงวันที่ครบกำหนดและวันที่ให้ส่วนลดสำหรับธุรกรรมลูกค้าที่เปิดค้างไว้ ในการนำออกใช้ 8.1 ประสบการณ์ได้รับการปรับปรุง ขณะนี้ คุณสามารถเพิ่มวันที่ครบกำหนดลงในหน้ารายการ **ธุรกรรมลูกค้า** ได้ โดยการคลิกที่วันที่ครบกำหนดในหน้ารายการ **ธุรกรรมลูกค้า** คุณยังสามารถเปลี่ยนวันที่ครบกำหนด วันที่ให้ส่วนลด เงื่อนไขการชำระเงิน และเงื่อนไขส่วนลดเงินสดในกล่องโต้ตอบ **ปรับปรุงวันที่ครบกำหนดและวันที่ให้ส่วนลดเงินสด**  ได้
...
ขณะนี้ วันที่ครบกำหนดจะถูกเพิ่มลงในหน้ารายการ **ธุรกรรมลูกค้า** และคุณสามารถปรับเปลี่ยนวันที่ครบกำหนดชำระ และวันที่ให้ส่วนลดเงินสดสำหรับธุรกรรมได้ง่ายขึ้น
...
- **แก้ไขวันที่ครบกำหนด:** มีการเปลี่ยนแปลงเฉพาะวันที่ครบกำหนด
- **แก้ไขวันที่ให้ส่วนลด:** มีการเปลี่ยนแปลงเฉพาะวันที่ให้ส่วนลด
- **แก้ไขเงื่อนไขการชำระเงิน:** วันที่ครบกำหนดมีการเปลี่ยนแปลง โดยขึ้นอยู่กับวันที่พื้นฐานและเงื่อนไขการชำระเงิน
- **แก้ไขเงื่อนไขส่วนลดเงินสด:** ส่วนลดเงินสดมีการเปลี่ยนแปลง โดยขึ้นอยู่กับวันที่พื้นฐานและเงื่อนไขส่วนลดเงินสด
