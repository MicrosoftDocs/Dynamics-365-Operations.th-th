...
เมื่อต้องการเปิดใช้งานคุณลักษณะมิติการแสดงผลเป็นตัวอย่างสีในศูนย์ควบคุม Commerce ให้ไปที่ **พื้นที่ทำงาน \> การจัดการคุณลักษณะ** และเปิดคุณลักษณะ **เปิดใช้งานกลไกในการแสดงมิติเป็นตัวอย่างสี** เมื่อเปิดใช้งานแฟล็กคุณลักษณะนี้ ฟิลด์ใหม่สามฟิลด์จะเพิ่มให้กับแต่ละมิติในตารางที่เหมาะสมในศูนย์ควบคุม Commerce: **Hexcode** **URL** (สำหรับรูปภาพ) และ **RefinerGroup**
