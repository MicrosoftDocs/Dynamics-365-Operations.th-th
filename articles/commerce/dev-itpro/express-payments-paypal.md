...
description: บทความนี้จะอธิบายวิธีตั้งค่าคอนฟิกการชำระเงินด่วนให้กับ PayPal เพื่อเปิดใช้งานความสามารถในการเช็คเอาท์ที่รวดเร็วขึ้นใน Microsoft Dynamics 365 Commerce
author: BrianShook
ms.date: 05/11/2022
ms.topic: article
...
ms.locfileid: "8905293"
---
# <a name="configure-express-payments-for-paypal"></a>ตั้งค่าคอนฟิกการชำระเงินด่วนสำหรับ PayPal

[!include [banner](../includes/banner.md)]

บทความนี้จะอธิบายวิธีตั้งค่าคอนฟิกการชำระเงินด่วนให้กับ PayPal เพื่อเปิดใช้งานความสามารถในการเช็คเอาท์ที่รวดเร็วขึ้นใน Microsoft Dynamics 365 Commerce
...
| การชำระเงินด่วน | โมดูล Commerce ที่สนับสนุนลักษณะการทำงานการเช็คเอาท์ที่เร็วขึ้นเมื่อใช้วิธีการชำระเงินที่รองรับ บทความนี้ครอบคลุมการใช้โมดูลการชำระเงินด่วนกับ PayPal |
