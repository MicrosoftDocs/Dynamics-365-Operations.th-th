...
1. อัปเดตส่วนประกอบของสถานี POS และสถานีฮาร์ดแวร์ ปิดใช้งานส่วนขยายที่เป็นส่วนประกอบของตัวอย่างก่อนหน้านี้ และเปิดใช้งานส่วนขยายของตัวอย่างปัจจุบัน
    ...
    > [!NOTE]
    > นี้ขึ้นอยู่กับชนิดของสภาพแวดล้อม คุณสามารถค้นหารายละเอียดทางเทคนิคเพิ่มเติมเกี่ยวกับกระบวนการย้ายในส่วน [การย้ายในสภาพแวดล้อมการพัฒนา](#migration-in-a-development-environment) หรือ [การย้ายในส่วนสภาพแวดล้อมการผลิต](#migration-in-a-production-environment) ของบทความนี้
