...
description: บทความนี้ให้คำแนะนำสำหรับการตั้งค่าฟังก์ชันการรวมทางการเงินสำหรับช่องทางการค้า
...
ms.locfileid: "9631435"
---
# <a name="set-up-the-fiscal-integration-for-commerce-channels"></a>ตั้งค่าการรวมทางการเงินสำหรับช่องทางการค้า

[!include [banner](../includes/banner.md)]

บทความนี้ให้คำแนะนำสำหรับการตั้งค่าฟังก์ชันการรวมทางการเงินสำหรับช่องทางการค้า สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการรวมทางการเงิน ดูที่ [ภาพรวมของการรวมทางการเงินสำหรับช่องทางการค้า](fiscal-integration-for-retail-channel.md)

## <a name="enable-features-in-commerce-headquarters"></a>เปิดใช้งานคุณลักษณะใน Commerce headquarters

หากต้องการเปิดใช้งานคุณลักษณะที่เกี่ยวข้องกับฟังก์ชันการรวมทางการเงินของช่องทางการค้า ให้ปฏิบัติตามขั้นตอนต่อไปนี้

1. ใน Commerce headquarters ไปที่ **การจัดการระบบ \> พื้นที่ทำงาน \> การจัดการคุณลักษณะ**
1. ค้นหาและเปิดใช้งานคุณลักษณะต่อไปนี้:

    - **การรวมทางการเงินโดยตรงจากเครื่องบันทึกเงินสด POS** – คุณลักษณะนี้ขยายกรอบงานการรวมทางการเงินโดยเพิ่มความสามารถเพื่อสร้างตัวเชื่อมต่อทางการเงินที่จะเรียกใช้ในการขายหน้าร้าน (POS) ตัวเชื่อมต่อชนิดนี้สื่อสารกับอุปกรณ์หรือบริการทางการเงินที่มี HTTP Application Programming Interface (API) และไม่ต้องการเครื่องจริงเฉพาะในร้านค้า ตัวอย่างเช่น ฟังก์ชันนี้เปิดใช้งานการรวมทางการเงินสำหรับอุปกรณ์เคลื่อนที่โดยไม่ต้องใช้สถานีฮาร์ดแวร์ที่ใช้ร่วมกัน
    - **การแทนที่โพรไฟล์เทคนิคการลงทะเบียนทางการเงิน** – คุณลักษณะนี้เปิดใช้งานการตั้งค่าคอนฟิกของการรวมทางการเงินที่จะขยายและเพิ่มความสามารถในการแทนที่พารามิเตอร์ของโพรไฟล์เทคนิค ตัวอย่างเช่น อาจระบุสตริงการเชื่อมต่ออุปกรณ์ทางการเงินในระดับเครื่องบันทึกเงินสด POS แต่ละระดับ คุณลักษณะนี้ยังเพิ่มความเป็นไปได้ที่จะตรวจสอบพารามิเตอร์การเชื่อมต่อในหน้า **การตั้งค่า** ของเครื่องบันทึกเงินสด POS อีกด้วย 
    - **สถานะการลงทะเบียนทางการเงินของเครื่องบันทึกเงินสด POS** – เมื่อเปิดใช้งานคุณลักษณะนี้ คุณสามารถปิดใช้งานกระบวนการลงทะเบียนทางการเงินของเครื่องบันทึกเงินสด POS เฉพาะได้ หากไม่การลงทะเบียนทางการเงินกับเครื่องบันทึกเงินสด POS ถูกปิดใช้งาน ธุรกรรมการขายจะไม่สามารถทำให้เสร็จสมบูรณ์ในเครื่องบันทึกเงินสดนั้น
    - **การสำรองที่เก็บข้อมูลภายในเครื่องของการรวมทางการเงิน** – คุณลักษณะนี้ขยายความสามารถในการจัดการข้อผิดพลาดของกรอบงานการรวมทางการเงินโดยเปิดใช้งานการสำรองข้อมูลการลงทะเบียนทางการเงินโดยอัตโนมัติ เพื่อให้สามารถคืนค่าข้อมูลในที่เก็บข้อมูลในเครื่องได้ในขณะที่เปิดใช้งานอุปกรณ์
    - **เลื่อนการลงทะเบียนเอกสารออกไป** - คุณลักษณะนี้ขยายความสามารถในการจัดการข้อผิดพลาดของกรอบงานการรวมทางการเงินโดยเปิดใช้งานตัวเลือกในการเลื่อนการลงทะเบียนทางการเงินออกไปในกรณีที่การลงทะเบียนทางการเงินล้มเหลว และใช้ตัวเลือกการลงทะเบียนทางการเงินสำรอง หรือดำเนินการลงทะเบียนทางการเงินให้เสร็จสิ้นในภายหลังด้วยวิธีอื่นนอกเหนือจากกรอบงานการรวมทางการเงิน

## <a name="set-up-commerce-parameters"></a>ตั้งค่าพารามิเตอร์ Commerce

หากต้องการตั้งค่าพารามิเตอร์ Commerce ให้ดำเนินการตามขั้นตอนต่อไปนี้
...
- กำหนดกระบวนการลงทะเบียนทางการเงินไปยังโพรไฟล์ฟังก์ชันการทำงานของ POS
- กำหนดโพรไฟล์ทางเทคนิคตัวเชื่อมต่อให้กับโพรไฟล์ฮาร์ดแวร์
- กำหนดโพรไฟล์ทางเทคนิคเป็นโพรไฟล์ฮาร์ดแวร์หรือฟังก์ชัน POS
...
1. ใน Commerce headquarters ให้ไปที่หน้า **ผู้ให้บริการเอกสารทางการเงิน** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> ผู้ให้บริการเอกสารทางการเงิน**)
...
1. ใน Commerce headquarters ให้ไปที่หน้า **ตัวเชื่อมต่อทางการเงิน** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> ตัวเชื่อมต่อทางการเงิน**)
...
1. ใน Commerce headquarters ให้ไปที่หน้า **โพรไฟล์ฟังก์ชันของตัวเชื่อมต่อ** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> โพรไฟล์ฟังก์ชันของตัวเชื่อมต่อ**)
...
1. ใน Commerce headquarters ให้ไปที่หน้า **โพรไฟล์เทคนิคของตัวเชื่อมต่อ** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> โพรไฟล์เทคนิคของตัวเชื่อมต่อ**)
...
1. ใน Commerce headquarters ให้ไปที่หน้า **กระบวนการลงทะเบียนทางการเงิน** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> กระบวนการลงทะเบียนทางการเงิน**)
...
1. ใน Commerce headquarters ให้ไปที่หน้า **โพรไฟล์ฟังก์ชันของ POS** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การตั้งค่า POS \> โพรไฟล์ POS \> โพรไฟล์ฟังก์ชันการทำงาน**) 
...
1. บนแท็บ **บริการทางการเงิน** ให้เลือกโพรไฟล์ทางเทคนิคของตัวเชื่อมต่อที่มีตำแหน่งตัวเชื่อมต่อ **เครื่องบันทึกเงินสด**
1. ไปที่หน้า **โพรไฟล์ฮาร์ดแวร์ POS** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การตั้งค่า POS \> โพรไฟล์ POS \> โพรไฟล์ฮาร์ดแวร์**)
...
1. บนแท็บ **อุปกรณ์ต่อพ่วงทางการเงิน** ให้เลือกโพรไฟล์ทางเทคนิคของตัวเชื่อมต่อที่มีตำแหน่งตัวเชื่อมต่อ **สถานีฮาร์ดแวร์**
...
- เมื่อตัวให้บริการเอกสารทางการเงินสร้างเอกสารทางการเงิน ตัวเชื่อมต่อทางการเงินสามารถเป็นส่งไปยังอุปกรณ์ทางการเงินทั้งอย่างนั้น หรือแยกวิเคราะห์และแปลงเป็นลำดับของคำสั่งของ API อุปกรณ์ โดยขึ้นอยู่กับวิธีการจัดการการสื่อสาร

### <a name="set-up-registers-with-fiscal-registration-restrictions"></a>ตั้งค่าเครื่องบันทึกเงินสดที่มีข้อจํากัดการลงทะเบียนทางการเงิน

คุณสามารถเลือกเครื่องบันทึกเงินสดที่ไม่อนุญาตให้มีการลงทะเบียนทางการเงิน ตัวอย่างเช่น ในกรณีที่คุณต้องระบุเฉพาะการดำเนินงานที่ไม่ใช่ทางการเงิน เช่น การค้นหาแค็ตตาล็อกผลิตภัณฑ์ การค้นหาลูกค้า หรือการสร้างแบบร่างของธุรกรรมบนอุปกรณ์เหล่านี้

การตั้งค่าเครื่องบันทึกเงินสดที่มีข้อจํากัดการลงทะเบียนทางการเงิน ให้ปฏิบัติตามขั้นตอนเหล่านี้

1. ใน Commerce headquarters ไปที่ **การขายปลีกและการค้า \> การตั้งค่าช่องทางการขาย \> การรวมทางการเงิน \> กระบวนการลงทะเบียนทางการเงิน**
1. เลือกกระบวนการที่ต้องการ
1. เลือกแท็บ **เครื่องบันทึกเงินสด POS ที่มีข้อจํากัดกระบวนการทางการเงิน**
1. เพิ่มเครื่องบันทึกเงินสดที่มีข้อจํากัดกระบวนการทางการเงินตามที่ต้องการ
...
1. ตัวเลือก **ข้าม** และ **ทำเครื่องหมายเป็นลงทะเบียนแล้ว** ในกล่องโต้ตอบการจัดการข้อผิดพลาดที่จำเป็นต้องเปิดใช้งานสิทธิ์ **อนุญาตให้ข้ามการลงะเบียนหรือทำเครื่องหมายเป็นลงทะเบียนแล้ว** หากต้องการเปิดใช้งานสิทธิ์นี้ ให้ไปที่หน้า **กลุ่มสิทธิ์** (**การขายปลีกและการค้า \> พนักงาน \> กลุ่มสิทธิ์**) และตั้งค่าตัวเลือก **อนุญาตให้ข้ามการลงะเบียนหรือทำเครื่องหมายเป็นลงทะเบียนแล้ว** เป็น **ใช่**
1. ตัวเลือก **เลื่อน** ในกล่องโตต้อบการจัดการข้อผิดพลาดต้องมีการเปิดใช้งานสิทธิ์ **อนุญาตให้เลื่อน** หากต้องการเปิดใช้งานสิทธิ์ ให้ไปที่หน้า **กลุ่มสิทธิ์** (**การขายปลีกและการค้า \> พนักงาน \> กลุ่มสิทธิ์**) และตั้งค่าตัวเลือก **อนุญาตให้เลื่อน** เป็น **ใช่**
...
## <a name="enable-manual-execution-of-deferred-fiscal-registration"></a>เปิดใช้งานการดำเนินการด้วยตนเองของการลงทะเบียนทางการเงินที่ถูกเลื่อน

เมื่อต้องการเปิดใช้งานการดำเนินการด้วยตนเองของการลงทะเบียนทางการเงินที่ถูกเลื่อน คุณควรเพิ่มปุ่มใหม่ไปยังโครงร่าง POS
...
## <a name="view-connection-parameters-and-other-information-in-pos"></a>ดูพารามิเตอร์การเชื่อมต่อและข้อมูลอื่นๆ ใน POS

หากต้องการดูพารามิเตอร์การเชื่อมต่อและข้อมูลอื่นๆ ใน POS ให้ทำตามขั้นตอนเหล่านี้

1. เปิด Modern POS (MPOS) หรือ Cloud POS (CPOS)
1. เลือก **การตั้งค่า** ถ้าเปิดใช้งานการรวมทางการเงิน ส่วน **การรวมทางการเงิน** ทางด้านขวาจะแสดงข้อมูลต่อไปนี้

    - สถานะของการรวมทางการเงิน
    - สถานะของธุรกรรมทางเงินล่าสุด
    - จำนวนเหตุการณ์การตรวจสอบที่ค้างอยู่

1. เลือก **รายละเอียด** เพื่อดูข้อมูลต่อไปนี้:

    - ขั้นตอนของกระบวนการลงทะเบียน
    - พารามิเตอร์การเชื่อมต่อ
    - รายละเอียดเหตุการณ์การตรวจสอบ
