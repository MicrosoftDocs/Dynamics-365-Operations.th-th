...
## <a name="enable-features-in-commerce-headquarters"></a>เปิดใช้งานคุณลักษณะในศูนย์ควบคุม Commerce
...
1. ในศูนย์ควบคุม Commerce ให้ไปที่หน้า **ผู้ให้บริการเอกสารทางการเงิน** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> ผู้ให้บริการเอกสารทางการเงิน**)
...
1. ในศูนย์ควบคุม Commerce ให้ไปที่หน้า **ตัวเชื่อมต่อทางการเงิน** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> ตัวเชื่อมต่อทางการเงิน**)
...
1. ในศูนย์ควบคุม Commerce ให้ไปที่หน้า **โพรไฟล์ฟังก์ชันของตัวเชื่อมต่อ** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> โพรไฟล์ฟังก์ชันของตัวเชื่อมต่อ**)
...
1. ในศูนย์ควบคุม Commerce ให้ไปที่หน้า **โพรไฟล์เทคนิคของตัวเชื่อมต่อ** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> โพรไฟล์เทคนิคของตัวเชื่อมต่อ**)
...
1. ในศูนย์ควบคุม Commerce ให้ไปที่หน้า **กระบวนการลงทะเบียนทางการเงิน** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การรวมทางการเงิน \> กระบวนการลงทะเบียนทางการเงิน**)
...
1. ในศูนย์ควบคุม Commerce ให้ไปที่หน้า **โพรไฟล์ฟังก์ชันของ POS** (**การขายปลีกและการค้า \> การตั้งค่าช่องทาง \> การตั้งค่า POS \> โพรไฟล์ POS \> โพรไฟล์ฟังก์ชันการทำงาน**) 
...
1. ในศูนย์ควบคุม Commerce ไปที่ **การขายปลีกและการค้า \> การตั้งค่าช่องทางการขาย \> การรวมทางการเงิน \> กระบวนการลงทะเบียนทางการเงิน**
