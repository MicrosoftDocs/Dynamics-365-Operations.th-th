...
description: หัวข้อนี้อธิบายภาพรวมของตัวอย่างการรวมทางบัญชีสำหรับอิตาลีใน Microsoft Dynamics 365 Commerce
...
ms.locfileid: "7944645"
---
# <a name="fiscal-printer-integration-sample-for-italy"></a>ตัวอย่างการรวมเครื่องพิมพ์ทางการเงินสำหรับอิตาลี

[!include[banner](../includes/banner.md)]

หัวข้อนี้อธิบายภาพรวมของตัวอย่างการรวมทางบัญชีสำหรับอิตาลีใน Microsoft Dynamics 365 Commerce

ฟังก์ชัน Commerce สำหรับอิตาลีรวมการรวมตัวอย่างของการขายหน้าร้าน (POS) กับเครื่องพิมพ์ทางการเงิน ตัวอย่างจะขยาย [ฟังก์ชันการรวมทางการเงิน](fiscal-integration-for-retail-channel.md) เพื่อให้งานกับเครื่องพิมพ์ [Epson FP-90III Series](https://www.epson.it/products/sd/pos-printer/epson-fp-90iii-series) จาก Epson และช่วยให้สามารถสื่อสารกับเครื่องพิมพ์ทางการเงินในโหมดเว็บเซิร์ฟเวอร์ผ่านเว็บเซอร์วิส EpsonFPMate โดยใช้ Fiscal ePOS-Print API ตัวอย่างสนับสนุนโหมด Registratore Telematico (RT) เท่านั้น ตัวอย่างมีให้ในรูปแบบของรหัสต้นฉบับและเป็นส่วนหนึ่งของชุดการพัฒนาซอฟต์แวร์ (SDK) ของการขายปลีก
...
1. ดาวน์โหลดไฟล์การตั้งค่าคอนฟิกสำหรับผู้ให้บริการเอกสารทางการเงินและตัวเชื่อมต่อทางการเงิน:
    ...
    1. ดาวน์โหลดไฟล์การตั้งค่าคอนฟิกผู้ให้บริการเอกสารทางการเงินที่ **CommerceRuntime \> DocumentProvider.EpsonFP90IIISample \> Configuration \> DocumentProviderEpsonFP90IIISample.xml** (ตัวอย่างเช่น [ไฟล์ของรุ่น/9.33](https://github.com/microsoft/Dynamics365Commerce.Solutions/blob/release/9.33/src/FiscalIntegration/EpsonFP90IIISample/CommerceRuntime/DocumentProvider.EpsonFP90IIISample/Configuration/DocumentProviderEpsonFP90IIISample.xml))
    1. ดาวน์โหลดไฟล์การตั้งค่าคอนฟิกตัวเชื่อมต่อทางการเงินที่ **HardwareStation \> EpsonFP90IIIFiscalDeviceSample \> Configuration \> ConnectorEpsonFP90IIISample.xml** (ตัวอย่างเช่น [ไฟล์สำหรับรุ่น/9.33](https://github.com/microsoft/Dynamics365Commerce.Solutions/blob/release/9.33/src/FiscalIntegration/EpsonFP90IIISample/HardwareStation/EpsonFP90IIIFiscalDeviceSample/Configuration/ConnectorEpsonFP90IIISample.xml)
...
- **การแม็ปชนิดการชำระเงิน** – การแม็ปวิธีการชำระเงินที่ตั้งค่าคอนฟิกไว้ให้กับร้านค้ากับชนิดการชำระเงินที่สนับสนุนโดยเครื่องพิมพ์ทางการเงิน ตัวอย่างต่อไปนี้แสดงการแม็ปเริ่มต้น
    ...
    นี่เป็นคำอธิบายเกี่ยวกับแอททริบิวต์ในการแม็ปนี้:
    ...
    ตารางต่อไปนี้แสดงวิธีการแม็ปตัวอย่างของวิธีการชำระเงินจะตรงกับวิธีการชำระเงินของร้านค้าที่ตั้งค่าคอนฟิกในข้อมูลสาธิตมาตรฐาน
    ...
    คุณต้องปรับเปลี่ยนการแม็ปตัวอย่างตามวิธีการชำระเงินที่ตั้งค่าคอนฟิกในโปรแกรมประยุกต์ของคุณ

- **ชนิดบาร์โค้ดของหมายเลขใบเสร็จ** – ชนิดของบาร์โค้ดที่ใช้เพื่อแสดงหมายเลขใบเสร็จในใบเสร็จทางการเงิน การแม็ปเริ่มต้นคือ **CODE128**
...
- **การแม็ปแผนกเครื่องพิมพ์ทางการเงิน** – การแม็ปแผนกของเครื่องพิมพ์ทางการเงินกับอัตราภาษีมูลค่าเพิ่ม (VAT) ลักษณะการยกเว้น VAT และชนิดผลิตภัณฑ์ ตัวอย่างต่อไปนี้แสดงการแม็ปเริ่มต้น
    ...
    - **VATRate** คืออัตรา VAT ที่ได้รับการสนับสนุนซึ่งตั้งค่าคอนฟิกเป็นรหัสภาษีขาย ค่าในการแม็ปมีทศนิยมสองจุด แต่ไม่มีตัวแบ่งทศนิยม ตัวอย่างเช่น **2200** แสดงถึง 22 เปอร์เซ็นต์ และ **1000** จะแสดงถึง 10 เปอร์เซ็นต์
    - **VATExemptNature** สามารถใช้ได้เฉพาะในกรณีที่อัตรา VAT เป็น 0 (ศูนย์) เท่านั้น รวมถึงกรณีที่ไม่มีภาษี ปัจจุบัน **VATExemptNature** ได้รับการสนับสนุนเฉพาะกับบัตรของขวัญและค่าในการแม็ปควรตรงกับค่าของคุณสมบัติ **VATExemptNatureForGiftCard** ในไฟล์การตั้งค่าคอนฟิก XML
    ...
    คุณต้องปรับเปลี่ยนการแม็ปตัวอย่างตามอัตรา VAT ที่ตั้งค่าคอนฟิกในโปรแกรมประยุกต์ของคุณและแผนกที่เกี่ยวข้องซึ่งตั้งค่าคอนฟิกในเครื่องพิมพ์ทางการเงินของคุณ

- **ลักษณะยกเว้น VAT ของบัตรของขวัญ** – ลักษณะยกเว้น VAT ที่ควรใช้เมื่อมีการออกหรือเติมบัตรของขวัญ ค่าควรตรงกับบางรายการในการแม็ปแผนกเครื่องพิมพ์ทางการเงิน การแม็ปเริ่มต้นคือ **NS**
...
- **รหัสข้อมูลเกี่ยวกับจุดเริ่มต้นการส่งคืน** – รหัสข้อมูลที่ใช้เพื่อรวบรวมจุดเริ่มต้นของธุรกรรมการส่งคืน ถ้าไม่ได้ระบุต้นฉบับใบเสร็จไว้ พารามิเตอร์นี้ใช้ร่วมกับพารามิเตอร์ **รหัสข้อมูลของวันที่ขายเดิม** และ **การแม็ปจุดเริ่มต้นการส่งคืน** เพื่อสร้างข้อความที่ถูกต้องในใบเสร็จทางการเงินเกี่ยวกับจุดเริ่มต้นของธุรกรรมการส่งคืน ถ้าไม่มีธุรกรรมการขายเดิมอยู่ 

    คุณควรตั้งค่าคอนฟิกรหัสข้อมูลนี้เพื่อให้ผู้ใช้สามารถเลือกหรือป้อนหนึ่งในจุดเริ่มต้นของการส่งคืนในร้านค้าของคุณ ตัวอย่างเช่น คุณสามารถตั้งค่าคอนฟิกรหัสย่อยเป็นรายการของรหัสย่อย (เช่น **ส่งคืนจากไซต์** หรือ **ส่งคืนจาก คีออสก์**) จากนั้นพารามิเตอร์ **การแม็ปจุดเริ่มต้นการส่งคืน** จะใช้ในการแปลค่าของรหัสข้อมูลเป็นข้อความคำสั่งของเครื่องพิมพ์ทางการเงิน
    ...
    ไม่ได้ระบุค่าเริ่มต้นไว้สำหรับการแม็ปนี้ คุณต้องเลือกรหัสข้อมูลที่ตั้งค่าคอนฟิกในโปรแกรมประยุกต์ของคุณ

- **รหัสข้อมูลเกี่ยวกับวันที่ขายเดิม** – รหัสข้อมูลที่ใช้เพื่อรวบรวมวันที่ขายเดิมของธุรกรรมการส่งคืน ถ้าไม่ได้ระบุต้นฉบับใบเสร็จไว้ พารามิเตอร์นี้ใช้ร่วมกับพารามิเตอร์ **รหัสข้อมูลของจุดเริ่มต้นการส่งคืน** และ **การแม็ปจุดเริ่มต้นการส่งคืน** เพื่อสร้างข้อความที่ถูกต้องในใบเสร็จทางการเงินเกี่ยวกับจุดเริ่มต้นของธุรกรรมการส่งคืน ถ้าไม่มีธุรกรรมการขายเดิมอยู่
...
- **การแม็ปจุดเริ่มต้นการส่งคืน** – การแม็ปจุดเริ่มต้นการส่งคืนที่ใช้เพื่อพิมพ์จุดเริ่มต้นของธุรกรรมการส่งคืน ถ้าไม่ได้ระบุต้นฉบับใบเสร็จไว้ พารามิเตอร์นี้ใช้ร่วมกับพารามิเตอร์ **รหัสข้อมูลของจุดเริ่มต้นการส่งคืน** และ **รหัสข้อมูลเกี่ยวกับวันที่ขายเดิม** เพื่อสร้างข้อความที่ถูกต้องในใบเสร็จทางการเงินเกี่ยวกับจุดเริ่มต้นของธุรกรรมการส่งคืน ถ้าไม่มีธุรกรรมการขายเดิมอยู่ ตัวอย่างต่อไปนี้แสดงการแม็ปเริ่มต้น
...
การแม็ปข้อมูลเริ่มต้นต่อไปนี้ล้าสมัยและคงไว้เฉพาะความเข้ากันได้กับรุ่นผลิตภัณฑ์แบบย้อนกลับเท่านั้น:

- การแม็ปรหัสภาษีมูลค่าเพิ่ม (VAT)
...
ปฏิบัติตามขั้นตอนต่างๆ ใน [การตั้งค่าไปป์ไลน์การสร้างตัวอย่างการรวมทางการเงิน](fiscal-integration-sample-build-pipeline.md) เพื่อสร้างและปล่อย Cloud Scale Unit และแพคเกจที่ปรับใช้ได้แบบบริการตนเองในตัวอย่างการรวมทางการเงิน ไฟล์ YAML แม่แบบ **EpsonFP90III build-pipeline.yml** สามารถพบได้ในโฟลเดอร์ **Pipeline\\YAML_Files** ของที่เก็บ [โซลูชัน Dynamics 365 Commerce](https://github.com/microsoft/Dynamics365Commerce.Solutions)
...
> [!WARNING]
> เนื่องจากข้อจํากัดของ [แบบจำลองบรรจุภัณฑ์และส่วนขยายอิสระใหม่](../dev-itpro/build-pipeline.md) จึงไม่สามารถใช้กับตัวอย่างการรวมทางการเงินนี้ได้ในขณะนี้ คุณต้องใช้ Retail SDK บน VM สำหรับนักพัฒนาใน LCS หากต้องการข้อมูลเพิ่มเติม โปรดดูที่ [แนวทางการปรับใช้งานตัวอย่างการรวมเครื่องพิมพ์ทางการเงินของอิตาลี (ดั้งเดิม)](emea-ita-fpi-sample-sdk.md) มีการวางแผนการสนับสนุนรูปแบบบรรจุภัณฑ์และส่วนขยายอิสระใหม่จากตัวอย่างการรวมทางการเงินกับรุ่นที่ใหม่กว่า
