...
- **เลื่อน** – ผู้ปฏิบัติงานสามารถใช้ตัวเลือกนี้เมื่อธุรกรรมไม่มีการลงทะเบียน เนื่องจากไม่มีบริการลงทะเบียน 

> [!NOTE]
> ตัวเลือก **ข้าม**, **ทำเครื่องหมายเป็นลงทะเบียนแล้ว** และ **เลื่อน** ต้องถูกเปิดใช้งานในกระบวนการลงทะเบียนทางบัญชี ก่อนที่จะมีการใช้ นอกจากนั้น ต้องมีการมอบสิทธิ์ที่สอดคล้องกันให้กับตัวดำเนินการ

ตัวเลือก **ข้าม**, **ทำเครื่องหมายเป็นลงทะเบียนแล้ว** และ **เลื่อน** เปิดใช้งานรหัสข้อมูลให้บันทึกข้อมูลเฉพาะบางอย่างเกี่ยวกับความล้มเหลว เช่น เหตุผลสำหรับความล้มเหลว หรือการให้เหตุผลสำหรับการข้ามการลงทะเบียนทางบัญชี หรือการทำเครื่องหมายธุรกรรมเป็นลงทะเบียนแล้ว สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการตั้งค่าพารามิเตอร์การจัดการข้อผิดพลาด ดู [ตั้งการตั้งค่าการจัดการข้อผิดพลาด](setting-up-fiscal-integration-for-retail-channel.md#set-error-handling-settings)
...
### <a name="postpone-option"></a>ตัวเลือกการเลื่อน

ตัวเลือก **การเลื่อน** ช่วยให้คุณประมวลผลการลงทะเบียนทางการเงินต่อได้ถ้าขั้นตอนปัจจุบันล้มเหลว โดยสามารถใช้ได้เมื่อมีตัวเลือกสํารองการลงทะเบียนทางการเงิน
