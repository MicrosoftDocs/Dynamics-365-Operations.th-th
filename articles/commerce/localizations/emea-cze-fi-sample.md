...
คุณต้องระบุการตั้งค่าต่อไปนี้สำหรับสาธารณรัฐเช็ก โปรดทราบว่าคุณต้องรันงานการกระจายที่เหมาะสมหลังจากที่คุณเสร็จสิ้นการตั้งค่า
...
- **การแม็ปกลุ่ม VAT เริ่มต้น** – ยอดเงิน VAT ใดๆ ที่สามารถแม็ปกับกลุ่ม VAT ที่ไว้ล่วงหน้ากลุ่มใดกลุ่มหนึ่งจะถูกแอททริบิวต์เป็นกลุ่ม VAT เริ่มต้น (พื้นฐาน) ต่อไปนี้เป็นการแม็ปเริ่มต้น:

    ```
    A
    ```

- **การแม็ปกลุ่ม VAT การฝากเงิน** – ยอดเงินฝากของลูกค้าและยอดเงินฝากใบสั่งของลูกค้าจะได้รับการแอททริบิวต์ไปยังกลุ่ม VAT การฝากเงิน ต่อไปนี้เป็นการแม็ปเริ่มต้น:
