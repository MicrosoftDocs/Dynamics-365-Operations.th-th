...
- **ตัวเลือกการเรียงลำดับขั้นสูง** ใช้สำหรับผู้เยี่ยมชมเว็บไซต์ในการเรียงลำดับผลิตภัณฑ์โดยใช้เกณฑ์อัจฉริยะ โดยการเปิดใช้งาน [คำแนะนำผลิตภัณฑ์](product-recommendations.md) ตัวเลือกการเรียงลำดับต่อไปนี้จะมีพร้อมใช้งาน สำหรับข้อมูลเพิ่มเติม อ้างถึงบทความ [ชนิดของคำแนะนำผลิตภัณฑ์](product-recommendations.md#types-of-product-recommendations)
...
- **ตัวเลือกการเรียงลำดับมาตรฐาน** ใช้สำหรับผู้เยี่ยมชมเว็บไซต์ในการเรียงลำดับผลิตภัณฑ์ โดยค่าเริ่มต้น ตัวเลือกการเรียงลำดับต่อไปนี้จะมีพร้อมใช้งาน:
    ...
    > [!NOTE]
    > ถ้ามีการกำหนดค่า **ลำดับการแสดงผล** ให้กับผลิตภัณฑ์ในลำดับการนําทาง ให้เรียงลำดับตามค่าเริ่มต้นในหน้าประเภทที่กําหนดไว้ใน **ลำดับการแสดงผล** การเรียงลำดับจะเสร็จสิ้นด้วย **หมายเลขผลิตภัณฑ์**)
...
>นอกจากนี้ เมื่อต้องการใช้ตัวเลือกการเรียงดับขั้นสูง เช่น การขายใหม่ การขายที่ดีที่สุด และแนวโน้ม คุณต้องเปิดใช้งาน [การแนะนำผลิตภัณฑ์](product-recommendations.md) ให้กับสภาพแวดล้อมของคุณ ตัวเลือกการเรียงลำดับขั้นสูงพร้อมใช้งานกับ Commerce SDK รุ่น 9.35+ และ Commerce รุ่น 10.0.20
