...
- **ProductWarehouseInventoryAvailabilities** – ใช้ API นี้เพื่อร้องขอสินค้าคงคลังสำหรับสินค้าจากคลังสินค้าหนึ่งๆ ตัวอย่างเช่น คุณสามารถใช้เพื่อแสดงความพร้อมใช้งานของสินค้าคงคลังในสถานการณ์ที่เกี่ยวข้องกับการเบิกสินค้าตามใบสั่ง
...
ก่อนที่คุณจะใช้ APIs สองรายการที่กล่าวถึงก่อนหน้านี้ คุณต้องทำการเปลี่ยนแปลงพารามิเตอร์ในศูนย์ควบคุม Commerce เพื่อให้แน่ใจว่าสแนปช็อตของมูลค่าสินค้าคงคลังที่ศูนย์ควบคุม Commerce คำนวณโดยใช้งาน **ความพร้อมใช้งานของผลิตภัณฑ์** ป้อนข้อมูลในตารางที่ถูกต้อง

เพื่อตั้งค่าพารามิเตอร์ ให้ดำเนินการตามขั้นตอนเหล่านี้

1. ไปที่ **Retail และ Commerce \> การตั้งค่าศูนย์ควบคุม \> พารามิเตอร์ \> พารามิเตอร์ที่ใช้ร่วมกันของ Commerce**
1. บนแท็บ **สินค้าคงคลัง** ในส่วน **งานความพร้อมใช้งานของผลิตภัณฑ์** เลือก **ใช้กระบวนการที่เหมาะสมสำหรับงานความพร้อมใช้งานของผลิตภัณฑ์** การตั้งค่านี้จะช่วยให้มั่นใจว่าชุดคุณลักษณะที่ดีที่สุดจะถูกใช้ในการคำนวณสินค้าคงคลังที่มีอยู่ของช่องทางผ่านเซิร์ฟเวอร์ Commerce
...
เมื่อต้องการใช้ตรรกะการคำนวณด้านข้างช่องทางและปิดใช้งานการเรียกบริการแบบเรียลไทม์สำหรับการค้นหาสินค้าคงคลังจากแอพลิเคชัน POS คุณต้องทำการเปลี่ยนแปลงพารามิเตอร์สองรายการก่อน คุณต้องซิงค์การเปลี่ยนแปลงกับช่องทางผ่านกระบวนการจัดกำหนดการการกระจาย

เพื่อตั้งค่าพารามิเตอร์แรก ให้ดำเนินการตามขั้นตอนเหล่านี้

1. ไปที่ **Retail และ Commerce \> การตั้งค่าศูนย์ควบคุม \> พารามิเตอร์ \> พารามิเตอร์ที่ใช้ร่วมกันของ Commerce**
1. บนแท็บ **สินค้าคงคลัง** ในส่วน **งานความพร้อมใช้งานของผลิตภัณฑ์** เลือก **ใช้กระบวนการที่เหมาะสมสำหรับงานความพร้อมใช้งานของผลิตภัณฑ์** การตั้งค่านี้จะช่วยให้มั่นใจว่าชุดคุณลักษณะที่ดีที่สุดจะถูกใช้ในการคำนวณสินค้าคงคลังที่มีอยู่ของช่องทางผ่านเซิร์ฟเวอร์ Commerce

เพื่อตั้งค่าพารามิเตอร์ที่สอง ให้ดำเนินการตามขั้นตอนเหล่านี้
...
เพื่อปรับปรุงเซิร์ฟเวอร์ ให้ดำเนินการตามขั้นตอนเหล่านี้
