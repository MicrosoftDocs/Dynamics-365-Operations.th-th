...
การคํานวณสินค้าคงคลังฝั่งช่องทางเป็นระบบที่ใช้ข้อมูลสินค้าคงคลังช่องทางที่รู้จักล่าสุด ใน Commerce headquarters เป็นพื้นฐาน จากนั้นปัจจัยต่างๆ ในการเปลี่ยนแปลงสินค้าคงคลังเพิ่มเติมที่เกิดขึ้นทางด้านช่องทางซึ่งไม่ได้รวมอยู่ในพื้นฐานนั้น เพื่อคํานวณปริมาณคงคลังคงเหลือที่ประเมินไว้ใกล้เวลาจริง 
...
หากต้องการใช้การคํานวณสินค้าคงคลังฝั่งช่องทาง คุณต้องเปิดใช้งานคุณลักษณะ **การคํานวณความพร้อมใช้งานของผลิตภัณฑ์อย่างเต็มประสิทธิภาพ**

หากสภาพแวดล้อม Commerce ของคุณอยู่ในรุ่น **10.0.8 10.0.11** ให้ปฏิบัติตามขั้นตอนต่อไปนี้

1. ใน Commerce headquarters ให้ไปที่ **Retail และ Commerce** \> **พารามิเตอร์ที่ใช้ร่วมกันของ Commerce**
1. บนแท็บ **สินค้าคงคลัง** ในฟิลด์ **งานความพร้อมใช้งานของผลิตภัณฑ์** เลือก **ใช้กระบวนการที่เหมาะสมสำหรับงานความพร้อมใช้งานของผลิตภัณฑ์**

หากสภาพแวดล้อม Commerce ของคุณอยู่ในรุ่น **10.0.12 หรือรุ่นใหม่กว่า** ให้ปฏิบัติตามขั้นตอนต่อไปนี้

1. ใน Commerce headquarters ให้ไปที่ **พื้นที่ทำงาน \> การจัดการคุณลักษณะ** และเปิดใช้งานคุณลักษณะ **การคำนวณความพร้อมใช้งานของผลิตภัณฑ์ที่ปรับให้เหมาะสม**
1. ถ้าช่องทางออนไลน์และร้านค้าออนไลน์ของคุณใช้คลังสินค้าการเติมสินค้าเดียวกัน คุณต้องเปิดใช้งานลักษณะ **ตรรกะการคํานวณสินค้าคงคลังฝั่งช่องทาง e-Commerce ขั้นสูง** ด้วย วิธีนั้น ตรรกะการคํานวณฝั่งช่องทางจะพิจารณาถึงธุรกรรมที่ยังไม่ได้ลงรายการบัญชีที่สร้างขึ้นในช่องทางร้านค้า (ธุรกรรมเหล่านั้นสามารถเป็นธุรกรรมเงินสดและการขนส่ง ใบสั่งของลูกค้า และการส่งคืน)
1. รันงาน **1070** (**การตั้งค่าคอนฟิกช่องทาง**)

ถ้าสภาพแวดล้อม Commerce ของคุณได้รับการอัพเกรดจากรุ่นก่อน Commerce เวอร์ชัน 10.0.8 หลังจากที่คุณเปิดใช้งานคุณลักษณะ **การคำนวณความพร้อมใช้งานของผลิตภัณฑ์ที่ปรับให้เหมาะสม** คุณต้องรัน **เริ่มต้นตัวกำหนดตารางทำงานการค้า** ให้คุณลักษณะมีผลบังคับใช้ด้วย เพื่อรันการเริ่มต้น ให้ไปที่ **Retail และ Commerce** \> **การตั้งค่าศูนย์ควบคุม** \> **ตัวกำหนดตารางทำงานการค้า**
...
เมื่อต้องการใช้สแนปช็อตของสินค้าคงคลังใน Commerce headquarters ให้ทำตามขั้นตอนเหล่านี้
...
เมื่อต้องการตั้งค่าคอนฟิกการดำเนินการ **ค้นหาสินค้าคงคลัง** POS ใน Commerce headquarters เพื่อใช้ตรรกะการคำนวณฝั่งช่องทางและปิดใช้งานการเรียกบริการแบบเรียลไทม์ อันดับแรกคุณต้องเปิดใช้งานคุณลักษณะ **การคำนวณความพร้อมของผลิตภัณฑ์ที่ปรับให้เหมาะสม** ผ่านพื้นที่ทำงาน **การจัดการคุณลักษณะ** ใน Commerce headquarters จากนั้นทำตามขั้นตอนเหล่านี้
...
- **งาน P** – พบงาน P บนหน้า **กำหนดการกระจาย** และควรรันบ่อยๆ งานนี้จะนำใบสั่งอีคอมเมิร์ซ ใบสั่งของลูกค้าแบบอะซิงโครนัสที่มีการสร้าง POS และใบสั่งเงินสดและการขนส่งที่ POS สร้างขึ้นจากฐานข้อมูลช่องทางเข้าสู่ Commerce headquarters เพื่อให้สามารถดำเนินการต่อได้ จนกว่าข้อมูลนี้จะถูกซิงค์จากช่องทางไปยัง Commerce headquarters  Commerce headquarters ไม่มีข้อมูลเกี่ยวกับการปรับปรุงสินค้าคงคลังให้กับผลิตภัณฑ์ในคลังสินค้าที่เป็นผลมาจากธุรกรรมดังกล่าว
- **ซิงโครไนส์ใบสั่ง** – งานนี้จะประมวลผลข้อมูลของธุรกรรมดิบใน Commerce headquarters ซึ่งงาน P มีให้และแปลงธุรกรรมใบสั่งซื้อของลูกค้าและแบบอะซิงโครนัสให้เป็นใบสั่งขายใน Commerce headquarters จนกว่าจะมีการประมวลผลงานนี้และใบสั่งขายถูกสร้างขึ้น จะไม่มีการสร้างธุรกรรมสินค้าคงคลัง ดังนั้น สินค้าคงคลังคงเหลือใน Commerce headquarters จะไม่พิจารณาธุรกรรม
...
- **ลงรายการบัญชีใบแจ้งยอดธุรกรรมเป็นชุดงาน** – งานนี้ยังต้องใช้สำหรับการลงรายการบัญชีฟีดแบบต่อเนื่องอีกด้วย นี่จะเป็นไปตามงาน **คำนวณใบแจ้งยอดธุรกรรมเป็นชุดงาน** งานนี้จะลงรายการบัญชีใบแจ้งยอดที่มีการคำนวณอย่างเป็นระบบ ดังนั้นจึงมีการสร้างใบสั่งขายสำหรับการขายแบบเงินสดและการขนส่งใน Commerce headquarters และ Commerce headquarters จะสะท้อนถึงสินค้าคงคลังของร้านค้าของคุณได้อย่างถูกต้องมากขึ้น
- **ความพร้อมใช้งานของผลิตภัณฑ์** – งานนี้สร้างสแนปช็อตของสินค้าคงคลังจาก Commerce headquarters
- **1130 (ความพร้อมใช้งานของผลิตภัณฑ์)** – งานนี้พบบนหน้า **กำหนดการกระจาย** และควรรันทันทีหลังจากงาน **ความพร้อมใช้งานของผลิตภัณฑ์** งานนี้จะขนส่งข้อมูลสแนปช็อตของสินค้าคงคลังจาก Commerce headquarters ไปยังฐานข้อมูลช่องทาง
