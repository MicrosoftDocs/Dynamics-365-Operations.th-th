...
## <a name="disable-option-to-pay-later"></a>ปิดใช้งานตัวเลือกในการชำระเงินภายหลัง

ใน Commerce รุ่น10.0.12 และรุ่นที่ใหม่กว่า ผู้ค้าสามารถลบตัวเลือกในการชำระเงินภายหลังเมื่อมีการสร้างใบสั่งของลูกค้าที่ POS ได้ เมื่อต้องการปิดใช้งานตัวเลือก ให้เปิด **โพรไฟล์ฟังก์ชัน** สำหรับช่องทางที่ไม่อนุญาตให้มีการชำระเงินภายหลัง แล้วเลือก **แก้ไข** บนแท็บ **ทั่วไป** ให้เลือกรายการแบบหล่นลงสำหรับ **จำเป็นต้องมีการชำระเงินสำหรับการเก็บแพ็คส่งสินค้า** หากการชำระเงินภายหลังไม่ควรได้รับอนุญาตที่ POS ให้เลือก **จำเป็นต้องมีบัตร** และเลือก **บันทึก** เรียกใช้กำหนดการกระจาย **1070** เพื่อซิงโครไนส์การเปลี่ยนแปลงนี้กับช่องทาง 
