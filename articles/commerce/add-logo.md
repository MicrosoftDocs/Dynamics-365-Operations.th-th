...
1. อัปโหลดโลโก้ของคุณไปยังตัวจัดการสินทรัพย์ดิจิทัล ซึ่งคุณสามารถเข้าถึงได้จากหน้า **สินทรัพย์**
...
1. ในบานหน้าต่างนำทางทางด้านซ้าย ให้เลือก **ส่วน** แล้วเลือกส่วนหัวที่คุณสร้างขึ้น
2. เลือก **เช็คเอาท์**
3. ขยายช่อง **ส่วนหัว** และช่อง **โลโก้**
4. เลือกปุ่มจุดไข่ปลา (**...**) สำหรับช่อง **โลโก้** แล้วเลือก **เพิ่มโมดูล**
5. เลือกโมดูลโลโก้
6. ในบานหน้าต่างคุณสมบัติทางด้านขวา ให้ตั้งค่าโมดูลโลโก้กลับไปที่ด้านบนเพื่อแสดงโลโก้ของคุณ
7. บันทึกส่วนที่เป็นส่วนหัว เช็คอิน และเผยแพร่
