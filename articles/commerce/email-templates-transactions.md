...
Dynamics 365 Commerce ให้โซลูชันแบบสำเร็จรูป เพื่อส่งอีเมลซึ่งแจ้งเตือนลูกค้าเกี่ยวกับเหตุการณ์ธุรกรรม ตัวอย่างเช่น อีเมลสามารถส่งเมื่อวางใบสั่งซื้อ เมื่อพร้อมรับการเบิกสินค้า หรือถูกจัดส่งแล้ว หัวข้อนี้จะอธิบายขั้นตอนสำหรับการสร้าง อัปโหลด และกำหนดค่าเท็มเพลตอีเมลที่ใช้ในการส่งอีเมลของธุรกรรม

## <a name="notification-types"></a>ชนิดการแจ้งเตือน

สามารถตั้งค่าคอนฟิกการแจ้งเตือนเพื่อแจ้งให้ลูกค้าทราบผ่านทางอีเมลเมื่อเหตุการณ์เฉพาะเกิดขึ้น เป็นส่วนหนึ่งของใบสั่งซื้อและรอบเวลาของลูกค้า เมื่อต้องการตั้งค่าคอนฟิกการแจ้งเตือน คุณต้องแม็ปเท็มเพลตอีเมลกับชนิดการแจ้งเตือนโดยสร้างโพรไฟล์การแจ้งเตือนทางอีเมลของ Commerce สำหรับข้อมูลเกี่ยวกับวิธีการตั้งค่าโปรไฟล์การแจ้งเตือนทางอีเมล ดูที่ [ตั้งค่าโพรไฟล์การแจ้งเตือนทางอีเมล](email-notification-profiles.md)
...
| `pickupstorehourfrom` | เวลาเปิดทำการของร้านค้าที่จะรับสินค้า |
| `pickupstorehourto`   | เวลาปิดทำการของร้านค้าที่จะรับสินค้า |
...
1. ภายใต้ **ทั่วไป** ให้ตั้งค่าฟิลด์ต่อไปนี้
    ...
    - **รหัสอีเมล** – รหัสอีเมลเป็นตัวระบุเฉพาะของเท็มเพลต เป็นค่าที่แสดงเมื่อคุณเลือกเท็มเพลตเพื่อแม็ปกับเหตุการณ์
    ...
    - **รหัสภาษาเริ่มต้น** – ฟิลด์นี้จะระบุเวอร์ชันที่แปลเป็นภาษาท้องถิ่นของอีเมลที่ส่งโดยค่าเริ่มต้น ถ้าช่องทางที่เรียกใช้เท็มเพลตนี้ไม่ได้ระบุภาษาเฉพาะ
