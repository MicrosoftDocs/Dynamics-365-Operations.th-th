...
เพื่อเปิดใช้งานการแจ้งเตือนที่สร้างโดยลูกค้าใน Commerce headquarters ไปที่ **การขายปลีกและการค้า \> การตั้งค่าศูนย์ควบคุม \> พารามิเตอร์ \> พารามิเตอร์ Commerce \> ทั่วไป** ในรายการแบบหล่นลง **โปรไฟล์การแจ้งเตือนทางอีเมล** ให้เลือกโปรไฟล์การแจ้งเตือนทางอีเมลที่ประกอบด้วยชนิดการแจ้งเตือนของลูกค้าที่สร้าง 

ตามค่าเริ่มต้น เหตุการณ์ที่ลูกค้าสร้างจะถูกอัปโหลดไปยังศูนย์ควบคุมด้วยชุดงาน **ซิงโครไนส์ลูกค้าและคำขอช่องทาง** หากคุณต้องการใช้การเรียกบริการแบบเรียลไทม์เพื่อส่งเหตุการณ์เหล่านี้ ให้ตั้งค่ารหัสอีเมลของลูกค้าที่สร้างแม่แบบเป็น **newCust** อย่างไรก็ตาม ไม่แนะใช้ เนื่องจากการเรียกบริการแบบเรียลไทม์ เป็นการเรียก "เรียกใช้และลืม" และไม่ได้มีการย้อนกลับหรือลองตรรกะใหม่ที่มีชุดงานให้
...
เมื่อเรียกผ่านชุดงาน ลูกค้าสร้างชนิดการแจ้งเตือนจะสนับสนุนตัวยึดสถานะต่อไปนี้

| ชื่อของตัวยึด | คำอธิบาย                                                      |
| ---------------- | ------------------------------------------------------------ |
| customername     | ชื่อและนามสกุลของลูกค้าที่สร้างบัญชี |

เมื่อเรียกผ่านการเรียกใช้บริการแบบเรียลไทม์ใหม่ ลูกค้าสร้างชนิดการแจ้งเตือนจะสนับสนุนตัวยึดสถานะต่อไปนี้

| ชื่อของตัวยึด | คำอธิบาย                                                      |
| ---------------- | ------------------------------------------------------------ |
| ชื่อ             | ชื่อและนามสกุลของลูกค้าที่สร้างบัญชี |
| อีเมล            | ที่อยู่อีเมลของลูกค้าที่สร้างบัญชี    |
| โทรศัพท์            | หมายเลขโทรศัพท์ของลูกค้าที่สร้างบัญชี      |
| URL              | URL ที่ลูกค้าให้ไว้เมื่อสร้างบัญชี |
...
1. ภายใต้ **ทั่วไป** ให้ตั้งค่าฟิลด์ต่อไปนี้
    ...
    - **ชื่อผู้ส่ง** – ชื่อที่คุณป้อนจะปรากฏในฟิลด์ "เริ่มต้น" ของไคลเอ็นต์อีเมลที่มากที่สุด
