...
| ชื่อของตัวยึด               | ค่าของตัวยึด |
|--------------------------------|-------------------|
| productid                      | <p>รหัสของผลิตภัณฑ์ รหัสนี้อธิบายตัวแปร</p><p><strong>หมายเหตุ:</strong> ตัวยึดตำแหน่งนี้ไม่ได้รับการสนับสนุนตาม **lineproductrecid**</p> |
