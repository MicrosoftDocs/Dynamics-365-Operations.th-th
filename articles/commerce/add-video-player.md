...
description: บทความนี้ครอบคลุมถึงโมดูลโปรแกรมเล่นวิดีโอและอธิบายวิธีการเพิ่มลงในเพจของไซต์ใน Microsoft Dynamics 365 Commerce
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9269306"
---
# <a name="video-player-module"></a>โมดูลโปรแกรมเล่นวิดีโอ

[!include [banner](includes/banner.md)]

บทความนี้ครอบคลุมถึงโมดูลโปรแกรมเล่นวิดีโอและอธิบายวิธีการเพิ่มลงในเพจของไซต์ใน Microsoft Dynamics 365 Commerce
...
1. ในกล่องโต้ตอบ **เทมเพลตใหม่** ภายใต้ **ชื่อเท็มเพลต** ให้ป้อน **เท็มเพลตโปรแกรมเล่นวิดีโอ** และจากนั้น เลือก **ตกลง**
...
1. ในกล่องโต้ตอบ **เลือกโมดูล** ให้เลือกโมดูล **โปรแกรมเล่นวิดีโอ** แล้วเลือก **ตกลง**
...
1. ในกล่องโต้ตอบ **สร้างหน้าใหม่** ภายใต้ **ชื่อหน้า** ให้ป้อน **หน้าโปรแกรมเล่นวิดีโอ** และจากนั้น เลือก **ถัดไป**
1. ภายใต้ **เลือกเทมเพลต** ให้เลือก **เทมเพลตของโปรแกรมเล่นวิดีโอ** ที่คุณสร้างขึ้น และจากนั้นเลือก **ถัดไป**
