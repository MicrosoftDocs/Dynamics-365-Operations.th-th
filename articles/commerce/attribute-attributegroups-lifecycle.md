...
description: บทความนี้อธิบายวิธีการใช้แอททริบิวต์ เพื่อช่วยให้มีวิธีในการอธิบายผลิตภัณฑ์และลักษณะผ่านฟิลด์ที่ผู้ใช้กำหนด
author: ashishmsft
ms.date: 04/28/2018
ms.topic: article
ms.prod: ''
...
|            | 3D เปิดใช้งาน               | ใช่ หรือ ไม่ใช่                   | ไม่            |
...
สำหรับผลิตภัณฑ์ การตั้งค่าข้อมูลเมตาของแอททริบิวต์สามารถถูกแทนที่ได้ที่ระดับช่องทาง ความสามารถนี้จะถูกกล่าวถึงในบทความนี้ในภายหลัง
