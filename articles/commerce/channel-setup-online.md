...
description: บทความนี้จะอธิบายวิธีการสร้างช่องทางออนไลน์ใหม่ใน Microsoft Dynamics 365 Commerce
author: samjarawan
ms.date: 02/04/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8864940"
---
# <a name="set-up-an-online-channel"></a>ตั้งค่าช่องทางออนไลน์

[!include [banner](includes/banner.md)]

บทความนี้จะอธิบายวิธีการสร้างช่องทางออนไลน์ใหม่ใน Microsoft Dynamics 365 Commerce
...
## <a name="assign-the-channel-to-a-commerce-scale-unit"></a>กําหนดช่องทางให้กับ Commerce Scale Unit

คุณต้องกำหนดช่องทางใหม่ของคุณให้กับ Commerce Scale Unit ดูคําแนะนําที่ [ตั้งค่าคอนฟิกช่องทางเพื่อใช้ Commerce Scale Unit](../fin-ops-core/dev-itpro/deployment/initialize-retail-channels.md#configure-channels-to-use-commerce-scale-unit)
...
จากส่วน **บัญชีการชำระเงิน** คุณสามารถเพิ่มผู้ให้บริการชำระเงินภายนอกได้ สำหรับข้อมูลเกี่ยวกับการตั้งค่าตัวเชื่อมต่อการชำระเงิน Adyen ดู [ตัวเชื่อมต่อการชำระเงิน Dynamics 365 สำหรับ Adyen](./dev-itpro/adyen-connector.md)
