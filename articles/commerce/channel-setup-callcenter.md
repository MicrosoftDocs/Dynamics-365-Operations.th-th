...
1. ในฟิลด์ **ลูกค้าเริ่มต้น** ให้ระบุลูกค้าเริ่มต้นที่ถูกต้อง ข้อมูลนี้จะใช้เพื่อช่วยในการเติมค่าเริ่มต้นโดยอัตโนมัติ เมื่อสร้างเรกคอร์ดลูกค้าใหม่ เมื่อสร้างใบสั่งศูนย์บริการ จะไม่แนะนำให้สร้างใบสั่งสำหรับลูกค้าเริ่มต้น
