---
title: ตั้งค่าช่องทางของศูนย์บริการ
description: บทความนี้จะอธิบายวิธีการสร้างช่องทางคอลเซ็นเตอร์ใหม่ใน Microsoft Dynamics 365 Commerce
author: samjarawan
ms.date: 03/13/2020
ms.topic: article
ms.prod: ''
...
บทความนี้จะอธิบายวิธีการสร้างช่องทางคอลเซ็นเตอร์ใหม่ใน Microsoft Dynamics 365 Commerce
...
เมื่อต้องการสร้างใบสั่งขายที่เชื่อมโยงกับช่องทางของศูนย์บริการจาก Commerce headquarters ผู้ใช้ที่สร้างใบสั่งขายจะต้องเชื่อมโยงกับช่องทางของศูนย์บริการ ผู้ใช้ไม่สามารถเชื่อมโยงใบสั่งขายที่สร้างขึ้นใน Commerce headquarters ไปยังช่องทางของศูนย์บริการได้ด้วยตนเอง ลิงค์เป็นระบบ และขึ้นอยู่กับผู้ใช้และความสัมพันธ์ของผู้ใช้ไปยังช่องทางของศูนย์บริการ ผู้ใช้สามารถเชื่อมโยงกับช่องทางศูนย์บริการได้เพียงช่องทางเดียวเท่านั้น
