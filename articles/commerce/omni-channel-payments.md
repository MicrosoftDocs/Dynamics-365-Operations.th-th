...
ms.locfileid: "3024259"
---
# <a name="omni-channel-payments-overview"></a>ภาพรวมการชำระเงินผ่านช่องทาง Omni

[!include [banner](../includes/banner.md)]

หัวข้อนี้แสดงภาพรวมของการชำระเงินผ่านช่องทาง omni ใน Dynamics 365 Commerce ซึ่งรวมถึงรายการที่ครอบคลุมของสถานการณ์จำลองที่สนับสนุน ข้อมูลเกี่ยวกับฟังก์ชัน การตั้งค่า และการแก้ไขปัญหาเบื้องต้น และคำอธิบายเกี่ยวกับปัญหาทั่วไปบางอย่าง
...
สถานการณ์ทั้งหมดที่อธิบายไว้ในหัวข้อนี้สามารถนำมาใช้ได้โดยใช้ชุดสินค้าพัฒนาซอฟต์แวร์มาตรฐานการชำระเงิน (SDK) ที่มีอยู่ในการค้า [ตัวเชื่อมต่อการชำระเงิน Dynamics 365 สำหรับ Adyen](https://docs.microsoft.com/dynamics365/unified-operations/retail/dev-itpro/adyen-connector?tabs=8-1-3) ให้การใช้งานแบบสำเร็จรูปของสถานการณ์จำลองทุกสถานการณ์ที่อธิบายไว้ที่นี่ 
...
- **การกำหนดค่าการชำระเงินช่องทาง Omni :** ในแผนกสนับสนุน ไปที่ **การขายปลีกและการค้า \> การตั้งค่าสำนักงานใหญ่ \> พารามิเตอร์ \> พารามิเตอร์ที่ใช้ทางการค้าร่วมกัน** จากนั้น บนแท็บ **การชำระเงินผ่านช่องทาง Omni** ตั้งค่าตัวเลือก **ใช้การชำระเงินผ่านช่องทาง Omni** เป็น **ใช่**
...
- ตัวเลือก **การชำระเงินช่องทาง Omni** ในหน้า **พารามิเตอร์ที่ใช้ทางการค้าร่วมกัน** ได้รับการกำหนดเป็น **จริง**
