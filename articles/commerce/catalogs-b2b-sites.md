...
> [!NOTE]
> หัวข้อนี้ใช้กับ Dynamics 365 Commerce รุ่น 10.0.26 และรุ่นที่ใหม่กว่า
...
> [!NOTE]
> คุณลักษณะนี้พร้อมใช้งานตั้งแต่ Dynamics 365 Commerce รุ่น 10.0.26 เมื่อต้องการตั้งค่าคอนฟิกการตั้งค่าคอนฟิกเฉพาะแค็ตตาล็อก เช่น ลำดับชั้นการนำทางและลำดับชั้นลูกค้า ในศูนย์ควบคุม Commerce เปิดพื้นที่ทำงาน **การจัดการคุณลักษณะ** (**การจัดการระบบ \> พื้นที่ทำงาน \> การจัดการคุณลักษณะ**) เปิดใช้งานคุณลักษณะ **เปิดใช้งานการใช้แค็ตตาล็อกหลายรายการในช่องทางการขายปลีก** แล้วเรียกใช้งาน **1110 CDX**
