...
โปรดดูข้อมูลอ้างอิงเพิ่มเติมเกี่ยวกับการลงทะเบียนแอปใน Azure AD B2C โปรดดู [ประสบการณ์การลงทะเบียนแอปใหม่สำหรับ Azure Active Directory](https://docs.microsoft.com/azure/active-directory-b2c/app-registrations-training-guide)
