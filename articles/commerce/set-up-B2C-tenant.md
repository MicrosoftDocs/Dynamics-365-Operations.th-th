...
1. เลือกโปรแกรมประยุกต์ที่เพิ่งสร้างขึ้นใหม่ และนําทางไปยังเมนู **สิทธิ์ API** 
...
1. ในพอร์ทัล Azure ให้ไปที่ **หน้าหลัก \> Azure AD B2C - แอปพลิเคชัน**
1. เลือกแอปพลิเคชันของคุณ และจากนั้น ในบานหน้าต่างนำทางด้านซ้าย เลือก **คุณสมบัติ** เพื่อดูรายละเอียดแอปพลิเคชัน
1. จากกล่อง **รหัสแอปพลิเคชัน** ให้รวบรวมรหัสแอปพลิเคชันของแอปพลิเคชัน B2C ที่สร้างขึ้นในผู้เช่า B2C ของคุณ นี่จะถูกป้อนเป็น **GUID ของไคลเอนต์** ในโปรแกรมสร้างไซต์ในภายหลัง
...
รูปภาพต่อไปนี้แสดงตัวอย่างของหน้า **Azure AD B2C - แอปพลิเคชัน**

![นำทางไปยังแอปพลิเคชัน B2C ภายในผู้เช่าของคุณ](./media/B2CImage_19.png)

รูปภาพต่อไปนี้แสดงตัวอย่างของหน้า **คุณสมบัติ** ของแอปพลิเคชันใน Azure AD B2C 
