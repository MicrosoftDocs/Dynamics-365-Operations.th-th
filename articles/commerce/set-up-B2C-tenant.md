...
- ตั้งค่า **AllowAnonymousAccess** ของการดําเนินงาน POS เป็น "1" ในศูนย์ควบคุม Commerce:
    ...
    1. รันงาน **1090 (เครื่องบันทึกเงินสด)**
...
เมื่อมีการสร้างผู้เช่า B2C คุณจะสร้างแอพลิเคชัน B2C ภายในผู้เช่า Azure AD B2C ใหม่ของคุณเพื่อโต้ตอบกับการดำเนินการ Commerce
...
1. ภายใต้ **ชื่อ** ให้ป้อนชื่อเพื่อให้โปรแกรมประยุกต์ Azure AD B2C นี้
...
1. เพื่อ **เปลี่ยนเส้นทาง URI** ให้ป้อน URL การตอบเฉพาะของคุณเป็นชนิด **เว็บ** สำหรับข้อมูลเกี่ยวกับ URL ตอบกลับและวิธีจัดรูปแบบไฟล์เหล่านั้นที่นี่ โปรดดูที่ [ตอบ URL](#reply-urls) ด้านล่าง
1. เลือก **สิทธิ์** เลือก **ให้การยินยอมแก่ผู้ดูแลระบบสำหรับสิทธิ์ OpenID และ offline_access**
1. เลือก **การลงทะเบียน**
1. เลือกโปรแกรมประยุกต์ที่เพิ่งสร้างขึ้นใหม่ และนําทางไปยังเมนู **การรับรองความถูกต้อง** ที่นี่คุณสามารถเพิ่ม **เปลี่ยนเส้นทาง URL** เพิ่มเติมได้ถ้าต้องการ (ทันทีหรือภายหลัง) ไปที่ขั้นตอนถัดไปหากไม่ต้องใช้ในปัจจุบัน
1. ภายใต้ **การให้สิทธิ์โดยนัย** ให้เลือกทั้ง **โทเคนการเข้าถึง** และ **โทเคนรหัส** เพื่อเปิดใช้งานโทเคนเหล่านั้นของโปรแกรมประยุกต์ เลือก **บันทึก**
1. ไปที่เมนู **ภาพรวมของ** ของพอร์ทัล Azure และคัดลอก **รหัสโปรแกรมประยุกต์ (ไคลเอนต์)** บันทึกรหัสนี้ของขั้นตอนการตั้งค่าในภายหลัง (ซึ่งอ้างอิงในภายหลังเป็น **GUID ของไคลเอนต์**)
...
![รันตัวเลือกโฟลว์ของผู้ใช้ในโฟลว์ของนโยบาย](./media/B2CImage_23.png)
...
1. ภายใต้ **ตัวให้บริการข้อมูลเฉพาะตัว** ให้เลือก **ลงชื่อเข้าใช้อีเมล**
...
![สร้างโฟลว์ของผู้ใช้ในการแก้ไขโปรไฟล์](./media/B2CImage_12.png)
...
1. เลือก **โครงร่างหน้า** ในเมนูการนําทางด้านซ้าย ภายใต้ **ชื่อโครงร่าง** เลือก **ลงชื่อสมัครใช้และลงชื่อเข้าใช้แบบครบวงจร** แล้วเลือก **รันโฟลว์ผู้ใช้**
1. ตรวจสอบให้แน่ใจว่าโปรแกรมประยุกต์ของคุณได้รับการตั้งค่าเป็นโปรแกรมประยุกต์ Azure AD B2C ที่ต้องการซึ่งสร้างขึ้นข้างต้น แล้วเลือกลิงค์ภายใต้ส่วนหัว **รันโฟลว์ผู้ใช้** ที่รวม ``.../.well-known/openid-configuration?p=<B2CSIGN-INPOLICY>``
1. หน้าข้อมูลเมตาจะแสดงอยู่ในแท็บเบราเซอร์ของคุณ คัดลอก URL ของผู้ออกตัวให้บริการข้อมูลเฉพาะตัว (ค่าของ **"ผู้ออก"**)
...
![นำทางไปยังแอปพลิเคชัน B2C ภายในผู้เช่าของคุณ](./media/B2CImage_19.png)

รูปภาพต่อไปนี้แสดงตัวอย่างของหน้า **คุณสมบัติ** ของแอพลิเคชันใน Azure AD B2C 

![คัดลอกรหัสของแอปพลิเคชันจากคุณสมบัติของแอปพลิเคชัน B2C](./media/B2CImage_21.png)
