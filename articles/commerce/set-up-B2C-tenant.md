...
1. ในพอร์ทัล Azure เลือก **แอพลิเคชัน** แล้วเลือก **เพิ่ม**
...
การตอบกลับ URLs มีความสำคัญ เนื่องจากมีการอนุญาตรายการที่ไม่ได้รับอนุญาตของโดเมนส่งคืน เมื่อไซต์ของคุณเรียกใช้ Azure AD B2C เพื่อตรวจสอบความถูกต้องของผู้ใช้ การทำเช่นนี้จะช่วยให้การส่งคืนของผู้ใช้ที่ได้รับการรับรองความถูกต้องสามารถกลับไปยังโดเมนที่มีการลงชื่อเข้าใช้ (โดเมนของไซต์ของคุณ) 
...
1. ในกล่องค้นหา Commerce ให้ค้นหา **ลำดับหมายเลข** (การจัดการองค์กร > ลำดับหมายเลข)
1. ภายใต้บานหน้าต่างการดำเนินการ เลือก **แก้ไข** ภายใต้ **รักษา**
1. บนแท็บด่วน **ทั่วไป** ให้เลือก **ไม่** สำหรับ **ด้วยตนเอง**
1. บนบานหน้าต่างการดำเนินการ เลือก **บันทึก** 
...
1. ป้อนรายการที่จำเป็นต่อไปนี้ในฟอร์มที่แสดง โดยใช้ค่าจากผู้เช่า B2C และแอพลิเคชันของคุณ ฟิลด์ที่ไม่จำเป็น (ฟิลด์ที่ไม่มีเครื่องหมายดอกจัน) อาจถูกปล่อยว่างไว้
    ...
    - **ชื่อผูเชา**: ชื่อของผู้เช่า B2C ของคุณ ตัวอย่างเช่น "Fabrikam"
