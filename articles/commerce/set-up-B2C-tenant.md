...
1. ตรวจสอบให้แน่ใจว่าแอปพลิเคชันของคุณได้รับการตั้งค่าเป็นแอปพลิเคชัน Azure AD B2C ที่ต้องการซึ่งสร้างขึ้นข้างต้น แล้วเลือกลิงค์ภายใต้ส่วนหัว **เรียกใช้โฟลว์ผู้ใช้** ที่รวม ``.../.well-known/openid-configuration?p=<B2CSIGN-INPOLICY>``
