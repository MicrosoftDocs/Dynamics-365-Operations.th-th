...
description: บทความนี้อธิบายวิธีการทำงานกับใบสั่งที่ระงับโดยใช้ Dynamics 365 Commerce
author: josaw1
ms.date: 05/14/2018
ms.topic: article
ms.prod: ''
...
บนหน้ารายการใบสั่ง ผู้ใช้ศูนย์บริการสามารถระงับใบสั่งได้โดยใช้ตัวเลือก **ระงับใบสั่ง** บนแท็บ **ใบสั่งขาย** ของเมนูรายการใบสั่ง อีกทางหนึ่งคือ ผู้ใช้สามารถเลือกรายการเมนู **ระงับ** บนหน้า **สรุปใบสั่งขาย** ซึ่งปรากฏขึ้น เมื่อผู้ใช้เลือก **ดำเนินการให้เสร็จสมบูรณ์** ในใบสั่งขายของศูนย์บริการ
