...
เมื่อเตรียมใช้งานสภาพแวดล้อมอีคอมเมิร์ซใน [Microsoft Dynamics Lifecycle Services (LCS)](https://lcs.dynamics.com/) กล่อง **ชื่อโฮสต์ที่ได้รับการสนับสนุน** บนหน้าจอการเตรียมใช้งานอีคอมเมิร์ซเพื่อป้อนโดเมนที่จะเชื่อมโยงกับสภาพแวดล้อม Commerce ที่ปรับใช้ โดเมนเหล่านี้จะเป็นชื่อของเซิร์ฟเวอร์ชื่อโดเมน (DNS) ที่เชื่อมต่อกับลูกค้าซึ่งจะเป็นโฮสต์ของเว็บไซต์อีคอมเมิร์ซ การป้อนโดเมนในลำขั้นนี้ไม่ได้เริ่มต้นการแปลงการรับส่งข้อมูลสำหรับโดเมน Dynamics 365 Commerce การรับส่งข้อมูลสำหรับโดเมนจะถูกส่งไปยังปลายทาง Commerce เมื่อมีการอัปเดตเรกคอร์ด DNS CNAME เพื่อใช้ปลายทาง Commerce กับโดเมนเท่านั้น
...
ตัวอย่างเช่น ถ้าคุณมีไซต์ในตัวสร้างไซต์ที่ชื่อ"fabrikam" ในผู้เช่าอีคอมเมิร์ซชื่อ "xyz" และถ้าคุณตั้งค่าไซต์ที่มีพาธที่ว่างเปล่า คุณจะเข้าถึงเนื้อหาของไซต์ที่เผยแพร่ในเว็บเบราว์เซอร์โดยไปที่ URL ฐานที่สร้างโดย Commerce โดยตรง:
