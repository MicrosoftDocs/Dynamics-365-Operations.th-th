...
คุณยังสามารถเพิ่มโดเมนที่กำหนดเองได้ด้วย โดยบนหน้าการจัดการ Commerce ของสภาพแวดล้อมของโครงการ ภายใต้หัวข้อย่อย **อีคอมเมิร์ซ** ให้เลือก **+ เพิ่มโดเมนที่กำหนดเอง** แถบเลื่อนจะแสดงโดเมนที่กำหนดเองที่มีอยู่และแสดงตัวเลือกในการเพิ่มโดเมนที่กำหนดเองใหม่

## <a name="update-which-commerce-scale-unit-is-used"></a>อัปเดต Commerce Scale Unit ที่ใช้

โดยทั่วไป Commerce Scale Unit (CSU) ที่ใช้โดย Commerce จะมีการเลือกเมื่อสร้างสภาพแวดล้อมครั้งแรก Commerce ช่วยให้คุณสามารถเปลี่ยนแปลงอินสแตนซ์ CSU ที่สภาพแวดล้อมของคุณใช้ ซึ่งทำให้คุณสามารถรักษาสถาปัตยกรรมของคุณผ่านฟังก์ชันบริการตนเองได้ดีขึ้น และลดจำนวนครั้งในการติดต่อฝ่ายสนับสนุน เมื่อต้องการอัปเดตอินสแตนซ์ CSU ของคุณ ให้ไปที่หน้าการจัดการ Commerce ของสภาพแวดล้อมของคุณสำหรับโครงการ แล้วเลือก **อัปเดตสเกลยูนิต** ใช้แถบเลื่อน **Commerce Scale Unit ใหม่** เพื่อเลือกอินสแตนซ์ CSU ใหม่จากรายการ CSU ที่พร้อมใช้งานสำหรับสภาพแวดล้อมของคุณ
...
- ตั้งค่าบริการประตูหน้า เช่น Azure Front Door เพื่อจัดการปริมาณงานส่วนหน้าและเชื่อมต่อกับสภาพแวดล้อม Commerce ของคุณ ซึ่งจะมีการควบคุมโดเมนและการจัดการใบรับรองมากขึ้น และนโยบายความปลอดภัยแบบละเอียดเพิ่มเติม

- ใช้อินสแตนซ์ Azure Front Door ที่จัดหา Commerce ซึ่งจำเป็นต้องมีการดำเนินร่วมกับทีม Dynamics 365 Commerce สำหรับการตรวจสอบโดเมนและการขอรับใบรับรอง SSL สำหรับโดเมนการทำงานจริงของคุณ
...
- คุณจะต้องยืนยันว่าคำขอบริการนี้ใช้สำหรับโดเมนที่มีอยู่ (ใช้สำหรับไซต์ที่ใช้งานอยู่ในปัจจุบัน) หรือเป็นโดเมนใหม่ 
