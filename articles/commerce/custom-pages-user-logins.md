...
---
# <a name="set-up-custom-pages-for-user-logins"></a>ตั้งค่าหน้าแบบกำหนดเองสำหรับการล็อกอินของผู้ใช้
...
1. ในฟิลด์ **URI ของหน้าแบบกำหนดเอง** ให้ป้อน URL แบบเต็มในการลงชื่อเข้าใช้ รวมคำต่อท้าย **preloadscripts=true** ตัวอย่างเช่น ป้อน **www.\<โดเมนของฉัน\>.com/sign-in?preloadscripts=true**
...
ในชุดเริ่มต้น การลงชื่อเข้าใช้ในโมดูลจะมีการกรอกข้อมูลล่วงหน้ากับสตริงข้อความเริ่มต้นสำหรับป้ายชื่อและคำอธิบาย คุณสามารถเลือกกำหนดสตริงเหล่านี้ในชุดการพัฒนาซอฟต์แวร์ (SDK) โดยอัพเดตค่าในไฟล์ global.json สากลสำหรับลงชื่อเข้าใช้ในโมดูล
...
อย่างไรก็ตาม ในไฟล์ global.json สำหรับชุดเริ่มต้นการลงชื่อเข้าใช้ในโมดูล คุณสามารถแก้ไขข้อความเป็น **ลืมรหัสผ่านใช่หรือไม่** ดังที่แสดงในภาพประกอบต่อไปนี้

![ข้อความลิงก์ที่อัพเดตในการลงชื่อเข้าใช้ในโมดูลไฟล์ global.json](./media/B2C_CustomizingStringsForModule.png)

หลังจากที่คุณอัพเดตไฟล์ global.json และเผยแพร่การเปลี่ยนแปลงของคุณ ข้อความลิงก์ใหม่จะปรากฏขึ้นในการลงชื่อเข้าใช้โมดูลในทั้งใน Commerce และบนหน้าลงชื่อเข้าใช้แบบใช้งานจริง
