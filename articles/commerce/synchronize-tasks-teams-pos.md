...
> [!NOTE]
> ก่อนที่คุณจะพยายามรวมการจัดการงานกับ Teams ตรวจสอบให้แน่ใจว่าคุณได้เปิดใช้งาน [การรวม Dynamics 365 Commerce กับ Microsoft Teams](enable-teams-integration.md) 
...
> [!NOTE]
> หลังจากเผยแพร่รายการงานใน Teams เรียบร้อยแล้ว งานจะแสดงใน POS จากนั้นผู้จัดการ POS และพนักงานเก็บเงินต้องเปิดการเข้าสู่ระบบ Azure AD ใน POS สำหรับข้อมูลเพิ่มเติม โปรดดูที่บทความ [เปิดใช้งานการรับรองความถูกต้อง Azure Active Directory สำหรับการลงชื่อเข้าใช้ POS](aad-pos-logon.md) 
