...
หน้าโปรไฟล์ของฉันแสดงรายละเอียดโปรไฟล์บัญชีผู้ใช้โดยใช้โมดูลโปรไฟล์บัญชี หน้าจะแสดงที่อยู่อีเมลที่เชื่อมโยงกับบัญชีของผู้ใช้รวมทั้งการลักษณะที่ตั้งค่าไว้ของบัญชี หากตั้งค่าแอตทริบิวต์ลูกค้าที่ศุลกากร ส่วน "ข้อมูลเพิ่มเติม" จะแสดงแอตทริบิวต์เหล่านั้นด้วย ผู้ใช้สามารถแก้ไขชื่อ การลักษณะ หรือข้อมูลเพิ่มเติมของพวกเขา (ถ้ามี)
