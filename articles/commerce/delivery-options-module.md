...
description: บทความนี้ครอบคลุมถึงโมดูลตัวเลือกการจัดส่งและอธิบายวิธีการตั้งค่าคอนฟิกใน Microsoft Dynamics 365 Commerce
author: anupamar-ms
ms.date: 02/24/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9268459"
---
# <a name="delivery-options-module"></a>โมดูลตัวเลือกการจัดส่ง

[!include [banner](includes/banner.md)]

บทความนี้ครอบคลุมถึงโมดูลตัวเลือกการจัดส่งและอธิบายวิธีการตั้งค่าคอนฟิกใน Microsoft Dynamics 365 Commerce
...
> [!NOTE]
> คุณอาจประสบกับการจัดการการจัดส่งที่ไม่สอดคล้องกัน หรือคุณอาจไม่เห็นค่าธรรมเนียมระดับส่วนหัวที่ไม่เป็นตามสัดส่วนในช่องทางอีคอมเมิร์ซของคุณ สําหรับแนวทางเกี่ยวกับวิธีการแก้ไขปัญหาเหล่านี้ ดูที่ [เปิดใช้งานการจัดการวิธีการจัดส่งที่สอดคล้องกันในช่องทางอีคอมเมิร์ซ](consistent-delivery-mode-handling.md)
