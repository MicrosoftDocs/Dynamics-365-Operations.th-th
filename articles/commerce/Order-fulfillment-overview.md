...
การเติมสินค้าตามใบสั่ง [รหัสการดำเนินงาน 928](https://docs.microsoft.com/dynamics365/unified-operations/retail/pos-operations) สามารถใช้ในการเข้าถึงพื้นที่ทำงานของการเติมสินค้าตามใบสั่งร้านค้าในจุดขายหน้าร้านได้
...
รูปแบบรายการหยิบสินค้าได้รับการกำหนดค่าในการค้าและเพิ่มไปยังโปรไฟล์ใบรับสินค้า สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการตั้งค่าโพรไฟล์ใบเสร็จ ดู [เท็มเพลตใบเสร็จและการพิมพ์](https://docs.microsoft.com/dynamics365/unified-operations/retail/receipt-templates-printing)
