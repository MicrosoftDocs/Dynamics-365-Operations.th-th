...
บนหน้าเช็คเอาท์ คุณสามารถมีทั้ง Adyen และการตั้งค่าคอนฟิกการเชื่อมต่อ PayPal โมดูลการชำระเงินได้รับการปรับปรุงด้วยคุณสมบัติเพิ่มเติมเพื่อช่วยระบุว่าตัวเชื่อมต่อที่ควรจะทำงานด้วย สำหรับรายละเอียด ให้ดูที่ **ชนิดการชำระเงินที่ได้รับการสนับสนุน** และคุณสมบัติโมดูล **เป็นการชำระเงินหลักหรือไม่** ในตารางต่อไปนี้
...
|ชนิดการชำระเงินที่รองรับ| สตริง| ถ้ามีการตั้งค่าคอนฟิกตัวเชื่อมต่อการชำระเงินหลายรายการ คุณควรระบุสตริงการชำระเงินที่ได้รับการสนับสนุนตามที่กำหนดไว้ในการตั้งค่าคอนฟิกการเชื่อมต่อการชำระเงินของ Commerce headquarters (ดูที่ภาพต่อไปนี้) ถ้าว่างเปล่า ฟิลด์นี้จะเป็นค่าเริ่มต้นในการเชื่อมต่อการชำระเงิน Adyen มีการเพิ่มใน Commerce รีลีส 10.0.14|
...
|ใช้รหัสตัวเชื่อมต่อ| **จริง** หรือ **เท็จ** | ใช้คุณสมบัตินี้หากมีการตั้งค่าคอนฟิกตัวเชื่อมต่อการเงินหลายตัวเชื่อมต่อในไซต์ หากเป็น **จริง** ตัวเชื่อมต่อต้องใช้รหัสตัวเชื่อมต่อสำหรับความสัมพันธ์ของการชำระเงิน|
|ใช้รหัสภาษาของชุดเบราว์เซอร์สำหรับ iFrame|  **จริง** หรือ **เท็จ** | (เฉพาะ Adyen เท่านั้น) หากเป็น **จริง** Adyen iFrame จะแสดงภาษาตามบริบทเบราว์เซอร์ของผู้ใช้ไซต์ แทนที่จะใช้รหัสภาษาของช่องทาง Commerce ที่กำหนดค่าไว้สำหรับไซต์ มีการเพิ่มใน Commerce รีลีส 10.0.27|

ภาพประกอบต่อไปนี้แสดงตัวอย่างของค่า **ชนิดการชำระเงินที่ได้รับการสนับสนุน** กำหนดเป็น "PayPal" ในการตั้งค่าคอนฟิกการเชื่อมต่อการชำระเงินใน Commerce headquarters
![ตัวอย่างของชนิดการชำระเงินที่ได้รับการสนับสนุนใน Commerce headquarters](./media/ecommerce-paymenttendertypes.png)
...
## <a name="configure-the-adyen-and-paypal-payment-connectors-when-both-are-used"></a>ตั้งค่าคอนฟิกตัวเชื่อมต่อการชำระเงิน Adyen และ PayPal เมื่อใช้ทั้งสองอย่าง

หากมีการใช้ทั้งตัวเชื่อมต่อการชำระเงิน Adyen และ PayPal กับไซต์ของคุณ ให้ปฏิบัติตามขั้นตอนต่อไปนี้ในตัวสร้างไซต์ Commerce เพื่อเพิ่มโมดูลการชำระเงินให้กับแต่ละตัวเชื่อมต่อในโมดูลเช็คเอาท์ แล้วตั้งค่าคอนฟิกคุณสมบัติต่างๆ ของแต่ละโมดูล

1. ในบานหน้าต่างคุณสมบัติในโมดูลการชำระเงิน PayPal ให้ปฏิบัติตามขั้นตอนต่อไปนี้

    1. ในฟิลด์คุณสมบัติ **ชนิดการจ่ายเงินที่รองรับ** ให้ป้อน **PayPal**
    1. ล้างกล่องกาเครื่องหมายของคุณสมบัติ **เป็นการชำระเงินหลักหรือไม่**
    1. เลือกกล่องกาเครื่องหมายของคุณสมบัติ **ใช้รหัสตัวเชื่อมต่อ**

1. ในบานหน้าต่างคุณสมบัติในโมดูลการชำระเงิน Adyen ให้ปฏิบัติตามขั้นตอนต่อไปนี้

    1. ปล่อยฟิลด์คุณสมบัติ **ชนิดการชำระเงินที่รองรับ** เว้นว่างไว้
    1. เลือกกล่องกาเครื่องหมายของคุณสมบัติ **เป็นการชำระเงินหลักหรือไม่**
    1. เลือกกล่องกาเครื่องหมายของคุณสมบัติ **ใช้รหัสตัวเชื่อมต่อ**

> [!NOTE]
> เมื่อคุณตั้งค่าคอนฟิกตัวเชื่อมต่อ Adyen และ PayPal ที่จะใช้พร้อมกัน การตั้งค่าคอนฟิก **ตัวเชื่อมต่อการชำระเงิน Dynamics 365 สำหรับ Adyen** ต้องอยู่ในตําแหน่งแรกในการตั้งค่าคอนฟิกตัวเชื่อมต่อ **บัญชีการชำระเงิน** ของช่องทางออนไลน์ใน Commerce headquarters เมื่อต้องการยืนยันหรือเปลี่ยนลำดับตัวเชื่อมต่อ ให้ไปที่ **ร้านค้าออนไลน์** และเลือกช่องทางสำหรับไซต์ของคุณ จากนั้นบนแท็บ **ตั้งค่า** บนแท็บด่วน **บัญชีการชำระเงิน** ภายใต้ **ตัวเชื่อมต่อ** ตรวจสอบว่าการตั้งค่าคอนฟิก **ตัวเชื่อมต่อการชำระเงิน Dynamics 365 สำหรับ Adyen** อยู่ในตําแหน่งแรก (ซึ่งคือบรรทัดบนสุด) และการตั้งค่าคอนฟิก **ตัวเชื่อมต่อการชำระเงิน Dynamics 365 สำหรับ PayPal** อยู่ในบรรทัดที่สอง เพิ่มหรือลบตัวเชื่อมต่อตามต้องการเพื่อเรียงลำดับใหม่
