...
> [!NOTE]
> เมื่อคุณตั้งค่าคอนฟิกตัวเชื่อมต่อ Adyen และ PayPal ที่จะใช้พร้อมกัน การตั้งค่าคอนฟิก **ตัวเชื่อมต่อการชำระเงิน Dynamics 365 สำหรับ Adyen** ต้องอยู่ในตําแหน่งแรกในการตั้งค่าคอนฟิกตัวเชื่อมต่อ **บัญชีการชำระเงิน** ของช่องทางออนไลน์ในศูนย์ควบคุม Commerce เมื่อต้องการยืนยันหรือเปลี่ยนลำดับตัวเชื่อมต่อ ให้ไปที่ **ร้านค้าออนไลน์** และเลือกช่องทางสำหรับไซต์ของคุณ จากนั้นบนแท็บ **ตั้งค่า** บนแท็บด่วน **บัญชีการชำระเงิน** ภายใต้ **ตัวเชื่อมต่อ** ตรวจสอบว่าการตั้งค่าคอนฟิก **ตัวเชื่อมต่อการชำระเงิน Dynamics 365 สำหรับ Adyen** อยู่ในตําแหน่งแรก (ซึ่งคือบรรทัดบนสุด) และการตั้งค่าคอนฟิก **ตัวเชื่อมต่อการชำระเงิน Dynamics 365 สำหรับ PayPal** อยู่ในบรรทัดที่สอง เพิ่มหรือลบตัวเชื่อมต่อตามต้องการเพื่อเรียงลำดับใหม่
