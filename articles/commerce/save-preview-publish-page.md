...
เมื่อต้องการบันทึกหน้า คุณต้องทำการเช็คเอาท์ไปยังตัวคุณเองและเปิดในตัวแก้ไขหน้า คุณควรบันทึกหน้าทันทีหลังจากที่คุณแก้ไขแล้ว เพื่อช่วยรับประกันว่ามีการจัดเก็บการเปลี่ยนแปลงของคุณ
...
เครื่องมือการสร้างมีลักษณะการทำงานการแสดงตัวอย่างสองชนิด: a "สิ่งที่คุณเห็นคือสิ่งที่คุณได้รับ" (WYSIWYG) แสดงตัวอย่างบานหน้าต่างในตัวแก้ไขหน้า และหน้าต่างแสดงตัวอย่างที่แยกต่างหาก

ขณะที่คุณกำลังใช้ตัวแก้ไขหน้า "สิ่งที่คุณเห็นคือสิ่งที่คุณได้รับ" (WYSIWYG) แสดงตัวอย่างที่ปรากฏขึ้นในบานหน้าต่างศูนย์ การแสดงตัวอย่างนี้จะได้รับการอัพเดตโดยอัตโนมัติเมื่อใดก็ตามที่คุณบันทึกหน้า นอกจากนี้คุณยังสามารถอัพเดตด้วยตนเองได้ด้วยการเลือก **รีเฟรช** บนแถบคำสั่ง การแสดงตัวอย่าง WYSIWYG แสดงหน้าเช่นเดียวกับที่ผู้ใช้ของไซต์จะเห็น แต่ตัวช่วยการสร้างจะแสดงอยู่ด้านบนของหน้านี้
...
เมื่อหน้าของคุณพร้อมแล้ว ขั้นตอนต่อไปคือเผยแพร่เพื่อให้ผู้ใช้ภายนอกสามารถดูเนื้อหาได้ ก่อนที่คุณจะสามารถเผยแพร่หน้า คุณต้องเช็คอิน
