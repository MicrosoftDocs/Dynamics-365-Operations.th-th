...
1. [เปิดใช้งานและตั้งค่าคอนฟิก Add in ส่งออกไปยัง Data Lake](#enableExportToDataLake)
1. [ติดตั้งและตั้งค่าคอนฟิก Azure Synapse workspace](#configureAzureSynapse)
1. [เพิ่มข้อมูลลับลงใน Key Vault](#addSecrets)
1. [เปิดใช้งานและตั้งค่าคอนฟิก Add-in การวิเคราะห์ของ Commerce (พรีวิว)](#enableCommerceAnalyticsAddin)
1. [ติดตั้งแอปเทมเพลต Power BI](#powerbi)
