...
เมื่อต้องการแก้ไขและตรวจสอบธุรกรรมใบสั่งใน Commerce headquarters ให้ทําตามขั้นตอนต่อไปนี้

1. ติดตั้ง [Microsoft Dynamics Office Add-in](https://appsource.microsoft.com/product/office/WA104379629?tab=Overview)
1. บนหน้า **พารามิเตอร์ Commerce** บนแท็บ **ใบสั่งของลูกค้า** บนแท็บด่วน **ใบสั่ง** ให้ระบุรหัสการระงับสำหรับ **รหัสการระงับสำหรับสําหรับข้อผิดพลาดการซิงโครไนส์ใบสั่ง**
2. หยุดงานการซิงโครไนส์ใบสั่งอื่นๆ ที่จะขัดแย้งกับช่วงเวลาของการแก้ไขและการตรวจสอบของคุณชั่วคราว
3. เปิดพื้นที่ทำงาน **การเงินของร้านค้า** ไทล์ **ข้อผิดพลาดการซิงโครไนส์ใบสั่งออนไลน์** และ **ข้อผิดพลาดการซิงโครไนส์ใบสั่งของลูกค้า** จะให้มุมมองที่กรองไว้ล่วงหน้าของหน้าธุรกรรมการขายปลีก แต่ละไทล์จะแสดงเรกคอร์ดธุรกรรมที่ล้มเหลวในการซิงโครไนส์สําหรับชนิดใบสั่งที่สอดคล้องกัน
4. เปิดหน้า **ข้อผิดพลาดการซิงโครไนส์ใบสั่งออนไลน์** หรือหน้า **ข้อผิดพลาดการซิงโครไนส์ใบสั่งของลูกค้า** เลือกเรกคอร์ดเพื่อดูรายละเอียดข้อผิดพลาดในการซิงโครไนส์ แท็บด่วน **สถานะการซิงโครไนส์** ให้รายละเอียดข้อผิดพลาดต่อไปนี้:
...
1. ในไฟล์ Excel ให้ปรับเปลี่ยนฟิลด์ที่เหมาะสมแล้วอัปโหลดข้อมูลกลับเข้าไปใน Commerce headquarters โดยใช้ฟังก์ชันการเผยแพร่ของ Dynamics Excel Add-in หลังจากที่เผยแพร่ข้อมูล การเปลี่ยนแปลงจะปรากฏในระบบ ระหว่างการเผยแพร่ จะไม่มีการตรวจสอบความถูกต้องสำหรับการเปลี่ยนแปลงที่ผู้ใช้ทำ
    > [!NOTE]
    > ถ้าคุณไม่พบฟิลด์ที่คุณต้องการแก้ไข ให้ปฏิบัติตามขั้นตอนด้านล่างเพื่อเพิ่มฟิลด์ที่ขาดหายไปในเวิร์กชีต
    >   1. เลือก **ออกแบบ** ในตัวเชื่อมต่อข้อมูล
    >   1. เลือกไอคอนดินสอถัดจากตารางที่คุณต้องการเพิ่มฟิลด์
    >   1. เลือกฟิลด์ในส่วน **ฟิลด์ที่พร้อมใช้งาน** แล้วเลือก **เพิ่ม**
    >   1. เพิ่มฟิลด์ได้มากเท่าที่คุณต้องการ แล้วเลือก **อัปเดต**
    >   1. เมื่อการอัปเดตเสร็จสมบูรณ์ คุณอาจต้องเลือก **รีเฟรช** เพื่ออัปเดตค่า

3. คุณสามารถดูบันทึกการตรวจสอบบัญชีที่สมบูรณ์ของการเปลี่ยนแปลงได้โดยการเลือก **ดูบันทึกการตรวจสอบ** ในหัวข้อ **ธุรกรรมการขายปลีก** สำหรับการเปลี่ยนแปลงในระดับหัวข้อและในส่วนและเรกคอร์ดที่เกี่ยวข้องในหน้าธุรกรรมที่เหมาะสม ตัวอย่างเช่น การเปลี่ยนแปลงทั้งหมดที่เกี่ยวข้องกับรายการขายจะแสดงขึ้นบนหน้า **ธุรกรรมการขาย** และการเปลี่ยนแปลงทั้งหมดที่เกี่ยวข้องกับการชําระเงินจะแสดงขึ้น **ธุรกรรมการชำระเงิน** รายละเอียดการตรวจสอบต่อไปนี้ได้รับการรักษาไว้สําหรับการเปลี่ยนแปลง:
