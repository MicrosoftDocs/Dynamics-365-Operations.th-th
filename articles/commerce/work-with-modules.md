...
1. ในบานหน้าต่างเค้าร่างทางด้านซ้าย ให้ขยายแผนภูมิและเลือกโมดูลเนื้อหาใดๆ (ตัวอย่างเช่น **คุณลักษณะ** **ฮีโร่** หรือ **แบนเนอร์**)
1. ในบานหน้าต่างคุณสมบัติทางด้านขวา ให้ค้นหาเนื้อหาของโมดูลและตัวควบคุมการตั้งค่า
1. ป้อนคุณสมบัติสำหรับการควบคุมโมดูลที่ต้องการใดๆ
1. ให้เลือก **บันทึก** ในแถบคำสั่ง การทำเช่นนี้จะเป็นการรีเฟรชพื้นที่ทำงานของการแสดงตัวอย่างด้วย
