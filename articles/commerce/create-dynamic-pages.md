...
นอกจากนี้คุณยังสามารถแทนที่เซกเมนต์ URL ที่ใส่พารามิเตอร์ด้วยหน้าตัวสร้างไซต์ได้ ตัวอย่างเช่น หน้าที่สร้างขึ้นในตัวสร้างไซต์และที่มีชื่อว่า **blog\_summary** สามารถแมปกับ URL `https://fabrikam.com/blog/about-this-blog` เมื่อมีการร้องขอ URL `https://fabrikam.com/blog` ด้วยเซกเมนต์ `/about-this-blog` ในตอนท้าย เนื้อหาของหน้า **blog\_summary** จะถูกส่งคืนแทนเซกเมนต์ `/about-this-blog` ที่ตีความเซกเมนต์เป็นพารามิเตอร์ที่หน้า `https://fabrikam.com/blog` จะใช้ 
