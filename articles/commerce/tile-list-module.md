...
โมดูลรายการไทล์ถูกขับเคลื่อนด้วยข้อมูลจากระบบการจัดการเนื้อหา (CMS) ซึ่งไม่ได้ขึ้นอยู่กับโมดูลหรือข้อมูลอื่นใดจาก Commerce headquarters สามารถเพิ่มโมดูลรายการไทล์ไปยังหน้าไซต์ใดๆ ที่ซึ่งผู้ค้าปลีกต้องการทำตลาด หรือส่งเสริมบางสิ่งบางอย่าง (ตัวอย่างเช่น ผลิตภัณฑ์ ประเภท หรือแบรนด์)
