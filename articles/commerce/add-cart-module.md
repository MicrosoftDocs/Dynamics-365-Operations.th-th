...
> [!IMPORTANT]
> ใน Dynamics 365 Commerce รุ่น 10.0.14 และรุ่นที่ใหม่กว่า สินค้าในรถเข็นจะรวมกันตามการตั้งค่าที่กำหนดไว้ในโพรไฟล์การทำงานแบบออนไลน์สำหรับร้านค้าออนไลน์ใน Commerce headquarters สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการสร้างโพรไฟล์การทำงานแบบออนไลน์และตั้งค่าคุณสมบัติที่จำเป็นสำหรับการรวม โปรดดู [สร้างโพรไฟล์การทำงานแบบออนไลน์](online-functionality-profile.md)
...
1. ในกล่องโต้ตอบ **เลือกส่วนย่อย** ให้เลือกโมดูล **รถเข็น**
