...
หัวข้อนี้จะอธิบายถึงองค์ประกอบต่างๆ ที่ใช้ในหน้าของไซต์ Microsoft Dynamics 365 Commerce
...
| URL | <p>**ข้อกำหนด:** ที่อยู่ของแหล่งข้อมูลในอินเทอร์เน็ต (URLs) เป็นที่อยู่ที่ชี้ไปที่เว็บเพจหรือ URL อื่นๆ</p><p>**ตำแหน่งที่ถูกเลือกไว้:** มีการเลือก URL เมื่อมีการกำหนดการเชื่อมโยงระหว่างหน้า</p><p>**ตำแหน่งที่มีการแก้ไข:** URL จะถูกแก้ไขในโปรแกรมแก้ไข URL ไม่จำเป็นต้องระบุรหัสเพื่อสร้างหรือปรับเปลี่ยน</p> |
