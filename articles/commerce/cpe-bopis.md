...
description: บทความนี้จะอธิบายถึงวิธีการตั้งค่าคอนฟิกการซื้อออนไลน์ การเบิกสินค้าในร้านค้า (BOPIS) ในสภาพแวดล้อมการประเมิน Microsoft Dynamics 365 Commerce หลังจากที่มีการจัดเตรียมแล้ว
author: BrianShook
ms.date: 07/16/2020
ms.topic: article
ms.prod: ''
...
5. กล่องโต้ตอบการรับรองความถูกต้องจะปรากฏขึ้น เลือกบัญชีที่ใช้ที่อยู่อีเมลที่เกี่ยวข้องก่อนหน้านี้กับผู้ปฏิบัติงาน **000713 - Andrew Collette**
    ...
    > [!NOTE]
    > ถ้าคุณยังไม่ได้เชื่อมโยงผู้ปฏิบัติงานกับข้อมูลประจำตัวของคุณ การเรียกใช้งานจะไม่ประสบความสำเร็จ ในกรณีนี้ ให้ทำตามขั้นตอนภายใต้ส่วน "เชื่อมโยงผู้ปฏิบัติงานกับรหัสประจำตัวของคุณ" ในบทความ [ตั้งค่าคอนฟิกสภาพแวดล้อมการประเมินของ Dynamics 365 Commerce](cpe-post-provisioning.md#associate-a-worker-with-your-identity)
