...
รูปภาพต่อไปนี้แสดงตัวอย่างวิธีการชำระเงินสดและการตั้งค่าคอนฟิกแท็บ **ยอดเงิน**

![การตั้งค่าตัวอย่างวิธีการชำระเงินสำหรับยอดเงิน](media/payment-methods-recount.png)

> [!NOTE]
> ค่าสำหรับแท็บ **ยอดเงิน** จะถูกแคชใน Retail Server และจะไม่มีผลทันทีหลังจากที่คุณใช้งานของงานกำหนดการกระจาย คุณอาจต้องรีสตาร์ท Cloud Scale Unit เพื่อใช้ค่าเหล่านี้เพื่อทดสอบทันที
