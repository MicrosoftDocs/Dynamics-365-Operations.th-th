...
หัวข้อนี้ครอบคลุมถึงการรับประกันแบบขยาย และอธิบายวิธีการสร้างและตั้งค่าคอนฟิกใน Microsoft Dynamics 365 Commerce
...
การดำเนินงานของ POS สองรายการช่วยให้บริษัทผู้ขายสามารถขายสินค้าที่มีการรับประกันได้ในระหว่างลำดับงานสำหรับการซื้อของลูกค้า:
...
เมื่อการรับประกันถูกขายในธุรกรรมเงินสดและการขนส่ง หลังจากที่มีการลงรายการบัญชีธุรกรรมในศูนย์ควบคุม Commerce ผู้ใช้ Commerce สามารถรันงาน **ประมวลผลธุรกรรมการรับประกัน** เพื่อประมวลผลธุรกรรมการรับประกัน และสร้างนโยบายการรับประกัน

เมื่อต้องการประมวลผลธุรกรรมการรับประกันในศูนย์ควบคุม Commerce ให้ทำตามขั้นตอนเหล่านี้
...
ตารางต่อไปนี้จะอธิบายคุณสมบัตินโยบายการรับประกันและค่า ในศูนย์ควบคุม Commerce ตารางฐานข้อมูลจะมีชื่อว่า WARRANTYPOLICY
...
คุณสามารถค้นหาใบรับสินค้าได้เฉพาะเมื่อมีการรันงานการดึง (งาน P) เพื่ออัพโหลดใบรับสินค้าไปยังศูนย์ควบคุม Commerce เมื่อต้องการรันงาน P ให้ไปที่ **Retail และ Commerce \> Retail และ Commerce IT \> กำหนดการการกระจาย** เลือกงาน **P-0001** และจากนั้น เลือก **เรียกใช้เดี๋ยวนี้**
