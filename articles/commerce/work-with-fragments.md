...
1. ในบานหน้าต่างเค้าร่างทางด้านซ้ายหรือโดยตรงในพื้นที่ทำงานหลัก ให้เลือกโมดูลที่ตั้งค่าคอนฟิกไว้ก่อนหน้านี้
1. เลือกจุดไข่ปลา (**...**) ที่อยู่ถัดจากชื่อของโมดูลในบานหน้าต่างเค้าร่างหรือแถบเครื่องมือของโมดูลที่เลือกในพื้นที่ทำงาน 
1. เลือก **ใช้ร่วมกันเป็นส่วนของหน้า** 
1. ในกล่องโต้ตอบ **บันทึกเป็นส่วนของหน้า** ให้ป้อนชื่อของส่วน
1. เลือก **ตกลง** เพื่อบันทึกการตั้งค่าคอนฟิกโมดูลเป็นส่วนที่สามารถเพิ่มเข้าไปในหน้าอื่นๆ

รูปภาพต่อไปนี้แสดงวิธีการบันทึกการตั้งค่าคอนฟิกโมดูลเป็นส่วนย่อย
...
รูปภาพต่อไปนี้แสดงตำแหน่งที่จะสร้างส่วนย่อยใหม่
...
1. ในบานหน้าต่างออนไลน์ ให้เลือกจุดไข่ปลา (**...**) ที่อยู่ถัดจากชื่อคอนเทนเนอร์หรือช่องเสียบ  อีกทางหนึ่งคือ ถ้าใช้พื้นที่ทำงานหลัก ให้เลือกสัญลักษณ์บวก (**+**)  
1. เลือก **เพิ่มส่วน**
...
1. ในกล่องโต้ตอบ **เพิ่มส่วน** ให้ค้นหาและเลือกส่วนที่จะเพิ่ม ถ้าไม่มีการระบุส่วนที่มีอยู่ คุณอาจต้องสร้างส่วนใดส่วนหนึ่งจากชนิดโมดูลที่มีการสนับสนุนคอนเทนเนอร์หรือช่องเสียบที่เลือกก่อน
...
1. ในบานหน้าต่างเค้าร่างทางด้านซ้าย ให้เลือกปุ่มจุดไข่ปลา (**...**) ที่อยู่ถัดจากชื่อส่วนที่ต้องการลบ แล้วเลือกสัญลักษณ์ถังขยะ  อีกทางหนึ่งคือ คุณสามารถเลือกส่วนต่างๆ ในพื้นที่ทำงาน และเลือกสัญลักษณ์ถังขยะได้ในแถบเครื่องมือของส่วน
