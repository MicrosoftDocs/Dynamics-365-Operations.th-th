...
description: บทความนี้ครอบคลุมถึงโมดูลบัตรของขวัญและอธิบายวิธีการเพิ่มลงในเพจของไซต์ใน Microsoft Dynamics 365 Commerce
author: anupamar-ms
ms.date: 08/02/2021
ms.topic: article
ms.prod: ''
...
บทความนี้ครอบคลุมถึงโมดูลบัตรของขวัญและอธิบายวิธีการเพิ่มลงในเพจของไซต์ใน Microsoft Dynamics 365 Commerce
...
- **เปิดใช้งานสำหรับผู้ใช้ที่เป็นแขก** – เมื่อเปิดใช้งานคุณสมบัตินี้ ผู้ใช้ที่เป็นแขกสามารถแลกหรือตรวจสอบยอดดุลบนบัตรของขวัญได้ คุณสมบัตินี้กำหนดให้ต้องเปิดใช้งานการเข้าถึงโดยไม่ระบุชื่อ (แขก) สำหรับบัตรของขวัญในสำนักงานใหญ่ของ Commerce สำหรับข้อมูลเพิ่มเติม ดูที่ [เปิดใช้งานการเช็คเอาท์ด้วยบัตรของขวัญสำหรับแขก](#enable-gift-card-payments-for-guest-checkout)

> [!IMPORTANT]
> คุณสมบัติ **เปิดใช้งานสำหรับผู้ใช้ที่เป็นแขก** พร้อมใช้งาน ณ การนำออกใช้ Commerce รุ่น 10.0.21 ซึ่งจำเป็นต้องมีการติดตั้งแพคเกจไลบรารีโมดูล Commerce รุ่น 9.31
