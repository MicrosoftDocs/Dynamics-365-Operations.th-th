...
description: บทความนี้อธิบายสถานการณ์การแมปช่องทางทั่วไปเพิ่มเติมบางส่วนใน Microsoft Dynamics 365 Commerce ที่สามารถคาดการณ์สำหรับความต้องการทางธุรกิจอื่นๆ ส่วนใหญ่
author: samjarawan
ms.date: 05/11/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8902774"
---
# <a name="map-channels-to-e-commerce-sites"></a>แมปช่องทางกับไซต์อีคอมเมิร์ซ

บทความนี้อธิบายสถานการณ์การแมปช่องทางทั่วไปเพิ่มเติมบางส่วนใน Microsoft Dynamics 365 Commerce ที่สามารถคาดการณ์สำหรับความต้องการทางธุรกิจอื่นๆ ส่วนใหญ่
...
บทความนี้กล่าวถึงสถานการณ์ต่อไปนี้:
...
ช่องทางออนไลน์ช่องทางเดียวสามารถแมปกับไซต์ไซต์อีคอมเมิร์ซไซต์เดียวในโปรแกรมสร้างไซต์ หากต้องการข้อมูลเพิ่มเติมเกี่ยวกับการสร้างไซต์ใหม่และแมปกับช่องทาง ดูที่ส่วน [แมปช่องทางกับไซต์ในโปรแกรมสร้างไซต์](#map-a-channel-to-a-site-in-site-builder) ของบทความนี้
...
สำหรับข้อมูลเกี่ยวกับวิธีการช่วยลูกค้าสลับไปมาระหว่างภาษาด้วยตนเอง โปรดดูที่ส่วน [เพิ่มและตั้งค่าคอนฟิกโมดูลตัวเลือกไซต์](#add-and-configure-the-site-picker-module) ของบทความนี้ สำหรับข้อมูลเกี่ยวกับวิธีการปรับแต่งเพจและส่วนย่อยที่แปลแล้ว โปรดดูที่ส่วน [จัดการเนื้อหาของไซต์ที่มีหลายช่องทางและหลายภาษา](#manage-site-content-that-has-multiple-channels-and-languages)
...
คุณอาจต้องการให้ไซต์ของคุณมีรายการดรอปดาวน์ที่ช่วยให้ผู้ใช้สามารถสลับไปยังตลาดเฉพาะด้วยตนเองได้ สำหรับข้อมูลเพิ่มเติม ให้ดูที่ส่วน [เพิ่มและตั้งค่าคอนฟิกโมดูลตัวเลือกไซต์](#add-and-configure-the-site-picker-module) ในบทความนี้
...
หากต้องการข้อมูลเพิ่มเติมเกี่ยวกับวิธีการทำงานกับตัวแปรของหน้า โปรดดูที่ส่วน [ใช้ตัวแปรของหน้ากับแต่ละภาษา](#implement-page-variants-for-each-language) ของบทความนี้
