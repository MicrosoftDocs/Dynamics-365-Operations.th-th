...
| **ตัวเลือกการปรับใช้**              | ทั้งหมด |
| **สถานะ**                         | ไม่สนับสนุน: ณ รุ่น 10.0.21 SDK ที่จัดส่งผ่านทาง LCS VMs จะถูกลบออกในเดือนเมษายน 2023 |
...
| **ตัวเลือกการปรับใช้**              | ทั้งหมด |
| **สถานะ**                         | ไม่สนับสนุน: ณ รุ่น 10.0.21 การสนับสนุนแพคเกจ POS และรูปแบบส่วนขยายรวมโดยใช้ ModernPos.Sln, CloudPOs.sln และ POS Extensons.csproj ใน Retail SDK จะถูกลบออกในเดือนเมษายน 2023 |
