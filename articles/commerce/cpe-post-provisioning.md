...
2. ไปที่ **พารามิเตอร์ Commerce > พารามิเตอร์การตั้งค่าคอนฟิก** และตรวจสอบให้แน่ใจว่ามีรายการสำหรับ **ProductSearch.UseAzureSearch** ตั้งค่าเป็น **จริง** ถ้ารายการนี้ขาดหายไป คุณสามารถเพิ่มรายการนี้และเรียกใช้ **ฐานข้อมูลช่องทาง > การซิงค์แบบเต็ม** สำหรับ Commerce Scale Unit ที่เชื่อมโยงกับเว็บไซต์อีคอมเมิรซ์ของคุณ
...
1. ใช้เมนูด้านซ้ายเพื่อไปที่ **โมดูล \> Retail และ Commerce \> การตั้งค่า Headquarters \> ตัวจัดกำหนดการของ Commerce \> ฐานข้อมูลช่องทาง**
