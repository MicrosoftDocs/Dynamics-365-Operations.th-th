...
ลักษณะการใช้งานการกําหนดขีดจํากัดปริมาณช่วยให้มั่นใจว่าปริมาณต่สุด สูงสุด หลายรายการ และปริมาณมาตรฐาน ที่ตั้งค่าคอนฟิกใน Microsoft (ในการตั้งค่าใบสั่งเริ่มต้น หรือการตั้งค่าไซต์โปรแกรมสร้างไซต์ของ Commerce) จะใช้กับใบสั่งของลูกค้าที่จัดวางบนไซต์อีคอมเมิร์ซ Dynamics 365 Commerce ปัจจุบันไม่สนับสนุนขีดจํากัดปริมาณผลิตภัณฑ์ในการขายหน้าร้าน (POS) และศูนย์บริการ
