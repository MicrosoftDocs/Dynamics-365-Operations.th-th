...
description: หัวข้อนี้อธิบายวิธีการเพิ่ม ลบ และแก้ไขผู้ใช้ที่เป็นคู่ค้าทางธุรกิจบนเว็บไซต์อีคอมเมิร์ซระหว่างธุรกิจกับธุรกิจ (B2B) Microsoft Dynamics 365 Commerce และในศูนย์ควบคุม Commerce
author: josaw1
ms.date: 04/19/2022
ms.topic: article
ms.prod: ''
...
หัวข้อนี้อธิบายวิธีการเพิ่ม ลบ และแก้ไขผู้ใช้ที่เป็นคู่ค้าทางธุรกิจบนเว็บไซต์อีคอมเมิร์ซระหว่างธุรกิจกับธุรกิจ (B2B) Microsoft Dynamics 365 Commerce และในศูนย์ควบคุม Commerce

> [!NOTE]
> - หัวข้อ [จัดการคู่ค้าทางธุรกิจ B2B โดยใช้ลำดับชั้นของลูกค้า](partners-customer-hierarchies.md) เป็นข้อกำหนดเบื้องต้นสำหรับเอกสารนี้
> - ตรวจสอบให้แน่ใจว่าคุณเริ่มต้นเอนทิตี้ชนิดเอกสารในศูนย์ควบคุม Commerce โดยเปิดแบบฟอร์ม **ชนิดเอกสาร** ที่ **การจัดการองค์กร \> การจัดการองค์กร \> ชนิดเอกสาร**
...
หากต้องการอนุมัติคำขอของคู่ค้าทางธุรกิจในศูนย์ควบคุม Commerce ให้ทำตามขั้นตอนต่อไปนี้
...
เมื่อต้องการตั้งค่าการแจ้งเตือนทางอีเมลในศูนย์ควบคุม Commerce สำหรับเหตุการณ์ของชนิดการแจ้งเตือน **ผู้ที่มีแนวโน้มจะเป็นลูกค้า B2B ที่ได้รับอนุมัติ** หรือ **ผู้ที่มีแนวโน้มจะเป็นลูกค้า B2B ที่ปฏิเสธ** ให้ปฏิบัติตามขั้นตอนต่อไปนี้
...
> [!NOTE]
> เมื่อคุณลบผู้ใช้ออกจากรายชื่อผู้ใช้ที่สามารถเข้าถึงเว็บไซต์อีคอมเมิร์ซของ B2B เรกคอร์ดลูกค้าที่สอดคล้องจะถูกลบออกจากเรกคอร์ดลำดับชั้นของลูกค้าของคู่ค้าทางธุรกิจ อย่างไรก็ตาม ตัวเรกคอร์ดลูกค้าเองไม่ได้ถูกลบออกจากศูนย์ควบคุม Commerce
...
ผู้ดูแลระบบสามารถเตรียมพร้อมคู่ค้าทางธุรกิจและผู้ใช้ได้โดยตรงในศูนย์ควบคุม Commerce ความสามารถนี้มีประโยชน์ต่อการเตรียมความพร้อมคู่ค้าทางธุรกิจที่มีอยู่ของคุณบนเว็บไซต์อีคอมเมิร์ซของ B2B

หากต้องการเตรียมพร้อมคู่ค้าทางธุรกิจและผู้ใช้ในศูนย์ควบคุม Commerce ให้ทำตามขั้นตอนต่อไปนี้
...
- งานทั้งหมดที่กล่าวถึงในหัวข้อนี้สามารถตั้งค่าคอนฟิกให้รันในกําหนดการในรูปแบบชุดงานได้ ความคาดหวังคือคู่ค้าทางธุรกิจจะตั้งค่าคอนฟิกชุดงานตามความกําหนด
- ปัจจุบัน สามารถแต่งตั้งเรกคอร์ดผู้ใช้/ลูกค้าได้เพียงเรกคอร์ดเดียวเป็นผู้ใช้ระดับผู้ดูแลระบบ และสามารถเปลี่ยนบทบาทนั้นในศูนย์ควบคุม Commerce เท่านั้น ไม่มีการสนับสนุนความสามารถด้านการบริการตนเองที่แจ้งให้คู่ค้าทางธุรกิจแต่งตั้งผู้ดูแลหลายคน หรือเปลี่ยนผู้ดูแลระบบจากเว็บไซต์อีคอมเมิร์ซ B2B
...
- ตรรกะทางธุรกิจทั้งหมดและการตรวจสอบความถูกต้องของประสบการณ์ของผู้ใช้ในเว็บไซต์อีคอมเมิร์ซแบบ B2B ยึดตามการตั้งค่าคอนฟิกของเรกคอร์ดลูกค้าที่ถูกแมปกับผู้ใช้ในศูนย์ควบคุม Commerce
