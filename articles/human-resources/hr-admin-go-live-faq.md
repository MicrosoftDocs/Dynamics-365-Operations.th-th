...
- คุณสามารถใช้การรวม Common Data Service กับการซิงโครไนส์เอนทิตีที่เลือกลงในฐานข้อมูล Common Data Service สำหรับข้อมูลเพิ่มเติม ให้ดู [เอนทิตี Common Data Service](hr-developer-entities.md) 
...
Microsoft ยังคงมีสำเนาสำรองเพียงพอสำหรับการอนุญาตให้มีการคืนสภาพเวลา (PITR) ภายในเจ็ดวันหลังสุด 
