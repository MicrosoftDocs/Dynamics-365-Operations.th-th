...
1. บนพื้นที่ทำงาน **การขาดงานและการลางาน** โปรดเลือกแท็บ **ลิงก์**
2. ภายใต้ **การตั้งค่า** ให้เลือก **ชนิดของการลางานและการขาดงาน**
3. เลือก **ใหม่**
4. ป้อนชื่อสำหรับชนิดการลางานภายใต้ **ชนิด** ป้อนคำอธิบาย ภายใต้ **คำอธิบาย** และเลือกเวิร์กโฟลว์ใสฟิลด์ **รหัสเวิร์กโฟลว์** ขึ้นอยู่กับชนิดการลางาน เลือกชนิดคำขอในฟิลด์ **ชนิดคำขอ** ตัวอย่างเช่น เลือก **เวลาหยุดพัก** หรือ **การลางาน**
...
7. ภายใต้ **รหัสเหตุผลที่จำเป็น** ให้เลือกว่าคุณต้องการใช้รหัสเหตุผลหรือไม่ ถ้าคุณต้องการใช้รหัสเหตุผล คุณอาจต้องเพิ่มรหัสดังกล่าว ภายใต้ **รหัสเหตุผล** ให้เลือก **เพิ่ม** เลือกรหัสเหตุผลแล้วเลือกกล่องกาเครื่องหมายที่ **เปิดใช้งาน** ที่อยู่ด้านข้างรหัสเหตุผล
8. ถ้าชนิดคำขอคือ **การลางาน** ให้ทำตามขั้นตอนเหล่านี้:

      1. ภายใต้ **แบบไม่กำหนดเวลา** ให้เลือกว่าผู้ใช้ควรจะสามารถสร้างการลางานแบบไม่กำหนดเวลาหรือไม่
      2. ถ้า **แบบไม่กำหนดเวลา** เปิดใช้งานไว้ คุณสามารถเลือกได้ว่าผู้ปฏิบัติงานต้องส่งหนังสือแจ้งการกลับมาทำงาน เมื่อพวกเขากลับมาจากการลางานหรือไม่
      3. ถ้าผู้ปฏิบัติงานต้องส่งหนังสือแจ้งการกลับมาทำงาน คุณสามารถเปิดใช้ **เปิดใช้งานหนังสือแจ้งการกลับมาทำงาน** ถ้า **เปิดใช้งานหนังสือแจ้งการกลับมาทำงาน** ถูกเปิดไว้ **เอกสารแนบที่กำหนด** จะเปิดใช้งานโดยอัตโนมัติและไม่สามารถปิดใช้งานได้

9. ถ้าผู้ใช้ควรอัปโหลดเอกสารเมื่อสร้างหรืออัปเดตการขอลางาน คุณสามารถเปิดใช้งาน **เอกสารแนบที่กำหนด** ได้
10. ภายใต้ **จำกัดการเข้าถึงบทบาทที่เลือกไว้** ให้เลือกว่าคุณต้องการจำกัดการเข้าถึงหรือไม่ จากนั้น ภายใต้ **บทบาทความปลอดภัยสำหรับชนิดการลางานนี้** ให้เลือกบทบาทความปลอดภัย บาทความปลอดภัยถูกกำหนดไว้ในเวิร์กโฟลว์ที่คุณเลือกไว้ภายใต้ **รหัสเวิร์กโฟลว์** ก่อนหน้าในกระบวนงานนี้
11. ภายใต้ **สีของปฏิทิน** ให้เลือกสีที่จะแสดงบนปฏิทินการลางานและการขาดงานสำหรับชนิดการลางานนี้
11. ภายใต้ **ความสัมพันธ์ของการระงับ** ให้เลือกว่าคุณต้องการให้ชนิดการลางานนี้ควรระงับชนิดการลางานอื่น หรือถูกระงับโดยชนิดการลางานอื่น เมื่อมีการส่งคำขอการลางานสำหรับชนิดการระงับการลา จะมีการสร้างการระงับการลางานโดยอัตโนมัติสำหรับชนิดการลางานที่ถูกระงับ
12. เลือก **บันทึก**

## <a name="configure-leave-type-rules"></a>ตั้งค่าคอนฟิกกฎชนิดการลางาน

1. ตั้งค่าตัวเลือกการปัดเศษสำหรับชนิด **การลาและการขาดงาน** ตัวเลือกประกอบด้วย **ไม่** **ขึ้น** **ลง** และ **ใกล้ที่สุด** นอกจากนี้คุณยังสามารถตั้งค่าความแม่นยำในการปัดเศษสำหรับชนิดการลางานได้ด้วย
...
4. กำหนด **กฎการหมดอายุ** สำหรับชนิดการลางาน เมื่อคุณตั้งค่าคอนฟิกตัวเลือกนี้ คุณสามารถเลือกหน่วยของวันหรือเดือน และกำหนดระยะเวลาสำหรับการหมดอายุ วันที่มีผลบังคับใช้ของกฎการหมดอายุจะใช้เพื่อระบุว่าเมื่อใดที่จะเริ่มต้นการเรียกใช้ชุดงาน ซึ่งประมวลผลการหมดอายุการลางาน หรือวันที่ที่กฎนั้นจะมีผลบังคับ วันหมดอายุจะเกิดขึ้นในวันที่เริ่มต้นรอบระยะเวลาการรับรู้เสมอ ตัวอย่างเช่น ถ้าวันที่เริ่มต้นรอบระยะเวลาการรับรู้คือ 3 สิงหาคม 2021 และตั้งค่ากฎการหมดอายุไว้ที่ 6 เดือน กฎจะถูกประมวลผลตามออฟเซ็ตวันหมดอายุจากวันที่เริ่มต้นรอบระยะเวลาการรับรู้ ดังนั้นกฎจึงจะเรียกใช้ในวันที่ 3 กุมภาพันธ์ 2022 ยอดดุลการลางานใดๆ ที่มีอยู่ในช่วงเวลาของการหมดอายุจะถูกลบออกจากชนิดของการลางาน และจะถูกสะท้อนให้เห็นในยอดดุลการลางาน
...
2. เลือก **ชนิดการลางาน** ในรายการ ในส่วน **ทั่วไป** ให้ใช้ฟิลด์ **เอกสารแนบที่กำหนด** เพื่อระบุว่าต้องอัปโหลดเอกสารแนบเมื่อพนักงานส่งคำขอการลางานใหม่สำหรับชนิดการลางานที่เลือกหรือไม่ 
