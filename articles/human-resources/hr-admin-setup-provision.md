...
สภาพแวดล้อมการทดลองใช้ช่วยประเมินฟังก์ชันของฝ่ายทรัพยากรบุคคลได้ สำหรับบุคคลที่ยังไม่มีสิทธิเข้าถึงสภาพแวดล้อมของทรัพยากรบุคคล ถ้าคุณเตรียมใช้งานสภาพแวดล้อมการทดลองและผู้ใช้ที่ได้รับการรับรองความถูกต้องสามารถเข้าถึงสภาพแวดล้อมทรัพยากรบุคคลที่มีอยู่หนึ่งรายการหรือมากกว่านั้น ผู้ใช้จะถูกเปลี่ยนเส้นทางไปยังสภาพแวดล้อมหรือรายการสภาพแวดล้อมที่มีอยู่

ภาพแวดล้อมการทดลองไม่ได้ตั้งใจที่จะถูกใช้เป็นสภาพแวดล้อมการผลิต โดยจะจํากัดเฉพาะช่วงทดลอง 30 วันเท่านั้น เมื่อระยะเวลาทดลองหมดอายุ สภาพแวดล้อมและข้อมูลทั้งหมดที่อยู่ในนั้นจะถูกลบ และจะไม่สามารถกู้คืนได้ สภาพแวดล้อมไม่สามารถแปลงเป็นสภาพแวดล้อม Sandbox หรือสภาพแวดล้อมการทำงานจริงได้ คุณสามารถลงทะเบียนสำหรับสภาพแวดล้อมการทดลองใหม่ได้ หลังจากสภาพแวดล้อมที่มีอยู่หมดอายุ
...
ก่อนที่คุณจะสร้างสภาพแวดล้อมทรัพยากรบุคคลแรกของคุณ คุณควรวางแผนความต้องการสภาพแวดล้อมในโครงการของคุณอย่างรอบคอบ การบอกรับเป็นสมาชิกพื้นฐานในทรัพยากรบุคคลประกอบด้วยสภาพแวดล้อมสองประเภท ได้แก่ สภาพแวดล้อมการผลิตและสภาพแวดล้อม Sandbox คุณอาจจำเป็นต้องซื้อสภาพแวดล้อม Sandbox เพิ่มเติมเพื่อสนับสนุนกิจกรรมโครงการ ทั้งนี้ขึ้นอยู่กับความซับซ้อนของโครงการของคุณ 

ข้อควรพิจารณาเกี่ยวกับสภาพแวดล้อมเพิ่มเติม:

- **การย้ายข้อมูล**: กิจกรรมการย้ายข้อมูลเพื่อให้สามารถใช้สภาพแวดล้อม Sandbox ของคุณเพื่อวัตถุประสงค์ในการทดสอบทั่วทั้งโครงการได้ การมีสภาพแวดล้อมเพิ่มเติมจะช่วยให้กิจกรรมการย้ายข้อมูลสามารถต่อไปในระหว่างการทดสอบและกิจกรรมการตั้งค่าคอนฟิกจะเกิดขึ้นพร้อมกันในสภาพแวดล้อมที่แตกต่างกัน
- **การรวม**: ตั้งค่าคอนฟิกและทดสอบการรวม ซึ่งอาจรวมถึงการรวมเข้ากับบริษัทแม่ เช่น การรวมแบบ Ceridian Dayforce หรือการรวมที่กําหนดเอง
...
- **โครงการหลายระยะ**: สนับสนุนการตั้งค่าคอนฟิก การย้ายข้อมูล การทดสอบ หรือกิจกรรมอื่นๆ ในระยะโครงการที่วางแผนไว้หลังจากการเริ่มใช้งานของโครงการ
...
2. บ่งชี้ว่าสภาพแวดล้อมนี้เป็นอินสแตนซ์ Sandbox หรืออินสแตนซ์การใช้งานจริงของ Human Resources คุณลักษณะการแสดงตัวอย่างก่อนหน้านี้อาจมีอยู่ในอินสแตนซ์ Sandbox เพื่ออนุญาตให้มีผลป้อนกลับและการทดสอบก่อนกำหนด
    ...
    > [!NOTE]
    > อินสแตนซ์ทรัพยากรบุคคลจะไม่สามารถเปลี่ยนแปลงชนิดได้ เมื่อตั้งค่าแล้ว ตรวจสอบว่ามีการเลือกชนิดของอินสแตนซ์ที่ถูกต้องก่อนดำเนินการต่อ</br></br>
...
6. เลือก **ใช่** เพื่อยอมรับเงื่อนไข และเริ่มต้นการปรับใช้
   ...
   สภาพแวดล้อมใหม่ของคุณ ปรากฏในรายการของสภาพแวดล้อมในบานหน้าต่างนำทางด้านซ้าย อย่างไรก็ตาม คุณไม่สามารถเริ่มต้นใช้สภาพแวดล้อมได้ จนกว่าสถานะการปรับใช้งานจะเป็น **ถูกปรับใช้** กระบวนการนี้โดยปกติใช้เวลาไม่กี่นาที ถ้ากระบวนการเตรียมใช้งานไม่สำเร็จ ให้ติดต่อฝ่ายสนับสนุน
...
6. ความสามารถการรวมแบบสองทิศทางสำหรับข้อมูลทรัพยากรบุคคลแบบรวมเข้ากับสภาพแวดล้อม Power Apps จะสามารถใช้งานได้หากมีการเลือกตัวเลือก **เปิดใช้งานแอป Dynamics 365** ไว้เฉพาะกับสภาพแวดล้อมเท่านั้น สำหรับข้อมูลเพิ่มเติม ดูที่ [โฮมเพจ Dual-write](../fin-ops-core/dev-itpro/data-entities/dual-write/dual-write-home-page.md)

    > [!NOTE]
    > ตัวเลือก **เปิดใช้งานแอป Dynamics 365** ต้องเลือกในเวลาที่สร้างสภาพแวดล้อม Power Apps ถ้าไม่ได้เลือกตัวเลือกนี้ในขณะที่เตรียมใช้งาน คุณจะไม่สามารถใช้การรวมแบบสองทิศทางเพื่อรวมข้อมูลระหว่างกับสภาพแวดล้อม Dynamics 365 Human Resources หรือ Power Apps ได้ หรือติดตั้งแอป Dynamics 365 เช่น Dynamics 365 Sales และ Field Service ในสภาพแวดล้อมได้ ตัวเลือกนี้ไม่สามารถย้อนกลับได้ 
    > -  Human Resources ไม่สนับสนุนการเปลี่ยนแปลงอินสแตนซ์ Dataverse ที่เชื่อมโยงหลังจากที่ปรับใช้ Human Resources แล้ว </br></br>
    > สำหรับข้อมูลเพิ่มเติม ให้ดู [ข้อควรพิจารณาที่สําคัญสองสามอย่างเมื่อสร้างสภาพแวดล้อมใหม่](/power-platform/admin/create-environment#some-important-considerations-when-creating-a-new-environment) บนไซต์คู่มือ Power Platform  
