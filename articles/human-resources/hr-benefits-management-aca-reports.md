...
description: หัวข้อนี้อธิบายวิธีการจัดการสวัสดิการติดตามข้อมูลที่รายงานบนฟอร์ม 1095-B และฟอร์ม 1095-C สำหรับข้อตกลงของนายจ้างด้านกฎหมายประกันสุขภาพ (ACA)
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
การจัดการสวัสดิการติดตามข้อมูลที่รายงานบนฟอร์ม 1095-B และฟอร์ม 1095-C สำหรับข้อตกลงของนายจ้างด้านกฎหมายประกันสุขภาพ (ACA) เช่นเดียวกับความสามารถในการรายงาน ACA ในพื้นที่ทำงาน **สวัสดิการ** เก่า ฟังก์ชันนี้จะใช้กับนิติบุคคลในสหรัฐอเมริกาเท่านั้น
...
2. เปลี่ยนพารามิเตอร์ตามที่ต้องการ แล้วเลือก **ตกลง**
    ...
    > [!NOTE]
    > ถ้าคุณกำลังพิมพ์ฟอร์ม 1095-C สำหรับพนักงานมากกว่า 500 ราย คุณจะได้รับไฟล์ PDF มากกว่าหนึ่งไฟล์ ขอแนะนาว่าคุณควรเพิ่มฟิลด์ **ค่าของขนาดไฟล์สูงสุดเป็นเมกะไบต์** ในหน้า **พารามิเตอร์การจัดการเอกสาร** เป็น **150** (หากต้องการเปิดหน้าอย่างรวดเร็ว ใช้ฟิลด์การค้นหาบนแถบการนำทางได้)
    >
