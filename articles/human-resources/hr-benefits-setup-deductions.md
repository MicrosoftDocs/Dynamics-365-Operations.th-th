...
3. ระบุค่าสำหรับฟิลด์ต่อไปนี้
   ...
   | **สามารถลบได้** | ระบุว่าค่าที่ส่งออกจาก Dynamics 365 Finance จะทำให้ค่าที่อยู่ในระบบบัญชีเงินเดือนถูกลบออกหรือไม่ |
   | **คอลัมน์ที่ถูกจับคู่** | ระบุว่าจะส่งออกหัวข้อและยอดการหักลดในคอลัมน์คู่ที่อยู่ติดกันกับระบบการจ่ายเงินเดือนหรือไม่ |
   | **วันที่มีผลของการเปลี่ยนแปลง** | วันที่ที่มีการเปลี่ยนแปลงการหักลดจะเริ่มมีผลบังคับใช้ ในวันที่มีผลบังคับใช้ การเปลี่ยนการหักเงินสิทธิประโยชน์และแผนสวัสดิการทั้งหมดที่เกี่ยวข้องกับการหักลดนี้อัปเดตโดยอัตโนมัติ ตราบใดที่คุณดำเนินการประมวลผล **การอัปเดตการหักลด** |
   | **การเปลี่ยนแปลงรายการหักเสร็จสมบูรณ์แล้ว** | กล่องกาเครื่องหมาย **การเปลี่ยนแปลงการหักลดที่เสร็จสมบูรณ์** จะถูกเลือกโดยอัตโนมัติเมื่อการเปลี่ยนแปลงการหักเงินสิทธิประโยชน์เสร็จสมบูรณ์แล้วโดยการประมวลผลการอัปเดตความเปลี่ยนแปลงของการหักลด |
