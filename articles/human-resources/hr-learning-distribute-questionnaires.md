...
-   กำหนดให้แบบสอบถาม **เปิดใช้งาน** แบบสอบถามจะพร้อมใช้งานสำหรับพนักงานทั้งหมด ยกเว้นว่ามีการตั้งค่ากลุ่มแบบสอบถามเป็นจำกัดการเข้าถึง
...
ใช้หน้า **กำหนดการแบบสอบถาม** เพื่อจัดเตรียมและส่งอีเมลไปยังผู้ตอบทั้งหมดที่กำหนดให้ตอบแบบสอบถาม ป้อนข้อความอีเมลบนแท็บ **อีเมลสำหรับระบบบริการตนเองของพนักงาน** หลังจากกำหนดการเริ่มต้นขึ้น คลิก **ฟังก์ชัน** &gt; **ส่งอีเมล** เพื่อสร้างและส่งอีเมลไปยังผู้ตอบ ผู้ตอบสามารถลงชื่อเข้าใช้งานในเว็บไซต์ และกรอกแบบสอบถาม 

> [!NOTE]
> ก่อนที่คุณจะใช้ฟังก์ชันอีเมลได้ ผู้ดูแลระบบ IT ของคุณต้องป้อนการตั้งค่าอีเมลในหน้า **พารามิเตอร์อีเมล์** ก่อน
