...
- <span data-ttu-id="b64a7-111">ข้อมูลทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-111">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="b64a7-141">ตั้งค่าคอนฟิกข้อมูลของคุณ</span><span class="sxs-lookup"><span data-stu-id="b64a7-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="b64a7-158">สวัสดิการ</span><span class="sxs-lookup"><span data-stu-id="b64a7-158">Benefits</span></span>
...
<span data-ttu-id="b64a7-187">สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการกำหนดและจัดการโปรแกรมสวัสดิการ ให้ดูบทความต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="b64a7-187">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- [<span data-ttu-id="b64a7-206">การลงทะเบียนพนักงานในแผนค่าตอบแทนผันแปร</span><span class="sxs-lookup"><span data-stu-id="b64a7-206">Enroll an employee in a variable compensation plan</span></span>](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/enroll-employee-variable-compensation-plan)
...
### <a name="worker-data"></a><span data-ttu-id="b64a7-265">ข้อมูลของผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-265">Worker data</span></span>
...
#### <a name="personal-information"></a><span data-ttu-id="b64a7-281">ข้อมูลส่วนบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-281">Personal information</span></span>
...
#### <a name="employment-details"></a><span data-ttu-id="b64a7-321">รายละเอียดการจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-321">Employment details</span></span>
...
- <span data-ttu-id="b64a7-349">จำนวนเทียบเท่ารายชั่วโมง (จำเป็น)</span><span class="sxs-lookup"><span data-stu-id="b64a7-349">Hourly equivalent (required)</span></span>
...
## <a name="configure-your-data-to-generate-payroll-in-united-states-and-canada"></a><span data-ttu-id="b64a7-389">ตั้งค่าคอนฟิกข้อมูลของคุณเพื่อสร้างค่าจ้างในสหรัฐอเมริกาและแคนาดา</span><span class="sxs-lookup"><span data-stu-id="b64a7-389">Configure your data to generate payroll in United States and Canada</span></span>
...
<span data-ttu-id="b64a7-397">มีการใช้ชนิดงานเพื่อจัดกลุ่มงานที่คล้ายกันเป็นประเภทต่างๆ</span><span class="sxs-lookup"><span data-stu-id="b64a7-397">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="b64a7-398">ชนิดของงานจะต้องใช้เพื่อประมวลผลค่าจ้างในสหรัฐอเมริกาและแคนาดา</span><span class="sxs-lookup"><span data-stu-id="b64a7-398">Job types are required in order to process payroll in the United States and Canada.</span></span> <span data-ttu-id="b64a7-399">ตัวอย่างของชนิดงานรวมแบบเต็มเวลาและแบบชั่วคราว หรือแบบชำระค่าจ้างรายเดือนและรายชั่วโมง</span><span class="sxs-lookup"><span data-stu-id="b64a7-399">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="b64a7-400">ชนิดงานถูกแม็ปไปยัง Dayforce เป็นชนิดค่าจ้างที่บ่งชี้ว่า พนักงานเป็นแบบรายชั่วโมง หรือแบบรับเงินเดือน</span><span class="sxs-lookup"><span data-stu-id="b64a7-400">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="b64a7-401">ชนิดงานและคำอธิบายต่อไปนี้จำเป็นต้องใช้</span><span class="sxs-lookup"><span data-stu-id="b64a7-401">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="b64a7-402">ชนิดงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-402">Job type</span></span>   | <span data-ttu-id="b64a7-403">คำอธิบาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-403">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="b64a7-404">ต่อชั่วโมง</span><span class="sxs-lookup"><span data-stu-id="b64a7-404">Hourly</span></span>     | <span data-ttu-id="b64a7-405">ต่อชั่วโมง</span><span class="sxs-lookup"><span data-stu-id="b64a7-405">Hourly</span></span>      |
| <span data-ttu-id="b64a7-406">รับเงินเดือน</span><span class="sxs-lookup"><span data-stu-id="b64a7-406">Salaried</span></span>   | <span data-ttu-id="b64a7-407">รับเงินเดือน</span><span class="sxs-lookup"><span data-stu-id="b64a7-407">Salaried</span></span>    |

### <a name="position-types"></a><span data-ttu-id="b64a7-408">ชนิดของตำแหน่งงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-408">Position types</span></span> 

<span data-ttu-id="b64a7-409">คุณใช้ชนิดของตำแหน่งเพื่ออธิบายว่า ตำแหน่งเป็นแบบเต็มเวลา แบบชั่วคราว หรือแบบอื่น</span><span class="sxs-lookup"><span data-stu-id="b64a7-409">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="b64a7-410">ชนิดของตำแหน่งถูกแม็ปไปยัง Dayforce เป็นคลาสค่าจ้างที่บ่งชี้ว่าพนักงานเป็นแบบเต็มเวลา หรือแบบชั่วคราว</span><span class="sxs-lookup"><span data-stu-id="b64a7-410">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="b64a7-411">ชนิดของตำแหน่งและคำอธิบายต่อไปนี้จำเป็นต้องใช้</span><span class="sxs-lookup"><span data-stu-id="b64a7-411">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="b64a7-412">ชนิดของตำแหน่ง</span><span class="sxs-lookup"><span data-stu-id="b64a7-412">Position type</span></span>   | <span data-ttu-id="b64a7-413">คำอธิบาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-413">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="b64a7-414">งานประจำ</span><span class="sxs-lookup"><span data-stu-id="b64a7-414">Full-time</span></span>       | <span data-ttu-id="b64a7-415">พนักงานแบบเต็มเวลา</span><span class="sxs-lookup"><span data-stu-id="b64a7-415">Full time employee</span></span> |
| <span data-ttu-id="b64a7-416">งานชั่วคราว</span><span class="sxs-lookup"><span data-stu-id="b64a7-416">Part-time</span></span>       | <span data-ttu-id="b64a7-417">พนักงานแบบชั่วคราว</span><span class="sxs-lookup"><span data-stu-id="b64a7-417">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="b64a7-418">รหัสเหตุผล</span><span class="sxs-lookup"><span data-stu-id="b64a7-418">Reason codes</span></span>

<span data-ttu-id="b64a7-419">รหัสเหตุผลให้ข้อมูลเกี่ยวกับสถานะของพนักงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-419">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="b64a7-420">รหัสเหตุผลถูกแม็ปไปยัง Dayforce เป็นเหตุผลสถานะที่บ่งชี้เหตุผลสำหรับการเปลี่ยนแปลงไปยังสถานะการจ้างงานหรือตำแหน่งงานของพนักงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-420">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="b64a7-421">รหัสเหตุผลและคำอธิบายต่อไปนี้จำเป็นต้องใช้</span><span class="sxs-lookup"><span data-stu-id="b64a7-421">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="b64a7-422">รหัสเหตุผล</span><span class="sxs-lookup"><span data-stu-id="b64a7-422">Reason code</span></span>    | <span data-ttu-id="b64a7-423">คำอธิบาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-423">Description</span></span>      | <span data-ttu-id="b64a7-424">สถานการณ์จำลองที่ใช้ได้</span><span class="sxs-lookup"><span data-stu-id="b64a7-424">Applicable scenarios</span></span> |
|----------------|------------------|----------------------|
| <span data-ttu-id="b64a7-425">การลาออก</span><span class="sxs-lookup"><span data-stu-id="b64a7-425">RESIGNATION</span></span>    | <span data-ttu-id="b64a7-426">การลาออก</span><span class="sxs-lookup"><span data-stu-id="b64a7-426">Resignation</span></span>      | <span data-ttu-id="b64a7-427">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-427">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-428">การสิ้นสุดการจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-428">TERMINATION</span></span>    | <span data-ttu-id="b64a7-429">การสิ้นสุดการจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-429">Termination</span></span>      | <span data-ttu-id="b64a7-430">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-430">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-431">การปลดเกษียณ</span><span class="sxs-lookup"><span data-stu-id="b64a7-431">RETIREMENT</span></span>     | <span data-ttu-id="b64a7-432">การปลดเกษียณ</span><span class="sxs-lookup"><span data-stu-id="b64a7-432">Retirement</span></span>       | <span data-ttu-id="b64a7-433">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-433">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-434">อื่นๆ</span><span class="sxs-lookup"><span data-stu-id="b64a7-434">OTHER</span></span>          | <span data-ttu-id="b64a7-435">เหตุผลอื่นๆ</span><span class="sxs-lookup"><span data-stu-id="b64a7-435">Other Reasons</span></span>    | <span data-ttu-id="b64a7-436">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-436">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-437">ความตาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-437">DEATH</span></span>          | <span data-ttu-id="b64a7-438">เสียชีวิต</span><span class="sxs-lookup"><span data-stu-id="b64a7-438">Death</span></span>            | <span data-ttu-id="b64a7-439">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-439">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-440">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="b64a7-440">LEAVEOFABSENCE</span></span> | <span data-ttu-id="b64a7-441">การลาหยุด</span><span class="sxs-lookup"><span data-stu-id="b64a7-441">Leave of Absence</span></span> | <span data-ttu-id="b64a7-442">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-442">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-443">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="b64a7-443">CONTRACTEND</span></span>    | <span data-ttu-id="b64a7-444">จุดสิ้นสุดของสัญญา</span><span class="sxs-lookup"><span data-stu-id="b64a7-444">End of Contract</span></span>  | <span data-ttu-id="b64a7-445">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-445">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-446">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="b64a7-446">SALARYCHANGE</span></span>   | <span data-ttu-id="b64a7-447">การเปลี่ยนแปลงเงินเดือน</span><span class="sxs-lookup"><span data-stu-id="b64a7-447">Change of Salary</span></span> | <span data-ttu-id="b64a7-448">ค่าตอบแทน</span><span class="sxs-lookup"><span data-stu-id="b64a7-448">Compensation</span></span>         |

### <a name="marital-status"></a><span data-ttu-id="b64a7-449">สถานภาพการสมรส</span><span class="sxs-lookup"><span data-stu-id="b64a7-449">Marital status</span></span>

<span data-ttu-id="b64a7-450">ค่าสถานภาพการสมรสถูกแม็ปไปยัง Dayforce และถูกแปล ตามความเหมาะสม ไปยังค่าที่ยอมรับ เมื่อมีการรวม</span><span class="sxs-lookup"><span data-stu-id="b64a7-450">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="b64a7-451">ตารางต่อไปนี้แสดงวิธีการแม็ปค่าสถานภาพการสมรสไปยัง Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-451">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="b64a7-452">ทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-452">Human Resources</span></span>                 | <span data-ttu-id="b64a7-453">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-453">Dayforce</span></span>             |
|------------------------|----------------------|
| <span data-ttu-id="b64a7-454">สมรส</span><span class="sxs-lookup"><span data-stu-id="b64a7-454">Married</span></span>                | <span data-ttu-id="b64a7-455">สมรส</span><span class="sxs-lookup"><span data-stu-id="b64a7-455">Married</span></span>              |
| <span data-ttu-id="b64a7-456">โสด</span><span class="sxs-lookup"><span data-stu-id="b64a7-456">Single</span></span>                 | <span data-ttu-id="b64a7-457">โสด</span><span class="sxs-lookup"><span data-stu-id="b64a7-457">Single</span></span>               |
| <span data-ttu-id="b64a7-458">หม้าย</span><span class="sxs-lookup"><span data-stu-id="b64a7-458">Widowed</span></span>                | <span data-ttu-id="b64a7-459">หม้าย</span><span class="sxs-lookup"><span data-stu-id="b64a7-459">Widowed</span></span>              |
| <span data-ttu-id="b64a7-460">หย่าร้าง</span><span class="sxs-lookup"><span data-stu-id="b64a7-460">Divorced</span></span>               | <span data-ttu-id="b64a7-461">หย่าร้าง</span><span class="sxs-lookup"><span data-stu-id="b64a7-461">Divorced</span></span>             |
| <span data-ttu-id="b64a7-462">ห้างหุ้นส่วนจดทะเบียน</span><span class="sxs-lookup"><span data-stu-id="b64a7-462">Registered Partnership</span></span> | <span data-ttu-id="b64a7-463">ห้างหุ้นส่วนในประเทศ</span><span class="sxs-lookup"><span data-stu-id="b64a7-463">Domestic Partnership</span></span> |
| <span data-ttu-id="b64a7-464">None</span><span class="sxs-lookup"><span data-stu-id="b64a7-464">None</span></span>                   | <span data-ttu-id="b64a7-465">None</span><span class="sxs-lookup"><span data-stu-id="b64a7-465">None</span></span>                 |
| <span data-ttu-id="b64a7-466">การอยู่ร่วมกัน</span><span class="sxs-lookup"><span data-stu-id="b64a7-466">Cohabiting</span></span>             | <span data-ttu-id="b64a7-467">การอยู่ร่วมกัน</span><span class="sxs-lookup"><span data-stu-id="b64a7-467">Cohabiting</span></span>           |

### <a name="gender"></a><span data-ttu-id="b64a7-468">เพศ</span><span class="sxs-lookup"><span data-stu-id="b64a7-468">Gender</span></span>

<span data-ttu-id="b64a7-469">การแต่งตั้งเพศถูกแม็ปไปยัง Dayforce และถูกแปล ตามความเหมาะสม ไปยังค่าที่ยอมรับ เมื่อมีการรวม</span><span class="sxs-lookup"><span data-stu-id="b64a7-469">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="b64a7-470">ตารางต่อไปนี้แสดงวิธีการแม็ปการแต่งตั้งเพศไปยัง Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-470">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="b64a7-471">ทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-471">Human Resources</span></span>       | <span data-ttu-id="b64a7-472">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-472">Dayforce</span></span>        |
|--------------|-----------------|
| <span data-ttu-id="b64a7-473">เพศชาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-473">Male</span></span>         | <span data-ttu-id="b64a7-474">เพศชาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-474">Male</span></span>            |
| <span data-ttu-id="b64a7-475">เพศหญิง</span><span class="sxs-lookup"><span data-stu-id="b64a7-475">Female</span></span>       | <span data-ttu-id="b64a7-476">เพศหญิง</span><span class="sxs-lookup"><span data-stu-id="b64a7-476">Female</span></span>          |
| <span data-ttu-id="b64a7-477">ไม่เจาะจง</span><span class="sxs-lookup"><span data-stu-id="b64a7-477">Non-specific</span></span> | <span data-ttu-id="b64a7-478">*ไม่สนับสนุน*</span><span class="sxs-lookup"><span data-stu-id="b64a7-478">*Not supported*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="b64a7-479">รหัสรายได้</span><span class="sxs-lookup"><span data-stu-id="b64a7-479">Earning codes</span></span>

<span data-ttu-id="b64a7-480">รหัสรายได้ระบุทุกชนิดของรายได้ทุกชนิดที่ผู้ปฏิบัติงานที่ได้รับ</span><span class="sxs-lookup"><span data-stu-id="b64a7-480">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="b64a7-481">รหัสครอบคลุมพารามิเตอร์ต่างๆ ที่เกี่ยวข้องกับรายได้ เช่น กฎทางบัญชี กฎภาษี ข้อกำหนดในการรายงาน และความสามารถในการชำระเพิ่ม</span><span class="sxs-lookup"><span data-stu-id="b64a7-481">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="b64a7-482">ถ้ามีการใช้ความถี่ที่ไม่สนับสนุน ความถี่ **การชำระค่าจ้างทุกๆ รายการ** จะถูกใช้ตามค่าเริ่มต้นสำหรับการคำนวณ</span><span class="sxs-lookup"><span data-stu-id="b64a7-482">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="b64a7-483">ความถี่ที่สนับสนุน</span><span class="sxs-lookup"><span data-stu-id="b64a7-483">Supported frequencies</span></span>

- <span data-ttu-id="b64a7-484">ทั้งหมด</span><span class="sxs-lookup"><span data-stu-id="b64a7-484">All</span></span>
- <span data-ttu-id="b64a7-485">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="b64a7-485">EVERYPAY</span></span>
- <span data-ttu-id="b64a7-486">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="b64a7-486">EACHPAYPERIOD</span></span>
- <span data-ttu-id="b64a7-487">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="b64a7-487">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="b64a7-488">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="b64a7-488">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="b64a7-489">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-489">1OFMTH</span></span>
- <span data-ttu-id="b64a7-490">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-490">LASTOFMTH</span></span>
- <span data-ttu-id="b64a7-491">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-491">2OFMTH</span></span>
- <span data-ttu-id="b64a7-492">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-492">3OFMTH</span></span>
- <span data-ttu-id="b64a7-493">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-493">4OFMTH</span></span>
- <span data-ttu-id="b64a7-494">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-494">5OFMTH</span></span>
- <span data-ttu-id="b64a7-495">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-495">1N2OFMTH</span></span>
- <span data-ttu-id="b64a7-496">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-496">3N4OFMTH</span></span>
- <span data-ttu-id="b64a7-497">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-497">1N3OFMTH</span></span>
- <span data-ttu-id="b64a7-498">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-498">1N4OFMTH</span></span>
- <span data-ttu-id="b64a7-499">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-499">2N3OFMTH</span></span>
- <span data-ttu-id="b64a7-500">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-500">2N4OFMTH</span></span>
- <span data-ttu-id="b64a7-501">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-501">1N2N3OFMTH</span></span>
- <span data-ttu-id="b64a7-502">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-502">1N2N4OFMTH</span></span>
- <span data-ttu-id="b64a7-503">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-503">1N3N4OFMTH</span></span>
- <span data-ttu-id="b64a7-504">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-504">2N3N4OFMTH</span></span>
- <span data-ttu-id="b64a7-505">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-505">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="b64a7-506">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="b64a7-506">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="b64a7-507">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="b64a7-507">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="b64a7-508">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="b64a7-508">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="b64a7-509">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="b64a7-509">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="b64a7-510">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="b64a7-510">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="b64a7-511">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="b64a7-511">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="b64a7-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="b64a7-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="b64a7-513">ที่อยู่</span><span class="sxs-lookup"><span data-stu-id="b64a7-513">Addresses</span></span>

<span data-ttu-id="b64a7-514">การระบุรหัสประจำตัวของประเทศหรือภูมิภาคเฉพาะ รัฐ และรหัสเขต (เขตปกครอง) ต้องมีรูปแบบเฉพาะที่ Dayforce และผู้ให้บริการในประเทศ/ในเขตสามารถจดจำได้</span><span class="sxs-lookup"><span data-stu-id="b64a7-514">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="b64a7-515">แม้ว่ารูปแบบสำหรับเมืองจะยืดหยุ่นได้ เมืองทุกเมืองต้องเชื่อมโยงกับรัฐ</span><span class="sxs-lookup"><span data-stu-id="b64a7-515">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="b64a7-516">ทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-516">Human Resources</span></span>          | <span data-ttu-id="b64a7-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-517">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="b64a7-518">ประเทศ/ภูมิภาค</span><span class="sxs-lookup"><span data-stu-id="b64a7-518">Country/Region</span></span>  | <span data-ttu-id="b64a7-519">รหัสประเทศ</span><span class="sxs-lookup"><span data-stu-id="b64a7-519">Country Code</span></span>          |
| <span data-ttu-id="b64a7-520">รหัสไปรษณีย์</span><span class="sxs-lookup"><span data-stu-id="b64a7-520">Zip/Postal Code</span></span> | <span data-ttu-id="b64a7-521">รหัสไปรษณีย์</span><span class="sxs-lookup"><span data-stu-id="b64a7-521">Postal Code</span></span>           |
| <span data-ttu-id="b64a7-522">สถานะ</span><span class="sxs-lookup"><span data-stu-id="b64a7-522">State</span></span>           | <span data-ttu-id="b64a7-523">รหัสรัฐ</span><span class="sxs-lookup"><span data-stu-id="b64a7-523">State Code</span></span>            |
| <span data-ttu-id="b64a7-524">เมือง</span><span class="sxs-lookup"><span data-stu-id="b64a7-524">City</span></span>            | <span data-ttu-id="b64a7-525">เมือง</span><span class="sxs-lookup"><span data-stu-id="b64a7-525">City</span></span>                  |
| <span data-ttu-id="b64a7-526">เขตเทศบาล</span><span class="sxs-lookup"><span data-stu-id="b64a7-526">County</span></span>          | <span data-ttu-id="b64a7-527">เขต (เขตปกครอง)</span><span class="sxs-lookup"><span data-stu-id="b64a7-527">County (Municipality)</span></span> |
| <span data-ttu-id="b64a7-528">ถนน</span><span class="sxs-lookup"><span data-stu-id="b64a7-528">Street</span></span>          | <span data-ttu-id="b64a7-529">ที่อยู่ บรรทัดที่ 1</span><span class="sxs-lookup"><span data-stu-id="b64a7-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="b64a7-530">ภูมิภาคการเก็บภาษี</span><span class="sxs-lookup"><span data-stu-id="b64a7-530">Tax regions</span></span>

<span data-ttu-id="b64a7-531">ภูมิภาคการเก็บภาษีถูกใช้เพื่อกำหนดภาษีที่เหมาะสมที่ควรนำมาใช้ในระหว่างการสร้างระบบค่าจ้าง</span><span class="sxs-lookup"><span data-stu-id="b64a7-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="b64a7-532">ภูมิภาคการเก็บภาษีถูกแม็ปไปยัง Dayforce เป็นที่อยู่ของสถานที่</span><span class="sxs-lookup"><span data-stu-id="b64a7-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="b64a7-533">ภูมิภาคการเก็บภาษีเริ่มต้นต้องเชื่อมโยงกับตำแหน่งงานที่ใช้งานอยู่ของผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="b64a7-534">ภูมิภาคการเก็บภาษี (จำเป็น)</span><span class="sxs-lookup"><span data-stu-id="b64a7-534">Tax region (required)</span></span>
- <span data-ttu-id="b64a7-535">ประเทศ/ภูมิภาค (จำเป็น)</span><span class="sxs-lookup"><span data-stu-id="b64a7-535">Country/Region (required)</span></span>
- <span data-ttu-id="b64a7-536">รัฐ (จำเป็น)</span><span class="sxs-lookup"><span data-stu-id="b64a7-536">State (required)</span></span>
- <span data-ttu-id="b64a7-537">เขตเทศบาล</span><span class="sxs-lookup"><span data-stu-id="b64a7-537">County</span></span> 
- <span data-ttu-id="b64a7-538">เมือง (จำเป็น)</span><span class="sxs-lookup"><span data-stu-id="b64a7-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="b64a7-539">ตั้งค่าคอนฟิกข้อมูลของคุณเพื่อสร้างค่าจ้างในเม็กซิโก</span><span class="sxs-lookup"><span data-stu-id="b64a7-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="b64a7-540">ถ้าคุณกำลังสร้างค่าจ้างสำหรับพนักงานในเม็กซิโก ต้องตั้งค่าคอนฟิกองค์ประกอบต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="b64a7-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="b64a7-541">ต้องมีแผนกในตำแหน่งต่างๆ</span><span class="sxs-lookup"><span data-stu-id="b64a7-541">Departments are required on positions.</span></span>
- <span data-ttu-id="b64a7-542">ศูนย์ต้นทุนต้องถูกตั้งค่าเป็นมิติทางการเงิน และต้องเป็นองค์ประกอบแรกในสตริงมิติทางการเงินเริ่มต้น</span><span class="sxs-lookup"><span data-stu-id="b64a7-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="b64a7-543">ชนิดงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-543">Job types</span></span>

<span data-ttu-id="b64a7-544">มีการใช้ชนิดงานเพื่อจัดกลุ่มงานที่คล้ายกันเป็นประเภทต่างๆ</span><span class="sxs-lookup"><span data-stu-id="b64a7-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="b64a7-545">ชนิดของงานจะต้องใช้เพื่อประมวลผลค่าจ้างในเม็กซิโก</span><span class="sxs-lookup"><span data-stu-id="b64a7-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="b64a7-546">ตัวอย่างของชนิดงานรวมแบบเต็มเวลาและแบบชั่วคราว หรือแบบชำระค่าจ้างรายเดือนและรายชั่วโมง</span><span class="sxs-lookup"><span data-stu-id="b64a7-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="b64a7-547">ชนิดงานถูกแม็ปไปยัง Dayforce เป็นชนิดค่าจ้างที่บ่งชี้ว่า พนักงานเป็นแบบรายชั่วโมง หรือแบบรับเงินเดือน</span><span class="sxs-lookup"><span data-stu-id="b64a7-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="b64a7-548">ชนิดงานและคำอธิบายต่อไปนี้จำเป็นต้องใช้</span><span class="sxs-lookup"><span data-stu-id="b64a7-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="b64a7-549">ชนิดงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-549">Job type</span></span>   | <span data-ttu-id="b64a7-550">คำอธิบาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="b64a7-551">ต่อชั่วโมง</span><span class="sxs-lookup"><span data-stu-id="b64a7-551">Hourly</span></span>     | <span data-ttu-id="b64a7-552">MX รายชั่วโมง</span><span class="sxs-lookup"><span data-stu-id="b64a7-552">MX Hourly</span></span>   |
| <span data-ttu-id="b64a7-553">รับเงินเดือน</span><span class="sxs-lookup"><span data-stu-id="b64a7-553">Salaried</span></span>   | <span data-ttu-id="b64a7-554">MX รับเงินเดือน</span><span class="sxs-lookup"><span data-stu-id="b64a7-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="b64a7-555">ชนิดของตำแหน่งงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-555">Position types</span></span> 

<span data-ttu-id="b64a7-556">คุณใช้ชนิดของตำแหน่งเพื่ออธิบายว่า ตำแหน่งเป็นแบบเต็มเวลา แบบชั่วคราว หรือแบบอื่น</span><span class="sxs-lookup"><span data-stu-id="b64a7-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="b64a7-557">ชนิดของตำแหน่งถูกแม็ปไปยัง Dayforce เป็นคลาสค่าจ้างที่บ่งชี้ว่าพนักงานเป็นแบบเต็มเวลา หรือแบบชั่วคราว</span><span class="sxs-lookup"><span data-stu-id="b64a7-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="b64a7-558">ชนิดของตำแหน่งและคำอธิบายต่อไปนี้จำเป็นต้องใช้</span><span class="sxs-lookup"><span data-stu-id="b64a7-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="b64a7-559">ชนิดของตำแหน่ง</span><span class="sxs-lookup"><span data-stu-id="b64a7-559">Position type</span></span>   | <span data-ttu-id="b64a7-560">คำอธิบาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="b64a7-561">งานประจำ</span><span class="sxs-lookup"><span data-stu-id="b64a7-561">Full-time</span></span>       | <span data-ttu-id="b64a7-562">พนักงานแบบเต็มเวลา</span><span class="sxs-lookup"><span data-stu-id="b64a7-562">Full time employee</span></span> |
| <span data-ttu-id="b64a7-563">งานชั่วคราว</span><span class="sxs-lookup"><span data-stu-id="b64a7-563">Part-time</span></span>       | <span data-ttu-id="b64a7-564">พนักงานแบบชั่วคราว</span><span class="sxs-lookup"><span data-stu-id="b64a7-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="b64a7-565">รหัสเหตุผล</span><span class="sxs-lookup"><span data-stu-id="b64a7-565">Reason codes</span></span>

<span data-ttu-id="b64a7-566">รหัสเหตุผลให้ข้อมูลเกี่ยวกับสถานะของพนักงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="b64a7-567">รหัสเหตุผลถูกแม็ปไปยัง Dayforce เป็นเหตุผลสถานะที่บ่งชี้เหตุผลสำหรับการเปลี่ยนแปลงไปยังสถานะการจ้างงานหรือตำแหน่งงานของพนักงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="b64a7-568">รหัสเหตุผลและคำอธิบายต่อไปนี้จำเป็นต้องใช้</span><span class="sxs-lookup"><span data-stu-id="b64a7-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="b64a7-569">รหัสเหตุผล</span><span class="sxs-lookup"><span data-stu-id="b64a7-569">Reason code</span></span>            | <span data-ttu-id="b64a7-570">คำอธิบาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-570">Description</span></span>                    | <span data-ttu-id="b64a7-571">สถานการณ์จำลองที่ใช้ได้</span><span class="sxs-lookup"><span data-stu-id="b64a7-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="b64a7-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="b64a7-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="b64a7-573">การออกก่อนค่าจ้างแรก</span><span class="sxs-lookup"><span data-stu-id="b64a7-573">Departure before first payroll</span></span> | <span data-ttu-id="b64a7-574">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-574">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-575">การลาออก</span><span class="sxs-lookup"><span data-stu-id="b64a7-575">RESIGNATION</span></span>            | <span data-ttu-id="b64a7-576">การลาออก</span><span class="sxs-lookup"><span data-stu-id="b64a7-576">Resignation</span></span>                    | <span data-ttu-id="b64a7-577">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-577">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-578">เงินบำนาญ</span><span class="sxs-lookup"><span data-stu-id="b64a7-578">PENSION</span></span>                | <span data-ttu-id="b64a7-579">เงินบำนาญ</span><span class="sxs-lookup"><span data-stu-id="b64a7-579">Pension</span></span>                        | <span data-ttu-id="b64a7-580">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-580">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-581">การสิ้นสุดการจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-581">TERMINATION</span></span>            | <span data-ttu-id="b64a7-582">การสิ้นสุดการจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-582">Termination</span></span>                    | <span data-ttu-id="b64a7-583">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-583">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-584">การปลดเกษียณ</span><span class="sxs-lookup"><span data-stu-id="b64a7-584">RETIREMENT</span></span>             | <span data-ttu-id="b64a7-585">การปลดเกษียณ</span><span class="sxs-lookup"><span data-stu-id="b64a7-585">Retirement</span></span>                     | <span data-ttu-id="b64a7-586">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-586">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-587">ผู้ขาดงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-587">ABSENTEE</span></span>               | <span data-ttu-id="b64a7-588">ผู้ขาดงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-588">Absentee</span></span>                       | <span data-ttu-id="b64a7-589">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-589">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-590">อื่นๆ</span><span class="sxs-lookup"><span data-stu-id="b64a7-590">OTHER</span></span>                  | <span data-ttu-id="b64a7-591">เหตุผลอื่นๆ</span><span class="sxs-lookup"><span data-stu-id="b64a7-591">Other Reasons</span></span>                  | <span data-ttu-id="b64a7-592">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-592">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-593">การปิด</span><span class="sxs-lookup"><span data-stu-id="b64a7-593">CLOSURE</span></span>                | <span data-ttu-id="b64a7-594">การปิดของธุรกิจ</span><span class="sxs-lookup"><span data-stu-id="b64a7-594">Business Closure</span></span>               | <span data-ttu-id="b64a7-595">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-595">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-596">ความตาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-596">DEATH</span></span>                  | <span data-ttu-id="b64a7-597">เสียชีวิต</span><span class="sxs-lookup"><span data-stu-id="b64a7-597">Death</span></span>                          | <span data-ttu-id="b64a7-598">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-598">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="b64a7-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="b64a7-600">การลาหยุด</span><span class="sxs-lookup"><span data-stu-id="b64a7-600">Leave of Absence</span></span>               | <span data-ttu-id="b64a7-601">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-601">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="b64a7-602">CONTRACTEND</span></span>            | <span data-ttu-id="b64a7-603">จุดสิ้นสุดของสัญญา</span><span class="sxs-lookup"><span data-stu-id="b64a7-603">End of Contract</span></span>                | <span data-ttu-id="b64a7-604">เลิกจ้างผู้ปฏิบัติงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-604">Terminate worker</span></span>     |
| <span data-ttu-id="b64a7-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="b64a7-605">SALARYCHANGE</span></span>           | <span data-ttu-id="b64a7-606">การเปลี่ยนแปลงเงินเดือน</span><span class="sxs-lookup"><span data-stu-id="b64a7-606">Change of Salary</span></span>               | <span data-ttu-id="b64a7-607">ค่าตอบแทน</span><span class="sxs-lookup"><span data-stu-id="b64a7-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="b64a7-608">เงื่อนไขการจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-608">Terms of employment</span></span>

<span data-ttu-id="b64a7-609">มีการใช้เงื่อนไขของการจ้างงาน เพื่อสร้างประเภทและตัวอย่างของการจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="b64a7-610">เงื่อนไขถูกแม็ปกับ Dayforce เป็นค่าตัวบ่งชี้การจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="b64a7-611">เงื่อนไขการจ้างงานและคำอธิบายต่อไปนี้จำเป็นต้องใช้</span><span class="sxs-lookup"><span data-stu-id="b64a7-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="b64a7-612">เงื่อนไขการจ้างงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-612">Terms of employment</span></span>   | <span data-ttu-id="b64a7-613">คำอธิบาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="b64a7-614">เป็นประจำ</span><span class="sxs-lookup"><span data-stu-id="b64a7-614">Regular</span></span>               | <span data-ttu-id="b64a7-615">เป็นประจำ</span><span class="sxs-lookup"><span data-stu-id="b64a7-615">Regular</span></span>     |
| <span data-ttu-id="b64a7-616">โดยตรง</span><span class="sxs-lookup"><span data-stu-id="b64a7-616">Direct</span></span>                | <span data-ttu-id="b64a7-617">โดยตรง</span><span class="sxs-lookup"><span data-stu-id="b64a7-617">Direct</span></span>      |
| <span data-ttu-id="b64a7-618">การฝึกงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-618">Internship</span></span>            | <span data-ttu-id="b64a7-619">การฝึกงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-619">Internship</span></span>  |
| <span data-ttu-id="b64a7-620">ถาวร</span><span class="sxs-lookup"><span data-stu-id="b64a7-620">Permanent</span></span>             | <span data-ttu-id="b64a7-621">ถาวร</span><span class="sxs-lookup"><span data-stu-id="b64a7-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="b64a7-622">สถานภาพการสมรส</span><span class="sxs-lookup"><span data-stu-id="b64a7-622">Marital status</span></span>

<span data-ttu-id="b64a7-623">ค่าสถานภาพการสมรสถูกแม็ปไปยัง Dayforce และถูกแปล ตามความเหมาะสม ไปยังค่าที่ยอมรับ เมื่อมีการรวม</span><span class="sxs-lookup"><span data-stu-id="b64a7-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="b64a7-624">ตารางต่อไปนี้แสดงวิธีการแม็ปค่าสถานภาพการสมรสไปยัง Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="b64a7-625">ทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-625">Human Resources</span></span>                 | <span data-ttu-id="b64a7-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="b64a7-627">สมรส</span><span class="sxs-lookup"><span data-stu-id="b64a7-627">Married</span></span>                | <span data-ttu-id="b64a7-628">สมรส</span><span class="sxs-lookup"><span data-stu-id="b64a7-628">Married</span></span>                   |
| <span data-ttu-id="b64a7-629">โสด</span><span class="sxs-lookup"><span data-stu-id="b64a7-629">Single</span></span>                 | <span data-ttu-id="b64a7-630">โสด</span><span class="sxs-lookup"><span data-stu-id="b64a7-630">Single</span></span>                    |
| <span data-ttu-id="b64a7-631">หม้าย</span><span class="sxs-lookup"><span data-stu-id="b64a7-631">Widowed</span></span>                | <span data-ttu-id="b64a7-632">หม้าย</span><span class="sxs-lookup"><span data-stu-id="b64a7-632">Widowed</span></span>                   |
| <span data-ttu-id="b64a7-633">หย่าร้าง</span><span class="sxs-lookup"><span data-stu-id="b64a7-633">Divorced</span></span>               | <span data-ttu-id="b64a7-634">หย่าร้าง</span><span class="sxs-lookup"><span data-stu-id="b64a7-634">Divorced</span></span>                  |
| <span data-ttu-id="b64a7-635">ห้างหุ้นส่วนจดทะเบียน</span><span class="sxs-lookup"><span data-stu-id="b64a7-635">Registered Partnership</span></span> | <span data-ttu-id="b64a7-636">ห้างหุ้นส่วนในประเทศ</span><span class="sxs-lookup"><span data-stu-id="b64a7-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="b64a7-637">None</span><span class="sxs-lookup"><span data-stu-id="b64a7-637">None</span></span>                   | <span data-ttu-id="b64a7-638">*ไม่รองรับโดยเม็กซิโก*</span><span class="sxs-lookup"><span data-stu-id="b64a7-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="b64a7-639">การอยู่ร่วมกัน</span><span class="sxs-lookup"><span data-stu-id="b64a7-639">Cohabiting</span></span>             | <span data-ttu-id="b64a7-640">*ไม่รองรับโดยเม็กซิโก*</span><span class="sxs-lookup"><span data-stu-id="b64a7-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="b64a7-641">เพศ</span><span class="sxs-lookup"><span data-stu-id="b64a7-641">Gender</span></span>

<span data-ttu-id="b64a7-642">การแต่งตั้งเพศถูกแม็ปไปยัง Dayforce และถูกแปล ตามความเหมาะสม ไปยังค่าที่ยอมรับ เมื่อมีการรวม</span><span class="sxs-lookup"><span data-stu-id="b64a7-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="b64a7-643">ตารางต่อไปนี้แสดงวิธีการแม็ปการแต่งตั้งเพศไปยัง Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="b64a7-644">ทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-644">Human Resources</span></span>       | <span data-ttu-id="b64a7-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="b64a7-646">เพศชาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-646">Male</span></span>         | <span data-ttu-id="b64a7-647">เพศชาย</span><span class="sxs-lookup"><span data-stu-id="b64a7-647">Male</span></span>                      |
| <span data-ttu-id="b64a7-648">เพศหญิง</span><span class="sxs-lookup"><span data-stu-id="b64a7-648">Female</span></span>       | <span data-ttu-id="b64a7-649">เพศหญิง</span><span class="sxs-lookup"><span data-stu-id="b64a7-649">Female</span></span>                    |
| <span data-ttu-id="b64a7-650">ไม่เจาะจง</span><span class="sxs-lookup"><span data-stu-id="b64a7-650">Non-specific</span></span> | <span data-ttu-id="b64a7-651">*ไม่รองรับโดยเม็กซิโก*</span><span class="sxs-lookup"><span data-stu-id="b64a7-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="b64a7-652">วิธีการชำระเงิน</span><span class="sxs-lookup"><span data-stu-id="b64a7-652">Payment method</span></span>

<span data-ttu-id="b64a7-653">วิธีการชำระเงินให้พนักงานและบริษัทมีวิธีในการอธิบายวิธีการจ่ายเงินแก่พนักงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="b64a7-654">วิธีการชำระเงินถูกแม็ปไปยัง Dayforce และถูกแปล ตามความเหมาะสม ไปยังค่าที่ยอมรับ เมื่อมีการรวม</span><span class="sxs-lookup"><span data-stu-id="b64a7-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="b64a7-655">ตารางต่อไปนี้แสดงวิธีการแม็ปวิธีการชำระเงินกับ Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="b64a7-656">ทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-656">Human Resources</span></span>             | <span data-ttu-id="b64a7-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="b64a7-658">เงินสด</span><span class="sxs-lookup"><span data-stu-id="b64a7-658">Cash</span></span>               | <span data-ttu-id="b64a7-659">เงินสด</span><span class="sxs-lookup"><span data-stu-id="b64a7-659">Cash</span></span>                      |
| <span data-ttu-id="b64a7-660">การชำระเงินทางอิเล็กทรอนิกส์</span><span class="sxs-lookup"><span data-stu-id="b64a7-660">Electronic Payment</span></span> | <span data-ttu-id="b64a7-661">การโอนย้าย</span><span class="sxs-lookup"><span data-stu-id="b64a7-661">Transfer</span></span>                  |
| <span data-ttu-id="b64a7-662">ตรวจสอบ</span><span class="sxs-lookup"><span data-stu-id="b64a7-662">Check</span></span>              | <span data-ttu-id="b64a7-663">เช็ค</span><span class="sxs-lookup"><span data-stu-id="b64a7-663">Cheque</span></span>                    |
| <span data-ttu-id="b64a7-664">ตั๋วแลกเงินธนาคาร</span><span class="sxs-lookup"><span data-stu-id="b64a7-664">Bank Draft</span></span>         | <span data-ttu-id="b64a7-665">*ไม่รองรับโดยเม็กซิโก*</span><span class="sxs-lookup"><span data-stu-id="b64a7-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="b64a7-666">อื่นๆ</span><span class="sxs-lookup"><span data-stu-id="b64a7-666">Other</span></span>              | <span data-ttu-id="b64a7-667">*ไม่รองรับโดยเม็กซิโก*</span><span class="sxs-lookup"><span data-stu-id="b64a7-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="b64a7-668">ชนิดของบัญชีธนาคาร</span><span class="sxs-lookup"><span data-stu-id="b64a7-668">Bank account type</span></span>

<span data-ttu-id="b64a7-669">ชนิดของบัญชีธนาคารถูกใช้สำหรับการชำระเงินทางอิเล็กทรอนิกส์แก่พนักงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="b64a7-670">ชนิดบัญชีธนาคารถูกแม็ปกับ Dayforce เป็นข้อมูลบัญชีการโอนย้าย</span><span class="sxs-lookup"><span data-stu-id="b64a7-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="b64a7-671">ชนิดของบัญชีธนาคารจะถูกแปล ตามความเหมาะสม กับค่าที่ยอมรับ เมื่อมีการรวม</span><span class="sxs-lookup"><span data-stu-id="b64a7-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="b64a7-672">ทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-672">Human Resources</span></span>            | <span data-ttu-id="b64a7-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="b64a7-674">บัญชีกระแสรายวัน</span><span class="sxs-lookup"><span data-stu-id="b64a7-674">Checking Account</span></span>  | <span data-ttu-id="b64a7-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="b64a7-675">CheckingAccount</span></span>           |
| <span data-ttu-id="b64a7-676">บัญชีเครดิตค่าจ้าง</span><span class="sxs-lookup"><span data-stu-id="b64a7-676">Payroll Account</span></span>   | <span data-ttu-id="b64a7-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="b64a7-677">PayrollAccount</span></span>            |
| <span data-ttu-id="b64a7-678">บัญชีออมทรัพย์</span><span class="sxs-lookup"><span data-stu-id="b64a7-678">Savings Account</span></span>   | <span data-ttu-id="b64a7-679">*ไม่รองรับโดยเม็กซิโก*</span><span class="sxs-lookup"><span data-stu-id="b64a7-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="b64a7-680">บัญชี BankGirot</span><span class="sxs-lookup"><span data-stu-id="b64a7-680">BankGirot account</span></span> | <span data-ttu-id="b64a7-681">*ไม่รองรับโดยเม็กซิโก*</span><span class="sxs-lookup"><span data-stu-id="b64a7-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="b64a7-682">บัญชี PlusGirot</span><span class="sxs-lookup"><span data-stu-id="b64a7-682">PlusGirot account</span></span> | <span data-ttu-id="b64a7-683">*ไม่รองรับโดยเม็กซิโก*</span><span class="sxs-lookup"><span data-stu-id="b64a7-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="b64a7-684">รหัสรายได้</span><span class="sxs-lookup"><span data-stu-id="b64a7-684">Earning codes</span></span>

<span data-ttu-id="b64a7-685">รหัสรายได้ระบุทุกชนิดของรายได้ทุกชนิดที่ผู้ปฏิบัติงานที่ได้รับ</span><span class="sxs-lookup"><span data-stu-id="b64a7-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="b64a7-686">รหัสครอบคลุมพารามิเตอร์ต่างๆ ที่เกี่ยวข้องกับรายได้ เช่น กฎทางบัญชี กฎภาษี ข้อกำหนดในการรายงาน และความสามารถในการชำระเพิ่ม</span><span class="sxs-lookup"><span data-stu-id="b64a7-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="b64a7-687">ถ้ามีการใช้ความถี่ที่ไม่สนับสนุน ความถี่ **การชำระค่าจ้างทุกๆ รายการ** จะถูกใช้ตามค่าเริ่มต้นสำหรับการคำนวณ</span><span class="sxs-lookup"><span data-stu-id="b64a7-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="b64a7-688">ความถี่ที่สนับสนุน</span><span class="sxs-lookup"><span data-stu-id="b64a7-688">Supported frequencies</span></span>

- <span data-ttu-id="b64a7-689">ทั้งหมด</span><span class="sxs-lookup"><span data-stu-id="b64a7-689">All</span></span>
- <span data-ttu-id="b64a7-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="b64a7-690">EVERYPAY</span></span>
- <span data-ttu-id="b64a7-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="b64a7-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="b64a7-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="b64a7-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="b64a7-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="b64a7-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="b64a7-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-694">1OFMTH</span></span>
- <span data-ttu-id="b64a7-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-695">LASTOFMTH</span></span>
- <span data-ttu-id="b64a7-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-696">2OFMTH</span></span>
- <span data-ttu-id="b64a7-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-697">3OFMTH</span></span>
- <span data-ttu-id="b64a7-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-698">4OFMTH</span></span>
- <span data-ttu-id="b64a7-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-699">5OFMTH</span></span>
- <span data-ttu-id="b64a7-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-700">1N2OFMTH</span></span>
- <span data-ttu-id="b64a7-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-701">3N4OFMTH</span></span>
- <span data-ttu-id="b64a7-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-702">1N3OFMTH</span></span>
- <span data-ttu-id="b64a7-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-703">1N4OFMTH</span></span>
- <span data-ttu-id="b64a7-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-704">2N3OFMTH</span></span>
- <span data-ttu-id="b64a7-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-705">2N4OFMTH</span></span>
- <span data-ttu-id="b64a7-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="b64a7-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="b64a7-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="b64a7-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="b64a7-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="b64a7-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="b64a7-711">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="b64a7-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="b64a7-712">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="b64a7-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="b64a7-713">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="b64a7-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="b64a7-714">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="b64a7-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="b64a7-715">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="b64a7-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="b64a7-716">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="b64a7-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="b64a7-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="b64a7-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="b64a7-718">ที่อยู่</span><span class="sxs-lookup"><span data-stu-id="b64a7-718">Addresses</span></span>

<span data-ttu-id="b64a7-719">การระบุรหัสประจำตัวของประเทศหรือภูมิภาคเฉพาะ รัฐ และรหัสเขต (เขตปกครอง) ต้องมีรูปแบบเฉพาะที่ Dayforce และผู้ให้บริการในประเทศ/ในเขตสามารถจดจำได้</span><span class="sxs-lookup"><span data-stu-id="b64a7-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="b64a7-720">แม้ว่ารูปแบบสำหรับเมืองจะยืดหยุ่นได้ เมืองทุกเมืองต้องเชื่อมโยงกับรัฐ</span><span class="sxs-lookup"><span data-stu-id="b64a7-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="b64a7-721">ทรัพยากรบุคคล</span><span class="sxs-lookup"><span data-stu-id="b64a7-721">Human Resources</span></span>              | <span data-ttu-id="b64a7-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="b64a7-723">ประเทศ/ภูมิภาค</span><span class="sxs-lookup"><span data-stu-id="b64a7-723">Country/Region</span></span>      | <span data-ttu-id="b64a7-724">รหัสประเทศ</span><span class="sxs-lookup"><span data-stu-id="b64a7-724">Country Code</span></span>          |
| <span data-ttu-id="b64a7-725">รหัสไปรษณีย์</span><span class="sxs-lookup"><span data-stu-id="b64a7-725">Zip/Postal Code</span></span>     | <span data-ttu-id="b64a7-726">รหัสไปรษณีย์</span><span class="sxs-lookup"><span data-stu-id="b64a7-726">Postal Code</span></span>           |
| <span data-ttu-id="b64a7-727">สถานะ</span><span class="sxs-lookup"><span data-stu-id="b64a7-727">State</span></span>               | <span data-ttu-id="b64a7-728">รหัสรัฐ</span><span class="sxs-lookup"><span data-stu-id="b64a7-728">State Code</span></span>            |
| <span data-ttu-id="b64a7-729">เมือง</span><span class="sxs-lookup"><span data-stu-id="b64a7-729">City</span></span>                | <span data-ttu-id="b64a7-730">เมือง</span><span class="sxs-lookup"><span data-stu-id="b64a7-730">City</span></span>                  |
| <span data-ttu-id="b64a7-731">เขตเทศบาล</span><span class="sxs-lookup"><span data-stu-id="b64a7-731">County</span></span>              | <span data-ttu-id="b64a7-732">เขต (เขตปกครอง)</span><span class="sxs-lookup"><span data-stu-id="b64a7-732">County (Municipality)</span></span> |
| <span data-ttu-id="b64a7-733">ถนน</span><span class="sxs-lookup"><span data-stu-id="b64a7-733">Street</span></span>              | <span data-ttu-id="b64a7-734">ที่อยู่ บรรทัดที่ 1</span><span class="sxs-lookup"><span data-stu-id="b64a7-734">Address Line 1</span></span>        |
| <span data-ttu-id="b64a7-735">หมายเลขถนน</span><span class="sxs-lookup"><span data-stu-id="b64a7-735">Street Number</span></span>       | <span data-ttu-id="b64a7-736">ที่อยู่ บรรทัดที่ 2</span><span class="sxs-lookup"><span data-stu-id="b64a7-736">Address Line 2</span></span>        |
| <span data-ttu-id="b64a7-737">ข้อมูลเพิ่มเติมเกี่ยวกับอาคาร</span><span class="sxs-lookup"><span data-stu-id="b64a7-737">Building Complement</span></span> | <span data-ttu-id="b64a7-738">ที่อยู่ บรรทัดที่ 5</span><span class="sxs-lookup"><span data-stu-id="b64a7-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="b64a7-739">หมายเลขหนังสือเดินทาง</span><span class="sxs-lookup"><span data-stu-id="b64a7-739">Passport number</span></span>

<span data-ttu-id="b64a7-740">พนักงานสามารถประกาศข้อมูลหนังสือเดินทางได้</span><span class="sxs-lookup"><span data-stu-id="b64a7-740">Employees can declare passport information.</span></span> <span data-ttu-id="b64a7-741">ข้อมูลนี้เป็นชนิดการระบุรหัสประจำตัว **หนังสือเดินทาง** และถูกรวมอยู่ใน Dayforce เป็นส่วนหนึ่งของข้อมูลเม็กซิโกเฉพาะของพนักงาน</span><span class="sxs-lookup"><span data-stu-id="b64a7-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="b64a7-742">ชนิดการระบุรหัสประจำตัว = "หนังสือเดินทาง"</span><span class="sxs-lookup"><span data-stu-id="b64a7-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="b64a7-743">วันที่ออก</span><span class="sxs-lookup"><span data-stu-id="b64a7-743">Issued Date</span></span>
- <span data-ttu-id="b64a7-744">วันหมดอายุ</span><span class="sxs-lookup"><span data-stu-id="b64a7-744">Expiration Date</span></span>

<span data-ttu-id="b64a7-745">พนักงานสามารถประกาศหมายเลขรหัสหลายเลขของชนิดการระบุรหัสประจำตัว **หนังสือเดินทาง**</span><span class="sxs-lookup"><span data-stu-id="b64a7-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="b64a7-746">อย่างไรก็ตาม เฉพาะรายการหนังสือเดินทางที่ใช้งานปัจจุบันจะถูกรวมอยู่ใน Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="b64a7-747">ถ้ารายการหนังสือเดินทางทั้งหมดหมดอายุ หนังสือเดินทางที่ออกครั้งล่าสุดจะถูกรวมอยู่ใน Dayforce</span><span class="sxs-lookup"><span data-stu-id="b64a7-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
