...
8. ป้อนข้อมูลที่จำเป็นสำหรับการตั้งค่าคอนฟิกแหล่งข้อมูล
   ...
   - **URL เป้าหมาย**: URL ของพื้นที่ว่างในชื่อทรัพยากรบุคคลของคุณ
...
4. ใน **ฮับความสมบูรณ์ของโซลูชัน** ให้เลือกไอคอน **การค้นหาขั้นสูง** ที่ด้านบนขวาของหน้า

5. บนหน้า **การค้นหาขั้นสูง** ในรายการแบบเลื่อนลง **ค้นหา** ให้เลือก **เอนทิตี HR ที่พร้อมใช้งาน**

6. ใช้ตัวเลือกการกรองข้อมูลเพื่อค้นหาหนึ่งเอนทิตี หรือมากกว่าหนึ่งเอนทิตีที่คุณต้องการเปิดใช้งาน

7. เลือกเอนทิตีจากรายการ

8. บนหน้าเอนทิตี ให้เปลี่ยนคุณสมบัติ **สร้างขึ้นแล้ว** เป็น **ใช่** สำหรับเอนทิตี

9. บันทึกและปิดหน้าเอนทิตี

> [!NOTE]
> คุณสามารถสร้างเอนทิตีเสมือนจำนวนมากพร้อมกันได้โดยใช้หน้า **เปลี่ยนหลายเรกคอร์ด** เลือกหลายเรกคอร์ดบนหน้า และเลือก **แก้ไข** บน ribbon คุณสามารถเปลี่ยนคุณสมบัติ **สร้างขึ้นแล้ว** สำหรับเรกคอร์ดที่เลือกทั้งหมดได้

![เอนทิตี HR ที่มีอยู่](./media/hr-admin-integration-virtual-entities-available.jpg)

> [!NOTE]
> เมื่อต้องการปรับปรุงกระบวนการสร้างเอนทิตีเสมือนในรุ่นต่อไป กระบวนการนี้จะเกิดขึ้นในหน้าในทรัพยากรบุคคล
