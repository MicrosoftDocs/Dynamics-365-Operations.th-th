...
หัวข้อนี้ตอบคําถามที่ถามบ่อยเกี่ยวกับการผสานโครงสร้างพื้นฐานของ Microsoft Dynamics 365 Human Resources และแอป Finance and Operations
...
Dynamics 365 Human Resources เป็นโปรแกรมประยุกต์แบบสแตนด์อโลนที่ใช้โครงสร้างพื้นฐานที่แตกต่างจากแอป Finance and Operations อื่นๆ เช่น Dynamics 365 Finance, Dynamics 365 Supply Chain Management, Dynamics 365 Commerce และ Dynamics 365 Project Operations การผสานโครงสร้างพื้นฐานจะนำ Dynamics 365 Human Resources ไปสู่โครงสร้างพื้นฐานเดียวกันกับแอป Finance and Operations อื่นๆ
...
### <a name="how-does-this-change-affect-me-if-i-am-an-existing-customer-and-i-use-both-the-hr-module-on-the-finance-and-operations-infrastructure-and-dynamics-365-human-resources-through-custom-integrations"></a>การเปลี่ยนแปลงนี้จะมีผลกระทบอย่างไรต่อฉันหากฉันเป็นลูกค้าปัจจุบัน และฉันใช้ทั้งโมดูล HR บนโครงสร้างพื้นฐาน Finance and Operations และ Dynamics 365 Human Resources ผ่านการรวมที่กำหนดเอง

การรวมที่กำหนดเองระหว่าง Dynamics 365 Human Resources และโมดูล HR ใน Dynamics 365 Finance จะไม่จำเป็นอีกต่อไป ข้อมูล HR ทั้งหมดจะอยู่ในฐานข้อมูลเดียวกับแอป Finance and Operations อื่นๆ

## <a name="migration-from-dynamics-365-human-resources-to-finance-and-operations-apps"></a>การย้ายจาก Dynamics 365 Human Resources ไปยังแอป Finance and Operations
...
หากองค์กรของคุณใช้ Dynamics 365 Human Resources แต่ไม่ได้ใช้แอป Finance and Operations อื่น สภาพแวดล้อมทรัพยากรบุคคลของคุณจะถูกย้ายไปยังโครงสร้างพื้นฐานใหม่ กระบวนการย้ายข้อมูลมากจะเป็นแบบอัตโนมัติ กระบวนการจะอยู่เพื่อย้ายฐานข้อมูลของคุณและซิงโครไนส์กับโครงสร้างพื้นฐานใหม่
...
ใช่ โมดูลทั้งหมดจาก Dynamics 365 Human Resources จะใช้งานเช่นเดียวกับในแอป Finance and Operations และจะมีพาริตี้คุณลักษณะ 100 เปอร์เซ็นต์ ในฐานะส่วนหนึ่งของกลยุทธ์การย้ายโดยรวมของลูกค้าที่ปัจจุบันใช้ความสามารถเหล่านี้ใน HR ข้อมูลลูกค้าจะถูกย้ายเพื่อที่จะยังคงทำงานบนโครงสร้างพื้นฐาน Finance and Operations

### <a name="i-use-the-new-dynamics-365-human-resources-benefits-management-capabilities-ive-built-custom-integrations-with-the-hr-module-on-the-finance-and-operations-infrastructure-so-that-i-can-take-advantage-of-the-payroll-capabilities-by-using-benefits-data-will-these-custom-integrations-be-required-going-forward"></a>ฉันใช้ความสามารถการจัดการสวัสดิการ Dynamics 365 Human Resources ใหม่ ฉันสร้างการรวมที่กำหนดเองเข้ากับโมดูล HR ในโครงสร้างพื้นฐาน Finance and Operations เพื่อให้ฉันใช้ประโยชน์จากความสามารถด้านค่าจ้างโดยการใช้ข้อมูลสวัสดิการ ต้องระบุการรวมที่กำหนดเองเหล่านี้เพื่อดำเนินการต่อหรือไม่

เนื่องจากเป็นส่วนหนึ่งของการผสานโครงสร้างพื้นฐาน ข้อมูล HR จะถูกพาไปยังฐานข้อมูลเดียวกันกับแอป Finance and Operations อื่นๆ คุณจะไม่ต้องมีการรวมระหว่างโมดูลในแอป Finance and Operations อีกต่อไป
...
### <a name="we-are-using-data-integrator-to-move-data-between-dynamics-365-human-resources-and-finance-and-operations-apps-how-will-the-data-that-is-currently-being-integrated-be-affected"></a>เราใช้งานตัวรวมข้อมูลเพื่อย้ายข้อมูลระหว่าง Dynamics 365 Human Resources และแอป Finance and Operations ข้อมูลที่จะรวมในปัจจุบันจะได้รับผลกระทบอย่างไร

ข้อมูล HR ที่ปัจจุบันเป็นต้นฉบับใน Dynamics 365 Human Resources มีการซิงโครไนส์กับ Dataverse จากนั้นตัวรวมข้อมูลสามารถใช้การซิงโครไนส์กับแอป Finance and Operations แบบทางเดียวได้ หลังจากการย้ายข้อมูลไปยังโครงสร้างพื้นฐานใหม่ ข้อมูล HR จะเป็นข้อมูลเริ่มต้นในแอป Finance and Operations ตัวรวมข้อมูลจะไม่ต้องใช้ในการซิงโครไนส์ข้อมูลระหว่างแอป Finance and Operations และ Human Resources อีกต่อไป
...
### <a name="we-are-using-dual-write-to-move-hr-data-between-dataverse-and-other-finance-and-operations-apps-how-will-the-data-that-is-currently-being-integrated-be-affected-by-the-migration-to-the-new-infrastructure"></a>เราใช้งานการรวมแบบสองทิศทางเพื่อย้ายข้อมูล HR ระหว่าง Dataverse และแอป Finance and Operations อื่นๆ การย้ายไปยังโครงสร้างพื้นฐานใหม่จะส่งผลกระทบต่อข้อมูลที่ถูกรวมในปัจจุบันอย่างไร

ข้อมูล HR จะเป็นข้อมูลเริ่มต้นในแอป Finance and Operations ในสภาพแวดล้อมบนโครงสร้างพื้นฐานใหม่ จากนั้นจะมีการใช้การรวมแบบสองทิศทางเพื่อย้ายข้อมูล HR ระหว่างสภาพแวดล้อมใหม่และสภาพแวดล้อม Dataverse
...
ขึ้นอยู่กับปลายทางการรวม สำหรับข้อมูลเพิ่มเติมเกี่ยวกับเทคโนโลยีการรวมที่พร้อมใช้งานในแอป Finance and Operations และวิธีเลือกเทคโนโลยีการรวมที่ดีที่สุด ดูที่ [ภาพรวมการรวม](../fin-ops-core/dev-itpro/data-entities/integration-overview.md)
...
คาดว่าสภาพแวดล้อม Human Resources จะยังคงอยู่ในภูมิภาค Azure เดียวกันในระหว่างการย้าย ข้อยกเว้นเพียงอย่างเดียวจะเกิดขึ้นถ้าสภาพแวดล้อม Human Resources จะถูกผสานกับสภาพแวดล้อม Finance and Operations ที่อยู่ในภูมิภาคแตกต่างกัน ในกรณีนี้ สภาพแวดล้อม Human Resources จะถูกย้ายไปยังภูมิภาค Azure ของสภาพแวดล้อม Finance and Operations
...
การรวมกับ Ceridian จะถูกย้ายไปยังการรวมโดยใช้ API ของค่าจ้าง การรวมโดยใช้ไฟล์ที่มีอยู่ในปัจจุบันใน Dynamics 365 Human Resources จะไม่ถูกย้ายไปยังโครงสร้างพื้นฐาน Finance and Operations สำหรับข้อมูลเพิ่มเติม ดูที่ [บทนําเกี่ยวกับ API บัญชีเงินเดือน](./hr-admin-integration-payroll-api-introduction.md)
...
ทั้งตัวเลือกความสามารถในการเพิ่มฟังก์ชัน Microsoft Power Platform และตัวเลือกความสามารถในการเพิ่มฟังก์ชัน Finance and Operations จะพร้อมใช้งานและสามารถใช้กับการพัฒนาได้ สำหรับข้อมูลเพิ่มเติม ดูที่ [พัฒนาและกำหนดโฮมเพจ](../fin-ops-core/dev-itpro/dev-tools/developer-home-page.md)
...
การส่งออกใดๆ ที่ตั้งค่าคอนฟิกในปัจจุบันสำหรับ Azure Data Lake Storage ในแอป Finance and Operations จะรักษาการตั้งค่าคอนฟิกเดียวกันไว้หลังจากการย้ายข้อมูล
...
ใช่ Dynamics 365 Human Resources จะรวมอยู่ในโค้ดพื้นฐานที่ผสานและโครงสร้างพื้นฐานของแอป Finance and Operations การอัปเกรดจาก Dynamics AX 2012 เป็น Dynamics 365 Human Resources จะใช้พาธการอัปเกรดและเครื่องมือเดียวกันกับที่ใช้ในการอัปเกรดเป็นแอป Finance and Operations รุ่นล่าสุด
...
เอกสารจะยังคงอยู่ในที่จัดเก็บเอกสารปัจจุบัน โดยจะแม็ปใหม่ไปยังสภาพแวดล้อมในโครงสร้างพื้นฐานใหม่
