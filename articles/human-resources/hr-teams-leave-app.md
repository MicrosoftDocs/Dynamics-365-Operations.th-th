---
title: จัดการคำขอลางานใน Teams
description: บทความนี้จะแสดงวิธีการขอลาหยุดในแอป Dynamics 365 Human Resources ใน Microsoft Teams
author: twheeloc
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> ถ้าคุณไม่เห็นกล่องโต้ตอบลงชื่อเข้าใช้ ให้อัพเดตการตั้งค่าเบราว์เซอร์ของคุณเพื่ออนุญาตป๊อปอัป 
...
> [!NOTE]
> เมื่อคุณโต้ตอบกับบอทครั้งแรก คุณอาจจำเป็นต้องลงชื่อเข้าใช้ ถ้าคุณไม่เห็นกล่องโต้ตอบลงชื่อเข้าใช้ ให้อัพเดตการตั้งค่าเบราว์เซอร์ของคุณเพื่ออนุญาตป๊อปอัป

คุณสามารถขอให้บอทไปที่:

- ดูยอดดุลการลางานปัจจุบันของคุณ ตัวอย่างเช่น ส่งข้อความที่ระบุว่า "ดูยอดดุลการลางาน"

- เริ่มต้นการร้องขอการลาหยุดสำหรับคุณ ตัวอย่างเช่น ส่งข้อความ "ลางาน" หรือ "ฉันต้องการหยุดพักร้อนในวันพฤหัสบดีและวันศุกร์ถัดไป" เพื่อระบุถึงเหตุผลในการขอลาในประเภทการลางานในวันหยุด 
...
เมื่อคุณหรือผู้ปฏิบัติงานที่คุณเป็นผู้อนุมัติการลาหยุด คุณจะได้รับการแจ้งเตือนในแอป Human Resources ใน Teams คุณสามารถเลือกการแจ้งเตือนเพื่อดูการขอลาหยุดได้ การแจ้งเตือนจะปรากฏในพื้นที่ **การแชท** ด้วย
...
### <a name="cant-find-the-dynamics-365-human-resources-environment-in-settings"></a>ไม่พบสภาพแวดล้อมในการตั้งค่า Dynamics 365 Human Resources
...
หากคุณยังคงพบปัญหาการแปล โปรดแจ้งให้เราทราบ สำหรับข้อมูลเพิ่มเติม โปรดดู [รับการสนับสนุนสำหรับแอปการเงินและการดำเนินงาน หรือ Lifecycle Services (LCS)](../fin-ops-core/dev-itpro/lifecycle-services/lcs-support.md?toc=%2fdynamics365%2fhuman-resources%2ftoc.json)
...
| บนแท็บ **เวลาหยุดพัก** เสียงตามสายจะประกาศปุ่มดำเนินการขณะที่อ่านส่วนหัวของกริดเวลาหยุดพัก | ส่วนหัวและองค์ประกอบภายในกริดจะถูกจัดกลุ่มตามปี และจะสามารถยุบได้ เสียงตามสายจะแปลการนำเสนอนนี้เป็นสินค้าที่สามารถดำเนินการได้ แต่ไม่ใช่ |
