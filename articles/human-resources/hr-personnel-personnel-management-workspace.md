...
description: บทความนี้อธิบายองค์ประกอบแนวคิดของพื้นที่การจัดการบุคลากร
author: twheeloc
ms.date: 11/03/2021
ms.topic: article
ms.prod: ''
...
พื้นที่ทำงาน **การจัดการบุคลากร** ประกอบด้วยเนื้อหาจํานวนหนึ่ง ประกอบด้วยความเคลื่อนไหวของบุคลากร ติดตามการเปลี่ยนแปลงของพนักงาน ตําแหน่งที่เปิด การเปลี่ยนแปลงที่อยู่ เรกคอร์ดที่หมดอายุ และการวิเคราะห์ และให้ลิงค์ไปยังข้อมูลเฉพาะ บทความนี้แสดงรายละเอียดเกี่ยวกับแต่ละส่วนของพื้นที่ทำงาน
...
> [!NOTE] 
> ขอแนะนำให้คุณกําหนดตําแหน่งงานให้กับผู้ปฏิบัติงานก่อนใช้รายการตรวจสอบ ในบางครั้ง งานการลงทะเบียนใหม่จะถูกมอบหมายให้กับผู้จัดการที่ได้รับการว่าจ้างใหม่ อย่างไรก็ตาม หากไม่มีการกำหนดตําแหน่ง ไม่สามารถกําหนดผู้จัดการของพนักงานใหม่ได้ ในกรณีดังกล่าว งานการเตรียมพร้อมที่มีไว้เพื่อผู้จัดการจะถูกกําหนดให้กับเจ้าของรายการตรวจสอบแทน
