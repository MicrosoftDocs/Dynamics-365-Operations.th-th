...
3. ระบุค่าสำหรับฟิลด์ต่อไปนี้
   ...
   | **ข้อความป้ายชื่อของไทล์** | ข้อความที่จะปรากฏสำหรับไทล์ใน **บริการตนเองของพนักงาน** |
   | **คำอธิบาย** | คำอธิบายเกี่ยวกับไทล์ |
   | **ที่อยู่อินเทอร์เน็ต** | ป้อน URL ไปยังหน้า **บริการตนเองของพนักงาน** |
