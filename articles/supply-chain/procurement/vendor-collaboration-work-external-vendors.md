---
title: การทำงานร่วมกันของผู้จัดจำหน่ายกับผู้จัดจำหน่ายภายนอก
description: บทความนี้อธิบายวิธีที่เจ้าหน้าที่จัดซื้อสามารถทำงานร่วมกันกับผู้จัดจำหน่ายภายนอก เพื่อแลกเปลี่ยนข้อมูลเกี่ยวกับใบสั่งซื้อและสินค้าคงคลังที่มีการส่งมอบ
...
### <a name="scheduling-the-auto-confirmation-batch-job"></a>การจัดกำหนดการชุดงานการยืนยันอัตโนมัติ
...
1. ในกล่องโต้ตอบ **ยืนยันใบสั่งซื้อที่ยอมรับจากการทำงานร่วมกันของผู้จัดจำหน่าย** บนแท็บด่วน **ทำงานในแบบเบื้องหลัง** เลือก **การเกิดซ้ำ**
1. ในกล่องโต้ตอบ **กำหนดการเกิดซ้ำ** ให้กําหนดกําหนดการที่งานควรเกิดขึ้น เมื่อคุณเลือกกำหนดการ ให้พิจารณาปัญหาต่อไปนี้
...
1. เลือก **ตกลง** เพื่อใช้กำหนดการของคุณและกลับไปที่กล่องโต้ตอบ **ยืนยันใบสั่งซื้อที่ยอมรับจากการทำงานร่วมกันของผู้จัดจำหน่าย**
1. ตั้งค่าตัวเลือกเบื้องหลังเพิ่มเติมตามความต้องการ กล่องโต้ตอบจะมีตัวเลือกปกติในการตั้งค่าชุดงานใน Supply Chain Management

สำหรับข้อมูลเพิ่มเติมเกี่ยวกับชุดงาน โปรดดู [ภาพรวมของการประมวลผลชุดงาน](../../fin-ops-core/dev-itpro/sysadmin/batch-processing-overview.md)
