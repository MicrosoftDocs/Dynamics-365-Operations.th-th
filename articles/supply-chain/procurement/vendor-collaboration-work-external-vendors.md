...
<td>สถานะใบสั่งจะถูกอัพเดตเป็น <strong>ยืนยันแล้ว</strong> ถ้าใบสั่งไม่ถูกอัพเดตด้วยเหตุผลบางประการ การตอบสนองของผู้จัดจำหน่ายจะยังคงถูกบันทึกเป็น <strong>ยอมรับแล้ว</strong> แต่สถานะของใบสั่งซื้อจะยังคงเป็น <strong>อยู่ระหว่างการตรวจทานภายนอก</strong> 
...
<tr class="odd">
<td>ผู้จัดจำหน่าย <strong>ยอมรับ</strong> ใบสั่ง แต่ Finance and Operations ไม่ถูกตั้งค่าคอนฟิกเพื่อยืนยัน POs ที่ผู้จัดจำหน่ายที่ยอมรับโดยอัตโนมัติ</td>
...
ผู้จัดจำหน่ายไม่สามารถเปลี่ยนข้อมูลราคาและค่าธรรมเนียมได้ อย่างไรก็ตาม ผู้จัดจำหน่ายสามารถแนะนำการเปลี่ยนแปลงเหล่านี้ได้โดยใช้บันทึกย่อ</td>
<td>การตอบสนองของผู้จัดจำหน่ายถูกบันทึกเป็น <strong>ยืนยันการเปลี่ยนแปลง</strong> และสถานะของ PO ยังคงเป็น <strong>ระหว่างการตรวจทานภายนอก</strong> สถานะแสดงชนิดของการเปลี่ยนแปลงที่ผู้จัดจำหน่ายได้แนะนำ สำหรับข้อมูลเกี่ยวกับปริมาณการใช้วัสดุอัตโนมัติของการเปลี่ยนแปลง ดูส่วน "อัพเดต PO เมื่อมีการเปลี่ยนแปลงที่แนะนำโดยผู้จัดจำหน่าย" ในภายหลังในหัวข้อนี้ </td>
</tr>
</tbody>
</table>
