...
> [!NOTE]
> ข้อมูลเกี่ยวกับการทำงานร่วมกันกับผู้จัดจำหน่ายในหัวข้อนี้ ใช้เฉพาะกับกับรุ่นปัจจุบันของ Finance and Operations ใน Microsoft Dynamics AX 7.0 (กุมภาพันธ์ 2016) และแอพลิเคชัน Microsoft Dynamics AX เวอร์ชัน 7.0.1 (พฤษภาคม 2016) คุณร่วมมือกับผู้จัดจำหน่ายโดยใช้การใช้โมดูล **พอร์ทัลผู้จัดจำหน่าย** สำหรับข้อมูลเกี่ยวกับโมดูล **พอร์ทัลของผู้จัดจำหน่าย** ดู [ทำงานร่วมกันกับผู้จัดจำหน่ายโดยการใช้พอร์ทัลผู้จัดจำหน่าย](collaborate-vendors-vendor-portal.md)
...
ผู้ดูแลระบบตั้งค่าคอนฟิกการตั้งค่าทั่วไปสำหรับการทำงานร่วมกันกับผู้จัดจำหน่ายใน Finance and Operations เช่น บทบาทความปลอดภัยที่พร้อมใช้งานสำหรับผู้จัดจำหน่ายทั้งหมดที่คุณทำงานด้วย อย่างไรก็ตาม ยังมีการตั้งค่าที่อาจแตกต่างกันสำหรับแต่ละบัญชีของผู้จัดจำหน่ายอีกด้วย คุณควรตั้งค่าคอนฟิกการตั้งค่าเหล่านี้
...
<tbody>
<tr class="even">
<td>ผู้จัดจำหน่าย <strong>ยอมรับ</strong> ใบสั่ง และ Finance and Operations ถูกตั้งค่าคอนฟิกเพื่อยืนยัน POs ที่ผู้จัดจำหน่ายที่ยอมรับโดยอัตโนมัติ</td>
<td>สถานะใบสั่งจะถูกอัพเดตเป็น <strong>ยืนยันแล้ว</strong> ถ้าใบสั่งไม่&#39;สามารถอัพเดตได้ด้วยเหตุผลบางประการ การตอบสนองของผู้จัดจำหน่ายจะยังคงถูกบันทึกเป็น <strong>ยอมรับแล้ว</strong> แต่สถานะของใบสั่งซื้อจะยังคงเป็น <strong>อยู่ระหว่างการตรวจทานภายนอก</strong> 
...
<tr class="odd">
<td>ผู้จัดจำหน่าย <strong>ยอมรับ</strong> ใบสั่ง แต่ Finance and Operations ไม่&#39;ถูกตั้งค่าคอนฟิกเพื่อยืนยัน POs ที่ผู้จัดจำหน่ายที่ยอมรับโดยอัตโนมัติ</td>
...
<td>การตอบสนองของผู้จัดจำหน่ายถูกเรกคอร์ดเป็น <strong>ปฏิเสธแล้ว</strong> และใบสั่งซื้อยังคงอยู่ในสถานะอยู่ระหว่าง <strong>การตรวจทานภายนอก</strong> ได้รับการปฏิเสธพร้อมกับบันทึกย่อของ&#39;ผู้จัดจำหน่าย</td>
</tr>
<tr class="odd">
...
ผู้จัดจำหน่ายไม่&#39;สามารถเปลี่ยนข้อมูลราคาและค่าธรรมเนียมได้ อย่างไรก็ตาม ผู้จัดจำหน่ายสามารถแนะนำการเปลี่ยนแปลงเหล่านี้ได้โดยใช้บันทึกย่อ</td>
...
ผู้จัดจำหน่ายไม่ต้องยืนยัน PO โดยการใช้อินเทอร์เฟสการทำงานร่วมกันกับผู้จัดจำหน่าย พวกเขายังสามารถส่งข้อความอีเมล หรือสื่อสารการยอมรับ PO ของพวกเขาผ่านช่องทางอื่นๆ ได้อีกด้วย จากนั้น คุณสามารถยืนยันใบสั่งด้วยตนเองได้ใน Finance and Operations ในกรณีนี้ คุณจะได้รับคำเตือนสถานะที่กำลังยืนยันใบสั่ง แม้ว่าจะไม่มีการตอบสนองใดๆ จากผู้จัดจำหน่าย จากนั้น PO จะปรากฎในประวัติการยืนยันเป็นใบสั่งที่มีการยืนยันแบบเปิดที่ไม่มีการตอบสนองใดๆ ณ จุดนี้ ผู้จัดจำหน่ายจะไม่มีตัวเลือกที่จะยืนยันหรือปฏิเสธ PO อีกต่อไป

> [!NOTE]
> PO เวอร์ชันที่พร้อมใช้งานสำหรับกระบวนการอื่นๆ ใน Finance and Operations เป็นเวอร์ชันล่าสุดเสมอ แม้ว่าเวอร์ชันนั้นยังไม่ได้ถูกลงทะเบียนไว้ในอินเทอร์เฟสการทำงานร่วมกันกับผู้จัดจำหน่าย
...
ส่วนนี้อธิบายการโต้ตอบระหว่างลูกค้าและผู้จัดจำหน่ายในระหว่างกระบวนการ RFQ ซึ่งยังอธิบายถึงวิธีการสื่อสารข้อมูลไปยังผู้จัดจำหน่ายอีกด้วย สำหรับภาพรวมของข้อมูลพื้นฐานของการสนับสนุนสำหรับกระบวนการ RFQ ดู [คำขอใบเสนอราคา (RFQs)](request-quotations.md)
