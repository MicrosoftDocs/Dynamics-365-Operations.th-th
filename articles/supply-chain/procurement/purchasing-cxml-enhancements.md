...
เมื่อต้องการเปิดใช้งานลักษณะการทำงาน ให้เปิดหน้า **[การจัดการลักษณะการทำงาน](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)** และค้นหาลักษณะการทำงานที่มีการระบุชื่อ *การปรับปรุง cXML การซื้อ* เลือกคุณลักษณะการทำงาน และจากนั้นเลือก **เปิดใช้งานตอนนี้** เพื่อเปิดใช้งาน (เริ่มจาก Supply Chain Management เวอร์ชัน 10.0.21 คุณลักษณะนี้จะเปิดตามค่าเริ่มต้น)
...
- **USERAGENT** – ป้อนค่าเพื่อระบุระบบที่คุณกำลังใช้อยู่ สำหรับตัวอย่าง ป้อน _Dynamics 365 Supply Chain Management_
...
เมื่อต้องการตั้งค่าชนิดของหมายเหตุที่ระบบจะค้นหา ให้ไปที่ **การจัดซื้อและการจัดหา \> การตั้งค่า \> แบบฟอร์ม \> การตั้งค่าแบบฟอร์ม** บนแท็บ **ใบสั่งซื้อ** ให้ตั้งค่าฟิลด์ **รวมเอกสารของประเภท** ให้กับประเภทของหมายเหตุที่คุณต้องการให้สามารถรวมได้ มีเพียงข้อความที่จะรวมไว้เท่านั้น ไม่ใช่เอกสารแนบของเอกสาร
