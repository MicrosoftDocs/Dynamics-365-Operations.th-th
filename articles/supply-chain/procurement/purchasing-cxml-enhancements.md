...
![พื้นที่สำหรับการตั้งค่าลักษณะการทำงาน cXML](media/cxml-settings-areas.png "พื้นที่สำหรับการตั้งค่าลักษณะการทำงาน cXML")
...
![หน้าการตั้งค่าแบบฟอร์ม](media/cxml-form-setup.png "หน้าการตั้งค่าแบบฟอร์ม")
...
![หมายเหตุที่แนบซึ่งตั้งค่าไว้เพื่อส่งให้กับผู้จัดจำหน่าย](media/cxml-note-to-vendor.png "หมายเหตุที่แนบซึ่งตั้งค่าไว้เพื่อส่งให้กับผู้จัดจำหน่าย")
...
![หน้าล็อกข้อความของรถเข็น cXML](media/cxml-cart-message-log.png "หน้าล็อกข้อความของรถเข็น cXML")
...
![ชุดใบสั่งซื้อที่จะใช้ cXML](media/cxml-purchase-order.png "ชุดใบสั่งซื้อที่จะใช้ cXML")
