...
| ข้อบังคับ | สำหรับแอททริบิวต์ของชนิด *บูลีน* ถ้ามีการตั้งค่าตัวเลือกนี้เป็น *ใช่* ผู้ใช้ต้องตั้งค่าแอททริบิวต์เป็น *ใช่* ถ้ามีการตั้งค่าตัวเลือกนี้เป็น *ไม่* ผู้ใช้สามารถตั้งค่าแอททริบิวต์เป็น *ใช่* หรือ *ไม่* สำหรับชนิดข้อมูลอื่นๆ การตั้งค่าของตัวเลือกนี้จะให้ข้อมูลเท่านั้น |
