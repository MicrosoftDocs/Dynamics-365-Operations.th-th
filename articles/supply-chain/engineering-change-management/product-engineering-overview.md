...
description: บทความนี้แสดงภาพรวมของการจัดการการเปลี่ยนแปลงทางวิศวกรรม ซึ่งช่วยให้คุณสามารถวางแผนและจัดการการกำหนดรุ่นผลิตภัณฑ์ และจัดการวงจรผลิตภัณฑ์และการเปลี่ยนแปลงทางวิศวกรรม
author: t-benebo
ms.date: 08/09/2022
ms.topic: overview
ms.prod: ''
...
### <a name="turn-the-basic-engineering-change-management-features-on-or-off"></a>เปิดหรือปิดคุณลักษณะการจัดการการเปลี่ยนแปลงทางวิศวกรรมพื้นฐาน

การเปิดหรือปิดคุณลักษณะการจัดการการเปลี่ยนแปลงทางวิศวกรรมพื้นฐาน ให้ทำตามขั้นตอนเหล่านี้ เริ่มจาก Supply Chain Management เวอร์ชัน 10.0.25 คุณลักษณะ *การจัดการการเปลี่ยนแปลงทางวิศวกรรม* จะเปิดตามค่าเริ่มต้น
...
1. ตรวจหาการอัปเดต
1. เปิดหรือปิดคุณลักษณะที่ชื่อ *การจัดการการเปลี่ยนแปลงทางวิศวกรรม* ตามความจำเป็น
1. ถ้าคุณต้องการติดตามมิติรุ่นของผลิตภัณฑ์ในธุรกรรม (ไม่บังคับ) ให้เปิดคุณลักษณะที่ชื่อ *รุ่นของมิติของผลิตภัณฑ์*

### <a name="turn-the-required-configuration-keys-on-or-off"></a>เปิดหรือปิดคีย์การตั้งค่าคอนฟิกที่จำเป็น

ถัดไป เปิดใช้งานคีย์การตั้งค่าคอนฟิกเหล่านั้นได้โดยปฏิบัติตามขั้นตอนต่อไปนี้ คุณลักษณะเหล่านี้ไม่ได้เปิดโดยค่าเริ่มต้น
...
1. ขยายโหนด **การค้า**
1. เปิดหรือปิดใช้งานนคีย์การตั้งค่าคอนฟิกสำหรับลักษณะหลักโดยใช้กล่องกาเครื่องหมาย **การจัดการการเปลี่ยนแปลงทางวิศวกรรม**
...
1. ถ้าคุณต้องการใช้มิติรุ่นด้วย ให้เลือกกล่องกาเครื่องหมาย **มิติของผลิตภัณฑ์ - รุ่น** ด้วย (กล่องกาเครื่องหมายนี้จะอยู่ด้านล่างรายการ ไม่ได้ซ้อนภายใต้โหนด **การจัดการการเปลี่ยนแปลงทางวิศวกรรม**) คุณสามารถล้างกล่องกาเครื่องหมายนี้ได้ถ้าคุณไม่ต้องการคุณลักษณะนี้
1. ปิดโหมดการบำรุงรักษา ตามที่อธิบายไว้ใน [โหมดการบำรุงรักษา](../../fin-ops-core/dev-itpro/sysadmin/maintenance-mode.md)
1. ต้องมีการซิงโครไนส์ฐานข้อมูลเพื่อให้แน่ใจว่าคีย์การตั้งค่าคอนฟิกอัปเดตอย่างถูกต้องเพื่อแสดงการเปลี่ยนแปลง เลือกปฏิบัติตามขั้นตอนใดขั้นตอนหนึ่งต่อไปนี้ ขึ้นอยู่กับชนิดของสภาพแวดล้อมที่คุณทำงานอยู่
...
> [!NOTE]
> ถ้าต้องการใช้การจัดการการเปลี่ยนแปลงทางวิศวกรรม ต้องมีการตั้งค่าทั้งลำดับหมายเลข BOM และลำดับหมายเลขสูตร (ถ้าคุณใช้สูตรอยู่) เป็น *อัตโนมัติ* บนหน้า **ลำดับหมายเลข**
