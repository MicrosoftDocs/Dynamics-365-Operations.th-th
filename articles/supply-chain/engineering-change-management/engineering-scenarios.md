...
- <span data-ttu-id="e32c0-113">วิธีการจัดกำหนดการและดำเนินการเปลี่ยนแปลงที่ร้องขอโดยการสร้างใบสั่งเปลี่ยนแปลงทางวิศวกรรม</span><span class="sxs-lookup"><span data-stu-id="e32c0-113">How to schedule and implement requested changes by creating an engineering change order</span></span>
...
### <a name="set-up-an-engineering-organization"></a><span data-ttu-id="e32c0-127">ตั้งค่าองค์กรวิศวกรรม</span><span class="sxs-lookup"><span data-stu-id="e32c0-127">Set up an engineering organization</span></span>
...
### <a name="set-up-product-lifecycle-states"></a><span data-ttu-id="e32c0-142">ตั้งค่าสถานะของวงจรการใช้ของผลิตภัณฑ์</span><span class="sxs-lookup"><span data-stu-id="e32c0-142">Set up product lifecycle states</span></span>
...
1. <span data-ttu-id="e32c0-176">บน FastTab **ผลิตภัณฑ์ทั้งหมด** ให้เลือก **เพิ่ม** เพื่อเพิ่มบรรทัด และตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="e32c0-176">On the **All products** FastTab, select **Add** to add a line, and set the following values for it:</span></span>
...
1. <span data-ttu-id="e32c0-194">บน FastTab **รายละเอียด** ให้กำหนดค่าดังต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="e32c0-194">On the **Details** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="e32c0-195">**ชื่อ:** *ส่วนประกอบ*</span><span class="sxs-lookup"><span data-stu-id="e32c0-195">**Name:** *Components*</span></span>
...
## <a name="create-a-new-engineering-product"></a><span data-ttu-id="e32c0-214">สร้างผลิตภัณฑ์วิศวกรรมใหม่</span><span class="sxs-lookup"><span data-stu-id="e32c0-214">Create a new engineering product</span></span>
...
1. <span data-ttu-id="e32c0-230">เลือก **ตกลง** เพื่อสร้างผลิตภัณฑ์ และปิดกล่องโต้ตอบ</span><span class="sxs-lookup"><span data-stu-id="e32c0-230">Select **OK** to create the product and close the dialog box.</span></span>
...
1. <span data-ttu-id="e32c0-242">ในกล่องโต้ตอบ **สร้าง BOM** ให้ตั้งค่าค่าดังต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="e32c0-242">In the **Create BOM** dialog box, set the following values:</span></span>
    ...
    <span data-ttu-id="e32c0-246">![กำลังสร้าง BOM](media/create-bom.png "กำลังสร้าง BOM")</span><span class="sxs-lookup"><span data-stu-id="e32c0-246">![Creating a BOM](media/create-bom.png "Creating a BOM")</span></span>
...
1. <span data-ttu-id="e32c0-264">รักษาการตั้งค่านิติบุคคลเป็น *DEMF*</span><span class="sxs-lookup"><span data-stu-id="e32c0-264">Keep the legal entity set to *DEMF*.</span></span> <span data-ttu-id="e32c0-265">(ใช้ตัวเลือกบริษัททางด้านขวาของแถบนำทางตามต้องการ)</span><span class="sxs-lookup"><span data-stu-id="e32c0-265">(Use the company picker on the right side of the navigation bar as required.)</span></span>
...
<span data-ttu-id="e32c0-296">เมื่อต้องการรีวิวผลิตภัณฑ์และนำออกใช้ในบริษัท *USMF* ให้ทำตามขั้นตอนเหล่านี้</span><span class="sxs-lookup"><span data-stu-id="e32c0-296">To review the product and release it in the *USMF* company, follow these steps.</span></span>
...
## <a name="use-the-product-in-transactions-in-the-local-company"></a><span data-ttu-id="e32c0-316">ใช้ผลิตภัณฑ์ในธุรกรรมในบริษัทเฉพาะที่</span><span class="sxs-lookup"><span data-stu-id="e32c0-316">Use the product in transactions in the local company</span></span>
...
1. <span data-ttu-id="e32c0-329">ไปยัง **การขายและการตลาด &gt; ใบสั่งขาย &gt; ใบสั่งขายทั้งหมด**</span><span class="sxs-lookup"><span data-stu-id="e32c0-329">Go to **Sales and marketing &gt; Sales orders &gt; All sales orders**.</span></span>
...
## <a name="make-changes-to-the-product-by-using-an-engineering-change-order"></a><span data-ttu-id="e32c0-358">ทำการเปลี่ยนแปลงไปยังผลิตภัณฑ์โดยใช้ใบสั่งเปลี่ยนแปลงทางวิศวกรรม</span><span class="sxs-lookup"><span data-stu-id="e32c0-358">Make changes to the product by using an engineering change order</span></span>

<span data-ttu-id="e32c0-359">พนักงานขายรู้ว่าผลิตภัณฑ์มีความสำคัญและได้รับการออกแบบโดยเฉพาะสำหรับลูกค้า</span><span class="sxs-lookup"><span data-stu-id="e32c0-359">The sales clerk knows that the product is important and was designed especially for the customer.</span></span> <span data-ttu-id="e32c0-360">ดังนั้น พนักงานขายจึงเรียกวิศวกรในบริษัท *DEMF* เพื่อแจ้งให้ทราบเกี่ยวกับคำขอเปลี่ยนแปลง</span><span class="sxs-lookup"><span data-stu-id="e32c0-360">Therefore, the sales clerk calls an engineer in the *DEMF* company to notify them about the change request.</span></span> <span data-ttu-id="e32c0-361">ด้วยวิธีนี้ วิศวกรจึงสามารถทำให้กระบวนการทำงานรวดเร็วขึ้น</span><span class="sxs-lookup"><span data-stu-id="e32c0-361">In this way, the engineer can speed up the process.</span></span>

<span data-ttu-id="e32c0-362">ขณะนี้วิศวกรตรวจสอบคำขอจากลูกค้า และสร้างใบสั่งเปลี่ยนแปลงสำหรับผลิตภัณฑ์</span><span class="sxs-lookup"><span data-stu-id="e32c0-362">The engineer now reviews the request from the customer and creates a change order for the product.</span></span>

1. <span data-ttu-id="e32c0-363">เนื่องจากวิศวกรทำงานในบริษัท *DEMF* ให้ตั้งค่านิติบุคคลเป็น *DEMF*</span><span class="sxs-lookup"><span data-stu-id="e32c0-363">Because the engineer works in the *DEMF* company, set the legal entity to *DEMF*.</span></span> <span data-ttu-id="e32c0-364">(ใช้ตัวเลือกบริษัททางด้านขวาของแถบนำทาง)</span><span class="sxs-lookup"><span data-stu-id="e32c0-364">(Use the company picker on the right side of the navigation bar.)</span></span>
1. <span data-ttu-id="e32c0-365">ให้ไปที่ **การจัดการการเปลี่ยนแปลงทางวิศวกรรม &gt; ทั่วไป &gt; คำขอเปลี่ยนแปลงทางวิศวกรรม**</span><span class="sxs-lookup"><span data-stu-id="e32c0-365">Go to **Engineering change management &gt; Common &gt; Engineering change requests**.</span></span>
1. <span data-ttu-id="e32c0-366">เปิดคำขอเปลี่ยนแปลง *555*</span><span class="sxs-lookup"><span data-stu-id="e32c0-366">Open change request *555*.</span></span>
1. <span data-ttu-id="e32c0-367">รีวิวข้อมูล แล้วจากนั้น อนุมัติการเปลี่ยนแปลง</span><span class="sxs-lookup"><span data-stu-id="e32c0-367">Review the information, and then approve the change.</span></span> <span data-ttu-id="e32c0-368">บนบานหน้าต่างการดำเนินการ บนแท็บ **คำขอเปลี่ยนแปลง** ในกลุ่ม **สถานะการเปลี่ยนแปลง** ให้เลือก **อนุมัติ**</span><span class="sxs-lookup"><span data-stu-id="e32c0-368">On the Action Pane, on the **Change request** tab, in the **Change status** group, select **Approve**.</span></span>
1. <span data-ttu-id="e32c0-369">ให้ไปที่ **การจัดการการเปลี่ยนแปลงทางวิศวกรรม &gt; ทั่วไป &gt; ใบสั่งเปลี่ยนแปลงทางวิศวกรรม**</span><span class="sxs-lookup"><span data-stu-id="e32c0-369">Go to **Engineering change management &gt; Common &gt; Engineering change orders**.</span></span>
1. <span data-ttu-id="e32c0-370">ในบานหน้าต่างการดำเนินการ ให้เลือก **สร้าง** เพื่อสร้างใบสั่งเปลี่ยนแปลง และตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="e32c0-370">On the Action Pane, select **New** to create a change order, and set the following values for it:</span></span>

    - <span data-ttu-id="e32c0-371">**ใบสั่งเปลี่ยนแปลง:** *555*</span><span class="sxs-lookup"><span data-stu-id="e32c0-371">**Change order:** *555*</span></span>
    - <span data-ttu-id="e32c0-372">**ชื่อ:** *Z0001 การเปลี่ยนแปลงของลูกค้า*</span><span class="sxs-lookup"><span data-stu-id="e32c0-372">**Title:** *Z0001 customer change*</span></span>
    - <span data-ttu-id="e32c0-373">**ประเภท:** *การเปลี่ยนแปลงของลูกค้า*</span><span class="sxs-lookup"><span data-stu-id="e32c0-373">**Category:** *Customer change*</span></span>
    - <span data-ttu-id="e32c0-374">**ระดับความสำคัญ:** *ต่ำ*</span><span class="sxs-lookup"><span data-stu-id="e32c0-374">**Priority:** *Low*</span></span>
    - <span data-ttu-id="e32c0-375">**ความรุนแรง:** *ปานกลาง*</span><span class="sxs-lookup"><span data-stu-id="e32c0-375">**Severity:** *Medium*</span></span>

1. <span data-ttu-id="e32c0-376">บน FastTab **ผลิตภัณฑ์ที่ได้รับผลกระทบ** ให้เลือก **สร้าง &gt; เพิ่มผลิตภัณฑ์ที่มีอยู่** เพื่อเพิ่มแถวไปยังกริด แล้วตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="e32c0-376">On the **Impacted products** FastTab, select **New &gt; Add existing product** to add a row to the grid, and set the following values for it:</span></span>

    - <span data-ttu-id="e32c0-377">**ผลิตภัณฑ์:** *Z0001*</span><span class="sxs-lookup"><span data-stu-id="e32c0-377">**Product:** *Z0001*</span></span>
    - <span data-ttu-id="e32c0-378">**ผลกระทบ:** *รุ่นใหม่*</span><span class="sxs-lookup"><span data-stu-id="e32c0-378">**Impact:** *New version*</span></span>

    <span data-ttu-id="e32c0-379">![การสร้างใบสั่งเปลี่ยนแปลงทางวิศวกรรม](media/eng-change-order.png "การสร้างใบสั่งเปลี่ยนแปลงทางวิศวกรรม")</span><span class="sxs-lookup"><span data-stu-id="e32c0-379">![Creating an engineering change order](media/eng-change-order.png "Creating an engineering change order")</span></span>

1. <span data-ttu-id="e32c0-380">โปรดสังเกตว่า เนื่องจากคุณตั้งค่าฟิลด์ **ผลกระทบ** เป็น *รุ่นใหม่* ฟิลด์ **รุ่นใหม่** บนแท็บ **รายละเอียด** ของ FastTab **รายละเอียดของผลิตภัณฑ์** จะแสดงว่าหมายเลขรุ่นใหม่จะเป็น (*V-02* สำหรับตัวอย่างนี้)</span><span class="sxs-lookup"><span data-stu-id="e32c0-380">Notice that, because you set the **Impact** field to *New version*, the **New version** field on the **Details** tab of the **Product details** FastTab shows what the new version number will be (*V-02* for this example).</span></span>

    <span data-ttu-id="e32c0-381">![รายละเอียดของผลิตภัณฑ์สำหรับใบสั่งเปลี่ยนแปลงทางวิศวกรรม](media/eng-change-order-product-details.png "รายละเอียดของผลิตภัณฑ์สำหรับใบสั่งเปลี่ยนแปลงทางวิศวกรรม")</span><span class="sxs-lookup"><span data-stu-id="e32c0-381">![Product details for an engineering change order](media/eng-change-order-product-details.png "Product details for an engineering change order")</span></span>

1. <span data-ttu-id="e32c0-382">บนบานหน้าต่างการดำเนินการ เลือก **บันทึก**</span><span class="sxs-lookup"><span data-stu-id="e32c0-382">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="e32c0-383">บน FastTab **รายละเอียดของผลิตภัณฑ์** บนแท็บ **สูตรการผลิต** ให้เลือก **บรรทัด** ที่จะเปิด BOM สำหรับรุ่น *V-01* ของผลิตภัณฑ์ *Z0001*</span><span class="sxs-lookup"><span data-stu-id="e32c0-383">On the **Product details** FastTab, on the **Bill of material** tab, select **Lines** to open the BOM for version *V-01* of product *Z0001*.</span></span>

    <span data-ttu-id="e32c0-384">![บรรทัด BOM ของผลิตภัณฑ์วิศวกรรม](media/eng-product-bom-lines.png "บรรทัด BOM ของผลิตภัณฑ์วิศวกรรม")</span><span class="sxs-lookup"><span data-stu-id="e32c0-384">![Engineering product BOM lines](media/eng-product-bom-lines.png "Engineering product BOM lines")</span></span>

1. <span data-ttu-id="e32c0-385">เลือกบรรทัดสำหรับหมายเลขสินค้า *D0003* และจากนั้น ในบานหน้าต่างการดำเนินการ ให้เลือก **ลบ**</span><span class="sxs-lookup"><span data-stu-id="e32c0-385">Select the line for item number *D0003*, and then, on the Action Pane, select **Delete**.</span></span> <span data-ttu-id="e32c0-386">ค่าของ **ฟิลด์ชนิดการเปลี่ยนแปลง** สำหรับบรรทัดนี้เปลี่ยนเป็น *ลบ*</span><span class="sxs-lookup"><span data-stu-id="e32c0-386">The value of the **Change type** field for this line changes to *Deleted*.</span></span>
1. <span data-ttu-id="e32c0-387">บนบานหน้าต่างการดำเนินการ เลือก **บันทึก**</span><span class="sxs-lookup"><span data-stu-id="e32c0-387">On the Action Pane, select **Save**.</span></span>

    <span data-ttu-id="e32c0-388">![บรรทัด BOM ของผลิตภัณฑ์วิศวกรรมที่ปรับเปลี่ยน](media/eng-product-bom-lines-modified.png "บรรทัด BOM ของผลิตภัณฑ์วิศวกรรมที่ปรับเปลี่ยน")</span><span class="sxs-lookup"><span data-stu-id="e32c0-388">![Modified engineering product BOM lines](media/eng-product-bom-lines-modified.png "Modified engineering product BOM lines")</span></span>

1. <span data-ttu-id="e32c0-389">ปิดหน้า **บรรทัด BOM** เพื่อกลับไปที่หน้า **ใบสั่งเปลี่ยนแปลงทางวิศวกรรม**</span><span class="sxs-lookup"><span data-stu-id="e32c0-389">Close the **BOM line** page to return to the **Engineering change order** page.</span></span>
1. <span data-ttu-id="e32c0-390">บน FastTab **รายละเอียดผลิตภัณฑ์** บนแท็บ **สูตรการผลิต** ให้สังเกตว่าค่าของฟิลด์ **ชนิดการเปลี่ยนแปลง** สำหรับ BOM *Z0001* มีการ *เปลี่ยนแปลง* ในขณะนี้</span><span class="sxs-lookup"><span data-stu-id="e32c0-390">On the **Product details** FastTab, on the **Bill of material** tab, notice that the value of the **Change type** field for BOM *Z0001* is now *Changed*.</span></span>

    <span data-ttu-id="e32c0-391">![ใบสั่งเปลี่ยนแปลงทางวิศวกรรมที่มี BOM ที่เปลี่ยนไป](media/eng-change-order-changed-bom.png "ใบสั่งเปลี่ยนแปลงทางวิศวกรรมที่มี BOM ที่เปลี่ยนไป")</span><span class="sxs-lookup"><span data-stu-id="e32c0-391">![Engineering change order that includes a changed BOM](media/eng-change-order-changed-bom.png "Engineering change order that includes a changed BOM")</span></span>

    <span data-ttu-id="e32c0-392">ขณะนี้ต้องมีการอนุมัติใบสั่ง ก่อนที่จะสามารถประมวลผลการเปลี่ยนแปลงได้</span><span class="sxs-lookup"><span data-stu-id="e32c0-392">The order must now be approved before the changes can be processed.</span></span> <span data-ttu-id="e32c0-393">เมื่อมีการประมวลผลการเปลี่ยนแปลง จะมีการอัปเดตผลิตภัณฑ์โดยมีการเปลี่ยนแปลงที่รวมอยู่ในใบสั่งเปลี่ยนแปลงทางวิศวกรรม</span><span class="sxs-lookup"><span data-stu-id="e32c0-393">When the changes are processed, the products are updated with the changes that are included in the engineering change order.</span></span> <span data-ttu-id="e32c0-394">สำหรับตัวอย่างนี้ ผู้ที่สร้างใบสั่งเปลี่ยนแปลงทางวิศวกรรมถูกระบุเป็นผู้อนุมัติ</span><span class="sxs-lookup"><span data-stu-id="e32c0-394">For this example, the person who creates the engineering change order has been specified as the approver.</span></span>

1. <span data-ttu-id="e32c0-395">บนบานหน้าต่างการดำเนินการ บนแท็บ **ใบสั่งเปลี่ยนแปลง** ในกลุ่ม **สถานะการเปลี่ยนแปลง** ให้เลือก **อนุมัติ**</span><span class="sxs-lookup"><span data-stu-id="e32c0-395">On the Action Pane, on the **Change order** tab, in the **Change status** group, select **Approve**.</span></span>
1. <span data-ttu-id="e32c0-396">เลือก **กระบวนการ** เพื่ออัปเดตข้อมูลของผลิตภัณฑ์</span><span class="sxs-lookup"><span data-stu-id="e32c0-396">Select **Process** to update the product's information.</span></span>
1. <span data-ttu-id="e32c0-397">เลือก **เสร็จสมบูรณ์** เพื่อทำเครื่องหมายใบสั่งเปลี่ยนแปลงเป็นเสร็จสมบูรณ์</span><span class="sxs-lookup"><span data-stu-id="e32c0-397">Select **Complete** to mark the change order as completed.</span></span>

## <a name="release-the-changed-product"></a><span data-ttu-id="e32c0-398">นำผลิตภัณฑ์ที่เปลี่ยนแปลงออกใช้</span><span class="sxs-lookup"><span data-stu-id="e32c0-398">Release the changed product</span></span>

<span data-ttu-id="e32c0-399">ขณะนี้สามารถนำผลิตภัณฑ์ออกใช้อีกครั้งไปยังบริษัท *USMF*  แล้วจากนั้น ส่งไปให้ลูกค้า</span><span class="sxs-lookup"><span data-stu-id="e32c0-399">The product can now be released again to the *USMF* company and then sent to the customer.</span></span> <span data-ttu-id="e32c0-400">เมื่อต้องการนำผลิตภัณฑ์ออกใช้โดยตรงจากใบสั่งเปลี่ยนแปลงทางวิศวกรรม ให้ทำตามขั้นตอนต่อไปนี้</span><span class="sxs-lookup"><span data-stu-id="e32c0-400">To release the product directly from the engineering change order, follow these steps.</span></span>

1. <span data-ttu-id="e32c0-401">เปิดใบสั่งเปลี่ยนแปลงทางวิศวกรรมที่คุณสร้างขึ้นในแบบฝึกหัดก่อนหน้านี้ ถ้าไม่ได้เปิดอยู่แล้ว</span><span class="sxs-lookup"><span data-stu-id="e32c0-401">Open the engineering change order that you created in the previous exercise, if it isn't already open.</span></span>
1. <span data-ttu-id="e32c0-402">บนบานหน้าต่างการดำเนินการ บนแท็บ **ใบสั่งเปลี่ยนแปลง** ในกลุ่ม **การนำผลิตภัณฑ์ออกใช้** ให้เลือก **ค้นหา**</span><span class="sxs-lookup"><span data-stu-id="e32c0-402">On the Action Pane, on the **Change order** tab, in the **Product releases** group, select **Search**.</span></span>
1. <span data-ttu-id="e32c0-403">ผลการค้นหาจะแสดงว่าบริษัทใดที่มีการนำผลิตภัณฑ์ที่ได้รับผลกระทบออกใช้</span><span class="sxs-lookup"><span data-stu-id="e32c0-403">The search results show which companies the affected products have been released to.</span></span> <span data-ttu-id="e32c0-404">ปิดผลการค้นหา</span><span class="sxs-lookup"><span data-stu-id="e32c0-404">Close the search results.</span></span>
1. <span data-ttu-id="e32c0-405">บนบานหน้าต่างการดำเนินการ บนแท็บ **ใบสั่งเปลี่ยนแปลง** ในกลุ่ม **การนำผลิตภัณฑ์ออกใช้** ให้เลือก **มุมมอง** เพื่อเปิดกล่องโต้ตอบ **การนำออกใช้** ซึ่งคุณสามารถดูผลลัพธ์ของการค้นหาก่อนหน้านี้ได้</span><span class="sxs-lookup"><span data-stu-id="e32c0-405">On the Action Pane, on the **Change order** tab, in the **Product releases** group, select **View** to open the **Releases** dialog box, where you can view the results of the previous search.</span></span>
1. <span data-ttu-id="e32c0-406">เลือกแต่ละบริษัทที่คุณต้องการนำผลิตภัณฑ์ออกใช้</span><span class="sxs-lookup"><span data-stu-id="e32c0-406">Select each company that you want to release products to.</span></span>
1. <span data-ttu-id="e32c0-407">เลือก **ตกลง** เพื่อปิดกล่องโต้ตอบ **การนำออกใช้** และกลับไปยังใบสั่งเปลี่ยนแปลง</span><span class="sxs-lookup"><span data-stu-id="e32c0-407">Select **OK** to close the **Releases** dialog box and return to the change order.</span></span>
1. <span data-ttu-id="e32c0-408">บนบานหน้าต่างการดำเนินการ บนแท็บ **ใบสั่งเปลี่ยนแปลง** ในกลุ่ม **การนำผลิตภัณฑ์ออกใช้** ให้เลือก **กระบวนการ** เพื่อนำผลิตภัณฑ์ที่ได้รับผลกระทบออกใช้ไปยังบริษัทที่เลือก</span><span class="sxs-lookup"><span data-stu-id="e32c0-408">On the Action Pane, on the **Change order** tab, in the **Product releases** group, select **Process** to release the affected products to the selected companies.</span></span> <span data-ttu-id="e32c0-409">อีกทางหนึ่งคือ เลือก **นำโครงสร้างผลิตภัณฑ์ออกใช้** เพื่อเริ่มต้นกระบวนการนำออกใช้</span><span class="sxs-lookup"><span data-stu-id="e32c0-409">Alternatively, select **Release product structure** to start the release process.</span></span>
