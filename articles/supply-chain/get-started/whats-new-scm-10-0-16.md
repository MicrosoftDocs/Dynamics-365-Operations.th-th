...
description: บทความนี้อธิบายคุณลักษณะที่ใหม่หรือเปลี่ยนแปลงใน Dynamics 365 Supply Chain Management 10.0.16
author: kamaybac
ms.date: 11/20/2020
ms.topic: article
ms.prod: ''
...
บทความนี้แสดงรายการคุณลักษณะที่ใหม่หรือที่มีการเปลี่ยนแปลงอย่างใดอย่างหนึ่งใน Microsoft Dynamics 365 Supply Chain Management รุ่น 10.0.16 รุ่นนี้มีหมายเลขการสร้างเป็น 10.0.689 และพร้อมใช้งานดังนี้:
...
- [ภาพรวมของวัสดุอันตราย](../pim/hazmat-overview.md) (และบทความที่เกี่ยวข้อง)
