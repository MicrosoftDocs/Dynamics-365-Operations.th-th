...
---
# <a name="preview-features-in-dynamics-365-supply-chain-management-10014-november-2020"></a>คุณลักษณะพรีวิวใน Dynamics 365 Supply Chain Management 10.0.14 (พฤศจิกายน 2020)

[!include [banner](../includes/banner.md)]
[!include [preview banner](../includes/preview-banner.md)]

หัวข้อนี้แสดงรายการคุณลักษณะที่ใหม่ หรือที่มีการเปลี่ยนแปลง อย่างใดอย่างหนึ่ง ใน Microsoft Dynamics 365 Supply Chain Management รุ่นการแสดงตัวอย่าง 10.0.14 รุ่นนี้มีหมายเลขการสร้างเป็น 10.0.605 และพร้อมใช้งานดังนี้:

- **การเผยแพร่รุ่นพรีวิว:** กันยายน 2020
- **ความพร้อมใช้งานทั่วไป (การอัปเดตด้วยตนเอง):** ตุลาคม 2020
- **อัปเดตอัตโนมัติ:** พฤศจิกายน 2020
...
Microsoft Dynamics 365 Supply Chain Management 10.0.14 รวมถึง Platform update เมื่อต้องการเรียนรู้เพิ่มเติม ให้ดูที่ [Platform update สำหรับรุ่น10.0.14 ของแอป Finance and Operations (ตุลาคม 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-14.md)

### <a name="bug-fixes"></a>การแก้ไขปัญหา

สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการแก้ไขบักที่รวมอยู่ในการอัปเดตแต่ละรายการที่เป็นส่วนหนึ่งของ 10.0.14 ให้ลงชื่อเข้าใช้ Lifecycle Services (LCS) และดู [บทความ KB](https://fix.lcs.dynamics.com/Issue/Details?bugId=488609&dbType=3&qc=8251e8e1d5e2386de850599926c1adc3fec8e2ba25308036d22cdfe0a1c28fc7)
