---
title: มีอะไรใหม่หรือมีอะไรเปลี่ยนแปลงใน Dynamics 365 Supply Chain Management 10.0.21 (ตุลาคม 2021)
description: บทความนี้อธิบายคุณลักษณะที่ใหม่หรือเปลี่ยนแปลงใน Dynamics 365 Supply Chain Management 10.0.21
author: kamaybac
ms.date: 10/28/2021
ms.topic: article
...
บทความนี้แสดงรายการคุณลักษณะที่ใหม่หรือที่มีการเปลี่ยนแปลงอย่างใดอย่างหนึ่งใน Microsoft Dynamics 365 Supply Chain Management รุ่น 10.0.21 รุ่นนี้มีหมายเลขการสร้างเป็น 10.0.960 และพร้อมใช้งานดังนี้:
...
| การจัดการคลังสินค้า | แยกการทำงานการจัดเก็บออกจาก ASN | ต้องใช้คุณลักษณะนี้ในการส่งและรับการแจ้งเตือนการจัดส่งล่วงหน้า (ASNs) เมื่อคุณเรียกใช้ปริมาณงานการจัดการคลังสินค้าใน scale unit (เป็นส่วนหนึ่งของโทโพโลยีแบบไฮบริดที่มีการกระจาย) ซึ่งจะเพิ่มตารางฐานข้อมูลใหม่ที่จัดสรรไว้เพื่อจัดเก็บข้อมูลเกี่ยวกับงานการสำรองสินค้า ก่อนหน้านี้ ข้อมูลนี้ถูกจัดเก็บไว้ในตารางที่ใช้สำหรับ ASN ด้วย |
| การจัดการคลังสินค้า | วางในช่องหน่วยผสม | อนุญาตให้ระบบสามารถวางสินค้าลงในสถานที่ที่มีหน่วยแบบผสม (เช่น ทั้งกล่องและกรณี) สำหรับบรรทัดเทมเพลตการแบ่งช่วงเวลาแต่ละรายการ คุณลักษณะนี้จะอนุญาตให้คุณสามารถเลือกว่ารายการควรวางสินค้าลงในสถานที่แบบหน่วยผสมหรือหน่วยเดียว |
...
| ไม่อนุญาตให้สร้างการบรรทุกที่ไม่ตรงตามข้อกำหนดเทมเพลตการสร้างการบรรทุกของเวฟ | วันที่ 9/1/2021 | วันที่ 8/17/2020 | วันที่ตามค่าเริ่มต้น | การจัดการคลังสินค้า |
...
Microsoft Dynamics 365 Supply Chain Management 10.0.21 รวมถึงการอัปเดตแพลตฟอร์ม เมื่อต้องการเรียนรู้เพิ่มเติม ให้ดูที่ [การอัปเดตแพลตฟอร์มสำหรับรุ่น 10.0.21 ของแอปการเงินและการดำเนินงาน (ตุลาคม 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-21.md)
