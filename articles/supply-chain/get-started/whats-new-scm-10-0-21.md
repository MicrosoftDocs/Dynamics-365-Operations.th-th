...
การปรับใช้จะทำงานแม้จะมีคำเตือน อย่างไรก็ตาม อาจเกิดปัญหาที่ทราบต่อไปนี้ใน Lifecycle Services (LCS):
...
| สินค้าคงคลัง&nbsp;และ&nbsp;ลอจิสติกส์ | [สแกนบาร์โค้ดในคลังสินค้าโดยใช้มาตรฐานรูปแบบ GS1](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/scan-barcodes-warehouse-using-gs1-format-standards) | *เร็วๆ นี้*<!-- KFM: Add doc link when ready. --> |
| สินค้าคงคลัง&nbsp;และ&nbsp;ลอจิสติกส์ | การประมูลที่ปิดผนึกแล้ว <!-- KFM: Add RP link when available --> | *เร็วๆ นี้*<!-- KFM: Add doc link when ready. --> |
...
| สินค้าคงคลัง&nbsp;และ&nbsp;ลอจิสติกส์ | [คำแนะนำตามขั้นตอนของแอปคลังสินค้า](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/warehouse-management-mobile-app-step-instructions) | *เร็วๆ นี้*<!-- KFM: Add doc link when ready --> |
...
| การวางแผนหลัก | (พรีวิว) การรองรับ MRP ที่ขับเคลื่อนด้วยลำดับความสำคัญสำหรับการเพิ่มประสิทธิภาพการวางแผน | คุณลักษณะพรีวิวการเพิ่มประสิทธิภาพการวางแผนนี้จะเปิดใช้งานการวางแผนหลักที่ควบคุมโดยระดับความสำคัญของการวางแผนที่มีจุดการสั่งใหม่ การเปลี่ยนแปลงที่เน้นได้แก่: ฟิลด์ **ระดับความสำคัญของการวางแผน** บนบรรทัดใบสั่งขาย, บรรทัดใบสั่งซื้อ, การคาดการณ์ความต้องการ, และแผนการใบสั่ง ตัวเลือกรหัสความครอบคลุมใหม่ ฟิลด์ **ความครอบคลุมสินค้า** สำหรับจุดการสั่งใหม่ ฟอร์มการตั้งค่าการวางแผนหลักเพื่อควบคุมการตั้งค่าระดับความสำคัญของการวางแผน และตรรกะการคํานวณการเพิ่มประสิทธิภาพการวางแผนเพื่อตั้งค่าและคำนึงถึงระดับความสำคัญของการวางแผน |
