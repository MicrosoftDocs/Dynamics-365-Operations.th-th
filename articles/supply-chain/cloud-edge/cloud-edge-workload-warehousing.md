---
title: ปริมาณงานการจัดการคลังสินค้าสำหรับสเกลยูนิตในระบบคลาวด์และแบบปลายทาง
description: บทความนี้แสดงข้อมูลเกี่ยวกับลักษณะการทำงานที่ช่วยให้ scale units เรียกใช้กระบวนการที่เลือกจากปริมาณงานการจัดการคลังสินค้าของคุณ
author: perlynne
ms.date: 09/03/2021
ms.topic: article
ms.prod: ''
...
> [!WARNING]
> ฟังก์ชันทางธุรกิจเกี่ยวกับการจัดการคลังสินค้าไม่ครบทั้งหมดที่ได้รับการสนับสนุนสำหรับคลังสินค้าที่เรียกใช้ปริมาณงานบน scale unit ตรวจสอบให้แน่ใจว่าได้ใช้กระบวนการที่บทความนี้อธิบายไว้อย่างชัดแจ้งว่าได้รับการสนับสนุน

## <a name="warehouse-execution-on-scale-units"></a>การดำเนินการของคลังสินค้าใน scale unit

ปริมาณงาน Warehouse Management ช่วยให้สเกลยูนิตในระบบคลาวด์และแบบปลายทาง สามารถเรียกใช้กระบวนการที่เลือกจากความสามารถในการจัดการคลังสินค้า

## <a name="prerequisites"></a>ข้อกำหนดเบื้องต้น

ก่อนที่คุณจะเริ่มทำงานกับปริมาณงานของการจัดการคลังสินค้า คุณต้องจัดเตรียมระบบของคุณตามที่อธิบายไว้ในส่วนนี้

### <a name="deploy-a-scale-unit-with-the-warehouse-management-workload"></a>ปรับใช้สเกลยูนิตกับริมาณงานของการจัดการคลังสินค้า
...
### <a name="turn-on-required-features-in-feature-management"></a>เปิดใช้งานคุณลักษณะที่จำเป็นในการจัดการคุณลักษณะ

ใช้พื้นที่ทำงาน [การจัดการคุณลักษณะ](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) เพื่อเปิดใช้งานคุณลักษณะทั้งคู่ต่อไปนี้ (คุณลักษณะทั้งสองรายการแสดงอยู่ในโมดูล *การจัดการคลังสินค้า*)

- แยกการทำงานการจัดเก็บออกจาก ASN
- (พรีวิว) รองรับ scale unit สำหรับใบสั่งคลังสินค้าขาเข้าและขาออก
...
กระบวนการความเป็นเจ้าของข้อมูลขาออกขึ้นอยู่กับว่าคุณใช้กระบวนการวางแผนการบรรทุกหรือไม่ ในทุกกรณี ฮับเป็นเจ้าของ *เอกสารต้นทาง* เช่น ใบสั่งขายและใบสั่งโอนย้าย รวมทั้งกระบวนการปันส่วนใบสั่งและข้อมูลธุรกรรมใบสั่งที่เกี่ยวข้อง แต่เมื่อคุณใช้กระบวนการวางแผนการบรรทุก การโหลดจะถูกสร้างบนฮับและเป็นของฮับโดยเริ่มแรก ในฐานะส่วนประกอบหนึ่งในกระบวนการ *นำออกใช้ไปยังคลังสินค้า* ความเป็นเจ้าของข้อมูลปริมาณงานจะถูกโอนย้ายไปยังการปรับใช้หน่วยสเกลที่จัดสรรไว้ ซึ่งจะกลายเป็นเจ้าของ *การประมวลผลเวฟการจัดส่ง* ในเวลาต่อมา (เช่น การปันส่วนงาน งานการเติมสินค้า และการสร้างงานความต้องการ ) ดังนั้น ผู้ปฏิบัติงานคลังสินค้าจึงสามารถประมวลผลงานของใบสั่งขายและใบสั่งโอนย้ายขาออกเท่านั้น โดยใช้แอป Warehouse Management บนมือถือ ซึ่งเชื่อมต่อกับการปรับใช้ที่เรียกใช้ปริมาณงานของหน่วยสเกลเฉพาะ

เมื่อกระบวนการงานขั้นสุดท้ายวางสินค้าคงคลังที่สถานที่จัดส่งสุดท้าย (Baydoor) scale unit จะส่งสัญญาณถึงฮับเพื่ออัปเดตธุรกรรมของสินค้าคงคลังของเอกสารต้นทางเป็น *เบิกสินค้าแล้ว* จนกว่ากระบวนการนี้จะเรียกใช้และรับการซิงโครไนส์กลับ สินค้าคงคลังคงเหลือบนปริมาณงานของหน่วยสเกลจะถูกจองตามจริงที่ระดับคลังสินค้า และคุณสามารถประมวลผลการยืนยันการจัดส่งขาออกได้ทันที โดยไม่รอให้การซิงโครไนส์นี้เสร็จสมบูรณ์ บันทึกการจัดส่งสินค้าขายและการออกใบแจ้งหนี้หรือโอนย้ายการจัดส่งตามใบสั่งในเวลาต่อมา เพื่อให้มีการจัดการกับจำนวนงานในฮับ
...
คุณต้องลงชื่อเข้าใช้ในฮับเพื่อใช้กระบวนการ *นำออกใช้ไปยังคลังสินค้า* สำหรับกระบวนการใบสั่งซื้อ ให้ไปที่หน้าใดหน้าหนึ่งต่อไปนี้เพื่อเรียกใช้หรือจัดกำหนดการ:
...
ผู้ปฏิบัติงานสามารถเรียกใช้กระบวนการรับได้ โดยใช้แอป Warehouse Management บนมือถือที่มีการเชื่อมต่อกับ scale unit ข้อมูลจะถูกบันทึกโดย scale unit และรายงานจากใบสั่งคลังสินค้าขาเข้า การสร้างและการดำเนินการ putaway ในเวลาต่อมาจะถูกจัดการโดย scale unit
...
ปริมาณงานการจัดการคลังสินค้ารองรับสามขั้นตอนต่อไปนี้สำหรับการผลิตในแอป Warehouse Management:

- รายงานเมื่อเสร็จสมบูรณ์และการสำรอง
- เริ่มใบสั่งผลิต
- ลงทะเบียนปริมาณการใช้วัสดุ

### <a name="report-as-finished-and-put-away"></a>รายงานเมื่อเสร็จสมบูรณ์และการสำรอง

ผู้ปฏิบัติงานสามารถใช้ขั้นตอน **รายงานเมื่อเสร็จสมบูรณ์และการสำรอง** ในแอป Warehouse Management เพื่อรายงานใบสั่งผลิตหรือใบสั่งชุดงานเมื่อเสร็จสมบูรณ์ และยังสามารถรายงานผลิตภัณฑ์ร่วมและสินค้าพลอยได้จากใบสั่งชุดงานเมื่อเสร็จสมบูรณ์ได้ด้วย เมื่อมีการรายงานงานเมื่อเสร็จสมบูรณ์ โดยปกติระบบจะสร้างงานคลังสินค้าการสำรองสินค้าในสเกลยูนิตนั้น หากคุณไม่ต้องการงานการสำรองสินค้า คุณสามารถตั้งค่านโยบายงานของคุณเพื่อละเว้นงานได้

### <a name="start-production-order"></a>เริ่มใบสั่งผลิต

ผู้ปฏิบัติงานสามารถใช้ขั้นตอน **เริ่มใบสั่งผลิต** ในแอป Warehouse Management เพื่อลงทะเบียนการเริ่มต้นของใบสั่งผลิตหรือใบสั่งชุดงาน

### <a name="register-material-consumption"></a>ลงทะเบียนปริมาณการใช้วัสดุ

ผู้ปฏิบัติงานสามารถใช้ขั้นตอน **ลงทะเบียนปริมาณการใช้วัสดุ** ในแอป Warehouse Management เพื่อรายงานปริมาณการใช้วัสดุสำหรับใบสั่งผลิตหรือใบสั่งชุดงานได้ จากนั้นระบบจะสร้างสมุดรายวันรายการเบิกสินค้าสำหรับวัสดุที่รายงานในใบสั่งผลิตหรือใบสั่งชุดงานบนสเกลยูนิต รายการสมุดรายวันจะจองสินค้าทางกายภาพในสินค้าคงคลังที่ใช้ เมื่อข้อมูลถูกซิงค์ระหว่างสเกลยูนิตกับฮับ ระบบจะสร้างสมุดรายวันรายการเบิกสินค้าและลงรายการบัญชีบนอินสแตนซ์ฮับ
...
- การสร้างและการเรียกใช้การเคลื่อนย้ายสินค้าคงคลังโดยใช้แอปคลังสินค้า
...
- **การรับสินค้าสินค้าโอนย้าย** – ผ่านการประมวลผลการรับป้ายทะเบียน
...
ไม่รองรับชนิดของการประมวลผลเอกสารต้นทางหรืองานคลังสินค้าอื่นบนสเกลยูนิต ตัวอย่างเช่น เมื่อคุณเรียกใช้กับงปริมาณงานการดำเนินการคลังสินค้าบนสเกลยูนิต คุณไม่สามารถใช้กระบวนการรับใบสั่งส่งคืนสินค้าขายเพื่อประมวลผลใบสั่งส่งคืนสินค้า แต่การประมวลผลนี้ต้องดำเนินการโดยอินสแตนซ์ฮับ
...
>
> ต้องมีขั้นตอนเพิ่มเติมสองสามขั้นตอนในการตั้งค่าแอป Warehouse Management บนมือถือเพื่อใช้งานกับสเกลยูนิตในระบบคลาวด์และแบบปลายทาง สำหรับข้อมูลเพิ่มเติม ดูที่ [ตั้งค่าคอนฟิกแอป Warehouse Management บนมือถือสำหรับสเกลยูนิตในระบบคลาวด์และแบบปลายทาง](cloud-edge-workload-setup-warehouse-app.md)
>
> เมื่อคุณเรียกใช้ปริมาณงานใน scale unit คุณจะไม่สามารถเรียกใช้กระบวนการที่ไม่ได้รับการสนับสนุนสำหรับคลังสินค้าเฉพาะนั้นบนฮับ ตารางที่ระบุในภายหลังในบทความนี้จะจัดอยู่ในเอกสารความสามารถที่สนับสนุน
>
...
- การใช้ข้อมูลร่วมกันข้ามบริษัทสำหรับผลิตภัณฑ์ <!-- Planned -->
- การประมวลผลงานของคลังสินค้าด้วยบันทึกการจัดส่ง (ตัวอย่างเช่น บันทึกการบรรจุที่สถานีบรรจุ)
...
> [!WARNING]
> ฟังก์ชันคลังสินค้าบางฟังก์ชันจะไม่พร้อมใช้งานสำหรับคลังสินค้าที่เรียกใช้ปริมาณงานของการจัดการคลังสินค้าใน scale unit และยังไม่ได้รับการสนับสนุนบนฮับหรือปริมาณงานของ scale unit ด้วย
>
...
| การประมวลผลสถานีบรรจุด้วยตนเอง  | ไม่  | ไม่ |
...
| ขอให้ยกเลิกรายการใบสั่งของคลังสินค้า                      | ใช่ | ไม่ แต่การร้องขอจะได้รับการอนุมัติหรือถูกปฏิเสธ |
| <p>การปล่อยใบสั่งโอนสำหรับการรับ</p><p>กระบวนการนี้จะเกิดขึ้นโดยอัตโนมัติโดยเป็นส่วนหนึ่งของกระบวนการจัดส่งของใบสั่งโอนย้าย อย่างไรก็ตาม คุณสามารถใช้กระบวนการนี้ด้วยตนเองเพื่อเปิดใช้งานการรับป้ายทะเบียนที่สเกลยูนิตถ้ามีการยกเลิกรายการใบสั่งของคลังสินค้าขาเข้าหรือเป็นส่วนหนึ่งของกระบวนการปรับใช้ปริมาณงานใหม่</p> | ใช่ | ไม่|
<!--| การประมวลผลสถานีบรรจุด้วยตนเอง ซึ่งรวมถึงงาน 'การเบิกสินค้าคอนเทนเนอร์ที่บรรจุแล้ว'  | ไม่  | ใช่ แต่ไม่มีการจัดทำรายการการจัดส่ง TMS และการลงรายการบัญชีบันทึกการจัดส่งการขายและไม่มีบันทึกการบรรจุและรูปภาพของผลิตภัณฑ์ |-->
...
| นำใบสั่งซื้อออกใช้ไปยังคลังสินค้า (การประมวลผลใบสั่งคลังสินค้า) | ใช่ | ไม่ |
| ขอให้ยกเลิกรายการใบสั่งของคลังสินค้า                            | ใช่ | ไม่ แต่การร้องขอจะได้รับการอนุมัติหรือถูกปฏิเสธ |
| การประมวลผลใบรับสินค้าของเอกสารต้นทางใบสั่งซื้อ                        | ใช่ | ไม่ |
...
| การรับใบสั่งส่งคืนสินค้าและการสำรองสินค้า                              | ใช่ | ไม่ |
| การรับป้ายทะเบียนแบบผสมและการสำรองสินค้า                       | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ใช่ |
| การรับสินค้าของจำนวนงานในศูนย์การผลิต                                              | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ไม่ |
| การรับป้ายทะเบียนของใบสั่งซื้อและการสำรองสินค้า              | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ไม่ |
| การรับป้ายทะเบียนของใบสั่งโอนย้ายและการสำรองสินค้า             | ไม่ | ใช่ |
| การรับสินค้าตามใบสั่งโอนย้ายและการสำรองสินค้า                       | ใช่ | ไม่ |
| การรับรายการใบสั่งโอนย้ายและการสำรองสินค้า                       | ใช่ | ไม่ |
...
| การรับที่มีการสร้างงาน *การส่งสินค้าผ่านศูนย์เปลี่ยนถ่ายสินค้า*                 | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ไม่ |
| การรับที่มีการสร้างงาน *ใบสั่งตรวจสอบคุณภาพ*                  | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ไม่ |
| การรับที่มีการสร้างงาน *การสุ่มตัวอย่างสินค้าที่มีคุณภาพ*          | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ไม่ |
| การรับที่มีการสร้างงาน *คุณภาพในการตรวจสอบคุณภาพ*       | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ไม่ |
| การรับที่มีการสร้างใบสั่งตรวจสอบคุณภาพ                            | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ไม่ |
| การประมวลผลงาน - ซึ่งควบคุมโดย *การสำรองสินค้าแบบคลัสเตอร์*                 | ใช่ | ไม่ |
...
| การประมวลผล | ฮับ | ปริมาณงานของการดำเนินการของคลังสินค้าบน scale unit |
|---------|-----|----------------------------------------------|
| การประมวลผลเอกสารต้นทางของใบสั่งผลิต    | ใช่ | ไม่ |
| นำออกใช้ไปยังคลังสินค้า                           | ใช่ | ไม่ |
| เริ่มใบสั่งผลิต                         | ใช่ | ใช่|
| สร้างใบสั่งของคลังสินค้า                        | ใช่ | ไม่ |
| ขอให้ยกเลิกรายการใบสั่งของคลังสินค้า        | ใช่ | ไม่ แต่การร้องขอจะได้รับการอนุมัติหรือถูกปฏิเสธ |
| รายงานเมื่อเสร็จสมบูรณ์และการสำรองสินค้าสำเร็จรูป | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ใช่|
| การสำรองผลิตภัณฑ์ร่วมและสินค้าพลอยได้             | <p>ใช่ เมื่อไม่มีใบสั่งคลังสินค้า</p><p>ไม่ เมื่อมีใบสั่งคลังสินค้า</p> | ใช่|
| ลงทะเบียนปริมาณการใช้วัสดุ                  | ใช่ | ใช่|
| การประมวลผลเวฟการผลิต                     | ใช่ | ไม่ |
| การเบิกวัตถุดิบ                           | ใช่ | ไม่ |
| การสำรองสินค้าคัมบัง                                | ใช่ | ไม่ |
| การเบิกสินค้าคัมบัง                                 | ใช่ | ไม่ |
| คัมบังว่างเปล่า                                   | ใช่ | ไม่ |
| ของเสียจากการผลิต                               | ใช่ | ไม่ |
| แท่นวางสินค้าสุดท้ายของการผลิต                         | ใช่ | ไม่ |
...
ชุดงานต่างๆ เรียกใช้ทั้งบนฮับและ scale unit

ในการปรับใช้ฮับ คุณสามารถดูแลรักษาชุดงานต่อไปนี้ด้วยตนเอง

- จัดการชุดงานต่อไปนี้ได้ที่ **การจัดการคลังสินค้า \> งานประจำงวด \> การจัดการปริมาณงานของฝ่ายสนับสนุน**:

    - ตัวประมวลผลข้อความของ Scale Unit กับฮับ
    - ลงทะเบียนการรับสินค้าตามใบสั่งต้นทาง
    - ทำใบสั่งของคลังสินค้าให้เสร็จสมบูรณ์
    - สร้างใบสั่งคลังสินค้าขาออกที่หายไป

- จัดการชุดงานต่อไปนี้ได้ที่ **การจัดการคลังสินค้า \> งานประจำงวด \> การจัดการปริมาณงาน**:

    - ตัวประมวลผลข้อความของฮับคลังสินค้ากับ Scale Unit
    - ประมวลผลการรับรายการในใบสั่งของคลังสินค้าสำหรับการลงรายการบัญชีการรับเข้าคลังสินค้า

ในการปรับใช้สเกลยูนิต คุณสามารถจัดการชุดงานต่อไปนี้ได้ที่ **การจัดการคลังสินค้า \> งานประจำงวด \> การจัดการปริมาณงาน**:
