...
> [!IMPORTANT]
> ตอนนี้ปริมาณงานการเริ่มการผลิตสามารถใช้ได้ในรุ่นพรีวิวเท่านั้น
>
> ฟังก์ชันธุรกิจบางอย่างไม่ได้รับการสนับสนุนอย่างเต็มที่ในตัวอย่างสำหรับสาธารณะเมื่อมีการใช้ปริมาณงาน scale unit
>
> คุณไม่สามารถเรียกใช้ปริมาณงานการเริ่มการผลิตรุ่นพรีวิวบนสเกลยูนิตที่มีการติดตั้งปริมาณงานการดำเนินการคลังสินค้าได้
...
แบบจำลองเดี๋ยวนี้จะมาจากการติดตั้งอินสแตนซ์เดียวกับแบบจำลองที่ยึดตามฮับและ scale unit ระยะ _แผน_ และ _การเสร็จสิ้น_ จะเรียกใช้เป็นการดำเนินงานของฝ่ายสนับสนุนบนฮับ และปริมาณงานการดำเนินการผลิตจะเรียกใช้บน scale unit ข้อมูลจะถูกโอนย้ายแบบอะซิงโครนัสระหว่างฮับและ scale unit
...
## <a name="manufacturing-execution-tasks-that-can-be-run-on-workloads"></a>งานการดำเนินการผลิตที่สามารถเรียกใช้บนปริมาณงาน

สามารถเรียกใช้งานการดำเนินการผลิตต่อไปนี้บนปริมาณงานเมื่อมีการใช้ scale unit:
...
- กิจกรรมทางอ้อม
- ตัวแบ่ง
- รายงานการเสร็จงานและการสำรองสินค้า (คุณยังต้องเรียกใช้ปริมาณงานการเรียกใช้คลังสินค้าบน scale unit ของคุณ ให้ดูเพิ่มเติมที่ [รายงานการเสร็จงานและการสำรองสินค้าบน scale unit](#RAF))

## <a name="working-with-manufacturing-execution-workloads-on-the-hub"></a>การทำงานกับปริมาณงานการดำเนินการผลิตบนฮับ

โดยทั่วไป กระบวนการที่จำเป็นในการเรียกใช้ปริมาณงานการดำเนินการผลิตจะเรียกใช้โดยอัตโนมัติเพื่อเก็บฮับและ scale unit ทั้งหมดในการซิงค์ ตามต้องการ อย่างไรก็ตาม ถ้าคุณกำลังประสบปัญหา คุณสามารถทริกเกอร์การประมวลผลการลงทะเบียนดิบที่ได้รับจากปริมาณงาน และ/หรือ ตรวจสอบล็อกการประมวลผลการลงทะเบียนด้วยตนเองได้

### <a name="manually-process-raw-registrations"></a>ประมวลผลการลงทะเบียนดิบด้วยตนเอง

ชุดงานใน Supply Chain Management จะเรียกใช้โดยอัตโนมัติเพื่อประมวลผลการลงทะเบียนทั้งหมดที่ได้รับมาจากปริมาณงาน งานนี้จะสร้างสมุดรายวันการผลิตที่จำเป็นและรายการบันทึกเมื่อมีการประมวลผลการลงทะเบียนสำหรับงานที่เสร็จสมบูรณ์แล้วในปริมาณงาน

ถึงแม้ว่างานจะเรียกใช้โดยอัตโนมัติ คุณสามารถเรียกใช้ด้วยตนเองได้ตลอดเวลาด้วยการล็อกอินเข้าฮับและไปที่ **การควบคุมการผลิต \> งานประจำงวด \> การจัดการปริมาณงานของฝ่ายสนับสนุน \> ประมวลผลการลงทะเบียนดิบ**
...
- **กระบวนการ** – ประมวลผลการลงทะเบียนที่เลือกด้วยตนเอง การดำเนินการนี้อาจเป็นประโยชน์ถ้างาน _ประมวลผลการลงทะเบียนดิบ_ ไม่ได้เรียกใช้อยู่ หรือถ้าล้มเหลว
...
โดยทั่วไป กระบวนการที่จำเป็นในการเรียกใช้ปริมาณงานการดำเนินการผลิตจะเรียกใช้โดยอัตโนมัติเพื่อเก็บฮับและ scale unit ทั้งหมดในการซิงค์ ตามต้องการ อย่างไรก็ตาม ถ้าคุณกำลังประสบปัญหา คุณสามารถตรวจสอบประวัติของใบสั่งที่มีการประมวลผลไว้ใน scale unit หรือเรียกใช้งาน _ตัวประมวลผลข้อความของฮับการดำเนินการผลิตไปยัง scale unit_
...
## <a name="enable-and-use-the-start-operation-on-a-scale-unit"></a>เปิดใช้งานและใช้การดําเนินงานเริ่มต้นบนสเกลยูนิต

ในผลิตภัณฑ์ปัจจุบัน การดำเนินการเริ่มต้นสำหรับใบสั่งผลิตและใบสั่งชุดงานได้รับการสนับสนุนโดย [ปริมาณงานการดําเนินงานของคลังสินค้า](cloud-edge-workload-warehousing.md) (ไม่ใช่ปริมาณงานการดําเนินการผลิต) ดังนั้น เมื่อต้องการใช้ฟังก์ชันนี้เมื่อเชื่อมต่อกับสเกลยูนิต คุณต้องทำงานดังต่อไปนี้

- ติดตั้งทั้งปริมาณงานการปฏิบัติการของคลังสินค้าและปริมาณงานการปฏิบัติการผลิตบน scale unit ของคุณ
- เปิดใช้งานคุณลักษณะ *เริ่มต้นใบสั่งผลิตในปริมาณงานในการจัดการคลังสินค้าสำหรับสเกลยูนิตในระบบคลาวด์และแบบปลายทาง* ใน [การจัดการคุณลักษณะ](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)
- ใช้แอป Warehouse Management บนมือถือเพื่อเริ่มต้นใบสั่งผลิตหรือใบสั่งชุดงาน

## <a name="enable-and-use-material-consumption-on-a-scale-unit"></a>เปิดใช้งานและใช้ปริมาณการใช้วัสดุบนสเกลยูนิต

ในผลิตภัณฑ์ปัจจุบัน ขั้นตอนในแอป Warehouse Management บนมือถือสำหรับการลงทะเบียนปริมาณการใช้วัสดุได้รับการสนับสนุนโดย [ปริมาณงานการดําเนินงานของคลังสินค้า](cloud-edge-workload-warehousing.md) (ไม่ใช่ปริมาณงานการดําเนินการผลิต) ดังนั้น เมื่อต้องการใช้ฟังก์ชันนี้เมื่อเชื่อมต่อกับสเกลยูนิต คุณต้องทำงานดังต่อไปนี้

- ติดตั้งทั้งปริมาณงานการปฏิบัติการของคลังสินค้าและปริมาณงานการปฏิบัติการผลิตบน scale unit ของคุณ
- เปิดใช้งานคุณลักษณะ *ลงทะเบียนการใช้วัสดุบนแอปสำหรับอุปกรณ์เคลื่อนที่ในสเกลยูนิต* ใน [การจัดการคุณลักษณะ](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)
- ใช้แอป Warehouse Management บนมือถือเพื่อลงทะเบียนปริมาณการใช้วัสดุ
