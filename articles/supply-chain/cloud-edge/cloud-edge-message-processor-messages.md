...
description: บทความนี้มีข้อมูลเกี่ยวกับคุณลักษณะข้อความตัวประมวลผลข้อความของปริมาณงานของ scale unit
author: perlynne
ms.date: 04/22/2021
ms.topic: article
ms.prod: ''
...
## <a name="example-message-type-request-inventory-adjustment-financial-update"></a>ชนิดข้อความตัวอย่าง: ร้องขอการอัปเดตทางการเงินของการปรับปรุงสินค้าคงคลัง
