...
เมื่อรันโทโพโลยีแบบไฮบริดแบบกระจายที่มี scale unit ชุดงาน *ตัวประมวลผลข้อความ* จะได้รับการเริ่มต้นโดยอัตโนมัติ เมื่อมีการสร้างข้อความใหม่เพื่อการประมวลผล ดังนั้นคุณจึงไม่ควรจะต้องจัดกำหนดการงานนี้ด้วยตนเอง
