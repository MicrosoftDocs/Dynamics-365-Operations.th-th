...
หัวข้อนี้อธิบายวิธีการติดตั้งและตั้งค่าคอนฟิก Microsoft Dynamics 365 for Finance and Operations - คลังสินค้า
...
> [!NOTE]
> แกลเลอรีแอป Zebra ได้ถูกเลิกใช้ ซึ่งหมายความว่าแอป Finance and Operations - Warehousing จะไม่พร้อมใช้งานอีกต่อไปสำหรับการดาวน์โหลดจากสถานที่นั้น
...
เพื่อเปิดใช้งานแอปให้ทำงานกับเซิร์ฟเวอร์ Finance and Operations เฉพาะ คุณต้องลงทะเบียนแอพลิเคชัน Web Service ในผู้เช่า Azure Active Directory สำหรับ Finance and Operations สำหรับเหตุผลด้านความปลอดภัย เราขอแนะนำให้คุณสร้างแอพบริการเว็บสำหรับแต่ละอุปกรณ์ที่คุณใช้ เพื่อสร้างแอพลิเคชัน Web Service ใน Azure Active Directory (Azure AD) ให้ดำเนินการขั้นตอนต่อไปนี้ให้เสร็จสมบูรณ์:
...
เพื่อเปิดใช้งาน Finance and Operations เพื่อใช้แอพลิเคชัน Azure AD ของคุณ คุณต้องทำขั้นตอนการตั้งค่าคอนฟิกต่อไปนี้ให้เสร็จสมบูรณ์:

1.  สร้างผู้ใช้ Finance and Operations ที่สอดคล้องกับข้อมูลประจำตัวผู้ใช้แอพคลังสินค้า
...
2.  เชื่อมโยงแอพลิเคชัน Azure Active Directory ของคุณกับผู้ใช้แอปคลังสินค้า
    1.  ใน Finance and Operations ไปที่ **การดูแลระบบ** &gt; **การตั้งค่า** &gt; **Azure Active Directory แอพลิเคชัน**
    2.  สร้างบรรทัดใหม่ 
...
คุณต้องตั้งค่าคอนฟิกแอปบนอุปกรณ์เพื่อเชื่อมต่อในเซิร์ฟเวอร์ Finance and Operations ผ่านทางแอพลิเคชัน Azure AD เมื่อต้องการทำเช่นนี้ ให้ทำตามขั้นตอนต่อไปนี้
...
3.  ป้อนข้อมูลต่อไปนี้ 
    ...
    + **ทรัพยากร Azure Active directory** - ทรัพยากรไดเรกทอรี Azure AD แสดง URL รากของ Finance and Operations **หมายเหตุ**: อย่าลงท้ายฟิลด์นี้ด้วยอักขระทับ (/) 
    + **ผู้เช่า Azure Active directory** - ผู้เช่าไดเรกทอรี Azure AD ที่ใช้กับเซิร์ฟเวอร์ Finance and Operations: `https://login.windows.net/your-AD-tenant-ID` ตัวอย่างเช่น: `https://login.windows.net/contosooperations.onmicrosoft.com.` 
...
สำหรับข้อมูลเกี่ยวกับวิธีการตั้งค่า  Dynamics 365 for Finance and Operations – คลังสินค้าที่จะสแกนบาร์โค้ดโดยใช้กล้องบนอุปกรณ์มือถือ ดู [สแกนบาร์โค้ดโดยใช้กล้องใน Dynamics 365 for Finance and Operations – คลังสินค้า](scan-bar-codes-using-a-camera.md)
