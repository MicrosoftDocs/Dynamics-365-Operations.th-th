...
หลังจากที่คุณสร้างคำสั่งสถานที่ คุณสามารถเชื่อมโยงแต่ละรหัสคำสั่งด้วยรหัสเท็มเพลตงานสำหรับการสร้างงาน สำหรับข้อมูลเพิ่มเติม โปรดดูที่ [ควบคุมงานคลังสินค้าโดยใช้เท็มเพลตงานและคำสั่งสถานที่](./control-warehouse-location-directives.md)
