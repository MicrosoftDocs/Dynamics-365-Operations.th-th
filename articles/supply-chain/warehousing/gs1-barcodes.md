...
การตั้งค่า GS1 ทั่วไปจะสร้างชุดของการแมปทั่วไป การแมปเหล่านี้จะจับคู่ฟิลด์ป้อนข้อมูลที่เกี่ยวข้องแต่ละฟิลด์ในแอปสำหรับอุปกรณ์เคลื่อนที่กับตัวระบุแอปพลิเคชัน ซึ่งควบคุมว่าควรจะตีความและจัดเก็บค่าจากบาร์โค้ดที่สแกนและจัดเก็บในฟิลด์นั้นอย่างไร ตามค่าเริ่มต้น การตั้งค่าเหล่านี้จะใช้กับการสแกนทั้งหมดสำหรับรายการเมนูของอุปกรณ์เคลื่อนที่ทั้งหมด อย่างไรก็ตาม คุณสามารถเขียนทับฟิลด์ที่ระบุหนึ่งฟิลด์ขึ้นไปโดยนโยบาย GS1 ซึ่งถูกมอบหมายให้กับรายการเมนูหนึ่งๆ
...
หน้า **การตั้งค่าทั่วไป GS1** ช่วยให้คุณสามารถโหลดชุดมาตรฐานของการแมประหว่างฟิลด์อุปกรณ์เคลื่อนที่และตัวระบุแอปพลิเคชันมาตรฐานที่สร้างขึ้นโดยการตั้งค่าเริ่มต้น
...
1. บน FastTab ภายใต้ส่วนหัว ให้แมปชื่อฟิลด์กับตัวระบุแอปพลิเคชันตามที่ต้องการสำหรับนโยบายปัจจุบัน ใช้ปุ่มบนแถบเครื่องมือเพื่อเพิ่มหรือลบแถวตามที่คุณต้องการ สำหรับแต่ละแถว กำหนดค่าฟิลด์ต่อไปนี้:

    - **ฟิลด์** – เลือกหรือป้อนฟิลด์ป้อนข้อมูลแอปสำหรับอุปกรณ์เคลื่อนที่ที่ควรมีการมอบหมายค่าขาเข้าให้ ค่าไม่ใช่ชื่อที่แสดงที่ผู้ปฏิบัติงานมองเห็น แต่นี่เป็นชื่อคีย์ที่มอบหมายให้กับฟิลด์ในรหัสพื้นฐานแทน การตั้งค่าเริ่มต้นจะแสดงชุดของฟิลด์ที่มีแนวโน้มที่จะมีประโยชน์ และรวมชื่อคีย์สำหรับแต่ละฟิลด์และฟังก์ชันโปรแกรมที่ตรงกัน อย่างไรก็ตาม คุณอาจต้องสนทนากับคู่ค้าการพัฒนาของคุณเพื่อค้นหาการเลือกที่ถูกต้องสำหรับการใช้งานของคุณ
    - **ตัวระบุแอปพลิเคชัน** – เลือกตัวระบุแอปพลิเคชันที่เกี่ยวข้องตามที่กําหนดไว้บนหน้า **ตัวระบุแอปพลิเคชัน GS1** ตัวระบุจะกําหนดวิธีการตีความและจัดเก็บบาร์โค้ดเป็นค่าสำหรับฟิลด์ที่มีการระบุชื่อ หลังจากที่คุณเลือกตัวระบุแอปพลิเคชันแล้ว ฟิลด์ **คำอธิบาย** จะแสดงคำอธิบายของฟิลด์นั้น
    - **การเรียงลำดับ** – บาร์โค้ดแบบหลายค่าแต่ละรายการประกอบด้วยชุดของตัวระบุแอปพลิเคชัน ซึ่งแต่ละรายการจะตามด้วยค่า นโยบาย GS1 ที่เกี่ยวข้องจะระบุตัวระบุแอปพลิเคชันที่แมปกับฟิลด์ฐานข้อมูลแต่ละฟิลด์ อย่างไรก็ตาม ถ้าบาร์โค้ดใช้ตัวระบุแอปพลิเคชันเดียวกันมากกว่าหนึ่งครั้ง ระบบจะใช้ลำดับที่ตัวระบุแอปพลิเคชันปรากฏอยู่ในรหัสเพื่อแมปไปยังฟิลด์ สำหรับแถวที่ใช้ตัวระบุแอปพลิเคชันร่วมกันกับแถวอื่นๆ หนึ่งแถวขึ้นไป ใช้ฟิลด์นี้เพื่อสร้างลำดับที่มีการประมวลผลแถวที่ตรงกัน แถวที่มีค่าการเรียงลำดับต่ำสุดจะได้รับการประมวลผลก่อน
