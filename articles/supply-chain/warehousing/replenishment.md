...
ยอดเงินต่ำสุดและสูงสุดถูกตั้งค่าไว้ในเท็มเพลตการเพิ่มเติมสินค้า การตั้งค่าอื่นๆ ส่วนใหญ่ในเท็มเพลตคล้ายกับการตั้งค่าในเท็มเพลตที่ใช้ในการเพิ่มเติมสินค้าตามความต้องการของเวฟ เท็มเพลตควมีหนี่งรายการสำหรับแต่ละสินค้าและสถานที่ เมื่อคุณเรียกใช้การเติมสินค้าโดยใช้ชุดงาน Microsoft Dynamics 365 for Finance and Operations จะประเมินว่าจำเป็นต้องมีการเติมสินค้าหรือไม่ โดยใช้ลำดับที่รายการถูกจัดเรียง 
