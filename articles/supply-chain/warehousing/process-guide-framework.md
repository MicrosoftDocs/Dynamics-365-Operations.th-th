...
description: บทความนี้ให้ข้อมูลเกี่ยวกับกรอบงานคู่มือกระบวนการสำหรับนักพัฒนาที่ขยายกระบวนการคลังสินค้าบนอุปกรณ์เคลื่อนที่ของเราใน X++
author: Mirzaab
ms.date: 11/01/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8860448"
---
# <a name="process-guide-framework"></a>กรอบงานคู่มือกระบวนการ

[!include [banner](../includes/banner.md)]

บทความนี้ให้ข้อมูลเกี่ยวกับกรอบงานคู่มือกระบวนการสำหรับนักพัฒนาที่ขยายกระบวนการคลังสินค้าบนอุปกรณ์เคลื่อนที่ใน X++ กระบวนการคลังสินค้าบนอุปกรณ์เคลื่อนที่สามารถขยายได้ เนื่องจากกระบวนการแบ่งออกเป็นขั้นตอนขนาดเล็ก ตรรกะทางธุรกิจและการสร้างอินเทอร์เฟสผู้ใช้ของแต่ละขั้นตอนถูกแยกออกเป็นแต่ละคลาส ซึ่งช่วยให้ขยายได้
...
> [!NOTE]
> คุณสามารถค้นหารหัสต้นทางเดียวกันได้กับวิธีการ X++ ในบทความนี้โดยใช้ Application Explorer กรองข้อมูลในชื่อคลาส แล้วคลิกขวาที่ชื่อคลาสและเลือก **ดูรหัส**
...
เพื่อสรุปทุกอย่างที่ได้อธิบายในบทความนี้ ต่อไปนี้เป็นสรุปโดยครอบคลุมของรหัสที่ทางกระบวนการต้องการ:
...
3.  **ProdProcessGuideConfirmProductionOrderPageBuilder**
    ...
    2.  แทนที่ **addActionControls()** เพื่อเพิ่มปุ่ม **ตกลง** และ **ยกเลิก**
        ...
        > [!NOTE]
        > วิธีการ **generateItemInfoForProdId()** ที่ใช้ในการสร้างป้ายชื่อข้อมูลสินค้า จะถูกแยกออกจากบทความนี้ วิธีการนี้จะสอบถามเกี่ยวกับตารางสองสามตารางที่จะรับรหัสสินค้า ข้อความ และมิติ ถ้าคุณต้องการเข้าใจมากขึ้นเกี่ยวกับ **generateItemInfoForProdId()** ให้ดูรหัสต้นทาง
...
จนถึงขณะนี้ บทความนี้ได้เน้นวิธีการสร้างกระบวนการใหม่โดยใช้กรอบงาน **ProcessGuide** ในส่วนสุดท้ายนี้ คุณจะพบตัวอย่างของวิธีการขยายกระบวนการทางธุรกิจนี้
