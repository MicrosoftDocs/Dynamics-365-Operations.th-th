...
4. ในฟิลด์ **คำอธิบายเท็มเพลตงาน** ให้พิมพ์ค่าใดค่าหนึ่ง
    - ตัวเลือก **มีผลบังคับใช้** จะไม่ถูกทำเครื่องหมาย จนกว่าคุณจะได้กรอกข้อมูลทั้งหมดที่จำเป็นเสร็จสมบูรณ์โดยใช้เท็มเพลต และได้เลือก **บันทึก** แล้ว  
...
1. เลือก **แก้ไขการสอบถาม** เราจะตั้งข้อจำกัดว่าเท็มเพลตสามารถนำมาใช้เฉพาะภายในคลังสินค้าเฉพาะเท่านั้น  
2. เลือก **เพิ่ม**
