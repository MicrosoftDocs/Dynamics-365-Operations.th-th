...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="6f692-123">การตั้งค่าเท็มเพลตเวฟ</span><span class="sxs-lookup"><span data-stu-id="6f692-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="6f692-139">บน FastTab **ผู้ใช้** ให้เลือก **สร้าง** เพื่อสร้างบัญชีอุปกรณ์เคลื่อนที่ และตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="6f692-140">**รหัสผู้ใช้:** ป้อนรหัสที่ไม่ซ้ำกัน</span><span class="sxs-lookup"><span data-stu-id="6f692-140">**User ID:** Enter a unique ID.</span></span>
...
1. <span data-ttu-id="6f692-158">ไปที่ **การจัดการคลังสินค้า \> การตั้งค่า \> พารามิเตอร์การจัดการคลังสินค้า**</span><span class="sxs-lookup"><span data-stu-id="6f692-158">Go to **Warehouse management \> Setup \> Warehouse management parameters**.</span></span>
...
1. <span data-ttu-id="6f692-176">ในบานหน้าต่างการดำเนินการ ให้เลือก **สร้าง** เพื่อสร้างสถานที่ และตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-176">On the Action Pane, select **New** to create a location, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="6f692-177">**คลังสินค้า:** *62*</span><span class="sxs-lookup"><span data-stu-id="6f692-177">**Warehouse:** *62*</span></span>
...
1. <span data-ttu-id="6f692-192">บนแท็บด่วน **ทั่วไป** ให้กำหนดค่าดังต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-192">On the **General** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="6f692-194">**สร้างงานในการปิดตำแหน่ง:** *ใช่*</span><span class="sxs-lookup"><span data-stu-id="6f692-194">**Create work on position close:** *Yes*</span></span>
        ...
        <span data-ttu-id="6f692-195">ถ้ามีการตั้งค่าตัวเลือกนี้เป็น *ใช่* เมื่อปิดตำแหน่ง จะมีการสร้างงานเพื่อย้ายสินค้าคงคลังไปยังสถานที่จัดส่งขั้นสุดท้าย</span><span class="sxs-lookup"><span data-stu-id="6f692-195">If this option is set to *Yes*, when the position is closed, work will be created to move inventory to the final shipping location.</span></span> <span data-ttu-id="6f692-196">ถ้ามีการตั้งค่าเป็น *ไม่* จะมีการเบิกสินค้าคงคลังไปยังใบสั่งนี้โดยทันที เมื่อมีการปิดตำแหน่ง</span><span class="sxs-lookup"><span data-stu-id="6f692-196">If it's set to *No*, inventory will immediately be picked to the order when the position is closed.</span></span>
...
1. <span data-ttu-id="6f692-211">คุณอาจได้รับข้อความแสดงข้อความต่อไปนี้: "การจัดกลุ่มจะถูกรีเซ็ต ดำเนินการต่อหรือไม่"</span><span class="sxs-lookup"><span data-stu-id="6f692-211">You might receive the following message: "Grouping will be reset, continue?"</span></span> <span data-ttu-id="6f692-212">เลือก **ใช่**</span><span class="sxs-lookup"><span data-stu-id="6f692-212">Select **Yes**.</span></span>
    ...
    <span data-ttu-id="6f692-213">ปุ่ม **การแบ่งเท็มเพลตการเรียงลำดับขาออก** ในบานหน้าต่างการดำเนินการ จะพร้อมใช้งาน</span><span class="sxs-lookup"><span data-stu-id="6f692-213">The **Outbound sorting template breaks** button on the Action Pane becomes available.</span></span>
...
1. <span data-ttu-id="6f692-232">เลือก **บันทึก**</span><span class="sxs-lookup"><span data-stu-id="6f692-232">Select **Save**.</span></span>
...
1. <span data-ttu-id="6f692-251">เลือก **บันทึก**</span><span class="sxs-lookup"><span data-stu-id="6f692-251">Select **Save**.</span></span>
...
1. <span data-ttu-id="6f692-268">เลือก **บันทึก**</span><span class="sxs-lookup"><span data-stu-id="6f692-268">Select **Save**.</span></span>
...
1. <span data-ttu-id="6f692-285">ไปที่ **การจัดการคลังสินค้า \> การตั้งค่า \> อุปกรณ์เคลื่อนที่ \> เมนูบนอุปกรณ์เคลื่อนที่**</span><span class="sxs-lookup"><span data-stu-id="6f692-285">Go to **Warehouse management \> Setup \> Mobile device \> Mobile device menu**.</span></span>
...
1. <span data-ttu-id="6f692-300">บนส่วนหัว ให้กำหนดค่าดังต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-300">In the header, set the following values:</span></span>
    ...
    - <span data-ttu-id="6f692-301">**ลำดับ:** *1*</span><span class="sxs-lookup"><span data-stu-id="6f692-301">**Sequence:** *1*</span></span>
...
#### <a name="set-up-a-multiple-sku-directive"></a><span data-ttu-id="6f692-324">ตั้งค่าคำสั่ง SKU หลายรายการ</span><span class="sxs-lookup"><span data-stu-id="6f692-324">Set up a multiple-SKU directive</span></span>
...
1. <span data-ttu-id="6f692-343">บน FastTab **การดำเนินการคำสั่งสถานที่** ให้เลือก **สร้าง** แล้วจากนั้น ตั้งค่าค่าต่อไปนี้ในรายการใหม่</span><span class="sxs-lookup"><span data-stu-id="6f692-343">On the **Location Directive Actions** FastTab, select **New**, and then set the following values on the new line.</span></span> <span data-ttu-id="6f692-344">ยอมรับค่าเริ่มต้นสำหรับฟิลด์อื่นๆ ทั้งหมด</span><span class="sxs-lookup"><span data-stu-id="6f692-344">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="6f692-345">**ลำดับ:** *1*</span><span class="sxs-lookup"><span data-stu-id="6f692-345">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="6f692-364">เลือก **สร้าง** อีกครั้งเพื่อเพิ่มบรรทัดที่สอง แล้วจากนั้น ตั้งค่าค่าต่อไปนี้สำหรับบรรทัดนั้น:</span><span class="sxs-lookup"><span data-stu-id="6f692-364">Select **New** again to add a second line, and then set the following values for it:</span></span>
...
1. <span data-ttu-id="6f692-378">เลือก **ตกลง** เพื่อปิดกล่องโต้ตอบ</span><span class="sxs-lookup"><span data-stu-id="6f692-378">Select **OK** to close the dialog box.</span></span>
    ...
    <span data-ttu-id="6f692-379">มีการเปิดใบสั่งขายใหม่</span><span class="sxs-lookup"><span data-stu-id="6f692-379">The new sales order is opened.</span></span>
...
1. <span data-ttu-id="6f692-398">ในกล่องโต้ตอบ **สร้างใบสั่งขาย** ให้ตั้งค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-398">In the **Create sales order** dialog box, set the following values:</span></span>
    ...
    - <span data-ttu-id="6f692-399">**บัญชีลูกค้า:** *US-006*</span><span class="sxs-lookup"><span data-stu-id="6f692-399">**Customer account:** *US-006*</span></span>
...
1. <span data-ttu-id="6f692-411">บน FastTab **รายละเอียดของรายการ** บนแท็บ **การจัดส่ง** ให้เปลี่ยนค่าของฟิลด์ **โหมดการจัดส่ง** เป็น *Air C-Air*</span><span class="sxs-lookup"><span data-stu-id="6f692-411">On the **Line details** FastTab, on the **Delivery** tab, change the value of the **Mode of delivery** field to *Air C-Air*.</span></span>
1. <span data-ttu-id="6f692-412">บน FastTab **รายการใบสั่งขาย** เลือกรายการใบสั่งแรก</span><span class="sxs-lookup"><span data-stu-id="6f692-412">On the **Sales order lines** FastTab, select the first order line.</span></span> <span data-ttu-id="6f692-413">จากนั้น บนเมนู **สินค้าคงคลัง** ด้านบนกริด ให้เลือก **การจอง**</span><span class="sxs-lookup"><span data-stu-id="6f692-413">Then, on the **Inventory** menu above the grid, select **Reservation**.</span></span>
1. <span data-ttu-id="6f692-414">บนหน้า **การจอง** ให้เลือก **สำรองล็อต** เพื่อจองปริมาณทั้งหมดของรายการที่เลือกในคลังสินค้า</span><span class="sxs-lookup"><span data-stu-id="6f692-414">On the **Reservation** page, select **Reserve lot** to reserve the full quantity of the selected line in the warehouse.</span></span>
1. <span data-ttu-id="6f692-415">ปิดหน้า **การจอง** เพื่อส่งคืนไปยังใบสั่งขาย</span><span class="sxs-lookup"><span data-stu-id="6f692-415">Close the **Reservation** page to return to the sales order.</span></span>
1. <span data-ttu-id="6f692-416">บน FastTab **รายการใบสั่งขาย** เลือกรายการใบสั่งที่สอง</span><span class="sxs-lookup"><span data-stu-id="6f692-416">On the **Sales order lines** FastTab, select the second order line.</span></span> <span data-ttu-id="6f692-417">จากนั้น บนเมนู **สินค้าคงคลัง** ด้านบนกริด ให้เลือก **การจอง**</span><span class="sxs-lookup"><span data-stu-id="6f692-417">Then, on the **Inventory** menu above the grid, select **Reservation**.</span></span>
1. <span data-ttu-id="6f692-418">บนหน้า **การจอง** ให้เลือก **สำรองล็อต** เพื่อจองปริมาณทั้งหมดของรายการที่เลือกในคลังสินค้า</span><span class="sxs-lookup"><span data-stu-id="6f692-418">On the **Reservation** page, select **Reserve lot** to reserve the full quantity of the selected line in the warehouse.</span></span>
1. <span data-ttu-id="6f692-419">ปิดหน้า **การจอง** เพื่อส่งคืนไปยังใบสั่งขาย</span><span class="sxs-lookup"><span data-stu-id="6f692-419">Close the **Reservation** page to return to the sales order.</span></span>
1. <span data-ttu-id="6f692-420">บนบานหน้าต่างการดำเนินการ บนแท็บ **คลังสินค้า** ในกลุ่ม **การดำเนินการ** ให้เลือก **นำออกใช้ไปยังคลังสินค้า**</span><span class="sxs-lookup"><span data-stu-id="6f692-420">On the Action Pane, on the **Warehouse** tab, in the **Actions** group, select **Release to warehouse**.</span></span>
1. <span data-ttu-id="6f692-421">คุณได้รับข้อความที่ให้ข้อมูลซึ่งแสดงการจัดส่งและเวฟสำหรับใบสั่งนี้</span><span class="sxs-lookup"><span data-stu-id="6f692-421">You receive an informational message that shows the shipment and wave for this order.</span></span> <span data-ttu-id="6f692-422">โปรดสังเกตว่ามีการสร้างหมายเลขรหัสเวฟสองหมายเลขและหมายเลขรหัสการจัดส่งสองหมายเลข หนึ่งหมายเลขสำหรับโหมดการจัดส่งแต่ละโหมดสำหรับรายการใบสั่งขาย</span><span class="sxs-lookup"><span data-stu-id="6f692-422">Notice that two wave ID numbers and two shipment ID numbers have been created, one for each mode of delivery for the sales order lines.</span></span>

#### <a name="get-the-work-ids-from-the-work-details"></a><span data-ttu-id="6f692-423">เรียกดูรหัสงานจากรายละเอียดงาน</span><span class="sxs-lookup"><span data-stu-id="6f692-423">Get the work IDs from the work details</span></span>

1. <span data-ttu-id="6f692-424">ไปที่ **การจัดการคลังสินค้า \> งาน \> รายละเอียดงาน**</span><span class="sxs-lookup"><span data-stu-id="6f692-424">Go to **Warehouse management \> Work \> Work details**.</span></span>
1. <span data-ttu-id="6f692-425">หน้าแสดงรหัสงานที่สร้างขึ้นจากใบสั่งขาย</span><span class="sxs-lookup"><span data-stu-id="6f692-425">The page shows the work IDs that have been created from sales orders.</span></span> <span data-ttu-id="6f692-426">ใช้รหัสคลื่นและรหัสการจัดส่งจากใบสั่งขายที่คุณสร้างขึ้น เพื่อหารหัสงานสำหรับเวฟและการจัดส่งแต่ละรายการ</span><span class="sxs-lookup"><span data-stu-id="6f692-426">Use the wave IDs and shipment IDs from the sales orders that you created to find the work ID for each wave and shipment.</span></span> <span data-ttu-id="6f692-427">จดบันทึกรหัสงานเหล่านั้น เนื่องจากคุณจะต้องใช้ในขั้นตอนถัดไป</span><span class="sxs-lookup"><span data-stu-id="6f692-427">Make a note of those work IDs, because you will need them in the next steps.</span></span> <span data-ttu-id="6f692-428">โปรดสังเกตว่ามีการสร้างรหัสงานสองรหัสสำหรับใบสั่งขายที่สอง</span><span class="sxs-lookup"><span data-stu-id="6f692-428">Notice that two work IDs were created for the second sales order.</span></span> <span data-ttu-id="6f692-429">ถ้ามีการเบิกสินค้าที่แตกต่างกันจากสถานที่เก็บที่แตกต่างกัน จะมีการสร้างรหัสงานที่แยกต่างหาก</span><span class="sxs-lookup"><span data-stu-id="6f692-429">If different items are picked from different locations, separate word IDs are generated.</span></span>

### <a name="pick-items-for-the-sales-orders"></a><span data-ttu-id="6f692-430">เบิกสินค้าสำหรับใบสั่งขาย</span><span class="sxs-lookup"><span data-stu-id="6f692-430">Pick items for the sales orders</span></span>

<span data-ttu-id="6f692-431">ทำงานที่สร้างขึ้นให้เสร็จสมบูรณ์โดยใช้อุปกรณ์เคลื่อนที่เพื่อย้ายสินค้าไปยังสถานีบรรจุสินค้า</span><span class="sxs-lookup"><span data-stu-id="6f692-431">Complete the created work by using the mobile device to move the items to the pack station.</span></span>

1. <span data-ttu-id="6f692-432">บนอุปกรณ์เคลื่อนที่ ให้ลงชื่อเข้าใช้คลังสินค้า *62* โดยใช้รหัสผู้ใช้ที่คุณสร้างไว้สำหรับสถานการณ์จำลองนี้ (หรือรหัสผู้ใช้ของผู้ใช้ข้อมูลสาธิตที่มีอยู่)</span><span class="sxs-lookup"><span data-stu-id="6f692-432">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="6f692-433">บนเมนูหลัก ให้เลือก **ขาออก**</span><span class="sxs-lookup"><span data-stu-id="6f692-433">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="6f692-434">บนเมนู **ขาออก** ให้เลือก **การเบิกสินค้าขาย**</span><span class="sxs-lookup"><span data-stu-id="6f692-434">On the **Outbound** menu, select **Sales Picking**.</span></span>
1. <span data-ttu-id="6f692-435">ในฟิลด์ **รหัส** ให้ป้อนรหัสงานที่สร้างไว้สำหรับใบสั่งขายที่ 1</span><span class="sxs-lookup"><span data-stu-id="6f692-435">In the **ID** field, enter the work ID that was created for sales order 1.</span></span>
1. <span data-ttu-id="6f692-436">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-436">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-437">บนหน้า **ใบสั่งขาย - เบิกสินค้า** ให้ป้อน LP เป้าหมายที่สร้างไว้สำหรับใบสั่งขายที่ 1</span><span class="sxs-lookup"><span data-stu-id="6f692-437">On the **Sales orders - Pick** page, enter a target LP that was created for sales order 1.</span></span> <span data-ttu-id="6f692-438">โปรดสังเกตว่าสถานที่เบิกสินค้า (*bulk-001*) สินค้า (*A0001*) และปริมาณ (*2 pcs*) จะแสดงขึ้น</span><span class="sxs-lookup"><span data-stu-id="6f692-438">Notice that the picking location (*bulk-001*), item (*A0001*), and quantity (*2 pcs*) are shown.</span></span>
1. <span data-ttu-id="6f692-439">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-439">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-440">รีวิวข้อมูลในหน้า **ใบสั่งขาย - ส่งสินค้า**</span><span class="sxs-lookup"><span data-stu-id="6f692-440">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="6f692-441">ฟิลด์ **Loc** ควรบ่งชี้ว่าสินค้าที่เบิกจะไปที่สถานที่ *บรรจุ*</span><span class="sxs-lookup"><span data-stu-id="6f692-441">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
1. <span data-ttu-id="6f692-442">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-442">Select **OK**.</span></span>

    <span data-ttu-id="6f692-443">บนหน้า **สแกนรหัสงาน / รหัสป้ายทะเบียน** คุณจะได้รับข้อความ "งานเสร็จสมบูรณ์" ซึ่งบ่งชี้ว่ารหัสงานจากใบสั่งขายที่ 1 เสร็จสมบูรณ์แล้ว</span><span class="sxs-lookup"><span data-stu-id="6f692-443">On the **Scan a work ID / license plate ID** page, you receive a "Work Completed" message, which indicates that the work ID from sales order 1 has been completed.</span></span>

    <span data-ttu-id="6f692-444">ขณะนี้คุณจะเบิกสินค้าตามใบสั่งขายที่ 2</span><span class="sxs-lookup"><span data-stu-id="6f692-444">You will now pick sales order 2.</span></span>

1. <span data-ttu-id="6f692-445">ในฟิลด์ **รหัส** ให้ป้อนรหัสงานที่สร้างไว้สำหรับใบสั่งขายที่ 2 ขณะที่รายการที่ 1 มีสินค้า *A0001*</span><span class="sxs-lookup"><span data-stu-id="6f692-445">In the **ID** field, enter the work ID that was created for sales order 2, where line 1 has item *A0001*.</span></span>
1. <span data-ttu-id="6f692-446">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-446">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-447">บนหน้า **ใบสั่งขาย - เบิกสินค้า** ให้ป้อน LP เป้าหมาย</span><span class="sxs-lookup"><span data-stu-id="6f692-447">On the **Sales orders - Pick** page, enter a target LP.</span></span> <span data-ttu-id="6f692-448">โปรดสังเกตว่าสถานที่เบิกสินค้า (*bulk-001*) สินค้า (*A0001*) และปริมาณ (*1 pcs*) จะแสดงขึ้น</span><span class="sxs-lookup"><span data-stu-id="6f692-448">Notice that the picking location (*bulk-001*), item (*A0001*), and quantity (*1 pcs*) are shown.</span></span>
1. <span data-ttu-id="6f692-449">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-449">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-450">รีวิวข้อมูลในหน้า **ใบสั่งขาย - ส่งสินค้า**</span><span class="sxs-lookup"><span data-stu-id="6f692-450">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="6f692-451">ฟิลด์ **Loc** ควรบ่งชี้ว่าสินค้าที่เบิกจะไปที่สถานที่ *บรรจุ*</span><span class="sxs-lookup"><span data-stu-id="6f692-451">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
1. <span data-ttu-id="6f692-452">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-452">Select **OK**.</span></span>

    <span data-ttu-id="6f692-453">บนหน้า **สแกนรหัสงาน / รหัสป้ายทะเบียน** คุณจะได้รับข้อความ "งานเสร็จสมบูรณ์"</span><span class="sxs-lookup"><span data-stu-id="6f692-453">On the **Scan a work ID / license plate ID** page, you receive a "Work Completed" message.</span></span> <span data-ttu-id="6f692-454">ข้อความนี้บ่งชี้ว่ารหัสงานจากบรรทัดที่ 1 ของใบสั่งขายที่ 2 เสร็จสมบูรณ์แล้ว</span><span class="sxs-lookup"><span data-stu-id="6f692-454">This message indicates that the work ID from line 1 of sales order 2 has been completed.</span></span>

1. <span data-ttu-id="6f692-455">ในฟิลด์ **รหัส** ให้ป้อนรหัสงานที่สร้างไว้สำหรับใบสั่งขายที่ 2 ขณะที่รายการที่ 2 มีสินค้า *A0002*</span><span class="sxs-lookup"><span data-stu-id="6f692-455">In the **ID** field, enter the work ID that was created for sales order 2, where line 2 has item *A0002*.</span></span>
1. <span data-ttu-id="6f692-456">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-456">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-457">บนหน้า **ใบสั่งขาย - เบิกสินค้า** ให้ป้อน LP เป้าหมาย</span><span class="sxs-lookup"><span data-stu-id="6f692-457">On the **Sales orders - Pick** page, enter a target LP.</span></span> <span data-ttu-id="6f692-458">โปรดสังเกตว่าสถานที่เบิกสินค้า (*bulk-002*) สินค้า (*A0001*) และปริมาณ (*1 pcs*) จะแสดงขึ้น</span><span class="sxs-lookup"><span data-stu-id="6f692-458">Notice that the picking location (*bulk-002*), item (*A0001*), and quantity (*1 pcs*) are shown.</span></span>
1. <span data-ttu-id="6f692-459">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-459">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-460">รีวิวข้อมูลในหน้า **ใบสั่งขาย - ส่งสินค้า**</span><span class="sxs-lookup"><span data-stu-id="6f692-460">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="6f692-461">ฟิลด์ **Loc** ควรบ่งชี้ว่าสินค้าที่เบิกจะไปที่สถานที่ *บรรจุ*</span><span class="sxs-lookup"><span data-stu-id="6f692-461">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
1. <span data-ttu-id="6f692-462">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-462">Select **OK**.</span></span>

    <span data-ttu-id="6f692-463">บนหน้า **สแกนรหัสงาน / รหัสป้ายทะเบียน** คุณจะได้รับข้อความ "งานเสร็จสมบูรณ์"</span><span class="sxs-lookup"><span data-stu-id="6f692-463">On the **Scan a work ID / license plate ID** page, you receive a "Work Completed" message.</span></span> <span data-ttu-id="6f692-464">ข้อความนี้บ่งชี้ว่ารหัสงานจากรายการที่ 2 ของใบสั่งขายที่ 2 เสร็จสมบูรณ์แล้ว</span><span class="sxs-lookup"><span data-stu-id="6f692-464">This message indicates that the work ID from line 2 of sales order 2 has been completed.</span></span>

### <a name="pack-sales-orders-into-containers"></a><span data-ttu-id="6f692-465">บรรจุใบสั่งขายลงในคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-465">Pack sales orders into containers</span></span>

#### <a name="pack-sales-order-1-into-containers"></a><span data-ttu-id="6f692-466">บรรจุใบสั่งขายที่ 1 ลงในคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-466">Pack sales order 1 into containers</span></span>

1. <span data-ttu-id="6f692-467">ไปที่ **การจัดการคลังสินค้า \> การบรรจุและการบรรจุลงตู้บรรจุสินค้า \> บรรจุ**</span><span class="sxs-lookup"><span data-stu-id="6f692-467">Go to **Warehouse management \> Packing and containerization \> Pack**.</span></span>

    <span data-ttu-id="6f692-468">กล่องโต้ตอบ **เลือกสถานีบรรจุสินค้า** ปรากฏขึ้น</span><span class="sxs-lookup"><span data-stu-id="6f692-468">The **Select packing station** dialog box appears.</span></span> <span data-ttu-id="6f692-469">โดยค่าเริ่มต้น ควรมีการตั้งค่าฟิลด์ **ผู้ปฏิบัติงาน** เป็นชื่อของผู้ปฏิบัติงานที่คุณตั้งค่าไว้ก่อนหน้านี้</span><span class="sxs-lookup"><span data-stu-id="6f692-469">By default, the **Worker** field should be set to the name of the worker that you set up earlier.</span></span>

1. <span data-ttu-id="6f692-470">ตั้งค่าค่าต่อไปนี้เพื่อดูและทำงานกับการจัดส่งและคอนเทนเนอร์ที่วางแผนไว้ที่สถานที่บรรจุที่ระบุ:</span><span class="sxs-lookup"><span data-stu-id="6f692-470">Set the following values to view and work on shipments and containers that are planned at the specific packing location:</span></span>

    - <span data-ttu-id="6f692-471">**ไซต์:** *6*</span><span class="sxs-lookup"><span data-stu-id="6f692-471">**Site:** *6*</span></span>
    - <span data-ttu-id="6f692-472">**คลังสินค้า:** *62*</span><span class="sxs-lookup"><span data-stu-id="6f692-472">**Warehouse:** *62*</span></span>
    - <span data-ttu-id="6f692-473">**สถานที่:** *บรรจุ*</span><span class="sxs-lookup"><span data-stu-id="6f692-473">**Location:** *Pack*</span></span>
    - <span data-ttu-id="6f692-474">**รหัสโพรไฟล์การบรรจุ:** *เรียงลำดับ*</span><span class="sxs-lookup"><span data-stu-id="6f692-474">**Packing profile ID:** *Sort*</span></span>

1. <span data-ttu-id="6f692-475">เลือก **ตกลง** เพื่อปิดกล่องโต้ตอบ</span><span class="sxs-lookup"><span data-stu-id="6f692-475">Select **OK** to close the dialog box.</span></span>
1. <span data-ttu-id="6f692-476">บนหน้า **บรรจุ** ในฟิลด์ **ป้ายทะเบียนหรือการจัดส่ง** ให้ป้อน LP เป้าหมายสำหรับใบสั่งขายที่ 1</span><span class="sxs-lookup"><span data-stu-id="6f692-476">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for sales order 1.</span></span> <span data-ttu-id="6f692-477">แล้วเลือก **แท็บ** หรือ **ป้อน** คีย์บนแป้นพิมพ์เพื่อย้ายออกจากฟิลด์</span><span class="sxs-lookup"><span data-stu-id="6f692-477">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="6f692-478">บนหน้าต่างการดำเนินการ เลือก **คอนเทนเนอร์ใหม่**</span><span class="sxs-lookup"><span data-stu-id="6f692-478">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="6f692-479">ยอมรับการตั้งค่าเริ่มต้นทั้งหมด และเลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-479">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="6f692-480">จดบันทึกรหัสคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-480">Make a note of the container ID.</span></span>
1. <span data-ttu-id="6f692-481">บน FastTab **การบรรจุสินค้า** ให้ตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-481">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="6f692-482">**ปริมาณ:** *1*</span><span class="sxs-lookup"><span data-stu-id="6f692-482">**Quantity:** *1*</span></span>
    - <span data-ttu-id="6f692-483">**ตัวระบุ:** สินค้า *A0001*</span><span class="sxs-lookup"><span data-stu-id="6f692-483">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="6f692-484">บนหน้าต่างการดำเนินการ เลือก **ปิดคอนเทนเนอร์**</span><span class="sxs-lookup"><span data-stu-id="6f692-484">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="6f692-485">ในกล่องโต้ตอบ **ปิดคอนเทนเนอร์** ให้เลือก **ดูน้ำหนักของระบบ** เพื่อให้ระบบปรับปรุงฟิลด์ **น้ำหนักรวม**</span><span class="sxs-lookup"><span data-stu-id="6f692-485">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="6f692-486">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-486">Select **OK**.</span></span> <span data-ttu-id="6f692-487">คอนเทนเนอร์ถูกย้ายไปสถานที่ *SORT* และพร้อมสำหรับการเรียงลำดับ</span><span class="sxs-lookup"><span data-stu-id="6f692-487">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="6f692-488">สร้างคอนเทนเนอร์ที่สองเพื่อเพิ่มสินค้าที่สองจาก LP สำหรับใบสั่งขายที่ 1 ไปยังคอนเทนเนอร์ใหม่</span><span class="sxs-lookup"><span data-stu-id="6f692-488">Create a second container to add the second item from the LP for sales order 1 to a new container.</span></span>
1. <span data-ttu-id="6f692-489">บนหน้าต่างการดำเนินการ เลือก **คอนเทนเนอร์ใหม่**</span><span class="sxs-lookup"><span data-stu-id="6f692-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="6f692-490">ยอมรับการตั้งค่าเริ่มต้นทั้งหมด และเลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="6f692-491">จดบันทึกรหัสคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="6f692-492">บน FastTab **การบรรจุสินค้า** ให้ตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="6f692-493">**ปริมาณ:** *1*</span><span class="sxs-lookup"><span data-stu-id="6f692-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="6f692-494">**ตัวระบุ:** สินค้า *A0001*</span><span class="sxs-lookup"><span data-stu-id="6f692-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="6f692-495">บนหน้าต่างการดำเนินการ เลือก **ปิดคอนเทนเนอร์**</span><span class="sxs-lookup"><span data-stu-id="6f692-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="6f692-496">ในกล่องโต้ตอบ **ปิดคอนเทนเนอร์** ให้เลือก **ดูน้ำหนักของระบบ** เพื่อให้ระบบปรับปรุงฟิลด์ **น้ำหนักรวม**</span><span class="sxs-lookup"><span data-stu-id="6f692-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="6f692-497">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-497">Select **OK**.</span></span> <span data-ttu-id="6f692-498">คอนเทนเนอร์ถูกย้ายไปสถานที่ *SORT* และพร้อมสำหรับการเรียงลำดับ</span><span class="sxs-lookup"><span data-stu-id="6f692-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="6f692-499">บรรจุใบสั่งขายที่ 2 ลงในคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="6f692-500">บนหน้า **บรรจุ** ในฟิลด์ **ป้ายทะเบียนหรือการจัดส่ง** ให้ป้อน LP เป้าหมายสำหรับรายการที่ 1 ของใบสั่งขายที่ 2</span><span class="sxs-lookup"><span data-stu-id="6f692-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="6f692-501">แล้วเลือก **แท็บ** หรือ **ป้อน** คีย์บนแป้นพิมพ์เพื่อย้ายออกจากฟิลด์</span><span class="sxs-lookup"><span data-stu-id="6f692-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="6f692-502">บนหน้าต่างการดำเนินการ เลือก **คอนเทนเนอร์ใหม่**</span><span class="sxs-lookup"><span data-stu-id="6f692-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="6f692-503">ยอมรับการตั้งค่าเริ่มต้นทั้งหมด และเลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="6f692-504">จดบันทึกรหัสคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="6f692-505">บน FastTab **การบรรจุสินค้า** ให้ตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="6f692-506">**ปริมาณ:** *1*</span><span class="sxs-lookup"><span data-stu-id="6f692-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="6f692-507">**ตัวระบุ:** สินค้า *A0001*</span><span class="sxs-lookup"><span data-stu-id="6f692-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="6f692-508">บนหน้าต่างการดำเนินการ เลือก **ปิดคอนเทนเนอร์**</span><span class="sxs-lookup"><span data-stu-id="6f692-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="6f692-509">ในกล่องโต้ตอบ **ปิดคอนเทนเนอร์** ให้เลือก **ดูน้ำหนักของระบบ** เพื่อให้ระบบปรับปรุงฟิลด์ **น้ำหนักรวม**</span><span class="sxs-lookup"><span data-stu-id="6f692-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="6f692-510">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-510">Select **OK**.</span></span> <span data-ttu-id="6f692-511">คอนเทนเนอร์ถูกย้ายไปสถานที่ *SORT* และพร้อมสำหรับการเรียงลำดับ</span><span class="sxs-lookup"><span data-stu-id="6f692-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="6f692-512">ในฟิลด์ **ป้ายทะเบียนหรือการจัดส่ง** ให้ป้อน LP เป้าหมายสำหรับรายการที่ 2 ของใบสั่งขายที่ 2</span><span class="sxs-lookup"><span data-stu-id="6f692-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="6f692-513">แล้วเลือก **แท็บ** หรือ **ป้อน** คีย์บนแป้นพิมพ์เพื่อย้ายออกจากฟิลด์</span><span class="sxs-lookup"><span data-stu-id="6f692-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="6f692-514">บนหน้าต่างการดำเนินการ เลือก **คอนเทนเนอร์ใหม่**</span><span class="sxs-lookup"><span data-stu-id="6f692-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="6f692-515">ยอมรับการตั้งค่าเริ่มต้นทั้งหมด และเลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="6f692-516">จดบันทึกรหัสคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="6f692-517">บน FastTab **การบรรจุสินค้า** ให้ตั้งค่าค่าต่อไปนี้:</span><span class="sxs-lookup"><span data-stu-id="6f692-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="6f692-518">**ปริมาณ:** *1*</span><span class="sxs-lookup"><span data-stu-id="6f692-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="6f692-519">**ฟิลด์ตัวระบุ:** สินค้า *A0002*</span><span class="sxs-lookup"><span data-stu-id="6f692-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="6f692-520">บนหน้าต่างการดำเนินการ เลือก **ปิดคอนเทนเนอร์**</span><span class="sxs-lookup"><span data-stu-id="6f692-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="6f692-521">ในกล่องโต้ตอบ **ปิดคอนเทนเนอร์** ให้เลือก **ดูน้ำหนักของระบบ** เพื่อให้ระบบปรับปรุงฟิลด์ **น้ำหนักรวม**</span><span class="sxs-lookup"><span data-stu-id="6f692-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="6f692-522">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-522">Select **OK**.</span></span> <span data-ttu-id="6f692-523">คอนเทนเนอร์ถูกย้ายไปสถานที่ *SORT* และพร้อมสำหรับการเรียงลำดับ</span><span class="sxs-lookup"><span data-stu-id="6f692-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="6f692-524">ถ้าต้องการดูรายละเอียดคอนเทนเนอร์ ให้ไปที่ **การจัดการคลังสินค้า \> การบรรจุและการบรรจุลงตู้บรรจุสินค้า \> คอนเทนเนอร์** และค้นหารหัสคอนเทนเนอร์ที่สร้างขึ้นในระหว่างการบรรจุ</span><span class="sxs-lookup"><span data-stu-id="6f692-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers**, and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="6f692-525">เรียงลำดับคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="6f692-526">เมื่อคุณเข้าถึงรายการเมนู **การสร้างแท่นวางสินค้า** บนแอปสำหรับอุปกรณ์เคลื่อนที่เพื่อทำการเรียงลำดับขาออก คุณจะเห็นปุ่มที่ติดป้ายชื่อ **แบบเต็ม**</span><span class="sxs-lookup"><span data-stu-id="6f692-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="6f692-527">*อย่าใช้ปุ่ม **แบบเต็ม** เพื่อเรียงลำดับหรือปิดตำแหน่ง*</span><span class="sxs-lookup"><span data-stu-id="6f692-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="6f692-528">ปุ่ม **แบบเต็ม** จะระบุโดยค่าเริ่มต้น และไม่สามารถปิดใช้งานหรือลบออกจากหน้าได้</span><span class="sxs-lookup"><span data-stu-id="6f692-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="6f692-529">ซึ่งไม่มีการใช้สำหรับคุณลักษณะ *การเรียงลำดับขาออก*</span><span class="sxs-lookup"><span data-stu-id="6f692-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="6f692-530">เรียงลำดับคอนเทนเนอร์แรก</span><span class="sxs-lookup"><span data-stu-id="6f692-530">Sort the first container</span></span>

1. <span data-ttu-id="6f692-531">บนอุปกรณ์เคลื่อนที่ ให้ลงชื่อเข้าใช้คลังสินค้า *62* โดยใช้รหัสผู้ใช้ที่คุณสร้างไว้สำหรับสถานการณ์จำลองนี้ (หรือรหัสผู้ใช้ของผู้ใช้ข้อมูลสาธิตที่มีอยู่)</span><span class="sxs-lookup"><span data-stu-id="6f692-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="6f692-532">บนเมนูหลัก ให้เลือก **ขาออก**</span><span class="sxs-lookup"><span data-stu-id="6f692-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="6f692-533">บนเมนู **ขาออก** ให้เลือก **การสร้างแท่นวางสินค้า**</span><span class="sxs-lookup"><span data-stu-id="6f692-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="6f692-534">ในฟิลด์ **LP/Con** ให้ป้อนรหัสคอนเทนเนอร์แรกที่สัมพันธ์กับใบสั่งขายที่ 1</span><span class="sxs-lookup"><span data-stu-id="6f692-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="6f692-535">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-535">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-536">เนื่องจากไม่มีตำแหน่งการเรียงลำดับอยู่ในขณะนี้ คุณต้องระบุหนึ่งตำแหน่ง</span><span class="sxs-lookup"><span data-stu-id="6f692-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="6f692-537">ในฟิลด์ **รหัสตำแหน่งการเรียงลำดับ** ให้ป้อน *SP01*</span><span class="sxs-lookup"><span data-stu-id="6f692-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="6f692-538">เนื่องจากไม่มี LP ที่เชื่อมโยงกับตำแหน่งการเรียงลำดับ *SP01* อยู่ในขณะนี้ คุณต้องระบุหนึ่งรายการ</span><span class="sxs-lookup"><span data-stu-id="6f692-538">Because no LP is currently associated with sort position *SP01*, you must specify one.</span></span> <span data-ttu-id="6f692-539">ในฟิลด์ **LP** ป้อน *PLP01*</span><span class="sxs-lookup"><span data-stu-id="6f692-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="6f692-540">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-540">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-541">เนื่องจากมีการเปิดใช้งานการตรวจสอบความถูกต้องของตำแหน่งการเรียงลำดับ คุณต้องป้อนรหัสตำแหน่งการเรียงลำดับอีกครั้ง</span><span class="sxs-lookup"><span data-stu-id="6f692-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="6f692-542">ในฟิลด์ **รหัสตำแหน่งการเรียงลำดับ** ให้ป้อน *SP01*</span><span class="sxs-lookup"><span data-stu-id="6f692-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="6f692-543">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-543">Select **OK**.</span></span>

    <span data-ttu-id="6f692-544">คุณได้รับข้อความ "งานเสร็จสมบูรณ์"</span><span class="sxs-lookup"><span data-stu-id="6f692-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="6f692-545">เมื่อต้องการดูตำแหน่งการเรียงลำดับและ LP ในนั้น ให้ไปที่ **การจัดการคลังสินค้า \> การบรรจุและการบรรจุลงตู้บรรจุสินค้า \> การกำหนดตำแหน่งการเรียงลำดับขาออก**</span><span class="sxs-lookup"><span data-stu-id="6f692-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="6f692-546">หน้า **การกำหนดตำแหน่งการเรียงลำดับขาออก** จะแสดงตำแหน่งการเรียงลำดับทั้งหมดที่ใช้งานอยู่ในปัจจุบัน</span><span class="sxs-lookup"><span data-stu-id="6f692-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="6f692-547">ฟิลด์ **ธุรกรรมตำแหน่งการเรียงลำดับ** จะแสดง LP ที่สัมพันธ์กับแต่ละตำแหน่งการเรียงลำดับแต่ละตำแหน่ง และคอนเทนเนอร์ที่อยู่ในตำแหน่งการเรียงลำดับ</span><span class="sxs-lookup"><span data-stu-id="6f692-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="6f692-548">โปรดสังเกตว่าตำแหน่งการเรียงลำดับหนึ่งตำแหน่งมีอยู่ในขณะนี้ และ FastTab **เกณฑ์ตำแหน่งการเรียงลำดับ** จะแสดงเกณฑ์ของ **การจัดส่ง – บริการผู้ขนส่ง - อากาศ**</span><span class="sxs-lookup"><span data-stu-id="6f692-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="6f692-549">เรียงลำดับคอนเทนเนอร์ที่เหลือ</span><span class="sxs-lookup"><span data-stu-id="6f692-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="6f692-550">บนอุปกรณ์เคลื่อนที่ ให้ลงชื่อเข้าใช้คลังสินค้า *62* โดยใช้รหัสผู้ใช้ที่คุณสร้างไว้สำหรับสถานการณ์จำลองนี้ (หรือรหัสผู้ใช้ของผู้ใช้ข้อมูลสาธิตที่มีอยู่)</span><span class="sxs-lookup"><span data-stu-id="6f692-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="6f692-551">บนเมนูหลัก ให้เลือก **ขาออก**</span><span class="sxs-lookup"><span data-stu-id="6f692-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="6f692-552">บนเมนู **ขาออก** ให้เลือก **การสร้างแท่นวางสินค้า**</span><span class="sxs-lookup"><span data-stu-id="6f692-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="6f692-553">ในฟิลด์ **LP/Con** ให้ป้อนรหัสคอนเทนเนอร์ที่สองที่สัมพันธ์กับใบสั่งขายที่ 1</span><span class="sxs-lookup"><span data-stu-id="6f692-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="6f692-554">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-554">Select **OK**.</span></span> <span data-ttu-id="6f692-555">เนื่องจากมีการตั้งค่าเท็มเพลตการเรียงลำดับเพื่อเรียงลำดับโดยอัตโนมัติ และมีตำแหน่งการเรียงลำดับที่มีเงื่อนไขที่ตรงกันอยู่แล้ว คุณจะถูกส่งไปยังตำแหน่งการเรียงลำดับที่ถูกต้องโดยอัตโนมัติ</span><span class="sxs-lookup"><span data-stu-id="6f692-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="6f692-556">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-556">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-557">ยืนยันรหัสตำแหน่งการเรียงลำดับเพื่อระบุว่าสินค้าคงคลังอยู่ในสถานที่ที่ถูกต้อง</span><span class="sxs-lookup"><span data-stu-id="6f692-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="6f692-558">ในฟิลด์ **รหัสตำแหน่งการเรียงลำดับ** ให้ป้อน *SP01*</span><span class="sxs-lookup"><span data-stu-id="6f692-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="6f692-559">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-559">Select **OK**.</span></span>

    <span data-ttu-id="6f692-560">งานจะเสร็จสมบูรณ์บในคอนเทนเนอร์ที่สองจากใบสั่งขายที่ 1</span><span class="sxs-lookup"><span data-stu-id="6f692-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="6f692-561">ขณะนี้คุณจะเรียงลำดับคอนเทนเนอร์ที่เหลือจากใบสั่งขายที่ 2</span><span class="sxs-lookup"><span data-stu-id="6f692-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="6f692-562">ในฟิลด์ **LP/Con** ให้ป้อนรหัสคอนเทนเนอร์ของคอนเทนเนอร์จากใบสั่งขายที่ 2 ที่มีสินค้า *A0001*</span><span class="sxs-lookup"><span data-stu-id="6f692-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="6f692-563">เนื่องจากบริการของผู้ขนส่งแตกต่างกัน คุณจะได้รับพร้อมท์ให้ป้อนตำแหน่งการเรียงลำดับใหม่และกำหนด LP ให้กับตำแหน่งดังกล่าว</span><span class="sxs-lookup"><span data-stu-id="6f692-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="6f692-564">ใช้ตำแหน่งการเรียงลำดับ *SP02* และ LP *PLP02*</span><span class="sxs-lookup"><span data-stu-id="6f692-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="6f692-565">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-565">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-566">ยืนยันตำแหน่งการเรียงลำดับโดยป้อน *SP02* ในฟิลด์ **รหัสตำแหน่งการเรียงลำดับ**</span><span class="sxs-lookup"><span data-stu-id="6f692-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="6f692-567">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-567">Select **OK**.</span></span>

    <span data-ttu-id="6f692-568">งานเสร็จสมบูรณ์ในคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="6f692-569">ในฟิลด์ **LP/Con** ให้ป้อนรหัสคอนเทนเนอร์สำหรับคอนเทนเนอร์ที่เหลือจากใบสั่งขายที่ 2 ที่มีสินค้า *A0002*</span><span class="sxs-lookup"><span data-stu-id="6f692-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="6f692-570">เนื่องจากบริการของผู้ขนส่งเหมือนกับบริการของผู้ขนส่งสำหรับใบสั่งขายที่ 1 ระบบจะแสดงตำแหน่งการเรียงลำดับที่มีอยู่ที่มีเกณฑ์ที่ตรงกัน</span><span class="sxs-lookup"><span data-stu-id="6f692-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="6f692-571">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-571">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-572">ยืนยันตำแหน่งการเรียงลำดับโดยป้อน *SP01* ในฟิลด์ **รหัสตำแหน่งการเรียงลำดับ**</span><span class="sxs-lookup"><span data-stu-id="6f692-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="6f692-573">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-573">Select **OK**.</span></span>

    <span data-ttu-id="6f692-574">งานเสร็จสมบูรณ์ในคอนเทนเนอร์</span><span class="sxs-lookup"><span data-stu-id="6f692-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="6f692-575">ปิดตำแหน่งการเรียงลำดับขาออก</span><span class="sxs-lookup"><span data-stu-id="6f692-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="6f692-576">เมื่อมีการเรียงลำดับสินค้าคงคลังทั้งหมดแล้ว ต้องปิดตำแหน่งก่อนจึงจะสามารถสร้างงานได้</span><span class="sxs-lookup"><span data-stu-id="6f692-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="6f692-577">งานการเบิกสินค้าคงคลังที่เรียงลำดับจะถูกสร้างขึ้นเพื่อให้มีการจัดเก็บสินค้าคงคลังไปที่พื้นที่ประตู</span><span class="sxs-lookup"><span data-stu-id="6f692-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="6f692-578">ปิดตำแหน่งจากอุปกรณ์เคลื่อนที่</span><span class="sxs-lookup"><span data-stu-id="6f692-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="6f692-579">บนอุปกรณ์เคลื่อนที่ ให้ลงชื่อเข้าใช้คลังสินค้า *62* โดยใช้รหัสผู้ใช้ที่คุณสร้างไว้สำหรับสถานการณ์จำลองนี้ (หรือรหัสผู้ใช้ของผู้ใช้ข้อมูลสาธิตที่มีอยู่)</span><span class="sxs-lookup"><span data-stu-id="6f692-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="6f692-580">บนเมนูหลัก ให้เลือก **ขาออก**</span><span class="sxs-lookup"><span data-stu-id="6f692-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="6f692-581">บนเมนู **ขาออก** ให้เลือก **การสร้างแท่นวางสินค้า**</span><span class="sxs-lookup"><span data-stu-id="6f692-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="6f692-582">ในฟิลด์ **LP/Con** ให้ป้อนรหัสคอนเทนเนอร์ที่มีการเรียงลำดับเพื่อเรียงลำดับตำแหน่ง *SP01*</span><span class="sxs-lookup"><span data-stu-id="6f692-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="6f692-583">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-583">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-584">คุณได้รับข้อความต่อไปนี้: "คอนเทนเนอร์ถูกเรียงลำดับให้กับตำแหน่ง SP01 แล้ว</span><span class="sxs-lookup"><span data-stu-id="6f692-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="6f692-585">ปิดตำแหน่งหรือไม่"</span><span class="sxs-lookup"><span data-stu-id="6f692-585">Close the position?"</span></span> <span data-ttu-id="6f692-586">เลือก **ปิด**</span><span class="sxs-lookup"><span data-stu-id="6f692-586">Select **Close**.</span></span>

    <span data-ttu-id="6f692-587">งานเสร็จสมบูรณ์แล้ว</span><span class="sxs-lookup"><span data-stu-id="6f692-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="6f692-588">ปิดตำแหน่งงานจากการกำหนดตำแหน่งการเรียงลำดับขาออก</span><span class="sxs-lookup"><span data-stu-id="6f692-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="6f692-589">ไปที่ **การจัดการคลังสินค้า \> การบรรจุและการบรรจุลงตู้บรรจุสินค้า \> การกำหนดตำแหน่งการเรียงลำดับขาออก**</span><span class="sxs-lookup"><span data-stu-id="6f692-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="6f692-590">ในคอลัมน์ด้านซ้าย เลือก **SP02**</span><span class="sxs-lookup"><span data-stu-id="6f692-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="6f692-591">แถวตำแหน่งการเรียงลำดับขาออกนี้เป็นแถวที่คุณจะปิด</span><span class="sxs-lookup"><span data-stu-id="6f692-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="6f692-592">บนหน้าต่างการดำเนินการ เลือก **ปิดตำแหน่ง**</span><span class="sxs-lookup"><span data-stu-id="6f692-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="6f692-593">เรกคอร์ดตำแหน่งการเรียงลำดับถูกปิด และไม่มีการแสดงไว้อีกต่อไป</span><span class="sxs-lookup"><span data-stu-id="6f692-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="6f692-594">เมื่อต้องการแสดงเรกคอร์ดตำแหน่งที่ปิดอยู่ทั้งหมด ให้เลือกกล่องกาเครื่องหมาย **แสดงที่ปิด**</span><span class="sxs-lookup"><span data-stu-id="6f692-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="6f692-595">การเบิกสินค้าคงคลังที่จัดเรียง</span><span class="sxs-lookup"><span data-stu-id="6f692-595">Sorted inventory picking</span></span>

<span data-ttu-id="6f692-596">คุณต้องทำงานการเบิกสินค้าคงคลังที่เรียงลำดับให้เสร็จสมบูรณ์</span><span class="sxs-lookup"><span data-stu-id="6f692-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="6f692-597">เมื่อเสร็จสมบูรณ์ ระบบจะเบิกสินค้าคงคลังไปยังใบสั่งขาย</span><span class="sxs-lookup"><span data-stu-id="6f692-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="6f692-598">ณ จุดนั้น กระบวนการคลังสินค้าอื่นๆ ทั้งหมดจะนำไปใช้</span><span class="sxs-lookup"><span data-stu-id="6f692-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="6f692-599">บนอุปกรณ์เคลื่อนที่ ให้ลงชื่อเข้าใช้คลังสินค้า *62* โดยใช้รหัสผู้ใช้ที่คุณสร้างไว้สำหรับสถานการณ์จำลองนี้ (หรือรหัสผู้ใช้ของผู้ใช้ข้อมูลสาธิตที่มีอยู่)</span><span class="sxs-lookup"><span data-stu-id="6f692-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="6f692-600">บนเมนูหลัก ให้เลือก **ขาออก**</span><span class="sxs-lookup"><span data-stu-id="6f692-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="6f692-601">บนเมนู **ขาออก** ให้เลือก **โหลดจากการเรียงลำดับ**</span><span class="sxs-lookup"><span data-stu-id="6f692-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="6f692-602">ป้อนรหัส LP เป้าหมายจากตำแหน่งการเรียงลำดับแรก *SP01*</span><span class="sxs-lookup"><span data-stu-id="6f692-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="6f692-603">ตั้งค่าฟิลด์ **รหัส** เป็น *PLP01*</span><span class="sxs-lookup"><span data-stu-id="6f692-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="6f692-604">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-604">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-605">หน้า **การเบิกสินค้าคงคลังที่เรียงลำดับ: เบิกสินค้า** จะแสดงงานการเบิกสินค้าที่ต้องทำ</span><span class="sxs-lookup"><span data-stu-id="6f692-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="6f692-606">เบิกสินค้าจากสถานที่ *SORT* และเป้าหมาย LP *PLP01* ซึ่งมีสินค้าหลายรายการและปริมาณเท่ากับ *3*</span><span class="sxs-lookup"><span data-stu-id="6f692-606">Pick from the *SORT* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="6f692-607">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-607">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-608">หน้า **การเบิกสินค้าคงคลังที่เรียงลำดับ: ส่งสินค้า** จะแสดงงานการส่งสินค้าที่ต้องทำ</span><span class="sxs-lookup"><span data-stu-id="6f692-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="6f692-609">ส่งสินค้าไปยังสถานที่ *Baydoor* และเป้าหมาย LP *PLP01* ซึ่งมีสินค้าหลายรายการและปริมาณเท่ากับ *3*</span><span class="sxs-lookup"><span data-stu-id="6f692-609">Put to the *Baydoor* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="6f692-610">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-610">Select **OK**.</span></span>

    <span data-ttu-id="6f692-611">งานเสร็จสมบูรณ์แล้ว</span><span class="sxs-lookup"><span data-stu-id="6f692-611">Work is completed.</span></span>

1. <span data-ttu-id="6f692-612">ป้อนรหัสป้ายทะเบียนเป้าหมายจากตำแหน่งการเรียงลำดับที่สอง *SP02*</span><span class="sxs-lookup"><span data-stu-id="6f692-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="6f692-613">ตั้งค่าฟิลด์ **รหัส** เป็น *PLP02*</span><span class="sxs-lookup"><span data-stu-id="6f692-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="6f692-614">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-614">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-615">หน้า **การเบิกสินค้าคงคลังที่เรียงลำดับ: เบิกสินค้า** จะแสดงงานการเบิกสินค้าที่ต้องทำ</span><span class="sxs-lookup"><span data-stu-id="6f692-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="6f692-616">เบิกสินค้าจากสถานที่ *SORT* และเป้าหมาย LP *PLP02* ซึ่งมีสินค้าหลายรายการและปริมาณเท่ากับ *1*</span><span class="sxs-lookup"><span data-stu-id="6f692-616">Pick from the *SORT* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="6f692-617">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-617">Select **OK**.</span></span>
1. <span data-ttu-id="6f692-618">หน้า **การเบิกสินค้าคงคลังที่เรียงลำดับ: ส่งสินค้า** จะแสดงงานการส่งสินค้าที่ต้องทำ</span><span class="sxs-lookup"><span data-stu-id="6f692-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="6f692-619">ส่งสินค้าไปยังสถานที่ *Baydoor* และเป้าหมาย LP *PLP02* ซึ่งมีสินค้าหลายรายการและปริมาณเท่ากับ *1*</span><span class="sxs-lookup"><span data-stu-id="6f692-619">Put to the *Baydoor* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="6f692-620">เลือก **ตกลง**</span><span class="sxs-lookup"><span data-stu-id="6f692-620">Select **OK**.</span></span>

    <span data-ttu-id="6f692-621">งานเสร็จสมบูรณ์แล้ว</span><span class="sxs-lookup"><span data-stu-id="6f692-621">Work is completed.</span></span>

<span data-ttu-id="6f692-622">ตั้งแต่จุดนี้เป็นต้นไป กระบวนการคลังสินค้าอื่นๆ ทั้งหมดจะนำไปใช้</span><span class="sxs-lookup"><span data-stu-id="6f692-622">From this point forward, all other warehouse processes apply.</span></span>
