...
หัวข้อนี้จะอธิบายวิธีตั้งค่าคอนฟิกการข้ามตำแหน่งสำหรับรายการเมนูเพื่อให้ผู้ปฏิบัติงานสามารถ "หยุด" ปฏิบัติงานปัจจุบัน ปฏิบัติงานอื่น แล้วกลับไปที่งานดั้งเดิมโดยไม่สูญเสียข้อมูลใดๆ
...
1. บนหน้าที่ปรากฏขึ้น บนแท็บด่วน **การข้ามตำแหน่งที่ใช้ได้ (รายการเมนู)** คุณสามารถระบุรายการเมนูที่ควรทำหน้าที่เป็นการข้ามตำแหน่ง คุณยังสามารถเลือกว่าค่าฟิลด์ใดจากงานหลักควรถูกคัดลอกไปยังและจากการข้ามตำแหน่งโดยอัตโนมัติ ตัวอย่างที่แสดงวิธีการใช้การตั้งค่าเหล่านี้ โปรดดูสถานการณ์ในภายหลังในหัวข้อนี้
