...
1. เปิดคุณลักษณะต่อไปนี้ ซึ่งจะให้ฟังก์ชันที่อธิบายไว้ในบทความนี้:
    ...
    - *ส่งขั้นตอนการข้ามตำแหน่งอัตโนมัติสำหรับแอป Warehouse Management บนอุปกรณ์เคลื่อนที่*
...
## <a name="sample-scenario-1-sales-picking-where-a-location-inquiry-acts-as-a-detour"></a><a name="scenario-1"></a>สถานการณ์ตัวอย่างที่ 1: การเบิกสินค้าขายที่การสอบถามสถานที่ทำหน้าที่เป็นการข้ามตำแหน่ง
...
1. ในกล่องโต้ตอบ **เลือกฟิลด์ที่จะส่ง** ให้ระบุข้อมูลที่ควรส่งไปและออกจากการข้ามตำแหน่ง ในสถานการณ์นี้ คุณเปิดใช้งานผู้ปฏิบัติงานเพื่อใช้ที่ตั้งที่พนักงานควรเบิกสินค้าเป็นข้อมูลป้อนเข้าสำหรับการข้ามตำแหน่งการสอบถามสถานที่ ดังนั้น ในส่วน **ส่งจากการเบิกสินค้าขาย** ให้เลือก **เพิ่ม** บนแถบเครื่องมือเพื่อเพิ่มแถวลงในกริด จากนั้น ให้กำหนดค่าดังต่อไปนี้สำหรับแถวใหม่:
    ...
    - **ส่งอัตโนมัติ:** *ที่เลือก* (หน้าจะถูกรีเฟรชด้วยค่า *สถานที่* ที่วางแล้ว)
...
1. เนื่องจากการข้ามตำแหน่งในสถานการณ์ดังกล่าวได้รับการตั้งค่าคอนฟิกบนขั้นตอนป้ายทะเบียน ผู้ปฏิบัติงานจึงควรสามารถดึงป้ายทะเบียนจากการสอบถามกลับไปยังโฟลว์หลักได้ ดังนั้น ในส่วน **นำกลับจากการสอบถามสถานที่** ให้เลือก **เพิ่ม** บนแถบเครื่องมือเพื่อเพิ่มแถวลงในกริด จากนั้น ให้กำหนดค่าดังต่อไปนี้สำหรับแถวใหม่:
    ...
    - **ส่งอัตโนมัติ:** *ล้างข้อมูล* (จะไม่มีการอัปเดตอัตโนมัติเมื่อส่งคืนจากการเปลี่ยนแปลงด้วยค่า *ป้ายสิทธิการใช้งาน*)
...
ในขั้นตอนนี้ คุณจะเบิกสินค้าจากการขายให้เสร็จสมบูรณ์โดยใช้แอปการจัดการคลังสินค้าบนมือถือ คุณจะใช้การข้ามตำแหน่งที่คุณเพิ่งตั้งค่าคอนฟิกเพื่อค้นหาป้ายทะเบียนที่คุณจะใช้เพื่อให้ขั้นตอนการเบิกสินค้าเสร็จสมบูรณ์
...
1. ในกล่องโต้ตอบ **เลือกฟิลด์ที่จะส่ง** ให้ระบุข้อมูลที่ควรส่งไปและออกจากการข้ามตำแหน่ง ในสถานการณ์นี้ คุณคาดว่าผู้ปฏิบัติงานจะค้นหาสถานที่ที่มีการควบคุมป้ายทะเบียน ดังนั้น ควรคัดลอกป้ายทะเบียนจากการสอบถามไปยังการข้ามตำแหน่ง **การเคลื่อนย้าย** จึงมีประโยชน์ ในส่วน **ส่งจากการเบิกสินค้าขาย** ให้เลือก **เพิ่ม** บนแถบเครื่องมือเพื่อเพิ่มแถวลงในกริด จากนั้น ให้กำหนดค่าดังต่อไปนี้สำหรับแถวใหม่:
    ...
    - **ส่งอัตโนมัติ:** *ล้างข้อมูล* (ไม่มีการอัปเดตอัตโนมัติเกิดขึ้น)
...
ในขั้นตอนนี้ คุณจะทำการสอบถามสถานที่โดยใช้แอปการจัดการคลังสินค้าบนมือถือ: จากนั้น คุณจะใช้การข้ามตำแหน่งในการเคลื่อนย้ายสินค้าให้เสร็จสมบูรณ์
...
>
> คุณลักษณะ *ขั้นตอนการจัดส่งอัตโนมัติของแอปการจัดการคลังสินค้าบนมือถือ* ช่วยให้ผู้ปฏิบัติงานสามารถตอบสนองขั้นตอนการจัดส่งของสินค้าคงคลังในแอปการจัดการคลังสินค้าบนมือถือได้เร็วขึ้นและง่ายขึ้น ซึ่งช่วยให้สามารถข้ามขั้นตอนบางขั้นตอนได้โดยการแจ้งให้แอปเติมข้อมูลอัตโนมัติบนแบ็คเอนด์ แล้วย้ายโดยอัตโนมัติไปที่ขั้นตอนถัดไปโดยการส่งหน้าโดยอัตโนมัติ ตามที่แสดงใน [*สถานการณ์ตัวอย่าง 1: การเบิกสินค้าจากการขายที่การสอบถามสถานที่จะทำหน้าที่เป็นการข้ามตำแหน่ง*](#scenario-1)
