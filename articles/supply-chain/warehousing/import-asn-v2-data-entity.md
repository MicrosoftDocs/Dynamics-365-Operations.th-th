...
ms.locfileid: "6751708"
---
# <a name="import-inbound-asns-through-the-v2-data-entity"></a>นําเข้า ASN ขาเข้าผ่านเอนทิตีข้อมูล V2
...
## <a name="inbound-asn-v2-entity"></a>เอนทิตี ASN V2 ขาเข้า

คุณนําเข้า ASN ขาเข้าโดยใช้เอนทิตีข้อมูลแบบรวม *ASN V2 ขาเข้า* *ASN V2 ขาเข้า* ใช้ประโยชน์จากเอนทิตีต่อไปนี้
...
เอนทิตีข้อมูลแบบรวม *ASN V2 ขาเข้า* ที่ใช้กับสถานการณ์การรวมแบบอสมวารซึ่งใช้การนําเข้าโดยใช้ไฟล์ XML
