...
เมื่อต้องการใช้คุณลักษณะนี้ คุณต้องมีการตั้งค่ากลุ่มงานบางอย่าง นอกจากนี้ คุณยังอาจตั้งค่าเทมเพลตงานของคุณเพื่อให้กำหนดกลุ่มโดยอัตโนมัติ ถ้าคุณต้องการทำงานผ่านสถานการณ์จำลองตัวอย่างที่ระบุไว้ในภายหลังในหัวข้อนี้ ให้ตั้งค่าระบบของคุณตามที่อธิบายไว้ในหัวข้อนี้
