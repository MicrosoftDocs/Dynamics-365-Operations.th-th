...
| ฟิลด์การรวมบัญชีต่อไปนี้กำหนดชุดของค่าที่ไม่ซ้ำกันที่ใช้ในการรวมบัญชีการจัดส่งสำหรับ *รายการโอนย้าย* (ฟิลด์อื่นทั้งหมดจะถูกละเว้น)<ul><li>หมายเลขใบสั่ง (OrderNum)</li></ul> | ฟิลด์การรวมบัญชีต่อไปนี้กำหนดชุดของค่าที่ไม่ซ้ำกันที่ใช้ในการรวมบัญชีการจัดส่งสำหรับ *รายการโอนย้าย* (ฟิลด์อื่นทั้งหมดจะถูกละเว้น)<ul><li>หมายเลขใบสั่ง (OrderNum)</li><li>ผู้รับการจัดส่ง (DeliveryName)</li><li>ที่อยู่ทางไปรษณีย์ (DeliveryPostalAddress)</li><li>รหัสประเทศ ISO (CountryRegionISOCode)</li><li>ที่อยู่ (ที่อยู่)</li><li>ไซต์ (InventSiteId)</li><li>คลังสินค้า (InventLocationId)</li><li>ผู้ขนส่งสินค้า (CarrierCode)</li><li>บริการขนส่ง (CarrierServiceCode)</li><li>โหมดการจัดส่ง (ModeCode) \*</li><li>กลุ่มผู้ขนส่ง (CarrierGroupCode)</li><li>เงื่อนไขการจัดส่ง (DlvTermId)</li></ul><p>ฟิลด์เหล่านี้เป็นฟิลด์เฉพาะที่พร้อมใช้งานและเริ่มต้นเมื่อมีการสร้างการจัดส่งใหม่</p><p>\* หมายเหตุ: *ModeCode* เป็น **โหมด** ที่กำหนดให้กับ **ผู้ขนส่ง** ที่เลือกสำหรับรายการโอนย้าย (ไม่ใช่ **วิธีการจัดส่ง** ที่เลือกสำหรับรายการโอนย้าย) หากคุณเลือกที่จะรวม *วิธีการจัดส่ง (ModeCode)* ระหว่างเงื่อนไขการรวมบัญชีของคุณ ระบบจะรวมบัญชีเฉพาะรายการโอนย้ายที่ค่า **โหมด** มี **ผู้ขนส่ง**, **บริการผู้ขนส่ง** และ **วิธีการจัดส่ง** มีการกำหนดเหมือนกันทั้งหมดรายการ (ไม่ว่าจะเป็นค่าใด) นอกจากนี้ ระบบจะรวมรายการโอนย้ายทั้งหมดที่มี **โหมด** เป็นว่างเปล่าด้วย</p> |
| ฟิลด์การรวมบัญชีต่อไปนี้กำหนดชุดของค่าที่ไม่ซ้ำกันที่ใช้ในการรวมบัญชีการจัดส่งสำหรับ *รายการขาย* (ฟิลด์อื่นทั้งหมดจะถูกละเว้น)<ul><li>หมายเลขใบสั่ง (OrderNum)</li><li>ข้อมูลอ้างอิงของลูกค้า (CustomerRef)</li><li>การจัดหาวัตถุดิบของลูกค้า (CustomerReq)</li><li>เงื่อนไขการจัดส่ง (DlvTermId)</li></ul> | ฟิลด์การรวมบัญชีต่อไปนี้กำหนดชุดของค่าที่ไม่ซ้ำกันที่ใช้ในการรวมบัญชีการจัดส่งสำหรับ *รายการขาย* (ฟิลด์อื่นทั้งหมดจะถูกละเว้น)<ul><li>หมายเลขใบสั่ง (OrderNum)</li><li>หมายเลขบัญชี (AccountNum)</li><li>ผู้รับการจัดส่ง (DeliveryName)</li><li>ที่อยู่ทางไปรษณีย์ (DeliveryPostalAddress)</li><li>รหัสประเทศ ISO (CountryRegionISOCode)</li><li>ที่อยู่ (ที่อยู่)</li><li>ไซต์ (InventSiteId)</li><li>คลังสินค้า (InventLocationId)</li><li>ผู้ขนส่งสินค้า (CarrierCode)</li><li>บริการขนส่ง (CarrierServiceCode)</li><li>โหมดการจัดส่ง (ModeCode) \*</li><li>กลุ่มผู้ขนส่ง (CarrierGroupCode)</li><li>รหัสนายหน้า (BrokerCode)</li><li>ทิศทาง (LoadDirection)</li><li>เงื่อนไขการจัดส่ง (DlvTermId)</li><li>ข้อมูลอ้างอิงของลูกค้า (CustomerRef)</li><li>การจัดหาวัตถุดิบของลูกค้า (CustomerReq)</li></ul><p>ฟิลด์เหล่านี้เป็นฟิลด์เฉพาะที่พร้อมใช้งานและเริ่มต้นเมื่อมีการสร้างการจัดส่งใหม่</p><p>\* หมายเหตุ: *ModeCode* เป็น **โหมด** ที่กำหนดให้กับ **ผู้ขนส่ง** ที่เลือกสำหรับรายการขาย (ไม่ใช่ **วิธีการจัดส่ง** ที่เลือกสำหรับรายการขาย) หากคุณเลือกที่จะรวม *วิธีการจัดส่ง (ModeCode)* ระหว่างเงื่อนไขการรวมบัญชีของคุณ ระบบจะรวมบัญชีเฉพาะรายการขายที่ค่า **โหมด** มี **ผู้ขนส่ง**, **บริการผู้ขนส่ง** และ **วิธีการจัดส่ง** มีการกำหนดเหมือนกันทั้งหมดรายการ (ไม่ว่าจะเป็นค่าใด) นอกจากนี้ ระบบจะรวมรายการขายทั้งหมดที่มี **โหมด** เป็นว่างเปล่าด้วย</p> |
