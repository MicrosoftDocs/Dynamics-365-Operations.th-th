...
> [!NOTE]
> ลักษณะการทำงานนี้ไม่ได้รับการสนับสนุน สำหรับข้อมูลเพิ่มเติม ให้ดู [คุณลักษณะที่ลบหรือถูกเลิกใช้](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal)
...
ตัวอย่างต่อไปนี้เปิดใช้งาน Internet Explorer 8 ที่จะถูกใช้:
