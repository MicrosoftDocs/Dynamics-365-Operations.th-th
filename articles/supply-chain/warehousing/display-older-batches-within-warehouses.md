...
- <span data-ttu-id="2df3d-110">ทำการเบิกสินค้าจากสถานที่เก็บปัจจุบัน - ถ้าคุณดำเนินการต่อกับสถานที่เก็บรายการงานปัจจุบัน ปริมาณสำหรับรายการงานจะดำเนินการเบิกสินค้าจากสถานที่เก็บเดิมต่อไป</span><span class="sxs-lookup"><span data-stu-id="2df3d-110">Continue picking from the current location - If you continue with the current work line location, the quantities for the work line will continue to be picked from the original location.</span></span>

## <a name="where-it-applies"></a><span data-ttu-id="2df3d-111">ตำแหน่งที่ใช้</span><span class="sxs-lookup"><span data-stu-id="2df3d-111">Where it applies</span></span>
<span data-ttu-id="2df3d-112">แสดงชุดงานที่เก่ากว่าภายในคลังสินค้า ถูกตั้งค่าคอนฟิกบนรายการเมนูของอุปกรณ์เคลื่อนที่ และส่งผลต่อการเลือกชุดงานด้านล่างรายการ</span><span class="sxs-lookup"><span data-stu-id="2df3d-112">Display older batches within warehouse is configured on mobile device menu items and affects the pick for batch below items.</span></span>

## <a name="set-up-display-older-batches-within-warehouse"></a><span data-ttu-id="2df3d-113">ตั้งค่า แสดงผลชุดงานที่เก่ากว่าภายในคลังสินค้า</span><span class="sxs-lookup"><span data-stu-id="2df3d-113">Set up Display older batches within warehouse</span></span>
<span data-ttu-id="2df3d-114">การตั้งค่าคอนฟิก **แสดงชุดงานที่เก่ากว่าภายในคลังสินค้า** จะพร้อมใช้งานบนรายการเมนูอุปกรณ์เคลื่อนที่เมื่อตัวเลือก **เลือกชุดงานที่เก่าที่สุด** ถูกตั้งค่าเป็น **เตือน**</span><span class="sxs-lookup"><span data-stu-id="2df3d-114">The **Display older batches within warehouse** configuration is available on mobile device menu items when the **Pick oldest batch** option is set to **Warn**.</span></span>

- <span data-ttu-id="2df3d-115">ภายใต้ **การบริหารคลังสินค้า** > **การตั้งค่า** > **อุปกรณ์เคลื่อนที่** > **รายการเมนูบนอุปกรณ์เคลื่อนที่** ตั้งค่า **ใช้งานที่มีอยู่** เป็น **ใช่** สำหรับรายการเมนู และเลือก **เตือน** ในฟิลด์ **เลือกชุดงานที่เก่าที่สุด**</span><span class="sxs-lookup"><span data-stu-id="2df3d-115">Under **Warehouse management** > **Setup** > **Mobile device** > **Mobile device menu items**, set **Use existing work** to **Yes** for the menu item, and select **Warn** in the **Pick oldest batch** field.</span></span> 
