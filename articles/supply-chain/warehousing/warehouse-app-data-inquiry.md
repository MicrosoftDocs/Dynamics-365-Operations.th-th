...
1. เปิดใช้งานคุณลักษณะที่แสดงอยู่ในลักษณะต่อไปนี้:
    ...
    คุณลักษณะนี้เป็นข้อกำหนดเบื้องต้นสำหรับคุณลักษณะ *โฟลว์การสอบถามข้อมูลแอปการจัดการคลังสินค้า* สำหรับข้อมูลเพิ่มเติมเกี่ยวกับคุณลักษณะ *คําแนะนําเกี่ยวกับขั้นตอนของแอปคลังสินค้า* โปรดดูที่ [ปรับแต่งชื่อขั้นตอนและคําแนะนําต่างๆ ของแอป Warehouse Management บนมือถือ](mobile-app-titles-instructions.md)
...
1. เปิดใช้งานคุณลักษณะที่แสดงอยู่ในลักษณะต่อไปนี้:
    ...
    คุณลักษณะนี้เป็นข้อกำหนดเบื้องต้นสำหรับคุณลักษณะ *โฟลว์การสอบถามข้อมูลแอปการจัดการคลังสินค้า* สำหรับข้อมูลเพิ่มเติมเกี่ยวกับคุณลักษณะ *การข้ามตำแหน่งของแอปการจัดการคลังสินค้า* ดูที่ [ตั้งค่าคอนฟิกการข้ามตำแหน่งสำหรับขั้นตอนต่างๆ ในรายการเมนูบนมือถือ](warehouse-app-detours.md)
