...
เหตุผลการบล็อคงานใหม่ *การแบ่งงาน* บ่งชี้ว่ารหัสงานกำลังอยู่ระหว่างการแบ่ง ซึ่งแสดงทั้งบนหน้า **แบ่งงาน** และในแอป Warehouse Management บนมือถือถ้าผู้ใช้พยายามทำงาน เมื่อมีการใช้เหตุผลการบล็อค ชื่อของฟิลด์ **เวฟที่ถูกบล็อค** จากรหัสงานจะถูกเปลี่ยนเป็น **บล็อค**
...
## <a name="user-blocking-on-the-warehouse-management-mobile-app"></a>การบล็อกผู้ใช้บนแอป Warehouse Management บนมือถือ

ถ้าคุณพยายามใช้แอป Warehouse Management บนมือถือเพื่อเรียกใช้งานการเบิกสินค้ากับรหัสงานที่กำลังแบ่ง คุณจะได้รับข้อความแสดงข้อผิดพลาดต่อไปนี้: "งานที่มีรหัส \#\#\#\# ถูกแบ่งอยู่ในขณะนี้ ถ้าคุณได้รับข้อความนี้ ให้เลือก **ยกเลิก** คุณสามารถดำเนินการต่อเพื่อดำเนินการงานอื่น
