...
description: หัวข้อนี้อธิบายวิธีการเปิดใช้งานและการใช้จุดยึด
...
ms.locfileid: "8676508"
---
# <a name="anchoring"></a>การกำหนดจุดยึด

[!include [banner](../includes/banner.md)]

หัวข้อนี้แสดงรายละเอียดเกี่ยวกับกระบวนการของจุดยึด ซึ่งอธิบายการตั้งค่าคอนฟิกที่ต้องใช้และตรรกะที่ทำงานเมื่อผู้ปฏิบัติงานคลังสินค้าเปลี่ยนสถานที่การแบ่งระยะหรือสถานที่การโหลด
...
หัวข้อนี้มีสถานการณ์ที่แสดงว่าจุดยึดทำงานอย่างไร ในระหว่างสถานการณ์จำลอง คุณจะสร้างชุดของใบสั่งขายและนำออกใช้ไปยังคลังสินค้า จากนั้นคุณจะแทนที่สถานที่ของการแบ่งระยะที่แนะนำและตรวจสอบว่าการย้ายงานที่เหลือทั้งหมดถูกสั่งการไปยังสถานที่ใหม่
