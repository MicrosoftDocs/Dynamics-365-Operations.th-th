...
description: บทความนี้อธิบายวิธีการจัดการนําเข้าประกาศการจัดส่งสินค้าขั้นสูงขาเข้า (ASN) โดยผ่านเอนทิตีข้อมูล ASN ขาเข้า
...
บทความนี้จะแสดงถึงชุดของสถานการณ์จำลองที่แสดง โดยผ่านตัวอย่าง วิธีการทำงานกับไฟล์ ASN

> [!IMPORTANT]
> การนําเข้า *ASN ขาเข้า* จะใช้กับสินค้าที่เปิดใช้งานเฉพาะกับกระบวนการจัดการคลังสินค้า (WMS) เท่านั้น ก่อนที่คุณจะได้รับ ASN ต้องมีการลงทะเบียนใบสั่งซื้อในระบบกับผู้จัดจำหน่ายที่ส่ง ASN นั้นไป
