...
description: บทความนี้จะอธิบายวิธีการตั้งค่ากฎต้นทุนสำหรับระดับการเดินทางขาเข้าต่างๆ โดยยึดตามกฎเหล่านี้ ระบบจะคํานวณต้นทุนและเพิ่มโดยอัตโนมัติ ดังนั้น ผู้ใช้จึงไม่ต้องเพิ่มต้นทุนด้วยตนเอง
author: Weijiesa
ms.date: 01/21/2021
ms.topic: article
ms.prod: ''
