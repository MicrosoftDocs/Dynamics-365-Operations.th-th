---
title: เอนทิตี้ใบแจ้งหนี้ของผู้จัดจำหน่าย
description: บทความนี้มีข้อมูลเกี่ยวกับเอนทิตี้ใบแจ้งหนี้ของผู้จัดจำหน่าย ซึ่งเปิดใช้งานรหัสชนิดต้นทุนที่จะตั้งค่าคอนฟิกให้กับต้นทุนภายในหรือต้นทุนที่ได้รับจากภายนอก
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
