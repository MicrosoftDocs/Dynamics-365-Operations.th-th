---
title: เอนทิตี้การสร้างการเดินทาง
description: บทความนี้มีข้อมูลเกี่ยวกับเอนทิตีข้อมูลการสร้างการเดินทาง ซึ่งจัดกลุ่มเอนทิตีข้อมูลที่ต้องใช้ในการสร้างการเดินทางในการทำงาน
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
