...
- **การวางแผนหลักระหว่างบริษัท** - แผนหลักระหว่างบริษัทจะคำนวณความต้องการสุทธิระหว่างนิติบุคคล ซึ่งเชื่อมต่อความต้องการและการจัดหาวัสดุระหว่างบริษัท ไม่ใช่เพียงความต้องการและการจัดหาวัสดุของบริษัทในระยะสั้น แต่ยังสำหรับความต้องการและการจัดหาวัสดุที่มีการวางแผนระยะยาวอีกด้วย (ซึ่งยังไม่ได้รับการยืนยัน) สำหรับข้อมูลเพิ่มเติม ดู [การวางแผนระหว่างบริษัท](planning-optimization/Intercompany-planning.md)

บริษัทสามารถเปลี่ยนผลลัพธ์ของแผนได้ พวกเขาสามารถเรียกใช้รายการที่เกิดขึ้นใหม่ การเปลี่ยนแปลงสุทธิ หรือทั้งสองอย่าง แผนที่เกิดขึ้นใหม่ปรับปรุงความต้องการทั้งหมด ในขณะที่ แผนการเปลี่ยนแปลงสุทธิอัปเดตเฉพาะแผนสินค้าด้วยความต้องการใหม่ที่เข้ามา นับตั้งแต่ครั้งล่าสุดที่รันการจัดกำหนดการ
...
คุณสามารถค้นหาความคิดเห็น ข่าว และข้อมูลอื่นเกี่ยวกับการวางแผนหลักและโซลูชันอื่นใน [บล็อกทีม R&D การผลิตของ Dynamics AX](/archive/blogs/axmfg/) และ [การจัดการห่วงโซ่อุปทานในบล็อกทีม R&D ของ Dynamics AX](https://blogs.msdn.microsoft.com/dynamicsaxscm)
