...
description: บทความนี้อธิบายงานการตั้งค่าที่คุณต้องดำเนินการเพื่อจัดเตรียมสำหรับการคาดการณ์ความต้องการ
author: t-benebo
ms.date: 11/23/2021
ms.topic: article
...
ms.locfileid: "8960191"
---
# <a name="demand-forecasting-setup"></a>การตั้งค่าการคาดการณ์ความต้องการ

[!include [banner](../includes/banner.md)]

บทความนี้จะอธิบายวิธีการตั้งค่าการคาดการณ์ความต้องการ  
...
1. ทำตามวิซาร์ดให้เสร็จสมบูรณ์โดยปฏิบัติตามคําแนะนําบนหน้าจอ โปรดคำนึงถึงประเด็นต่อไปนี้เมื่อคุณทำงาน
    ...
    - ตรวจสอบให้แน่ใจว่าได้เลือกภูมิภาคทางภูมิศาสตร์ที่ตรงกับภูมิภาคที่ปรับใช้อินสแตนซ์ของ Supply Chain Management ของคุณ ไม่เช่นนั้น ข้อมูลบางอย่างของคุณอาจส่งข้ามผ่านเขตแดนภูมิภาค สำหรับข้อมูลเพิ่มเติม โปรดดูที่ส่วน [ประกาศความเป็นส่วนตัว](#privacy) ในภายหลังในบทความนี้
