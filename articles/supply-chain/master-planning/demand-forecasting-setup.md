...
- **ค่าสูงสุดที่คาดการณ์**: ระบุค่าสูงสุดที่จะใช้สำหรับการคาดการณ์ รูปแบบ: +1E[n] หรือค่าคงที่แบบตัวเลข
- **ค่าต่ำสุดที่คาดการณ์**: ระบุค่าต่ำสุดที่จะใช้สำหรับการคาดการณ์ รูปแบบ: -1E[n] หรือค่าคงที่แบบตัวเลข
