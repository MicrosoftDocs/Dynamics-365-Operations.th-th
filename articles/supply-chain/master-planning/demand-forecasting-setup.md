...
เมื่อต้องการตั้งค่าพารามิเตอร์การคาดการณ์ความต้องการ ให้ไปที่ **การวางแผนหลัก \> การตั้งค่า \> \> การคาดการณ์ความต้องการ \> พารามิเตอร์การคาดการณ์ความต้องการ** เนื่องจากการคาดการณ์ความต้องการดำเนินงานระหว่างบริษัท การตั้งค่าเป็นแบบสากล ซึ่งหมายความว่าการตั้งค่าใช้กับบริษัททั้งหมด

การคาดการณ์ความต้องสร้างการคาดการณ์ในปริมาณ ดังนั้นจึงต้องมีการระบุหน่วยวัดที่ควรมีการแสดงปริมาณในฟิลด์ **หน่วยการคาดการณ์ความต้องการ** หน่วยวัดต้องไม่ซ้ำกัน เพื่อช่วยทำให้มั่นใจว่าการรวมและการกระจายเปอร์เซ็นต์นั้นเหมาะสม สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการรวมและการกระจายเปอร์เซ็นต์ ให้ดู [ทำการปรับปรุงด้วยตนเองไปยังการคาดการณ์พื้นฐาน](manual-adjustments-baseline-forecast.md) สำหรับทุกหน่วยการวัดที่ใช้สำหรับ SKUs ที่รวมอยู่ในการคาดการณ์ความต้องการ ตรวจสอบให้แน่ใจว่ามีกฎการแปลงสำหรับหน่วยวัดและหน่วยวัดการคาดการณ์ทั่วไป เมื่อมีการดำเนินการสร้างการคาดการณ์ รายการสินค้าที่ไม่มีการแปลงหน่วยวัดจะถูกบันทึก เพื่อให้คุณสามารถแก้ไขการตั้งค่าได้โดยง่าย
...
โดยการเลือก **มิติการคาดการณ์** ในบานหน้าต่างด้านซ้ายของหน้า **พารามิเตอร์การคาดการณ์ความต้องการ** คุณยังสามารถเลือกชุดของมิติการคาดการณ์ที่จะใช้เมื่อมีการสร้างการคาดการณ์ความต้องการได้ มิติการคาดการณ์บ่งชี้ระดับของรายละเอียดที่กำหนดไว้สำหรับการคาดการณ์ บริษัท ไซต์ และคีย์การปันส่วนสินค้าเป็นมิติการคาดการณ์ที่จำเป็น แต่คุณยังสามารถสร้างการคาดการณ์ที่คลังสินค้า สถานะสินค้าคงคลัง กลุ่มลูกค้า บัญชีลูกค้า ประเทศ/ภูมิภาค รัฐ และระดับมิติสินค้าบวกสินค้าทั้งหมด
...
หากต้องการดูพารามิเตอร์ที่สามารถตั้งค่าคอนฟิก สำหรับบริการการคาดการณ์ความต้องการ ให้ไปที่ **การวางแผนหลัก \> การตั้งค่า \> การคาดการณ์ความต้องการ \> พารามิเตอร์อัลกอริทึมการคาดการณ์** หน้า **พารามิเตอร์ค่าเริ่มต้นของอัลกอริทึมการคาดการณ์** แสดงค่าเริ่มต้นสำหรับพารามิเตอร์ คุณสามารถบันทึกทับพารามิเตอร์เหล่านี้โดยไปที่ **การวางแผนหลัก \> การตั้งค่า \> การคาดการณ์ความต้องการ \> พารามิเตอร์การคาดการณ์ความต้องการ** ซึ่งคุณสามารถดำเนินการต่อไปนี้:

- ใช้แท็บ **ทั่วไป** เพื่อบันทึกทับพารามิเตอร์แบบสากล
- ใช้แท็บ **คีย์การปันส่วนสินค้า** เพื่อบันทึกทับพารามิเตอร์ต่อคีย์การปันส่วนสินค้า พารามิเตอร์ที่จะถูกบันทึกทับสำหรับคีย์การปันส่วนสินค้ามีผลเฉพาะกับการคาดการณ์ของสินค้าที่เกี่ยวข้องกับคีย์การปันส่วนสินค้านั้น

### <a name="forecast-algorithm-parameters"></a>พารามิเตอร์อัลกอริทึมการคาดการณ์

บนแท็บ **คีย์การปันส่วนสินค้า** ของหน้า **พารามิเตอร์การคาดการณ์ความต้องการ** คุณสามารถใช้แท็บด่วน **พารามิเตอร์อัลกอริทึมการคาดการณ์** เพื่อกําหนดพารามิเตอร์อัลกอริทึมการคาดการณ์ให้กับคีย์การปันส่วนสินค้าที่เลือกในปัจจุบันในกริดทางด้านซ้าย ใช้ปุ่ม **เพิ่ม** และ **ลบ** บนแถบเครื่องมือเพื่อสร้างชุดพารามิเตอร์ที่กําหนด สำหรับแต่ละพารามิเตอร์ในรายการ เลือกค่าใดค่าหนึ่งดังต่อไปนี้ในฟิลด์ **ชื่อ** แล้วป้อนค่าที่ถูกต้องในฟิลด์ **ค่า**:
...
- **ขอบเขตการแทนที่ค่าที่ขาดหายไป** – ระบุว่าให้แทนที่ค่าที่หายไปโดยใช้ส่วนประกอบของช่วงวันที่ของแต่ละแอททริบิวต์หรือใช้ชุดข้อมูลทั้งหมด มีตัวเลือกดังต่อไปนี้เพื่อสร้างช่วงวันที่ที่ระบบจะใช้เมื่อกรอกข้อมูลช่องว่างในข้อมูลในอดีต:
  ...
  - สากล – ระบบใช้ช่วงวันที่แบบเต็มของแอททริบิวต์ความละเอียดทั้งหมด
  - HISTORY_DATE_RANGE – ระบบใช้ช่วงวันที่เฉพาะที่กําหนดโดยฟิลด์ **วันที่เริ่มต้น** และ **วันที่สิ้นสุด** บนกลุ่มฟิลด์ **ระดับในอดีต** ในกล่องโต้ตอบ **สร้างการคาดการณ์พื้นฐานทางสถิติ**
