...
description: บทความนี้จะอธิบายถึงวิธีการรวมการคาดการณ์ความต้องการในระหว่างการวางแผนหลักที่มีการเพิ่มประสิทธิภาพการวางแผน
author: t-benebo
ms.date: 12/02/2020
ms.topic: article
ms.prod: ''
...
1. บน FastTab **ทั่วไป** ตั้งค่าฟิลด์ต่อไปนี้:
    ...
    - **วิธีการที่ใช้ในการลดความต้องการในการคาดการณ์** – เลือกวิธีการที่ควรใช้ในการลดความต้องการในการคาดการณ์ สำหรับข้อมูลเพิ่มเติม ให้ดูส่วน [เงื่อนไขสำคัญของการลดการคาดการณ์](#reduction-keys) ในบทความนี้ในภายหลัง
...
1. บน FastTab **อื่นๆ** ตั้งค่าฟิลด์ต่อไปนี้:
    ...
    - **เงื่อนไขสำคัญของการลด** – เลือกเงื่อนไขสำคัญของการลดที่จะใช้ สำหรับข้อมูลเพิ่มเติม ให้ดูที่ส่วน [สร้างและตั้งค่าเงื่อนไขสำคัญของการลดการคาดการณ์](#create-reduction-key) และ [ใช้เงื่อนไขสำคัญของการลด](#use-reduction-key) ในภายหลังในบทความนี้
