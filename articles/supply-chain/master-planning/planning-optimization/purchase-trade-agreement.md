...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ***US001*** | ***1*** | จำนวน | จำนวน | US003 | 3 | จำนวน | **US001** | **1** |
| US001 | 1 | ***ใช่: US002*** | ***ใช่: 2*** | US003 | 3 | จำนวน | **US002** | **2** |
| *(ว่างเปล่า)* | 1 | จำนวน | จำนวน | ***US003*** | ***3*** | จำนวน | **US003** | **3** |
| *(ว่างเปล่า)* | ***1*** | จำนวน | จำนวน | ***US003*** | 3 | ใช่ | **US003** | **1** |
| *(ว่างเปล่า)* | ***1*** | ***ใช่: US002*** | จำนวน | US003 | 3 | จำนวน | **US002** | **1** |
| *(ว่างเปล่า)* | ***1*** | ***ใช่: US002*** | จำนวน | US003 | 3 | จำนวน | **US002** | **1** |
| *(ว่างเปล่า)* | 1 | จำนวน | ใช่: 2 | ***US003*** | ***3*** | จำนวน | **US003** | **3** |
| *(ว่างเปล่า)* | 1 | จำนวน | ***ใช่: 2*** | ***US003*** | 3 | ใช่ | **US003** | **2** |
