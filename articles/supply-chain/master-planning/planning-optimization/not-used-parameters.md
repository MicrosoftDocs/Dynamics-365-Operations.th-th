...
description: บทความนี้แสดงรายการพารามิเตอร์ที่การเพิ่มประสิทธิภาพการวางแผนไม่ได้พิจารณาในขณะนี้ในระหว่างการดําเนินงาน
author: t-benebo
ms.date: 09/02/2021
ms.topic: article
...
ms.locfileid: "9542305"
---
# <a name="parameters-not-used-by-planning-optimization"></a>พารามิเตอร์ที่ไม่ได้ใช้โดยการเพิ่มประสิทธิภาพการวางแผน

[!include [banner](../../includes/banner.md)]

บทความนี้แสดงรายการพารามิเตอร์ที่การเพิ่มประสิทธิภาพการวางแผนไม่ได้พิจารณาในขณะนี้ในระหว่างการดําเนินงาน บริการวางแผนอาจข้ามพารามิเตอร์ เนื่องจาก ตัวอย่างเช่น ฟังก์ชันที่เกี่ยวข้องยังไม่ได้รับการสนับสนุน หรือพารามิเตอร์อาจล้าสมัย เนื่องจากการเปลี่ยนแปลงฟังก์ชัน
...
- แท็บ **ทั่วไป**:
  ...
  - **คัดลอกแผนหลักแบบคงที่ที่เสร็จสมบูรณ์และที่อัปเดตแล้วไปที่แผนหลักแบบไดนามิก** – การสนับสนุน *คัดลอกแผนแบบคงที่ไปยังแบบไดนามิก* ที่ค้างอยู่
...
- FastTab **ทั่วไป** :
  ...
  - **จำนวนวันค่าบวก** – ค่า *จำนวนวันค่าบวก* ไม่มีการใช้ ด้วยการเพิ่มประสิทธิภาพการวางแผน จะถือว่าจำนวนวันค่าบวกไม่มีสิ้นสุด
...
- FastTab **ความล่าช้าที่คํานวณได้**:
  ...
  - **ตรวจสอบให้แน่ใจว่าไม่ได้สร้างแผนการใบสั่งก่อนวันที่เรียกใช้การวางแผนหลัก** – การสนับสนุน *ความล่าช้าที่คํานวณได้* ที่ค้างอยู่
...
- แท็บด่วน **ข้อความการดำเนินการ**:

  - **อัปเดตวันที่เลื่อนออกไปเป็นวันที่ต้องการ** - พารามิเตอร์นี้ถูกยกเลิกด้วยการเพิ่มประสิทธิภาพการวางแผน
