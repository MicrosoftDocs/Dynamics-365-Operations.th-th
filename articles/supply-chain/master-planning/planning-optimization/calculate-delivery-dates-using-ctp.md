...
description: ฟังก์ชัน Capable-to-promise (CTP) ช่วยให้คุณสามารถให้วันที่ตามจริงแก่ลูกค้าเมื่อคุณสามารถสัญญาสินค้าเฉพาะได้ บทความนี้จะอธิบายวิธีการตั้งค่าและใช้ CTP กับกลไกจัดการการวางแผนแต่ละกลไกจัดการ (ประสิทธิภาพการวางแผนและกลไกจัดการในตัว)
author: t-benebo
ms.date: 07/20/2022
ms.topic: article
...
CTP จะทำงานในลักษณะต่างกันเล็กน้อย ขึ้นกับกลไกจัดการการวางแผนหลักที่คุณใช้ (ประสิทธิภาพการวางแผนและกลไกจัดการในตัว) บทความนี้จะอธิบายวิธีการตั้งค่าสำหรับแต่ละกลไกจัดการ ปัจจุบัน CTP เพื่อเพิ่มประสิทธิภาพการวางแผนสนับสนุนเฉพาะชุดย่อยของสถานการณ์สมทบ CTP ที่สนับสนุนโดยกลไกจัดการในตัว

## <a name="turn-on-ctp-for-planning-optimization"></a>เปิด CTP สำหรับการเพิ่มประสิทธิภาพการวางแผน

CTP สำหรับกลไกจัดการการวางแผนหลักในตัวพร้อมใช้งานเสมอ อย่างไรก็ตาม ถ้าคุณต้องการใช้ CTP สำหรับการเพิ่มประสิทธิภาพการวางแผน ต้องเปิด CTP เพื่อระบบของคุณ ผู้ดูแลระบบสามารถใช้การตั้งค่า [การจัดการคุณลักษณะ](../../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) เพื่อตรวจสอบสถานะของคุณลักษณะและเปิดใช้งาน ในพื้นที่ทำงาน **การจัดการคุณลักษณะ** มีการแสดงรายการคุณลักษณะในวิธีต่อไปนี้:
...
ตารางต่อไปนี้สรุปผลต่างระหว่าง CTP สำหรับการเพิ่มประสิทธิภาพการวางแผนและ CTP สำหรับกลไกจัดการการวางแผนหลักในตัว

| องค์ประกอบ | การเพิ่มประสิทธิภาพการวางแผน | กลไกจัดการการวางแผนหลักในตัว |
|---|---|---|
...
1. บนแท็บ **การจัดส่ง** บนแท็บด่วน **ตัวควบคุม Delivery** ในฟิลด์ **ตัวควบคุม Delivery date** ให้เลือกวิธีการที่คุณต้องการใช้เป็นวิธีการเริ่มต้นของบริษัทของคุณ
    ...
    - *CTP* – ใช้การคํานวณ CTP ที่ให้มาโดยกลไกจัดการการวางแผนหลักในตัว ถ้าคุณใช้การเพิ่มประสิทธิภาพการวางแผนวิธีการควบคุมวันที่จัดส่งของ *CTP* จะไม่ได้รับอนุญาต และถ้ามีการเลือกไว้ จะทําให้เกิดข้อผิดพลาดเมื่อรันการคํานวณ
    - *CTP สำหรับการเพิ่มประสิทธิภาพการวางแผน* – ใช้การคํานวณ CTP ที่ให้มาโดยการเพิ่มประสิทธิภาพการวางแผน ตัวเลือกนี้จะไม่มีผลถ้าคุณใช้งานกลไกจัดการการวางแผนหลักในตัว
...
เมื่อคุณใช้ CTP สำหรับการเพิ่มประสิทธิภาพการวางแผน คุณต้องรันแผนแบบไดนามิกเพื่อทริกเกอร์ระบบเพื่อคํานวณ CTP แล้วตั้งค่าวันที่จัดส่งและวันที่รับสินค้าที่ยืนยันแล้วของใบสั่งที่เกี่ยวข้องทั้งหมด แผนต้องมีสินค้าทั้งหมดที่ต้องใช้วันที่จัดส่งและวันที่รับสินค้าที่ยืนยัน (เมื่อคุณใช้ CTP สำหรับกลไกจัดการการวางแผนในตัว การคํานวณ CTP จะเกิดขึ้นทันทีเฉพาะที่ ดังนั้น คุณจึงไม่ต้องรันแผนแบบไดนามิกเพื่อดูผลลัพธ์ CTP)
...
## <a name="use-ctp-for-built-in-master-planning"></a>ใช้ CTP สำหรับการวางแผนหลักในตัว

### <a name="create-a-new-order-by-using-ctp-for-built-in-master-planning"></a>สร้างใบสั่งใหม่โดยใช้ CTP เพื่อการวางแผนหลักในตัว
...
### <a name="view-confirmed-delivery-dates-when-you-use-ctp-for-built-in-master-planning"></a>ดูวันที่จัดส่งที่ยืนยันเมื่อคุณใช้ CTP เพื่อการวางแผนหลักในตัว

ถ้าคุณใช้กลไกจัดการการวางแผนหลักในตัว การคํานวณ CTP จะถูกใช้กับใบสั่งและ/หรือรายการใบสั่งที่มีการตั้งค่าฟิลด์ **ตัวควบคุม Delivery date** เป็น *CTP*

สำหรับรายการขายที่ใช้ CTP สำหรับการวางแผนหลักในตัว ระบบจะตั้งค่าฟิลด์ **วันที่จัดส่งที่ยืนยัน** และ **วันที่ยืนยันการรับสินค้า** ทุกครั้งที่คุณบันทึกรายการขายโดยอัตโนมัติ ถ้าหลังจากนั้น คุณมีการเปลี่ยนแปลงที่เกี่ยวข้องกับบรรทัดการขาย (ตัวอย่างเช่น ด้วยการเปลี่ยนปริมาณหรือไซต์) วันที่จะถูกคำนวณใหม่ทันที
...
1. บนแท็บด่วน **การจัดส่ง** ให้ตั้งค่าฟิลด์ **ตัวควบคุม Delivery date** เป็นค่าใดค่าหนึ่งต่อไปนี้ ทั้งนี้ขึ้นอยู่กับกลไกจัดการการวางแผนที่คุณใช้งาน
    ...
    - *CTP* – ใช้การคํานวณ CTP ที่ให้มาโดยกลไกจัดการการวางแผนหลักในตัว ถ้าคุณใช้การเพิ่มประสิทธิภาพการวางแผน ไม่อนุญาตให้ใช้วิธีการควบคุมวันที่จัดส่งของ *CTP* ดังนั้นถ้าคุณเลือกค่านี้ ข้อผิดพลาดจะเกิดขึ้นเมื่อการคํานวณรัน
    - *CTP สำหรับการเพิ่มประสิทธิภาพการวางแผน* – ใช้การคํานวณ CTP ที่ให้มาโดยการเพิ่มประสิทธิภาพการวางแผน การตั้งค่านี้จะไม่มีผลถ้าคุณใช้งานกลไกจัดการการวางแผนหลักในตัว
