...
เมื่อคุณทำงานกับความล่าช้าในการตั้งค่าการผลิตที่มีระดับ BOM หลายระดับ จำเป็นต้องทราบว่ามีเฉพาะสินค้าที่อยู่เหนือรายการโดยตรง (ในโครงสร้าง BOM) ซึ่งก่อให้เกิดการล่าช้าจะได้รับการอัปเดตด้วยความล่าช้าโดยเป็นส่วนหนึ่งของการรันการวางแผนหลัก สินค้าอื่นๆ ในโครงสร้าง BOM จะไม่มีการหน่วงเวลาจนกว่าจะมีการรันการวางแผนหลักครั้งแรก เมื่อใบสั่งที่วางแผนไว้สำหรับระดับสูงสุดได้รับการอนุมัติหรือยืนยันแล้ว 

เมื่อต้องการแก้ไขข้อจำกัดที่รู้จักนี้ ใบสั่งผลิตที่อยู่ด้านบนของโครงสร้าง BOM ที่มีความล่าช้าอาจได้รับการอนุมัติ (หรือยืนยัน) ก่อนที่จะรันการวางแผนหลักถัดไป เมื่อเป็นเช่นนี้ความล่าช้าจากใบสั่งผลิตที่วางแผนไว้และได้รับการอนุมัติล่าช้าจะถูกเก็บไว้ และจะมีการอัปเดตส่วนประกอบพื้นฐานทั้งหมดตามลำดับ
