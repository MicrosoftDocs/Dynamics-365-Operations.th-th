...
เมื่อต้องการติดตั้งการบัญชีสินค้าคงคลังส่วนกลางสำหรับ Supply Chain Management รุ่น10.0.19 เป็น 10.0.26 ให้เริ่มต้นโดย [การติดตั้ง Add-in](#install) จากนั้นส่งรหัสสภาพแวดล้อมและชื่อบริษัท LCS ของคุณทางอีเมลไปยัง [ทีมงานการบัญชีสินค้าคงคลังส่วนกลาง](mailto:GlobalInvAccount@microsoft.com) ทีมงานจะส่งอีเมลติดตามผลที่มีคีย์รุ่นเบต้าของการบัญชีสินค้าคงคลังมาตรฐานของคุณ

### <a name="supply-chain-management-version-10027-and-later"></a>Supply Chain Management รุ่น 10.0.27 และที่ใหม่กว่า

เมื่อต้องการติดตั้งการบัญชีสินค้าคงคลังส่วนกลางสำหรับ Supply Chain Management รุ่น10.0.27 และที่ใหม่กว่า ให้ [ติดตั้ง Add-in](#install) สำหรับรุ่นเหล่านี้ของ Supply Chain Management ปลายทางของบริการบัญชีสินค้าคงคลังส่วนกลางจะได้รับการตั้งค่าโดยอัตโนมัติ เพื่อที่คุณไม่ต้องค้นหาด้วยตนเอง หากคุณพบปัญหาใดๆ ขณะตั้งค่า Add-in โปรดติดต่อ [ทีมงานการบัญชีสินค้าคงคลังส่วนกลาง](mailto:GlobalInvAccount@microsoft.com)
...
## <a name="install-or-update-the-add-in-and-solution"></a><a name="install"></a>ติดตั้งหรืออัปเดต Add-in และโซลูชัน

ใช้ขั้นตอนต่อไปนี้เพื่อติดตั้งหรืออัปเดต Add-in และโซลูชันการบัญชีสินค้าคงคลังส่วนกลาง ส่วนของขั้นตอนที่คุณควรปฏิบัติตามจะขึ้นอยู่กับว่าคุณอยู่ในการติดตั้งเป็นครั้งแรก หรือเพียงแต่ต้องอัปเดตโซลูชันการติดตั้งที่มีอยู่

- ถ้าคุณไม่เคยติดตั้ง Add-in มาก่อน ให้ปฏิบัติตามขั้นตอนทั้งหมดเพื่อติดตั้งทั้ง Add-in และโซลูชัน
- ถ้าคุณใช้การบัญชีสินค้าคงคลังส่วนกลางอยู่แล้ว แต่ต้องอัปเดตโซลูชันใน [ศูนย์การจัดการ Power Platform](https://admin.powerplatform.microsoft.com) ให้ปฏิบัติตามขั้นตอนที่ 6 เท่านั้น และข้ามขั้นตอนอื่นๆ ทั้งหมด

เพื่อติดตั้งหรืออัปเดต Add-in และโซลูชัน:
...
1. ในกล่องโต้ตอบ **การตั้งค่าสภาพแวดล้อม Power Platform** ให้เลือกกล่องกาเครื่องหมาย แล้วเลือก **การตั้งค่า** โดยทั่วไป การตั้งค่าจะจะใช้เวลาระหว่าง 60 และ 90 นาที
1. หลังจากการตั้งค่าสภาพแวดล้อม Microsoft Power Platform เสร็จสมบูรณ์ ให้ลงชื่อเข้าใช้ [ศูนย์จัดการ Power Platform](https://admin.powerplatform.microsoft.com) ติดตั้งหรืออัปเดตโซลูชันของการบัญชีสินค้าคงคลังส่วนกลางโดยปฏิบัติตามขั้นตอนต่อไปนี้:
   1. เลือกสภาพแวดล้อมที่คุณต้องการติดตั้งหรืออัปเดตโซลูชัน
   1. เลือก **แอป Dynamics 365**
   1. เลือก **ติดตั้งแอป**
   1. เลือก **การบัญชีสินค้าคงคลังมาตรฐาน Dynamics 365**
   1. เลือก **ถัดไป** เพื่อติดตั้ง
1. หลังจากติดตั้งโซลูชันอย่างสมบูรณ์แล้ว ให้กลับไปยังสภาพแวดล้อม LCS บนแท็บด่วน **add-in ของสภาพแวดล้อม** ให้เลือก **ติดตั้ง add-in ใหม่**
...
1. โดยขึ้นอยู่กับรุ่นของ Supply Chain Management ที่คุณกำลังใช้ ให้ทำขั้นตอนใดขั้นตอนหนึ่งต่อไปนี้:
    - **Supply Chain Management รุ่น 10.0.19 เป็น 10.0.26**: ในฟิลด์ **ปลายทางของบริการข้อมูล** และ **ปลายทางการบัญชีสินค้าคงคลังส่วนกลาง** ให้ป้อน URL ที่ส่งถึงคุณทางอีเมลจากทีมงานการบัญชีสินค้าคงคลังส่วนกลาง (ให้ดูเพิ่มเติมที่ [วิธีการรับ Add-in การบัญชีสินค้าคงคลังส่วนกลาง](#sign-up))
