...
| **หมายเหตุ**                                                                                                                                                                                                                                                                                                                                                                     |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| กลไกจัดการการจัดการขนส่งที่จัดส่งกับ Supply Chain Management ขึ้นอยู่กับข้อมูลที่ดึงมาจากแอปพลิเคชัน กลไกจัดการที่เชื่อมต่อกับระบบภายนอกไม่ได้รวมอยู่กับ Operations อย่างไรก็ตาม ตามรูปแบบความสามารถในการเพิ่มฟังก์ชันของกลไกจัดการช่วยให้คุณสามารถสร้างส่วนขยายโดยใช้ Visual Studio Tools |
