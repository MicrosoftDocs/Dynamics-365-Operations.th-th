...
1. ในพื้นที่ทำงาน **การจัดการคุณลักษณะ** โปรดตรวจสอบให้แน่ใจว่าคุณลักษณะ *การใช้หน่วยวัดและปริมาณหน่วยในสมุดรายวันสินค้าคงคลัง* เปิดอยู่ ลักษณะการเช่นนี้จะเพิ่มฟิลด์ **หน่วย** และ **ปริมาณหน่วย** ลงในสมุดรายวัน (เริ่มจาก Supply Chain Management เวอร์ชัน 10.0.21 คุณลักษณะนี้จะเปิดตามค่าเริ่มต้น)
