...
description: บทความนี้อธิบายเท็มเพลตและงานพื้นฐานที่ใช้ในการซิงโครไนส์ส่วนหัวและรายการของใบเสนอราคาขายโดยตรงจาก Dynamics 365 Supply Chain Management ไปยัง Dynamics 365 Sales
author: Henrikan
ms.date: 10/26/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9103289"
---
# <a name="synchronize-sales-invoice-headers-and-lines-directly-from-finance-and-operations-to-sales"></a>ซิงโครไนส์ส่วนหัวและรายการของใบแจ้งหนี้การขายโดยตรงจากการเงินและการดำเนินงานไปยัง Sales

[!include [banner](../includes/banner.md)]

บทความนี้อธิบายเท็มเพลตและงานพื้นฐานที่ใช้ในการซิงโครไนส์ส่วนหัวและรายการของใบเสนอราคาขายโดยตรงจาก Dynamics 365 Supply Chain Management ไปยัง Dynamics 365 Sales
...
![การแม็ปแม่แบบในการรวมข้อมูลของ SalesInvoiceHeader](./media/sales-invoice-direct-template-mapping-data-integrator-1.png)

### <a name="salesinvoiceline"></a>SalesInvoiceLine

![การแม็ปแม่แบบในการรวมข้อมูลของ SalesInvoiceLine](./media/sales-invoice-direct-template-mapping-data-integrator-2.png)
