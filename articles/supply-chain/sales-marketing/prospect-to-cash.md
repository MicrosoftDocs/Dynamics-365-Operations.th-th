...
สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการรวมผู้ที่มีแนวโน้มจะเป็นลูกค้าเป็นเงินสด ให้ดูวิดีโอ YouTube แบบย่อ:
...
2. ต้องแน่ใจว่าไฟล์ Zip ไม่ถูกบล็อค มิฉะนั้น เมื่อคุณพยายามติดตั้งแพคเกจโซลูชัน คุณอาจได้รับข้อความแสดงข้อผิดพลาดต่อไปนี้ "ไม่พบแพคเกจนำเข้า" เพื่อยกเลิกการบล็อคไฟล์ Zip คลิกขวา แล้วเลือก **คุณสมบัติ** เลือก **ยกเลิกการบล็อก**
