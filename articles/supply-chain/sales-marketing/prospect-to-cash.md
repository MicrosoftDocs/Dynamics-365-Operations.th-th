---
title: ผู้ที่มีแนวโน้มจะเป็นลูกค้ากับเงินสด
description: บทความนี้แสดงภาพรวมของโซลูชันของผู้ที่มีแนวโน้มจะเป็นลูกค้าเงินสดระหว่าง Dynamics 365 Supply Chain Management และ Dynamics 365 Sales
author: Henrikan
ms.date: 04/25/2018
ms.topic: article
ms.prod: ''
