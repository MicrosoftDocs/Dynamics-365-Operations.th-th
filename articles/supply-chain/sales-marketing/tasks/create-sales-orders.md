...
## <a name="sales-order-creation-performance-enhancement"></a>การปรับปรุงประสิทธิภาพการสร้างใบสั่งขาย
คุณลักษณะใหม่ที่นำมาใช้กับแอปพลิเคชันเวอร์ชัน 10.0.26 ช่วยลดการสร้างเรกคอร์ดพิเศษสำหรับตาราง **SourceDocumentHeader** และ **SourceDocumentLine** ประสิทธิภาพได้รับการปรับปรุงและขนาดที่เก็บข้อมูลลดลงเนื่องจากไม่มีการสร้างเรกคอร์ดเหล่านี้ ตารางกรอบงานเอกสารต้นทางพื้นฐานเหล่านี้ไม่ได้ใช้สำหรับใบสั่งขายในผลิตภัณฑ์ในขณะนี้ และไม่มีแผนกำหนดการที่จะใช้ การเปิดใช้งานคุณลักษณะนี้ถือเป็นการเปลี่ยนแปลงที่ปลอดภัยในการเพิ่มประสิทธิภาพ 
