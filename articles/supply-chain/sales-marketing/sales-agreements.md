...
เมื่อลูกค้าส่งคืนผลิตภัณฑ์ที่ถูกสั่งจากข้อตกลงการขาย Microsoft Dynamics 365 for Finance and Operations สามารถค้นหาและปรับปรุงข้อผูกพันข้อตกลงการขายที่เกี่ยวข้องเพื่อสะท้อนการเปลี่ยนแปลงในปริมาณหรือจำนวน โดยการสร้างใบสั่งส่งคืนสินค้าที่ขึ้นอยู่กับใบสั่งขายต้นฉบับที่ลิงค์กับข้อตกลงการขาย คุณจะสร้างความสัมพันธ์ ระหว่างข้อผูกมัดเกี่ยวกับข้อตกลงการขาย รายการใบสั่งขาย ใบแจ้งหนี้ของใบสั่งส่งคืนสินค้า  
...
ในบางสถานการณ์ที่ซึ่งมีการสร้างใบสั่งขายทางอ้อม เช่น เมื่อคุณสร้างใบลดหนี้หรือใบสั่งขายระหว่างบริษัท คุณสามารถควบคุมได้ว่า Microsoft Dynamics 365 for Finance and Operations ค้นหาข้อตกลงการขายที่เกี่ยวข้องโดยอัตโนมัติหรือไม่
