...
**สรุปสินค้าคงคลัง** เป็นมุมมองที่กำหนดเองสำหรับ *เอนทิตีผลรวมปริมาณคงคลังคงเหลือ* โดยจะให้สรุปสินค้าคงคลังสำหรับผลิตภัณฑ์พร้อมด้วยมิติทั้งหมด ข้อมูลสรุปสินค้าคงคลังจะถูกซิงค์เป็นระยะจากการแสดงผลสินค้าคงคลังทุกๆ 15 นาที เพื่อดูข้อมูลบนแท็บ **สรุปสินค้าคงคลัง** ได้ คุณต้องเปิดคุณลักษณะ *OnHandMostSpecificBackgroundService* บนแท็บ **การจัดการคุณลักษณะ** และเลือก **อัปเดตการกำหนดค่า**
