---
title: การปันส่วนสินค้าคงคลังสำหรับการมองเห็นสินค้าคงคลัง
description: หัวข้อนี้อธิบายวิธีการตั้งค่าและใช้คุณลักษณะการปันส่วนสินค้าคงคลัง ซึ่งช่วยให้คุณตั้งค่าสินค้าคงคลังที่จัดสรรไว้เพิ่มเติมเพื่อให้แน่ใจว่าคุณสามารถตอบสนองช่องทางหรือลูกค้าได้มากที่สุด
author: yufeihuang
ms.date: 05/20/2022
ms.topic: article
ms.search.form: ''
...
### <a name="allcoation-using-tips"></a>การปันส่วนโดยใช้เทคนิค

- สำหรับผลิตภัณฑ์ทุกรายการ ฟังก์ชัน allocation ควรจะใช้ในระดับมิติเดียวกันตามลำดับชั้นของดัชนีผลิตภัณฑ์ที่คุณตั้งค่าใน [การตั้งค่าคอนฟิกตามลำดับชั้นของดัชนีผลิตภัณฑ์](inventory-visibility-configuration.md#index-configuration) ตัวอย่างเช่น ลำดับชั้นของดัชนีคือ ไซต์ สถานที่ สี และขนาด ถ้าคุณปันส่วนปริมาณบางอย่างให้กับผลิตภัณฑ์หนึ่งๆ ในระดับไซต์ สถานที่ สี ในครั้งถัดไปที่คุณใช้ในการปันส่วน ควรอยู่ที่ระดับไซต์ สถานที่ สี ถ้าคุณใช้ระดับไซต์ สถานที่ สี ระดับขนาด หรือระดับไซต์ สถาน ข้อมูลจะไม่สอดคล้องกัน
