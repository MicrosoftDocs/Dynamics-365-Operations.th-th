...
ความสามารถในการมองเห็นสินค้าคงคลังเป็น microservice ที่สร้างขึ้นบน Common Data Service ซึ่งหมายความว่า คุณสามารถขยายได้โดยการสร้าง Power Apps และการใช้ Power BI เพื่อให้ฟังก์ชันการทำงานที่กำหนดเองตรงกับความต้องการทางธุรกิจของคุณ นอกจากนี้ คุณยังสามารถอัปเกรดดัชนีเพื่อทำการสอบถามสินค้าคงคลังได้ด้วย
...
เมื่อต้องการเรียกใช้โทเคนบริการรักษาความปลอดภัย ให้ทำตามขั้นตอนต่อไปนี้:

1. เรียกใช้ `aadToken` ของคุณ และเรียกปลายทาง: https://securityservice.operations365.dynamics.com/token
1. แทนที่ `client_assertion` ในเนื้อหาด้วย `aadToken` ของคุณ
1. แทนที่บริบทในเนื้อหาด้วยสภาพแวดล้อมที่คุณต้องการปรับใช้ add-in
1. แทนที่ขอบเขตในเนื้อหาด้วยข้อมูลต่อไปนี้:

    - ขอบเขตสำหรับ MCK - "https://inventoryservice.operations365.dynamics.cn/.default"  
    (คุณสามารถค้นหารหัสแอปพลิเคชัน Azure Active Directory และรหัสผู้เช่าสำหรับ MCK ใน `appsettings.mck.json`)
    - ขอบเขตสำหรับ PROD - "https://inventoryservice.operations365.dynamics.com/.default"  
    (คุณสามารถค้นหารหัสแอปพลิเคชัน Azure Active Directory และรหัสผู้เช่าสำหรับ PROD ใน `appsettings.prod.json`)

    ผลลัพธ์ควรมีลักษณะคล้ายกับตัวอย่างต่อไปนี้
