...
โทเค็นความปลอดภัยของแพลตฟอร์มจะถูกใช้ในการเรียก API สาธารณะของการแสดงผลสินค้าคงคลัง ดังนั้น คุณจึงต้องสร้างโทเค็น _Azure Active Directory (Azure AD)_ โดยใช้โปรแกรมประยุกต์ Azure AD ของคุณ จากนั้นคุณต้องใช้โทเค็น Azure AD เพื่อรับ _การเข้าถึงโทเค็น_ จากบริการความปลอดภัย
