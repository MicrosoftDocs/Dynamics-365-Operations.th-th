...
โทเคนความปลอดภัยของแพลตฟอร์มจะถูกใช้ในการเรียก API สาธารณะของการแสดงผลสินค้าคงคลัง ดังนั้น คุณจึงต้องสร้างโทเคน _Azure Active Directory (Azure AD)_ โดยใช้แอปพลิเคชัน Azure AD ของคุณ จากนั้นคุณต้องใช้โทเคน Azure AD เพื่อรับ _การเข้าถึงโทเคน_ จากบริการความปลอดภัย
