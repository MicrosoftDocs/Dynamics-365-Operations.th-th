...
description: บทความนี้จะอธิบายวิธีการสร้างและใช้โซนตรวจสอบสินค้าของความไม่สอดคล้องกัน
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857734"
---
# <a name="quarantine-zones-for-nonconformances"></a>โซนตรวจสอบสินค้าสำหรับความไม่สอดคล้องกัน

[!include [banner](../includes/banner.md)]

บทความนี้จะอธิบายวิธีการสร้างและใช้โซนตรวจสอบสินค้าของความไม่สอดคล้องกัน
