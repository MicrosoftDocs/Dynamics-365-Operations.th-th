...
1. In the **บานหน้าต่างนำทาง** ไปที่ **โมดูล > การบริหารสินค้าคงคลัง > การสอบถามและรายงาน > มิติการติดตาม > การติดตามสินค้า**
2. ในฟิลด์ **หมายเลขสินค้า** ให้เลือก 'P9100'
3. ในรายการนี้ ให้คลิกลิงค์ในแถวที่เลือก
4. ในฟิลด์ **ไปข้างหน้า หรือย้อนหลัง** เลือก 'ย้อนหลัง'
5. ในฟิลด์ **หมายเลขชุดงาน** เลือก 'เป็น-12-344-01'
...
2. ในแผนภูมิ ให้ขยาย 'โหนดที่อธิบายด้านล่าง แล้วเลือกโหนดนั้น'
    ...
    โดยเริ่มต้นจากโหนดที่คุณเพิ่งเลือก ขยาย 'M9103 ● สายการผลิต B-000050 ● 12/9/2015 ● -160.00 ปอนด์ ● ขนาด=70 สี=ตกลง ไซต์=1 คลังสินค้า=10 หมายเลขชุดงาน=App01' และจากนั้นให้เลือกโหนดนั้น  
3. คลิก **ติดตามจากโหนด**
4. คลิก **ไปข้างหน้า**
5. บน **บานหน้าต่างการดำเนินการ** คลิก **การติดตาม**
    
    มีตัวเลือกการติดตามหลายตัวเลือกที่ให้ข้อมูลเกี่ยวกับลูกค้าที่ได้รับผลกระทบจากสินค้าที่คุณกำลังติดตาม และใบสั่งขายที่เกี่ยวข้องกับสินค้าที่ได้จัดส่งแล้วและยังไม่มีการจัดส่ง   
6. คลิก **ลูกค้า**
7. ปิดหน้า
8. บน **บานหน้าต่างการดำเนินการ** คลิก **การติดตาม**
