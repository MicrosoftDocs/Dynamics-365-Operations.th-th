...
1. สร้างคลาสงานที่แยกต่างหากสำหรับชนิดของใบสั่งงาน _การสุ่มตัวอย่างสินค้าที่มีคุณภาพ_ และ _ใบสั่งตรวจสอบคุณภาพ_ ด้วยวิธีนี้ คุณต้องตรวจสอบให้แน่ใจว่าสามารถสร้างงานที่เหมาะสมโดยอัตโนมัติโดยยึดตามชนิดของใบสั่งงานสองชนิด และงานนี้สามารถรันได้โดยใช้แอปบนมือถือของคลังสินค้า (WMA)
...
|---|---|---|---|---|---|---|
| ใบสั่ง | ป้ายทะเบียนทั้งหมด | ใช่ _(ถูกล็อค/ไม่สามารถแก้ไขได้)_ | <p>สถานที่: ใช่</p><p>ป้ายทะเบียน: ใช่ _(ถูกล็อค/ไม่สามารถแก้ไขได้)_</p> | จำนวน | 3 | <p>**ปริมาณในรายการใบสั่ง: 100 EA**</p><ol><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP1<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 20 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 20 EA</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP2<p>งานใบสั่งซื้อสำหรับ 20 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP3<p>งานใบสั่งซื้อสำหรับ 20 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP4<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 20 EA</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP5<p>งานใบสั่งซื้อสำหรับ 20 EA (การย้ายเก็บ)</p></li></ol> |
| ใบสั่ง | ปริมาณคงที่ = 1 | ใช่ | <p>สถานที่: ใช่</p><p>ป้ายทะเบียน: ใช่</p> | จำนวน | ใช้ไม่ได้ | <p>**ปริมาณในรายการใบสั่ง: 100**</p><ol><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP1<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 1 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 1 EA</p><p>งานใบสั่งซื้อสำหรับ 19 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP2<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 1 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 1 EA</p><p>งานใบสั่งซื้อสำหรับ 19 (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP3<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 1 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 1 EA</p><p>งานใบสั่งซื้อสำหรับ 19 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP4<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 1 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 1 EA</p><p>งานใบสั่งซื้อสำหรับ 19 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 20 EA LP5<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 1 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 1 EA</p><p>งานใบสั่งซื้อสำหรับ 19 EA (การย้ายเก็บ)</p></li></ol> |
| ใบสั่ง | เปอร์เซ็นต์ = 10 | จำนวน | <p>สถานที่: ไม่</p><p>ป้ายทะเบียน: ไม่</p> | จำนวน | ใช้ไม่ได้ | <p>**ปริมาณในรายการใบสั่ง: 100 EA**</p><ol><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 50 EA LP1<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 10 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 10 EA</p><p>งานใบสั่งซื้อสำหรับ 40 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 50 EA LP2<p>งานใบสั่งซื้อสำหรับ 50 EA (การย้ายเก็บ)</p></li></ol> |
| จำนวนงานในศูนย์การผลิต | เปอร์เซ็นต์ = 5 | ใช่ _(ถูกล็อค/ไม่สามารถแก้ไขได้)_ | <p>สถานที่: ไม่</p><p>ป้ายทะเบียน: ไม่</p> | จำนวน | ใช้ไม่ได้ | <p>**ปริมาณในรายการใบสั่ง: 500 EA**</p><p>**จำนวนงานในศูนย์การผลิตสองรายการ: จำนวนงานในศูนย์การผลิตแรก 200 EA จำนวนงานในศูนย์การผลิตที่สอง 300 EA**</p><ol><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับจำนวนงานในศูนย์การผลิตแรกสำหรับ 100 EA<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 5 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 5 EA</p><p>งานใบสั่งซื้อสำหรับ 95 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับจำนวนงานในศูนย์การผลิตแรกสำหรับ 100 EA<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 5 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 5 EA</p><p>งานใบสั่งซื้อสำหรับ 95 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับจำนวนงานในศูนย์การผลิตที่สองสำหรับ 300 EA<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 15 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 15 EA</p><p>งานใบสั่งซื้อสำหรับ 285 EA (การย้ายเก็บ)</p></li></ol> |
| ใบสั่ง | เปอร์เซ็นต์ = 10 | จำนวน | <p>สถานที่: ใช่</p><p>ป้ายทะเบียน: ใช่</p> | จำนวน | ใช้ไม่ได้ | <p>**ปริมาณในรายการใบสั่ง: 100**</p><ol><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 50 EA LP1<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 5 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 5 EA</p><p>งานใบสั่งซื้อสำหรับ 45 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 50 EA LP2<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 5 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 5 EA</p><p>งานใบสั่งซื้อสำหรับ 45 (การย้ายเก็บ)</p></li></ol> |
| จำนวนงานในศูนย์การผลิต | ป้ายทะเบียนทั้งหมด | ใช่ _(ถูกล็อค/ไม่สามารถแก้ไขได้)_ | <p>สถานที่: ใช่</p><p>ป้ายทะเบียน: ใช่ _(ถูกล็อค/ไม่สามารถแก้ไขได้)_</p> | จำนวน | 3 | <p>**สินค้าสองรายการ:**</p><ul><li>**ปริมาณในรายการใบสั่งสำหรับสินค้า A: 120 EA (แท่นวางสินค้า 4 แท่น)**</li><li>**ปริมาณในรายการใบสั่งสำหรับสินค้า B: 90 EA (แท่นวางสินค้า 3 แท่น)**</li></ul><p>**รายการของจำนวนงานในศูนย์การผลิตหนึ่งรายการ สองรายการ ที่มีรายการในใบสั่งแต่ละรายการ**</p><ol><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP1<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 30 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 30 EA</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP2<p>งานใบสั่งซื้อสำหรับ 30 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP3<p>งานใบสั่งซื้อสำหรับ 30 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP4<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 30 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 30 EA</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า B 30 EA LP5<p>งานใบสั่งซื้อสำหรับ 30 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า B 30 EA LP6<p>งานใบสั่งซื้อสำหรับ 30 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP7<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 30 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 30 EA</p></li></ol> |
| จำนวนงานในศูนย์การผลิต | ป้ายทะเบียนทั้งหมด | ใช่ _(ถูกล็อค/ไม่สามารถแก้ไขได้)_ | <p>สถานที่: ใช่</p><p>ป้ายทะเบียน: ใช่ _(ถูกล็อค/ไม่สามารถแก้ไขได้)_</p> | ใช่ | 3 | <p>**สินค้าสองรายการ:**</p><ul><li>**ปริมาณในรายการใบสั่งสำหรับสินค้า A: 120 EA (แท่นวางสินค้า 4 แท่น)**</li><li>**ปริมาณในรายการใบสั่งสำหรับสินค้า B: 90 EA (แท่นวางสินค้า 3 แท่น)**</li></ul><p>**รายการของจำนวนงานในศูนย์การผลิตหนึ่งรายการ สองรายการ ที่มีรายการในใบสั่งแต่ละรายการ**</p><ol><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP1<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 30 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 30 EA</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP2<p>งานใบสั่งซื้อสำหรับ 30 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP3<p>งานใบสั่งซื้อสำหรับ 30 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP4<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 30 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 30 EA</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า B 30 EA LP5<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 30 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 30 EA</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า B 30 EA LP6<p>งานใบสั่งซื้อสำหรับ 30 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับสินค้า A 30 EA LP7<p>งานใบสั่งซื้อสำหรับ 30 EA (การย้ายเก็บ)</p></li></ol> |
| จำนวนงานในศูนย์การผลิต | เปอร์เซ็นต์ = 10 | ใช่ _(ถูกล็อค/ไม่สามารถแก้ไขได้)_ | <p>สถานที่: ไม่</p><p>ป้ายทะเบียน: ไม่</p> | จำนวน | ใช้ไม่ได้ | <p>**ปริมาณในรายการใบสั่ง: 100 EA**</p><p>**ไม่มีการสร้างจำนวนงานในศูนย์การผลิต มีการใช้ขอบเขตของใบสั่ง**</p><ol><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 50 EA LP1<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 5 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 5 EA</p><p>งานใบสั่งซื้อสำหรับ 45 EA (การย้ายเก็บ)</p></li><li>ลงทะเบียนการรับสินค้าใน WMA สำหรับ 50 EA LP2<p>งานการสุ่มตัวอย่างสินค้าที่มีคุณภาพสำหรับ 5 EA</p><p>ใบสั่งตรวจสอบคุณภาพ 1 สำหรับ 5 EA</p><p>งานใบสั่งซื้อสำหรับ 45 EA (การย้ายเก็บ)</p></li></ol> |
...
ขณะนี้มีการสร้างใบสั่งซื้อสำหรับปริมาณ 10 ของสินค้า A0001 สำหรับผู้จัดจำหน่าย 104 หลังจากนั้น รายการในใบสั่งซื้อที่มีปริมาณ 10 มีการลงทะเบียนเป็นได้รับแล้วบนป้ายทะเบียนหนึ่งโดยใช้ WMA นี่คือผลลัพธ์:
...
1. ไปที่อุปกรณ์เคลื่อนที่หรือตัวเลียนแบบที่กำลังรัน WMA และลงชื่อเข้าใช้คลังสินค้า 51 โดยใช้ *51* เป็นรหัสผู้ใช้ และ *1* เป็นรหัสผ่าน
