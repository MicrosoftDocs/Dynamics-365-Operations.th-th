...
บางครั้ง สินค้าบางรายการในสินค้าคงคลังไม่สามารถถูกเบิกสินค้าโดยเป็นส่วนหนึ่งของกระบวนการรายการเบิกสินค้าได้ ตัวอย่างเช่น สถานการณ์นี้อาจเกิดขึ้นถ้าผู้ปฏิบัติงานคลังสินค้าลดปริมาณในรายการเบิกสินค้า และกระบวนการรายการเบิกสินค้า ถ้าตัวเลือก **สิ้นสุดใบสั่งสินค้าคงคลังของผลผลิต** ถูกตั้งค่าเป็น **ใช่** ปริมาณคงเหลือที่ไม่ได้ถูกเบิกสินค้าจะถูกรายงานกลับไปยังระดับใบสั่ง ถ้ามีการตั้งค่าตัวเลือกเป็น **ไม่ใช่** ปริมาณคงเหลือที่ไม่ได้ถูกเบิกสินค้าจะถูกจัดเก็บไว้เป็นปริมาณใบสั่งผลผลิตที่เปิด ในกรณีนี้ ปริมาณจะยังคงที่ตามที่นำออกใช้ไปยังคลังสินค้า และต้องเพิ่มลงในรายการเบิกสินค้าใหม่โดยเป็นส่วนหนึ่งของฟังก์ชัน **ใบสั่งผลผลิตที่เปิด**
