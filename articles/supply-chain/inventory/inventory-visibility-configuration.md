...
| *onHandIndexQueryPreloadBackgroundService* | คุณลักษณะนี้ช่วยให้สามารถโหลดการสอบถามปริมาณคงเหลือของการมองเห็นสินค้าคงคลังล่วงหน้าเพื่อรวมรายการปริมาณคงเหลือกับมิติที่เลือกไว้ล่วงหน้า ความถี่ในการซิงโครไนส์เริ่มต้นคือ หนึ่งครั้งทุกๆ 15 นาที สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [สรุปสินค้าคงคลัง](inventory-visibility-power-platform.md#preload-the-inventory-visibility-onhand-query) |
...
การแสดงผลสินค้าคงคลังช่วยให้คุณมีความยืดหยุ่นได้โดยการอนุญาตให้คุณตั้งค่า _ดัชนี_ เพื่อปรับปรุงประสิทธิภาพของการสอบถามของคุณ ดัชนีเหล่านี้จะขึ้นอยู่กับมิติหรือชุดของมิติ ดัชนีประกอบด้วย *หมายเลขชุด* *มิติ* และ *ลำดับชั้น* ตามที่กําหนดไว้ในตารางต่อไปนี้
