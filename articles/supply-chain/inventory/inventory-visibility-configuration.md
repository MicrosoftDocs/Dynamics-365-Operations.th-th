...
แต่ละแหล่งข้อมูลแสดงถึงระบบที่เป็นที่มาของข้อมูลของคุณ ตัวอย่างชื่อแหล่งข้อมูล ได้แก่ `fno` (ซึ่งหมายถึง "แอป Dynamics 365 การเงินและการดำเนินงาน") และ `pos` (ซึ่งหมายถึง "การขายหน้าร้าน") ตามค่าเริ่มต้น Supply Chain Management จะถูกตั้งค่าเป็นแหล่งข้อมูลเริ่มต้น (`fno`) ในการแสดงผลสินค้าคงคลัง
