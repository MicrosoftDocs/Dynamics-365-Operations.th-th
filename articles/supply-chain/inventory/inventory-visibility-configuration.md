...
> [!NOTE]
> แหล่งข้อมูล `fno` ถูกจองสำหรับ Supply Chain Management ถ้า Add-in ที่มองเห็นได้ของสินค้าคงคลังของคุณรวมกับสภาพแวดล้อม Supply Chain Management เราขอแนะนำว่าคุณควรลบการตั้งค่าคอนฟิก `fno` ที่เกี่ยวข้องกับแหล่งข้อมูล
