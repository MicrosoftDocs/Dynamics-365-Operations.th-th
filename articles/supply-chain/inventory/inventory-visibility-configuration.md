...
| *OnHandMostSpecificBackgroundService* | คุณลักษณะนี้จะให้สรุปสินค้าคงคลังสำหรับผลิตภัณฑ์พร้อมด้วยมิติทั้งหมด ข้อมูลสรุปสินค้าคงคลังจะถูกซิงค์เป็นระยะจากการแสดงผลสินค้าคงคลัง สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [สรุปสินค้าคงคลัง](inventory-visibility-power-platform.md#inventory-summary) |
...
| *การปันส่วน* | คุณลักษณะที่เลือกได้นี้ช่วยให้การแสดงผลสินค้าคงคลังสามารถปกป้องสินค้าคงคลัง (ringcing) และควบคุมการขายเกินได้ สำหรับข้อมูลเพิ่มเติม ให้ดูที่ [การปันส่วนการแสดงผลสินค้าคงคลัง](inventory-visibility-allocation.md) |
| *เปิดใช้งานรายการคลังสินค้าในการมองเห็นสินค้าคงคลัง* | คุณลักษณะที่เป็นตัวเลือกนี้ช่วยให้มองเห็นสินค้าคงคลังเพื่อรองรับสินค้าที่เปิดใช้งานกระบวนการคลังสินค้าขั้นสูง (สินค้า WHS) สำหรับข้อมูลเพิ่มเติม โปรดดู [การสนับสนุนการมองเห็นสินค้าคงคลังสำหรับสินค้า WHS](inventory-visibility-whs-support.md) |
...
แต่ละแหล่งข้อมูลแสดงถึงระบบที่เป็นที่มาของข้อมูลของคุณ ตัวอย่างชื่อแหล่งข้อมูล ได้แก่ `fno` (ซึ่งหมายถึง "แอปการเงินและการดำเนินงานของ Dynamics 365") และ `pos` (ซึ่งหมายถึง "การขายหน้าร้าน") ตามค่าเริ่มต้น Supply Chain Management จะถูกตั้งค่าเป็นแหล่งข้อมูลเริ่มต้น (`fno`) ในการแสดงผลสินค้าคงคลัง
...
- ตามค่าเริ่มต้น ถ้าคุณไม่ได้ใช้ Supply Chain Management เป็นหนึ่งในแหล่งข้อมูลของคุณ มิติ 13 มิติจะถูกแมปไปยังมิติมาตรฐานของ Supply Chain Management มิติอื่นๆ อีกสิบสองมิติ (`inventDimension1` ผ่าน `inventDimension12`) ถูกแมปไปยังมิติที่กำหนดเองใน Supply Chain Management มิติทั้งแปดมิติที่เหลือเป็นมิติแบบขยายที่คุณสามารถแมปกับแหล่งข้อมูลภายนอกได้
...
> [!NOTE]
> ถ้ามิติของคุณไม่อยู่ในรายการมิติเริ่มต้น และคุณกำลังใช้แหล่งข้อมูลภายนอก เราขอแนะนำให้คุณใช้ `ExtendedDimension1` ผ่าน `ExtendedDimension8` เพื่อทำการแมป
...
ระบบภายนอกสามารถเข้าถึงการแสดงผลสินค้าคงคลังผ่าน RESTful APIs สำหรับการรวม การแสดงผลสินค้าคงคลังช่วยให้คุณสามารถตั้งค่าคอนฟิก _แหล่งข้อมูลภายนอก_ และการแมปจาก _มิติภายนอก_ ไปยัง _มิติพื้นฐาน_ นี่เป็นตัวอย่างของตารางการแมปมิติ
...
1. ลงชื่อเข้าใช้สภาพแวดล้อม Power Apps ของคุณ และเปิด **การแสดงผลสินค้าคงคลัง**
1. เปิดหน้า **การตั้งค่าคอนฟิก**
1. บนแท็บ **แหล่งข้อมูล** ในส่วน **การแมปมิติ** ให้เลือก **เพิ่ม** เพื่อเพิ่มการแมปมิติ
...
ตัวอย่างเช่น ถ้าแหล่งข้อมูลของคุณรวมมิติสีของผลิตภัณฑ์ คุณสามารถแมปไปยังมิติพื้นฐาน `ColorId` เพื่อเพิ่มมิติแบบกำหนดเอง `ProductColor` ในแหล่งข้อมูล `exterchannel` ได้ จากนั้น มีการแมปกับมิติพื้นฐาน `ColorId`
...
1. ตั้งค่าฟิลด์ต่อไปนี้สำหรับการวัดที่คำนวณใหม่:
    ...
    - **แหล่งข้อมูล** – เลือกแหล่งข้อมูลที่สัมพันธ์กับตัวแก้ไขใหม่ ระบบการสอบถามเป็นแหล่งข้อมูล
...
1. ทำซ้ำขั้นตอนที่ 5 ถึง 6 จนกระทั่งคุณเพิ่มตัวแก้ไขที่ต้องการทั้งหมด
1. เลือก **บันทึก**
...
> - คุณต้องมีลำดับชั้นดัชนีอย่างน้อยหนึ่งลำดับ (ตัวอย่างเช่น ที่ประกอบด้วยมิติพื้นฐาน `Empty`) มิฉะนั้น การสอบถามจะล้มเหลวโดยมีข้อผิดพลาด "ไม่ได้ตั้งค่าลำดับชั้นดัชนีไว้"
...
1. บนแท็บ **การวัดที่มีการคํานวณ** ของหน้า **การตั้งค่าคอนฟิก** ให้กําหนดการวัดที่มีการคํานวณที่ *พร้อมสำหรับการจอง* (AFR) ที่มีสูตรการคํานวณ AFR ที่คุณต้องการแมปกับการวัดทางกายภาพ ตัวอย่างเช่น คุณอาจตั้งค่า `AvailableToReserve` (พร้อมสำหรับการจอง) เพื่อให้มีการแมปกับการวัดทางกายภาพ `SoftReservOrdered` ที่กําหนดไว้ก่อนหน้านี้ ด้วยวิธีนี้ คุณสามารถค้นหาปริมาณที่มีสถานะสินค้าคงคลัง `SoftReservOrdered` ที่จะพร้อมใช้งานสำหรับการจอง ตารางต่อไปนี้แสดงสูตรการคํานวณ AFR
...
1. เปิดหน้า **การตั้งค่าคอนฟิก**
1. บนแท็บ **การแมปการจองแบบชั่วคราว** ตั้งค่าการแมปจากการวัดทางกายภาพไปยังการวัดที่มีการคํานวณ สำหรับตัวอย่างก่อนหน้านี้ คุณอาจใช้การตั้งค่าต่อไปนี้เพื่อแมป `AvailableToReserve` กับการวัดทางกายภาพ `SoftReservOrdered` ที่กําหนดไว้ก่อนหน้านี้
...
หลังจากที่คุณตั้งค่าคอนฟิกเสร็จสมบูรณ์แล้ว คุณต้องยืนยันการเปลี่ยนแปลงทั้งหมดต่อการแสดงผลสินค้าคงคลัง เมื่อต้องการยืนยันการเปลี่ยนแปลง ให้เลือก **อัปเดตการตั้งค่าคอนฟิก** ในมุมด้านขวาบนของหน้า **การตั้งค่าคอนฟิก** ใน Power Apps

ในครั้งแรกที่คุณเลือก **อัปเดตการตั้งค่าคอนฟิก** ระบบจะร้องขอข้อมูลประจำตัวของคุณ
...
หลังจากที่คุณลงชื่อเข้าใช้แล้ว การตั้งค่าคอนฟิกจะถูกอัปเดตในบริการการแสดงผลสินค้าคงคลัง

> [!NOTE]
> โปรดตรวจสอบให้แน่ใจว่าได้ตรวจสอบความถูกต้องของชื่อแหล่งข้อมูล การวัดทางกายภาพ และการแมปมิติของคุณ ก่อนที่คุณจะอัปเดตการตั้งค่าคอนฟิกสำหรับบริการการแสดงผลสินค้าคงคลัง คุณจะไม่สามารถแก้ไขการตั้งค่าเหล่านี้ได้หลังจากคุณเลือก **อัปเดตการตั้งค่าคอนฟิก**
