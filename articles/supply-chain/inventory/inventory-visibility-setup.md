...
- รับโครงการสำหรับการใช้งาน Lifecycle Services โดยมีสภาพแวดล้อมที่ปรับใช้อย่างน้อยหนึ่งรายการ
...
> [!IMPORTANT]
> ถ้าคุณมีสภาพแวดล้อม Lifecycle Services มากกว่าหนึ่งสภาพแวดล้อม ให้สร้างแอปพลิเคชัน Azure AD ที่แตกต่างกันในแต่ละสภาพแวดล้อม ถ้าคุณใช้รหัสแอปพลิเคชันและรหัสผู้เช่าเดียวกันเพื่อติดตั้ง Add-in ของ Inventory Visibility ในสภาพแวดล้อมที่ต่างกัน ปัญหาโทเค็นจะเกิดขึ้นกับสภาพแวดล้อมที่เก่ากว่า ซึ่งอาจส่งผลให้การติดตั้งสุดท้ายเท่านั้นที่จะมีผลบังคับใช้
...
1. ลงชื่อเข้าใช้ [Lifecycle Services](https://lcs.dynamics.com/Logon/Index)
...
1. ในหน้าสภาพแวดล้อม ให้เลื่อนลงจนกว่าคุณจะพบส่วน **Add-in ของสภาพแวดล้อม** ในส่วน **การรวม Power Platform** คุณสามารถค้นหาชื่อสภาพแวดล้อม Dataverse ได้ ยืนยันว่าชื่อสภาพแวดล้อม Dataverse เป็นชื่อที่คุณต้องการใช้ในการแสดงผลสินค้าคงคลัง
    ...
    > [!NOTE]
    > ปัจจุบัน สนับสนุนเฉพาะสภาพแวดล้อม Dataverse ที่สร้างโดยใช้ Lifecycle Services เท่านั้น ถ้าสภาพแวดล้อม Dataverse ของคุณถูกสร้างขึ้นในวิธีอื่น (ตัวอย่างเช่น โดยใช้ศูนย์การจัดการ PowerApps) และถ้าจะเชื่อมโยงกับสภาพแวดล้อม Supply Chain Management ของคุณ คุณต้องแก้ปัญหาการแม็ปก่อนที่จะติดตั้ง Add-in ของ Inventory Visibility
    >
    > เป็นไปได้ว่าสภาพแวดล้อมแบบสองทิศทางของคุณเชื่อมโยงกับอินสแตนซ์ Dataverse ในขณะที่ Lifecycle Services ไม่ได้ตั้งค่าเพื่อการรวม Power Platform การเชื่อมโยงนี้ไม่ตรงกันอาจทําให้เกิดลักษณะการทํางานที่ไม่คาดคิด ขอแนะนำว่ารายละเอียดของสภาพแวดล้อม Lifecycle Services จะตรงกับสิ่งที่คุณเชื่อมต่อด้วยแบบสองทิศททาง เพื่อให้การเชื่อมต่อเดียวกันสามารถใช้ได้โดยเหตุการณ์ทางธุรกิจ ตารางเสมือน และ Add-in ดูที่ [การลิงค์ไม่ตรงกัน](../../fin-ops-core/dev-itpro/data-entities/dual-write/lcs-setup.md#linking-mismatch) สำหรับข้อมูลเกี่ยวกับวิธีการแก้ไขปัญหาการแม็ป เมื่อปัญหาการแม็ปได้รับการแก้ไขแล้ว คุณสามารถดําเนินการติดตั้งการมองเห็นสินค้าคงคลัง

1. ในส่วน **add-in สภาพแวดล้อม** ให้เลือก **ติดตั้ง add-in ใหม่**

    ![หน้าสภาพแวดล้อมใน Lifecycle Services](media/inventory-visibility-environment.png "หน้าสภาพแวดล้อมใน Lifecycle Services")
...
> [!NOTE]
> หากระบบเตือนคุณว่าคุณไม่มีสิทธิ์ติดตั้ง Inventory Visibility ใน Lifecycle Services คุณต้องติดต่อผู้ดูแลระบบเพื่อแก้ไขสิทธิ์ของคุณ
>
> หากใช้เวลามากกว่าหนึ่งชั่วโมงในการติดตั้งจากหน้า Lifecycle Services บัญชีผู้ใช้ของคุณอาจไม่มีสิทธิ์เพียงพอในการติดตั้งโซลูชันในสภาพแวดล้อม Dataverse ให้ทำตามขั้นตอนต่อไปนี้เพื่อแก้ไขปัญหานี้:
>
> 1. ยกเลิกกระบวนการการติดตั้ง Add-in ของการมองเห็นสินค้าคงคลังจากหน้า Lifecycle Services
...
>
> 1. หลังจากการติดตั้งเสร็จสมบูรณ์ ให้ไปที่หน้า Lifecycle Services แล้วลองอีกครั้งเพื่อติดตั้ง Add-in **Inventory Visibility** ใหม่
...
ถ้าคุณเรียกใช้ Supply Chain Management เวอร์ชัน 10.0.17 หรือก่อนหน้านั้น ให้ติดต่อทีมสนับสนุนการแสดงผลสินค้าคงคลัง ที่ [inventvisibilitysupp@microsoft.com](mailto:inventvisibilitysupp@microsoft.com) เพื่อรับไฟล์แพคเกจ แล้วปรับใช้แพคเกจใน Lifecycle Services
...
1. ไปที่ Lifecycle Services และเปิดหน้าเพื่อดูสภาพแวดล้อมที่คุณต้องการถอนการติดตั้ง Add-in (ดูเพิ่มเติม [การติดตั้ง Add-in ของ Inventory Visibility](#install-add-in))
1. เลือก **ถอนการติดตั้ง**
1. ตอนนี้ กระบวนการถอนการติดตั้งจะยุติ Add-in ของ Inventory Visibility ยกเลิกการลงทะเบียน Add-in จาก Lifecycle Services และลบข้อมูลชั่วคราวใดๆ ที่จัดเก็บไว้ในแคชข้อมูล Add-in ของ Inventory Visibility อย่างไรก็ตาม ข้อมูลสินค้าคงคลังหลักที่ซิงค์กับการสมัครใช้งาน Dataverse ของคุณ จะถูกเก็บไว้ที่นั่น ในการลบข้อมูลนี้ ให้ทำกระบวนงานที่เหลือนี้ให้เสร็จสิ้น
1. เปิด [Power Apps](https://make.powerapps.com)
1. เลือก **สภาพแวดล้อม** บนแถบนําทาง
1. เลือกสภาพแวดล้อม Dataverse ที่ผูกกับสภาพแวดล้อม Lifecycle Services ของคุณ
