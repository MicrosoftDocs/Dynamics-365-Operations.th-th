...
description: บทความนี้อธิบายถึงวิธีการทำงานกับรายงานต่างๆ ที่เกี่ยวข้องกับวัตถุอันตราย รายงานจำนวนมากเหล่านี้มีความจำเป็นเพื่อให้คุณยังคงมีปฏิบัติตามกฎระเบียบเกี่ยวกับวัตถุอันตรายต่างๆ ระหว่างการจัดส่งและการจัดเก็บ
author: t-benebo
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
...
เมื่อมีการเปิดใช้งานคุณลักษณะวัตถุอันตรายสำหรับระบบของคุณ รายงาน **ใบตราส่ง** จะมีคอลัมน์ **วัตถุอันตราย** ที่บ่งชี้ว่าการบรรทุกมีวัตถุอันตรายหรือไม่ รายงานนี้สามารถใช้งานได้จากหน้า **การบรรทุกทั้งหมด** ตามปกติ

## <a name="packing-list-report"></a>รายงานรายการบรรจุสินค้า

เมื่อมีการเปิดใช้งานคุณลักษณะวัตถุอันตรายสำหรับระบบของคุณ รายการบรรจุสินค้ามีข้อมูลเพิ่มเติมที่เกี่ยวข้องกับข้อความที่พิมพ์สำหรับการจัดส่งของสินค้า รายงานนี้สามารถใช้งานได้จากหน้า **การบรรทุกทั้งหมด** ตามปกติ
