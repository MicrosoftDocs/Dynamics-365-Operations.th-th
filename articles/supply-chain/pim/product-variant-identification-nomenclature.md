...
description: บทความนี้อธิบายวิธีที่คุณสามารถตั้งค่าระบบการตั้งชื่อหมายเลขผลิตภัณฑ์เพื่อแทนที่รูปแบบ [หมายเลขผลิตภัณฑ์หลัก - การจัดโครงแบบ - ขนาด -สี - ลักษณะ] ที่คงที่
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8850625"
---
# <a name="nomenclature-of-product-variant-numbers-and-names"></a>ระบบการตั้งชื่อสำหรับชื่อและหมายเลขผลิตภัณฑ์ย่อย

[!include [banner](../includes/banner.md)]

บทความนี้อธิบายวิธีที่คุณสามารถตั้งค่าระบบการตั้งชื่อหมายเลขผลิตภัณฑ์เพื่อแทนที่รูปแบบ [หมายเลขผลิตภัณฑ์หลัก - การจัดโครงแบบ - ขนาด -สี - ลักษณะ] ที่คงที่ ระบบการตั้งชื่อใหม่มีรูปแบบที่เป็นเป้าหมายที่มีหมายเลขผลิตภัณฑ์หลัก มิติของผลิตภัณฑ์ที่ใช้งานอยู่ และตัวกำหนดเขตข้อความที่คุณเลือก นอกจากนี้ คุณยังสามารถสร้างระบบการตั้งชื่อสำหรับชื่อผลิตภัณฑ์ ท้ายสุด คุณยังสามารถสร้างระบบการตั้งชื่อเพื่อระบุการจัดโครงแบบที่สร้างขึ้นโดยตัวจัดโครงแบบผลิตภัณฑ์ตามข้อจำกัดได้อีกด้วย ระบบการตั้งชื่อเหล่านี้อาจประกอบด้วยแอททริบิวต์ที่คุณเลือก
