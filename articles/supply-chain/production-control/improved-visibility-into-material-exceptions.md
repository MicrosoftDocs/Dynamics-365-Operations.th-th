...
description: บทความนี้อธิบายวิธีการที่คุณจะมีการมองเห็นที่ดีขึ้นในข้อยกเว้น สำหรับวัตถุดิบสำหรับใบสั่งผลิตและใบสั่งชุดงาน
...
เมื่อมีเลือกไทล์ หน้า **เวฟการผลิตทั้งหมด** จะเปิด หน้านี้จะถูกกรองตามจำนวนเวฟที่เปิดซึ่งประกอบด้วยรายการเวฟจากรายการ BOM และรายการสูตรที่นำออกใช้ซึ่งตรงกับเงื่อนไขสำหรับไทล์

### <a name="manually-maintain-production-waves"></a>รักษาเวฟการผลิตด้วยตนเอง

ในหน้า **เวฟการผลิตทั้งหมด** คุณสามารถใช้ปุ่มบนแท็บ **เวฟ** บนบานหน้าต่างการดำเนินการเพื่อ **ประมวลผล** และ **ปล่อย** เวฟด้วยตนเองได้ คุณยังสามารถใช้ตัวเลือก **รักษาการผลิต** เพื่อดูและรักษาข้อมูล **กลุ่ม BOM การผลิต** ซึ่งใช้ในการจัดการกระบวนการการผลิต

## <a name="open-warehouse-work-needing-attention"></a>งานคลังสินค้าที่เปิดอยู่ซึ่งต้องให้ความสนใจ
