...
1. เลือกหมายเลขชุดงานจากกริด
1. บนบานหน้าต่างการดำเนินการ ให้เปิดแท็บ **มุมมอง** แล้วจากนั้น เลือก **แอททริบิวต์ของชุดงานของสินค้าคงคลัง**
...
### <a name="active-ingredients"></a>สารออกฤทธิ์
...
#### <a name="active-ingredient-example"></a>ตัวอย่างสารออกฤทธิ์
...
### <a name="none-ingredients"></a>ไม่มีส่วนผสม
...
#### <a name="none-ingredient-example"></a>ตัวอย่างแบบไม่มีส่วนผสม
...
### <a name="compensating-ingredients"></a>สารทดแทน
...
1. เปิดรายการสูตร แล้วจากนั้น เลือก **ส่วนผสม** เพื่อเปิดหน้า **หลักการชดเชย**
1. เลือกรายการที่แสดงถึงหลักการชดเชย และจากนั้นเลือกสารออกฤทธิ์ที่จะชดเชย
...
#### <a name="compensating-ingredient-example"></a>ตัวอย่างสารทดแทน
...
1. ผลลัพธ์ถูกคูณด้วยปัจจัยทดแทน:  
    4.29 × 1.10 = –4.72

1. ปริมาณสารทดแทนที่ประเมินจะลดลง –4.72 เพื่อกำหนดปริมาณทดแทนแบบสมดุล:  
    10 – (–4.72) = 14.72
...
### <a name="filler-ingredients"></a>สารเติมเต็ม
...
#### <a name="filler-ingredient-example"></a>ตัวอย่างสารเติมเต็ม
...
โดยทั่วไป มีการใช้การปรับสมดุลแบบกลุ่มกับใบสั่งชุดงาน หากสูตรมีรายการสูตรอย่างน้อยหนึ่งรายการที่ซึ่ง **ชนิดส่วนผสม** เป็น *ใช้งานอยู่* (สำหรับข้อยกเว้นกับกฎนี้ ดูส่วน "ชุดงานของใบสั่งที่ไม่เกี่ยวข้องสำหรับการปรับสมดุลแบบกลุ่ม" ในหัวข้อนี้ในภายหลัง)

กระบวนการปรับสมดุลแบบกลุ่มสามารถแบ่งออกได้เป็นสองกระบวนการย่อย:

1. ส่วนผสมชุดงานที่สมดุล
1. ยืนยันและนำสูตรออกใช้
...
1. ถ้าสูตรประกอบด้วยสารออกฤทธิ์สำหรับผลิตภัณฑ์ที่ถูกเปิดใช้งานสำหรับกระบวนการจัดการคลังสินค้า แต่หมายเลขชุดงานต่ำกว่าตำแหน่งในลำดับชั้นการจอง ใบสั่งชุดงานไม่สามารถใช้ได้สำหรับการปรับสมดุลแบบกลุ่ม
