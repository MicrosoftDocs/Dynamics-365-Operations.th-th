...
description: บทความนี้จะช่วยให้คุณสามารถสร้างการฝึกปฏิบัติของการทำสัญญาย่อยในการผลิตใน Dynamics 365 Supply Chain Management
...
ms.locfileid: "8854190"
---
# <a name="subcontracting"></a>การรับเหมารายย่อย

[!include [banner](../includes/banner.md)]

บทความนี้จะช่วยให้คุณสามารถสร้างการฝึกปฏิบัติของการทำสัญญาย่อยในการผลิตใน Microsoft Dynamics 365 Supply Chain Management ส่วนแรกของบทความนี้อธิบายถึงการตั้งค่าของข้อมูล ส่วนที่สองจะนำคุณผ่านขั้นตอนต่างๆ ในการฝึกปฏิบัตินี้

## <a name="target-audience"></a>ผู้ชมเป้าหมาย

ในบทความนี้ คุณจะได้เรียนรู้วิธีการตั้งค่าการรับเหมารายย่อยในการผลิต คุณจะใช้ข้อมูลที่มีอยู่ในนิติบุคคล HQUS เพื่อทำการตั้งค่าพื้นฐานของโฟลว์กิจกรรมการรับเหมารายย่อย ข้อมูลสาธิตในนิติบุคคล HQUS จะรวมถึงพารามิเตอร์การตั้งค่าที่ได้ถูกกำหนดไว้ล่วงหน้า เพื่อสนับสนุนขั้นตอนต่างๆ ในการฝึกปฏิบัตินี้ ถึงแม้ว่าการฝึกปฏิบัติจะระบุจุดบอดที่สำคัญและความท้าทายสำหรับบทบาทต่างๆ แต่สามารถดำเนินการให้เสร็จสิ้นได้โดยผู้ดูแลระบบ
...
![การดำเนินงานแอสเซมบลีล่วงหน้า การเคลือบ และเสร็จสิ้น และวัสดุที่จะใช้](./media/subcontract01_operations-materials.png)
...
3. ในบานหน้าต่างการดำเนินการ บนแท็บ **วิศวกรรม** เลือก **กระบวนการผลิต** เพื่อเปิดหน้า **กระบวนการผลิต**
    ...
    ![รุ่นกระบวนการผลิตแปดรุ่นบนหน้ากระบวนการผลิต](./media/subcontract03_route-page.png)
...
11. ในบานหน้าต่างการดำเนินการ บนแท็บ **วิศวกรรม** เลือก **รุ่น BOM** เพื่อเปิดหน้า **รุ่น BOM**
    ...
    ![รุ่น BOM สี่รุ่นบนหน้ารุ่น BOM](./media/subcontract09_bom-versions-page.png)
...
12. บน FastTab **รายการสูตรการผลิต** เลือก **แก้ไข** เพื่อเปิดกล่องโต้ตอบ **แก้ไขรายการ BOM**
    ...
    ![กล่องโต้ตอบแก้ไขรายการ BOM](./media/subcontract10_edit-bom-line-dialog.png)
...
2. ในบานหน้าต่างการดำเนินการ เลือก **ใบสั่งผลิตใหม่** เพื่อเปิดกล่องโต้ตอบ **สร้างใบสั่งผลิต**
    ...
    ![กล่องโต้ตอบสร้างใบสั่งผลิต](./media/subcontract12_create-production-order-dialog.png)
...
8. ในฟิลด์ **หมายเลข BOM** และ **หมายเลขกระบวนการผลิต** เปลี่ยนค่าที่ถูกเลือกโดยอัตโนมัติเป็น **000042**
    ...
    ![ค่าที่ตั้งค่าในกล่องโต้ตอบการสร้างใบสั่งผลิต](./media/subcontract14_create-production-order-dialog-set.png)
...
12. ในบานหน้าต่างการดำเนินการ บนแท็บ **ใบสั่งผลิต** เลือก **BOM** เพื่อเปิดหน้า **BOM** ที่ซึ่งคุณสามารถดูรายการ BOM สำหรับใบสั่งผลิตได้
    ...
    ![รายการ BOM ใบสั่งผลิตบนหน้า BOM](./media/subcontract17_production-order-bom-lines.png)
...
15. ระบุค่าต่อไปนี้:
    ...
    ![กล่องโต้ตอบการจัดกำหนดการงาน](./media/subcontract18_job-scheduling-dialog.png)
...
19. ในบานหน้าต่างการดำเนินการ บนแท็บ **ใบสั่งผลิต** เลือก **นำออกใช้** เพื่อเปิดกล่องโต้ตอบ **นำออกใช้**
    ...
    ![กล่องโต้ตอบนำออกใช้](./media/subcontract20_release-dialog.png)
...
21. เลือก **การควบคุมการผลิต \> งานประจำงวด \> นำออกใช้ไปยังคลังสินค้า \> นำ BOM และรายการสูตรออกใช้อัตโนมัติ** เพื่อเปิดกล่องโต้ตอบ **นำ BOM และรายการสูตรออกใช้อัตโนมัติ**
    ...
    ![กล่องโต้ตอบการนำรายการ BOM และรายการสูตรออกใช้อัตโนมัติ](./media/subcontract21_auto-release-bom-formula-lines-dialog.png)
...
30. บนแท็บ **ทั่วไป** ระบุค่าต่อไปนี้:
    ...
    ![ค่าที่ตั้งค่าบนแท็บทั่วไป 1](./media/subcontract23_start-dialog.png)
...
34. บนแท็บ **ทั่วไป** ระบุค่าต่อไปนี้:
    ...
    ![ค่าที่ตั้งค่าบนแท็บทั่วไป 2](./media/subcontract24_general-tab.png)
...
48. เปลี่ยนราคาต่อหน่วยจาก **33** เป็น **40**
    ...
    ![ราคาต่อหน่วยที่เปลี่ยนแปลงบนหน้าใบสั่งซื้อ](./media/subcontract30_unit-price.png)
