...
ในภาพประกอบต่อไปนี้ (a) คือ BOM สำหรับผลิตภัณฑ์ H และส่วน F และ G และ (b) คือแผ่นงานกระบวนการผลิตสำหรับผลิตภัณฑ์ H และส่วน F

![ตัวอย่างของโครงสร้าง BOM ในสองระดับ](media/product-H-part-F.png)
...
![BOM วิศวกรรมของผลิตภัณฑ์ H](media/product-H-part-B.png)
...
![ชนิดของบรรทัดแฝงที่ใช้ในโครงสร้าง BOM หลายระดับ](media/product-G-route-sheet-G.png)
...
![ตัวอย่างของเครือข่ายกระบวนการผลิตที่ใช้ใน BOM หลายระดับ](media/product-G-part-F.png)

ในภาพประกอบต่อไปนี้ (a) คือ BOM สำหรับผลิตภัณฑ์ G และส่วน F และ G และ (b) คือแผ่นงานกระบวนการผลิตสำหรับผลิตภัณฑ์ G และส่วน F

![BOM ของผลิตภัณฑ์ G และส่วน F และแผ่นงานกระบวนการผลิตของผลิตภัณฑ์ส่วน G และ F](media/product-G-part-F-with-route-sheet.png)
