...
## <a name="turn-on-new-features-in-feature-management"></a>เปิดใช้งานคุณลักษณะใหม่ในการจัดการคุณลักษณะ

ต้องเปิดใช้งานการตั้งค่าบางอย่างที่อธิบายไว้ในหัวข้อนี้ในระบบของคุณก่อนที่จะพร้อมใช้งานสำหรับคุณ ใช้หน้า [การจัดการคุณลักษณะ](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) เพื่อเปิดใช้งานคุณลักษณะใดๆ หรือคุณลักษณะทั้งหมดต่อไปนี้ตามต้องการ
