...
- *ฟังก์ชันการจัดการสินทรัพย์สำหรับอินเทอร์เฟสการดำเนินการผลิต*<br>(เริ่มจาก Supply Chain Management เวอร์ชัน 10.0.25 คุณลักษณะนี้จะเปิดตามค่าเริ่มต้น)
...
- *การค้นหางานสำหรับอินเทอร์เฟสการดำเนินการผลิต*<br>(เริ่มจาก Supply Chain Management เวอร์ชัน 10.0.25 คุณลักษณะนี้จะเปิดตามค่าเริ่มต้น)
...
- **ล็อคพนักงาน** – เมื่อตั้งค่าตัวเลือกนี้เป็น *ไม่มี* ผู้ปฏิบัติงานจะถูกลงชื่อออกทันทีหลังจากที่ทำการลงทะเบียน (เช่น งานใหม่) แล้วอินเทอร์เฟสจะกลับไปที่หน้าลงชื่อเข้าใช้ เมื่อมีการตั้งค่าตัวเลือกนี้เป็น *ใช่* ผู้ปฏิบัติงานจะยังคงจะลงชื่อเข้าใช้อินเทอร์เฟสการดำเนินการของระบบการผลิต อย่างไรก็ตาม ผู้ปฏิบัติงานสามารถลงชื่อออกด้วยตนเองเพื่อให้ผู้ปฏิบัติงานอีกคนหนึ่งสามารถลงชื่อเข้าใช้ ในขณะที่อินเทอร์เฟสการดำเนินการของระบบการผลิตยังคงทำงานอยู่ภายใต้บัญชีผู้ใช้ระบบเดียวกัน สำหรับข้อมูลเพิ่มเติมเกี่ยวกับชนิดของบัญชีเหล่านี้ ให้ดูที่ [ผู้ใช้ที่ได้รับมอบหมาย](config-job-card-device.md#assigned-users)
