...
## <a name="set-up-theworkflow-to-register-consumption-using-a-handheld-device"></a>ตั้งค่าเวิร์กโฟลว์เพื่อลงทะเบียนการใช้โดยใช้อุปกรณ์มือถือ
...
หลังจากที่คุณได้เสร็จสิ้นการลงทะเบียนของคุณ เลือก **เสร็จสิ้น** เพื่อโพสต์สมุดรายวันและสิ้นสุดเวิร์กโฟลว์

### <a name="additional-comments"></a>ข้อคิดเห็นเพิ่มเติม 

-   ถ้าผู้ใช้ยกเลิกเวิร์กโฟลว์หลังจากบรรทัดสมุดรายวันถูกสร้าง สมุดรายวันอยู่ในสถานะที่ยังไม่ได้โพสต์ แต่ถ้าผู้ใช้ในภายหลังใช้เวิร์กโฟลว์สำหรับใบสั่งผลิตเดียวกัน จากนั้นบรรทัดจะถูกเพิ่มไปยังสมุดรายวันที่เปิด มากกว่าที่จะไปยังสมุดรายวันใหม่
-   นอกจากนี้ เวิร์กโฟลว์ใหม่ยังสนับสนุนการลงทะเบียนของหมายเลขประจำสินค้า
