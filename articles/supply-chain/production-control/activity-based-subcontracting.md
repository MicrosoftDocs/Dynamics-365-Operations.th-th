...
ใน Microsoft Dynamics 365 for Finance and Operations มีวิธีสองวิธีสำหรับการทำสัญญาย่อย: ใบสั่งผลิตภัณฑ์ และการผลิตแบบ lean ในวิธี Lean Manufacturing มีการจำลองงานที่รับเหมาย่อยเป็นบริการที่เกี่ยวข้องกับกิจกรรมของขั้นตอนการผลิต มีการแนะนำชนิดพิเศษของชนิดกลุ่มต้นทุนที่ชื่อว่า **การเอาท์ซอร์สโดยตรง** และบริการรับเหมารายย่อยไม่ใช่ส่วนหนึ่งของสูตรการผลิต (BOM) อีกต่อไป การบัญชีต้นทุนของงานที่รับเหมารายย่อยจะถูกรวมไว้ในโซลูชันการคำนวณต้นทุนสำหรับ Lean Manufacturing ทั้งหมด
