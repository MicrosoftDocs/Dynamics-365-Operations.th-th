...
เมื่อใช้สถานที่ควบคุมป้ายทะเบียน คุณสามารถเลือกว่าปริมาณที่สั่งหรือปริมาณทั้งหมดที่มีอยู่ของสินค้าควรมีการเบิกสินค้าขณะประมวลผลงานการเบิกวัตถุดิบ เพื่อตั้งค่าตัวเลือกนี้:

1. ไปยัง **การจัดการข้อมูลผลิตภัณฑ์ \> ผลิตภัณฑ์ \> ผลิตภัณฑ์ที่นำออกใช้** แล้วเปิดสินค้าที่เกี่ยวข้อง
1. ขยายแท็บด่วน **คลังสินค้า**
1. เลือกหนึ่งในตัวเลือกต่อไปนี้สำหรับฟิลด์ **การเบิกวัสดุในสถานที่ป้ายทะเบียน**
    - *การเบิกสินค้าตามใบสั่ง*: ควรเบิกสินค้าเฉพาะปริมาณที่สั่งเท่านั้น
    - *การจัดเตรียม*: เมื่อใดก็ตามที่เป็นไปได้ ปริมาณทั้งหมดที่พร้อมใช้งานที่ป้ายทะเบียนควรถูกเบิกสินค้า เพื่อให้ผู้ปฏิบัติงานสามารถเบิกปริมาณป้ายทะเบียนแบบเต็มได้ ป้ายทะเบียนต้องไม่มีสินค้าผสมและต้องไม่มีมิติผสม หากป้ายทะเบียนมีมิติหรือสินค้าผสม การเบิกสินค้าจะดําเนินการต่อไปเหมือนกับถูกตั้งค่าเป็น *การเบิกสินค้าตามใบสั่ง*
