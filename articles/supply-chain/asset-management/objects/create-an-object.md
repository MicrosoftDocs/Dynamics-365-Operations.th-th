...
description: บทความนี้จะอธิบายวิธีการสร้างสินทรัพย์ในการจัดการสินทรัพย์
...
บทความนี้จะอธิบายวิธีการสร้างสินทรัพย์ในการจัดการสินทรัพย์

1. คลิก **การจัดการสินทรัพย์** > **สินทรัพย์** > **สินทรัพย์ทั้งหมด** หรือ **สินทรัพย์ที่ใช้งานอยู่**
2. คลิกปุ่ม **สร้าง**
...
คุณสามารถเพิ่มบันทึกย่อที่เกี่ยวข้องกับสินทรัพย์บนแท็บด่วน **บันทึกย่อ** คลิกปุ่ม **เพิ่มการบันทึกเวลา** ก่อนที่คุณจะเขียนบันทึกย่อ หากคุณต้องการเพิ่มข้อมูลผู้ใช้และวันที่/การบันทึกเวลาลงในบันทึกย่อ

## <a name="attributes"></a>แอททริบิวต์

บนแท็บด่วนนี้ คุณสามารถตั้งค่าสำหรับแอททริบิวต์สินทรัพย์ แอตทริบิวต์เหล่านี้สามารถใช้เพื่ออธิบายคุณสมบัติหรือลักษณะที่เกี่ยวข้องกับสินทรัพย์ ตัวอย่างเช่น ขนาด น้ำหนัก หรือการตั้งค่าคอนฟิกเครื่อง
...
บนแท็บด่วนนี้ คุณจะได้รับภาพรวมของแผนการบำรุงรักษาที่เกี่ยวข้องกับตำแหน่งที่ทำงานที่มีการติดตั้งสินทรัพย์

## <a name="maintenance-rounds"></a>รอบการบำรุงรักษา

บนแท็บด่วนนี้ คุณสามารถเพิ่มหรือลบรอบการบำรุงรักษาซึ่งเกี่ยวข้องกับสินทรัพย์ได้
