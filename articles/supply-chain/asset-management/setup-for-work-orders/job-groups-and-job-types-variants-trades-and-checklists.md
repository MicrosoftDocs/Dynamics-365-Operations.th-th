...
29. ตั้งค่าฟิลด์บนหน้า **เอกสารแนบ** การตั้งค่าเอกสารแนบใช้ฟังก์ชันการตั้งค่าเอกสารมาตรฐานใน Microsoft Dynamics 365 for Finance and Operations
...
ในการบริหารสินทรัพย์ คุณสามารถปรับปรุงการเปลี่ยนแปลงใดๆ ไปยังการคาดการณ์ชนิดงานบำรุงรักษาได้โดยอัตโนมัติ สำหรับต้นทุนชั่วโมง ต้นทุนสินค้า และค่าใช้จ่ายที่มีการปรับปรุงในโมดูลอื่นๆ ใน Finance and Operations ด้วยวิธีนี้ คุณจะช่วยรับประกันได้ว่าการคาดการณ์ชนิดงานบำรุงรักษาของคุณจะใช้ราคาต้นทุนล่าสุดอยู่เสมอ
