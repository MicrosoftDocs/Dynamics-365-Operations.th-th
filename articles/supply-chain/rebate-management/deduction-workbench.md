...
description: บทความนี้อธิบายวิธีการใช้เวิร์กเบนซ์การหักลดเพื่อประมวลผลการชำระเงินของลูกค้าที่มีการหักลด
author: sherry-zheng
ms.date: 08/02/2021
ms.topic: article
ms.search.form: ''
...
1. ตั้งค่าฟิลด์เหล่านี้:
    ...
    - **สร้างสมุดรายวันการอ้างสิทธิ์** – ตั้งค่าตัวเลือกนี้เพื่อระบุว่าควรสร้างสมุดรายวันการอ้างสิทธิ์เมื่อมีการสร้างการอ้างสิทธิ์หรือการหักลดหรือไม่
        ...
        - *ใช่* – ระบบจะสร้างและลงรายการบัญชีสมุดรายวันทั่วไป โดยใช้สมุดรายวันการอ้างสิทธิ์ที่ตั้งค่าบนหน้า **พารามิเตอร์บัญชีลูกหนี้** (สำหรับข้อมูลเพิ่มเติม ดูที่ [ตั้งค่าคอนฟิกส่วนบัญชีลูกหนี้และการหักลด](#accounts-receivable-deductions) ก่อนหน้านี้ในบทความนี้) เมื่อมีการแนบใบแจ้งหนี้กับการอ้างสิทธิ์ สมุดรายวันการอ้างสิทธิ์จะใช้เพื่อลดยอดดุลของใบแจ้งหนี้ที่เกี่ยวข้อง หากมีการปฏิเสธการอ้างสิทธิ์ในภายหลัง สมุดรายวันการอ้างสิทธิ์และการชําระเงิน (หากมีการแนบใบแจ้งหนี้) จะถูกกลับรายการ
