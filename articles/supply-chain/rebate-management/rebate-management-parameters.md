...
description: บทความนี้อธิบายหน้าพารามิเตอร์การจัดการเงินคืน หน้านี้มีการตั้งค่าที่มีผลกระทบต่อการลงรายการบัญชี การอัพเดตสถานะ ลำดับหมายเลข และษณะการทำงานอื่นๆ
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
...
|---|---|
| ข้อเสนอการจัดการเงินคืน | ลำดับหมายเลขจะกําหนดค่าคีย์เฉพาะให้กับข้อตกลงเงินคืนแต่ละข้อตกลง คีย์นี้จะใช้เมื่อสร้างข้อตกลง |
