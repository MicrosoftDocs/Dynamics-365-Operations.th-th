...
4.  ในฟอร์ม **ใบสั่งส่งคืนสินค้า - หมายเลข RMA: %1, %2** เลือกสินค้า และจากนั้น ป้อนปริมาณค่าลบในฟิลด์ **ปริมาณ**
...
4.  ในฟอร์ม **ใบสั่งส่งคืนสินค้า - หมายเลข RMA: %1, %2** บน **บานหน้าต่างการดำเนินการ** คลิก **ค้นหาใบสั่งขาย**
...
5.  ในฟอร์ม **ใบสั่งส่งคืนสินค้า - หมายเลข RMA: %1, %2** ตรวจสอบว่า มีการสร้างใบสั่งส่งคืนสินค้าเพื่อส่งคืนสินค้าทดสอบ มีการตั้งค่าปริมาณในใบสั่งส่งคืนสินค้าเป็น -5.00
...
9.  เปิดแบบฟอร์ม **ธุรกรรมสินค้าคงคลัง** ตรวจสอบว่า การส่งคืนคิดต้นทุนที่ 7.00 ต่อชิ้น โดยใช้ค่าในฟิลด์ **ราคาต้นทุนการส่งคืน** สำหรับยอดรวมเป็น 35.00 ในฟิลด์ **ยอดต้นทุน** คุณสามารถเปิดแบบฟอร์ม **ธุรกรรมสินค้าคงคลัง** จากแบบฟอร์ม **ใบสั่งส่งคืนสินค้า - หมายเลข RMA: %1, %2** ได้ ในกริด **รายการ** คลิก **สินค้าคงคลัง** \> **ธุรกรรม**
