...
5.  ในฟอร์ม **ค้นหาใบสั่งขาย** เลือกรายการใบแจ้งหนี้ที่จะส่งคืน แล้วคลิก **ตกลง**
    ...
    บนแท็บด่วน **รายละเอียดรายการ** บนแท็บ **ทั่วไป** ฟิลด์ **รหัสล็อตการส่งคืน** แสดงค่าจากรายการขายเดิม นอกจากนี้ ฟิลด์ **ราคาต้นทุนการส่งคืน** จะแสดงมูลค่าต้นทุนจากรายการขายดั้งเดิม
...
1.  สร้าง และนำออกใช้ผลิตภัณฑ์ที่มีการตั้งชื่อว่า การทดสอบ ในฟอร์ม **รายละเอียดผลิตภัณฑ์ที่นำออกใช้** ระบุข้อมูลต่อไปนี้:
    ...
    2.  บนแท็บด่วน **ทั่วไป** ในฟิลด์ **กลุ่มแบบจำลองสินค้า** เลือก **DEF**
    
    3.  บนแท็บด่วน **ซื้อ** ในฟิลด์ **ราคา** พิมพ์ 10.00 เป็นราคาต้นทุนของสินค้า
