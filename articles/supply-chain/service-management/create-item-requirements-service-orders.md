...
4.  ในแบบฟอร์ม **ความต้องการสินค้า** ป้อนข้อมูลสำหรับสินค้าที่ต้องการ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับฟิลด์ที่ระบุ ดู [ความต้องการสินค้า (แบบฟอร์ม)](https://technet.microsoft.com/en-us/library/aa552021\(v=ax.60\))
