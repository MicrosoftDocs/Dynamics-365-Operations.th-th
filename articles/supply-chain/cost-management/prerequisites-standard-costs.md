...
# <a name="prerequisites-for-standard-costs"></a>ข้อกำหนดเบื้องต้นสำหรับต้นทุนมาตรฐาน
...
-  ใช้แท็บ **สูตรการผลิต** บนหน้า **พารามิเตอร์สินค้าคงคลัง** เพื่อกำหนดพารามิเตอร์การควบคุมต้นทุนสองตัวที่เกี่ยวข้องกับต้นทุนมาตรฐาน 
