...
ตารางต่อไปนี้จะแสดงรายการบทบาทความปลอดภัยสำเร็จรูปที่สามารถเข้าถึงแผ่นงานการคิดต้นทุน รวมทั้งระดับการเข้าถึงที่กำหนดให้กับแต่ละบทบาทโดยการตั้งค่าเริ่มต้น

| บทบาท | การเข้าถึง
|---|---|
| ผู้จัดการฝ่ายบัญชี | แก้ไข |
| เสมียนบัญชีสินค้าคงคลัง | มุมมอง |
| นักบัญชีสินค้าคงคลัง | มุมมอง |
...
นโยบายการบล็อคสองนโยบายสำหรับรุ่นการคำนวณต้นทุนกำหนดว่า ต้นทุนคงค้างสามารถรักษาไว้ได้ และสามารถเริ่มต้นทุนที่ค้างอยู่ได้ ใช้นโยบายการบล็อคเพื่ออนุญาตการบำรุงรักษาข้อมูล และป้องกันการบำรุงรักษาข้อมูลสำหรับข้อมูลต้นทุนในรุ่นการคำนวณต้นทุน 
