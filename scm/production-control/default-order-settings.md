---
title: "ตั้งค่าใบสั่งเริ่มต้นสำหรับมิติและผลิตภัณฑ์ย่อย"
...
# <a name="default-order-settings-for-dimensions-and-product-variants"></a>ตั้งค่าใบสั่งเริ่มต้นสำหรับมิติและผลิตภัณฑ์ย่อย
...
คุณสามารถกำหนดการตั้งค่าใบสั่งเริ่มต้นในหน้า **การตั้งค่าใบสั่งเริ่มต้น** เมื่อต้องการเปิดเพจนี้ ไป**การจัดการข้อมูลผลิตภัณฑ์**&gt;**ผลิตภัณฑ์**&gt;**ผลิตภัณฑ์ที่นำออกใช้**&gt;เลือกผลิตภัณฑ์นำออกใช้&gt;บน**วางแผน**หรือ *** จัดการสินค้าคงคลัง *** บานหน้าต่างการดำเนินการ&gt;**ตั้งค่าใบสั่ง**&gt;**ตั้งค่าใบสั่งเริ่มต้น**
...
เมื่อสร้างธุรกรรม คุณจำเป็นต้องระบุคำอธิบายเต็มของผลิตภัณฑ์นำออกใช้ในบรรทัดก่อน 365 Dynamics สำหรับการดำเนินการพยายามที่จะระบุการตั้งค่าใบสั่งเริ่มต้น คำอธิบายเต็มของผลิตภัณฑ์ที่นำออกใช้หมายความ ว่า หมายเลขสินค้าและมิติทั้งหมดผลิตภัณฑ์ที่ใช้งานอยู่ เช่นโครงแบบ ขนาด ลักษณะ สี ระบุไว้ในธุรกรรม ตัวอย่างเช่น ถ้าคุณสร้างบรรทัดใบสั่งซื้อสำหรับผลิตภัณฑ์ย่อยที่นำออกใช้ด้วยตนเอง คุณจำเป็นต้องระบุมิติของผลิตภัณฑ์ที่จำเป็นทั้งหมดก่อนที่ไซต์ คลังสินค้า ปริมาณ และระยะเวลารอคอยสินค้าจะแสดงโดยค่าเริ่มต้นในรายการใบสั่ง 

ไม่ใช่พารามิเตอร์การตั้งค่าใบสั่งเริ่มต้นทั้งหมดที่จะถูกนำไปใช้เมื่อมีการสร้างรายการใบสั่งหรือสมุดรายวัน ปริมาณและเวลารอคอยสินค้าจะแสดงเฉพาะ โดยค่าเริ่มต้นที่เหมาะสม ตัวอย่างเช่น เมื่อบรรทัดสมุดรายวันการตรวจนับ เฉพาะไซต์และคลังสินค้าจะแสดงตามค่าเริ่มต้นเมื่อมีสร้างบรรทัดนั้น เด่นชัดไม่มีการกำหนดค่าเริ่มต้นปริมาณ หรือเช็คในหลาย และต่ำจะดำเนินการเมื่อสร้างบรรทัด หรือลงรายการบัญชีสมุดรายวัน 

ระบบจะพยายามค้นหาไซต์เริ่มต้นและคลังสินค้าเมื่อมีการสร้างรายการใบสั่งหรือสมุดรายวันเสมอ ไซต์จะไม่แสดงตามค่าเริ่มต้นจากการตั้งค่าใบสั่งเสมอ ตัวอย่างเช่น เมื่อมีการสร้างใบสั่งขายหรือใบสั่งซื้อ ไซต์จากส่วนหน้าของใบสั่งจะถูกใช้ในรายการใบสั่งโดยอัตโนมัติ เมื่อสร้างบรรทัด BOM ไซต์จากหัวข้อ BOM การผลิต หลังจากที่มีกำหนดค่าไซต์ จะใช้ในการค้นหาไซต์ใด ๆ การตั้งค่าใบสั่งเฉพาะที่สามารถนำไปใช้เป็นค่าเริ่มต้นสำหรับคลังสินค้า 

ชนิดใบสั่งเริ่มต้น การซื้อ และระยะเวลารอคอยสินค้าคงคลังสามารถถูกแทนที่ โดยกฎความครอบคลุมของสินค้าบนการ**ความครอบคลุมสินค้า**หน้าได้ ถึงแม้ว่าการตั้งค่าใบสั่งเริ่มต้นไม่อนุญาตให้มีการแยกความแตกต่างระหว่างการผลิตและเวลารอคอยสินค้าโอนย้าย กฎความครอบคลุมสินค้าที่อนุญาตนั้น อย่างไรก็ตาม การตั้งค่าความครอบคลุมสินค้าจะสามารถใช้ได้โดย MRP เมื่อมีการสร้างแผนการใบสั่งผลิตและแผนการใบสั่งย้าย และจะไม่นำไปใช้เมื่อมีการสร้างแผนการใบสั่งผลิตและแผนการใบสั่งย้ายด้วยตนเอง 
...
สำหรับผลิตภัณฑ์เฉพาะที่นำออกใช้ คุณสามารถกำหนดการตั้งค่าใบสั่งทั่วไปหรือการตั้งค่าใบสั่งเฉพาะไซต์ การตั้งค่าใบสั่งทั่วไปจะมีการจัดอันดับเป็นศูนย์เสมอ ถ้าคุณตั้งค่าใบสั่งซื้อ ขาย และสินค้าคงคลังใหม่พร้อมกันในเวลาเดียวกัน เราขอแนะนำให้คุณใช้ **มุมมองรายละเอียด** ในหน้า **การตั้งค่าใบสั่งเริ่มต้น** เมื่อต้องการสลับไปยังมุมมองรายละเอียด ไป**ตัวเลือก**บานหน้าต่างการดำเนินการ&gt;**หน้าตัวเลือก**&gt;**เปลี่ยนมุมมอง**&gt;**รายละเอียดมุมมอง**

### <a name="site-specific-order-settings"></a>การตั้งค่าใบสั่งเฉพาะไซต์

เมื่อต้องการสร้างการตั้งค่าใบสั่งเฉพาะไซต์ คลิก **สร้าง** ใน**รายละเอียดมุมมอง**กรอกข้อมูลในไซต์ในแบบ**ใช้ได้สำหรับการตั้งค่า**&gt;**ไซต์**เขตข้อมูล ใน **มุมมองกริด**กรอกข้อมูลในไซต์ในคอลัมน์ **ไซต์** กฎใหม่จะได้รับการจัดอันดับค่าใหม่โดยอัตโนมัติที่สูงกว่าศูนย์ คุณสามารถสร้างกฎเฉพาะไซต์ได้มากเท่าที่จำเป็น และคุณสามารถกำหนดอันดับเดียวกันให้กับกฎเฉพาะไซต์ทั้งหมดได้ เพื่อเป็นแบบจำลองว่าทุกรายการมีความสำคัญเท่าๆ กัน 

ถ้าคุณอยู่ใน **มุมมองรายละเอียด**คุณไม่สามารถเรียกดูภาพรวมของกฎที่สร้างขึ้นสำหรับสินค้าได้ สลับปุ่ม **แสดง/ซ่อนรายการ** เพื่อดูข้อมูลภาพรวม เมื่อมีสร้างบรรทัดใบสั่งทุกชนิด และมีไซต์ไม่มี 365 Dynamics สำหรับการดำเนินงานค้นหากฎ ด้วยไม่มีไซต์ที่ระบุ ซึ่งสามารถช่วยตรวจสอบไซต์เริ่มต้นในบรรทัดใบสั่ง ไซต์นี้ถูกใช้เพื่อค้นหากฎเฉพาะไซต์โดยอาจมีการตั้งค่าคลังสินค้าเริ่มต้นไว้ คลังสินค้านี้จะใช้กับรายการใบสั่ง
...
|                                                     |                                         |
|-----------------------------------------------------|-----------------------------------------|
| **Product name**                                    | เซ็นเซอร์ photoelectric                    |
| **Item number**                                     | XW56                                    |
...
ระบบจะข้ามชุดของกฎสองครั้งเพื่อกำหนดไซต์และคลังสินค้า เมื่อมีสร้างบรรทัดใบสั่งซื้อสำหรับการตั้งค่าคอนฟิก C1 ลักษณะ R2 ไซต์จะถูกกำหนดตามกฎด้วยอันดับ 10 จากนั้น ระบบค้นหากฎสำหรับไซต์ 2 เพื่อกำหนดคลังสินค้า จะพบกฎที่ 20 และเนื่องจากกฎดังกล่าวมีอันดับสูงกว่า คลังสินค้าบนรายการใบสั่งซื้อจะเป็น 22 ไม่ใช่ 21 
...
หมายเลขของกฎที่สร้างขึ้นสำหรับผลิตภัณฑ์ที่นำออกใช้อาจมีหลายรายการ เมื่อต้องการทราบเกี่ยวกับแต่ละกฎที่จะแทนที่ และเหตุผลที่จำเป็นมากขึ้น เราแนะนำให้ใช้ **มุมมองกริด** ในหน้า **การตั้งค่าใบสั่งเริ่มต้น** คุณสามารถเปิดใช้งานมุมมองเส้นตาราง โดยไป**ตัวเลือก**บานหน้าต่างการดำเนินการ&gt;**หน้าตัวเลือก**&gt;**เปลี่ยนมุมมอง**&gt;**มุมมองกริด**ได้ จำนวนของคอลัมน์ที่แสดงในกริดอาจมีความสำคัญมาก โดยเฉพาะอย่างยิ่งสำหรับแท็บการขายและสินค้าคงคลัง เมื่อต้องการจำกัดจำนวนของคอลัมน์ที่แสดงในตาราง กลุ่มของคอลัมน์ที่สามารถซ่อน หรือแสดง โดยการใช้ปุ่มบนแบบ**ตั้งค่าใบสั่งเริ่มต้น**&gt;**แสดงคอลัมน์**เมนูได้
