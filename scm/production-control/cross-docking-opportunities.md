---
title: "การส่งสินค้าผ่านศูนย์เปลี่ยนถ่ายสินค้าจากใบสั่งผลิตไปยังท่าสินค้าขาออก | Microsoft Docs"
...
ตัวอย่างต่อไปนี้แสดง ความแตกต่างสามประการของขั้นตอนที่เริ่มต้นที่จุดสิ้นสุดของสายการผลิต (2)

ผลิตภัณฑ์จะถูกรายงานเป็นเสร็จสมบูรณ์ไปยังที่ตั้งเอาท์พุทการผลิต (3) และพนักงานขับรถยกของจะเบิกแท่นวางสินค้าในที่ตั้งนี้ (3)

-   ถ้าไม่มีกิจกรรมที่วางแผนไว้ (6) สำหรับการโอนย้ายผลิตภัณฑ์จากการผลิต (1) ไปยังศูนย์กระจายสินค้า (7) แล้วคนขับรถบรรทุกจะได้รับการเปลี่ยนเส้นทางโดยระบบเพื่อวางแท่นวางสินค้าตามที่ตั้งพื้นที่ประตู (4)
-   หากรถเทรลเลอร์ได้ถูกมอบหมายให้ไปยังพื้นที่ประตูแล้ว คนขับรถบรรทุกจะได้รับการเปลี่ยนเส้นทางให้ไปโหลดผลิตภัณฑ์โดยตรงที่รถเทรลเลอร์
-   ถ้าไม่มีกิจกรรมที่วางแผนไว้สำหรับการโอนย้ายผลิตภัณฑ์ พนักงานขับรถยกของจะได้รับการเปลี่ยนเส้นทางให้สำรองผลิตภัณฑ์ไว้ในที่ตั้งในคลังสินค้าภายใน (5)
...
6.  สร้างใบสั่งโอนย้าย  สร้างใบสั่งโอนย้ายสำหรับสินค้าหมายเลข L0101 ปริมาณ = 20
...
หลังจากที่ผลิตภัณฑ์ถูกรายงานเป็นเสร็จสมบูรณ์ที่สายการผลิต จะถูกโอนย้ายไปยังตำแหน่งพื้นที่ประตู ที่ถูกระบุโดยกำหนดการนัดหมายสำหรับตำแหน่งพื้นที่ประตู ใช้ USMF ของบริษัท
...
6.  สร้างใบสั่งผลิตสำหรับสินค้าหมายเลข **L0101** และตั้งค่าสถานะเป็น **เริ่มต้นแล้ว** ที่มีปริมาณเป็น 20
...
-   ปริมาณที่จะรายงานเป็นเสร็จสมบูรณ์ไม่สามารถถูกแบ่งไปยังความต้องการใบสั่งโอนย้ายที่อยู่ด้านล่างได้ ตัวอย่างเช่น ถ้าสินค้า 20 ชิ้นถูกรายงานเป็นเสร็จสมบูรณ์ และใบสั่งโอนย้ายมีอยู่สำหรับสินค้า 5 ชิ้น จากนั้นจะไม่พบใบสั่งโอนย้ายที่เกี่ยวข้องกับการส่งสินค้าผ่านศูนย์เปลี่ยนถ่ายสินค้า
