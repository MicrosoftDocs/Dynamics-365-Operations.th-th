---
title: "ภาพรวมของการผลิตแบบ lean"
description: "บทความนี้แสดงภาพรวมและคำอธิบายเกี่ยวกับลักษณะการทำงานของการผลิตแบบ Lean ใน Microsoft Dynamics AX"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="lean-manufacturing-overview"></a>ภาพรวมของการผลิตแบบ lean

บทความนี้แสดงภาพรวมและคำอธิบายเกี่ยวกับลักษณะการทำงานของการผลิตแบบ Lean ใน Microsoft Dynamics AX
...
สถาปัตยกรรมของ lean manufacturing ใน Microsoft Dynamics AX 7 ประกอบด้วยขั้นตอนการผลิต กิจกรรม และกฎคัมบัง โครงสร้างเหล่านี้จะถูกรวมเข้ากับกระบวนการ Microsoft Dynamics AX 7 คุณสามารถใช้ lean manufacturing ในสภาพแวดล้อมการผลิตโหมดผสมที่รวมอุปทานต่างๆ การผลิต และกลยุทธ์การจัดหา กลยุทธ์เหล่านี้รวมถึงใบสั่งผลิต ใบสั่งชุดงานสำหรับอุตสาหกรรมกระบวน ใบสั่งซื้อ และใบสั่งโอนย้าย
| **สำคัญ **                                                                                                                                                                                                                                                                |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| คุณสามารถใช้ Microsoft Dynamics AX 7 เพื่อสนับสนุนการใช้งานของ lean manufacturing กับคัมบัง อย่างไรก็ตาม ความสำเร็จของการใช้งานของหลักการ lean ขึ้นอยู่กับกระบวนการทางธุรกิจภายในที่คุณใช้ และเงื่อนไขการผลิตที่แท้จริง และสภาพแวดล้อม |
...
-   **ปริมาณคงที่** กฎคัมบังเกี่ยวข้องกับจำนวนคงที่ของหน่วยจัดการวัสดุ ซึ่งหมายความว่าจำนวนคัมบังที่ใช้งานอยู่นั้นคงที่ เมื่อใดก็ ตามที่มีใช้ผลิตภัณฑ์ทั้งหมดจากคัมบัง และหน่วยจัดการวัสดุเป็นว่างด้วยตนเอง คัมบังใหม่ของชนิดเดียวกันจะถูกสร้างขึ้น เมื่อคุณสร้างปริมาณคงที่กฎคัมบัง คุณสามารถคำนวณปริมาณตามระบบคัมบังที่ดีที่สุดและปริมาณของผลิตภัณฑ์ที่ใช้ การคำนวณจะพิจารณาถึงการคาดการณ์ ความต้องการจริงจากใบสั่งที่เปิดไว้ ระยะเวลารอคอยในการเติมสินค้า และความต้องการในอดีต
...
## <a name="kanban-jobs-and-integration-with-microsoft-dynamics-ax-processes"></a>งานคัมบังและการรวมกับกระบวนการ Microsoft Dynamics AX
งานคัมบังที่ถูกรวมเข้ากับกระบวนการปัจจุบันโดยสมบูรณ์สำหรับธุรกรรมสินค้าคงคลังใน Microsoft Dynamics AX
