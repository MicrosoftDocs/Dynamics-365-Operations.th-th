...
การดำเนินการผลิตมีวัตถุประสงค์ที่จะใช้ในบริษัทผู้ผลิตเป็นหลัก ผู้ปฏิบัติงานสามารถลงทะเบียนเวลาและสิ่งของที่ใช้ในงานการผลิต โดยใช้หน้า **ลงทะเบียนงาน** ได้ ลงทะเบียนทั้งหมดได้รับการอนุมัติ และถูกโอนย้ายไปโมดูลที่เกี่ยวข้องในภายหลัง การอนุมัติแบบต่อเนื่องและการโอนย้ายการลงทะเบียนช่วยให้ผู้จัดการสามารถติดตามต้นทุนจริงในใบสั่งผลิตได้โดยง่าย
...
| เงื่อนไข                          | คำอธิบาย                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| การดำเนินการผลิต       | ฟังก์ชันที่ใช้ในการลงทะเบียนเวลา ปริมาณการใช้วัตถุดิบ ต้นทุนเกี่ยวกับงานการผลิต โครงการ และกิจกรรมทางอ้อม การลงทะเบียนจะกระทำในไคลเอนต์การลงทะเบียนการดำเนินการผลิต                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   **ลงทะเบียนค่าธรรมเนียมโครงการและสินค้าในโครงการ**(ใช้ได้กับเวลาและการเข้างาน) – ผู้ปฏิบัติงานสามารถลงทะเบียนค่าธรรมเนียม (ค่าใช้จ่าย) ที่เกี่ยวข้องกับโครงการในโครงการค่าธรรมเนียมสมุดรายวัน เช่นระยะไมล์และบริดจ์โทร ได้ ผู้ปฏิบัติงานสามารถลงทะเบียนปริมาณการใช้สินค้าในโครงการ ซึ่งทำได้ในสมุดสินค้าโครงการ
