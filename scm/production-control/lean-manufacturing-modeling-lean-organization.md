---
title: "สร้างโมเดลองค์กรแบบ lean"
...
# <a name="modeling-a-lean-organization"></a>สร้างโมเดลองค์กรแบบ lean
...
## <a name="semifinished-products-nonbom-levels"></a>ผลิตภัณฑ์ทึ่ (ระดับ nonBOM)
...
สำหรับการใช้งานของการผลิตแบบ Lean สำหรับ Dynamics AX เราเลือกผลิตกิจกรรมและขั้นตอนวิธีการแบบที่ช่วยให้สถานการณ์การผลิตแบบง่าย และแบบซับซ้อนเพื่อสร้างแบบจำลองในสถาปัตยกรรมสามารถต่อขยายเดียว แนวคิดเกี่ยวกับกิจกรรมแสดงให้เห็นความเรียบง่ายแบบใหม่สำหรับผู้ใช้ที่จำเป็นต้องมีนั้น: การผลิตและผู้ปฏิบัติงานโลจิสทิก ด้วยการรายงานโดยเทียบกับงานที่ขึ้นกับกิจกรรม แทนที่จะเป็นธุรกรรมสินค้าคงคลัง อินเทอร์เฟสผู้ใช้รวมสำหรับตัวแปรการผลิตแบบ lean จะโอนย้ายความซับซ้อนของธุรกิจจากอินเทอร์เฟสผู้ใช้ไปที่ที่เหมาะสม: ขั้นตอนการผลิตเป็นแกนหลักของการผลิตแบบ lean
