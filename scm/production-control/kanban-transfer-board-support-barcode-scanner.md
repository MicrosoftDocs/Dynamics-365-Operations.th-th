---
title: "บอร์ดการโอนย้ายคัมบังที่สนับสนุนสำหรับบาร์โค้ดสแกนเนอร์"
...
# <a name="kanban-transfer-board-support-for-barcode-scanners"></a>บอร์ดการโอนย้ายคัมบังที่สนับสนุนสำหรับบาร์โค้ดสแกนเนอร์
...
เมื่อคุณใช้ตัวอ่านบาร์โค้ดเพื่อเลือกงาน โหมดการแสดงผลของการเปลี่ยนแปลงในบอร์ดคัมบัง ในโหมดนี้ ใช้เงื่อนไขต่อไปนี้:
...
-   คุณสามารถปรับปรุงข้อมูลในรายการงานด้วยตนเอง โดยการคลิก**รีเฟรช**(Shift + F5) ในบานหน้าต่างการกระทำได้ หลังจากที่คุณรีเฟรชข้อมูล ผลลัพธ์แบบเต็มสำหรับตัวกรองงานถูกแสดงผลอีกครั้ง
