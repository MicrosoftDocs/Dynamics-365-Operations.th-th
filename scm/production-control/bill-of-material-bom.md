...
description: "บทความนี้แสดงข้อมูลเกี่ยวกับรายการวัสดุและส่วนประกอบ (Bom) และสูตร ซึ่งเป็นส่วนหนึ่งของข้อกำหนดของผลิตภัณฑ์และผลิตภัณฑ์ย่อยส่วนกลาง Bom และสูตรระบุวัสดุที่จำเป็นหรือส่วนผสมสำหรับผลิตภัณฑ์เฉพาะ สูตรยังระบุสินค้าร่วมและสินค้าพลอยได้ที่ได้รับในบริบทการผลิตเฉพาะ"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
บทความนี้แสดงข้อมูลเกี่ยวกับรายการวัสดุและส่วนประกอบ (Bom) และสูตร ซึ่งเป็นส่วนหนึ่งของข้อกำหนดของผลิตภัณฑ์และผลิตภัณฑ์ย่อยส่วนกลาง Bom และสูตรระบุวัสดุที่จำเป็นหรือส่วนผสมสำหรับผลิตภัณฑ์เฉพาะ สูตรยังระบุสินค้าร่วมและสินค้าพลอยได้ที่ได้รับในบริบทการผลิตเฉพาะ 
...
BOM เป็นเอนทิตีแต่ละตัวที่มีอธิบาย โดยใช้ข้อมูลต่อไปนี้:
...
สูตรคือชนิดย่อยของ BOM ที่ใช้โดยทั่วไปสำหรับกระบวนการผลิต นอกเหนือจากส่วนประกอบและส่วนผสม สูตรอธิบายถึงผลิตภัณฑ์ร่วมและสินค้าพลอยได้ ในรุ่นเกิดขึ้นจริง คำนิยามของสินค้าร่วมและสินค้าพลอยได้ของสูตรจำเป็นต้องใช้เวอร์ชันสูตร โดยทั่วไปจะมีกำหนดสูตรสำหรับหนึ่งเฉพาะผลิตภัณฑ์สำเร็จรูป (สูตรหรือวางแผนสินค้า) ที่กำหนดไว้ในเวอร์ชันสูตร
...
ชนิดของ BOM ที่ใช้ในการดำเนินการจริงขึ้นอยู่กับการใช้งาน และ ในสถานการณ์ทางธุรกิจและความต้องการ ในการใช้งานอย่างง่าย การวางแผน BOM, การผลิต BOM และการคำนวณต้นทุน BOM อาจเป็นแบบจำลองของ BOM หนึ่ง ในสภาพแวดล้อมที่มีการเปลี่ยนแปลงทางวิศวกรรมที่ใช้บ่อยและหลายกระบวนการสำรอง ชุดที่ชนิด BOM ที่ใหญ่กว่าอาจจะจำเป็นต้องใช้
...
เพื่อที่จะตั้งค่าเฉพาะ BOM หรือสูตรเป็นค่าเริ่มต้นรุ่น BOM หรือรุ่นสูตรที่ถูกจะใช้โดยการวางแผนหลักหรือถูกใช้เพื่อสร้างใบสั่งผลิต คุณต้องเรียกใช้รุ่นดังกล่าว เมื่อมีการเรียกใช้เวอร์ชัน มีการตรวจสอบที่ไม่ซ้ำกันของเวอร์ชันสำหรับข้อจำกัดที่ระบุ (ตัวอย่างเช่น รอบระยะเวลา ไซต์ หรือปริมาณ) คุณได้รับข้อผิดพลาดถ้าเป็นรุ่นที่คุณกำลังพยายามเรียกใช้งานข้อขัดแย้งกับรุ่นที่ทำงานอยู่แล้ว จากนั้นคุณต้องยกเลิกรุ่นที่ขัดแย้งหรือปรับเปลี่ยนข้อจำกัดของรุ่น (โดยปกติคือรอบระยะเวลา) เพื่อป้องกันการเรียกใช้ไม่ชัดเจน
