...
description: "บทความนี้ให้ภาพรวมของกระบวนการผลิต จะอธิบายขั้นต่าง ๆ ของใบสั่งผลิต ใบสั่งชุดงาน และคัม บัง ตั้งแต่การสร้างใบสั่งการปิดบัญชีของรอบระยะเวลาทางการเงิน"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
บทความนี้ให้ภาพรวมของกระบวนการผลิต จะอธิบายขั้นต่าง ๆ ของใบสั่งผลิต ใบสั่งชุดงาน และคัม บัง ตั้งแต่การสร้างใบสั่งการปิดบัญชีของรอบระยะเวลาทางการเงิน 
...
การ**ควบคุมการผลิต**โมดูลจะเชื่อมโยงกับโมดูลอื่น เช่น**การจัดการข้อมูลผลิตภัณฑ์**,**บริหารสินค้าคงคลัง**,**บัญชีแยกประเภททั่วไป**,**การบริหารคลังสินค้า**,**บัญชีโครงการ**และ**จัดการองค์กร** การรวมนี้สนับสนุนลำดับการเคลื่อนย้ายของข้อมูล ซึ่งจำเป็นต่อการผลิตสินค้าสำเร็จรูปให้เสร็จสมบูรณ์  

กระบวนการผลิตโดยทั่วไปจะมีผลมาจากวิธีการลงบัญชีต้นทุนและการประเมินค่าสินค้าคงคลัง ที่ถูกเลือกสำหรับกระบวนการผลิตเฉพาะ Dynamics 365 สำหรับการดำเนินงานสนับสนุนทั้งต้นทุนจริง (ครั้งแรก ใน ก่อนออก\[FIFO\]สุดท้ายใน ก่อนหมด\[LIFO\]ค่าเฉลี่ยเคลื่อนที่ และค่าเฉลี่ยถ่วงน้ำหนักเป็นครั้งคราว) และวิธีการต้นทุนมาตรฐาน lean manufacturing ถูกนำมาใช้ตามหลักการการคิดต้นทุนแบบย้อนกลับ  
...
ผลิตภัณฑ์แตกต่างกันและโทโพโลยีการผลิตต้องการแอพลิเคชันของชนิดใบสั่งที่แตกต่างกัน Dynamics 365 สำหรับการดำเนินงานสามารถใช้ชนิดใบสั่งต่าง ๆ ในโหมดผสม กล่าวอีกอย่างคือ ชนิดใบสั่งทั้งหมดอาจเกิดขึ้นในระหว่างกระบวนการตั้งแต่ต้นจนจบของการผลิตผลิตภัณฑ์สำเร็จรูปหนึ่ง
...
2.  **ประเมินแล้ว**– คุณสามารถคำนวณการประเมินสำหรับปริมาณการใช้วัสดุและทรัพยากรได้ การประเมินสร้างธุรกรรมสินค้าคงคลังสำหรับวัตถุดิบที่มีสถานะเป็น **อยู่ระหว่างการสั่ง** การรับสินค้าสำหรับผลิตภัณฑ์หลัก ร่วม และสินค้าพลอยได้ถูกสร้างขึ้นเมื่อใบสั่งผลิต หรือใบสั่งชุดงานมีประเมิน ถ้า BOM ประกอบด้วยบรรทัดของการ**ที่กำหนดอุปทาน**พิมพ์ ใบสั่งซื้อสำหรับวัตถุดิบ หรือบริการรับเหมารายย่อยดำเนินการจะถูกสร้างขึ้น และที่กำหนดไปยังใบสั่งผลิตหรือใบสั่งชุดงาน มีการจองสินค้าหรือใบสั่งตามกลยุทธ์การจองของใบสั่งผลิต และราคาของสินค้าสำเร็จรูปจะถูกคำนวณตามการตั้งค่าพารามิเตอร์
...
5.  **เตรียม**/**เบิกสินค้าแล้ว**– เมื่อวัสดุและทรัพยากรทั้งหมดได้ถูกแบ่งระยะที่ตั้งการผลิต บรรทัด BOM การผลิต หรืออัพเดตการคัมบังเป็นสถานะ**เบิกสินค้าแล้ว** ใบสั่งการจัดหาวัสดุที่มีการเชื่อมโยงความต้องการกับการจัดซื้อและงานของคลังสินค้าที่เกี่ยวข้อง โดยทั่วไปจะเสร็จสมบูรณ์ในขั้นตอนนี้ บัตรคัมบังหรือบัตรงานที่จำเป็นต่อการรายงานความคืบหน้าของการผลิตควรจะถูกกำหนดและพิมพ์
