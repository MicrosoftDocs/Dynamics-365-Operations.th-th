---
title: "สำหรับความครอบคลุมไซต์ คลังสินค้าบังคับการวางแผนหลัก"
...
# <a name="master-planning-for-site-coverage-mandatory-warehouse"></a>สำหรับความครอบคลุมไซต์ คลังสินค้าบังคับการวางแผนหลัก
...
-   ใบสั่งประเภทใบสั่งเริ่มต้นถูกตั้งค่าเป็นการผลิต ใบสั่งซื้อ หรือคัมบัง คลิ**การจัดการข้อมูลผลิตภัณฑ์&gt;ผลิตภัณฑ์&gt;ผลิตภัณฑ์ที่นำออกใช้** เลือกสินค้า และจากนั้น คลิก**วางแผน&gt;ตั้งค่าใบสั่งเริ่มต้น** ในฟอร์ม **การตั้งค่าใบสั่งเริ่มต้น** ดูฟิลด์ **ประเภทใบสั่งเริ่มต้น**
...
[หลักการวางแผน - ความครอบคลุมของไซต์ คลังสินค้าบังคับ](master-plan-site-coverage-warehouse-mandatory.md)
