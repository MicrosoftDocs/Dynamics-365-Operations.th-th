...
สินค้าคงคลังที่มีการส่งมอบคือสินค้าคงคลังที่เป็นเจ้าของโดยผู้จัดจำหน่าย แต่เก็บอยู่ที่ไซต์ของคุณ เมื่อคุณพร้อมที่จะใช้หรือใช้สินค้าคงคลัง คุณจะต้องเป็นเจ้าของสินค้าคงคลังดังกล่าว หัวข้อนี้ประกอบด้วยข้อมูลเกี่ยวกับวิธีการเป็นเจ้าของผู้จัดจำหน่ายสินค้าคงคลังคงเหลือได้รับทางกายภาพ โดยไม่มีการสร้างธุรกรรมบัญชีแยกประเภททั่วไป วิธีการเริ่มต้นกระบวนการผลิตที่เป็นเจ้าของผู้จัดจำหน่ายสินค้าคงคลังสามารถจริงจอง และวิธีการเปลี่ยนการเป็นเจ้าของการจัดหาวัตถุดิบเพื่อให้สามารถประมวลผลปริมาณการใช้วัสดุที่เป็นส่วนหนึ่งของการประมวลผลใบสั่งผลิต นอกจากนี้ยังมีข้อมูลบางอย่างเกี่ยวกับวิธีการที่ผู้จัดจำหน่ายสามารถตรวจสอบปริมาณการใช้ของสินค้าคงคลังของพวกเขาโดยใช้อินเทอร์เฟสการทำงานร่วมกันกับผู้จัดจำหน่าย ดูข้อมูลเกี่ยวกับวิธีการเปิดใช้งานและตั้งค่าคอนฟิกกระบวนการส่งมอบขาเข้าที่ [การตั้งค่าการส่งมอบ](set-up-consignment.md)
...
[![-ความเป็นเจ้าของเปลี่ยนแปลงสมุดรายวันสต็อก](./media/inventory-ownership-change-journal.png)](./media/inventory-ownership-change-journal.png)
...
-   **ใบสั่งซื้อ****ใช้สินค้าคงคลังในการส่งมอบ**-แสดงรายละเอียดที่เกี่ยวข้องกับการเปลี่ยนแปลงความเป็นเจ้าของจากกระบวนการส่งมอบข้อมูลของใบสั่งซื้อ
