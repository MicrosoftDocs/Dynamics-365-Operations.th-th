...
# <a name="nonconformance-management"></a>จัดการไม่สอดคล้องกัน
...
[สร้าง และประมวลผลที่สอดคล้องกัน (แนะนำงาน)](https://ax.help.dynamics.com/en/wiki/create-and-process-a-nonconformance/)

[Quality management processes](quality-management-processes.md)

[ตั้งค่าข้อกำหนดเบื้องต้นสำหรับการจัดการสอดคล้อง (แนะนำงาน)](https://ax.help.dynamics.com/en/wiki/set-up-prequisites-for-nonconformance-management/)
