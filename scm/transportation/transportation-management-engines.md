...
|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *RateBaseAssigner*    | ชนิด .NET ที่แปลข้อมูลกำหนดฐานอัตราสำหรับเค้าร่างเฉพาะ ไวยากรณ์ของค่าพารามิเตอร์ประกอบด้วยสอง(แถบของเซ็กเมนต์ที่แบ่ง ด้วยตามแนวตั้ง|). เซ็กเมนต์แรกประกอบด้วยชื่อแอสเซมบลีที่กำหนดชนิดตัวกำหนด  เซ็กเมนต์ที่สองกำหนดชื่อเต็มของชนิดตัวกำหนด ซึ่งรวมถึง namespace ของชนิด |
...
-   กำหนดรายละเอียดนี้ใน**การจัดการขนส่ง**&gt;**ตั้งค่า**บน**อันดับชนิดพื้นฐาน**หน้า
