...
กลไกจัดการการขนส่งคำนวณงานต่างๆ เช่น อัตราการขนส่งของผู้ขนส่ง  ระบบกลไกจัดการช่วยให้คุณสามารถเปลี่ยนกลยุทธ์การคำนวณในช่วงรันไทม์ ขึ้นอยู่กับข้อมูลใน Microsoft Dynamics 365 for Operations กลไกจัดการการจัดการการขนส่งคล้ายกับปลั๊กอินที่เกี่ยวข้องกับสัญญาเฉพาะผู้ขนส่ง

## <a name="what-engines-are-available"></a>กลไกจัดการใดที่สามารถใช้ได้
ตารางต่อไปนี้แสดงกลไกจัดการการจัดการการขนส่งที่มีอยู่ใน Microsoft Dynamics 365 for Operations

| กลไกจัดการการจัดการขนส่ง | คำอธิบาย                                                                                                                                                                                                                                                                                                                 |
|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **กลไกจัดการอัตรา**                  | คำนวณอัตรา                                                                                                                                                                                                                                                                                                           |
| **กลไกจัดการทั่วไป**               | กลไกจัดการเสริมแบบง่ายที่ใช้โดยกลไกจัดการอื่นๆ ที่ไม่ต้องการข้อมูลจาก Microsoft Dynamics 365 for Operations ตัวอย่างเช่น กลไกจัดการการแบ่งตามส่วน กลไกจัดการการแบ่งตามส่วนถูกใช้เพื่อลดต้นทุนขั้นสุดท้ายของการขนส่งกับใบสั่งและรายการเฉพาะ ตามมิติ เช่น ปริมาณและน้ำหนัก |
...
เพื่อกำหนดอัตราการจัดส่งโดยการใช้ผู้ขนส่งที่ระบุ คุณต้องตั้งค่ากลไกจัดการการจัดการขนส่งหลายรายการ 
          **กลไกจัดการอัตรา** ถูกระบุ แต่กลไกจัดการการจัดการขนส่งอาจอาจต้องใช้เพื่อสนับสนุน **กลไกจัดการอัตรา** ตัวอย่างเช่น **กลไกจัดการอัตรา** สามารถใช้เพื่อดึงข้อมูลจาก **กลไกจัดการระยะไมล์** เพื่อ คำนวณอัตราที่ยึดตามระยะไมล์ระหว่างต้นทางและปลายทางได้
...
| *MileageEngineCode*   | รหัสกลไกจัดการระยะไมล์ที่ระบุเรกคอร์ดกลไกจัดการระยะไมล์ในฐานข้อมูล Microsoft Dynamics 365 for Operations                                                                                                                                                                                                                                                             |
| *ApportionmentEngine* | รหัสกลไกจัดการทั่วไปที่ระบุกลไกจัดการการแบ่งตามส่วนในฐานข้อมูล Microsoft Dynamics 365 for Operations                                                                                                                                                                                                                                                              |

 
<a name="how-is-metadata-used-in-transportation-management-engines"></a>ข้อมูลเมตาจะใช้ในกลไกจัดการการจัดการขนส่งอย่างไร
----------------------------------------------------------

กลไกจัดการการจัดการขนส่งที่ขึ้นอยู่กับข้อมูลที่กำหนดไว้ใน Dynamics 365 for Operations อาจใช้เค้าร่างข้อมูลที่แตกต่างกัน ระบบการจัดการขนส่งช่วยให้กลไกจัดการการจัดการขนส่งแตกต่างกันใช้ตารางฐานข้อมูลที่มีอยู่จริงทั่วไปเดียวกัน เพื่อให้แน่ใจว่าการแปลรันไทม์ของข้อมูลกลไกจัดการถูกต้อง คุณสามารถกำหนดข้อมูลเมตาสำหรับตารางฐานข้อมูล ซึ่งลดต้นทุนของการสร้างกลไกจัดการการจัดการการขนส่งใหม่ เนื่องจากตารางเพิ่มเติมและโครงสร้างแบบฟอร์มไม่จำเป็นใน Operations

## <a name="what-can-be-used-as-search-data-in-rate-calculations"></a>สิ่งใดที่สามารถใช้เป็นข้อมูลการค้นหาในการคำนวณอัตรา
ข้อมูลที่คุณใช้เมื่อคุณคำนวณอัตราใน Microsoft Dynamics 365 for Operations จะถูกควบคุม โดยการตั้งค่าคอนฟิกข้อมูลเมตา ตัวอย่างเช่น ถ้าคุณต้องการค้นหาอัตราให้ขึ้นอยู่กับรหัสไปรษณีย์ คุณต้องตั้งค่าข้อมูลเมตาให้ขึ้นอยู่กับชนิดการค้นหาของรหัสไปรษณีย์
...
| **หมายเหตุ**                                                                                                                                                                                                                                                                                                                                                                     |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| กลไกจัดการการจัดการขนส่งที่จัดส่งกับ Microsoft Dynamics 365 for Operations ขึ้นอยู่กับข้อมูลที่ดึงมาจากแอพลิเคชัน กลไกจัดการที่เชื่อมต่อกับระบบภายนอกไม่ได้รวมอยู่กับ Operations อย่างไรก็ตาม แบบจำลองการขยายตามแบบกลไกการจัดการให้คุณสร้างส่วนขยายโดยการใช้ Microsoft Dynamics 365 for Operations Visual Studio Tools |
