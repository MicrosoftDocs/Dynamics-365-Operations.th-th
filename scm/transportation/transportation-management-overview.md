...
description: "หัวข้อนี้ให้ภาพรวมของฟังก์ชันการจัดการขนส่งใน Microsoft Dynamics 365 for Operations"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
หัวข้อนี้ให้ภาพรวมของฟังก์ชันการจัดการขนส่งใน Microsoft Dynamics 365 for Operations
...
## <a name="planning-transportation-in-dynamics-365-for-operations"></a>การวางแผนการขนส่งใน Dynamics 365 for Operations
...
เมื่อคุณสั่งสินค้าจากผู้จัดจำหน่าย และจำเป็นต้องส่งสินค้าไปยังคลังสินค้าของคุณ คุณอาจต้องการจัดเตรียมการขนส่งสินค้าด้วยตัวคุณเอง คุณสามารถใช้ Dynamics 365 for Operations สำหรับการวางแผนการขนส่งและการรับการบรรทุกขาเข้า ภาพประกอบต่อไปนี้ แสดงลำดับกระบวนการทางธุรกิจสำหรับการวางแผนการขนส่งการบรรทุกขาเข้า 
