...
**หมายเหตุ:**ในรุ่นก่อนหน้านี้ ข้อตกลงการขายถูกอ้างอิงเป็นใบสั่งขายแบบครอบคลุม
...
| CurrencyDiscount, percentDiscountUnit, pricePrice, unitNet ยอดเงิน | ถ้าคุณเปลี่ยนค่าในฟิลด์เหล่านี้ และเลือกกล่องกาเครื่องหมาย **ราคาและส่วนลดเป็นแบบคงที่** ในบรรทัดข้อตกลงการขายถูกเชื่อมโยงไว้ กล่องข้อความจะเตือนคุณให้บันทึกการเปลี่ยนแปลง คลิ**ใช่**เมื่อต้องการเอาการเชื่อมโยงกับบรรทัดข้อตกลงการขาย และคำนวณราคา คลิ**ไม่ใช่**เมื่อต้องการเอาการเชื่อมโยงกับบรรทัดข้อตกลงการขาย โดยไม่มีการคำนวณราคา                                                                   |
| ยอดเงินสุทธิ                                                        | ถ้าคุณระบุยอดเงินที่เกินกว่ายอดเงินที่ระบุในรายการข้อตกลงการขาย ที่กล่องกาเครื่องหมายถูกเลือก **บังคับใช้ค่าสูงสุด** กล่องข้อความจะเตือนคุณให้บันทึกจำนวนเงินที่เปลี่ยนแปลง คลิ**ใช่**เมื่อต้องการเอาการเชื่อมโยงกับบรรทัดข้อตกลงการขาย และคำนวณราคา คลิ**ไม่ใช่**เมื่อต้องการเอาการเชื่อมโยงกับบรรทัดข้อตกลงการขาย โดยไม่มีการคำนวณราคา                                                                 |
| ปริมาณ                                                          | ถ้าคุณระบุปริมาณที่เกินกว่าปริมาณที่ระบุในรายการข้อตกลงการขาย ที่มีการเลือกกล่องกาเครื่องหมาย **บังคับใช้ค่าสูงสุด** กล่องข้อความจะเตือนคุณให้บันทึกปริมาณที่เปลี่ยนแปลง คลิ**ใช่**เมื่อต้องการเอาการเชื่อมโยงกับบรรทัดข้อตกลงการขาย และคำนวณราคา คลิ**ไม่ใช่**เมื่อต้องการเอาการเชื่อมโยงกับบรรทัดข้อตกลงการขาย โดยไม่มีการคำนวณราคา                                                            |

## <a name="returning-an-item-that-was-ordered-from-a-sales-agreement"></a>การส่งคืนสินค้าที่ถูกสั่งซื้อจากข้อตกลงการขาย
เมื่อลูกค้าส่งคืนผลิตภัณฑ์ที่สั่งจากข้อตกลงการขาย 365 Dynamics Microsoft สำหรับการดำเนินงานสามารถค้นหา และข้อผูกมัดที่ข้อตกลงการขายที่เกี่ยวข้องเพื่อสะท้อนการเปลี่ยนแปลงปริมาณหรือยอดเงินการปรับปรุงโดยอัตโนมัติ โดยการสร้างใบสั่งส่งคืนสินค้าที่ขึ้นอยู่กับใบสั่งขายต้นฉบับที่ลิงค์กับข้อตกลงการขาย คุณจะสร้างความสัมพันธ์ ระหว่างข้อผูกมัดเกี่ยวกับข้อตกลงการขาย รายการใบสั่งขาย ใบแจ้งหนี้ของใบสั่งส่งคืนสินค้า  
...
ในบางสถานการณ์ที่ใบสั่งขายจะถูกสร้างขึ้นโดยทางอ้อม เช่นเมื่อคุณสร้างใบลดหนี้หรือใบสั่งขายระหว่างบริษัท คุณสามารถควบคุม ว่า 365 Dynamics Microsoft สำหรับการดำเนินงานจะค้นหาข้อตกลงการขายที่เกี่ยวข้อง
