---
title: "ลงทะเบียนหมายเลขประจำสินค้าในกระบวนการขาย"
description: "บทความนี้อธิบายวิธีที่คุณสามารถลงทะเบียนหมายเลขประจำสินค้าบนบันทึกการจัดส่งหรือใบแจ้งหนี้ในระหว่างกระบวนการขาย ฟังก์ชันนี้จะมีประโยชน์เมื่อบริษัทต้องการรวบรวมหมายเลขลำดับประจำสินค้าสำหรับจุดประสงค์ในการบริการและการรับประกัน แต่ไม่จำเป็นต้องรักษาหมายเลขลำดับประจำสินค้าในสินค้าคงคลังจากการรับสินค้าเพื่อนำออกใช้"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="register-serial-numbers-in-the-sales-process"></a>ลงทะเบียนหมายเลขประจำสินค้าในกระบวนการขาย

บทความนี้อธิบายวิธีที่คุณสามารถลงทะเบียนหมายเลขประจำสินค้าบนบันทึกการจัดส่งหรือใบแจ้งหนี้ในระหว่างกระบวนการขาย ฟังก์ชันนี้จะมีประโยชน์เมื่อบริษัทต้องการรวบรวมหมายเลขลำดับประจำสินค้าสำหรับจุดประสงค์ในการบริการและการรับประกัน แต่ไม่จำเป็นต้องรักษาหมายเลขลำดับประจำสินค้าในสินค้าคงคลังจากการรับสินค้าเพื่อนำออกใช้

หลายบริษัทเพียงต้องการรวบรวมหมายเลขลำดับประจำสินค้าสำหรับจุดประสงค์ในการบริการและการรับประกัน และไม่จำเป็นต้องรักษาหมายเลขลำดับประจำสินค้าในสินค้าคงคลังจากการรับสินค้าเพื่อนำออกใช้ ในสถานการณ์เหล่านี้ Microsoft Dynamics 365 for Operations จะช่วยให้คุณลงทะเบียนหมายเลขลำดับประจำสินค้าในบันทึกการจัดส่งหรือใบแจ้งหนี้เมื่อมีการขายผลิตภัณฑ์ ถ้าผลิตภัณฑ์ถูกส่งกลับมาในภายหลัง คุณสามารถติดตามสินค้าแต่ละรายการกับใบแจ้งหนี้เพื่อกำหนดว่าขายผลิตภัณฑ์ และว่าข้อผูกมัดการรับประกันหรือบริการถูกต้อง
มีข้อกำหนดเบื้องต้นใดๆ หรือไม่
----------------------------

คุณต้องเปิดใช้งานหมายเลขลำดับประจำสินค้าสำหรับกระบวนการขาย ด้วยการเลือกตัวเลือก **ใช้งานอยู่ในกระบวนการขาย** ในหน้า **กลุ่มการติดตามมิติ** จากนั้น เหตุการณ์ต่อไปนี้จะเกิดขึ้นใน Microsoft Dynamics 365 for Operations:
...
## <a name="can-i-register-serial-numbers-for-catchweight-items"></a>ฉันสามารถลงทะเบียนหมายเลขประจำสินค้าสำหรับสินค้า catchweight หรือไม่
...
ฉันสามารถลงทะเบียนหมายเลขลำดับประจำสินค้าที่ retail POS ได้หรือไม่
------------------------------------------------
