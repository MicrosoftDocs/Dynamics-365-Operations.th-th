...
อินเทอร์เฟสการทำงานร่วมกันกับผู้จัดจำหน่ายใน Microsoft Dynamics 365 for Operations แสดงข้อมูลเกี่ยวกับใบสั่งซื้อ ใบแจ้งหนี้ และสินค้าคงคลังที่มีการส่งมอบให้แก่ผู้จัดจำหน่ายภายนอก คุณสามารถสร้างผู้ติดต่อของการทำงานร่วมกันกับผู้จัดจำหน่าย และร้องขอให้มีการเตรียมผู้ใช้ใหม่ถ้าคุณทำงานเป็นผู้จัดจำหน่ายภายนอกด้วยบทบาทความปลอดภัย **ผู้ดูแลระบบผู้จัดจำหน่าย (ภายนอก)** หรือสิทธิ์ที่คล้ายกัน คุณยังสามารถทำงานเหล่านี้ได้ถ้าคุณทำงานเป็นผู้เชี่ยวชาญด้านการจัดซื้อ ในหัวข้อนี้ บทบาทนี้อ้างอิงถึงผู้เชี่ยวชาญด้านการจัดซื้อที่ทำงานภายในบริษัทที่เป็นเจ้าของอินสแตนซ์ของ Dynamics 365 for Operations สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการใช้ร่วมกันของผู้จัดจำหน่ายถ้าคุณเป็นผู้ใช้ภายนอก ดู[ของผู้จัดจำหน่ายกับลูกค้า](vendor-collaboration-work-customers-dynamics-365-operations.md)  

สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการใช้ร่วมกันของผู้ขายถ้าคุณกำลังจัดซื้อแบบมืออาชีพ ดู[ความร่วมมือของผู้จัดจำหน่ายให้กับผู้จัดจำหน่ายภายนอก](vendor-collaboration-work-external-vendors.md)

## <a name="add-new-vendor-collaboration-contacts"></a>เพิ่มผู้ติดต่อของการทำงานร่วมกันกับผู้จัดจำหน่ายใหม่
ถ้าคุณต้องการให้ผู้อื่นสามารถเข้าถึงการทำงานร่วมกันกับผู้จัดจำหน่าย คุณจะต้องเพิ่มบุคคลเหล่านั้นให้เป็นผู้ติดต่อของการทำงานร่วมกันกับผู้จัดจำหน่ายก่อน คุณยังอาจต้องการเพิ่มผู้ติดต่อสำหรับพนักงานในบริษัทของคุณซึ่งจะไม่ใช่การทำงานร่วมกันกับผู้จัดจำหน่าย ตัวอย่างเช่น บุคคลเหล่านั้นอาจเป็นจุดติดต่อสำหรับข้อมูลการจัดซื้อชนิดอื่นๆ ผู้ติดต่อใหม่จะถูกเพิ่มในการ**ผู้ติดต่อทั้งหมด**หน้า ซึ่งสามารถเข้าถึงได้จาก**ทำงานร่วมกันของผู้จัดจำหน่าย**&gt;**ติดต่อ**เมนู เมื่อต้องการเพิ่มผู้ติดต่อใหม่:

1.  คลิก **สร้าง**
2.  ป้อนรายละเอียดของผู้ติดต่อ
3.  เลือกนิติบุคคลที่จะแสดงในบริษัทของคุณ และนิติบุคคลที่จะทำงานด้วยในบริษัทที่พวกเขาจะทำงานร่วมกัน คุณทำได้ โดยเลือก**นิติบุคคลในบริษัทของฉัน**/**นิติบุคคลในบริษัทลูกค้า**คู่
4.  คลิก **สร้าง**
...
-   ถ้าคุณเป็นผู้จัดจำหน่ายภายนอก คุณส่งการร้องขอจาก**ผู้ติดต่อทั้งหมด**หน้าภายใน**ทำงานร่วมกันของผู้จัดจำหน่าย**โมดูล
-   ถ้าคุณเป็นผู้เชี่ยวชาญด้านการจัดซื้อ คุณส่งคำขอจากหน้า **ดูผู้ติดต่อ** การทำเช่นนี้ บนเร็กคอร์ด ผู้จัดจำหน่ายในการ**ตั้งค่า**ส่วนในบานหน้าต่างการกระทำ เลือก**ติดต่อ**&gt;**ดูผู้ติดต่อ**
...
1.  บน**ผู้ติดต่อทั้งหมด**หน้า คลิ**ผู้ใช้ผู้จัดจำหน่ายการเตรียมใช้งาน**
2.  ป้อนที่อยู่อีเมลสำหรับผู้ใช้ ที่อยู่นี้จะถูกใช้โดยผู้ใช้ที่ล็อกออนเข้า Dynamics 365 for Operations ถ้าที่อยู่อีเมลอยู่ในโดเมนที่ลงทะเบียนเป็นผู้เช่าไว้กับ Microsoft Azure ที่อยู่อีเมลดังกล่าวจะต้องเป็นบัญชี Azure Active Directory (ADD) ที่มีอยู่เพื่อดำเนินการกระบวนการเตรียมใช้งานให้เสร็จสมบูรณ์ ถ้าที่อยู่อีเมลไม่ได้อยู่ในโดเมนที่ลงทะเบียนไว้กับ Microsoft Azure จะมีการสร้างบัญชี ADD โดยเป็นส่วนหนึ่งของกระบวนการเตรียมใช้งานและผู้ใช้ใหม่จะได้รับอีเมลคำเชิญ อีเมลของผู้ใช้ที่อยู่กับโดเมนเช่น@hotmail.com,@gmail.comหรือ@comcast.netไม่สามารถใช้เพื่อลงทะเบียน 365 Dynamics ตัวสำหรับผู้ใช้ในการดำเนินงานได้
...
เมื่อมีการส่งคำขอของผู้ใช้ผู้จัดจำหน่าย การ**เข้าร่วมกันของผู้จัดจำหน่ายที่ได้รับอนุญาต**ฟิลด์ถูกกำหนดเป็น**ใช่**สำหรับบัญชีผู้จัดจำหน่ายที่เลือกและผู้ใช้ร้องขอการเริ่มต้นเวิร์กโฟลว์ จะมีการสร้างผู้ใช้ใหม่ใน Dynamics 365 for Operations และมีการกำหนดบทบาทความปลอดภัยโดยเป็นส่วนหนึ่งของลำดับงาน นอกจากนี้ บริการแบบ Azure B2B จะถูกเรียกใช้งานซึ่งจะเริ่มต้นการโต้ตอบกับพอร์ทัล Azure และ เชื่อมโยงกับบัญชี AAD ใหม่หรือบัญชีที่มีอยู่กับบัญชีผู้ใช้ Dynamics 365 for Operations
...
เมื่อต้องการร้องขอให้ ผู้ใช้ถูกปิดใช้งาน:

1.  ในการ**ผู้ติดต่อทั้งหมด**หน้า คลิ**Inactivate****ผู้ใช้ผู้จัดจำหน่าย**
2.  เขียนข้อคิดเห็นในฟิลด์ **เหตุผลทางธุรกิจ**
3.  คลิก **ส่ง**

### <a name="modify-security-roles"></a>แก้ไขบทบาทความปลอดภัย

การ**รักษาบทบาทผู้ใช้ของผู้จัดจำหน่าย**หน้าจะเหมือนกับ**ผู้ใช้ผู้จัดจำหน่ายการเตรียมใช้งาน**หน้าเว้นเสียแต่ว่าคุณสามารถแก้ไขรายการของบทบาทความปลอดภัย  

เมื่อต้องการร้องขอให้ มีการปรับเปลี่ยนบทบาทความปลอดภัยสำหรับผู้ใช้:

1.  ในการ**ผู้ติดต่อทั้งหมด**หน้า คลิ**รักษา****บทบาทผู้ใช้ของผู้จัดจำหน่าย**
2.  เขียนข้อคิดเห็นในฟิลด์ **เหตุผลทางธุรกิจ**
