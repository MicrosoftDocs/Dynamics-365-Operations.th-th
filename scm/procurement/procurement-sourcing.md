...
การจัดซื้อและการจัดหาครอบคลุมขั้นตอนทั้งหมดจากการระบุความต้องการสำหรับผลิตภัณฑ์และบริการผ่านการจัดซื้อผลิตภัณฑ์ การรับสินค้า ใบแจ้งหนี้ และการประมวลผลการชำระเงินกับผู้จัดจำหน่าย กระบวนการการจัดซื้อสามารถถูกตั้งค่าคอนฟิกไปยังความต้องการทางธุรกิจ โดยการกำหนดลำดับงานและนโยบายการจัดซื้อ ดูข้อมูลทั่วไปที่ [ภาพรวมของการจัดซื้อและการจัดหา](procurement-sourcing-overview.md) มีแสดงรายการทรัพยากรเพิ่มเติมด้านล่าง

## <a name="purchase-requisitions"></a>ใบขอซื้อ
-   [ภาพรวมใบขอซื้อ](purchase-requisitions-overview.md)
-   [สร้างใบขอซื้อเพื่อปริมาณการใช้](http://ax.help.dynamics.com/en/wiki/create-a-requisition-for-consumption/)
-   [สร้างใบขอซื้อที่ใช้ RFQ](http://ax.help.dynamics.com/en/wiki/create-a-requisition-that-uses-an-rfq/)
-   [ตั้งค่าสิทธิ์สำหรับการสั่งซื้อสินค้าในนามของผู้อื่น](http://ax.help.dynamics.com/en/wiki/set-up-permissions-for-ordering-products-on-behalf-of-someone-else/)

## <a name="requests-for-quotation"></a>คำขอใบเสนอราคา
-   [คำขอใบเสนอราคา](request-quotations.md)
-   [สร้างคำขอใบเสนอราคา](http://ax.help.dynamics.com/en/wiki/create-a-request-for-quotation/)
-   [ป้อนและเปรียบเทียบการประมูล RFQ และให้สัญญา](http://ax.help.dynamics.com/en/wiki/enter-and-compare-rfq-bids-and-award-contracts/)
-   [สร้างวิธีการให้คะแนนสำหรับ RFQ](http://ax.help.dynamics.com/en/wiki/create-a-scoring-method-for-rfqs/)
-   [สร้างชนิดการร้องขอ และเกณฑ์การให้คะแนนสำหรับ RFQ](http://ax.help.dynamics.com/en/wiki/create-solicitation-types-and-scoring-criteria-for-rfqs/)
...
-   [การสร้างบัญชีผู้จัดจำหน่าย](http://ax.help.dynamics.com/en/wiki/create-a-vendor-account/)
-   [สร้างบัญชีธนาคารของผู้จัดจำหน่าย](http://ax.help.dynamics.com/en/wiki/create-a-vendor-bank-account/)
-   [ค้นหาผู้จัดจำหน่าย](http://ax.help.dynamics.com/en/wiki/search-for-vendors/)
-   [อนุมัติผู้จัดจำหน่ายสำหรับผลิตภัณฑ์เฉพาะ](http://ax.help.dynamics.com/en/wiki/approve-vendors-for-specific-products/)
-   [การทำงานร่วมกันกับผู้จัดจำหน่ายกับผู้จัดจำหน่ายภายนอก](vendor-collaboration-work-external-vendors.md)
...
-   [สร้างแค็ตตาล็อกการจัดซื้อ](http://ax.help.dynamics.com/en/wiki/create-a-procurement-catalog/)
...
-   [ตั้งค่าประเภทการจัดซื้อตามลำดับชั้น](http://ax.help.dynamics.com/en/wiki/set-up-a-procurement-category-hierarchy/)
-   [ตั้งค่านโยบายสำหรับการจัดประเภทการจัดซื้อตามลำดับชั้น](http://ax.help.dynamics.com/en/wiki/set-up-policies-for-procurement-category-hierarchies/)
-   [อนุมัติผู้จัดจำหน่ายสำหรับประเภทการจัดซื้อเฉพาะ](http://ax.help.dynamics.com/en/wiki/approve-vendors-for-specific-procurement-categories/)
...
-   [การสร้างใบสั่งซื้อ](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order/)
-   [สร้างใบสั่งซื้อซ้ำ](http://ax.help.dynamics.com/en/wiki/create-a-repeat-purchase-order/)
-   [การสร้างใบสั่งซื้อจากใบสั่งขาย](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-from-a-sales-order/)
-   [สร้างใบสั่งซื้อสำหรับซัพพลายเออร์ขาจร](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-for-a-one-time-supplier/)
-   [สร้างใบสั่งซื้อที่มีกำหนดการจัดส่ง](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-with-a-delivery-schedule/)
-   [สร้างใบสั่งส่งคืนสินค้าที่ซื้อ](http://ax.help.dynamics.com/en/wiki/create-a-purchase-return-order/)
-   [สร้างใบสั่งซื้อที่นำออกใช้จากข้อตกลงการซื้อ](http://ax.help.dynamics.com/en/wiki/create-a-purchase-release-order-from-a-purchase-agreement/)
-   [สร้างใบสั่งซื้อที่นำออกใช้เมื่อสร้างใบสั่งซื้อ](http://ax.help.dynamics.com/en/wiki/create-a-purchase-release-order-when-creating-the-purchase-order/)
-   [สร้างใบสั่งการเพิ่มเติมสินค้าที่มีการส่งมอบ](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/)

## <a name="prices-and-discounts"></a>ราคาและส่วนลด
-   [ข้อตกลงการซื้อ](purchase-agreements.md)
-   [สร้างข้อตกลงการซื้อ](http://ax.help.dynamics.com/en/wiki/create-a-purchase-agreement/)
...
-   [บันทึกการรับสินค้าในใบสั่งซื้อ](http://ax.help.dynamics.com/en/wiki/record-receipt-of-goods-on-a-purchase-order/)
...
-   [สร้างนโยบายการจัดซื้อ](http://ax.help.dynamics.com/en/wiki/create-purchasing-policies/)
