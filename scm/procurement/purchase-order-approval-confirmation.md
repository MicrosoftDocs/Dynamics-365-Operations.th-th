---
title: "อนุมัติ และยืนยันใบสั่งซื้อ"
...
# <a name="approve-and-confirm-purchase-orders"></a>อนุมัติ และยืนยันใบสั่งซื้อ
...
ผู้จัดจำหน่ายที่ถูกตั้งค่าเพื่อใช้พอร์ทัลผู้จัดจำหน่ายสามารถตรวจทานใบสั่งบนพอร์ทัล และอนุมัติหรือปฏิเสธเอกสารนั้น ในระหว่างกระบวนการตรวจทานนี้ PO จะมีสถานะเป็น **อยู่ระหว่างการตรวจทานจากภายนอก** สามารถตั้งค่าคอนฟิกพอร์ทัลผู้จัดจำหน่ายเพื่อให้การยืนยันจากผู้จัดจำหน่ายยืนยันใบสั่งใน Dynamics 365 for Operations โดยอัตโนมัติ อีกวิธีหนึ่งคือ คุณสามารถยืนยัน PO ด้วยตนเองได้หลังจากที่คุณได้รับการยืนยันจากผู้จัดจำหน่ายแล้ว ถ้าผู้จัดจำหน่ายปฏิเสธ PO การปฏิเสธนั้นจะได้รับพร้อมกับเหตุผลของการปฏิเสธและคำแนะนำสำหรับการเปลี่ยนแปลง ในกรณีนี้ สถานะของใบสั่งซื้อจะยังคงเป็น **อยู่ระหว่างการตรวจทานจากภายนอก**  
