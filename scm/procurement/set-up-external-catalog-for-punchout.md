...
1. ตั้งค่าประเภทการจัดซื้อตามลำดับชั้น สำหรับข้อมูลเพิ่มเติม โปรดดูที่ [ตั้งค่านโยบายสำหรับลำดับชั้นของประเภทการจัดซื้อ](/https://ax.help.dynamics.com/en/wiki/set-up-policies-for-procurement-category-hierarchies/)
2. ลงทะเบียนผู้จัดจำหน่ายในการเงินและการดำเนินงาน ก่อนที่คุณจะสามารถตั้งค่าคอนฟิกเพื่อเข้าถึงแค็ตตาล็อกของผู้จัดจำหน่ายภายนอก คุณต้องตั้งค่าผู้จัดจำหน่ายและผู้ติดต่อของผู้จัดจำหน่ายใน Microsoft Dynamics 365 นอกจากนี้ ยังต้องเพิ่มผู้จัดจำหน่ายของแค็ตตาล็อกภายนอกไปยังประเภทการจัดซื้อที่เลือก สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการลงทะเบียนผู้จัดจำหน่ายใน Microsoft Dynamics 365 ดู [จัดการผู้ใช้ร่วมกันของผู้จัดจำหน่าย](/procurement/manage-vendor-collaboration-users.md) สำหรับข้อมูลเกี่ยวกับวิธีการกำหนดของผู้จัดจำหน่ายให้กับประเภทการจัดซื้อ ดู [อนุมัติผู้จัดจำหน่ายสำหรับประเภทการจัดซื้อเฉพาะ](/https://ax.help.dynamics.com/en/wiki/approve-vendors-for-specific-procurement-categories/)
3. ตรวจสอบให้แน่ใจว่า หน่วยวัดและสกุลเงินที่ใช้ผู้จัดจำหน่ายได้ถูกตั้งค่า สำหรับข้อมูลเกี่ยวกับวิธีการสร้างหน่วยวัด ดู [สร้างหน่วยวัด](/https://ax.help.dynamics.com/en/wiki/manage-unit-of-measure/)
4. ตั้งค่าคอนฟิกแค็ตตาล็อกของผู้จัดจำหน่ายภายนอก โดยใช้ความต้องการสำหรับไซต์แค็ตตาล็อกภายนอกของผู้จัดจำหน่าย สำหรับข้อมูลเพิ่มเติมเกี่ยวกับงานนี้ ให้ดูที่ส่วนถัดไป
...
## <a name="4-configure-the-external-vendor-catalog"></a>(4) ตั้งค่าคอนฟิกแค็ตตาล็อกของผู้จัดจำหน่ายภายนอก
