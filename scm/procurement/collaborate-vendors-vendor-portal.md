---
title: "ทำงานร่วมกับผู้จัดจำหน่าย โดยใช้พอร์ทัลของผู้จัดจำหน่าย"
description: "หัวข้อนี้อธิบายวิธีที่เจ้าหน้าที่จัดซื้อสามารถใช้พอร์ทัลผู้จัดจำหน่ายเพื่อร่วมมือกับผู้จัดจำหน่ายภายนอกในระหว่างกระบวนการยืนยันใบสั่งซื้อ ข้อมูลนี้ใช้เฉพาะกับ 2016 กุมภาพันธ์&amp;2016 พฤษภาคม Dynamics AX เวอร์ชัน"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="collaborate-with-vendors-by-using-the-vendor-portal"></a>ทำงานร่วมกับผู้จัดจำหน่าย โดยใช้พอร์ทัลของผู้จัดจำหน่าย

หัวข้อนี้อธิบายวิธีที่เจ้าหน้าที่จัดซื้อสามารถใช้พอร์ทัลผู้จัดจำหน่ายเพื่อร่วมมือกับผู้จัดจำหน่ายภายนอกในระหว่างกระบวนการยืนยันใบสั่งซื้อ ข้อมูลนี้ใช้เฉพาะกับ 2016 กุมภาพันธ์&amp;2016 พฤษภาคม Dynamics AX เวอร์ชัน

ข้อมูลในหัวข้อนี้ใช้กับ Dynamics AX เวอร์ชันกุมภาพันธ์ 2016 และพฤษภาคม 2016 เท่านั้น ฟังก์ชันการพอร์ทัลของผู้จัดจำหน่ายได้ถูกแทนที่ โดยทำงานร่วมกันของผู้จัดจำหน่ายแบบขยายใน Dynamics 365 สำหรับการดำเนินงานรุ่น 1611 สำหรับข้อมูลเพิ่มเติมเกี่ยวกับฟังก์ชันการทำงานร่วมกันของผู้จัดจำหน่ายใหม่[ใช้ร่วมกันของผู้จัดจำหน่ายเพื่อทำงานกับผู้จัดจำหน่ายภายนอก](vendor-collaboration-work-external-vendors.md)  
