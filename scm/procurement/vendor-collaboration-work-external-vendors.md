...
ใบสั่งซื้อจะถูกจัดเตรียมไว้ใน Dynamics 365 for Operations เมื่อใบสั่งซื้อที่มีสถานะเป็น**อนุมัติ**ส่งไปยังผู้ขายโดยใช้การ ** ส่งการยืนยัน ** กระทำบน**ใบสั่งซื้อ**หน้า สถานะของใบสั่งซื้อจะเปลี่ยนเป็น **อยู่ระหว่างการตรวจทานจากภายนอก** หลังจากที่มีการส่งใบสั่งซื้อ ผู้จัดจำหน่ายจะสามารถเห็นในหน้า **ใบสั่งซื้อสำหรับการตรวจทาน** ในอินเทอร์เฟสการทำงานร่วมกันกับผู้จัดจำหน่าย ซึ่งพวกเขาสามารถยอมรับ ปฏิเสธ หรือแนะนำการเปลี่ยนแปลงกับใบสั่งได้ ผู้จัดจำหน่ายยังสามารถเพิ่มข้อคิดเห็นในการสื่อสารข้อมูลเช่นการเปลี่ยนแปลงใบสั่งซื้อ ถ้าคุณต้องการดึงความสนใจของผู้จัดจำหน่ายไปยังใบสั่งซื้อใหม่ คุณยังสามารถใช้ระบบการจัดการการพิมพ์เพื่อส่งใบสั่งซื้อทางอีเมล

### <a name="confirmation-and-acceptance-of-the-po-by-the-vendor"></a>การยืนยันและการยอมรับในใบสั่งซื้อโดยผู้จัดจำหน่าย

เมื่อผู้จัดจำหน่ายยอมรับใบสั่งซื้อ ใบสั่งซื้ออาจได้รับการยืนยันโดยอัตโนมัติหรืออาจต้องได้รับการยืนยันด้วยตนเอง นี้ขึ้นอยู่กับว่า ** เปิดใช้งานผู้จัดจำหน่าย ** ฟิลด์ถูกกำหนดเป็น**ที่ใช้งานอยู่ (PO จะยืนยันอัตโนมัติ)**สำหรับผู้จัดจำหน่าย หรือถึง**ที่ใช้งานอยู่ (ในใบสั่งซื้อจะไม่ยืนยันอัตโนมัติ)**  
...
<tr class="odd">
<td>ผู้จัดจำหน่าย<strong>ยอมรับใบสั่งที่ มีการเปลี่ยนแปลง</strong> มีการแนะนำการเปลี่ยนแปลงในระดับรายการ จึงสามารถยอมรับหรือปฏิเสธแต่ละบรรทัดได้ การเปลี่ยนแปลงอื่นที่เป็นไปได้รวมถึง:
<ul>
...
คุณสามารถใช้การ**ใบสั่งซื้อ****การจัดเตรียม**พื้นที่ทำงานการ POs ที่ผู้จัดจำหน่ายที่มีการตอบสนองต่อการตรวจสอบได้ พื้นที่ทำงานนี้ประกอบด้วยสองรายการที่ประกอบด้วยใบสั่งซื้อที่ มีสถานะเป็น**ในภายนอกตรวจทาน**:
...
ส่วนนี้อธิบายสถานะต่างๆ ที่ใบสั่งซื้ออาจมีจนกว่าจะมีการยืนยัน และจุดใดที่ใบสั่งซื้อเวอร์ชันใหม่อาจกลายเป็นพร้อมใช้งานแก่ผู้จัดจำหน่าย มีความแตกต่างในเรื่องนี้ ขึ้นอยู่กับว่าคุณใช้การจัดการการเปลี่ยนแปลงสำหรับใบสั่งซื้อ 
