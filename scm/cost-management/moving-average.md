...
1.  ในหน้า **กลุ่มแบบจำลองสินค้า** ให้ตั้งค่ากลุ่มแบบจำลองสินค้าที่มีค่าเฉลี่ยเคลื่อนที่ที่ได้เลือกไว้ในฟิลด์ **แบบจำลองสินค้าคงคลัง**
    | **Note**                                                                                                                                |
    |-----------------------------------------------------------------------------------------------------------------------------------------|
    | โดยค่าเริ่มต้น เมื่อมีการเลือกค่าเฉลี่ยเคลื่อนที่ ฟิลด์ **ลงรายการบัญชีสินค้าคงคลังทางกายภาพ** และ **การลงรายการบัญชีสินค้าคงคลังทางการเงิน** จะถูกเลือกด้วย |

2.  ในหน้า **การลงรายการบัญชี** กำหนดบัญชีไปยัง **ผลต่างราคาสำหรับค่าเฉลี่ยเคลื่อนที่** และบัญชี **การประเมินค่าต้นทุนสำหรับค่าเฉลี่ยเคลื่อนที่** บนแท็บ **สินค้าคงคลัง** คุณใช้บัญชี **ผลต่างของราคาสำหรับค่าเฉลี่ยเคลื่อนที่** เมื่อต้นทุนต้องเป็นการใช้จ่ายตามสัดส่วน เหตุการณ์นี้เกิดขึ้นเนื่องจากความแตกต่างในต้นทุนระหว่างการรับสินค้าซื้อและใบแจ้งหนี้การซื้อ และเนื่องจากความแตกต่างระหว่างปริมาณสินค้าคงคลังเดิมและปริมาณคงเหลือปัจจุบัน ใช้บัญชี **การประเมินค่าต้นทุนสำหรับค่าเฉลี่ยเคลื่อนที่** เมื่อคุณต้องการปรับปรุงต้นทุนค่าเฉลี่ยเคลื่อนที่สำหรับผลิตภัณฑ์กับราคาต่อหน่วยใหม่
3.  ในหน้า **ผลิตภัณฑ์ที่นำออกใช้** กำหนดกลุ่มแบบจำลองสินค้าค่าเฉลี่ยเคลื่อนที่ให้กับงผลิตภัณฑ์
...
| **Note**                                                                      |
|-------------------------------------------------------------------------------|
| การแปลงจากต้นทุนมาตรฐานเป็นยค่าเฉลี่ยถ่วงน้ำหนักคือ กระบวนการที่ดำเนินการด้วยตนเอง |
...
ผลต่างในราคาต่อหน่วย ซึ่งเท่ากับ 2.00 ได้มีการลงรายการบัญชีผลต่างราคาสำหรับบัญชีค่าเฉลี่ยเคลื่อนที่เมื่อมีลงรายการบัญชีใบแจ้งหนี้การซื้อ เหตุผลคือ ผลิตภัณฑ์สองรายการถูกซื้อสำหรับต้นทุน 20.00 เหรียญสหรัฐ หนึ่งในผลิตภัณฑ์มีการขายสำหรับราคาต่อหน่วยเป็น 10.00 ใบแจ้งหนี้การซื้อถูกลงรายการบัญชีที่ราคาต่อหน่วย 12.00 มีปริมาณเท่ากับ 2 ไม่สามารถลงรายการราคาต่อหน่วยของผลิตภัณฑ์ที่ 14.00 ต่อรายการ

## <a name="moving-average-product-and-inventory-adjustment"></a>การปรับปรุงผลิตภัณฑ์และสินค้าคงคลังค่าเฉลี่ยเคลื่อนที่
ถ้าคุณต้องปรับปรุงต้นทุนค่าเฉลี่ยเคลื่อนที่ของผลิตภัณฑ์ การปรับปรุงสินค้าคงคลังได้รับอนุญาตตามวันที่ของวันนี้ คุณไม่สามารถย้อนหลังการปรับปรุงสินค้าคงคลังเพื่อแก้ไขต้นทุนเฉลี่ยเคลื่อนที่ของผลิตภัณฑ์ คุณไม่สามารถมีกระแสต้นทุนผ่านธุรกรรมในเวลาต่อมาได้ ในตัวอย่างนี้ ต้นทุนค่าเฉลี่ยเคลื่อนที่มีการปรับปรุงสำหรับผลิตภัณฑ์
1.  เลือกผลิตภัณฑ์ที่คุณต้องการปรับปรุงต้นทุนเฉลี่ยเคลื่อนที่
    | **Note**                                                                                    |
    |---------------------------------------------------------------------------------------------|
    | การ ** การประเมินค่าใหม่สำหรับค่าเฉลี่ยเคลื่อนที่ ** หน้าสินค้าคงคลังพร้อมใช้งานสำหรับผลิตภัณฑ์ที่ตรวจสอบ |

    ผลิตภัณฑ์ที่เลือกมีปริมาณที่มีการลงรายการบัญชีเป็น 1 มูลค่าที่มีการลงรายการบัญชีเป็น 12.00 ต้นทุนต่อหน่วยที่มีการลงรายการบัญชีเป็น 12.00 และต้นทุนต่อหน่วยเป็น 12.00
...
ค่าเฉลี่ยเคลื่อนที่สนับสนุนสินค้าที่มีการผลิต ถ้าคุณวางแผนที่จะใช้ค่าเฉลี่ยเคลื่อนที่ในสภาพแวดล้อมการผลิต การ**ใช้ประเมินราคาต้นทุน**เลื่อนในแบบ ** พารามิเตอร์การควบคุมการผลิต ** หน้าควรที่เลือก ซึ่งหมายความว่า ราคาต้นทุนที่มีการคำนวณระหว่างการประเมินถูกใช้แทนที่ราคาต้นทุนการคำนวณ BOM ที่เกิดขึ้นจริง
...
|                  | 31 ตุลาคม   | ยอดรวม                      | 2        | 32.00  | 16.00             |
