...
1.  เลือกผลิตภัณฑ์ที่คุณต้องการปรับปรุงต้นทุนเฉลี่ยเคลื่อนที่
    | **หมายเหตุ**                                                                                    |
    |---------------------------------------------------------------------------------------------|
    | หน้า **การประเมินค่าใหม่สำหรับค่าเฉลี่ยเคลื่อนที่** ตรวจสอบสินค้าคงคลังที่พร้อมใช้งานสำหรับผลิตภัณฑ์ |
...
ค่าเฉลี่ยเคลื่อนที่สนับสนุนสินค้าที่มีการผลิต ถ้าคุณวางแผนที่จะใช้ค่าเฉลี่ยเคลื่อนที่ในสภาพแวดล้อมการผลิต ควรมีการเลือกตัวเลื่อน **ใช้ราคาต้นทุนที่มีการประเมิน** ในหน้า **พารามิเตอร์การควบคุมการผลิต** ซึ่งหมายความว่า ราคาต้นทุนที่มีการคำนวณระหว่างการประเมินถูกใช้แทนที่ราคาต้นทุนการคำนวณ BOM ที่เกิดขึ้นจริง
