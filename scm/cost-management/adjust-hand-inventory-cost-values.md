...
คุณสามารถใช้หน้า **การปรับปรุงปริมาณสินค้าคงคลังคงเหลือ** เพื่อปรับปรุงมูลค่าต้นทุนของปริมาณสินค้าคงคลังคงเหลือหลังจากกระบวนการปิดบัญชีสินค้าคงคลังได้ถูกรัน **หมายเหตุ:**เพื่อเปิด**การปรับปรุงของสต็อกถือครอง**หน้า คง**ปิดและการปรับปรุง**หน้า เลือกเรกคอร์ดของการกระบวนการปิดสินค้าคงคลังที่เสร็จสมบูรณ์ และจากนั้น คลิก**การปรับปรุง**&gt;**คง** **ตัวอย่าง:** คุณมีธุรกรรมต่อไปนี้ในเดือนกุมภาพันธ์:
...
รายการนี้ถูกตั้งค่าไว้ก่อนใน แบบจำลองสินค้าคงคลังแรก (fifo) และมีการดำเนินการปิดสินค้าคงคลัง ณวันที่ 28 กุมภาพันธ์ ธุรกรรมการตัดสินค้าจากคลังทางการเงินของ USD 11.00 จะถูกจับคู่กับการรับสินค้าทางการเงินคือวันที่ 1 กุมภาพันธ์ และจะทำการปรับปรุงของ USD 1.00 การรับสินค้าคงคลังต่อไปนี้จะมีปริมาณสินค้าคงคลังที่เปิดไว้:
