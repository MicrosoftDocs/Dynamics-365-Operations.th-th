...
เวอร์ชันปัจจุบันใช้หลักการการจ่ายโดยตรงเดียวกับที่ใช้สำหรับค่าเฉลี่ยถ่วงน้ำหนักในเวอร์ชันก่อนหน้านี้ ระบบจับคู่กับโดยตรงระหว่างการรับสินค้าและการตัดสินค้าจากคลัง ระบบจะใช้หลักการการจ่ายโดยตรงนี้ในสถานการณ์เฉพาะ:
...
ในสถานการณ์ด้านล่าง การรับสินค้าที่มีการอัพเดตทางการเงินและการตัดสินค้าจากคลังได้รับการลงรายการบัญชี ในระหว่างการปิดสินค้าคงคลัง ระบบจับคู่กับการรับสินค้าโดยตรงเฉลี่ยถ่วงน้ำหนัก และไม่มีการปรับปรุงราคาต้นทุนต้องใช้ในการตัดสินค้าจากคลัง ภาพประกอบต่อไปนี้แสดงธุรกรรมเหล่านี้:
...
-   ด้านบน หรือด้าน ล่างของลูกศรแนวตั้งแต่ละ มีระบุค่าของธุรกรรมสินค้าคงคลังในแบบฟอร์ม*ปริมาณ*@*ราคาต่อหน่วย*
...
ระบบจะใช้วิธีการจ่ายโดยตรงสำหรับวันที่ 1 **วันที่ 2:**
...
ระบบจะใช้วิธีการจ่ายโดยตรงสำหรับวันที่ 2 **วันที่ 3:**
...
เวอร์ชันปัจจุบันใช้หลักการการจ่ายโดยตรงเหมือนกันสำหรับวันค่าเฉลี่ยถ่วงน้ำหนักที่ใช้ในรุ่นก่อนหน้านี้ ระบบจับคู่กับโดยตรงระหว่างการรับสินค้าและการตัดสินค้าจากคลัง ระบบจะใช้หลักการการจ่ายโดยตรงนี้ในสถานการณ์เฉพาะ:

-   เมื่อมีการลงรายการบัญชีการรับสินค้าหนึ่งรายการหรือการตัดสินค้าจากคลังอย่างน้อยหนึ่งรายการในรอบระยะเวลานั้น
-   เมื่อมีการลงรายการบัญชีเฉพาะการตัดสินค้าจากคลังในรอบระยะเวลา และสินค้าคงคลังมีสินค้าคงเหลือจากการปิดก่อนหน้า

ถ้าคุณเลือก**รวมค่าทางกายภาพ**กล่องกาเครื่องหมายสำหรับสินค้าในแบบ**กลุ่มแบบจำลองสินค้า**หน้า ระบบจะใช้ใบรับที่อัพเดตทางกายภาพเมื่อโปรแกรมคำนวณราคาต้นทุนประเมิน หรือค่าเฉลี่ย การตัดสินค้าจากคลังได้มีการลงรายการบัญชีตามต้นทุนที่ประเมินได้นี้ในระหว่างรอบระยะเวลานั้น ในระหว่างการปิดสินค้าคงคลัง จะมีพิจารณาเฉพาะการรับสินค้าที่มีการอัพเดตทางการเงินในการคำนวณค่าเฉลี่ยถ่วงน้ำหนักเท่านั้น
