...
เหตุการณ์สมุดรายวันการโอนย้ายถูกลงทะเบียน เหตุการณ์โอนย้ายสินค้า A ชิ้นหนึ่งจากไซต์ 1 ไซต์ 2 มิติสินค้าคงคลังของไซต์จะถือเป็นส่วนหนึ่งของต้นทุนวัตถุ ดังนั้น เหตุการณ์สร้างธุรกรรมสินค้าคงคลังสองรายการและรายการต้นทุนสองรายการ
...
| ใบสำคัญ | วันที่       | ข้อมูลอ้างอิง      | หมายเลข | รหัสล็อต  | ล็อตอ้างอิง | รหัสล็อตของสินค้าที่รับคืน | ปริมาณ | จำนวนเงิน  |
|---------|------------|----------------|--------|---------|---------------|---------------|----------|---------|
...
หน้า **ต้นทุนรายการ** สามารถเปิดใช้งานการกรองข้อมูลตามรหัสเอกสารและวันเอกสาร **หมายเหตุ:**รายการต้นทุนจะมีเฉพาะสำหรับ[ต้นทุนวัตถุ](cost-object.md)หรือผลิตภัณฑ์ที่นำออกใช้
