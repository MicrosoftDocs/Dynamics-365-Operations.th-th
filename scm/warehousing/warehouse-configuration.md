...
พิจารณาว่าพื้นที่ที่แตกต่างกันในคลังสินค้า จะใช้สำหรับกระบวนการที่แตกต่างกันได้อย่างไร นอกจากนี้ ยังต้องพิจารณาปัจจัยต่าง ๆ เช่นลักษณะทางกายภาพของพื้นที่เฉพาะ ตัวอย่างเช่น อาจมีพื้นที่ที่คุณสามารถใช้รถบรรทุกยกของได้เพียงบางชนิด หรือถ้าบริษัทของคุณมีทั้งการผลิตและสินค้าสำเร็จรูปภายในสถานที่เดียวกัน คุณอาจต้องการสร้างคลังสินค้าเดี่ยวใน Dynamics 365 for Operations แต่แยกการดำเนินงานสองอย่าง ด้วยการสร้างกลุ่มโซนสองครั้ง มอบชื่อที่เป็นคำอธิบายแก่เอนทิตี้ เพื่อให้ง่ายต่อการระบุเมื่อคุณใช้ในต้นแบบแบบสอบถาม มอบชื่อที่เป็นคำอธิบายแก่เอนทิตี้ เพื่อให้ง่ายต่อการระบุเมื่อคุณใช้ในต้นแบบแบบสอบถาม
...
[ตั้งค่าคอนฟิกของสถานที่ในคลังสินค้า WMS ที่เปิดใช้งาน (คู่มืองาน)](https://ax.help.dynamics.com/en/wiki/configure-locations-in-a-wms-enabled-warehousing/)
