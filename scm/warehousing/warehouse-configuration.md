...
ระบบการจัดการคลังสินค้าใน Microsoft Dynamics 365 for Finance and Operations, Enterprise edition ให้วิธีที่ยืดหยุ่นในการกำหนดโครงร่างของคลังสินค้าของคุณให้ตรงกับความต้องการเปลี่ยนแปลง เพื่อให้คุณสามารถบรรลุประสิทธิภาพสูงสุดของคลังสินค้า
...
[ตั้งค่าคอนฟิกของสถานที่ในคลังสินค้า WMS ที่เปิดใช้งาน (คู่มืองาน)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/configure-locations-wms-enabled-warehouse)
