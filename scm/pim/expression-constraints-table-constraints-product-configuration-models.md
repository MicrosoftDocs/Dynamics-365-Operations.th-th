...
ตัวอย่างนี้แสดงว่าคุณสามารถจำกัดการตั้งค่าคอนฟิกของลำโพงเพื่อเสร็จสิ้นการ cabinet เฉพาะและ fronts ตารางแรกแสดง cabinet เสร็จสิ้นและ fronts ที่พร้อมใช้งานสำหรับการตั้งค่าคอนฟิกโดยทั่วไป มีกำหนดค่าสำหรับการ ** เสร็จสิ้น Cabinet ** และ**grill หน้า**ของแอตทริบิวต์ของชนิด

| ชนิดแอททริบิวต์ | มูลค่า                      |
|----------------|-----------------------------|
| เสร็จสิ้น cabinet | สีดำ ไม้โอ้ค Rosewood สีขาว |
...
## <a name="what-syntax-should-be-used-to-write-constraints"></a>ไวยากรณ์ใดควรใช้เพื่อเขียนข้อจำกัดหรือไม่
คุณต้องใช้ไวยากรณ์ Optimization Modeling Language (OML) เมื่อคุณเขียนข้อจำกัด ระบบจะใช้ solver ข้อจำกัด Microsoft Solver Foundation เพื่อแก้ไขข้อจำกัด
...
<tr class="even">
<td>กำลัง</td>
<td>นำเลขชี้กำลัง มีเลขยกกำลังจากขวาไปซ้าย (อีกนัยหนึ่ง จะสัมพันธ์ขวา) ดังนั้น<strong>พลังงาน [a, b, c]</strong>จะเท่ากับ<strong>พลังงาน [ กำลัง [b, c]]</strong> <strong>กำลัง</strong> สามารถใช้ได้เมื่อการยกกำลังมีค่าเป็นค่าบวกเท่านั้น</td>
...
<td><ul>
<li><strong>ตัวดำเนินการ:</strong>ไม่ [x]&amp;ไม่ [y == 3]</li>
...
คุณไม่สามารถใช้คำสำคัญที่สำรองไว้เป็นชื่อโปรแกรมแก้ปัญหาแอททริบิวต์ ส่วนประกอบ หรือส่วนประกอบย่อยในแบบจำลองการตั้งค่าคอนฟิกผลิตภัณฑ์  นี่คือรายการของคำสำคัญที่สำรองไว้ที่คุณไม่สามารถใช้ได้:
...
[สร้างข้อจำกัดนิพจน์ (แนะนำงาน)](http://ax.help.dynamics.com/en/wiki/create-an-expression-constraint/)

[เพิ่มการคำนวณเพื่อตั้งค่าคอนฟิกรุ่นผลิตภัณฑ์ (แนะนำงาน)](http://ax.help.dynamics.com/en/wiki/add-a-calculation-to-a-product-configuration-model/)
