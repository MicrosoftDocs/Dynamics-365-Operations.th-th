---
title: "การคำนวณสำหรับแบบจำลองการจัดโครงแบบผลิตภัณฑ์ FAQ"
description: "บทความนี้อธิบายถึงการคำนวณสำหรับแบบจำลองการจัดโครงแบบผลิตภัณฑ์ และอธิบายถึงวิธีการใช้การคำนวณร่วมกับข้อจำกัด"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="calculations-for-product-configuration-models-faq"></a>การคำนวณสำหรับแบบจำลองการจัดโครงแบบผลิตภัณฑ์ FAQ

บทความนี้อธิบายถึงการคำนวณสำหรับแบบจำลองการจัดโครงแบบผลิตภัณฑ์ และอธิบายถึงวิธีการใช้การคำนวณร่วมกับข้อจำกัด
...
**นิพจน์:**ถ้า\[decimalAttribute1 &lt;= decimalAttribute2, True, False\]  

**DecimalAttribute1**คือความยาวของตาราง และ**decimalAttribute2**คือความยาวของ tablecloth นิพจน์ที่ส่งกลับค่า **เป็นจริง** กับแอททริบิวต์เป้าหมายถ้า **decimalAttribute2** มากกว่า หรือเท่ากับ **decimalAttribute1** มิฉะนั้น นิพจน์ส่งกลับค่า **False** ดังนั้น การวัด tablecloth จะยอมรับได้ถ้าความยาว tablecloth เท่ากับ หรือเกินกว่าความยาวของตาราง
...
ในนิพจน์ต่อไปนี้ เป้าหมายสำหรับการคำนวณคือ ความยาวของไฟ และป้อนค่า สี:  

**นิพจน์:**\[ถ้าสี== "สีเขียว" 1.5, 1.0\]  

เมื่อคุณจัดโครงแบบสินค้า ความยาวของสายไฟถูกตั้งค่าเป็น**1.5**ถ้าคุณระบุ**สีเขียว**เป็นค่าของแอตทริบิวต์สี ถ้าคุณระบุสีอื่น ๆ ความยาวถูกตั้งค่าเป็น **1.0** อย่างไรก็ตาม เนื่องจากการคำนวณจะไม่มีทิศทาง การคำนวณไม่ได้ตั้งค่าของแอททริบิวต์สีเป็น **สีเขียว** ถ้าคุณระบุความยาว **1.5**
...
## <a name="how-do-i-set-a-target-attribute-as-hidden-or-readonly"></a>ฉันตั้งเป็นแอตทริบิวต์เป้าหมายเป็นซ่อนหรือแบบอ่านอย่างเดียวหรือไม่
ในการตั้งค่าแอททริบิวต์ให้ ซ่อนอยู่ หรือ อ่านอย่างเดียว ให้ทำตามขั้นตอนเหล่านี้

1.  คลิ**การจัดการข้อมูลผลิตภัณฑ์**&gt;**ทั่วไป**&gt;**แบบจำลองการจัดโครงแบบผลิตภัณฑ์**
...
หมายเลข ค่าที่คุณตั้งค่าเมื่อคุณจัดโครงแบบผลิตภัณฑ์คือ ค่าที่ใช้ การคำนวณที่เกิดขึ้นเมื่อมีการเปลี่ยนแปลงมูลค่าที่ป้อนในการคำนวณ ไม่สามารถบันทึกทับค่าที่คุณระบุสำหรับแอททริบิวต์เฉพาะเจาะจง
...
-   ค่าที่ส่งคืนโดยการคำนวณอยู่นอกโดเมนของแอททริบิวต์  ตัวอย่างคือ จำนวนเต็มจาก\[1..10\]ที่คำนวณเป็น 0
