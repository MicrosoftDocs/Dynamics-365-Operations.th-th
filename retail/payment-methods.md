...
description: "รูปแบบการชำระเงินแต่ละชนิดที่ผู้ค้าปลีกยอมรับต้องถูกกำหนดในการขายปลีกและ การค้าใน Microsoft Dynamics 365 for Operations เมื่อติดตั้งค่าระบบ บทความนี้อธิบายถึงชนิดการชำระเงินที่คุณสามารถตั้งค่า และอธิบายกระบวนการตั้งค่า"
author: MargoC
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
รูปแบบการชำระเงินแต่ละชนิดที่ผู้ค้าปลีกยอมรับต้องถูกกำหนดในการขายปลีกและ การค้าใน Microsoft Dynamics 365 for Operations เมื่อติดตั้งค่าระบบ บทความนี้อธิบายถึงชนิดการชำระเงินที่คุณสามารถตั้งค่า และอธิบายกระบวนการตั้งค่า

ผู้ค้าปลีกสามารถยอมรับการชำระเงินที่หลากหลายในซื้อสินค้าและบริการที่ผู้ค้าปลีกจำหน่าย แม้ว่าเงินสดเป็นรูปแบบที่ใช้กันทั่วไปของการชำระเงิน ผู้ค้าปลีกยังสามารถรับการชำระเงินในรูปแบบของเช็ค บัตร ใบสำคัญ และอื่น ๆ รูปแบบการชำระเงินแต่ละชนิดที่ผู้ค้าปลีกยอมรับต้องถูกกำหนดใน Dynamics 365 for Operations - การขายปลีก เมื่อติดตั้งค่าระบบ รายการต่อไปนี้ อธิบายการชำระเงินแต่ละชนิดที่สามารถตั้งค่าใน Dynamics 365 for Operations - การขายปลีก:
