...
**สีส่วนหัว** -สีส่วนหัวทำให้ผู้ใช้สามารถตั้งค่าคอนฟิกสีของส่วนหัวของหน้าเพื่อให้ตรงกับความต้องการในการสร้างแบรนด์ของผู้ค้าปลีก คุณลักษณะนี้จะพร้อมใช้งานใน Dynamics 365 for Operations รุ่น 1611 เท่านั้น
...
**แป้นกดหมายเลข** - แป้นกดหมายเลขคือข้อมูลป้อนเข้าของผู้ใช้หลักในหน้าจอธุรกรรม POS คุณสามารถตั้งค่าคอนฟิกเพื่อให้แสดงบนแป้นกดหน้าจอทั้งหมดได้ ซึ่งเหมาะสำหรับหน้าจอสัมผัส หรือเฉพาะฟิลด์ป้อนข้อมูลได้ ซึ่งสามารถใช้กับแป้นพิมพ์ของจริง มีการตั้งค่าแป้นกดหมายเลขในโครงร่างแบบเต็มเท่านั้น ใน Dynamics 365 for Operations รุ่น 1611 เค้าโครงแบบย่อมีแป้นกดหมายเลขแบบเต็มที่พร้อมใช้งานจากหน้าจอธุรกรรมเสมอ

**แผงผลรวม** - คุณสามารถตั้งค่าคอนฟิกแผงผลรวมในคอลัมน์เดียวหรือสองคอลัมน์อย่างใดอย่างหนึ่งเพื่อแสดงฟิลด์ต่างๆ เช่น จำนวนรายการ ยอดเงินส่วนลด ค่าธรรมเนียม ผลรวมย่อย และภาษี ใน Dynamics 365 for Operations รุ่น 1611 เค้าโครงแบบย่อสนับสนุนเฉพาะคอลัมน์ผลรวมเดียวเท่านั้น 

**รับ** - แผงรับประกอบด้วยบรรทัดการขาย บรรทัดการชำระเงิน และรายละเอียดการจัดส่งสำหรับผลิตภัณฑ์และบริการที่มีการประมวลผลใน POS ผู้ใช้สามารถระบุคอลัมน์ ความกว้าง และการจัดวาง เค้าโครงแบบย่อใน Dynamics 365 for Operations รุ่น 1611 คุณยังสามารถตั้งค่าคอนฟิกข้อมูลเพิ่มเติมซึ่งจะปรากฏในแถวใต้รายการหลัก 
