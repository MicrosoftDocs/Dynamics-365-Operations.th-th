...
## <a name="attribute-type"></a>ชนิดแอททริบิวต์
  [![การคัดลอกแอททริบิวต์คงที่](./media/attributes-fixed-copy.png)](./media/attributes-fixed-copy.png) แอททริบิวต์ขึ้นอยู่กับชนิดแอททริบิวต์ ชนิดแอททริบิวต์ระบุชนิดของข้อมูลที่สามารถป้อนเพื่อแอททริบิวต์เฉพาะ ในปัจจุบัน Microsoft Dynamics 365 for Operations สนับสนุนชนิดแอททริบิวต์ต่อไปนี้:
