---
title: "กำหนด และรักษาไคลเอนต์สถานี ทะเบียน และฮาร์ดแวร์สถานีวิทยุ"
description: "Wiki นี้ครอบคลุมวิธีการเชื่อมต่ออุปกรณ์ต่อพ่วงกับ Retail POS ของคุณ"
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="define-and-maintain-channel-clients-registers-and-hardware-stations"></a>กำหนด และรักษาไคลเอนต์สถานี ทะเบียน และฮาร์ดแวร์สถานีวิทยุ

Wiki นี้ครอบคลุมวิธีการเชื่อมต่ออุปกรณ์ต่อพ่วงกับ Retail POS ของคุณ

**หมายเหตุ:**สำหรับคำแนะนำในการติดตั้งเฉพาะ ดูที่[การตั้งค่าคอนฟิกและการติดตั้งสถานีฮาร์ดแวร์ขายปลีก](retail-hardware-station-configuration-installation.md) และ [การดาวน์โหลด/การติดตั้งการบริการตนเองของ Retail Modern POS และการเปิดใช้งาน Modern POS และ Cloud POS](retail-modern-pos-device-activation.md)
...
นำทาง: คลิก**ขายปลีกและพาณิชย์**&gt;**ตั้งค่าช่องสัญญาณ**&gt;**ตั้งค่า POS**&gt;**การลงทะเบียน** เครื่องบันทึกเงินสด POS เป็นเอนทิตีที่ใช้ในการกำหนดลักษณะของอินสแตนซ์ที่ระบุของ POS ลักษณะเหล่านี้รวมถึงส่วนกำหนดค่าของฮาร์ดแวร์หรือการตั้งค่าสำหรับอุปกรณ์ต่อพ่วงขายปลีกที่จะใช้ในการลงทะเบียน และร้านค้าที่ลงทะเบียนถูกแมปกับ การแสดงผลทางภาพระดับสำหรับผู้ใช้ที่ล็อกออนเข้าสู่ที่ลงทะเบียน

### <a name="devices"></a>อุปกรณ์

นำทาง: คลิก**ขายปลีกและพาณิชย์**&gt;**ตั้งค่าช่องสัญญาณ**&gt;**ตั้งค่า POS**&gt;**อุปกรณ์** อุปกรณ์คือเอนทิตีที่แสดงถึงอินสแตนซ์ที่มีอยู่จริงของอุปกรณ์ที่ถูกแม็ปไปยังเครื่องบันทึกเงินสด POS เมื่อมีการสร้างอุปกรณ์ อุปกรณ์นั้นจะถูกแม็ปไปยังเครื่องบันทึกเงินสด POS เอนทิตีอุปกรณ์จะติดตามข้อมูลเกี่ยวกับเวลาที่เครื่องบันทึกเงินสด POS ถูกเรียกใช้ ชนิดของไคลเอนต์ที่ถูกใช้ และแพคเกจของแอพลิเคชันที่มีการปรับใช้กับอุปกรณ์เฉพาะ อุปกรณ์มีสองชนิด: **Retail Modern POS** (MPOS) หรือ **Retail Cloud POS** (Cloud POS)

#### <a name="mpos"></a>MPOS

MPOS คือแอพพลิเคชันไคลเอนต์ POS ที่ติดตั้งบน Windows 8.1 หรือระบบปฏิบัติการที่ใช้ PC รุ่นที่ใหม่กว่า ถ้าชนิดแอพพลิเคชัน **Retail modern POS** ถูกแม็ปไปยังอุปกรณ์ จะสามารถระบุแพคเกจดาวน์โหลดสำหรับอุปกรณ์เฉพาะได้ สามารถเลือกกำหนดแพคเกจดาวน์โหลดให้รวมแพคเกจการติดตั้งรุ่นอื่นด้วย ความสามารถในการปรับใช้แพคเกจที่แตกต่างกันให้ความยืดหยุ่นในกรณีที่เครื่องบันทึกเงินสด POS ที่แตกต่างกันอาจต้องการการรวมที่แตกต่างกัน MPOS ถูกนำมาปรับใช้ร่วมกับสถานีฮาร์ดแวร์ในตัว

#### <a name="cloud-pos"></a>เมฆ POS

เมฆ POS ได้ POS ที่ใช้เบราว์เซอร์ เนื่องจากเรียกเบราว์เซอร์ Cloud POS ไม่จำเป็นต้อง Windows 8.1 หรือรุ่นที่ใหม่กว่าบนพีซีระบบปฏิบัติการ ถ้าชนิดแอพพลิเคชัน **Retail Cloud POS** ถูกแม็ปไปยังอุปกรณ์เฉพาะในฝ่ายสนับสนุน อุปกรณ์นั้นจะสามารถนำมาใช้ผ่านทางเบราว์เซอร์โดยไม่จำเป็นต้องดาวน์โหลดหรือติดตั้งแพคเกจได้ Cloud POS ต้องต้องสถานีฮาร์ดแวร์เพื่อใช้ฮาร์ดแวร์ที่นอกเหนือจากเครื่องอ่านบัตรเครดิตแบบแป้นพิมพ์ที่ใช้การสแกนบาร์โค้ด

### <a name="hardware-profile"></a>โพรไฟล์ฮาร์ดแวร์

นำทาง: คลิก**พาณิชย์**&gt;**ตั้งค่าช่องสัญญาณ**&gt;**ตั้งค่า POS**&gt;**โพรไฟล์ POS**&gt;**โพรไฟล์ฮาร์ดแวร์** โพรไฟล์ฮาร์ดแวร์ระบุฮาร์ดแวร์ที่เชื่อมต่อกับเครื่องบันทึกเงินสด POS หรือสถานีฮาร์ดแวร์ นอกจากนี้โพรไฟล์ฮาร์ดแวร์ยังถูกนำมาใช้เพื่อระบุพารามิเตอร์ตัวประมวลผลการชำระเงินที่ควรจะใช้ในระหว่างการสื่อสารกับชุดพัฒนาซอฟต์แวร์ (SDK) การชำระเงิน (SDK การชำระเงินมีการปรับใช้เป็นส่วนหนึ่งของสถานีฮาร์ดแวร์)

### <a name="hardware-station"></a>สถานีฮาร์ดแวร์

นำทาง: คลิก**ขายปลีกและพาณิชย์**&gt;**สถานี**&gt;**ร้านค้าปลีก**&gt;**ทั้งหมดขายปลีกร้านค้า** เลือกร้านค้า และคลิก FastTab **สถานีฮาร์ดแวร์** สถานีฮาร์ดแวร์คืออินสแตนซ์ของตรรกะทางธุรกิจที่กระตุ้นอุปกรณ์ต่อพ่วง POS สถานีฮาร์ดแวร์ถูกติดตั้งร่วมกับ MPOS โดยอัตโนมัติ กล่าวคือสถานีอุปกรณ์สามารถติดตั้งเป็นส่วนประกอบแบบสแตนด์อโลน และเข้าถึงโดย MPOS หรือ Cloud POS ผ่านบริการเว็บได้ สถานีฮาร์ดแวร์ต้องมีการกำหนดที่ระดับช่องทาง

### <a name="hardware-station-profile"></a>โพรไฟล์สถานีฮาร์ดแวร์

นำทาง: คลิก**พาณิชย์**&gt;**ตั้งค่าช่องสัญญาณ**&gt;**ตั้งค่า POS**&gt;**โพรไฟล์ POS**&gt;**ส่วนกำหนดค่าของอุปกรณ์ฮาร์ดแวร์** ในขณะที่สถานีฮาร์ดแวร์จะถูกระบุที่ระดับช่องทางซึ่งประกอบด้วยข้อมูลเฉพาะอินสแตนซ์ เช่น URL สำหรับสถานีฮาร์ดแวร์ ส่วนโพรไฟล์สถานีฮาร์ดแวร์ที่ประกอบด้วยข้อมูลที่อาจเป็นแบบคงที่หรือที่ใช้ร่วมกันระหว่างสถานีฮาร์ดแวร์หลายรายการ ข้อมูลแบบคงที่มีพอร์ตที่ควรถูกใช้ แพคเกจของสถานีฮาร์ดแวร์ และโพรไฟล์ฮาร์ดแวร์ ข้อมูลแบบคงที่ยังมีคำอธิบายของชนิดของสถานีฮาร์ดแวร์ที่มีการปรับใช้ เช่น**เช็คเอาท์ **หรือ **การส่งคืน**โดยขึ้นอยู่กับฮาร์ดแวร์ที่จำเป็นสำหรับแต่ละสถานีฮาร์ดแวร์เฉพาะ

## <a name="scenarios"></a>สถานการณ์จำลอง
### <a name="mpos-with-connected-peripheral-devices"></a>MPOS กับอุปกรณ์ต่อพ่วงที่เชื่อมต่อ

[![ดั้งเดิม คงจุดขาย](./media/traditional-300x279.png)](./media/traditional.png)MPOS เชื่อมต่อไปยังอุปกรณ์ต่อพ่วง POS ในสถานการณ์สมมติ POS ดั้งเดิม ถาวร ครั้งแรกไปยังการลงทะเบียนตัวเอง การกำหนดโพรไฟล์ฮาร์ดแวร์ คุณสามารถค้นหาเครื่องบันทึกเงินสด POS ที่**ขายปลีกและพาณิชย์**&gt;**ตั้งค่าช่องสัญญาณ**&gt;**ตั้งค่า POS**&gt;**การลงทะเบียน**ได้ หลังจากที่คุณได้กำหนดโพรไฟล์ฮาร์ดแวร์แล้ว ซิงค์การเปลี่ยนแปลงไปยังฐานข้อมูลช่องทางโดยใช้กำหนดการกระจาย "เครื่องบันทึกเงินสด" คุณสามารถค้นหาตารางเวลาการกระจายที่**ขายปลีกและพาณิชย์**&gt;**ไอทีขายปลีก**&gt;**กำหนดการกระจาย**ได้ ถัดไป ตั้งค่าสถานีฮาร์ดแวร์ "เฉพาะที่" ในช่องทาง คลิ**ขายปลีกและพาณิชย์**&gt;**สถานี**&gt;**ร้านค้าปลีก**&gt;**ทั้งหมดขายปลีกร้านค้า**และเลือกร้านค้า จากนั้น ใน FastTab **สถานีฮาร์ดแวร์** คลิก **เพิ่ม** เพื่อเพิ่มสถานีฮาร์ดแวร์ ป้อนคำอธิบาย ป้อน**localhost** เป็นชื่อโฮสต์ และจากนั้นซิงค์การเปลี่ยนแปลงไปยังสถานีโดยใช้กำหนดการกระจาย "การตั้งค่าคอนฟิกช่องทาง" คุณสามารถค้นหาตารางเวลาการกระจายที่**ขายปลีกและพาณิชย์**&gt;**ไอทีขายปลีก**&gt;**กำหนดการกระจาย**ได้ สุดท้าย ใน MPOS ใช้การดำเนินการ **เลือกสถานีฮาร์ดแวร์** เพื่อเลือกสถานีฮาร์ดแวร์ **localhost** ตั้งค่าสถานีฮาร์ดแวร์เป็น **ใช้งานอยู่** โพรไฟล์ฮาร์ดแวร์ที่ใช้ในสถานการณ์จำลองนี้ควรมาจากเครื่องบันทึกเงินสด POS ไม่จำเป็นต้องมีโพรไฟล์ของสถานีฮาร์ดแวร์สำหรับสถานการณ์จำลองนี้ **หมายเหตุ:** การเปลี่ยนแปลงโพรไฟล์ฮาร์ดแวร์บางอย่าง เช่น การเปลี่ยนแปลงลิ้นชักเงินสด กำหนดให้กะใหม่ต้องเปิดหลังจากที่มีการซิงค์การเปลี่ยนแปลงไปยังช่องทาง **หมายเหตุ:** Cloud POS ต้องใช้สถานีฮาร์ดแวร์แบบสแตนด์อโลนเพื่อสื่อสารกับอุปกรณ์ต่อพ่วงขายปลีก

### <a name="mpos-or-cloud-pos-with-a-stand-alone-hardware-station"></a>MPOS หรือ Cloud POS ที่มีสถานีฮาร์ดแวร์แบบสแตนด์อโลน

\[id คำอธิบายเฉพาะ = "สิ่งที่แนบมา\_340041 " จัดชิด =ความกว้าง "alignleft" = "300"\][![ที่ใช้ร่วมกันของอุปกรณ์ต่อพ่วง](./media/shared-300x254.png)](./media/shared.png)ที่ใช้ร่วมกันของอุปกรณ์ต่อพ่วง\[/ป้ายคำอธิบาย\]ในสถานการณ์สมมตินี้ สถานีฮาร์ดแวร์แบบสแตนด์อโลนใช้ร่วมกันระหว่างไคลเอนต์ MPOS และ Cloud POS สถานการณ์จำลองนี้จำเป็นต้องให้คุณสร้างโพรไฟล์สถานีฮาร์ดแวร์เพื่อระบุแพคเกจดาวน์โหลด พอร์ต และโพรไฟล์ฮาร์ดแวร์ที่สถานีฮาร์ดแวร์ใช้ คุณสามารถค้นหาโพรไฟล์สถานีฮาร์ดแวร์ที่**ขายปลีกและพาณิชย์**&gt;**ตั้งค่าช่องสัญญาณ**&gt;**ตั้งค่า POS**&gt;**โพรไฟล์ POS**&gt;**ส่วนกำหนดค่าของอุปกรณ์ฮาร์ดแวร์**ได้ หลังจากที่คุณได้สร้างโพรไฟล์ฮาร์ดแวร์การสถานี นำทางไปยังช่องทางการขายปลีกที่เฉพาะเจาะจง (**พาณิชย์และผู้ค้าปลีก**&gt;**สถานี**&gt;**ร้านค้าปลีก**&gt;**ทั้งหมดขายปลีกร้านค้า**), และเพิ่มสถานีฮาร์ดแวร์ใหม่ แม็ปสถานีฮาร์ดแวร์ใหม่นี้กับโพรไฟล์สถานีฮาร์ดแวร์ที่สร้างไว้ก่อนหน้านี้ ถัดไป ระบุคำอธิบายที่จะช่วยพนักงานเก็บเงินในการระบุสถานีฮาร์ดแวร์ ในการ**ชื่อโฮสต์**ฟิลด์ ป้อน URL เครื่องโฮสต์ในรูปแบบต่อไปนี้: **https://&lt;MachineName:Port&gt;/HardwareStation** (แทน**&lt;MachineName:Port&gt;**ด้วยชื่อเครื่องจริงของสถานีฮาร์ดแวร์และพอร์ตที่ระบุไว้ในส่วนกำหนดค่าของอุปกรณ์ฮาร์ดแวร์) สำหรับสถานีฮาร์ดแวร์แบบสแตนด์อโลน คุณควรระบุรหัสเทอร์มินัล (EFT) โอนเงินทางอิเล็กทรอนิกส์ ค่านี้ระบุเทอร์มินัล EFT ที่เชื่อมต่อกับสถานีฮาร์ดแวร์เมื่อตัวเชื่อมต่อการชำระเงินมีการสื่อสารกับผู้ให้บริการชำระเงิน ถัดไป จากเครื่องสถานีฮาร์ดแวร์จริง นำทางไปยังช่องทาง และเลือกสถานีฮาร์ดแวร์ แล้ว คลิก **ดาวน์โหลด** และติดตั้งสถานีฮาร์ดแวร์ ถัดไป จาก MPOS หรือ Cloud POS ใช้การดำเนินการ **เลือกสถานีฮาร์ดแวร์** เพื่อเลือกสถานีฮาร์ดแวร์ที่ติดตั้งไว้ก่อนหน้านี้ เลือก **คู่** เพื่อสร้างความสัมพันธ์ที่ปลอดภัยระหว่าง POS และสถานีฮาร์ดแวร์ ขั้นตอนนี้จะต้องทำให้เสร็จสิ้นหนึ่งครั้งสำหรับ POS และสถานีฮาร์ดแวร์ทุกชุด หลังจากที่สถานีฮาร์ดแวร์ถูกจับคู่แล้ว การดำเนินงานเดียวกันจะนำมาใช้เพื่อทำให้สถานีฮาร์ดแวร์ใช้งานอยู่ในขณะที่มีการใช้งาน สำหรับสถานการณ์สมมตินี้ โพรไฟล์ฮาร์ดแวร์ควรถูกกำหนดให้กับโพรไฟล์ฮาร์ดแวร์การสถานีแทนที่จะลงทะเบียนตัวเอง ถ้าด้วยเหตุผลบาง สถานีฮาร์ดแวร์ไม่มีโพรไฟล์ฮาร์ดแวร์ที่กำหนดโดยตรง แล้วโพรไฟล์ฮาร์ดแวร์ที่กำหนดให้กับเครื่องบันทึกเงินสดจะใช้
...
คุณสามารถค้นหาโพรไฟล์ POS ที่**ขายปลีกและพาณิชย์**&gt;**ตั้งค่าช่องสัญญาณ**&gt;**ตั้งค่า POS**&gt;**โพรไฟล์ POS**ได้ การจัดการเครื่องบันทึกเงินสดหลายลักษณะผ่านโพรไฟล์อาจมีประโยชน์ เนื่องจากโพรไฟล์สามารถถูกนำมาใช้ร่วมกันระหว่างเครื่องบันทึกเงินสดหลายเครื่อง โพรไฟล์สามารถถูกแม็ปกับเครื่องบันทึกเงินสดแต่ละเครื่อง หรือถ้าโพรไฟล์มีผลบังคับใช้ตามหลักการทั้งร้านค้าไปยังร้านค้าปลีก ส่วนต่อไปนี้อธิบายถึงโพรไฟล์ POS และวิธีการใช้งาน
...
โพรไฟล์ฟังก์ชันถูกตั้งค่าที่ระดับร้านค้า ใช้เพื่อระบุการตั้งค่าทั่วทั้งร้านค้าเกี่ยวกับฟังก์ชันที่สามารถดำเนินได้ที่ POS ความสามารถต่อไปนี้จะถูกจัดการผ่านโพรไฟล์ฟังก์ชัน ความสามารถเหล่านี้จะถูกจัดเรียงตาม FastTab
...
-   FastTab **รหัสข้อมูล** :
    -   ทุกด้านของวิธีจัดการข้อมูลรหัสที่ POS สำหรับรายละเอียด ดู[รหัสข้อมูล](info-codes-retail.md)
...
คุณสามารถสร้างฟิลด์แบบกำหนดเองเมื่อต้องการเพิ่มเขตข้อมูลที่ไม่ได้รับออกจากกล่องไป POS สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการใช้เขตข้อมูลกำหนดเอง ดู[การทำงานกับเขตข้อมูลแบบกำหนดเองติดประกาศในบล็อก](https://blogs.msdn.microsoft.com/axsupport/2012/08/06/ax-for-retail-2012-working-with-custom-fields/)
...
การเปลี่ยนแปลงทั้งหมดไปยังไคลเอนต์ POS ยกเว้นการเปลี่ยนแปลงสถานะการเรียกใช้อุปกรณ์ จะต้องสามารถซิงค์ไปยังฐานข้อมูลช่องทางเพื่อให้มีผลบังคับใช้ เมื่อต้องการซิงค์การเปลี่ยนแปลงไปยังฐานข้อมูลสถานี นำทางไปยัง**ขายปลีกและพาณิชย์**&gt;**ไอทีขายปลีก**&gt;**กำหนดการกระจาย**และรันการจัดตารางการแจกแจงที่ต้องการ สำหรับการเปลี่ยนแปลงของไคลเอนต์ คุณควรรันกำหนดการกระจาย "เครื่องบันทึกเงินสด" และ "การตั้งค่าคอนฟิกช่องทาง"
