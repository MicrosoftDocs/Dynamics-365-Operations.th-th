...
เมื่อต้องการเปิดใช้งานการบันทึกงานที่ POS ให้ทำตามขั้นตอนเหล่านี้

1.  คลิก **การขายปลีกและการค้าขายสินค้า** &gt; **การตั้งค่าช่องทาง** &gt; **การตั้งค่า POS** &gt; **การลงทะเบียน**
...
4.  คลิก **บันทึก**
5.  ไปที่ **การขายปลีกและการค้า** &gt; **ไอทีการขายปลีก** &gt; **กำหนดการกระจาย**
...
3.  ป้อนชื่อและคำอธิบายสำหรับการบันทึกเงิน แล้วคลิก **เริ่มต้น** รอบเวลาการบันทึกเริ่มต้นทันทีที่คุณคลิก **เริ่มต้น** **หมายเหตุ:** ถ้าคุณคลิกปุ่ม **ปิด** (**X**) ในมุมด้านขวาบนขณะที่การบันทึกอยู่ในระหว่างดำเนินการ การ บานหน้าต่าง **ตัวบันทึกงาน** จะถูกปิด แต่รอบเวลาการบันทึกไม่ได้สิ้นสุดลง เมื่อต้องการเปิดบานหน้าต่างตัวบันทึกงาน คลิกปุ่มวิธีใช้ (เครื่องหมายคำถาม) ที่ด้านบนของหน้าจอ 
...
ตัวบันทึกงานสามารถจับภาพหน้าจอของ Retail Modern POS UI ขณะที่คุณบันทึกกระบวนการทางธุรกิจ ตัวบันทึกงานใช้ภาพหน้าจอถ้าคุณดาวน์โหลดการบันทึกเป็นเอกสาร Word เมื่อต้องการเปิดใช้งานคุณลักษณะการจับภาพหน้าจอ ตั้งค่าตัวเลือก **จับภาพหน้าจอ** เป็น **ใช่** หมายเหตุ: ฟังก์ชันการจับภาพหน้าจอไม่ได้รับการสนับสนุนใน Cloud POS
...
## <a name="help-at-retail-modern-pos-and-cloud-pos"></a>วิธีใช้ที่ Retail Modern POS และ Cloud POS
เพื่อแสดงการบันทึกงานแบบกำหนดเองของคุณเองในบานหน้าต่างวิธีใช้ของ Retail Modern POS และ Cloud POS เพื่อให้สามารถดูเป็นข้อความได้ คุณต้องบันทึกการบันทึกงานของคุณไปยังไลบรารี BPM ของคุณเอง และจากนั้น ปรับปรุงพารามิเตอร์ระบบวิธีใช้ของคุณเพื่อชี้ไปยังไลบรารี BPM สำหรับข้อมูลเพิ่มเติมให้ดูที่ [การเชื่อมต่อระบบวิธีใช้](https://ax.help.dynamics.com/en/wiki/working-with-help/#connecting-the-help-system) วิธีใช้ของ Retail Modern POS และ Cloud POS ค้นหา LCS ในเวลาจริง โดยจะค้นหาจากไลบรารี BPM ทั้งหมดที่เลือกไว้ในพารามิเตอร์ระบบวิธีใช้ Microsoft Dynamics AX และแสดงผลที่เกี่ยวข้อง เมื่อต้องการเข้าถึงเมนู **วิธีใช้** คลิกปุ่ม **วิธีใช้** ที่ด้านบนของหน้าจอ และจากนั้น ในกล่องค้นหา ให้พิมพ์ชื่อกระบวนการของคุณ และกดปุ่มค้นหา 

[![ปุ่มวิธีใช้](./media/help.jpg)](./media/help.jpg) 

เมื่อคุณคลิกคู่มืองานในผลการค้นหา คุณสามารถดูขั้นตอนเป็นหัวข้อวิธีใช้หรือขั้นตอนการส่งออกไปยังเอกสาร Word ได้ หมายเหตุ: ระบบวิธีใช้ใน Retail Modern POS และ Cloud POS จะไม่นำคู่มืองานโดยอัตโนมัติตามแบบฟอร์มหรือการดำเนินการของคุณ คุณจะต้องพิมพ์ชื่อกระบวนการลงในกล่องค้นหา แล้วกดปุ่มค้นหาเพื่อรับผลลัพธ์
