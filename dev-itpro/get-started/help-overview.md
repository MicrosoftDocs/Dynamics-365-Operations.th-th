...
ดูข้อมูลเพิ่มเติมเกี่ยวกับตัวบันทึกงาน ให้ดูที่ [ตัวบันทึกงานใน Finance and Operations](../user-interface/task-recorder.md)
...
--------
[ระบบวิธีใช้ Finance and Operations (เอกสารข้อเท็จจริงที่สามารถดาวน์โหลดได้)](https://mbs.microsoft.com/files/public/CS/AX2012R3/DynamicsAXHelpSystemFactSheet.pdf)
