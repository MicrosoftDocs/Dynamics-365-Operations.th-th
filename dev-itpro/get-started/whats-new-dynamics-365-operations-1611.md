...
| สร้างเป้าหมายที่ละเอียดยิ่งขึ้น                                                                    | คุณสามารถควบคุมเนื้อหาของเป้าหมายที่คุณตั้งไว้ได้มากขึ้น คุณสามารถสร้างการวัดเป้าหมาย เชื่อมโยงรายการสมุดรายวันของประสิทธิภาพไปยังการวัด และแนบและดูเอกสาร คุณสามารถเก็บเป้าหมายเป็นเท็มเพลต และนำมาใช้ใหม่สำหรับการตั้งค่าอย่างรวดเร็ว                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| สร้างกลุ่มเป้าหมาย และใช้ในการเพิ่มเป้าหมายใหม่                                             | คุณสามารถเพิ่มเท็มเพลตเป้าหมายให้กับกลุ่ม และใช้กลุ่มดังกล่าวในการสร้างเป้าหมายอย่างน้อยหนึ่งรายการสำหรับพนักงาน ทีมงาน ตำแหน่ง แผนก หรือบริษัท                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| เข้าถึงห้าใหม่พลังงาน BI เนื้อหาชุดสำหรับทรัพยากรบุคคล                                     | ชุดเนื้อหาใหม่เปิดใช้งานการจัดการองค์กรและทรัพยากรบุคคลของทรัพยากรบุคคลเพื่อวิเคราะห์ต่อไปนี้: แบ่งประชากรของ•วัดแรงงานตามอายุ เพศ และสถานภาพการสมรส•เปรียบเทียบ attrition อัตราปีต่อปี และดูรายการของเหตุผลที่มีกำหนดพนักงานสำหรับปล่อย•องค์กรดูรายการของตำแหน่งที่เปิด ตลอดจนการเปรียบเทียบค่าตอบแทนของตำแหน่งที่เปิดเพื่อปิดและสวัสดิการ•เปรียบเทียบรายชั่วโมง และพนักงานประจำ•ดูจำนวนของพนักงานที่ลงทะเบียนในสวัสดิการที่พร้อมใช้งาน•ดูพนักงาน โดยเรียงตามชนิดการจ้างงานสรรหาบุคลากร•วิเคราะห์ ผู้สมัครตามจำนวนของผู้สมัคร ที่พวกเขากำลังมาจาก และอะไรตำแหน่งที่พวกเขากำลังใช้สำหรับการฝึกอบรมขององค์กร•ลงทะเบียนหลักสูตรตามตำแหน่ง•เข้า Couse โดย•สถานะรายชื่อพนักงานที่ลงทะเบียนไว้สำหรับความสามารถของพนักงานหลักสูตรและพัฒนา•รายการทักษะชอบ โดยพนักงาน•แบ่งชนิดของทักษะโดยสมาชิกในทีม |
...
| แสดงพื้นที่ทำงาน **ER** บนรายงาน Power BI                                                                                                                                                                                                                                                      | ผู้ใช้สามารถตั้งค่าคอนฟิกหน้า **พื้นที่ทำงาน ER** เพื่อให้รวมรายการเมนูใหม่และไทล์แบบสดที่รันรายงานตาม Power BI                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
<tbody>
<tr class="odd">
<td>ตั้งค่าคอนฟิกเรกคอร์ดการชำระค่าจ้างและดำเนินการกับบัญชีค่าจ้างโดยใช้ฟังก์ชันที่เทียบเท่ากับฟังก์ชันของโมดูล <strong>ค่าจ้าง</strong> ใน Microsoft Dynamics AX 2012 R3</td>
<td>ขณะนี้คุณสามารถตั้งค่าคอนฟิกและดำเนินการกับค่าจ้าง US ได้โดยใช้ชุดคุณลักษณะที่เทียบเท่ากับคุณลักษณะที่กำหนดใน AX 2012 R3
<ul>
...
<td>เมื่อคุณสร้างรายการการขายหรือรายการการซื้อ คุณสามารถค้นหาผลิตภัณฑ์ได้โดยใช้มิติของผลิตภัณฑ์และหมายเลขผลิตภัณฑ์ใดๆ ยกเว้นหมายเลขสินค้าของการค้าสากล (GTIN) และบาร์โค้ด การค้นหาเป็นการค้นหาข้อความเต็มที่แทนที่การค้นหา "ขึ้นต้นด้วย" ที่มีอยู่ที่ใช้ในรายการการค้นหาการขายและการซื้อ คุณลักษณะนี้ช่วยให้คุณสามารถค้นหากลุ่มของผลิตภัณฑ์ที่มีคุณสมบัติเหมือนกันหรือผลิตภัณฑ์เดียวที่มีลักษณะเฉพาะ เมื่อต้องการเปิดใช้งานคุณลักษณะนี้ เลือกพารามิเตอร์ <strong>เปิดใช้งานการค้นหาผลิตภัณฑ์</strong> ในหน้า <strong>พารามิเตอร์การค้นหา</strong></td>
</tr>
<tr class="even">
...
| สร้างการวิเคราะห์ในเดสก์ท็อป Power BI                                                                                     | เนื้อหาข่าวกรองธุรกิจ (BI) สำหรับข้อมูลที่เกี่ยวข้องกับโครงการและที่เกี่ยวข้องกับทรัพยากรสามารถถูกสร้างขึ้นในเดสก์ท็อป Power BI ได้อย่างง่ายดาย                                                                                                                                                                                                       |
...
| สิ่งที่คุณสามารถทำได้                                                                                                                                                                                                                                                                   | ทำไมนี่เป็นสิ่งสำคัญ                                                                                                                                                            |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ผู้ใช้: แอพที่เชื่อมต่อกับผู้ใช้รุ่นปัจจุบันทำให้สามารถใช้คุณลักษณะต่อไปนี้: การค้นหาผลิตภัณฑ์ การเรียกดูประเภท การเพิ่มลงรถเข็น และการเช็คเอาท์ผู้เยี่ยมชม ผู้ค้าปลีกสามารถใช้ตราสินค้าของบริษัทของตนกับแอพ และบรรจุลงในร้านค้าแอพ Android และ iOS | ผู้ค้าปลีกสามารถสร้างแอพที่เชื่อมต่อกับผู้ใช้ที่อนุญาตให้ลูกค้าเรียกดู ค้นหาผลิตภัณฑ์ และจัดส่งผลิตภัณฑ์โดยเป็นผู้เยี่ยมชมจากอุปกรณ์เคลื่อนที่ได้อย่างง่ายดาย                      |
...
| การสร้างลูกค้าแบบอะซิงโครนัสผ่าน Storefront ออนไลน์แบบพาณิชย์อิเล็กทรอนิกส์                                                                                                                                                                                                                  | ขณะนี้ ISV สามารถสร้างบัญชีลูกค้าแม้ว่า Commerce Data Exchange: Real-time Service ไม่พร้อมใช้งาน                                                                        |
...
| สิ่งที่คุณสามารถทำได้                                                                                                                                                                                                                                                                        | ทำไมนี่เป็นสิ่งสำคัญ                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ดูคำแนะนำผลิตภัณฑ์แบบส่วนบุคคลที่ touchpoints หลายในระบบขายหน้าร้าน (POS) เพื่อกำหนดว่า ลูกค้าใดอาจสนใจโดยยึดตามการประวัติการซื้อ สินค้าในรายการของพวกเขาพร และสินค้าที่ลูกค้ารายอื่นซื้อแบบออนไลน์ และในร้านค้าลายอิฐ และปูน | สำหรับผู้ค้าปลีกกับแค็ตตาล็อกที่มีขนาดใหญ่ คำแนะนำส่วนบุคคลช่วยให้ลูกค้าที่ มีการค้นพบผลิตภัณฑ์ และเพิ่มศักยภาพให้กับร้านค้าสมาคม ด้วย intelligent clienteling โดยมุ่งเป้าความสนใจของลูกค้าและพฤติกรรมการซื้อผลิตภัณฑ์ showcasing คำแนะนำผลิตภัณฑ์จะช่วยให้ผู้ค้าปลีก upsell และสามารถเพิ่มเงินวางประกันของลูกค้า ใน 365 Dynamics สำหรับการดำเนินงาน - ขายปลีก คำแนะนำผลิตภัณฑ์จะใช้พลังงานจากบริการการรู้คิดและเรียนรู้เครื่องจักร Azure ของ Microsoft |
...
-   Retail Modern POS และ POS ระบบคลาวด์จะสื่อสารกับเซิร์ฟเวอร์ระบบการขายปลีกในร้านค้าเสมอ
-   สนับสนุน Retail Modern POS และ POS ระบบคลาวด์ที่ไม่มีการเชื่อมต่อ HQ
-   สนับสนุนฐานข้อมูลออฟไลน์เฉพาะ Retail Modern POS (แยกต่างหากกับแต่ละอินสแตนซ์ของ Retail Modern POS) ที่ไม่มีการเชื่อมต่อ HQ
-   การรับรองความถูกต้องเป็นไปตามบริการต่อบริการสำหรับระบบร้านค้าเท่านั้น
-   ไม่สนับสนุนการเรียกบริการแบบเรียลไทม์ถ้าไม่มีการเชื่อมต่ออินเทอร์เน็ต
-   การเชื่อมต่อกับฐานข้อมูลโดยตรงของ Retail Modern POS กับฐานข้อมูลช่องทางไม่ได้รับการสนับสนุน
-   เปิดใช้งานการตรวจวัดระยะไกลและการตรวจสอบ

| สิ่งที่คุณสามารถทำได้                                                                                                                                       | ทำไมนี่เป็นสิ่งสำคัญ                                                                                   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| ผู้ค้าปลีกดาวน์โหลดโปรแกรมติดตั้งบริการตนเองของระบบร้านค้าจากหน้าฐานข้อมูลช่องทางใน Dynamics AX HQ และดาวน์โหลดไฟล์การตั้งค่าคอนฟิก   | ผู้ค้าปลีกสามารถดาวน์โหลดแพคเกจบริการตนเองได้อย่างราบรื่น                                          |
| ผู้ค้าปลีกติดตั้งระบบร้านค้าโดยใช้โปรแกรมติดตั้งบริการตนเอง                                                                                 | ผู้ค้าปลีกสามารถติดตั้งระบบร้านค้าโดยใช้แพคเกจบริการตนเอง                                |
| ผู้จัดการฝ่ายไอทีสามารถตั้งค่าคอนฟิกระบบร้านค้าใน Dynamics 365 for Operations (ฐานข้อมูลช่องทาง โพรไฟล์ช่องทาง ร้านค้า และแพคเกจที่สามารถปรับใช้ได้)             | ผู้จัดการฝ่ายไอทีสามารถตั้งค่าคอนฟิกระบบร้านค้าได้อย่างง่ายดายและมีประสิทธิภาพ                                       |
| ผู้ค้าปลีกดำเนินการ Retail Modern POS ในร้านค้าในสถานที่ และสามารถทำการดำเนินการแบบเรียลไทม์ต่างๆ เช่น ออกใช้บัตรของขวัญเมื่อมีการเชื่อมต่อ | ผู้ค้าปลีกสามารถดำเนินการแบบเรียลไทม์จากระบบร้านค้าเมื่อมีการเชื่อมต่อ                |
...
### <a name="universal-windows-platform-app-for-retail-modern-pos"></a>แอพแพลตฟอร์ม Universal Windows สำหรับ Retail Modern POS

ในปัจจุบัน Retail Modern POS จะพร้อมใช้งานเป็นแอพลิเคชัน Windows 8.1 สำหรับคอมพิวเตอร์เดสก์ท็อปและแท็บเล็ต และเป็นระบบคลาวด์ POS สำหรับเบราเซอร์เดสก์ท็อปหรือแท็บเล็ตเท่านั้น ในรุ่นนี้ Retail Moderns POS ถูกแปลงเป็นแอพแพลตฟอร์ม Universal Windows (UWP) การเปลี่ยนแปลงนี้จะเปิดใช้งาน Retail Modern POS เพื่อรันบนอุปกรณ์ Windows 10 (เดสก์ท็อป แท็บเล็ต หรือโทรศัพท์) และแม้แต่สลับระหว่างมุมมองต่างๆ สำหรับอุปกรณ์ที่เปิดใช้งาน Continuum
...
| สิ่งที่คุณสามารถทำได้                                                                                                                                                                | ทำไมนี่เป็นสิ่งสำคัญ                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ในฐานะผู้จัดจำหน่าย คุณสามารถจัดเก็บวัตถุดิบที่คลังสินค้าของลูกค้า ในฐานะลูกค้า คุณสามารถเลื่อนการซื้อจริงจนกระทั่งจำเป็นต้องใช้วัตถุดิบสำหรับการผลิต | การรักษาสินค้าคงคลังของวัตถุดิบอาจเกี่ยวข้องกับต้นทุนที่ร้ายแรง โดยใช้สินค้าคงคลังที่มีการส่งมอบ ผู้จัดจำหน่ายสามารถจัดเก็บวัตถุดิบที่คลังสินค้าของลูกค้า จากนั้นลูกค้าจึงสามารถเลื่อนการซื้อจริงจนกระทั่งจำเป็นต้องใช้วัตถุดิบสำหรับการผลิต วัตถุดิบจะถูกสั่งและได้รับโดยใช้ใบสั่งเพิ่มเติมสินค้าในการส่งมอบ ใบสั่งการเพิ่มเติมสินค้านี้บันทึกธุรกรรมที่เกิดขึ้นจริง แต่ไม่มีผลต่อบัญชีแยกประเภททั่วไป เพื่อแยกความแตกต่างระหว่างสินค้าคงคลังที่เป็นของลูกค้าและสินค้าคงคลังที่เป็นของผู้จัดจำหน่าย คุณสามารถใช้มิติสินค้าคงคลังของเจ้าของ การเปลี่ยนแปลงความเป็นเจ้าของสินค้าคงคลังถูกจัดการโดยกระบวนการของสมุดรายวันที่จัดการกับการโอนย้ายความเป็นเจ้าของของวัตถุดิบจากสินค้าคงคลังที่เป็นของผู้จัดจำหน่ายไปที่สินค้าคงคลังที่เป็นของลูกค้า กระบวนการนี้จะทริกเกอร์การสร้างใบสั่งซื้อและใบรับสินค้า **หมายเหตุ:** คุณลักษณะนี้จะจำกัดอยู่ที่การส่งมอบขาเข้าของวัตถุดิบสำหรับการผลิต ซึ่งจะไม่รวมเข้ากับการจัดการคลังสินค้า (WHS) และการจัดการการขนส่ง (TMS) |
...
| ดูข้อมูลเพิ่มเติมเกี่ยวกับการสนับสนุนการส่งมอบใน Dynamics 365 for Operations                                                                                                         | สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการสนับสนุนสำหรับกระบวนการส่งมอบ ดู[ส่งมอบ](/dynamics365/operations/scm/inventory/consignment),[การตั้งค่าการส่งมอบ](/dynamics365/operations/scm/inventory/set-up-consignment),[สร้างใบสั่งเติมสินค้าส่งมอบ (แนะนำงาน)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/)และ[เจ้าของการส่งมอบสินค้าคงคลังที่ยึดตามอุปสงค์การผลิต (รายการแนะนำงาน)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| เอกสารที่ใช้ร่วมกันที่เกี่ยวข้องกับใบสั่งซื้อกับผู้จัดจำหน่าย                    | เมื่อคุณต้องใช้เอกสารร่วมกับผู้จัดจำหน่ายอื่น เช่น เอกสารเกี่ยวกับข้อกำหนด ควรจะเชื่อมโยงเอกสารกับใบสั่งซื้อที่เกี่ยวข้อง จากนั้นผู้จัดจำหน่ายสามารถใช้บันทึกย่อและเอกสารแนบร่วมกันกับลูกค้าโดยการเชื่อมโยงเอกสารกับการตอบสนองของบุคคลดังกล่าวกับใบสั่งซื้อ การจัดการเอกสารเป็นกรอบงานที่สนับสนุนที่เน้น และเฉพาะบันทึกย่อและเอกสารแนบที่มีการจัดประเภทเป็น "ภายนอก" เท่านั้นที่สามารถใช้ร่วมกับผู้จัดจำหน่าย                                                                                                                                                                                                                                                                                                                              |
| เตรียมใช้งานผู้ใช้ที่เป็นผู้จัดจำหน่ายใหม่                                                          | ถ้าผู้จัดจำหน่ายของคุณใช้อินเทอร์เฟสการทำงานร่วมกันกับผู้จัดจำหน่าย พวกเขาจะมีวิธีการที่ไร้ที่ติในการร้องขอบัญชีผู้ใช้ใหม่เมื่อผู้ติดต่อใหม่ต้องการการเข้าถึงการทำงานร่วมกันกับผู้จัดจำหน่าย ผู้เชี่ยวชาญด้านการจัดซื้อสามารถส่งคำขอสำหรับบัญชีผู้ใช้สำหรับผู้ติดต่อในองค์กรของผู้จัดจำหน่าย ผู้ติดต่อของผู้จัดจำหน่ายที่มีผู้ใช้การทำงานร่วมกันกับผู้จัดจำหน่ายอยู่แล้วสามารถส่งคำขอชนิดนี้ได้ คำขอนี้จะสร้างผู้ใช้ใหม่ในขั้นสุดท้ายใน Dynamics 365 for Operations ที่มีบทบาทความปลอดภัยของผู้จัดจำหน่ายเฉพาะ นอกจากนี้ยังช่วยในการส่งคำขอไปยังเว็บไซต์ Microsoft Azure B2B เพื่อเตรียมใช้งานผู้ใช้ที่มีบัญชีผู้ใช้ Azure Active Directory (Azure AD) ใหม่ ผู้จัดจำหน่ายยังสามารถส่งคำขอให้ปิดใช้งานบัญชีผู้ใช้ที่เป็นผู้จัดจำหน่ายเฉพาะ หรือให้มีการปรับเปลี่ยนบทบาทความปลอดภัย |
| ดูข้อมูลเพิ่มเติมเกี่ยวกับการสนับสนุนสำหรับการทำงานร่วมกันกับผู้จัดจำหน่ายใน Dynamics 365 for Operations | ดูข้อมูลเพิ่มเติมเกี่ยวกับการทำงานร่วมกันกับผู้จัดจำหน่ายที่ [การทำงานร่วมกันกับผู้จัดจำหน่ายกับผู้จัดจำหน่ายภายนอก](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors) [การทำงานร่วมกันกับผู้จัดจำหน่ายกับลูกค้า](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations) [จัดการผู้ใช้การทำงานร่วมกันกับผู้จัดจำหน่าย](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users) [ตั้งค่าและรักษาการทำงานร่วมกันกับผู้จัดจำหน่าย](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration) และ [พื้นที่ทำงานการออกใบแจ้งหนี้ของการทำงานร่วมกันกับผู้จัดจำหน่าย](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace)                                                         |
...
<tbody>
<tr class="odd">
<td>กำหนดตำแหน่งที่ควรเป็นแหล่งข้อมูลของความต้องการ และควรเป็นแหล่งข้อมูลอย่างไร ในรายการใบสั่งขายโดยตรง <strong>ตัวอย่าง</strong>สร้างบรรทัดใบสั่งขาย และระบุจัดส่งโดยตรงเป็นชนิดการจัดส่ง ผู้จัดจำหน่ายหลักถูกเพิ่มไปยังรายการใบสั่งขายเป็นจุดแหล่งที่มา</td>
...
<tr class="even">
<td>สร้างสัญญาใบสั่งโดยตรงจากรายการใบสั่งขาย <strong>ตัวอย่าง</strong>สร้างบรรทัดใบสั่งขายที่มีต้นทางจากผู้ขายระหว่างบริษัท ออกจากรายการ วันที่จัดส่งจะถูกคำนวณตามความพร้อมใช้งานในบริษัทจัดหา</td>
...
| สร้างนโยบายการนำออกใช้สำหรับตู้บรรจุสินค้าที่บรรจุแล้ว                               | งานที่ถูกทริกเกอร์โดยการนำคอนเทนเนอร์ออกใช้อาจถูกสร้างขึ้นโดยอัตโนมัติหรือด้วยตนเอง เมื่อทำงานโดยอัตโนมัติ งานจะถูกสร้างในคอนเทนเนอร์แบบปิดโดยใช้คำสั่งที่ตั้งและกรอบงานเท็มเพลต เมื่อการนำออกใช้ทำงานด้วยตนเอง ผู้บรรจุสินค้าสามารถตัดสินใจว่าควรสร้างงานสำหรับคอนเทนเนอร์เดียวหรือสำหรับกลุ่มคอนเทนเนอร์ คุณลักษณะนี้ช่วยลดความเสี่ยงที่คอนเทนเนอร์แบบปิดที่ถูกจะเบิกสินค้า แล้วย้ายไปก่อนที่จะพร้อมที่จะย้ายจากสถานีบรรจุ นอกจากนี้ยังใช้ได้กับการนำออกใช้ที่มีการจัดกลุ่มที่ระบบไม่ได้กำหนด                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| การปันส่วนการเบิกสินค้าที่ขาด                                                   | มีการเพิ่มการสนับสนุนสำหรับกระบวนการเบิกสินค้าที่ขาด เพื่อช่วยในการเชื่อมโยงที่ไม่สามารถเบิกสินค้า และต้องการเติมเต็มลำดับเมื่อสินค้าจำเป็นต้องพร้อมใช้งานในที่ตั้งอื่น คุณสามารถใช้กระบวนการปันส่วนโดยอัตโนมัติที่ใช้คำสั่งที่ตั้งเดียวกันในการดึงข้อมูลสินค้าถ้าพร้อมใช้งานในที่ตั้งอื่น อีกทางหนึ่งคือ เมื่อมีใช้การปันส่วนด้วยตนเอง อุปกรณ์เคลื่อนที่จะแสดงรายชื่อของสถานที่พร้อมกับปริมาณที่พร้อมใช้งาน จากนั้นผู้ปฏิบัติงานคลังสินค้าสามารถเลือกสถานที่ที่จะใช้สินค้าคงคลัง มีสองวิธีที่สามารถตั้งค่าทีละรายการหรือแบบรวมเป็นคำสั่งเดียวในเมนูของผู้ปฏิบัติงานคลังสินค้า เมื่อมีการใช้การปันส่วนใหม่ด้วยตนเอง ผู้ปฏิบัติงานคลังสินค้าสามารถเบิกสินค้าในปริมาณของสินค้าที่เบิกขาดจากหลายสถานที่ สำหรับข้อมูลเพิ่มเติม ดู[ตั้งค่าการปันส่วนสินค้าการเบิกสินค้าแบบสั้น (แนะนำงาน)](http://ax.help.dynamics.com/en/wiki/set-up-short-picking-item-reallocation/)                                                                                                                                                                                          |
