...
-   เชื่อมโยงไปยังข้อมูลทางการเงิน ซึ่งอาจรวมถึงมิติค่าใน 365 Dynamics ของ Microsoft สำหรับการดำเนินงาน**หมายเหตุ:**คุณสามารถตั้งค่าคำนิยามแถวเพื่อดึงข้อมูลจากระบบมิติทางการเงินทุกครั้งที่มีสร้างรายงานได้
...
| ตัวเลือก                | คำอธิบาย                                                                                                                                                                                                                                                                      |
|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| มิติ             | รูปแบบซึ่งจะระบุมิติที่จะเพิ่มไปยังคำนิยามแถว รูปแบบนี้ประกอบด้วยเครื่องหมาย ampersand หนึ่ง (&) หรือเครื่องหมายตัวเลข (\#) สำหรับแต่ละตำแหน่งในมิติ โดยทั่วไป จะใช้เครื่องหมายทั้งหมดสำหรับมิติบัญชีหลักและเครื่องหมายตัวเลขทั้งหมดสำหรับมิติอื่นๆ |
...
4.  เมื่อต้องการจำกัดคำนิยามแถวให้กับช่วงเฉพาะของค่ามิติ ป้อนค่ามิติเริ่มต้นในเซลล์ ** เริ่มต้นช่วงมิติ **จากนั้นป้อนค่ามิติสิ้นสุดในเซลล์ **สิ้นสุดของช่วงมิติ** เพื่อรวมค่าทั้งหมดสำหรับมิติที่เลือก ปล่อยเซลล์เหล่านี้ให้ว่างไว้ **หมายเหตุ:**อักขระตัวแทน (\*หรือ?) ในมิติ ช่วงอาจส่งกลับผลลัพธ์ทั้งหมดที่คุณต้องการ ขึ้นอยู่กับว่าฐานข้อมูล ERP collates ข้อมูลได้
5.  ในฟิลด์ **เริ่มต้นรหัสแถว** ระบุรหัสแถวสำหรับค่ามิติแรกที่จะเพิ่มไปยังคำนิยามแถว
6.  ในฟิลด์ **เพิ่มแต่ละแถวโดย** ระบุความแตกต่างระหว่างรหัสแถวที่ต่อเนื่องกัน ตัวอย่างเช่น ถ้ารหัสแถวแรกคือ 100 และค่าเพิ่มขึ้นเป็น 30 ใหม่แถวแรกมีรหัส 100, 130, 160, 190 และ 220 ใช้ค่าเพิ่มขึ้นที่มีช่องว่างเพียงพอสำหรับการแทรกแถวใหม่ที่รูปแบบและสูตร
...
3.  คลิกปุ่มแถบเครื่องมือของรูปแบบที่ต้องการเพื่อนำไปใช้ ตัวอย่างเช่น การเยื้องแถว เลือกแถว และจากนั้น คลิ**เพิ่มการเยื้อง**![เพิ่มการเยื้อง](https://i-technet.sec.s-msft.com/dynimg/IC679497.gif "เพิ่มการเยื้อง")บนแถบเครื่องมือ
