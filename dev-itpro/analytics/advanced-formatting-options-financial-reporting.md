...
เมื่อคุณออกแบบรายงาน คุณควรสร้างแถวรายละเอียดทั้งหมดก่อนเพื่อให้แน่ใจว่า มูลค่าจะถูกดึงมาตามที่คาดไว้ หลังจากนั้น เพิ่ม **NP** (ไม่พิมพ์) รูปแบบการแทนที่เพื่อไม่แสดงรายละเอียดที่รวมค่าสุดท้าย **สิ่งสำคัญ:** เมื่อคุณใช้ **CAL** จัดรูปแบบรหัสในคำนิยามแถว คุณไม่สามารถดูรายละเอียดแนวลึกในธุรกรรมได้ สำหรับการบังคับ สูตรให้ใช้รูปแบบต่อไปนี้:&lt;คอลัมน์ปลายทาง&gt;=&lt;ริเริ่มคอลัมน์&gt;&lt;แถวรหัส&gt;แยกจัดวางใด ๆ เพิ่มเติมสำหรับแถวด้วยเครื่องหมายจุลภาคและช่องว่าง นี่คือตัวอย่าง: D=C.190,E=C.100
...
| รหัสแถว | คำอธิบาย                      | จัดรูปแบบรหัส | สูตร/แถว/หน่วย ที่เกี่ยวข้อง | การแทนที่รูปแบบ | ยอดดุลปกติ | ควบคุมการพิมพ์ | ข้อจำกัดของคอลัมน์ | ตัวปรับเปลี่ยนแถว               | ลิงค์ไปยังมิติทางการเงิน |
|----------|----------------------------------|-------------|-----------------------------|-----------------|----------------|---------------|--------------------|----------------------------|------------------------------|
| 100      | เงินสดในช่วงเริ่มต้นของระยะเวลา (NP) |             |                             |                 |                |               |                    | ตัวปรับเปลี่ยนบัญชี = \[/BB\] | + Segment2 = \[1100\]         |
| 130      | เงินสดในช่วงเริ่มต้นของระยะเวลา      | CAL         | C=C.100,F=D.100             |                 |                |               |                    |                            |                              |
| 160      |                                  |             |                             |                 |                |               |                    |                            |                              |
| 190      |                                  |             |                             |                 |                |               |                    |                            |                              |
...
2.  ดับเบิลคลิกเซลล์ **สูตร/แถว/หน่วยที่เกี่ยวข้อง** ที่เหมาะสม
3.  ในกล่องโต้ตอบ **การเลือกหน่วยการรายงาน** ในฟิลด์ **แผนภูมิการรายงาน** เลือกแผนภูมิที่กำหนดในข้อกำหนดของรายงาน
...
สามารถรวมสูตรการคำนวณในคำนิยามแถว**+**, **-**, **\***และ**/**ตัวดำเนินการ และ**นั้น/IF/ELSE**ใบแจ้งยอดได้ นอกจากนี้ การคำนวณสามารถเกี่ยวข้องกับแต่ละเซลล์และยอดเงินที่แน่นอน (หมายเลขจริงที่จะรวมอยู่ในสูตร) สูตรสามารถมีอักขระได้มากถึง 1024 อักขระ การคำนวณไม่สามารถใช้กับแถวที่มีเซลล์ของชนิด **ลิงค์ไปยังมิติทางการเงิน** (ดีมอนตัวกรอง) ได้ อย่างไรก็ตาม คุณสามารถรวมการคำนวณในแถวที่ต่อเนื่องกัน ระงับการพิมพ์แถวเหล่านั้น แล้วหลังจากนั้นก็รวมแถวการคำนวณ

### <a name="operators-in-a-calculation-formula"></a>ตัวดำเนินการในสูตรการคำนวณ

สูตรการคำนวณใช้ตัวดำเนินการซับซ้อนมากกว่าสูตรแถวผลรวม อย่างไรก็ตาม ที่คุณสามารถใช้การ**\***และ**/**ตัวดำเนินการร่วมกับตัวดำเนินการเพิ่มเติมที่จะใช้คูณ (\*) และหาร (/) เงินได้ เมื่อใช้ช่วงหรือผลรวมในสูตรการคำนวณ คุณต้องใส่เครื่องหมาย (@) ไว้หน้ารหัสแถวใดๆ ยกเว้นว่าคุณกำลังใช้คอลัมน์ในคำนิยามแถว ตัวอย่างเช่น เพื่อเพิ่มยอดเงินในแถว 100 ยอดเงินในแถว 330 คุณสามารถใช้สูตรผลรวมของแถว**100 + 330**หรือสูตรการคำนวณ**@100+@330**ได้ **หมายเหตุ:** คุณต้องใช้เครื่องหมาย (@) ก่อนทุกรหัสแถวที่คุณใช้ในสูตรการคำนวณ มิฉะนั้น หมายเลขจะถูกอ่านเป็นจำนวนเต็ม ตัวอย่างเช่น สูตร**@100+330** USD 330 เพิ่มเข้าในยอดเงินในแถว 100 เมื่อคุณอ้างอิงคอลัมน์ในสูตรการคำนวณ เครื่องหมาย (@) ก็ไม่จำเป็น
...
ในตัวอย่างนี้ สูตรการคำนวณ**@100+@330**หมายความ ว่า ยอดเงินในแถว 100 ถูกเพิ่มเข้าในยอดเงินในแถว 330 สูตรผลรวมของแถว**340 + 370**เพิ่มยอดเงินในแถว 340 ไปยอดเงินในแถว 370 (ยอดเงินในแถว 370 เป็นจำนวนจากสูตรการคำนวณ)

| รหัสแถว | คำอธิบาย                 | รหัสรูปแบบ | สูตร/แถว/หน่วย ที่เกี่ยวข้อง | ควบคุมการพิมพ์ | ตัวปรับเปลี่ยนแถว | ลิงค์ไปยังมิติทางการเงิน |
|----------|-----------------------------|-------------|----------------------------|---------------|--------------|------------------------------|
...
เมื่อแถวในคำนิยามแถวมีรหัสรูปแบบของ **CAL**และคุณป้อนการคำนวณทางคณิตศาสตร์ในเซลล์ **สูตร/แถว/หน่วยที่เกี่ยวข้อง** คุณยังต้องป้อนหนังสือเชื่อมโยงคอลัมน์และแถวในรายงานด้วย ตัวอย่างเช่น ป้อน**A.120**เพื่อแสดงคอลัมน์ A แถว 120 อีกวิธีหนึ่งคือ คุณสามารถใช้เป็นเครื่องหมาย (@) เพื่อระบุว่า คอลัมน์ทั้งหมดได้ ตัวอย่างเช่น ป้อน**@120**เพื่อแสดงคอลัมน์ทั้งหมดในแถว 120 การคำนวณทางคณิตศาสตร์ใด ๆ ที่ไม่มีตัวอักษรคอลัมน์ หรือมีเครื่องหมาย (@) จะถือว่าเป็นจำนวนจริง **หมายเหตุ:**ถ้าคุณใช้รหัสป้ายชื่อแถวในการอ้างอิงแถว คุณต้องใช้จุด (.) เป็นตัวแบ่งระหว่างตัวอักษรคอลัมน์และป้ายชื่อ (ตัวอย่างเช่น**A.GROSS\_MARGIN/A.SALES**) ถ้าคุณใช้เป็นเครื่องหมาย (@), ตัวแบ่งไม่จำเป็น (ตัวอย่างเช่น**@GROSS\_MARGIN/@SALES**)
...
-   เมื่อต้องการจำกัดสูตรสำหรับคอลัมน์ที่เฉพาะเจาะจง ใส่อักษรคอลัมน์ หมายเท่ากับ (**=**), และสูตรแล้ว
...
**สามารถเพิ่มคำสั่ง IF/THEN/ELSE** เพื่อคำนวณใดๆ ที่ถูกต้อง และใช้กับรูปแบบ **CAL** ได้ คุณป้อน **IF/THEN/ELSE** สูตรการคำนวณในเซลล์ในคอลัมน์ **สูตร/แถว/หน่วยที่เกี่ยวข้อง** **วันที่ นั้น/IF/ELSE**คำนวณสูตรให้ใช้รูปแบบต่อไปนี้: IF&lt;งบจริง/เท็จ&gt;แล้ว&lt;สูตร&gt;ELSE&lt;สูตร&gt;**ELSE&lt;สูตร&gt;**หรือไม่ก็ได้เป็นส่วนหนึ่งของคำสั่ง
...
-   **ถ้า A.200&gt;0** (การประเมินอย่างง่าย)
-   **ถ้า A.200&gt;0 และ A.200&lt;10000** (รายงานที่ซับซ้อน)
-   **ถ้า A.200&gt;10000 หรือ ((A.340/B.1200)\*2 &lt;1200)** (ซับซ้อนงบการเงินที่ประกอบด้วยหลายนิพจน์)
...
**THEN** และ **ELSE** สูตรสามารถคำนวณใดๆ ถูกต้อง จากการกำหนดค่าไปยังสูตรที่ซับซ้อนได้ ตัวอย่างเช่น คำ**IF A.200&gt;0 แล้ว A=B.200**หมายถึง "ถ้าค่าในเซลล์ในคอลัมน์ A แถว 200 จะมากกว่า 0 (ศูนย์), ใส่ค่าจากเซลล์ในคอลัมน์ B แถว 200 ลงในเซลล์ในคอลัมน์ A แถวปัจจุบัน" คำสั่ง **IF/THEN** ก่อนหน้าใส่ค่าในคอลัมน์หนึ่งของแถวปัจจุบัน อย่างไรก็ตาม คุณยังสามารถใช้เครื่องหมาย (@) ในการประเมินจริง/เท็จหรือสูตรเพื่อแสดงคอลัมน์ทั้งหมดได้ นี่คือตัวอย่างอื่นๆ ที่อธิบายไว้ในส่วนต่อไปนี้:

-   **ถ้า A.200 &gt;0 แล้ว B.200**: ถ้าค่าในเซลล์ A.200 เป็นบวก ค่าจากเซลล์ B.200 อยู่ในทุกคอลัมน์ของแถวปัจจุบัน
-   **ถ้า A.200 &gt;0 แล้ว@200**: ถ้าค่าในเซลล์ A.200 เป็นบวก ค่าจากคอลัมน์แต่ละคอลัมน์ในแถว 200 ถูกใส่ลงในคอลัมน์ที่สอดคล้องกันในแถวปัจจุบัน
-   **ถ้า@200&gt;0 แล้ว@200**: ถ้าค่าในแถว 200 ของคอลัมน์ปัจจุบันเป็นบวก ค่าจากแถว 200 อยู่ในคอลัมน์เดียวกันในแถวปัจจุบัน
...
เมื่อต้องการจำกัดการคำนวณเพื่อให้หน่วยในแผนภูมิซึ่งรายงาน รายงานเดียวเพื่อให้ยอดเงินเป็นผลลัพธ์ไม่ได้สะสมค่าไปยังระดับที่สูงกว่าหน่วย คุณสามารถใช้การ**@Unit**รหัสในการ**หน่วยที่เกี่ยวข้อง สูตร/แถว/**เซลล์ในคำนิยามแถวได้ การ**@Unit**รหัสจะแสดงในคอลัมน์ B ของแผนภูมิรายงาน**ชื่อหน่วย** เมื่อคุณใช้แบบ**@Unit**รหัส ค่าสะสมไม่ได้ แต่การคำนวณจะถูกประเมินในทุกระดับของแผนภูมิการรายงาน **หมายเหตุ:** ใช้ฟังก์ชั่น แผนภูมิการรายงานต้องเชื่อมโยงกับคำนิยามแถว แถวการคำนวณสามารถอ้างอิงถึงแถวการคำนวณหรือแถวข้อมูลทางการเงิน การคำนวณจะถูกบันทึกในเซลล์ **สูตร/แถว/หน่วยที่เกี่ยวข้อง** ของคำนิยามแถวและการจำกัดชนิดข้อมุลทางการเงิน การคำนวณต้องใช้การคำนวณแบบมีเงื่อนไขที่เริ่มต้นด้วยการ**IF @Unit**ก่อสร้าง นี่เป็นตัวอย่าง: IF @Unit(ขาย) แล้ว@100ELSE 0 คำนวณนี้ประกอบด้วยยอดเงินจากแถว 100 ในทุกคอลัมน์ของรายงาน แต่เฉพาะสำหรับหน่วยการขาย ถ้าหลายหน่วยถูกเรียกว่าการขาย ยอดเงินจะปรากฏในแต่ละหน่วยเหล่านั้น นอกจากนี้ แถว 100 สามารถเป็นแถวข้อมูลทางการเงิน และสามารถกำหนดเป็นไม่มีการพิมพ์ได้ ในกรณีนี้ ยอดเงินถูกป้องกันไม่ให้ปรากฏในหน่วยทั้งหมดในแผนภูมิ คุณยังสามารถจำกัดจำนวนคอลัมน์เดี่ยวของรายงาน เช่นคอลัมน์ H โดยใช้ข้อจำกัดในคอลัมน์ที่จะพิมพ์ค่าเฉพาะในคอลัมน์ของรายงานนั้น คุณสามารถรวม **หรือ** ชุดรวมในคำสั่ง **IF** ได้ นี่เป็นตัวอย่าง: IF @Unit(การขาย) หรือ@Unit(SALESWEST) แล้ว 5 ELSE@100คุณสามารถระบุหน่วยในข้อจำกัดการคำนวณชนิดหนึ่งในวิธีการต่อไปนี้:

-   ป้อนชื่อหน่วยเพื่อรวมหน่วยที่ตรงกัน ตัวอย่างเช่น**IF @Unit(การขาย)**ช่วยให้การคำนวณสำหรับหน่วยใด ๆ ที่มีชื่อว่าการขาย แม้ว่าจะขายหลายหน่วยในแผนภูมิการรายงาน
-   ป้อนชื่อบริษัทและหน่วยเพื่อจำกัดการคำนวณไปยังหน่วยที่ระบุในบริษัทที่ระบุ ตัวอย่างเช่น ป้อน**IF @Unit(รุ่งเรือง: ขาย**) เพื่อจำกัดการคำนวณกับหน่วยการขายในบริษัทรุ่งเรือง
-   ป้อนรหัสลำดับชั้นแบบเต็มจากแผนภูมิการรายงานเพื่อจำกัดการคำนวณหน่วยที่ระบุ ตัวอย่างเช่น ป้อน**IF @Unit(สรุป ^ รุ่งเรือง ^ โคสท์ตะวันตก ^ ขาย)** **หมายเหตุ:** พบรหัสลำดับชั้นแบบเต็ม คลิกขวาในข้อกำหนดแผนภูมิการรายงาน จากนั้นเลือก **สำเนาตัวบ่งชี้หน่วยการรายงาน (รหัส H)**

#### <a name="restrict-a-calculation-to-a-reporting-unit"></a>จำกัดการคำนวนไปที่หน่วยการรายงาน

1.  ในโปรแกรมออกแบบรายงาน คลิก **คำนิยามแถว** แล้วจึงเปิดคำนิยามแถวเพื่อแก้ไข
2.  ดับเบิลคลิกเซลล์ **รหัสรูปแบบ** จากนั้นเลือก **CAL**
3.  คลิก**หน่วยที่เกี่ยวข้อง สูตร/แถว/**เซลล์ และจากนั้น ป้อนการคำนวณแบบมีเงื่อนไขที่เริ่มต้นด้วยการ**IF @Unit**ก่อสร้าง

### <a name="ifthenelse-statements-in-a-column-definition"></a>คำสั่ง IF/THEN/ELSE ในคำนิยามแถว

คำสั่ง **IF/THEN/ELSE** ช่วยในการคำนวณใดๆ เพื่อจะขึ้นอยู่กับผลลัพธ์จากคอลัมน์อื่น คุณสามารถอ้างอิงไปยังคอลัมน์อื่น แต่คุณไม่สามารถอ้างอิงไปยังเซลล์รายงานในคำสั่ง **IF** การคำนวณใดๆ ต้องถูกใช้กับคอลัมน์ทั้งหมด ตัวอย่าง คำสั่ง**IF B&gt;100 แล้ว C อื่น B\*1.25**หมายถึง, "ถ้ายอดเงินในคอลัมน์ B คือ มากกว่า 100 ใส่ค่าจากคอลัมน์ B ที่อยู่ใน**คำนวณ**คอลัมน์ ถ้ายอดเงินในคอลัมน์ B ไม่เกิน 100 คูณค่าในคอลัมน์ C ด้วย1.25 และวางผลลัพธ์ในคอลัมน์ **คำนวณ** " ตามคำสั่ง **IF** ด้วยคำสั่งตรรกะที่สามารถประเมินเป็นจริงหรือเท็จได้เสมอ สูตรที่คุณใช้สำหรับทั้งคำสั่ง **THEN** และคำสั่ง **ELSE** สามารถประกอบด้วยข้อมูลอ้างอิงถึงจำนวนคอลัมน์ และสูตรเหล่านี้สามารถเป็นแบบซับซ้อน ตามที่คุณสร้าง **หมายเหตุ:** คุณไม่สามารถใส่ผลลัพธ์ของการคำนวณในคอลัมน์อื่นได้ ผลลัพธ์ต้องอยู่ในคอลัมน์ที่มีสูตร
