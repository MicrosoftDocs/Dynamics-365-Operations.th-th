...
| ดู รายงาน                       | เปิดรายงานที่สร้างรุ่นล่าสุดใน 365 Dynamics สำหรับการดำเนินงาน คำสั่งนี้จะพร้อมใช้งานจากข้อกำหนดของรายงานถ้าคุณได้สร้างรายงานอย่างน้อยหนึ่งรายการ                                 |
...
| นำเข้าลำดับชั้นของเซ็ตมิติ         | เปิดกล่องโต้ตอบ **ลำดับชั้นของเซ็ตมิติ** ซึ่งคุณสามารถนำเข้าลำดับชั้นของเซ็ตมิติจากข้อมูลทางการเงิน คำสั่งนี้จะพร้อมใช้งานจากคำนิยามของแผนภูมิการรายงานสำหรับการ... ระบบ \financial-dimensions\dimension-based  |
| แทรกหน่วยการรายงาน                  | แทรกแถวว่างลงในคำนิยามแผนภูมิรายงาน คำสั่งนี้จะพร้อมใช้งานจากข้อกำหนดของรายงานคำนิยามแผนภูมิรายงาน                                                                                                |
| ลบหน่วยการรายงาน                  | ลบแถวหน่วยรายงานที่เลือกจากคำนิยามแผนภูมิรายงาน คำสั่งนี้จะพร้อมใช้งานจากข้อกำหนดของรายงานคำนิยามแผนภูมิรายงาน                                                                             |
...
| หน้ายินดีต้อนรับ    | เปิดหน้า **ต้อนรับ**.                                             |
...
| คำสั่ง | คำอธิบาย                                                  |
|---------|--------------------------------------------------------------|
| วิธีใช้    | เปิด 365 Dynamics สำหรับเพจ wiki วิธีใช้ของการดำเนินงานสำหรับการรายงานทางการเงิน |
|         |                                                              |
...
| ปุ่ม                                                                                                                                                                                   | คำอธิบาย                                                                                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [![New button](./media/rowc130389.png)](./media/rowc130389.png)                              | สร้าง ใหม่ (ว่าง) คำนิยามแถว คำนิยามคอลัมน์ คำนิยามแผนภูมิรายงาน หรือข้อกำหนดของรายงาน                                                                               |
...
| [![ตัดปุ่ม](./media/cutc130389.png)](./media/cutc130389.png)                              | ลบข้อความที่เลือก และคัดลอกไปที่คลิปบอร์ด                                                                                                                                |
| [![ปุ่มวาง](./media/pastec130389.png)](./media/pastec130389.png)                        | แทรกข้อความจากคลิปบอร์ด                                                                                                                                                    |
| [![ปุ่มยกเลิก](./media/undoc130389.png)](./media/undoc130389.png)                           | เลิกทำการดำเนินการล่าสุด                                                                                                                                                                  |
| [![ปุ่มทำซ้ำ](./media/redoc130389.png)](./media/redoc130389.png)                           | กลับการดำเนินการที่เลิกทำล่าสุด                                                                                                                                                          |
...
| [![แทรกปุ่มแถว](./media/insertrowc130389.png)](./media/insertrowc130389.png)           | แทรกแถวว่างลงในคำนิยามแถวหรือมีแถวส่วนหัวที่ว่างลงในคำนิยามคอลัมน์ ปุ่มนี้จะพร้อมใช้งานจากคำนิยามแถวหรือคำนิยามคอลัมน์                    |
| [![แทรกปุ่มคอลัมน์](./media/insertcolumnc130389.png)](./media/insertcolumnc130389.png)  | แทรกคอลัมน์ว่างลงในคำนิยามคอลัมน์ ปุ่มนี้จะพร้อมใช้งานจากคำนิยามคอลัมน์                                                                                  |
| [![ปุ่ม'ล็อก'](./media/lockc130389.png)](./media/lockc130389.png)                           | นำรหัสผ่านไปใช้กับบล็อคส่วนประกอบปัจจุบัน ปุ่มนี้จะพร้อมใช้งานสำหรับผู้ใช้ที่มีบทบาทเป็น **ผู้ออกแบบ** หรือ **ผู้ดูแลระบบ**.                                                 |
...
| [![ปุ่ม'วิธีใช้'](./media/helpc130389.png)](./media/helpc130389.png)                           | เปิด'วิธีใช้'                                                                                                                                                                             |
...
| ปุ่ม                                                                                                                                                                                                   | คำอธิบาย                                             |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|
| [![ปุ่มลักษณะแบบอักษร](./media/formattingc130389.png)](./media/formattingc130389.png)                         | ใช้ลักษณะตัวอักษรที่เลือกกับข้อความปัจจุบัน      |
| [![ปุ่มแบบอักษร](./media/fonttype.png)](./media/fonttype.png)                                                 | ตั้งค่าข้อความปัจจุบันให้เป็นตัวอักษรที่เลือกไว้              |
| [![ปุ่ม'ขนาดแบบอักษร'](./media/fontsize.png)](./media/fontsize.png)                                            | ตั้งค่าข้อความปัจจุบันเป็นขนาดตัวอักษรที่เลือก (ตามจุด) |
...
| [![ปุ่มลดการเยื้อง](./media/outdentlsc130389.png)](./media/outdentlsc130389.png)                      | ลดระดับย่อหน้าของข้อความปัจจุบัน                |
| [![ปุ่มเพิ่มการเยื้อง](./media/indentlsc130389.png)](./media/indentlsc130389.png)                        | เพิ่มระดับย่อหน้าของข้อความปัจจุบัน                |
...
| [![ปุ่มสีแบบอักษร](./media/fontcolorc130389.png)](./media/fontcolorc130389.png)                           | เปลี่ยนสีตัวอักษรให้กับข้อความปัจจุบัน                   |
...
| [![รายงานปุ่มนิยามของแผนภูมิ](./media/treec130389.png)](./media/treec130389.png)             | แสดงคำนิยามแผนภูมิรายงานที่กำหนดให้กับข้อกำหนดของรายงานที่ใช้งานอยู่                                                                                         |
...
| [![สร้างปุ่มรายงาน](./media/generate-to-ddvc130389.png)](./media/generate-to-ddvc130389.png) | สร้างรายงานจากข้อกำหนดของรายงานที่ใช้งานอยู่ ปุ่มนี้จะพร้อมใช้งานจากคำนิยามรายงาน                                                                      |
