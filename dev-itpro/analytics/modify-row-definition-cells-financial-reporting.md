...
-   ป้ายชื่อต้องขึ้นต้นด้วยอักขระตัวอักษร (a ถึง z หรือ A ถึง Z), และสามารถเป็นได้ทั้งตัวเลข และตัวอักษรสูงสุด 16 อักขระ **หมายเหตุ:**ป้ายชื่อสามารถประกอบด้วยอักขระขีดล่าง (\_), แต่ไม่มีอักขระพิเศษอื่น ๆ ที่ได้รับอนุญาตได้
...
เซลล์ **รูปแบบรหัส** จะมีการเลือกตัวเลือกที่ตั้งค่าไว้ก่อนสำหรับเนื้อหาของแถวนั้นๆ ถ้าเซลล์ **รูปแบบรหัส** ว่าง เแถวจะถูกแปลผลเป็นแถวรายละเอียดข้อมูลทางการเงิน **หมายเหตุ:** ถ้ารายงานประกอบด้วยแถวที่จัดรูปแบบที่ไม่ใช่ยอดเงินที่เกี่ยวข้องกับแถวยอดที่ระงับไว้ (ตัวอย่างเช่น เนื่องจากมียอดดุลเป็นศูนย์) คุณสามารถใช้คอลัมน์ **สูตร/แถว/หน่วยที่เกี่ยวข้อง** เพื่อป้องกันไม่ให้พิมพ์แถวชื่อเรื่องและรูปแบบ
...
3.  เลือกรหัสรูปแบบในรายการ ตารางต่อไปนี้ อธิบายถึงรหัสรูปแบบและการดำเนินการ
    ...
    | CAL                           | การคำนวณ                        | ระบุแถวที่ใช้ตัวดำเนินการทางคณิตศาสตร์ในคอลัมน์ **สูตร/แถว/หน่วยที่เกี่ยวข้อง** การคำนวณประกอบด้วยตัวดำเนินการซับซ้อน เช่น**+**, **-**, **\***, **/**และ**นั้น/IF/ELSE**ใบแจ้งยอด |
    ...
    | ASORTDESC SORTDESC ASORT การเรียงลำดับ | เรียงลำดับ                               | เรียงลำดับค่าใช้จ่ายหรือรายได้ เรียงลำดับรายงาต่างของที่ใช้จริงหรืองบประมาณตามผลต่างสูงสุด หรือเรียงลำดับคำอธิบายตามลำดับอักษร                                                                   |
...
ในการ**รหัสรูปแบบ**คอลัมน์ในคำนิยามแถว**DES**, **LFT**, **RGT**, **CEN**, **---**และ**===**รหัสรูปแบบที่จัดรูปแบบไปยังแถวที่ไม่ใช่ยอดเงิน เมื่อต้องการป้องกันการจัดรูปแบบนี้จากการพิมพ์เมื่อถูกระงับแถวยอดเงินที่เกี่ยวข้อง (ตัวอย่างเช่น เนื่องจากแถวยอดเงินประกอบด้วยค่าเป็นศูนย์ หรือไม่มีกิจกรรมรอบระยะเวลา), คุณต้องเชื่อมโยงแถวรูปแบบกับแถวยอดเงินที่สอดคล้องกัน ฟังก์ชันนี้มีประโยชน์เมื่อคุณต้องการป้องกันไม่ให้มีการพิมพ์ส่วนหัว หรือการจัดรูปแบบที่เกี่ยวข้องกับผลรวมย่อย เมื่อไม่มีรายละเอียดที่จะพิมพ์สำหรับรอบระยะเวลา **หมายเหตุ:** คุณยังสามารถป้องกันไม่ให้มีการพิมพ์แถวยอดเงินโดยละเอียด โดยการยกเลิกตัวเลือกการแสดงแถวที่ไม่มียอดเงินได้ ตัวเลือกนี้จะอยู่ในแท็บ **ตั้งค่า** ของข้อหนดของรายงาน โดยค่าเริ่มต้น บัญชีรายละเอียดธุรกรรมที่มียอดดุลเป็นศูนย์หรือไม่มีกิจกรรมรอบระยะเวลา จะถูกระงับไว้ในรายงาน เมื่อต้องการแสดงบัญชีรายละเอียดธุรกรรมเหล่านี้ เลือกกล่องกาเครื่องหมาย **แสดงแถวที่ไม่มียอดเงิน** บนแท็บ **ตั้งค่า** ของข้อกำหนดของรายงาน
...
ในตัวอย่างต่อไปนี้ สาธินีต้องการป้องกันไม่ให้ส่วนหัวและเส้นใต้ในแถว **ยอดรวมเงินสด** ของรายงานของเธอถูกพิมพ์ เนื่องจากไม่มีกิจกรรมในบัญชีเงินสด ดังนั้น ในแถว 220 ( ซึ่งเป็น**---**รูปแบบรหัสบ่งชี้ ถูกจัดรูปแบบแถว), ในการ**หน่วยที่เกี่ยวข้อง สูตร/แถว/**เซลล์ เธอป้อน**250**ซึ่งเป็นรหัสแถวของแถวยอดที่เธอต้องการที่ระงับ [![RelatedRowsRowDefinition](./media/relatedrowsrowdefinition-1024x144.png)](./media/relatedrowsrowdefinition.png)
...
6.  ในเมนู **ไฟล์** คลิก **บันทึกเป็น** เพื่อบันทึกคำนิยามคอลัมน์ภายใต้ชื่อใหม่ ผนวก**CBR**เป็นชื่อไฟล์ปัจจุบัน (ตัวอย่างเช่น**ปัจจุบัน\_YTD\_CBR**) คำนิยามคอลัมน์นี้คือคำนิยามคอลัมน์แถวพื้นฐานของคุณ
...
ในตัวอย่างของคำนิยามแถวต่อไปนี้ แถว 100 แสดงให้เห็นว่า แถวพื้นฐานสำหรับการคำนวณคือแถว 280 [![ตัวอย่างของการคำนวณฐานแถว](./media/cbrrowdefinition.png)](./media/cbrrowdefinition.png) ในตัวอย่างของคำนิยามคอลัมน์ต่อไปนี้ การคำนวณใช้รหัสการจัดรูปแบบ **CBR** การคำนวณในคอลัมน์ C หารค่าในคอลัมน์ B ของรายงานตามค่าในแถว 280 ของคอลัมน์ B คอลัมน์ B แทนที่รูปแบบ พิมพ์ผลลัพธ์ของการคำนวณออกมาเป็นเปอร์เซ็นต์ ในทำนองเดียวกัน แต่ละยอดในคอลัมน์ E คือ จำนวนเงินในคอลัมน์ D เป็นเปอร์เซ็นต์ของยอดขายสุทธิ [![ตัวอย่างคำนิยามคอลัมน์](./media/cbrcolumndefinition2.png)](./media/cbrcolumndefinition2.png) ตัวอย่างต่อไปนี้ แสดงรายงานที่อาจถูกสร้างขึ้นตามการคำนวณก่อนหน้านี้ [![ตัวอย่างรายงานที่ยึดตามการคำนวณของตัวอย่างก่อนหน้านี้](./media/cbrreport-1024x272.png)](./media/cbrreport.png)
...
4.  ในเซลล์ **ข้อจำกัดของคอลัมน์** ป้อนจดหมายของรายงานคอลัมน์ที่จะใช้สำหรับการเรียงลำดับ **หมายเหตุ:** รวมเฉพาะแถวยอดเงินในการคำนวณการเรียงลำดับ

### <a name="examples-of-ascending-and-descending-column-values"></a>ตัวอย่างของค่าของคอลัมน์จากน้อยไปมาก และจากมากไปน้อย

ในตัวอย่างต่อไปนี้ ค่าในคอลัมน์ D ของรายงานจะถูกเรียงลำดับในการเรียงลำดับสำหรับแถว 160 ถึง 490 นอกจากนี้ ค่าสัมบูรณ์ในคอลัมน์ G ของรายงานจะถูกเรียงลำดับในการเรียงลำดับสำหรับแถว 610 ถึง 940
...
**เรียงลำดับตามผลต่างสัมบูรณ์ YTD ในลำดับจากมากไปน้อย**
...
-   **ข้อความการแทนค่าศูนย์** – ข้อความที่จะรวมในรายงานเมื่อยอดเงินเป็น 0 (ศูนย์) ข้อความนี้จะปรากฏเป็นรายการสุดท้ายในพื้นที่ **ตัวอย่าง** **หมายเหตุ:** ถ้าการพิมพ์จะถูกระงับไว้เนื่องจากค่าศูนย์หรือไม่มีกิจกรรมประจำรอบระยะเวลา ข้อความนี้จะถูกระงับไว้
...
ชนิดควรแสดงถึงค่าบวก และค่าลบ โดยทั่วไป คุณสามารถป้อนรูปแบบคล้ายคลีงกันที่แยกความแตกต่างของค่าบวกและค่าลบ ตัวอย่างเช่น เพื่อระบุว่า ค่าบวก และค่าลบที่มีทศนิยมสองตำแหน่ง แต่เป็นค่าลบปรากฏในวงเล็บ ป้อน**0.00;(0.00)** ตารางต่อไปนี้แสดงรูปแบบกำหนดเองที่คุณสามารถใช้ในการควบคุมรูปแบบของค่าของคุณ ตัวอย่างทั้งหมดเริ่มต้นจากค่า 1234.56
...
5.  ภายใต้ **แอททริบิวต์** ให้ทำตามขั้นตอนเหล่านี้เพื่อเพิ่มรายการสำหรับแต่ละแอททริบิวต์ที่ควรจะรวมกับรหัสแถว:
    1.  ดับเบิลคลิกเซลล์ **แอททริบิวต์** และเลือกชื่อแอททริบิวต์ **ข้อควรระวัง:**แทนเครื่องหมายตัวเลข (\#) มีค่าตัวเลข
...
เมื่อคุณเลือกบัญชีที่ระบุ โดยปกติผู้ออกแบบรายงานจะรวมบัญชี และปีบัญชี รอบระยะเวลา และข้อมูลอื่น ๆ ที่คุณระบุในคำนิยามคอลัมน์ คุณสามารถใช้ข้อมูลที่แตกต่างกัน เช่นรอบระยะเวลาทางบัญชีต่าง ๆ สำหรับแถวที่ระบุ ตารางต่อไปนี้แสดงตัวปรับเปลี่ยนบัญชีที่พร้อมใช้งาน แทนเครื่องหมายตัวเลข (\#) มีค่าที่เท่ากับ หรือน้อยกว่าจำนวนของรอบระยะเวลาในปีงบประมาณ

| ตัวปรับเปลี่ยนบัญชี | สิ่งที่พิมพ์                                                                           |
|------------------|-------------------------------------------------------------------------------------------|
| /BB              | ยอดดุลต้นงวดสำหรับบัญชี                                                     |
| /\#              | ยอดดุลสำหรับรอบระยะเวลาที่ระบุ                                                     |
| /-\#             | ยอดดุลสำหรับรอบระยะเวลาที่เป็น\#รอบระยะเวลาก่อนหน้ารอบระยะเวลาปัจจุบัน                  |
| /+\#             | ยอดดุลสำหรับรอบระยะเวลาที่เป็น\#รอบระยะเวลาหลังจากรอบระยะเวลาปัจจุบัน                   |
| /C               | ยอดดุลสำหรับรอบระยะเวลาปัจจุบัน                                                       |
| /C-\#            | ยอดดุลสำหรับรอบระยะเวลาที่เป็น\#รอบระยะเวลาก่อนหน้ารอบระยะเวลาปัจจุบัน                  |
| /C+\#            | ยอดดุลสำหรับรอบระยะเวลาที่เป็น\#รอบระยะเวลาหลังจากรอบระยะเวลาปัจจุบัน                   |
| /Y               | ยอดดุลปีปัจจุบันตามรอบระยะเวลาปัจจุบัน                                      |
| /Y-\#            | ยอดดุลต้นปีถึงรอบระยะเวลาที่จะ\#รอบระยะเวลาก่อนหน้ารอบระยะเวลาปัจจุบัน |
| /Y+\#            | ยอดดุลต้นปีถึงรอบระยะเวลาที่จะ\#รอบระยะเวลาหลังจากรอบระยะเวลาปัจจุบัน  |

### <a name="book-code-modifiers"></a>ตัวปรับเปลี่ยนรหัสสมุดบัญชี

คุณสามารถจำกัดแถวไปยังรหัสสมุดที่มีอยู่ คำนิยามคอลัมน์ต้องมีอย่างน้อยหนึ่งคอลัมน์ **FD=** ที่มีรหัสสมุดบัญชี **หมายเหตุ:** ข้อจำกัดของรหัสสมุดบัญชีสำหรับการแทนที่ข้อจำกัดของรหัสสมุดบัญชีในคำนิยามคอลัมน์สำหรับแถวนั้น
...
5.  ในการ**จาก**ฟิลด์ ป้อนขนาดเริ่มต้น หรือคลิ![เรียกดู](https://i-technet.sec.s-msft.com/dynimg/IC679490.gif "เรียกดู")การค้นหาสำหรับมิติที่พร้อมใช้งาน เมื่อต้องการป้อนช่วงของมิติ ป้อนมิติสิ้นสุดในฟิลด์ **ถึง**
...
เมื่อคุณป้อนค่าเซ็กเมนต์ที่เป็นธรรมชาติในการ**ขนาด**กล่องโต้ตอบ คุณสามารถใส่ตัวอักขระตัวแทนอักขระ (หรือไม่ หรือ\*) ในตำแหน่งใด ๆ ของเซ็กเมนต์ ตัวออกแบบรายงานแยกค่าทั้งหมดสำหรับตำแหน่งที่กำหนดไว้โดยไม่พิจารณาถึงอักขระตัวแทน ตัวอย่างเช่น คำนิยามแถวที่ประกอบด้วยค่าเซ็กเมนต์ธรรมชาติเท่านั้น และเซ็กเมนต์ธรรมชาติมีสี่อักขระ โดยการป้อน**6 รวม** ในแถว แนะนำตัวออกแบบรายงานที่จะรวมบัญชีทั้งหมดที่มีค่าเซ็กเมนต์ธรรมชาติที่เริ่มต้น ด้วยคำ 6 ถ้าคุณป้อน**6\***มีการส่งกลับผลลัพธ์เดียวกัน แต่ผลรวมค่าของตัวแปรความกว้าง เช่น**60**และ**600000** ผู้ออกแบบรายงานจะแทนที่แต่ละอักขระตัวแทน (?) ด้วยช่วงของค่าที่เป็นได้ที่เสร็จสมบูรณ์ภายใน ซึ่งประกอบด้วยตัวอักษรและอักขระพิเศษ ตัวอย่างเช่น ในช่วงจาก **12?0** ไปยัง **12?4** อักขระตัวแทนใน **12?0** จะถูกแทนที่ด้วยค่าต่ำสุดในชุดอักขระ และอักขระตัวแทนใน **12?4** จะถูกแทนที่ด้วยค่าสูงสุดในชุดอักขระ **หมายเหตุ:** คุณควรหลีกเลี่ยงการใช้อักขระตัวแทนสำหรับบัญชีเริ่มต้น และบัญชีสิ้นสุดในช่วง ถ้าคุณใช้อักขระตัวแทนในบัญชีเริ่มต้นหรือบัญชีสิ้นสุด คุณอาจได้รับผลลัพธ์ที่ไม่คาดคิด

### <a name="single-segment-or-single-dimension-ranges"></a>ช่วงเซ็กเมนต์เดียว หรือมิติเดียว

คุณสามารถระบุช่วงของค่าเซ็กเมนต์หรือค่ามิติได้ ประโยชน์ของการระบุขอบเขตคือ คุณไม่จำเป็นต้องปรับปรุงคำนิยามแถวทุกครั้งว่าค่าเซ็กเมนต์ใหม่หรือค่ามิติที่จะเพิ่มไปยังข้อมูลทางการเงิน ตัวอย่างเช่น ช่วง**+ บัญชี =\[6100:6900\]**ดึงค่าจากบัญชี 6100 ถึง 6900 เป็นจำนวนแถว เมื่อในช่วงมีอักขระตัวแทน (?) ผู้ออกแบบรายงานจะไม่ประเมินช่วงทีละอักขระ จะกำหนดค่าต่ำสุดและสูงสุดของช่วงแทน และจากนั้น จะรวมค่าสิ้นสุดและค่าระหว่างนั้นทั้งหมด **หมายเหตุ:** Report Designer ไม่สามารถเลือกบัญชี มิติ หรือเขตข้อมูลจากระบบ Microsoft Dynamics ERP ที่มีอักขระสงวนไว้ดังต่อไปนี้: &, \*, \[, \], {, หรือ} ได้ คุณสามารถเพิ่มเครื่องหมาย (&) เมื่อคุณจะสร้างคำนิยามแถวโดยใช้กล่องโต้ตอบ **แทรกแถวจากมิติ** ได้เท่านั้น

### <a name="multiple-segment-or-multiple-dimension-ranges"></a>ช่วงเซ็กเมนต์หลายครั้ง หรือช่วงมิติหลายค่า

เมื่อคุณป้อนช่วง โดยใช้ชุดของค่าขนาดหลาย ๆ การเปรียบเทียบช่วงเสร็จแล้วเป็น... ข้อมูลพื้นฐานของ \financial-dimensions\dimension-by-dimension ไม่สามารถทำการเปรียบเทียบช่วงตามเกณฑ์ทีละอักขระ หรือเกณฑ์เซ็กเมนต์บางส่วน ตัวอย่างเช่น ช่วง**+ บัญชี =\[5000:6000\]แผนก =\[1000:2000\]ศูนย์ต้นทุน =\[00\]**มีเฉพาะบัญชีที่ตรงกับแต่ละเซ็กเมนต์ ในสถานการณ์สมมตินี้ มิติแรกต้องอยู่ในช่วงตั้งแต่ 5000 ถึง 6000 มิติที่สองต้องอยู่ในช่วงตั้งแต่ 1000 ถึง 2000 และมิติสุดท้ายต้องเป็น 00 ตัวอย่างเช่น**+ บัญชี =\[5100\]แผนก =\[1100\]ศูนย์ต้นทุน =\[01\]**ไม่ได้รวมอยู่ในรายงาน เนื่องจากเซ็กเมนต์ล่าสุดอยู่นอกช่วงที่ระบุ ถ้าค่าเซ็กเมนต์มีการเว้นวรรค ล้อมรอบค่านั้นในวงเล็บเหลี่ยม (\[\]) ค่าต่อไปนี้ไม่ถูกต้องสำหรับเซ็กเมนต์เป็นอักขระสี่ตัว: **\[234\], \[123 \], \[1 34\]** ค่ามิติที่ควรอยู่ในวงเล็บเหลี่ยม (\[\]), และรายงานตัวออกเพิ่มวงเล็บเหล่านี้สำหรับคุณ เมื่อช่วงหลายเซ็กเมนต์ หรือหลายมิติประกอบด้วยอักขระตัวแทนอักขระ (หรือไม่ หรือ\*), ต่ำ และสูงสุดของช่วงหลายเซ็กเมนต์ หรือหลายมิติทั้งหมดจะถูกกำหนด และจากนั้น จะรวมค่าสิ้นสุดและค่าทั้งหมดระหว่างสิ่งเหล่านี้ ถ้าคุณมีช่วงขนาดใหญ่ เช่น ช่วงทั้งบัญชีจาก 40000 จนถึง 99999 คุณควรระบุบัญชีเริ่มต้นและบัญชีสิ้นสุดที่ถูกต้อง หากเป็นไปได้ **หมายเหตุ:** Report Designer ไม่สามารถเลือกบัญชี มิติ หรือเขตข้อมูลจากระบบ Microsoft Dynamics ERP ที่มีอักขระสงวนไว้ดังต่อไปนี้: &, \*, \[, \], {, หรือ} ได้ คุณสามารถเพิ่มเครื่องหมาย (&) เมื่อคุณจะสร้างคำนิยามแถวโดยใช้กล่องโต้ตอบ **แทรกแถวจากมิติ** ได้เท่านั้น
...
|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| เพื่อบัญชีแบบเต็มสองบัญชี                                                       | + หาร =\[000\]บัญชี =\[1205\]แผนก =\[00\]+ หาร =\[100\]บัญชี =\[1205\]แผนก =\[00\] |
| เพิ่มค่าเซ็กเมนต์สองค่า                                                                 | + บัญชี =\[1205\]+ บัญชี =\[1210\]                                                                           |
| เพิ่มค่าเซ็กเมนต์ที่รวมอักขระตัวแทน                                    | + บัญชี =\[120 ? + บัญชี =\[11 ซม.\]                                                                             |
| เพิ่มช่วงบัญชีแบบเต็มสองช่วง                                                | + หาร =\[000:100\]บัญชี =\[1205\]แผนก =\[00\]                                                   |
| เพิ่มช่วงของค่าเซ็กเมนต์                                                          | + บัญชี =\[1200:1205\]                                                                                       |
| เพิ่มช่วงของค่าเซ็กเมนต์ที่รวมอักขระตัวแทน                         | + บัญชี =\[120 ?: 130 หรือไม่\]                                                                                       |
| ลบบัญชีแบบเต็มบัญชีหนึ่งออกจากบัญชีไม่ครบถ้วนอีกบัญชี              | + หาร =\[000\]บัญชี =\[1205\]แผนก =\[00\]-หาร =\[100\]บัญชี =\[1205\]แผนก =\[00\] |
| ลบค่าเซ็กเมนต์หนึ่งออกจากค่าเซ็กเมนต์อื่น                                  | + บัญชี =\[1205\]-บัญชี =\[1210\]                                                                           |
| ลบค่าเซ็กเมนต์ที่ประกอบด้วยอักขระตัวแทนจากค่าเซ็กเมนต์อื่น | + บัญชี =\[1200\]-บัญชี =\[11 ซม.\]                                                                           |
| ลบช่วงบัญชีแบบเต็มช่วงหนึ่ง                                           | -ส่วนงาน =\[000:100\]บัญชี =\[1200:1205\]แผนก =\[00:01\]                                           |
| ลบช่วงของค่าเซ็กเมนต์                                                     | -บัญชี =\[1200:1205\]                                                                                       |
| ลบช่วงของค่าเซ็กเมนต์ที่รวมอักขระตัวแทน                    | -บัญชี =\[120 ?: 130 หรือไม่\]                                                                                       |

ไม่เพียงแต่คุณจะสามารถปรับเปลี่ยนบัญชีได้โดยตรง คุณยังสามารถใช้กล่องโต้ตอบ **มิติ** เพื่อจัดรูปแบบที่ถูกต้องสำหรับการเชื่อมโยงข้อมูลทางการเงินของคุณได้ ค่าสามารถรวมอักขระตัวแทนอักขระ (หรือไม่ Or \*). อย่างไรก็ตาม Report Designer ไม่สามารถเลือกบัญชี มิติ หรือเขตข้อมูลจากระบบ Microsoft Dynamics ERP ที่มีอักขระสงวนไว้ดังต่อไปนี้: &, \*, \[, \], {, หรือ} ได้ **หมายเหตุ:** เมื่อต้องการหักลบค่า คุณต้องใส่เครื่องหมายวงเล็บล้อมรอบค่าเหล่านั้น ตัวอย่างเช่น ถ้าคุณป้อน**450?-(4509)**ซึ่งจะแสดงเป็น**+ บัญชี =\[4509\]-บัญชี =\[450 หรือไม่ \]**และคุณกำลัง instructing ตัวออกแบบรายงานการหักลบยอดเงินสำหรับเซ็กเมนต์ของบัญชี 4509 จากยอดเงินสำหรับเซ็กเมนต์บัญชีใด ๆ ที่เริ่มต้น ด้วย 450
...
3.  ในแถวแรกของกล่องโต้ตอบ **มิติ** ให้ปฏิบัติดังนี้:
    ...
    2.  คลิกสองครั้ง**ดำเนิน+/-**เซลล์ และเลือกเครื่องหมายบวก (**+**) หรือลบ (**-**) ตัวดำเนินการที่ใช้กับค่ามิติอย่าง น้อยหนึ่งรายการ หรือการตั้งค่าในแถว
...
**หมายเหตุ:** ตัวดำเนินการจะใช้กับมิติทั้งหมดในแถว
...
| สินค้า                | คำอธิบาย                                                                                                                                                                                                                                                                                             |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| บุคคลหรือช่วง | ในการ**จาก**ฟิลด์ ป้อนชื่อของบัญชีผู้ใช้ หรือคลิก**เรียกดู**ปุ่ม![เรียกดู](https://i-technet.sec.s-msft.com/dynimg/IC679490.gif "เรียกดู")เพื่อเรียกดูบัญชีผู้ใช้ เพื่อเลือกช่วง ให้ป้อนหรือเลือกดูค่าในฟิลด์ **ถึง**                                             |
| เซ็ตค่ามิติ | ในฟิลด์ **ชื่อ** ให้ป้อนชื่อของเซ็ตค่ามิติ เมื่อต้องการสร้าง ปรับเปลี่ยน คัดลอก หรือลบชุด คลิก **จัดการเซ็ตค่ามิติ** การ**สูตร**ฟิลด์ถูกเติม ด้วยสูตรจาก**เชื่อมโยงไปยังมิติทางการเงิน**เซลล์สำหรับค่ามิตินี้ตั้งค่าในคำนิยามแถวไว้ |
...
5.  ในกล่องโต้ตอบ **แก้ไข** แก้ไขค่าสูตรเพื่อรวมไว้ในเซ็ต **หมายเหตุ:** ถ้าคุณเพิ่มบัญชีใหม่หรือมิติ ตรวจสอบให้แน่ใจว่าคุณได้แก้ไขเซ็ตค่ามิติที่มีอยู่เพื่อรวมการเปลี่ยนแปลงการแก้ไขไว้
