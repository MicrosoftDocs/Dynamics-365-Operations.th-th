...
-   พื้นที่ส่วนหัวของคำนิยามคอลัมน์ประกอบด้วยข้อความส่วนหัว และการจัดรูปแบบที่ปรากฏในรายงาน ส่วนหัวสามารถใช้กับแต่ละคอลัมน์ของข้อมูล สามารถครอบคลุมหลายคอลัมน์ หรือสามารถใช้กับคอลัมน์ตามเกณฑ์เงื่อนไข คำนิยามคอลัมน์สามารถรวมหลายแถวส่วนหัวคอลัมน์ตามที่คุณต้องการ **หมายเหตุ:** ส่วนหัวคอลัมน์ใช้กับแต่ละคอลัมน์ข้อมูลในรายงาน ส่วนหัวของรายงานนำไปใช้กับรายงานทั้งหมด คุณกำหนดส่วนหัวของรายงานในแท็บ **ส่วนหัวและส่วนท้าย** ของข้อกำหนดของรายงาน
...
ผู้ออกแบบรายงานสามารถสร้างส่วนหัวของคอลัมน์โดยอัตโนมัติ โดยอาศัยรหัสข้อความอัตโนมัติ รหัสข้อความอัตโนมัติเป็นตัวแปรที่จะมีการอัพเดทุกครั้งที่มีการสร้างรายงาน ส่วนหัวของคอลัมน์ใดๆ สามารถรวมรหัสเหล่านี้เพื่อระบุข้อมูลรายงานที่แตกต่างกัน เช่น วันหรือหมายเลขรอบระยะเวลา ดังนั้น คุณสามารถใช้คำนิยามคอลัมน์หนึ่งสำหรับหลายข้อกำหนดของรายงาน รอบระยะเวลา และแผนภูมิการรายงาน เนื่องจากรหัสข้อความอัตโนมัติขึ้นอยู่กับข้อมูลปฏิทินจากแถวรายละเอียดของคำนิยามคอลัมน์ ได้รับการสนับสนุนเฉพาะสำหรับคอลัมน์ **CALC****ดีมอนตัวกรอง** และ **WKS** วิธีการที่รหัสข้อความอัตโนมัติปรากฏในเซลล์ส่วนหัวของคอลัมน์มีผลต่อการปรากฏข้อมูลในรายงาน ในกล่องโต้ตอบ **ส่วนหัวของคอลัมน์** รหัสข้อความอัตโนมัติปรากฏขึ้นในกรณีผสม ดังนั้น ข้อความปรากฏขึ้นในกรณีผสมในรายงาน ตัวอย่างเช่น ในปีปฏิทินมาตรฐาน **@CalMonthLong** แยกเดือน **7** ไปที่ **กรกฎาคม** ถ้าชื่อเดือนควรเป็นตัวพิมพ์ใหญ่ (ตัวอย่างเช่น **กรกฎาคม**) ป้อนรหัสข้อความอัตโนมัติในอักขระตัวพิมพ์ใหญ่ในฟิลด์ **ข้อความส่วนหัวของคอลัมน์** ตัวอย่างเช่น ป้อน **@CALMONTHLONG** คุณสามารถรวมรหัสและข้อความ ตัวอย่างเช่น คุณสามารถป้อนข้อความส่วนหัวข้อต่อไปนี้: **รอบระยะเวลา @FiscalPeriod-@FiscalYear จาก @StartDate ถึง @EndDate** ส่วนหัวของรายงานที่สร้างขึ้นคล้ายคลึงกับข้อความต่อไปนี้: **รอบระยะเวลา 1-02 ตั้งแต่วันที่ 01/01/02 ถึงวันที่ 31/01/02** **หมายเหตุ:** รูปแบบของบางข้อความ เช่น วันที่แบบยาว ขึ้นอยู่กับการตั้งค่าภูมิภาคของคุณบนเซิร์ฟเวอร์ Dynamics 365 for Operations เพื่อเปลี่ยนการตั้งค่าเหล่านี้ คลิกปุ่ม **เริ่มต้น** คลิก **แผงควบคุม** แล้วคลิก **ภูมิภาคและภาษา** ตารางต่อไปนี้แสดงรายการตัวเลือกข้อความอัตโนมัติที่พร้อมใช้งานสำหรับส่วนหัวของคอลัมน์
...
-   ถ้าคุณระบุส่วนหัวของคอลัมน์ที่ทับซ้อน จะทับซ้อนเมื่อถูกพิมพ์บนรายงาน รายงานถูกสร้าง แต่คำเตือนต่อไปนี้ปรากฏในฟิลด์ **สถานะรายงานคิว** "ส่วนหัวของคอลัมน์โดยใช้พื้นฐานร่วมกับส่วนหัวของคอลัมน์อื่น และอาจส่งผลให้ข้อความทับซ้อนกัน" ตัวอย่างเช่น คำอธิบายส่วนหัวของคอลัมน์ B คือ B ถึง ฐาน+1 และคำอธิบายส่วนหัวของคอลัมน์ D คือ ฐาน+1 ถึง F ในกรณีนี้ส่วนหัวถูกพิมพ์ด้านบนของแต่ละอัน และไม่สามารถอ่านได้ เมื่อใดก็ตามที่ฐานถูกใช้ในคำนิยาม **กระจายจาก / กระจายไป** ตรวจสอบให้แน่ใจว่าได้ดูรายงานที่สร้างขึ้น เพื่อดูว่าส่วนหัวทับซ้อนกันหรือไม่
...
3.  ระบุชนิดคอลัมน์ในรายการ ตารางต่อไปนี้อธิบายชนิดคอลัมน์อื่นๆ
    ...
    <tr class="odd">
    <td>ATTR</td>
    <td>ถ้าระบบการบัญชีของคุณสนับสนุนแอททริบิวต์ แสดงแอตทริบิวต์บัญชี หรือธุรกรรมในคอลัมน์ แอททริบิวต์ ซึ่งต้องใช้กับบัญชีเต็มเดี่ยว แยกอยู่ภายใต้บัญชี หรือข้อมูลธุรกรรมจากข้อมูลทางการเงิน แอททริบิวต์ระดับบัญชีแสดงข้อมูลจากบัญชี และแอททริบิวต์ระดับธุรกรรมแสดงข้อมูลที่เกิดขึ้นในขณะที่ลงรายการบัญชีธุรกรรม ถ้าคุณเลือก <strong>ATTR</strong> เป็นชนิดคอลัมน์ ระบุประเภทแอททริบิวต์ในแถวรายละเอียด <strong>รหัสสมุดบัญชี/ประเภทแอททริบิวต์</strong> ของคำนิยามคอลัมน์</td>
    </tr>
    </tbody>
    </table>
...
**หมายเหตุ:** ตัวเลือกที่อธิบายไว้ที่นี่อาจแตกต่างกัน ขึ้นอยู่กับระบบ ERP สำหรับข้อมูลเพิ่มเติม โปรดดูที่ [เอกสารของระบบ Microsoft ERP](https://www.microsoft.com/en-us/download/details.aspx?id=5916) ของคุณ
...
| สกุลเงินหลักจากข้อมูลบริษัท | ว่าง                | **$2,310\*\*** – ผลลัพธ์แสดงข้อมูลทั้งหมดในสกุลเงินหลักที่ระบุในข้อมูลบริษัท **หมายเหตุ:** ยอดเงินนี้คือ ผลรวมของธุรกรรมทั้งหมดในสกุลเงินหลัก |
...
คุณสามารถสร้างคอลัมน์ที่แสดงค่าทั้งหมดในคอลัมน์ที่ระบุเป็นเปอร์เซ็นต์ของจำนวนพื้นฐาน ดังนั้น คุณสามารถแสดงความสัมพันธ์ระหว่างแถว เช่น เปอร์เซ็นต์ของแถวขาย หรือเปอร์เซ็นต์แถวของค่าใช้จ่ายรวม เพื่อคูณ หรือหารแต่ละแถวในคอลัมน์ที่ระบุด้วยแถวพื้นฐาน ป้อนคอลัมน์ที่จะใช้ในการคำนวณ จากนั้นป้อน **\*BASEROW** หรือ **/BASEROW** ตัวอย่างเช่น ป้อน **C\*BASEROW** หรือ **C/BASEROW** ** หมายเหตุ:** เมื่อคุณใช้การคำนวณแถวพื้นฐานในคำนิยามคอลัมน์ ตรวจสอบให้แน่ใจว่า แต่ละคำนิยามแถวที่ใช้กับคำนิยามคอลัมน์นี้ประกอบด้วยอย่างน้อยหนึ่งแถวพื้นฐานสำหรับการคำนวณ
