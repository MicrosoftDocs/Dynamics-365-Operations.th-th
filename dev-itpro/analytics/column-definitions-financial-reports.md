...
3.  ในเมนู **แก้ไข** คลิก **แทรกคอลัมน์** คอลัมน์ใหม่จะปรากฏที่ด้านซ้ายของคอลัมน์ที่คุณเลือก

### <a name="delete-a-column-from-a-column-definition"></a>ลบคอลัมน์จากคำนิยามคอลัมน์

1.  ในReport Designer คลิก **คำนิยามคอลัมน์** แล้วเปิดคำนิยามคอลัมน์เพื่อแก้ไข
2.  เลือกคอลัมน์ที่จะลบ
3.  ในเมนู **แก้ไข** คลิก **ลบคอลัมน์**
...
-   คอลัมน์จำนวนที่แสดงข้อมูลจากข้อมูลทางการเงิน แผ่นงาน Microsoft Excel หรือการคำนวณโดยอาศัยข้อมูลอื่นๆ ในคำนิยามคอลัมน์
-   จัดรูปแบบคอลัมน์
-   คอลัมน์แอททริบิวต์

ข้อมูลนี้ปรากฏในพื้นที่ต่อไปนี้ในคำนิยามคอลัมน์:

-   พื้นที่ส่วนหัวของคำนิยามคอลัมน์ประกอบด้วยข้อความส่วนหัว และการจัดรูปแบบที่ปรากฏในรายงาน หัวข้อที่สามารถนำไปใช้กับคอลัมน์เดียวของข้อมูล สามารถครอบคลุมหลายคอลัมน์ หรือสามารถใช้กับคอลัมน์ตามเกณฑ์ตามเงื่อนไข คำนิยามคอลัมน์สามารถรวมคอลัมน์มากหัวแถว ตามที่คุณต้องการ **หมายเหตุ:** ส่วนหัวคอลัมน์ใช้กับแต่ละคอลัมน์ข้อมูลในรายงาน ส่วนหัวของรายงานนำไปใช้กับรายงานทั้งหมด คุณกำหนดส่วนหัวของรายงานในแท็บ **ส่วนหัวและส่วนท้าย** ของข้อกำหนดของรายงาน
...
คุณสามารถใช้ข้อจำกัดในคอลัมน์เพื่อระบุว่า คำนิยามคอลัมน์จะใช้ข้อมูล หรือคำนวณข้อมูล คุณยังสามารถจำกัดคอลัมน์รายงาน ไปที่หน่วยเฉพาะ หรือสำหรับวันที่เฉพาะ **หมายเหตุ: รหัส** **ข้อจำกัดคอลัมน์** แทนการตั้งค่าความขัดแย้งใดๆ ที่กำหนดไว้ในคำนิยามแถว
...
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SU                      | ระงับการขีดเส้นใต้สำหรับคอลัมน์คำสั่งเครื่องหมายขีดล่าง (**---**) หรือคำสั่งที่ขีดเส้นใต้คู่ (**===**) ถูกป้อนในคำนิยามแถวไว้ ตัวอย่างเช่น คุณอาจไม่ต้องการขีดเส้นใต้ยอดเงินที่ถูกสร้างขึ้น โดยการคำนวณเปอร์เซ็นต์                                                                        |
...
| UPT                     | จำกัดยอดเงินในคอลัมน์ เพื่อให้เฉพาะธุรกรรมที่ลงรายการบัญชีถูกรวม ถ้าธุรกรรมเหล่านี้พร้อมใช้งาน **หมายเหตุ:** ไม่ใช่บริการข้อมูลทั้งหมดที่สนับสนุนธุรกรรมที่ไม่ลงรายการบัญชี สำหรับข้อมูลเพิ่มเติม ให้ดู [คำแนะนำการรวมข้อมูล](http://go.microsoft.com/fwlink/?LinkID=162565) สำหรับระบบ Microsoft Dynamics ERP ของคุณ |
...
3.  ในเมนู **แก้ไข** คลิก **แทรกแถว** มีการแทรกแถวใหม่เหนือแถวที่คุณเลือกไว้ในขั้นตอนที่ 2 **หมายเหตุ:**ถ้าคุณสี่แถวหรือมากกว่า ในส่วนหัวของรายงานบนรายงาน ส่วนหัวจะทับซ้อนเมื่อรายงานถูกส่งออกไปยังแผ่นงาน Excel เพื่อดูส่วนหัวทั้งหมดในรายงาน เพิ่มขอบด้านบนในข้อกำหนดของรายงาน
...
ผู้ออกแบบรายงานสามารถสร้างส่วนหัวของคอลัมน์โดยอัตโนมัติ โดยอาศัยรหัสข้อความอัตโนมัติ รหัสข้อความอัตโนมัติเป็นตัวแปรที่จะมีการอัพเดทุกครั้งที่มีการสร้างรายงาน ส่วนหัวของคอลัมน์ใดๆ สามารถรวมรหัสเหล่านี้เพื่อระบุข้อมูลรายงานที่แตกต่างกัน เช่น วันหรือหมายเลขรอบระยะเวลา ดังนั้น คุณสามารถใช้คำนิยามคอลัมน์หนึ่งสำหรับหลายข้อกำหนดของรายงาน รอบระยะเวลา และแผนภูมิการรายงาน เนื่องจากรหัสข้อความอัตโนมัติขึ้นอยู่กับข้อมูลปฏิทินจากแถวรายละเอียดของคำนิยามคอลัมน์ ได้รับการสนับสนุนเฉพาะสำหรับคอลัมน์ **CALC** **ดีมอนตัวกรอง** และ **WKS** วิธีการที่รหัสข้อความอัตโนมัติปรากฏในเซลล์ส่วนหัวของคอลัมน์มีผลต่อการปรากฏข้อมูลในรายงาน ในกล่องโต้ตอบ **ส่วนหัวของคอลัมน์** รหัสข้อความอัตโนมัติปรากฏขึ้นในกรณีผสม ดังนั้น ข้อความปรากฏขึ้นในกรณีผสมในรายงาน ตัวอย่างเช่น ในปีปฏิทินมาตรฐาน**@CalMonthLong**แก้เดือน**7**ไป**กรกฎาคม** ถ้าชื่อของเดือนควรจะเป็นตัวพิมพ์ใหญ่ (ตัวอย่าง**กรกฎาคม**), ป้อนรหัสข้อความอัตโนมัติในอักขระตัวพิมพ์ใหญ่ในแบบ**ข้อความส่วนหัวของคอลัมน์**ฟิลด์ ตัวอย่างเช่น ป้อน**@CALMONTHLONG** คุณสามารถรวมรหัสและข้อความ ตัวอย่างเช่น คุณสามารถป้อนข้อความหัวข้อต่อไปนี้:**รอบระยะเวลา@FiscalPeriod-@FiscalYearจาก@StartDateไป@EndDate** ส่วนหัวของรายงานที่สร้างขึ้นคล้ายคลึงกับข้อความต่อไปนี้: **รอบระยะเวลา 1-02 ตั้งแต่วันที่ 01/01/02 ถึงวันที่ 31/01/02** **หมายเหตุ:**รูปแบบบางส่วนของข้อความ เช่นวันแบบยาว ขึ้นอยู่กับการตั้งค่าภูมิภาคใน 365 Dynamics สำหรับเซิร์ฟเวอร์ที่มีการดำเนินงาน เพื่อเปลี่ยนการตั้งค่าเหล่านี้ คลิกปุ่ม **เริ่มต้น** คลิก **แผงควบคุม** แล้วคลิก **ภูมิภาคและภาษา** ตารางต่อไปนี้แสดงรายการตัวเลือกข้อความอัตโนมัติที่พร้อมใช้งานสำหรับส่วนหัวของคอลัมน์
...
| ปีงบประมาณ (@FiscalYear)               | พิมพ์ปีบัญชีสำหรับคอลัมน์เป็นรูปแบบตัวเลข                                                                                                                                                                                                                                            |
| ปีปฏิทิน (@CalYear)                | พิมพ์ปีปฏิทินสำหรับคอลัมน์เป็นรูปแบบตัวเลข                                                                                                                                                                                                                                          |
| วันเริ่มต้น (@StartDate)                 | พิมพ์วันที่เริ่มต้นสำหรับคอลัมน์                                                                                                                                                                                                                                                             |
| วันสิ้นสุด (@EndDate)                     | พิมพ์วันที่สิ้นสุดสำหรับคอลัมน์                                                                                                                                                                                                                                                               |
| ชื่อหน่วยจากทรี (@UnitName)         | ถ้าคุณจำกัดคอลัมน์ไปที่หน่วยเฉพาะของแผนภูมิรายงาน พิมพ์ชื่อหน่วยในส่วนหัวของคอลัมน์                                                                                                                                                                                     |
| คำอธิบายของหน่วย (@UnitDesc)            | ถ้าคุณจำกัดคอลัมน์ไปที่หน่วยเฉพาะของแผนภูมิรายงาน พิมพ์คำอธิบายหน่วยในส่วนหัวของคอลัมน์                                                                                                                                                                              |
| รหัสจอง (@BookCode)                   | พิมพ์รหัสสมุดบัญชีที่ระบุในคอลัมน์                                                                                                                                                                                                                                             |
| บรรทัดที่ว่างเปล่า (@Blank)                     | แทรกรายการว่างในส่วนหัวของคอลัมน์                                                                                                                                                                                                                                                       |

### <a name="create-a-conditional-spanning-header"></a>สร้างช่วงส่วนหัวของคอลัมน์แบบมีเงื่อนไข

ช่วงส่วนหัวของคอลัมน์แบบมีเงื่อนไขจะครอบคลุมคอลัมน์ต่างๆ ที่อาศัยข้อมูลรอบระยะเวลาที่ระบุ ตัวอย่างเช่น ถ้าคุณมีรายงานงบประมาณสำหรับปีบัญชี และต้องการแสดงงบประมาณจริงของเดือนที่ผ่านมาพร้อมกับงบประมาณที่คาดการณ์ของเดือนในอนาคต คุณสามารถใช้ช่วงส่วนหัวของคอลัมน์แบบมีเงื่อนไขเพื่ออัพเดตส่วนหัวของรายงานโดยอัตโนมัติ ควรคำนึงถึงสถานการณ์ต่อไปนี้เมื่อคุณสร้างช่วงส่วนหัวของคอลัมน์แบบมีเงื่อนไข:
...
-   ถ้าคุณระบุส่วนหัวของคอลัมน์ที่ทับซ้อน จะทับซ้อนเมื่อถูกพิมพ์บนรายงาน รายงานจะถูกสร้างขึ้น แต่คำเตือนต่อไปนี้ปรากฏในแบบ**สถานะคิวรายงาน**ฟิลด์: "โดยใช้ฐานของส่วนหัวของคอลัมน์ตัดกันกับส่วนหัวของคอลัมน์อื่น และอาจทำให้ข้อความที่ซ้อนทับกันอยู่" ตัวอย่าง คำนิยามหัวข้อในคอลัมน์ B คือ B เป็นพื้นฐาน + 1 และข้อกำหนดหัวข้อในคอลัมน์ D เป็นพื้นฐาน + 1 เพื่อ F. ในกรณีนี้ ส่วนหัวพิมพ์ทับกันได้ และไม่สามารถอ่าน เมื่อใดก็ตามที่ฐานถูกใช้ในคำนิยาม **กระจายจาก / กระจายไป** ตรวจสอบให้แน่ใจว่าได้ดูรายงานที่สร้างขึ้น เพื่อดูว่าส่วนหัวทับซ้อนกันหรือไม่
...
-   สำหรับคอลัมน์การพิมพ์แบบมีเงื่อนไข (**P&lt;B**, **P&gt;= B**), ส่วนหัวการใช้หลายจอภาพแบบมีเงื่อนไขทำงานเหมือนใด ๆ ข้อกำหนดหัวข้อของคอลัมน์ปกติ ตัวอย่างเช่น ถ้าเงื่อนไขเป็นเท็จ การตรงกันของคอลัมน์ใดๆ ในเวลาต่อมาสำหรับเงื่อนไขการกระจายเริ่มต้นการพิมพ์ส่วนหัว
...
|---------------------|------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|
| หัวกระดาษ 1            |      | เกิดขึ้นจริง        | งบประมาณ        |               |               |               |               |               |               |               |               |               |               |
| หัวกระดาษ 2            |      | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong | @CalMonthLong |
| หัวกระดาษ 3            |      |               |               |               |               |               |               |               |               |               |               |               |               |
...
| รอบระยะเวลาที่ครอบคลุม     |      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      | ประจำงวด      |
...
#### <a name="assign-a-format-currency-override-to-a-report-column"></a>กำหนดให้มีการแทนที่รูปแบบสกุลเงินไปที่คอลัมน์รายงาน

1.  ใน Report Designer เปิดคำนิยามคอลัมน์เพื่อแก้ไข
2.  ดับเบิลคลิกเซลล์ **การแทนที่ รูปแบบ/สกุลเงิน** ในคอลัมน์ยอดเงิน
...
| XCR                | เปลี่ยนเครื่องหมายถ้ายอดดุลโดยทั่วไปของแถวเป็นเครดิต | สร้างงบประมาณหรือรายงานเปรียบเทียบซึ่งผลต่างที่ไม่น่าพึงพอใจใดๆ (เช่น รายได้ไม่เพียงพอ หรือค่าใช้จ่ายเกิน) เป็นค่าลบเสมอ ใช้รหัสนี้กับคอลัมน์ **CALC** เพื่อกลับเครื่องหมายของยอดเงินคอลัมน์ ถ้ายอดดุลโดยทั่วไปของแถวที่ระบุเป็นเครดิต (ตามที่ระบุโดยคอลัมน์ **C** ใน **ยอดดุลปกติ** ของคำนิยามแถว) **หมายเหตุ:** สำหรับแถว **TOT** และแถว **CAL** ซึ่งโดยทั่วไปจะมียอดดุลเครดิต ให้แน่ใจว่าได้ป้อน **C** ในคอลัมน์ **ยอดดุลปกติ** ในคำนิยามแถว |
...
4.  เลือกตัวเลือกในฟิลด์ **ตัวเลือกการพิม์แบบมีเงื่อนไข** โดยค่าเริ่มต้น เลือก **(ไม่มี)** คุณสามารถเลือกรหัสการพิมพ์แบบมีเงื่อนไขเดียวเท่านั้นในแต่ละครั้ง
5.  คลิก **ตกลง** ระบบจะนำเข้าข้อมูลการชำระเงิน

**คำแนะนำ:** คุณสามารถป้อนรหัสการพิมพ์โดยตรงในเซลล์ **ควบคุมการพิมพ์** แยกหลายรหัสควบคุมการพิมพ์ด้วยเครื่องหมายจุลภาค

### 

## <a name="column-types"></a>ชนิดคอลัมน์
ชนิดของข้อมูลที่แต่ละคอลัมน์รวมไว้ในรายงานจะถูกระบุด้วยค่าในแถว **ชนิดคอลัมน์** ในคำนิยามคอลัมน์ แต่ละคำนิยามคอลัมน์ต้องประกอบด้วยอย่างน้อยหนึ่งคอลัมน์คำอธิบาย (**DESC**) และคอลัมน์ยอดเงินเดียว (**ดีมอนตัวกรอง****WKS** หรือ **CALC**) **หมายเหตุ:** ชนิดคอลัมน์ไม่สามารถใช้กับระบบการบัญชีทั้งหมด ถ้าคุณเลือกชนิดที่ไม่ถูกต้องสำหรับระบบการบัญชีของคุณ คอลัมน์นั้นจะว่างเปล่าในรายงาน
...
3.  ระบุชนิดคอลัมน์ในรายการ ตารางต่อไปนี้อธิบายชนิดคอลัมน์อื่นๆ
    ...
    <td>แสดงค่าเซ็กเมนต์ข้อมูลทางการเงิน หรือค่ามิติที่ใช้กับแต่ละแถว สำหรับรายงานรายละเอียดบัญชี และธุรกรรม บัญชีแบบเต็มถูกพิมพ์ (ตัวอย่างเช่น <strong>110140-070-0101</strong>) ถ้ามีการระบุช่วงในคอลัมน์ <strong>ลิงค์ไปยังมิติทางการเงิน</strong> ในคำนิยามแถวที่เชื่อมโยงกัน ช่วงอยู่ภายในวงเล็บเหลี่ยม และถือว่าเป็นค่าเดียว (ตัวอย่างเช่น <strong>[110140:110700]-070-[0101:0200]</strong>) สำหรับรายงานทางการเงิน และรายงานในระดับสูงซึ่งเป็นการรวมของหลายบัญชี ข้อมูลทางการเงินที่ลิงค์จากคำนิยามแถวจะถูกพิมพ์ (ตัวอย่างเช่น <strong>1100:1200</strong>)</td>
    </tr>
    <tr class="even">
    <td>เติม</td>
    ...
    <tr class="odd">
    <td>ATTR</td>
    <td>ถ้าระบบการบัญชีของคุณสนับสนุนแอททริบิวต์ แสดงแอตทริบิวต์บัญชี หรือธุรกรรมในคอลัมน์ แอททริบิวต์ ซึ่งต้องใช้กับบัญชีเต็มเดี่ยว แยกอยู่ภายใต้บัญชี หรือข้อมูลธุรกรรมจากข้อมูลทางการเงิน แอททริบิวต์ระดับบัญชีที่แสดงข้อมูลจากบัญชี และแอตทริบิวต์ระดับธุรกรรมแสดงข้อมูลที่เกิดขึ้นในขณะที่ธุรกรรมถูกลงรายการบัญชี ถ้าคุณเลือก<strong>ATTR</strong>เป็นชนิดคอลัมน์ ระบุประเภทแอตทริบิวต์ในการ<strong>สมุดรหัส/แอททริบิวต์ประเภท</strong>แถวรายละเอียดของคำนิยามคอลัมน์</td>
    </tr>
    </tbody>
    </table>
...
| พื้นฐาน +\# | ปีที่มีใช้\#ปีหลังจากปีพื้นฐาน ตัวอย่างเช่น จะใช้สามปีหลังจากปีพื้นฐาน ป้อน **ฐาน+3** |
| ฐาน-\# | ปีที่มีใช้\#ปีก่อนหน้าปีพื้นฐาน ตัวอย่างเช่น จะใช้ปีก่อนหน้า ป้อน **ฐาน-1**                 |
| \#      | ป้อนปีบัญชีจริง                                                                                                |
...
| พื้นฐาน +\#         | รอบระยะเวลาที่จะใช้\#รอบระยะเวลาหลังจากรอบระยะเวลาพื้นฐาน ตัวอย่างเช่น จะใช้สามรอบระยะเวลาหลังจากรอบระยะเวลาพื้นฐาน ป้อน **ฐาน+3**                                                                                               |
| ฐาน-\#         | รอบระยะเวลาที่จะใช้\#รอบระยะเวลาบัญชีพื้นฐาน ตัวอย่างเช่น จะใช้รอบระยะเวลาก่อนหน้า ป้อน **ฐาน-1**                                                                                                                 |
...
| ฐาน -\#: พื้นฐาน +\# | ใช้รอบระยะเวลาต่างๆ จากหลายรอบระยะเวลาก่อนหน้ารอบระยะเวลาพื้นฐาน ไปยังหลายรอบระยะเวลาหลังจากรอบระยะเวลาพื้นฐาน ตัวอย่างเช่น จะใช้สามรอบระยะเวลาก่อนหน้า รอบระยะเวลาพื้นฐาน และสองรอบระยะเวลาต่อไป ป้อน **ฐาน-3:ฐาน+2** |
...
คุณสามารถก้าวเข้าสู่ขอบเขตปีบัญชีในรอบระยะเวลาข้อมูลจำเพาะใดๆ และคุณสามารถผสมปีในช่วงรอบระยะเวลา ตัวอย่างเช่น คุณสามารถระบุรอบระยะเวลาที่เป็น**ฐาน 5** (เพื่อแสดงถึงอดีตหกรอบระยะเวลา) และเรียกใช้รายงานที่มีระยะเวลาฐาน 2 ในกรณีนี้ รายงานจะแสดงข้อมูลสำหรับรอบระยะเวลาสองของปีบัญชีที่ระบุและรอบระยะเวลาสี่ครั้งล่าสุดของปีบัญชีก่อนหน้านี้

### <a name="specify-the-periods-for-an-fd-column"></a>ระบุรอบระยะเวลาสำหรับคอลัมน์ดีมอนตัวกรอง

1.  ใน Report Designer เปิดคำนิยามคอลัมน์เพื่อแก้ไข
2.  ในคอลัมน์ **ดีมอนตัวกรอง** ดับเบิลคลิกเซลล์ในแถว **รอบระยะเวลา** และจากนั้นเลือกตัวเลือกในรายการ
3.  ในแถบสูตรด้านบนของบานหน้าต่างนำทาง หรือในเซลล์ **รอบระยะเวลา** ให้กรอกข้อมูลสูตร แทนเครื่องหมายตัวเลข (\#) ด้วยค่าที่เหมาะสม
...
| รหัสสมุดบัญชี/ประเภทแอททริบิวต์ |      | เกิดขึ้นจริง               |
| ปีบัญชี                  |      | ฐาน                 |
| รอบระยะเวลา                       |      | 1:ฐาน               |
...
| ...                          |      |                      |
| ตัวกรองแอททริบิวต์             |      |  อ้างอิง =\[01:10\] |

### <a name="dimension-filter-in-a-column-definition"></a>ตัวกรองมิติในคำนิยามคอลัมน์

ตัวกรองมิติจะใช้เพื่อจำกัดคอลัมน์ **ดีมอนตัวกรอง** เป็นค่ามิติเฉพาะ ตัวกรองสามารถรวมมิติหนึ่งมิติ ช่วงของมิติ หรือกลุ่มของมิติ ตัวกรองยังสามารถรวมชุดค่ามิติ เนื่องจากสามารถเปลี่ยนค่ามิติ การ... ระบบ \financial-dimensions\dimension-based ไม่จำเป็นต้องสอดคล้องกับความยาวแน่นอน ตัวกรองจะถูกใช้ โดยไม่คำนึงถึงว่ารายงานจะรวมแผนภูมิการรายงาน คุณสามารถใช้อักขระตัวแทน (\*หรือ?) ในตำแหน่งใดก็ได้ เมื่อคุณระบุบัญชีหลาย ๆ บัญชี ใส่เครื่องหมายจุลภาคระหว่างบัญชี ดังตัวอย่างต่อไปนี้: บัญชี + =\[1200\]บัญชี + =\[1100\]แผนก =\[01 หรือไม่\] บัญชีเฉพาะจะได้รับทุกแผนก คุณสามารถแยกมิติแผนกจากตัวกรองมิติ ตัวอย่างเช่น ทั้งตัวกรองมิติต่อไปนี้จะถูกจัดการในลักษณะเดียวกัน:

-   + บัญชี =\[1100\]แผนก
-   + บัญชี =\[1100\]

คุณยังสามารถใช้ชุดข้อมูลของอักขระตัวอักษร และตัวเลขสำหรับการจับคู่ที่แน่นอน และคุณสามารถกำหนดมิติบางส่วน ตัวอย่างเช่น**ที่ตั้ง = \[10\*\]**รวมถึงการตั้งค่ามิติทั้งหมดที่ขึ้นต้น ด้วย 10
...
สกุลเงินหลายรายงานสามารถแสดงยอดเงินในสกุลเงินธรรมชาติ (เฉพาะที่) สกุลเงินหลัก (ค่าเริ่มต้น) หรือการรายงานสกุลเงิน ฟังก์ชันสกุลเงินของบริษัทถูกกำหนดในระบบ Microsoft Dynamics ERP อย่าสับสนการตั้งค่า ERP นี้กับการตั้งค่าตัวเลือกภูมิภาคของระบบปฏิบัติงาน ซึ่งคอนฟิกสัญลักษณ์สกุลเงินเริ่มต้นที่จะถูกใช้ในรายงาน เซลล์ที่เกี่ยวข้องกับสกุลเงินต่อไปนี้จะพร้อมใช้งานในคำนิยามคอลัมน์:

-   **แสดงสกุลเงิน**– ระบุชนิดของสกุลเงิน (ธรรมชาติ ฟังก์ชัน หรือรายงาน) ที่แสดงอยู่ในธุรกรรม ฟังก์ชันนี้บางครั้งเรียกว่าการแปลงสกุลเงิน การแปลสกุลเงินมีความสามารถในการรายงานยอดเงินบัญชีแยกประเภททั่วไปในสกุลเงิน ที่อาจเป็นสกุลเงินหลักของบริษัท หรือสกุลเงินที่ป้อนไว้ในธุรกรรม
-   **ตัวกรองสกุลเงิน** – ระบุตัวกรองสกุลเงิน ธุรกรรมที่ป้อนในสกุลเงินที่เลือกเท่านั้นจะแสดงอยู่ในรายงาน

**หมายเหตุ:** เพื่อสร้างรายงานที่ใช้หลายสกุลเงิน คุณต้องเลือกกล่องกาเครื่องหมาย **รวมการรายงานสกุลเงินทั้งหมด** แท็บ **รายงาน** ของข้อกำหนดของรายงาน เพื่อกำหนดสกุลเงินฟังก์ชันของบริษัท ให้ปฏิบัติดังนี้
...
**หมายเหตุ:** ตัวเลือกที่อธิบายไว้ที่นี่อาจแตกต่างกัน ขึ้นอยู่กับระบบ ERP สำหรับข้อมูลเพิ่มเติม ให้ดูของคุณ[เอกสารระบบ Microsoft ERP](https://www.microsoft.com/en-us/download/details.aspx?id=5916)
...
| สกุลเงินหลักจากข้อมูลบริษัท | **เยน**              | **$60** – ผลลัพธ์แสดงเฉพาะธุรกรรมที่ป้อนเป็น JPY และแสดงธุรกรรมดังกล่าวเป็น USD **หมายเหตุ:** อัตราการแปลงคือ ประมาณ 100 JPY ต่อ USD                    |
| สกุลเงินหลักจากข้อมูลบริษัท | ว่าง                | **$2,310\*\*** – ผลลัพธ์แสดงข้อมูลทั้งหมดในสกุลเงินที่ระบุในรายละเอียดบริษัททำงาน **หมายเหตุ:** ยอดเงินนี้คือ ผลรวมของธุรกรรมทั้งหมดในสกุลเงินหลัก |
...
ชนิดคอลัมน์ของ**คำนวณ**ในคอลัมน์ ข้อกำหนดสนับสนุนการคำนวณที่ซับซ้อนในการ**สูตร**เซลล์ และอาจรวมถึง**+**, **-**, **\***และ**/**ตัวดำเนินการ และนอกจากนี้**นั้น/IF/ELSE**งบ คอลัมน์การคำนวณยังสามารถอ้างอิงไปคอลัมน์อื่น แม้แต่คอลัมน์ที่ตามมาได้ นอกจากนี้ คอลัมน์การคำนวณอาจประกอบด้วยปีบัญชี และรอบระยะเวลาเพื่อสนับสนุนส่วนหัวสำหรับคอลัมน์ สูตรการคำนวณสามารถมีความยาวถึง 1,024 อักขระ เมื่อแสดงผลลัพธ์จากการคำนวณด่วนเป็นเปอร์เซ็นต์ ใช้รูปแบบพิเศษแทน **หมายเหตุ:** ผลลัพธ์ของสูตรการคำนวณไม่รวมค่าในช่วงคอลัมน์ที่ไม่ได้พิมพ์ ตัวอย่างเช่น **A:D** พิมพ์ **0** (ศูนย์) ในขณะที่คำนวณค่า **A+B+C** สำหรับค่าที่ไม่ได้การพิมพ์
...
| -        | A-C                 | ลบยอดเงินในคอลัมน์ A จากยอดเงินในคอลัมน์ C **หมายเหตุ:** คุณสามารถใช้เครื่องหมายลบ (-) เพื่อกลับเครื่องหมายในคอลัมน์ ตัวอย่างเช่น ใช้ **-A+B** เพื่อเพิ่มการย้อนกลับของยอดเงินในคอลัมน์ A ไปยังยอดเงินในคอลัมน์ B |
...
คุณสามารถอ้างอิงไปยังเซลล์รายงานที่ระบุ โดยการป้อนจดหมายคอลัมน์ และรหัสแถว ตัวอย่างเช่น **B.100** อ้างอิงถึงรหัสแถว 100 ในคอลัมน์ B คุณสามารถหารทั้งคอลัมน์ด้วยเซลล์รายงานที่ระบุในคอลัมน์เดียวกัน ตัวอย่างเช่น การคำนวณ **B/B.100** หมายความว่ายอดเงินในคอลัมน์ B ควรถูกหารด้วยค่าในรหัสแถว 100 ในคอลัมน์ B ถ้าการคำนวณอ้างถึงคอลัมน์ที่ขึ้นอยู่กับคอลัมน์อื่น คอลัมน์ไม่เป็นอิสระได้รับการแก้ไขก่อน ถ้าคุณอ้างอิงคอลัมน์ไปยังคอลัมน์อื่นที่อ้างอิงกลับไปยังคอลัมน์แรก คุณจะก่อให้เกิดการผิดพลาดข้อมูลอ้างอิงแบบวน **หมายเหตุ:** การคำนวณอาจไม่ถูกต้อง ถ้าคุณเปลี่ยนระดับความสำคัญของการคำนวณสำหรับรายงาน คุณสามารถเซ็ตระดับความสำคัญของการคำนวณในแท็บ **การตั้งค่า** ของข้อกำหนดของรายงาน

#### <a name="multiply-or-divide-a-column-by-a-base-row"></a>คูณ หรือหารคอลัมน์ด้วยแถวพื้นฐาน

คุณสามารถสร้างคอลัมน์ที่แสดงค่าทั้งหมดในคอลัมน์ที่ระบุเป็นเปอร์เซ็นต์ของจำนวนพื้นฐาน ดังนั้น คุณสามารถแสดงความสัมพันธ์ระหว่างแถว เช่น เปอร์เซ็นต์ของแถวขาย หรือเปอร์เซ็นต์แถวของค่าใช้จ่ายรวม เมื่อต้องการคูณ หรือหารแต่ละแถวในคอลัมน์ระบุ โดยแถวพื้นฐาน ใส่คอลัมน์ที่จะใช้ในการคำนวณ และจากนั้น ป้อน**\*BASEROW**หรือ**/BASEROW** ตัวอย่างเช่น ป้อน**C\*BASEROW**หรือ**C/BASEROW** ** หมายเหตุ:** เมื่อคุณใช้การคำนวณแถวพื้นฐานในคำนิยามคอลัมน์ ตรวจสอบให้แน่ใจว่า แต่ละคำนิยามแถวที่ใช้กับคำนิยามคอลัมน์นี้ประกอบด้วยอย่างน้อยหนึ่งแถวพื้นฐานสำหรับการคำนวณ
