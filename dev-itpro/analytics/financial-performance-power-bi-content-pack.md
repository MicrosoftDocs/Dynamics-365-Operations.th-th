...
|-----------------------------|--------------------------------------|
| การวิเคราะห์เงินสด               | เงินสดโดยเรียงตามนิติบุคคล เงินสดโดยเรียงตามไตรมาส เงินสดรวม และเงินสดโดยเรียงตามบัญชี<blockquote>[!NOTE]<br>เงินสดเรียงตามข้อมูลไตรมาสไม่รวมกับยอดดุลต้นงวดในในผลรวมสำหรับไตรมาสแรก ระบบจะแสดงผลรวมของธุรกรรมใหม่ที่ถูกลงรายการบัญชีในแต่ละไตรมาส</blockquote> |
...
| การวิเคราะห์รายได้ที่เรียกเก็บ     | บัญชีลูกหนี้รวม บัญชีลูกหนี้รวมโดยเรียงตามนิติบุคคล บัญชีลูกหนี้รวมโดยเรียงตามไตรมาส และยอดดุลสำหรับบัญชีของบัญชีลูกหนี้<blockquote>[!NOTE]<br>ข้อมูลที่ไม่รวมกับยอดดุลต้นงวดสำหรับบัญชีลูกหนี้แบบแยกประเภท ซึ่งจะแสดงผลรวมของธุรกรรมใหม่ที่ถูกลงรายการบัญชีไปยังบัญชีลูกหนี้</blockquote> |
