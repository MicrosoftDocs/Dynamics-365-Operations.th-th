...
|**แผนก**|**Position**|**Job**|
|---|---|---|
|**Sales**|ผู้จัดการฝ่ายขาย (ตะวันออก)|ผู้จัดการฝ่ายขาย|
|**Sales**|ผู้จัดการฝ่ายขาย (ตะวันตก)|ผู้จัดการฝ่ายขาย|
|**Sales**|ผู้จัดการฝ่ายขาย (ส่วนกลาง)|ผู้จัดการฝ่ายขาย|
|**Accounting**|หัวหน้างานฝ่ายบัญชี|ผู้จัดการฝ่ายบัญชี|
|**Accounting**|การบัญชี-A|นักบัญชี|
|**Human resources**|ผู้จัดการฝ่ายทรัพยากรบุคคล (ตะวันออก)|ผู้จัดการฝ่ายทรัพยากรบุคคล|
|**Human resources**|ผู้จัดการฝ่ายทรัพยากรบุคคล (ตะวันตก)|ผู้จัดการฝ่ายทรัพยากรบุคคล|
|**Human resources**|ผู้จัดการฝ่ายทรัพยากรบุคคล (ส่วนกลาง)|ผู้จัดการฝ่ายทรัพยากรบุคคล|
...
ฟังก์ชันงานเหมือนกับการปฏิบัติงาน ฟังก์ชันงานอธิบายงานหนึ่งงานหรือหลายงาน หน้าที่หรือความรับผิดชอบที่ถูกกำหนดในงาน ฟังก์ชันงานสามารถถูกกำหนดให้กับงาน และใช้เพื่อตั้งค่า และใช้กฎการมีคุณสมบัติเหมาะสมสำหรับแผนค่าตอบแทน ตัวอย่างของฟังก์ชันงานจะแสดงในตารางต่อไปนี้
...
ตำแหน่งเป็นองค์ประกอบสำคัญของระดับต่ำกว่าของลำดับชั้นขององค์กร ตำแหน่งคือแต่ละอินสแตนซ์ของงาน ตัวอย่างเช่น ตำแหน่ง "ผู้จัดการฝ่ายขาย (ตะวันออก)," เป็นเพียงหนึ่งตำแหน่งที่เกี่ยวข้องกับงาน "ผู้จัดการฝ่ายขาย" ตำแหน่งที่มีอยู่ในแผนก และกำหนดให้กับผู้ปฏิบัติงาน
