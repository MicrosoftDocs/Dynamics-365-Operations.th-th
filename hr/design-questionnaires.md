...
description: "หัวข้อนี้อธิบายถึงกระบวนการสำหรับการสร้างแบบสอบถาม ขั้นตอนแรกคือการ ออกแบบแบบสอบถาม เมื่อคุณออกแบบแบบสอบถาม คุณไม่เพียงเขียนคำถามและคำตอบ แต่ยังสร้างโครงสร้างที่คำตอบที่สามารถบันทึก และจัดทำตารางคำตอบได้"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
หัวข้อนี้อธิบายถึงกระบวนการสำหรับการสร้างแบบสอบถาม ขั้นตอนแรกคือการ ออกแบบแบบสอบถาม เมื่อคุณออกแบบแบบสอบถาม คุณไม่เพียงเขียนคำถามและคำตอบ แต่ยังสร้างโครงสร้างที่คำตอบที่สามารถบันทึก และจัดทำตารางคำตอบได้ 
...
รหัสลำดับหมายเลขจะใช้ในการจัดระเบียบคำถามและคำตอบ ขึ้นอยู่กับรหัสเหล่านี้ลำดับหมายเลข การกำหนดค่าโดยอัตโนมัติให้กับสินค้า 
...
แบบสอบถามที่ประกอบด้วยองค์ประกอบหลักสาม: กลุ่มที่ประกอบด้วยคำตอบสำหรับหลายตัวเลือกในการตอบคำถาม คำถาม และแบบสอบถามตัวเอง อีกทางหนึ่งคือคุณสามารถจัดกลุ่มคำถามในแบบสอบถามในกลุ่มผลคะแนน กลุ่มผลคะแนนช่วยให้คุณสามารถจัดประเภทคำถาม และให้การวิเคราะห์เพิ่มเติมในแบบสอบถาม 
