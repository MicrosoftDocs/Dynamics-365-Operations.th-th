...
## การตั้งค่าชนิดแบบสอบถาม
<a id="setting-up-questionnaires" class="xliff"></a>
>**หมายเหตุ**
>  ก่อนที่คุณจะสามารถตั้งค่าแบบสอบถาม คุณต้องตั้งค่าคำตอบ คำถาม และข้อกำหนดเบื้องต้นเสียก่อน 
...
#### ตัวอย่าง: คะแนน/ข้อความสำหรับกลุ่มผลคะแนน 3
...
### ลำดับชั้นของคำถามแบบมีเงื่อนไข
