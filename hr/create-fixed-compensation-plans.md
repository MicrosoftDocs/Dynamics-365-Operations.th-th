...
ค่าตอบแทนคงที่อ้างอิงถึงเงินเดือนขั้นต้นปกติหรือค่าจ้างของพนักงาน หัวข้อนี้อธิบายเกี่ยวกับคอมโพเนนต์ที่ต้องตั้งค่าก่อนที่คุณสามารถสร้างแผนค่าตอบแทนคงที่ และการลงทะเบียนพนักงาน

คุณสามารถคำนวณยอดเงินค่าตอบแทนคงที่สำหรับพนักงานของคุณ ตามปัจจัยต่าง ๆ เช่นประสิทธิภาพ ภูมิภาค และงบประมาณการขึ้นค่าตอบแทน 365 Dynamics Microsoft สำหรับการดำเนินงานสนับสนุนขั้นตอน ระดับ และชนิดค่าตอบแทนของแบนด์

## <a name="fixed-compensation-components"></a>ส่วนประกอบของแผนค่าตอบแทนคงที่
### <a name="compensation-levels"></a>ระดับค่าตอบแทนต่างๆ

คุณสามารถใช้**ระดับค่าตอบแทน**เพื่อตั้งค่าค่าตอบแทนสำหรับงานที่หลากหลาย จะช่วยรับประกันว่า พนักงานที่เก็บงานเหล่านั้นจะได้รับค่าจ้างค่อนข้างได้ ในการ**ระดับค่าตอบแทน**หน้า คุณสามารถตั้งค่าระดับค่าตอบแทนที่จำเป็นสำหรับแต่ละขั้นตอน ระดับ และแบนด์แผน ได้ ใช้ปุ่ม **ขึ้น** และ **ลง** เพื่อกำหนดระดับในการสั่งที่ถูกต้อง ตามชนิดนั้นๆ โดยการตั้งค่าระดับค่าตอบแทนขึ้นอยู่กับงาน คุณช่วยรับประกันว่า พนักงานทั้งหมดที่ดำรงตำแหน่งงานนั้นได้รับการตอบแทนในระดับเดียวกัน

### <a name="reference-points"></a>จุดอ้างอิง

**จุดอ้างอิง** คือคอลัมน์ในกริดที่กำหนดช่วงค่าตอบแทนสำหรับแต่ละระดับ ระดับค่าตอบแทนมีแถวในตาราง จุดอ้างอิงทั่วไปสำหรับแผนชนิดระดับต่ำสุด จุดกึ่งกลาง และสูงสุดได้ คุณสามารถสร้างจุดอ้างอิงในการ**การตั้งค่าจุดอ้างอิง**หน้า
...
การ**กฎการจ้างงาน**การตั้งค่าการอนุญาตให้คุณระบุว่า พนักงานทั้งหมดควรได้รับการเพิ่มเดียวกัน โดยไม่คำนึงถึงวันที่มีการจ้างงาน (**กฎการจ้างงาน** = **ไม่มี**), หรือว่าพนักงานควรได้รับเปอร์เซ็นต์ของรางวัล ขึ้นอยู่กับระยะเวลาจะถูกว่าจ้างในระหว่างวงจรการ (**กฎการจ้างงาน** = **เปอร์เซ็นต์**) 
...
หลังจากที่คุณกำหนดพื้นฐานของแผนค่าตอบแทนคง คุณสามารถตั้งค่าโครงสร้างค่าตอบแทนสำหรับแผนนั้น คลิ**ตั้งค่าค่าตอบแทน** แถบเลื่อนกล่องโต้ตอบเปิดขึ้นที่ช่วยให้คุณสามตัวเลือก:
...
ขั้นตอนแรกในการลงทะเบียนพนักงานในแผนค่าตอบแทนคงที่จะกำหนดว่าใครมีมีสิทธิ์ที่จะได้รับค่าตอบแทนที่กำหนดไว้ในแผน จนกว่าคุณกำหนดสิทธิ์ คุณจะไม่สามารถกำหนดแบบแผนให้กับพนักงานใด ๆ เมื่อต้องการตั้งค่าสิทธิ์ เปิด**กฎการมีคุณสมบัติเหมาะสม**หน้า ที่นี่ คุณสามารถสร้างสิทธิ์ใหม่เป็นกฎสำหรับแผนค่าตอบแทนของคุณ และกำหนดเงื่อนไขที่ต้องตรงกับพนักงานมีสิทธิได้รับสำหรับแผน คุณสามารถจำกัดสิทธิ์ตามแผนก สหภาพแรงงาน ค่าตอบแทนตามภูมิภาค (ที่ตั้ง), งาน หน้าที่งาน ชนิดงาน หรือระดับค่าตอบแทน พนักงานสามารถลงทะเบียนในแผนค่าตอบแทนเฉพาะเมื่อพวกเขาเป็นไปตามเงื่อนไขทั้งหมดที่กำหนดบนกฎการมีสิทธิ์ 
...
นอกจากนี้กฎการมีคุณสมบัติเหมาะสมพิจารณาสหภาพแรงงานที่เกี่ยวข้องกับพนักงาน (บน**พนักงาน**หน้า คง**ของผู้ปฏิบัติงาน**แท็บ คลิ**ข้อมูลส่วนบุคคล**&gt;**สหภาพแรงงาน**)
...
ขณะนี้คุณสามารถมอบหมายพนักงานในแผนค่าตอบแทนคง เปิด **หน้าพนักงาน** และเลือกพนักงานที่จะลงทะเบียนในแผนค่าตอบแทน ในบานหน้าต่างการดำเนินการ คลิ**ค่าตอบแทน**&gt;**แผนถาวร** ขณะนี้คุณสามารถสร้างการดำเนินการค่าตอบแทนคงที่ใหม่สำหรับพนักงาน 
