...
ใช้หน้า **กำหนดการแบบสอบถาม** เพื่อจัดเตรียมและส่งอีเมลไปยังผู้ตอบทั้งหมดที่กำหนดให้ตอบแบบสอบถาม ป้อนข้อความอีเมลในแท็บ **อีเมล์สำหรับการบริการตนเองของพนักงาน** หลังจากกำหนดการเริ่มต้นแล้ว คลิก **ฟังก์ชัน** &gt; **ส่งอีเมล** เพื่อสร้าง และส่งอีเมลไปยังผู้ตอบ ผู้ตอบสามารถลงชื่อเข้าใช้งานในเว็บไซต์ และกรอกแบบสอบถาม 
...
<a name=""></a>=======
---
# <a name="required-metadata"></a>ข้อมูลเมตาที่จำเป็น

ชื่อเรื่อง: กระจายและทำตามคำอธิบายของแบบสอบถามให้เสร็จสมบูรณ์: หัวข้อนี้อธิบายวิธีกระจายแบบสอบถามที่คุณออกแบบ เพื่อให้สามารถใช้งานกับบุคคลหรือกลุ่มของบุคคลที่จะตอบ ผู้สร้าง: twheeloc manager: AnnBe ms.date: 06/20/2017 ms.topic: article ms.prod: ms.service: Dynamics365Operations ms.technology: 

# <a name="optional-metadata"></a>ข้อมูลเมตาที่ไม่จำเป็น

ms.search.form: KMConnectionType, KMKnowledgeCollectorPlanningTabel, SysEmailParameters
# <a name="robots"></a>ROBOTS: 
ผู้ชม: ผู้ใช้แอพลิเคชัน
...
# <a name="distribute-and-complete-a-questionnaire"></a>กระจายและทำแบบสอบถามให้เสร็จสมบูรณ์
...
ใช้หน้า **ชนิดการอ้างอิง** เพื่อตั้งค่าชนิดการอ้างอิงสำหรับแบบสอบถาม ชนิดการอ้างอิงแต่ละชนิดตรงกับตารางใน Microsoft Dynamics 365 for Finance and Operations, Enterprise edition เมื่อคุณสร้างกำหนดการแบบสอบถาม คุณสามารถระบุแต่ละเรกคอร์ดในตารางหรือช่วงของเรกคอร์ดที่จะเกี่ยวข้องกับแบบสอบถาม 
...
**หมายเหตุ:** ผู้ตอบต้องเป็นผู้ใช้ใน Microsoft Dynamics 365 for Finance and Operations, Enterprise edition เพื่อกรอกแบบสอบถาม
