...
> **หมายเหตุ**
>   ก่อนที่คุณจะสามารถตั้งค่ารอบเวลาคำตอบที่วางแผนไว้ คุณต้องออกแบบแบบสอบถามเสียก่อน 
...
ใช้หน้า **ชนิดการอ้างอิง** เพื่อตั้งค่าชนิดการอ้างอิงสำหรับแบบสอบถาม ชนิดการอ้างอิงแต่ละชนิดตรงกับตารางใน Microsoft Dynamics 365 for Operations เมื่อคุณสร้างกำหนดการแบบสอบถาม คุณสามารถระบุแต่ละเรกคอร์ดในตารางหรือช่วงของเรกคอร์ดที่จะเกี่ยวข้องกับแบบสอบถาม 
...
> **หมายเหตุ**
>   ผู้ตอบต้องเป็นผู้ใช้ใน Microsoft Dynamics 365 for Operations เพื่อกรอกแบบสอบถาม
...
> **หมายเหตุ**
>   ก่อนที่คุณจะใช้ฟังก์ชันอีเมลได้ ผู้ดูแลระบบไอทีของคุณต้องป้อนการตั้งค่าอีเมลในหน้า **พารามิเตอร์อีเมล** เสียก่อน
...
> **หมายเหตุ**
>   ถ้าผู้ตอบหนึ่งคนขึ้นไปยังไม่ได้กรอกข้อมูลแบบสอบถาม แต่คุณยังคงต้องการสิ้นสุดการจัดกำหนดการ คุณจะต้องลบผู้ตอบที่เกี่ยวข้องออกจากรายการในหน้า **รอบเวลาของคำตอบที่วางแผนไว้** เสียก่อน จากนั้นคุณจึงสามารถจบกำหนดการได้
