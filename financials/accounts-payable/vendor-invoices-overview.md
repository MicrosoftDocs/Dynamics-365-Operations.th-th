---
title: "ภาพรวมของใบแจ้งหนี้ของผู้จัดจำหน่าย"
...
ใบแจ้งหนี้ของผู้จัดจำหน่ายจากใบสั่งซื้อเป็นใบแจ้งหนี้ที่สร้างขึ้นเมื่อมีการรับผลิตภัณฑ์หรือบริการตามใบสั่งซื้อที่วางไว้กับผู้จัดจำหน่าย ใบแจ้งหนี้ของผู้จัดจำหน่ายประกอบด้วยส่วนหัว และหนึ่ง หรือหลายบรรทัดสำหรับสินค้าหรือบริการ ใบแจ้งหนี้ของผู้จัดจำหน่ายเสร็จสมบูรณ์วงจรจากใบสั่งซื้อกับใบรับสินค้ากับใบแจ้งหนี้ของผู้จัดจำหน่าย 
...
-   ทะเบียนใบแจ้งหนี้ของผู้จัดจำหน่ายช่วยให้คุณป้อนใบแจ้งหนี้ที่ไม่ได้อ้างอิงถึงใบสั่งซื้อ ได้อย่างรวดเร็วเพื่อให้คุณสามารถรับรู้ค่าใช้จ่าย โดยใช้สมุดรายวันการอนุมัติใบแจ้งหนี้ของผู้จัดจำหน่าย คุณสามารถเลือกใบแจ้งหนี้เหล่านั้น และลงรายการบัญชีในยอดดุลของผู้จัดจำหน่ายเพื่อกลับรายการค้างรับค้างจ่าย
...
คุณสามารถเพิ่มบรรทัดใหม่ที่ไม่ได้อยู่ในใบสั่งซื้อกับใบแจ้งหนี้ของผู้จัดจำหน่าย คุณต้องเลือกตัวเลขหรือการจัดประเภทสินค้า จากนั้นคุณสามารถเพิ่มปริมาณ ราคา และยอดเงินลงในรายการ รายการจะรวมอยู่ในนโยบายการจับคู่สำหรับผลรวมใบแจ้งหนี้เท่านั้น
