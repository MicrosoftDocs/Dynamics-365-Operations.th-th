...
ในส่วน **รายการตาราง **สถานะของการออกใบแจ้งหนี้จะแบ่งออกในลักษณะที่คล้ายกันกับไทล์สรุป: รายการฉบับร่าง รายการที่ส่งแล้ว และรายการที่อนุมัติ ขณะที่อยู่ในสถานะฉบับร่าง สามารถส่งใบแจ้งหนี้ไปยังลำดับงานหรือลบออกได้ ตารางรายการสุดท้ายมีตัวเลือกเพื่อค้นหาใบแจ้งหนี้ คุณสามารถกรองข้อมูล ตามที่คุณค้นหา การอนุญาตสำหรับการค้นหาได้รวดเร็วขึ้น
หน้ารายการใบแจ้งหนี้ของผู้จัดจำหน่ายทั้งหมด
-----------------------------

คุณสามารถดูใบแจ้งหนี้ของผู้จัดจำหน่ายที่ไม่ลงรายการบัญชี และลงรายการบัญชีแล้วทั้งหมดบนการ**ใบแจ้งหนี้ที่ทำงานร่วมกันของผู้จัดจำหน่าย**หน้ารายการได้ คุณสามารถใช้หน้ารายการนี้เพื่อดูสถานะการชำระเงินของใบแจ้งหนี้ สถานะการชำระเงินรวมถึง ยังไม่ได้ลงรายการบัญชี ยังไม่ได้ชำระเงิน ชำระเงินบางส่วน และชำระเงินครบถ้วน
...
สำหรับข้อมูลเพิ่มเติม ดู[ทำงานร่วมกับผู้จัดจำหน่าย โดยใช้พอร์ทัลของผู้จัดจำหน่าย](/dynamics365/operations/scm/procurement/collaborate-vendors-vendor-portal)
