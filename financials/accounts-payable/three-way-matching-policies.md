...
2.  April ผู้ประสานงานบัญชีฝั่งเจ้าหนี้ที่ Fabrikam ป้อนและตรวจสอบใบแจ้งหนี้ที่ส่งมาจาก Contoso เธอตรวจสอบข้อมูลดังต่อไปนี้
    ...
    -   สำหรับสินค้าที่จำเป็นต้องมีสอง หรือสามทางตรง ราคาบนบรรทัดใบแจ้งหนี้ถูกภายในค่าเผื่อที่กำหนดไว้ใน Microsoft Dynamics 365 สำหรับ Operations.This มีชนิดของการจับคู่ราคาต่อไปนี้:
...
ใน Microsoft Dynamics 365 สำหรับการผลิต บรรทัดใบแจ้งหนี้รวมถึงข้อมูลต่อไปนี้
...
2.  April ผู้ประสานงานบัญชีฝั่งเจ้าหนี้ที่ Fabrikam ป้อนและตรวจสอบใบแจ้งหนี้ที่ส่งมาจาก Contoso เธอตรวจสอบข้อมูลดังต่อไปนี้
    -   สำหรับสินค้าที่ต้องใช้การจับคู่แบบสามทาง ปริมาณในรายการใบแจ้งหนี้จะถูกจับคู่กับปริมาณสินค้าที่ได้รับ ปริมาณสินค้าที่ได้รับจะถูกระบุอยู่ในใบรับสินค้าที่ตรงกับใบแจ้งหนี้
    -   สำหรับสินค้าที่จำเป็นต้องมีสอง หรือสามทางตรง ราคาบนบรรทัดใบแจ้งหนี้ถูกภายในค่าเผื่อที่กำหนดไว้ใน 365 Dynamics Microsoft สำหรับการดำเนินงาน ซึ่งรวมถึงชนิดของการจับคู่ราคาต่อไปนี้:
...
สำหรับข้อมูลเพิ่มเติม ดู[บัญชีการจับคู่ใบแจ้งหนี้ของเจ้าหนี้](accounts-payable-invoice-matching.md)
