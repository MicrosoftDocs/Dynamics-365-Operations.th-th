...
> [!Note] 
> นอกจากนี้เอกสารบางอย่างยังสนับสนุนหัวข้อเอกสารจำนวนเงิน เช่นค่าธรรมเนียมสำหรับใบสั่งและใบแจ้งหนี้ 
...
-   **กระจายยอดเงิน** – ดูและแก้ไขการกระจายการลงบัญชีสำหรับส่วนหัวหรือรายการของเอกสารแต่ละรายการ รวมถึงรายการรอง เช่น ภาษี หรือ ค่าธรรมเนียม
    ...
    -   การกระจายข้อมูลรองใด ๆ เช่นส่วนลด, ค่าธรรมเนียม, ภาษีขาย, จะตามการกระจายหลักเสมอ คุณสามารถดูความสัมพันธ์หลัก/รองที่**อ้างอิง**&gt;**ข้อมูลหลัก**ได้
    ...
    -   ผลต่างการกระจายอาจถูกสร้างในสถานการณ์จำลอง เช่นการจับคู่ระหว่างใบแจ้งหนี้ของผู้จัดจำหน่ายกับใบสั่งซื้อ คุณสามารถดูความสัมพันธ์ที่ตรงกันระหว่างการกระจายการลงบัญชีที่**อ้างอิง**&gt;**ข้อมูลเอกสาร**ได้
    -   ปุ่ม**แก้ไข** ปรากฏขึ้นและเปิดใช้งานสำหรับเอกสารที่สนับสนุนการแก้ไข **ถูกต้อง**การกระจายใหม่สร้างขึ้น ก่อนอื่น การกระจายดังกล่าวที่ย้อนกลับการกระจายแบบดั้งเดิม การกระจายเหล่านี้ไม่สามารถแก้ไข ถัดไป ใหม่ถูกต้องกระจายการลงบัญชีจะถูกสร้างขึ้น กระจายเหล่านี้สามารถปรับเปลี่ยนได้ถ้าไม่สามารถปรับเปลี่ยนการกระจายดั้งเดิมได้
    ...
    -   คุณสามารถดูสถานะการลงบัญชีเอกสารปัจจุบันใน**อ้างอิง**ได้ สถานะสำหรับเอกสารทั้งหมด และบ่งชี้ว่า เอกสารจะอยู่ระหว่างดำเนินการ หรือทำให้เสร็จสมบูรณ์
-   ** ดูการกระจาย ** – ดูการกระจายการลงบัญชีสำหรับบรรทัดทั้งหมดและจำนวนเงินบนเอกสาร คุณไม่สามารถที่จะแก้ไขการกระจายการลงบัญชีจากมุมมองนี้


สำหรับข้อมูลเพิ่มเติม ดู[กระจายการลงบัญชีและรายการสมุดรายวันบัญชีแยกประเภทย่อยสำหรับข้อความใบแจ้งหนี้อิสระ](accounting-distributions-subledger-journal-entries-vendor-invoices.md)
