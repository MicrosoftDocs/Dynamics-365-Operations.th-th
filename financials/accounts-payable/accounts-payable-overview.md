...
description: "บทความนี้อธิบายถึงหน้าต่างๆ ที่คุณใช้เพื่อตั้งค่าฟังก์ชันพื้นฐานและฟังก์ชันที่ไม่จำเป็นสำหรับบัญชีเจ้าหนี้ใน Microsoft Dynamics 365 for Operations นอกจากนี้ยังอธิบายขั้นตอนการตั้งค่าที่คุณต้องดำเนินการก่อนที่คุณจะเริ่มการตั้งค่าบัญชีเจ้าหนี้อีกด้วย"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
บทความนี้อธิบายถึงหน้าต่างๆ ที่คุณใช้เพื่อตั้งค่าฟังก์ชันพื้นฐานและฟังก์ชันที่ไม่จำเป็นสำหรับบัญชีเจ้าหนี้ใน Microsoft Dynamics 365 for Operations นอกจากนี้ยังอธิบายขั้นตอนการตั้งค่าที่คุณต้องดำเนินการก่อนที่คุณจะเริ่มการตั้งค่าบัญชีเจ้าหนี้อีกด้วย
