...
หัวข้อนี้ไม่ให้ข้อกำหนดโดยละเอียดของแพคเกจข้อมูล ไม่ได้อธิบายวิธีการสร้างแพคเกจข้อมูลอีกด้วย สำหรับข้อมูลนี้ ดู [กรอบงานของเอนทิตีและแพคเกจข้อมูล](/dynamics365/en-us/unified-operations/dev-itpro/data-entities/data-entities-data-packages)
