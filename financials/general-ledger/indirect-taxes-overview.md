...
กรอบงานภาษีขายสนับสนุนหลายชนิดของภาษีทางอ้อม เช่นภาษีขาย ภาษีมูลค่าเพิ่ม (VAT), ภาษีสินค้าและบริการ (GST), ค่าธรรมเนียมตามหน่วย และภาษีหักณที่จ่าย ภาษีเหล่านี้ถูกคำนวณ และจัดทำเอกสารระหว่างธุรกรรมการซื้อและการขาย เป็นระยะ ๆ พวกเขาต้องรายงาน และจ่ายให้แก่หน่วยงานจัดเก็บภาษี 
...
สำหรับทุก ๆ ภาษีขายซึ่งบริษัทต้องนำมาพิจารณาสำหรับ รหัสภาษีขายที่ต้องกำหนด รหัสภาษีขายจะจัดเก็บอัตราภาษีและกฎการคำนวณสำหรับภาษีขาย 
...
ภาษีขายต้องถูกรายงาน และชำระให้กับหน่วยจัดเก็บภาษีในช่วงเวลาที่กำหนด (รายเดือน รายไตรมาส เป็นต้น) 365 Dynamics Microsoft สำหรับการดำเนินงานมีการทำงานที่ช่วยคุณในการชำระบัญชีภาษีสำหรับช่วงเวลา และยอดดุลไปการชำระบัญชีภาษี ตามที่ระบุไว้ในกลุ่มการลงรายการบัญชีแยกประเภทตรงข้าม คุณสามารถเข้าถึงฟังก์ชันการทำงานนี้ในการ**ชำระ และลงรายการบัญชีภาษีขาย**หน้าได้ คุณต้องระบุรอบระยะเวลาการจ่ายภาษีขายที่ควรมีชำระภาษีขายสำหรับ 
...
ภาษีขายแบบมีเงื่อนไขจะเป็นภาษีขายที่จ่ายอย่างเป็นสัดส่วนกับจำนวนแท้จริงที่มีการชำระเงินบนใบแจ้งหนี้ ในทางกลับกัน มาตรฐานจะคำนวณภาษีขาย ณเวลาที่ออกใบแจ้งหนี้ ต้องชำระภาษีขายแบบมีเงื่อนไขไปยังหน่วยงานจัดเก็บภาษีขายเมื่อการชำระเงินถูกลงรายการบัญชี เมื่อมีการลงรายการบัญชีใบแจ้งหนี้ไม่ เมื่ออินวอยซ์ถูกลงรายการบัญชี ธุรกรรมที่ต้องรายงานในรายงานสมุดบัญชีภาษีขาย อย่างไรก็ตาม ธุรกรรมต้องถูกแยกออกจากการรายงานการชำระภาษีขาย 

ถ้าคุณเลือกกล่องกาเครื่องหมายภาษีขายแบบมีเงื่อนไขในแบบฟอร์มพารามิเตอร์บัญชีแยกประเภททั่วไป สามารถหักภาษีขายใด ๆ จนกว่าคุณได้ชำระเงินใบแจ้งหนี้ นี่คือข้อกำหนดตามกฎหมายในบางประเทศ/ภูมิภาค

> [!NOTE]
> เมื่อคุณเลือกกล่องกาเครื่องหมายภาษีขายแบบมีเงื่อนไข คุณต้องตั้งค่ารหัสภาษีขายและกลุ่มภาษีขาย และยัง สร้างกลุ่มแยกประเภทลงรายการบัญชี เพื่อสนับสนุนฟังก์ชันการทำงาน |

###  <a name="example"></a>ตัวอย่าง

คุณชำระภาษีขายแต่ละเดือน วันที่ 15 มิถุนายน คุณสร้างใบแจ้งหนี้ลูกค้า 10000 บวกภาษีขาย
-   ภาษีขายคือ 25 เปอร์เซ็นต์ หรือ 2500
-   การชำระเงินใบแจ้งหนี้ที่จะครบกำหนดในวันที่ 30 กรกฎาคม

คุณโดยทั่วไปจะต้องชำระ และจ่าย 2500 หน่วยงานจัดเก็บภาษีเมื่ออินวอยซ์ถูกลงรายการบัญชีในเดือนมิถุนายน ถึงแม้ว่าคุณไม่ได้รับการชำระเงินจากลูกค้า 

อย่างไรก็ตาม ถ้าคุณกำลังใช้ภาษีขายแบบมีเงื่อนไข คุณชำระ ด้วยการจัดเก็บภาษีเมื่อคุณได้รับการชำระเงินจากลูกค้าในวันที่ 30 กรกฎาคม
