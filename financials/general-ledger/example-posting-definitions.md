...
description: "บทความนี้แสดงตัวอย่างที่แสดงวิธีใช้ข้อกำหนดการลงรายการบัญชีภาระผูกพันของใบสั่งซื้อและการจัดสรรงบประมาณ"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="posting-definition-examples"></a>ตัวอย่างของข้อกำหนดในการลงรายการบัญชี

บทความนี้แสดงตัวอย่างที่แสดงวิธีใช้ข้อกำหนดการลงรายการบัญชีภาระผูกพันของใบสั่งซื้อและการจัดสรรงบประมาณ
...
> [!NOTE]
> เมื่อต้องการเชื่อมโยงคำนิยามการลงรายการบัญชีที่ มีชนิดธุรกรรมเฉพาะ ใช้**ธุรกรรมที่ลงรายการบัญชีข้อกำหนด**หน้า หลังจากที่คุณเชื่อมโยงคำนิยามการลงรายการบัญชี ด้วยชนิดธุรกรรมและเลือก**ใช้ข้อกำหนดการลงรายการบัญชี**ในการ**พารามิเตอร์บัญชีแยกประเภททั่วไป**หน้า ธุรกรรมทั้งหมดของชนิดของธุรกรรมที่เลือกต้องใช้ข้อกำหนดของการลงรายการบัญชี
...
ในตัวอย่างนี้ บัญชีใด ๆซึ่งเป็นส่วนหนึ่งของโครงสร้างทางบัญชี - P&L ตรงกับเกณฑ์ข้อกำหนดการลงรายการบัญชี ดังนั้น เมื่อ 606500-OU\_1 OU\_3566-การฝึกอบรมจะถูกประเมิน รายการที่สร้างขึ้นจะถูกสร้างขึ้นสำหรับบัญชีที่กำหนดอยู่ในแบบ**รายการที่สร้างจาก**บานหน้าต่างสำหรับข้อกำหนดการลงรายการบัญชี
...
ในตัวอย่างนี้ บัญชีใด ๆซึ่งเป็นส่วนหนึ่งของโครงสร้างทางบัญชี - P&L ตรงกับเกณฑ์ข้อกำหนดการลงรายการบัญชี ดังนั้น เมื่อ 606400-OU\_1 OU\_3566-การฝึกอบรมจะถูกประเมิน รายการบัญชีแยกประเภทที่สร้างขึ้นจะถูกสร้างขึ้น
