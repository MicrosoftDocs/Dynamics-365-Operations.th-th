...
สำหรับข้อมูลเพิ่มเติม ดู [ยอดดุลบัญชีแยกประเภททั่วไป](general-ledger-account-balances.md) [โปรแกรมตรวจดูบัญชีต้นทาง](\financials\accounts-payable\accounting-source-explorer) และ [รายงานทางการเงิน](financial-reporting-getting-started.md)
