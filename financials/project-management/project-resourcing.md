...
1.  ใน Finance and Operations ตรวจสอบว่ามีการเลือกบริษัทที่ให้ยืม แล้วดำเนินการขั้นตอนข้างต้นให้เสร็จสมบูรณ์ "ตั้งค่าผู้ปฏิบัติงานเป็นทรัพยากรโครงการ"
...
ถ้าจำเป็น คุณยังสามารถกำหนดประเภทสำหรับทรัพยากรได้ ชนิดของประเภทเป็นต้นทุนหรือรายได้ อย่างใดอย่างหนึ่ง ซึ่งถูกกำหนดโดยองค์กรของคุณ ถ้าไม่มีประเภทที่กำหนดไว้สำหรับทรัพยากร Finance and Operations จะค้นหาประเภทเริ่มต้นจากราคาต่อชั่วโมงสำหรับต้นทุนและรายได้
...
เพื่อใช้บทบาทที่ได้ตั้งค่าไว้ก่อนหน้านี้ในโครงการ ผู้จัดการโครงการต้องเชื่อมโยงบทบาทกับโครงการ สามารถมีการกำหนดบทบาทหลายบทบาทสำหรับโครงการ และ Finance and Operations จะติดป้ายชื่อบทบาทเหล่านี้โดยอัตโนมัติในระหว่างการจอง เพื่อป้องกันความสับสน ตัวอย่างเช่น ถ้าผู้จัดการโครงการต้องการวิศวกรซอฟต์แวร์สามคน บทบาทวิศวกรซอฟต์แวร์สามคน ที่มีวิศวกรซอฟต์แวร์ 1 วิศวกรซอฟต์แวร์ 2 และวิศวกรซอฟต์แวร์ 3 เป็นป้ายชื่อของพวกเขา จะถูกสร้างขึ้นโดยอัตโนมัติ ถ้าลักษณะบทบาทได้ถูกตั้งค่าไว้ก่อนหน้านี้สำหรับบทบาท จะถูกใช้เป็นตัวกรองข้อมูลในระหว่างการค้นหาทรัพยากร  สามารถมีการเพิ่มลักษณะเพิ่มเติมตามที่จำเป็นเพื่อการปรับปรุงการค้นหาเพิ่มเติม 
...
<td>เพิ่มทรัพยากรที่วางแผนไว้โดยใช้บทบาทที่มีการเกี่ยวข้องกับงานโดยอัตโนมัติ  Finance and Operations แนะนำทรัพยากรที่วางแผนไว้โดยอัตโนมัติ โดยการใช้การวิเคราะห์การตัดสินใจแบบหลายเงื่อนไข ซึ่งขึ้นอยู่กับบทบาท หลังจากบทบาทและความพยายาม (ชั่วโมง) ได้ถูกกำหนดสำหรับงานใน WBS และโครงสร้างได้ถูกนำออกใช้แล้ว คลิก <strong>ทีมสร้างขึ้นโดยอัตโนมัติ</strong> จำนวนที่ระบุของทรัพยากรที่วางแผนไว้จะถูกเพิ่มไปที่ WBS และแท็บ <strong>การจัดกำหนดการโครงการและทีม</strong></td>
</tr>
<tr class="odd">
