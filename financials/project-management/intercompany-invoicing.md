...
description: "บทความนี้มีรายละเอียดและตัวอย่างเกี่ยวกับการออกใบแจ้งหนี้ระหว่างบริษัทสำหรับโครงการใน 365 Dynamics Microsoft สำหรับการดำเนินงาน"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
บทความนี้มีรายละเอียดและตัวอย่างเกี่ยวกับการออกใบแจ้งหนี้ระหว่างบริษัทสำหรับโครงการใน 365 Dynamics Microsoft สำหรับการดำเนินงาน

องค์กรของคุณอาจมีแผนก บริษัทในเครือ และนิติบุคคลจำนวนมากที่โอนย้ายผลิตภัณฑ์และบริการให้กันและกันสำหรับโครงการ นิติบุคคลที่ให้บริการหรือผลิตภัณฑ์เรียกว่าการ*นิติบุคคลที่ให้ยืม*และนิติบุคคลที่ได้รับบริการหรือผลิตภัณฑ์เรียกว่าการ*นิติบุคคลที่ขอยืม* 
...
เป้าหมายคือเพื่อ ทำให้การควบคุมต้นทุน การรับรู้รายได้ ภาษี และโอนย้ายราคาสำหรับธุรกรรมโครงการระหว่างบริษัทแบบยืดหยุ่น และมีประสิทธิภาพมากขึ้น นอกจากนี้ยังมีความสามารถต่อไปนี้:
...
1.  ตั้งค่า FRSI เป็นลูกค้าในนิติบุคคล USSI และตั้งค่า USSI เป็นผู้จัดจำหน่ายในนิติบุคคล FRSI มีจุดเข้าใช้งานสามจุดสำหรับขั้นตอนที่จำเป็นสำหรับงานนี้
    ...
    |------|-----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | A    | ใน USSI คลิ**บัญชีลูกหนี้**&gt;**ลูกค้า**&gt;**ลูกค้าทั้งหมด** | สร้างเรกคอร์ดลูกค้าใหม่สำหรับ FRSI และเลือกกลุ่มลูกค้า                                                                                                                                                                                                                           |
    | B    | ใน FRSI คลิ**บัญชีเจ้าหนี้**&gt;**ผู้จัดจำหน่าย**&gt;**ผู้จัดจำหน่ายทั้งหมด**        | สร้างเรกคอร์ดผู้จัดจำหน่ายใหม่สำหรับ USSI และเลือกกลุ่มผู้จัดจำหน่าย                                                                                                                                                                                                                               |
...
2.  คลิ**โครงการการจัดการและการบัญชี**&gt;**ตั้งค่า**&gt;**พารามิเตอร์การบัญชีการจัดการโครงการ**แล้ว คลิกการ**ระหว่างบริษัท**แท็บ วิธีการที่คุณตั้งค่าพารามิเตอร์ขึ้นอยู่กับว่าคุณเป็นนิติบุคคลที่ขอยืมหรือนิติบุคคลที่ให้ยืม
...
3.  คลิ**โครงการการจัดการและการบัญชี**&gt;**ตั้งค่า**&gt;**คา**&gt;**ราคาโอน**
...
5.  คลิ**บัญชีแยกประเภททั่วไป**&gt;**การตั้งค่าการลงรายการบัญชี**&gt;**การลงบัญชีระหว่างบริษัท**และตั้งค่าความสัมพันธ์สำหรับ USSI และ FRSI
...
| ขั้นตอน | จุดเข้าใช้งาน                                                                       | คำอธิบาย                                                                                                                                                                                       |
|------|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A    | **โครงการการจัดการและการบัญชี**&gt;**แผ่นเวลา**&gt;**แผ่นเวลาทั้งหมด** | สร้างแผ่นเวลาใหม่ บนรายการแผ่นเวลา ในฟิลด์ **นิติบุคคล** เลือก **FRSI** ในฟิลด์ **รหัสโครงการ** เลือกโครงการใน FRSI ป้อนจำนวนชั่วโมงในแต่ละวันของสัปดาห์ |
...
| ขั้นตอน | จุดเข้าใช้งาน                                                                                      | คำอธิบาย                                                                                                                                                                                                                                                                          |
|------|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A    | **บัญชีเจ้าหนี้**&gt;**ใบแจ้งหนี้**&gt;**เปิดใบแจ้งหนี้ของผู้จัดจำหน่าย**&gt;**ใบแจ้งหนี้ของผู้จัดจำหน่ายใหม่** | สร้างใบแจ้งหนี้ของผู้จัดจำหน่ายใหม่และป้อนการบริการที่ถูกค้นหาในนามของโครงการของ FRSI                                                                                                                                                                                  |
...
| ขั้นตอน | จุดเข้าใช้งาน                                                                                             | คำอธิบาย                                                                                                                                      |
|------|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| A    | **โครงการการจัดการและการบัญชี**&gt;**โครงการอินวอยซ์**&gt;**ใบแจ้งหนี้ของลูกค้าระหว่างบริษัท**  | คลิก **สร้าง** เพื่อเปิดหน้า **สร้างใบแจ้งหนี้ระหว่างบริษัท**                                                                                  |
| B    | **โครงการการจัดการและการบัญชี**&gt;**โครงการอินวอยซ์**&gt;**อินวอยซ์ของลูกค้าระหว่างบริษัท** | ในหน้า **สร้างใบแจ้งหนี้ระหว่างบริษัท** ป้อนนิติบุคคล ระบุธุรกรรมที่ควรรวมอยู่ด้วย แล้วคลิก **ค้นหา** |
| C    | **โครงการการจัดการและการบัญชี**&gt;**โครงการอินวอยซ์**&gt;**อินวอยซ์ของลูกค้าระหว่างบริษัท** | เลือกธุรกรรมที่จะออกใบแจ้งหนี้ หรือคลิก **เลือกทั้งหมด** เพื่อออกใบแจ้งหนี้ธุรกรรมทั้งหมดในรายการ แล้วคลิก **ตกลง**                  |
...
| ขั้นตอน | จุดเข้าใช้งาน                                                                                        | คำอธิบาย                                                                                                             |
|------|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| A    | **บัญชีเจ้าหนี้**&gt;**ใบแจ้งหนี้**&gt;**ใบแจ้งหนี้ของผู้จัดจำหน่ายที่ค้างอยู่**                            | ตรวจทานใบแจ้งหนี้เพื่อตรวจสอบว่าค่าของแผ่นเวลารวมอยู่ด้ย และจากนั้นลงรายการบัญชีใบแจ้งหนี้ของผู้จัดจำหน่าย                  |
| B    | **โครงการการจัดการและการบัญชี**&gt;**โครงการอินวอยซ์**&gt;**ข้อเสนอใบแจ้งหนี้โครงการ** | สร้างใบแจ้งหนี้โครงการใหม่สำหรับโครงการ และตรวจสอบว่าธุรกรรมชั่วโมงได้รับการลงรายการบัญชีแสดงขึ้น            |
