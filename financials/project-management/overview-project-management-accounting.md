...
โครงการคือ กลุ่มของกิจกรรมที่ถูกออกแบบมาเพื่อให้การบริการ สร้างผลิตภัณฑ์ หรือบรรลุผลลัพธ์ โครงการที่สิ้นเปลืองทรัพยากร และสร้างผลลัพธ์ทางการเงินในรูปของรายได้หรือสินทรัพย์

## <a name="projects-across-industries"></a>โครงการระหว่างอุตสาหกรรม
การจัดการโครงการและการลงบัญชีสามารถใช้ในอุตสาหกรรมหลากหลาย ดังที่แสดงในภาพประกอบต่อไปนี้ [![โครงการข้ามอุตสาหกรรม](./media/projects-accross-industries.jpg)](./media/projects-accross-industries.jpg) 

ในศูนย์บริการทางโทรศัพท์ ตั๋วสามารถใช้เพื่ออธิบายถึงชุดของการดำเนินการที่จำเป็นเพื่อแก้ปัญหาทางโทรศัพท์ได้ บริษัทคำปรึกษาเป็นต้น เช่นการบริหารด้านเทคนิคปรึกษาองค์กร หรือหน่วยงาน การโฆษณาที่อ้างอิงถึงกิจกรรมของพวกเขาเป็นโครงการ ในตลาด การส่งเสริมการขายแสดงถึงชุดของงานที่ต้องจัดส่ง ในการผลิตตามโครงการ ใบสั่งผลิตเกี่ยวข้องกับงานต่าง ๆ ต้องดำเนินการให้เสร็จสมบูรณ์เพื่อผลิตสินค้าสำเร็จรูปบางชนิด จะใช้ชื่อใดก็ตามได้ โครงการเหล่านี้เกี่ยวข้องกับทรัพยากร กำหนดการ และต้นทุน และการจัดการโครงการและฟังก์ชันการลงบัญชีใน 365 Dynamics Microsoft สำหรับการดำเนินงานสามารถช่วยในการวางแผน การดำเนินการ และการวิเคราะห์โครงการเหล่านี้
...
ในระหว่างการเริ่มต้นโครงการ กระบวนการที่สำคัญต่าง ๆ เกิดขึ้น คุณสามารถใช้ใบเสนอราคาโครงการในการสื่อสารที่ประเมินค่าแรง ค่าใช้จ่าย และวัตถุดิบให้กับลูกค้า คุณสามารถบันทึกการเรียกเก็บเงินเงื่อนไข ข้อจำกัด และข้อตกลงในสัญญาโครงการ คุณสามารถใช้โครงสร้างการแบ่งงาน (WBS) การวางแผน และประเมินการทำงาน คุณสามารถตั้งค่าการคาดการณ์และงบประมาณเพื่อแนะนำการดำเนินการโครงการ ภาพประกอบต่อไปนี้แสดงโครงสร้างของโครงการ [![โครงสร้างของโครงการ](./media/project-structure1.jpg)](./media/project-structure1.jpg)  
...
คุณสามารถใช้การคาดการณ์ได้ถ้าองค์กรของคุณมีมุมมองที่มีการดำเนินงาน และมุ่งเน้นรายได้และต้นทุนที่ได้รับมาจากธุรกรรมเฉพาะ อย่างไรก็ตาม ถ้าองค์กรของคุณมุ่งเน้นยอดเงินทางการเงินมากขึ้น คุณสามารถการจัดทำงบประมาณได้ แต่ละวิธีมีข้อดี ดูข้อมูลเพิ่มเติม [การคาดการณ์และงบประมาณ](project-forecasts-budgets.mdhttps:/ax.help.dynamics.com/en/wiki/project-forecasts-and-budgets/)

### <a name="create-projects"></a>สร้างโครงการ

คุณสามารถสร้างโครงการหกชนิดใน 365 Dynamics Microsoft สำหรับการดำเนินงาน โครงการแต่ละชนิดมีตั้งค่าแตกต่างออกไปสำหรับต้นทุนและการรับรู้รายได้ โครงการแต่ละชนิดที่คุณเลือกจะขึ้นอยู่กับวัตถุประสงค์ของโครงการ ตารางต่อไปนี้อธิบายถึงการใช้โดยทั่วไปของโครงการแต่ละชนิด

| ชนิดโครงการ      | คำอธิบาย 
|-------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| เวลาและวัสดุ | ในเวลาและโครงการวัสดุ ลูกค้าถูกเรียกเก็บเงินสำหรับต้นทุนทั้งหมดที่เกิดขึ้นในโครงการ ต้นทุนเหล่านี้รวมต้นทุนสำหรับชั่วโมง ค่าใช้จ่าย สินค้า และค่าธรรมเนียม                                                                                                                  |
| โครงการที่มีราคาคงที่       | ใบแจ้งหนี้ประกอบด้วยของธุรกรรมในบัญชีในโครงการที่มีราคาคงที่ โครงการที่มีราคาคงที่จะออกอินวอยซ์ตามกำหนดการเรียกเก็บเงินที่เป็นไปตามสัญญาโครงการ รายได้สำหรับโครงการที่มีราคาคงที่สามารถคำนวณ และลงรายการบัญชีทั่วทั้งโครงการ โดยการใช้วิธีการเปอร์เซ็นต์ที่เสร็จสมบูรณ์ อีกทางหนึ่งคือ รายได้สามารถคำนวณ และลงรายการบัญชีเมื่อโครงการเสร็จสมบูรณ์ โดยใช้วิธีการสัญญาที่สิ้นสุดแล้ว บริษัทอาจมักจะได้รับประโยชน์จากการใช้มูลค่าของงานระหว่าง(ทำ WIP) ในการคำนวณระดับของความสมบูรณ์ของโครงการหรือกลุ่มโครงการ                                                                                                                                     |
| การลงทุน        | โครงการลงทุนคือ โครงการที่ไม่ได้สร้างรายได้ในทันที โดยทั่วไปจะใช้สำหรับโครงการภายในระยะยาวที่ต้องบันทึกต้นทุนเป็นสินทรัพย์ มีการลงบันทึกเฉพาะต้นทุนสำหรับสินค้า จำนวนชั่วโมง ค่าใช้จ่ายสำหรับโครงการลงทุน ต้นทุนในโครงการลงทุนมีการติดตามและควบคุมโดยใช้คุณลักษณะการประเมิน โครงการลงทุนสามารถตั้งค่าโดยมีมูลค่าเงินทุนสูงสุดที่เป็นตัวเลือกได้ ตามที่การลงทุนโครงการกำลังดำเนินการอยู่ คุณเรกคอร์ดต้นทุนในบัญชี WIP ซึ่งจัดเก็บต้นทุนจนกว่าโครงการเสร็จสมบูรณ์ เมื่อตัดโครงการออก คุณโอนย้ายมูลค่า WIP ไปยังสินทรัพย์ถาวร บัญชีแยกประเภท หรือโครงการใหม่
> [!NOTE] 
> ธุรกรรมในโครงการลงทุนจะไม่ถูกแสดงบน**การลงรายการบัญชีต้นทุน**,**ตั้งรายได้ค้างรับ**หรือ**ข้อเสนอใบแจ้งหนี้สร้าง**หน้า                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | | ต้นทุนโครงการ | เช่นเดียวกับโครงการลงทุน โครงการต้นทุนโดยทั่วไปจะใช้ในการติดตาม โครงการภายใน และเฉพาะชั่วโมง ค่าใช้จ่าย และสินค้าคุณสามารถบันทึกรายการได้ อย่างไรก็ตาม ต้นทุนโครงการโดยปกติช่วงเวลาสั้นกว่าโครงการลงทุน นอกจากนี้ แตกต่างจากโครงการลงทุน ต้นทุนโครงการไม่สามารถเป็นตัวพิมพ์ใหญ่กับบัญชีงบดุล ธุรกรรมโครงการจะถูกลงรายการบัญชีในบัญชีกำไรขาดทุนเท่านั้น 
[!NOTE] 
> ธุรกรรมในโครงการต้นทุนจะไม่สะท้อนให้เห็นบน**การลงรายการบัญชีต้นทุน**,**ตั้งรายได้ค้างรับ**หรือ**ข้อเสนอใบแจ้งหนี้สร้าง**หน้า เนื่องจากโดยปกติแล้วโครงการต้นทุนจะใช้ในการติดตามโครงการภายใน โดยปกติแล้วจะไม่มีจะเชื่อมโยงกับรหัสลูกค้า อย่างไรก็ตาม ถ้ามีการตั้งค่าของคุณกำหนดว่า มีสร้างความต้องการสินค้าสำหรับใบสั่งซื้อ คุณต้องเชื่อมโยงโครงการต้นทุนกับลูกค้า ความเชื่อมโยงนี้จำเป็น เนื่องจากความต้องการสินค้าถูกจัดการตามรายการใบสั่งขาย และระบบจำเป็นต้องระบุลูกค้า อย่างไรก็ตาม การตั้งค่านี้จะไม่ก่อให้เกิดความต้องการสินค้าที่จะสร้างขึ้นโดยอัตโนมัติจากใบสั่งซื้อ สำหรับต้นทุนโครงการ **สร้างความต้องการสินค้า** การตั้งค่านี้จะถูกละเว้น ถ้าคุณต้องการความต้องการสินค้าในโครงการต้นทุน คุณสามารถสร้างได้ด้วยตนเอง ระบุว่าลูกค้าจะถูกเชื่อมโยงกับโครงการ | | ภายใน | โครงการภายในจะใช้ในการติดตามต้นทุนโครงการที่อยู่ภายในองค์กรของคุณ โครงการภายในสามารถแสดงเครื่องมือการวางแผนเพื่อจัดการปริมาณการใช้ทรัพยากร **หมายเหตุ:**ธุรกรรมในโครงการภายในไม่ปรากฏบนตัว**ตั้งรายได้ค้างรับ**หรือ**ข้อเสนอใบแจ้งหนี้สร้าง**หน้า                                                                                                                                                                                                                                                                       | | เวลา | โครงการเวลาจะใช้ในการติดตามเวลาที่สัมพันธ์กับที่ไม่คิดค่าธรรมเนียมได้ และผลิตผลกิจกรรม เช่นโครงการเพื่อติดตามเวลาป่วยสำหรับผู้ปฏิบัติงาน ธุรกรรมในโครงการเวลาไม่ได้ลงรายการบัญชีไปที่บัญชีแยกประเภท แต่จะรวมอยู่ในรายงานการใช้ประโยชน์ของผู้ปฏิบัติงาน เฉพาะรายการบันทึกชั่วโมงสามารถถูกบันทึกได้ในโครงการเวลา คุณใช้สมุดรายวันชั่วโมงหรือแผ่นเวลาเพื่อลงทะเบียนชั่วโมงเหล่านี้ไปยังโครงการ หลังจากที่มีการลงทะเบียนชั่วโมง จะปรากฏเป็นธุรกรรมในโครงการ แต่ไม่จำเป็นที่สอดคล้องกับธุรกรรมใบสำคัญ

> [!NOTE] 
> ธุรกรรมในโครงการเวลาจะไม่สะท้อนให้เห็นบน**การลงรายการบัญชีต้นทุน**,**ตั้งรายได้ค้างรับ**หรือ**ข้อเสนอใบแจ้งหนี้สร้าง**หน้า                                                                                                                                                                                       |
...
ต่อไปนี้คือบางวิธีที่คุณสามารถใช้ฟังก์ชันการจัดกำหนดการทรัพยากร:
...
มีสองวิธีในการจัดการ และควบคุมโครงการของคุณ: การคาดการณ์ของโครงการ และงบประมาณของโครงการ คุณสามารถใช้การคาดการณ์ได้ถ้าองค์กรของคุณมีมุมมองที่มีการดำเนินงาน และมุ่งเน้นรายได้และต้นทุนที่ได้รับมาจากธุรกรรมเฉพาะ อย่างไรก็ตาม ถ้าองค์กรของคุณมุ่งเน้นยอดเงินทางการเงินมากขึ้น คุณสามารถการจัดทำงบประมาณได้

ดูข้อมูลเพิ่มเติม [การคาดการณ์และงบประมาณ](project-forecasts-budgets.mdhttps:/ax.help.dynamics.com/en/wiki/project-forecasts-and-budgets/)
...
-   ใช้สินค้า/ไม่เชื่อมโยงกับใบสั่ง *** – เชื่อมโยงโครงการกับความต้องการสินค้า ด้วยวิธีนี้ คุณสามารถดูต้นทุนโครงการที่แท้จริงได้เมื่อการผลิตมีสถานะเป็น **เริ่มต้นแล้ว** หรือถูกรายงานเป็นเสร็จแล้ว ต้นทุนถูกลงรายการบัญชีเป็นหลายธุรกรรมของสินค้าโครงการสำหรับวัตถุดิบชั่วโมงทีใช้สำหรับการผลิต คุณยังสามารถกำหนดระดับในลำดับชั้นของ BOM ที่มีติดตามโครงการในการผลิต
...
-   เพื่อสั่งซื้อสินค้าจากสินค้าคงคลังของบริษัท คุณต้องป้อนใบสั่งเป็นความต้องการสินค้า ถ้าคุณใช้การ**ความต้องสินค้า**หน้า คุณสามารถตั้งค่าความต้องการเพื่อให้คุณได้รับสินค้าเป็นการจัดส่งเป็นบางส่วนได้ ดังนั้น คุณสามารถเลื่อนปริมาณของสินค้ามีปริมาณการใช้วัสดุจนกว่าสินค้าจำเป็น
-   เพื่อสั่งซื้อสินค้าจากผู้จัดจำหน่ายภายนอก คุณต้องสร้างคำสั่งซื้อเป็นใบสั่งซื้อบนหน้า **ใบสั่งซื้อ**

> [!NOTE] 
> ไม่สามารถยกเลิกบันทึกการจัดส่งสำหรับโครงการที่เกี่ยวข้องกับการขายถ้าสินค้าได้ถูกทำเครื่องหมายแล้วสำหรับการบรรจุ 
...
<td>ต้นทุนที่ประเมินต้องป้อนด้วยตนเอง หลังจาก <strong>ต้นทุนรวม</strong> หรือ <strong>ปริมาณรวม</strong> คอลัมน์บนหน้า <strong>การประเมินต้นทุน </strong>เสร็จสมบูรณ์ ต้นทุนจริงจะถูกหักจากผลรวมที่ผู้ใช้ป้อนไว้ ผลลัพธ์คือต้นทุนในการดำเนินการโครงการ โดยทั่วไป ความคืบหน้าของต้นทุนจะไม่ถูกติดตามโดยอาศัย ตัวอย่างเช่น จำนวนการพักในโรงแรมและอาหารที่ถูกบันทึกในแต่ละรอบระยะเวลา แทน การติดตามโดยปกติจะยึดตามการเปรียบเทียบกับยอดเงินรวมของชั่วโมงที่ประเมิน วิธีการนี้ไม่ต้องการโมเดลการคาดการณ์ และต้นทุนรวมหรือปริมาณรวมสามารถถูกเปลี่ยนด้วยตนเอง เมื่อมีป้อนค่าในการ<strong>รวมต้นทุน</strong>หรือ<strong>ปริมาณทั้งหมดที่</strong>คอลัมน์ 365 Dynamics Microsoft สำหรับการดำเนินการเปรียบเทียบค่านี้เทียบกับธุรกรรมที่เกิดขึ้นจริงที่ลงรายการบัญชีในรอบระยะเวลา และจากนั้น ลดค่าในการ<strong>ปริมาณที่จะเติม</strong>หรือ<strong>ต้นทุนในการทำให้เสร็จสมบูรณ์</strong>คอลัมน์</td>
</tr>
<tr class="even">
...
365 Dynamics Microsoft สำหรับการดำเนินงานไม่ลดลงประเมินคาดการณ์ไว้โดยอัตโนมัติ ดังนั้น จึงเป็นความคิดที่ดีในการรักษาแบบจำลองการคาดการณ์ต้นฉบับในโครงการที่มีราคาคงที่ เพื่อสร้างพื้นฐานสำหรับการเปรียบเทียบเมื่อโครงการเสร็จสมบูรณ์ 
> [!NOTE]เมื่อคุณเลือกวิธีนี้ ใช้แบบจำลองการคาดการณ์อย่างน้อยสอง แบบจำลองที่หนึ่งควรประกอบด้วยการคาดการณ์ดั้งเดิม สำหรับแบบจำลองอื่น คุณควรคัดลอกธุรกรรมการคาดการณ์จากแบบจำลองอื่น แบบจำลองนี้จะใช้ได้เฉพาะสำหรับโครงการที่มีราคาคงที่และโครงการลงทุนเท่านั้น</td>
> </tr>
<tr class="odd">
<td>งบประมาณที่เหลือ</td>
<td>วิธีนี้ใช้แบบจำลองงบประมาณที่เหลือเพื่อคำนวณต้นทุนในการดำเนินการโครงการให้เสร็จสมบูรณ์ เมื่อคุณใช้วิธีการนี้ ต้นทุนจริงและยอดเงินคาดการณ์ในแบบจำลองงบประมาณที่เหลือจะถูกบวกเข้าด้วยกัน ผลลัพธ์ คือ ต้นทุนรวม ก่อนที่คุณใช้วิธีการนี้ แบบจำลองงบประมาณที่เหลือต้องตั้งค่าการหักลบธุรกรรมที่ขึ้นอยู่กับธุรกรรมจริงที่บันทึกในระบบ บนหน้า <strong>แบบจำลองการคาดการณ์</strong> ให้แน่ใจว่า ฟิลด์ที่ทำเครื่องหมายไว้ในกลุ่ม <strong>การลดการคาดการณ์อัตโนมัติ</strong> โดยทั่วไป งบประมาณคงเหลือจะถูกคัดลอกจากงบประมาณเดิม เมื่อป้อนธุรกรรม ธุรกรรมในงบประมาณคงเหลือจะลดลง เป็นความก้าวหน้าโครงการ ถ้าคุณตัดสินใจว่า ต้องปรับปรุงงบประมาณคงเหลือ คุณคิดค่าธรรมเนียมธุรกรรมการคาดการณ์ไปที่งบประมาณคงเหลือ <strong>หมายเหตุ:</strong> วิธีการนี้สามารถใช้ได้เฉพาะเมื่อมีการแนบแบบจำลองการคาดการณ์กับการประเมินเท่านั้น</td>
</tr>
<tr class="even">
<td>ตามการประเมินก่อนหน้านี้</td>
<td>วิธีการประเมินเดียวกันที่ถูกใช้ในรอบระยะเวลาก่อนหน้านี้ วิธีการนี้จำเป็นต้องใช้โมเดลการคาดการณ์ถ้ารอบระยะเวลาก่อนหน้านี้จำเป็นต้องใช้โมเดลการคาดการณ์</td>
</tr>
<tr class="odd">
<td>กำหนดต้นทุนในการทำให้เสร็จเป็นศูนย์</td>
<td>โดยปกติ วิธีการนี้จะใช้ก่อนโครงการประเมินถูกตัดออก วิธีการนี้ตรงกับการประเมินผลรวมกับธุรกรรมที่เกิดขึ้นจริงที่ลงรายการบัญชีไว้ และล้างคอลัมน์ <strong>ต้นทุนในการทำให้เสร็จสมบูรณ์</strong> เปอร์เซ็นต์ของความสมบูรณ์ของผลลัพธ์จะเป็น 100 เปอร์เซ็นต์เสมอ ฟิลด์ <strong>การคาดการณ์</strong> ไม่ได้ถูกเลือกสำหรับแต่ละบรรทัดต้นทุนที่คุณสร้าง และผลรวมการประเมินจะถูกคัดลอกจากการประเมินต้นทุนก่อนหน้านี้ ปริมาณการใช้จริงสำหรับรอบระยะเวลาการประเมินจะถูกหักออกจากต้นทุนเพื่อดำเนินโครงการให้เสร็จสิ้น วิธีการนี้ไม่จำเป็นต้องมีโมเดลการคาดการณ์</td>
</tr>
<tr class="even">
...
-   **วันในใบแจ้งหนี้:** 31 มีนาคม 2012 วันนี้จะถูกกำหนดขึ้นอยู่กับความถี่ของใบแจ้งหนี้ ตัวอย่างนี้ คุณกำหนดความถี่ของใบแจ้งหนี้เป็นเดือนปัจจุบัน ดังนั้น ธุรกรรมทั้งหมดที่ลงรายการบัญชีในเดือนมีนาคมจะออกอินวอยซ์ในวันสุดท้ายของเดือน
-   **วันครบกำหนด:** 14 เมษายน 2012 วันนี้จะถูกกำหนดโดยยึดตามเงื่อนไขการชำระเงินที่ถูกตั้งค่าไว้สำหรับโครงการ ตัวอย่างนี้ คุณเลือกเงื่อนไขการชำระเงินของ 14 วัน ดังนั้น 14 วันจะถูกเพิ่มลงในวันใบแจ้งหนี้ที่จะมาถึงวันครบกำหนดของวันที่ 14 เมษายน 2012
-   **วันชำระเงินการขายที่คาดไว้:** 27 เมษายน 2012 วันนี้ถูกคำนวณ โดยการบวกจำนวนวันใน**จำนวนวันเผื่อทั่วไป**ใน**โครงการจัดการและพารามิเตอร์การบัญชี**หน้ากับจำนวนวันใน**จำนวนวันเผื่อแต่ละ**ใน**โครงการสัญญา**หน้า และจากนั้น เพิ่มผลรวมถึงจำนวนวันในการ**วันครบกำหนด**ฟิลด์ ตัวอย่างนี้ คุณป้อน **3** ในฟิลด์ **จำนวนวันเผื่อทั่วไป** และ **10** ในฟิลด์ **จำนวนวันเผื่อแต่ละวัน** ดังนั้น 13 วันจะถูกเพิ่มลงในวันที่ครบกำหนดที่จะมาถึงวันที่ชำระเงินจากการขายที่คาดไว้ของวันที่ 27 เมษายน 2012
...
-   **วันครบกำหนด:** 16 มีนาคม 2012 เงื่อนไขการชำระเงินถูกตั้งค่าเป็น 14 วัน
-   **วันชำระเงินการขายที่คาดไว้:** 29 มีนาคม 2012 การคำนวณประกอบด้วยจำนวนวันเผื่อทั่วไปและจำนวนวันเผื่อแต่ละ 10 สาม
...
> [!NOTE] 
> วันครบกำหนดสำหรับใบสั่งซื้อจะขึ้นอยู่กับธุรกรรมผู้จัดจำหน่ายเมื่อสร้างใบสั่งซื้อโครงการ วันที่ครบกำหนดไม่ขึ้นอยู่กับการตั้งค่าเริ่มต้นใด ๆ 
...
| หน้ากระแสเงินสด | หน้ารายงานโครงการ |
|----------------|-------------------------|
| กระแสเงินสดเข้า   | รายได้                 |
| กระแสเงินสดออก  | ต้นทุนรวม              |
| กระแสเงินสดสุทธิ | กำไรขั้นต้น            |
...
> [!NOTE] 
> เมื่อคุณใช้แบบ**ควบคุมต้นทุน**หน้าเพื่อดูสถานะปัจจุบันของต้นทุนโครงการ ใช้แบบจำลองการคาดการณ์ที่เลือกสำหรับงบประมาณเดิม และที่เหลือ ถ้าคุณเลือกแบบจำลองการคาดการณ์อื่นเมื่อคุณคำนวณต้นทุน ผลการคำนวณจะไม่ถูกต้อง
