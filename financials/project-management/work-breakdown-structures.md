...
โครงสร้างการแบ่งโครงสร้างการแบ่งงาน A โครงสร้างการแบ่งโครงสร้างการแบ่งงาน (WBS) คือ คำอธิบายของงานที่สามารถทำได้สำหรับโครงการได้ ลำดับชั้นของงานที่แสดงถึงความเข้าใจของทีมโครงการของส่วนประกอบ ของงาน และขนาด ต้นทุน และระยะเวลาของแต่ละส่วนประกอบหรืองาน ได้ WBS มีวัตถุประสงค์หลักสามข้อ:
...
การสร้าง WBS เป็นกระบวนการที่ดำเนินการมากซึ่งโดยปกติแล้วใช้ระยะเวลานาน และจำเป็นต้องทำงานร่วมกันและขอข้อมูลจากบุคคลที่หลากหลาย หัวข้อนี้อธิบายวิธีการใช้การปรับปรุง WBS ใน 365 Dynamics Microsoft สำหรับการดำเนินงานเพื่อตอบสนองความต้องการของคุณสำหรับการประเมินและการติดตาม
...
เมื่อต้องการใช้ความสามารถในการจัดกำหนดการเต็มคุณลักษณะ WBS ดำเนินการตั้งค่าต่อไปนี้:

1.  ตั้งค่าปฏิทินเริ่มต้นและปฏิทินโครงการ:
    1.  คลิ**โครงการการจัดการและการบัญชี**&gt;**ตั้งค่า**&gt;**เวลา** ในฟิลด์ **ปฏิทินการทำงานเริ่มต้น** ระบุปฏิทินเริ่มต้น นี่จะเป็นปฏิทินการทำงานเริ่มต้นสำหรับโครงการใหม่ใด ๆ ที่สร้างขึ้น
...
คลิก เพื่อตั้งค่าวันทำงานและชั่วโมงทำงานสำหรับปฏิทิน หรือ เพื่อสร้างปฏิทินใหม่**จัดการองค์กร**&gt;**ทั่วไป**&gt;**ปฏิทิน**
...
-   เมื่อต้องการตั้งค่าต้นทุนและราคาขายของแรงงาน ค่าใช้จ่าย และประเภทค่าธรรมเนียม คลิ**โครงการการจัดการและการบัญชี**&gt;**ตั้งค่า**&gt;**คา**
...
ส่วนต่อไปนี้อธิบายวิธีช่วย WBS ความสามารถให้กับแต่ละกิจกรรมเหล่านี้

### <a name="work-decomposition"></a>การแยกส่วนประกอบงาน

การสร้างการแบ่งหรือการแยกส่วนประกอบของงานโดยปกติจะเป็นขั้นตอนแรกในกระบวนการการสร้าง WBS ฟังก์ชันการทำงานของ WBS สนับสนุนของโครงสร้างพื้นฐานต่อไปนี้สำหรับการผลิตแบ่งหรือแยกส่วนประกอบ 
...
> [!NOTE] 
> เมื่อคุณเยื้องงานภายใต้งานที่เป็นโหนดปลายสุดก่อนที่จะดำเนินการเยื้อง งานสรุปที่สร้างขึ้นใหม่เสียของตนเองวันที่ ความพยายาม และหมายเลขของทรัพยากร ขณะนี้ใช้สรุปค่าของส่วนประกอบต่าง ๆ ของงานใหม่ 
...
การประเมินกำหนดการโดยปกติแล้วจะเป็นขั้นตอนที่สองในการสร้าง WBS ตามแนวทางปฏิบัติ คุณควรประเมินกำหนดการให้เสร็จสมบูณ์หลังจากที่คุณสร้างงาน การ**โครงสร้างการแบ่งงาน**หน้าใน Microsoft Dynamics 365 สำหรับการดำเนินการที่มีสองส่วน บานหน้าต่างด้านบนมีไว้สำหรับการประเมินกำหนดการ และบานหน้าต่างด้านล่างรวมถึงแท็บ **ต้นทุนและรายได้ที่ถูกประเมิน** ที่คุณสามารถใช้สำหรับการประเมินต้นทุน 
...
**งานการวางแผนใน 365 Dynamics Microsoft สำหรับการดำเนินงาน**ปัจจัยต่อไปนี้จะกำหนดว่าการจัดกำหนดการของงานโหนโหนดปลายสุด:
...
การจัดกำหนดการกฎ *** เมื่อเปิดความช่วยเหลือของการจัดกำหนดการอัตโนมัติ กฎต่อไปนี้นำไปใช้กับงานที่จัดกำหนดการสำหรับงานโหนโหนดปลายสุด:
...
จำนวนผู้ซื้อซื้อระยะเวลาจำนวนชั่วโมงในหนึ่งวันทำงานมาตรฐานในปฏิทินโครงการ 

ในบางกรณี คุณอาจต้องการให้ต่างจากกฎเหล่านี้ได้ คุณสามารถปิดการจัดกำหนดการอัตโนมัติเพื่อป้องกันไม่ให้ 365 Dynamics Microsoft สำหรับการดำเนินงานจากการตั้งค่า หรือแก้ไขคุณสมบัติของงานโหนโหนดปลายสุดใด ๆ โดยอัตโนมัติ เมื่อคุณป้อนข้อมูลสำหรับงานที่ทำให้เกิดการละเมิดกฎใด ๆ ของกฎการจัดกำหนดการ ไอคอนข้อผิดพลาดการจัดกำหนดการจะถูกแสดงสำหรับงาน ถ้าคุณไม่ต้องการจัดกำหนดการข้อผิดพลาดที่ถูกแสดง คลิก **ข้อผิดพลาดในการจัดกำหนดการจะถูกแสดง** เพื่อปิดคุณลักษณะ 

> [!NOTE] 
> ค่าสำหรับงานสรุปหรือคอนเทนเนอร์ยังถูกคำนวณเป็นผลรวมของค่าของงานแฟ้ม ๆ โดยไม่คำนึงถึงว่าความช่วยเหลือของการจัดกำหนดการอัตโนมัติถูกเปิด หรือปิด 
...
**แก้ไขข้อผิดพลาดการจัดกำหนดการทั้งหมด**ถ้าคุณต้องการให้ 365 Dynamics Microsoft สำหรับการดำเนินงานเพื่อแก้ไขข้อผิดพลาดการจัดกำหนดการทั้งหมดใน WBS บนบานหน้าต่างการดำเนินการ คลิ**แก้ไขความขัดแย้งของการจัดกำหนดการทั้งหมด** 

> [!NOTE] 
> คุณลักษณะนี้อาจทำให้เกิดการปรับเปลี่ยน WBS มีนัยสำคัญ แก้ไขข้อผิดพลาดตามลำดับต่อไปนี้:
...
> [!NOTE] 
> คุณไม่สามารถปรับเปลี่ยนการประเมินต้นทุนสำหรับงานสรุปหรือคอนเทนเนอร์ ประเมินต้นทุนสำหรับงานสรุปจะเท่ากับผลรวมของการประเมินต้นทุนของงานโหนดปลายสุด ต้นทุนรวมที่ประเมินสำหรับแต่ละงานจะถูกคำนวณเป็นผลรวมของยอดต้นทุนที่ประเมินสำหรับชนิดของธุรกรรมต่อไปนี้:
...
ต้นทุนและราคาขายสำหรับแต่ละค่าแรงหรือค่าใช้จ่ายประเมินรายการจะขึ้นอยู่กับการตั้งค่าที่กำหนดไว้สำหรับแต่ละประเภทในตารางราคาที่**โครงการการจัดการและการบัญชี**&gt;**ตั้งค่า**&gt;**ราคา** สำหรับสินค้า ต้นทุนและราคาขายถูกเพิ่มโดยค่าเริ่มต้นจากสินค้าหรือข้อตกลงทางการค้าในหน้ารายการ **ผลิตภัณฑ์ที่นำออกใช้** ในการจัดการข้อมูลผลิตภัณฑ์
...
365 Dynamics Microsoft สำหรับการดำเนินงานมีสามมุมมองสำหรับ WBS ของโครงการ: มุมมองของการวางแผน ความพยายามติดตามดู และมุมมองการติดตามต้นทุน
...
-   ความพยายามที่เหลือ (หรือที่เรียกอีกอย่างหนึ่งว่าการประเมินการทำให้สมบูรณ์\[เป็นต้น\]) =ความพยายามวางแผน – ความพยายามจริงวันที่สิ้นสุด
...
มีสองวิธีที่ให้ผู้จัดการโครงการสามารถปรับเปลี่ยนความพยายามในงาน:
...
> [!NOTE] 
> เมื่อคุณตรวจทานแก้ไขความพยายามสำหรับงาน WBS ในความพยายามติดตามมุมมอง งาน CTC, EAC เปอร์เซ็นต์ของต้นทุนที่ใช้ และผลต่างของต้นทุนที่คาดการณ์ไว้จะทั้งหมดถูกคำนวณในมุมมองการติดตามต้นทุน อย่างไรก็ตาม ต้นทุนการปรับปรุงไม่ส่งผลกระทบต่อค่าในมุมมองการติดตามความพยายาม เนื่องจากต้นทุนตามชนิดของธุรกรรม (แรงงาน วัสดุ หรือค่าใช้จ่าย) หรือประเภทโครงการไม่ได้ถูกปรับปรุง 
...
365 Dynamics Microsoft สำหรับการดำเนินงานใช้ใน 0:100 การได้กฎเมื่อจะลงจุดค่าที่วางแผนไว้ ภายใต้กฎนี้ มูลค่าของงานจะถูกลงรายการบัญชีงาน ณ วันที่สิ้นสุด จะไม่มีค่าถูกลงรายการบัญชีจนกว่างานจะเสร็จสมบูรณ์ 100 เปอร์เซ็นต์ 
...
365 Dynamics Microsoft สำหรับการดำเนินงานใช้ 0:100 กฎการได้เมื่อมีการลงจุดของค่าที่ได้รับ ภายใต้กฎนี้ มูลค่าของงานจะถูกลงรายการบัญชีงาน ณ วันที่สิ้นสุด จะไม่มีค่าถูกลงรายการบัญชีจนกว่างานจะเสร็จสมบูรณ์ 100 เปอร์เซ็นต์ 
...
> [!NOTE] 
> ในปัจจุบัน ระบบสำหรับ WBS การติดตามไม่มีโครงสร้างข้อมูลเพื่อเก็บเปอร์เซ็นต์ความคืบหน้าก่อนหน้านี้ในแต่ละงาน ดังนั้น มูลค่าที่ได้รับจะถูกรายงานเป็นของเวลาที่คิวบ์ได้รับการประมวลผลเท่านั้น ประมวลผลคิวบ์เป็นประจำเพื่อปรับปรุงข้อมูลมูลค่าที่ได้รับที่จะถูกแสดงบนศูนย์กลางเข้าถึงข้อมูล 
...
คุณสามารถใช้ฟังก์ชัน WBS แม่แบบเพื่อสร้างแม่แบบมาตรฐานสำหรับโครงการ ถ้าโครงการที่บริษัทของคุณนำเสนอเกี่ยวข้องกับงานที่สามารถทำซ้ำได้มากมาย คุณควรพิจารณาการสร้างเท็มเพล WBS 
