...
การสร้าง WBS เป็นกระบวนการที่ดำเนินการมากซึ่งโดยปกติแล้วใช้ระยะเวลานาน และจำเป็นต้องทำงานร่วมกันและขอข้อมูลจากบุคคลที่หลากหลาย หัวข้อนี้อธิบายวิธีการใช้ว่าคุณสามารถใช้การปรับปรุง WBS ใน Dynamics 365 for Operations ได้ตรงกับความต้องการสำหรับการประเมินและการติดตามได้อย่างไร
...
**การจัดกำหนดการงานใน Microsoft Dynamics 365 for Operations** ปัจจัยต่อไปนี้กำหนดการจัดกำหนดการงานระดับงานโหนดปลายสุด:
...
ในบางกรณี คุณอาจต้องการให้ต่างจากกฎเหล่านี้ได้ คุณสามารถปิดการจัดกำหนดการอัตโนมัติเพื่อป้องกัน Microsoft Dynamics 365 for Operations จากการตั้งค่า หรือแก้ไขคุณสมบัติของงานโหนดปลายสุดใด ๆ โดยอัตโนมัติ เมื่อคุณป้อนข้อมูลสำหรับงานที่ทำให้เกิดการละเมิดกฎใด ๆ ของกฎการจัดกำหนดการ ไอคอนข้อผิดพลาดการจัดกำหนดการจะถูกแสดงสำหรับงาน ถ้าคุณไม่ต้องการจัดกำหนดการข้อผิดพลาดที่ถูกแสดง คลิก **ข้อผิดพลาดในการจัดกำหนดการจะถูกแสดง** เพื่อปิดคุณลักษณะ 
...
**การแก้ไขข้อผิดพลาดเกี่ยวกับการจัดกำหนดการทั้งหมด** ถ้าคุณต้องการให้ Microsoft Dynamics 365 for Operations แก้ไขข้อผิดพลาดเกี่ยวกับการจัดกำหนดการทั้งหมดใน WBS บนบานหน้าต่างการดำเนินการ **แก้ไขส่วนต่างของการจัดกำหนดการทั้งหมด** 
...
Microsoft Dynamics 365 for Operations มีสามมุมมองสำหรับ WBS ของโครงการ: มุมมองการวางแผน มุมมองการติดตามความพยายาม และมุมมองการติดตามต้นทุน
...
Microsoft Dynamics 365 for Operations ใช้ 0:100 ตามกฎรายได้เมื่อจะลงจุดค่าที่วางแผนไว้ ภายใต้กฎนี้ มูลค่าของงานจะถูกลงรายการบัญชีงาน ณ วันที่สิ้นสุด จะไม่มีค่าถูกลงรายการบัญชีจนกว่างานจะเสร็จสมบูรณ์ 100 เปอร์เซ็นต์ 
...
Microsoft Dynamics 365 for Operations ใช้ 0:100 ตามกฎรายได้เมื่อจะลงจุดมูลค่าที่ได้มา ภายใต้กฎนี้ มูลค่าของงานจะถูกลงรายการบัญชีงาน ณ วันที่สิ้นสุด จะไม่มีค่าถูกลงรายการบัญชีจนกว่างานจะเสร็จสมบูรณ์ 100 เปอร์เซ็นต์ 
