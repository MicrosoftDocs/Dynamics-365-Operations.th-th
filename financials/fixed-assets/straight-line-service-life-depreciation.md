...
ตัวอย่างเช่น สำหรับวันที่ 1 กรกฎาคมถึง 30 มิถุนายนปีงบประมาณ การคำนวณค่าเสื่อมราคาเริ่มต้นในวันที่ 1 กรกฎาคม ปีบัญชีอาจจะยาวกว่าหรือสั้นกว่า 12 เดือนได้  ค่าเสื่อมราคาที่จะปรับปรุงโดยอัตโนมัติสำหรับแต่ละรอบระยะเวลาทางบัญชี ความยาวของปีบัญชีถัดไปจะขึ้นอยู่กับรอบระยะเวลาทางบัญชีที่คุณตั้งค่าเมื่อคุณสร้างปีบัญชีใหม่ในแบบฟอร์มปฏิทินทางบัญชี 
...
| ปีที่ 6 | 800 เหลือ\*                           | 1,800 - 800 = 1,000                   |

\*เนื่องจากยอดเงินเหลืออยู่น้อยกว่ายอดค่าเสื่อมราคา ระบบจะใช้เฉพาะยอดคงเหลือลบ ด้วยมูลค่าซาก
