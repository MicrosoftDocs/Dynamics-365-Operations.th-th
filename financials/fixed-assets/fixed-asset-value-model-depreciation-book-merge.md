...
description: "ในรุ่นก่อนหน้านี้ มีสองแนวคิดการคิดมูลค่าสำหรับสินทรัพย์ถาวร - รูปแบบมูลค่าและสมุดบัญชีค่าเสื่อมราคา ใน 365 Dynamics Microsoft สำหรับรุ่น 1611 การดำเนินการ ฟังก์ชันแบบจำลองค่าและฟังก์ชันการทำงานสมุดบัญชีค่าเสื่อมราคาได้ถูกผสานเข้าไปในแนวคิดเดียวที่เรียกว่าหนังสือ"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
ในรุ่นก่อนหน้านี้ มีสองแนวคิดการคิดมูลค่าสำหรับสินทรัพย์ถาวร - รูปแบบมูลค่าและสมุดบัญชีค่าเสื่อมราคา ใน 365 Dynamics Microsoft สำหรับรุ่น 1611 การดำเนินการ ฟังก์ชันแบบจำลองค่าและฟังก์ชันการทำงานสมุดบัญชีค่าเสื่อมราคาได้ถูกผสานเข้าไปในแนวคิดเดียวที่เรียกว่าหนังสือ

ฟังก์ชันสมุดบัญชีใหม่ขึ้นอยู่กับฟังก์ชันรูปแบบมูลค่าก่อนหน้า และยังรวมถึงฟังก์ชันทั้งหมดที่ระบุไว้ก่อนหน้านี้ในสมุดบัญชีค่าเสื่อมราคาเท่านั้น [![สมุดเป็นการผสานของฟังก์ชันค่าแบบจำลองและค่าเสื่อมราคาสมุด](./media/fixed-assets.png)](./media/fixed-assets.png)เนื่องจากการผสานนี้ และคุณสามารถนำหน้า สอบถาม รายงาน และชุดเดียวสำหรับกระบวนการสินทรัพย์ถาวรของคุณทั้งหมดได้ ตารางในหัวข้อนี้อธิบายฟังก์ชันก่อนหน้านี้สำหรับสมุดบัญชีค่าเสื่อมราคาและรูปแบบมูลค่าร่วมกับฟังก์ชันใหม่สำหรับสมุดบัญชี
