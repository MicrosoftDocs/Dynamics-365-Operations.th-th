...
ผู้จัดทำบัญชีต้นทุนกำหนดการตั้งค่าคอนฟิกพื้นที่ทำงานแบบเคลื่อนที่ของ **การควบคุมต้นทุน** ในโมดูล **การบัญชีต้นทุน** หลังจากที่พื้นที่ทำงานถูกเผยแพร่ไปยังแอพบนมือถือ Microsoft Dynamics 365 for Operations พื้นที่ทำงานดังกล่าวจะพร้อมใช้งานในแอพนั้น ดังนั้น ผู้จัดการศูนย์ต้นทุนทั้งหมดในองค์กรสามารถดูข้อมูลในรูปแบบเดียวกัน
