...
การมูลค่าตามทฤษฎี (มูลค่าตามบัญชี) ของธุรกรรมผู้จัดจำหน่ายที่เปิดค้างไว้ที่เป็นสกุลเงินต่างประเทศ จะเปลี่ยนแปลงเมื่อเวลาผ่านไป ตามความผันผวนของอัตราแลกเปลี่ยน เริ่มกระบวนการประเมินค่าตามสกุลเงินต่างประเทศ เพื่อปรับปรุงมูลค่าของเปิดธุรกรรมในบัญชีเจ้าหนี้และบัญชีลูกหนี้ การประเมินค่าตามสกุลเงินต่างประเทศ สามารถใช้ได้สำหรับทั้งบัญชีเจ้าหนี้และบัญชีลูกหนี้ กระบวนการนี้ใช้อัตราแลกเปลี่ยนใหม่เพื่อประเมินค่าเงินที่มีอยู่ หรือ ค่าเงินที่ยังไม่คงตัวใหม่ในวันที่ระบุ ความแตกต่างระหว่างยอดเงินที่ลงรายการบัญชีเดิมและยอดเงินประเมินค่าใหม่จะทำให้มียังไม่รับรู้กำไรหรือขาดทุนสำหรับแต่ละธุรกรรมที่เปิด บัญชีเจ้าหนี้และ subledgers ลูกหนี้บัญชีอยู่แล้วอัพเดตเพื่อสะท้อนยังไม่รับรู้กำไรหรือขาดทุน และลงรายการบัญชีรายการบัญชีแยกประเภททั่วไป
...
ใช้การ**การประเมินค่าใหม่ตามสกุลเงินต่างประเทศ**หน้าภายใต้**งานประจำงวด**การเปิดธุรกรรมการประเมินค่าใหม่ คุณสามารถดำเนินกระบวนการแบบเรียลไทม์ หรือจัดกำหนดการให้ดำเนินงานโดยการใช้ชุดงานได้ เมื่อคุณกำหนดการตั้งค่าสำหรับกระบวนการประเมินค่าใหม่ ได้ให้ตรวจสอบว่า คุณต้องการพิมพ์รายงานผลลัพธ์ ไม่สามารถ reprinted รายงานการประเมินค่าใหม่หลังจากกระบวนการเสร็จสมบูรณ์ ถ้าคุณสร้างรายงานการประเมินค่าใหม่ตามสกุลเงินต่างประเทศ มันจะแสดงยอดดุลต่าง ๆ ของลูกค้า/ผู้จัดจำหน่ายและระดับสกุลเงิน:
...
เรกคอร์ดจะถูกเก็บรักษาไว้ทุกครั้งที่คุณรันการประเมินค่าตามสกุลเงินต่างประเทศใหม่ จากเรกคอร์ดใน **ประเมินค่าสกุลเงินต่างประเทศ** เลือก **ธุรกรรม** เพื่อดูรายละเอียดรายการธุรกรรมที่ถูกสร้างขึ้นเนื่องจาก มีการประเมินค่าใหม่ แต่ละธุรกรรมใบสำคัญแทนธุรกรรมเปิดที่มีการประเมินใหม่ ถ้าธุรกรรมที่เปิดมีการประเมินใหม่มากกว่าหนึ่งครั้ง คุณจะเห็นสองระเบียนที่ใช้ในใบสำคัญเดียวกัน หนึ่งระเบียนจะเป็นการกลับรายการกำไรที่ยังไม่รับรู้ก่อนหน้าหรือขาดทุน และเรกคอร์ดอื่น ๆ จะเป็นสำหรับขาดทุนหรือกำไรที่ยังไม่รับรู้ใหม่ การรันกระบวนการประเมินค่าใหม่ กดปุ่ม **การประเมินค่าใหม่ตามสกุลเงินต่างประเทศ** กำหนดพารามิเตอร์ต่อไปนี้ให้กับเท็มเพลตแผ่นงาน
