...
description: "คุณลักษณะการกระทบยอดบัญชีธนาคารขั้นสูงจะช่วยให้คุณสามารถนำเข้าใบแจ้งยอดจากธนาคารอิเล็กทรอนิกส์ และกระทบยอดด้วยธุรกรรมธนาคารได้โดยอัตโนมัติใน Microsoft Dynamics 365 for Operations บทความนี้อธิบายวิธีการตั้งค่าฟังก์ชันการนำเข้าสำหรับใบแจ้งยอดจากธนาคารของคุณ"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
คุณลักษณะการกระทบยอดบัญชีธนาคารขั้นสูงจะช่วยให้คุณสามารถนำเข้าใบแจ้งยอดจากธนาคารอิเล็กทรอนิกส์ และกระทบยอดด้วยธุรกรรมธนาคารได้โดยอัตโนมัติใน Microsoft Dynamics 365 for Operations บทความนี้อธิบายวิธีการตั้งค่าฟังก์ชันการนำเข้าสำหรับใบแจ้งยอดจากธนาคารของคุณ 

การตั้งค่าสำหรับการนำเข้าใบแจ้งยอดจากธนาคารแตกต่างกันไปขึ้นอยู่กับรูปแบบของใบแจ้งยอดจากธนาคารอิเล็กทรอนิกส์ของคุณ 365 Dynamics Microsoft สำหรับการดำเนินงานรองรับรูปแบบใบแจ้งยอดจากธนาคารทั้งสามออกจากกล่อง: ISO20022, MT940 และ BAI2

## <a name="sample-files"></a>ไฟล์ตัวอย่าง
สำหรับรูปแบบทั้งหมดสาม คุณต้องมีแฟ้มที่แปลใบแจ้งยอดของธนาคารอิเล็กทรอนิกส์จากรูปแบบเดิมไว้ให้เป็นรูปแบบที่สามารถใช้ Dynamics 365 สำหรับการดำเนินงาน คุณสามารถค้นหาไฟล์ทรัพยากรที่จำเป็นภายใต้โหนด **ทรัพยากร** ใน Explorer Application Explorer ใน Microsoft Visual Studio ได้ หลังจากที่คุณพบไฟล์แล้ว ให้คัดลอกไปยังตำแหน่งที่ตั้งที่ทราบหนึ่ง เพื่อให้คุณสามารถอัพโหลดได้อย่างง่ายดายในระหว่างกระบวนการติดตั้ง

| ชื่อทรัพยากร                                           | ชื่อไฟล์                            |
|---------------------------------------------------------|--------------------------------------|
| BankStmtImport\_BAI2CSV\_ไป\_BAI2XML\_xslt              | BAI2CSV-to-BAI2XML.xslt              |
| BankStmtImport\_BAI2XML\_ไป\_กระทบยอด\_xslt       | BAI2XML-to-Reconciliation.xslt       |
| BankStmtImport\_BankReconciliation\_ไป\_คอมโพสิต\_xslt | BankReconciliation-to-Composite.xslt |
| BankStmtImport\_ISO20022XML\_ไป\_กระทบยอด\_xslt   | ISO20022XML-to-Reconciliation.xslt   |
| BankStmtImport\_MT940TXT\_ไป\_MT940XML\_xslt            | MT940TXT-to-MT940XML.xslt            |
| BankStmtImport\_MT940XML\_ไป\_กระทบยอด\_xslt      | MT940XML-to-Reconciliation.xslt      |
...
ต่อไปนี้เป็นตัวอย่างของการนำเข้าการกระทบยอดบัญชีธนาคารขั้นสูงคำนิยามโครงร่างทางเทคนิคแฟ้ม และสามที่เกี่ยวข้องกับแฟ้มตัวอย่างของใบแจ้งยอดจากธนาคาร: https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/how-to-articles/exofbankstfotechlayouts  
...
1.  ไปที่**พื้นที่ทำงาน**&gt;**จัดการข้อมูล**
2.  Click **Import**.
...
10. สำหรับหมายเลขลำดับ 1 คลิก **อัพโหลดไฟล์**และเลือกไฟล์**ISO20022XML Reconciliation.xslt** ที่คุณบันทึกไว้ก่อนหน้านี้ **หมายเหตุ:** Dynamics 365 สำหรับแฟ้มการแปลงการดำเนินงานจะถูกสร้างขึ้นสำหรับรูปแบบมาตรฐาน เนื่องจากธนาคารมักระบบจากรูปแบบนี้ คุณอาจจำเป็นต้องปรับปรุงแฟ้มการแปลงเพื่อแมปไปยังรูปแบบใบแจ้งยอดจากธนาคารของคุณ <!-- For details about the expected format for ISO20022, see [Dynamics AX ISO20022 Layout](./media/dynamicsaxiso20022layout1.xlsx).-->
11. Click **New**.
...
1.  ไปที่**การจัดการเงินสดและธนาคาร**&gt;**ตั้งค่า**&gt;**ขั้นสูงการตั้งค่าการกระทบยอดธนาคาร**&gt;**รูปแบบใบแจ้งยอดจากธนาคาร**
2.  Click **New**.
...
11. คลิก **สร้าง**
12. สำหรับหมายเลขลำดับ 2 คลิก **อัพโหลดไฟล์**และเลือกไฟล์ **MT940XML Reconciliation.xslt** ที่คุณบันทึกไว้ก่อนหน้านี้ **หมายเหตุ:** Dynamics 365 สำหรับแฟ้มการแปลงการดำเนินงานจะถูกสร้างขึ้นสำหรับรูปแบบมาตรฐาน เนื่องจากธนาคารมักระบบจากรูปแบบนี้ คุณอาจจำเป็นต้องปรับปรุงแฟ้มการแปลงเพื่อแมปไปยังรูปแบบใบแจ้งยอดจากธนาคารของคุณ <!--- For details about the expected format for MT940, see [Dynamics AX MT940 Layout](./media/dynamicsaxmt940layout1.xlsx)-->
13. Click **New**.
...
11. คลิก **สร้าง**
12. สำหรับหมายเลขลำดับ 2 คลิก **อัพโหลดไฟล์**และเลือกไฟล์ **BAI2XML Reconciliation.xslt** ที่คุณบันทึกไว้ก่อนหน้านี้ **หมายเหตุ:** Dynamics 365 สำหรับแฟ้มการแปลงการดำเนินงานจะถูกสร้างขึ้นสำหรับรูปแบบมาตรฐาน เนื่องจากธนาคารมักระบบรูปแบบนี้ และคุณอาจจำเป็นต้องปรับปรุงแฟ้มการแปลงเพื่อแมปไปยังรูปแบบใบแจ้งยอดจากธนาคารของคุณ <!--- For details about the expected format for BAI2, see [Dynamics AX BAI2 Layout](./media/dynamicsaxbai2layout1.xlsx).-->
13. Click **New**.
14. สำหรับหมายเลขลำดับ 3 คลิก **อัพโหลดไฟล์**และเลือกไฟล์ **BankReconciliation-to-Composite.xslt** ที่คุณบันทึกไว้ก่อนหน้านี้
15. คลิก **ใช้การแปลง**
