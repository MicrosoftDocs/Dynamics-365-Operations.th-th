---
title: "แก้ไขปัญหาการนำเข้าไฟล์ใบแจ้งยอดของธนาคาร"
description: "ข้อสำคัญคือว่า ไฟล์ใบแจ้งยอดจากธนาคารจากธนาคารตรงกับเค้าโครงที่สนับสนุน 365 Dynamics Microsoft สำหรับการดำเนินงาน เนื่องด้วยมาตรฐานที่เข้มงวดของใบแจ้งยอดจากธนาคาร การรวมส่วนใหญ่จะทำงานอย่างถูกต้อง อย่างไรก็ตาม บางครั้งไม่สามารถนำเข้าไฟล์ใบแจ้งยอดได้ หรือมีผลลัพธ์ที่ไม่ถูกต้อง โดยทั่วไป ปัญหาเหล่านี้มีสาเหตุมาจากความแตกต่างเล็ก ๆ น้อย ๆ ในไฟล์ใบแจ้งยอดจากธนาคาร บทความนี้อธิบายวิธีการแก้ไขความแตกต่างเหล่านี้ และวิธีการแก้ไขปัญหา"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="bank-statement-file-import-troubleshooting"></a>แก้ไขปัญหาการนำเข้าไฟล์ใบแจ้งยอดของธนาคาร

ข้อสำคัญคือว่า ไฟล์ใบแจ้งยอดจากธนาคารจากธนาคารตรงกับเค้าโครงที่สนับสนุน 365 Dynamics Microsoft สำหรับการดำเนินงาน เนื่องด้วยมาตรฐานที่เข้มงวดของใบแจ้งยอดจากธนาคาร การรวมส่วนใหญ่จะทำงานอย่างถูกต้อง อย่างไรก็ตาม บางครั้งไม่สามารถนำเข้าไฟล์ใบแจ้งยอดได้ หรือมีผลลัพธ์ที่ไม่ถูกต้อง โดยทั่วไป ปัญหาเหล่านี้มีสาเหตุมาจากความแตกต่างเล็ก ๆ น้อย ๆ ในไฟล์ใบแจ้งยอดจากธนาคาร บทความนี้อธิบายวิธีการแก้ไขความแตกต่างเหล่านี้ และวิธีการแก้ไขปัญหา
...
เปรียบเทียบคำนิยามโครงร่างไฟล์ธนาคารเพื่อ 365 Dynamics ของ Microsoft สำหรับคำนิยามการนำเข้าการดำเนินงาน และสังเกตความแตกต่างใด ๆ ในเขตข้อมูลและองค์ประกอบ เปรียบเทียบไฟล์ใบแจ้งยอดจากธนาคารกับ Dynamics 365 ตัวอย่างที่เกี่ยวข้องสำหรับแฟ้มการดำเนินงาน ในแฟ้ม ISO20022 ความแตกต่างใด ๆ ควรจะง่ายต่อการดู
...
ปรับปรุงการแปรงข้อมูลเพื่อรับฟิลด์หรือองค์ประกอบที่เหมาะสมในไฟล์ใบแจ้งยอดจากธนาคาร แมปเขตข้อมูลหรือองค์ประกอบนั้นไป 365 Dynamics เหมาะสมสำหรับองค์ประกอบของการดำเนินงานแล้ว
