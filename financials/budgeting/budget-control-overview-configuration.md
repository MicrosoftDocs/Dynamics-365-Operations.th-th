---
title: "ภาพรวมการควบคุมงบประมาณ"
description: "บทความนี้แนะนำการควบคุมงบประมาณ และให้ข้อมูลเกี่ยวกับการตั้งค่าคอนฟิกการควบคุมงบประมาณใน 365 Dynamics Microsoft สำหรับการดำเนินงานเพื่อให้คุณสามารถจัดการทรัพยากรทางการเงิน"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="budget-control-overview"></a>ภาพรวมการควบคุมงบประมาณ

บทความนี้แนะนำการควบคุมงบประมาณ และให้ข้อมูลเกี่ยวกับการตั้งค่าคอนฟิกการควบคุมงบประมาณใน 365 Dynamics Microsoft สำหรับการดำเนินงานเพื่อให้คุณสามารถจัดการทรัพยากรทางการเงิน

<a name="overview"></a>ภาพรวม
--------

การควบคุมงบประมาณใน 365 Dynamics Microsoft สำหรับการดำเนินงานสนับสนุนการจัดการทรัพยากรทางการเงินขององค์กรผ่านผังบัญชี เวิร์กโฟลว์ กลุ่มผู้ใช้ เอกสารต้นฉบับ และสมุดรายวัน การคำนวณสามารถจัดโครงแบบที่มีเงินในบัญชี วงจรงบประมาณ และขีดจำกัด เมื่อมี่การควบคุม องค์กรจะสามารถวางแผน วัด จัดการ และคาดการณ์ทรัพยากรทางการเงินทั่วทั้งปีบัญชีได้ 

หลังจากที่ได้รับอนุมัติงบประมาณใน 365 Dynamics สำหรับการดำเนินงาน คุณสามารถใช้แผนงบประมาณในการสร้างรายการทะเบียนงบประมาณที่สามารถบันทึกค่าใช้จ่ายงบประมาณสำหรับองค์กร อีกวิธีหนึ่งคือ คุณสามารถสร้าง หรือนำเข้ารายการทะเบียนงบประมาณจากโปรแกรมของบริษัทอื่นแทนที่จะใช้ฟังก์ชันการวางแผนงบประมาณ 
...
คุณสามารถตั้งค่าคอนฟิกการควบคุมงบประมาณตามปัจจัยหลายอย่าง:
...
-   **เอกสารต้นทาง**– ใดต้องมีประเมินเอกสารต้นทางสำหรับการควบคุมงบประมาณหรือไม่ ควรประเมินเอกสารสำหรับแต่ ละบรรทัด หรือสำหรับแต่ ละเอกสารหรือไม่
...
การควบคุมงบประมาณทั้งหมดได้รับการรวมเข้ากับ 365 Dynamics สำหรับการดำเนินงาน ดังนั้น คุณสามารถประเมินงบประมาณพร้อมใช้งานสำหรับทั้งการซื้อที่วางแผนไว้และการซื้อที่เกิดขึ้นจริง การสอบถามและรายงานงบประมาณพร้อมใช้งาน ดังนั้น ผู้ใช้สามารถประเมินงบประมาณตลอดทั้งวงจรงบประมาณตามความจำเป็น และสามารถทำการปรับปรุงตามความจำเป็น ในรูปแบบของการปรับปรุงงบประมาณหรือโอนย้าย ผู้จัดการงบประมาณยังสามารถส่งออกงบประมาณและจำนวนที่เกิดขึ้นจริงไปยัง Microsoft Excel เพื่อการวิเคราะห์และการคาดการณ์ที่ดีขึ้นตามความจำเป็น
...
ขั้นตอนถัดไปในการกำหนดค่าเสร็จสมบูรณ์แล้วบนแท็บต่าง ๆ บน**การตั้งค่าคอนฟิกการควบคุมงบประมาณ**หน้า
...
> [!NOTE] 
> ถ้าการคำนวณถูกปรับเปลี่ยนในระหว่างวงจรงบประมาณ การเปลี่ยนแปลงจะไม่มีผลต่อเอกสารใด ๆ ที่ส่งผ่านการตรวจสอบการควบคุมงบประมาณก่อนหน้านี้ และที่ได้ถูกลงรายการบัญชี หรือเสร็จสมบูรณ์
...
> [!Important]
> จะสามารถเปิดใช้งานการควบคุมงบประมาณสำหรับบัญชีต่าง ๆ หลักของการ**กำไรขาดทุน**,**ค่าใช้จ่าย**,**รายได้ งบดุล หนี้สิน หุ้น**หรือ**สินทรัพย์**ชนิด ถ้าแท็บนี้ประกอบด้วยกฎที่มีเงื่อนไขว่างเปล่า จะเปิดใช้งานการควบคุมงบประมาณสำหรับชุดมิติทางการเงินที่รวมบัญชีหลักของชนิดดังกล่าว**ทั้งหมด ** ดังนั้น โปรดตรวจสอบให้แน่ใจว่าคุณสร้างกฎการควบคุมงบประมาณที่กำหนดเฉพาะช่วงของชุดมิติทางการเงิน ที่การเปิดใช้การควบคุมงบประมาณเป็นสิ่งสำคัญ  
...
> [!Important]
> หลัง จากที่เปิดการควบคุมงบประมาณอยู่ และที่ใช้งานอยู่ และหลัง จากที่ลงรายบัญชีธุรกรรม นั้นควรไม่สามารถปิดปีกลางอยู่ เมื่อมีการปิดการควบคุมงบประมาณ กิจกรรมจะไม่ถูกบันทึกในการควบคุมงบประมาณ และจะไม่มีการดำเนินการตรวจสอบงบประมาณอีกต่อไป ดังนั้น เอกสารที่ได้ลงรายการบัญชีอาจไม่ได้สะท้อนยอดเงินที่ปลดปล่อยหรือยอดดุลในการสอบถามและรายงานที่เกี่ยวข้องกับการควบคุมงบประมาณใดๆ อย่างถูกต้อง ซึ่งรวมถึงสถิติการควบคุมงบประมาณสำหรับเอกสารปลายทาง หรือเอกสารที่ปรับปรุง และสมุดรายวัน 
...
จากเพจนี้ ผู้ใช้สามารถเข้าถึงแบบ**สถิติการควบคุมงบประมาณโดยเรียงตามรอบระยะเวลา**หน้าเพื่อดูรายละเอียดของการมีอยู่ของงบประมาณและการจองสินค้าสำหรับชุดมิติของการควบคุมงบประมาณที่เลือกได้ ผู้ใช้สามารถเพิ่มเข้าไปที่หน้า **สถิติการควบคุมงบประมาณ **เพื่อดูความพร้อมใช้งานของงบประมาณสำหรับชุดมิติทางการเงินทั้งหมดที่ใช้ในการควบคุมงบประมาณ 
