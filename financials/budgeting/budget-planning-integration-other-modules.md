...
-   **สร้างแผนงบประมาณใหม่**สร้างแผนใหม่ที่มีแอททริบิวต์ที่เลือกในแบบ ** เป้าหมาย ** ส่วน แอททริบิวต์เหล่านี้ไม่จำเป็นต้องเป็นแบบเฉพาะ ดังนั้น แผนทั้งสองสามารถมีชื่อเดียวกันและค่าอื่นๆได้
...
สำหรับกระบวนการทั้งหมด**แหล่ง**แท็บช่วยให้คุณสามารถกรองข้อมูล โดยใช้การ**ตัวกรอง**ปุ่ม โดยค่าเริ่มต้น เขตข้อมูลที่ระบุจะเพิ่มตัวกรองข้อมูลสำหรับแต่ละกระบวนการ ตัวอย่างเช่น สำหรับกระบวนการ **สร้างแผนงบประมาณจากบัญชีแยกประเภททั่วไป** ประเภทของ **บัญชีแยกประเภท** และ **บัญชีหลัก** จะพร้อมใช้งาน และจะปรากฏอยู่บนหน้าการสร้าง ฟิลด์ใดๆที่คุณเพิ่มไปยังตัวกรองข้อมูลจะถูกเพิ่มไปที่หน้าด้วย พร้อมกับเกณฑ์ใดๆที่คุณเพิ่ม
...
กระบวนการ **สร้างแผนงบประมาณจากสินทรัพย์ถาวร** ยังไม่มีตัวเลือกสำหรับการรวมตามรอบระยะเวลาหรือวัน นอกจากนี้ยังไม่มีตัวเลือกสำหรับการตั้งค่าแผนเป็นในอดีต คุณสามารถใช้ขั้นตอนนี้เป็นครั้งคราวเพื่อรวมธุรกรรมที่คาดการณ์ไว้สำหรับสินทรัพย์ถาวรในการวางแผนงบประมาณของคุณ
...
มีรวมบรรทัดในแผนงบประมาณตามบัญชีแยกประเภทและตำแหน่ง อย่างไรก็ตาม คุณสามารถแยกหมายเลขตำแหน่ง เพื่อให้บรรทัดจะถูกรวมโดยเรียงตามบัญชีแยกประเภทเท่านั้น ในแท็บ **เป้าหมาย** ให้ตั้งค่าตัวเลือก **รวมตำแหน่งในแผนงบประมาณ** เป็น **ไม่ใช่**
