...
## <a name="set-up-journal-names-settlement-writeoff-and-nsf"></a>ตั้งค่าชื่อสมุดรายวัน (การชำระเงิน writeoff และ NSF)
...
## <a name="set-up-a-reason-code-for-writeoff-transactions"></a>ตั้งค่ารหัสเหตุผลสำหรับธุรกรรม writeoff
...
## <a name="set-up-a-writeoff-account"></a>ตั้งค่าบัญชี writeoff
...
> [!NOTE] 
> ถ้าไม่ได้ระบุคอลเลกชันผู้ติดต่อสำหรับลูกค้า ผู้ติดต่อหลักสำหรับลูกค้าไว้ ถ้าไม่ได้ระบุผู้ติดต่อหลัก ข้อความอีเมลจะถูกส่งไปยังที่อยู่แรกที่แสดงอยู่บนหน้า **ผู้ติดต่อ**
