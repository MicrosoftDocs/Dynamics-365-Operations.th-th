---
title: "ชำระเงินบางส่วนจากลูกค้าที่มีส่วนลดบนใบลดหนี้"
...
# <a name="settle-a-partial-customer-payment-that-has-discounts-on-credit-notes"></a>ชำระเงินบางส่วนจากลูกค้าที่มีส่วนลดบนใบลดหนี้

บทความนี้แนะนำคุณผ่านสถานการณ์ที่ส่วนลดเงินสดจะใช้ใบลดหนี้เมื่อใบแจ้งหนี้เดิมยังมีส่วนลดเงินสด 

Fabrikam อนุญาตให้ลูกค้านำส่วนลดเงินสด ในการชำระเงินบางส่วน และ บนใบลดหนี้ (บันทึกเครดิต) ส่วนลดเงินสดสามารถทำได้ในใบลดหนี้เมื่อมีออกใบลดหนี้สำหรับใบแจ้งหนี้ที่ลูกค้าได้ส่วนลดเงินสด แทนที่จะให้เครดิตสำหรับยอดเงินเต็มจำนวน คุณสามารถเครดิตยอดดุลของลูกค้าสำหรับยอดเงินที่ไม่รวมเปอร์เซ็นต์ส่วนลดเงินสดที่ลูกค้าใช้ พารามิเตอร์การชำระเงินที่อยู่บนการ**พารามิเตอร์ลูกหนี้**หน้า
...
|------------|------------------|-----------|----------|--------------------------------------|---------------------------------------|----------|----------|
| FTI-10050  | ใบแจ้งหนี้          | วันที่ 28 มิถุนายน 2015 | 10050    | 1,000.00                             |                                       | 1,000.00 | ดอลลาร์สหรัฐ      |
| CCRN-10050 | ใบลดหนี้      | วันที่ 28 มิถุนายน 2015 | CR-10050 |                                      | 100.00                                | -100.00  | ดอลลาร์สหรัฐ      |
...
|----------|-------------------|------------|---------|-----------|-----------|----------|--------------------------------|----------|------------------|
| เลือกแล้ว | ปกติ            | FTI-10050  | 4035    | วันที่ 28 มิถุนายน 2015 | วันที่ 28 กรกฏาคม 2015 | 10050    | 1,000.00                       | ดอลลาร์สหรัฐ      | 990.00           |
| เลือกแล้ว | ปกติ            | CCRN-10050 | 4035    | วันที่ 28 มิถุนายน 2015 | วันที่ 28 กรกฏาคม 2015 | CR-10050 | -100.00                        | ดอลลาร์สหรัฐ      | -99.00           |
