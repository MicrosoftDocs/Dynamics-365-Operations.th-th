...
คุณมีตัวเลือกสองตัวเมื่อชำระเงินด้วยใบแจ้งหนี้และธุรกรรมอื่น  คุณสามารถเลือกธุรกรรมที่จะจับคู่ด้วยตนเอง หรือ 365 Dynamics Microsoft สำหรับการดำเนินงานสามารถเลือกธุรกรรมโดยอัตโนมัติ โดยใช้ฟังก์ชันการทำงานของการชำระเงินอัตโนมัติ คุณยังสามารถกำหนดการจับคู่ประมวลผลอัตโนมัติ โดยใช้ตัวเลือก **จัดระดับความสำคัญของการชำระเงิน** ตัวเลือกเหล่านี้เป็นส่วนหนึ่งของพารามิเตอร์การชำระเงินที่กำหนดไว้บนการ**พารามิเตอร์ลูกหนี้**หน้า วิธีการที่ธุรกรรมมีการจับคู่อัตโนมัติอาจแตกต่างกัน ขึ้นอยู่กับวิธีการที่คุณใช้สำหรับการชำระเงินอัตโนมัติ วิธีการที่พร้อมใช้งานมีดังต่อไปนี้
...
| ดอกเบี้ยตั๋วเงิน | 15 ตุลาคม  | 7.00 น.   |                     |                    | ดอกเบี้ยตั๋วเงินนี้คือสำหรับใบแจ้งหนี้ 1 และ 2 ของใบแจ้งหนี้ ยอดจะถูกคำนวณเป็น 2 เปอร์เซ็นต์ดอกเบี้ยตามยอดเงินที่มีอย่าง น้อย 30 วันครบกำหนดที่ผ่านมา ตัวอย่างเช่น 0.02 × (100.00 + 250.00) = 7.00 |

## <a name="userdefined-settlement-priority"></a>ระดับความสำคัญของการชำระเงิน Userdefined
...
|---------------|------------|---------|--------------------------------|------------------|---------|----------|
| ดอกเบี้ยตั๋วเงิน | วันที่ 15 ตุลาคม 2015 |         | 7.00 น.                           | 7.00 น.             | 0.00    | ดอลลาร์สหรัฐ      |
| ใบแจ้งหนี้ 1     | วันที่ 15 สิงหาคม 2015  | 10001   | 100.00                         | 100.00           | 0.00    | ดอลลาร์สหรัฐ      |
| ใบแจ้งหนี้ 2     | วันที่ 1 กันยายน 2015   | 10002   | 250.00                         | 250.00           | 0.00    | ดอลลาร์สหรัฐ      |
| ใบแจ้งหนี้ 3     | วันที่ 15 ตุลาคม 2015 |         | 500.00                         | 343.00           | 157.00  | ดอลลาร์สหรัฐ      |
...
| ดอกเบี้ยตั๋วเงิน | วันที่ 15 ตุลาคม 2015 |         | 7.00 น.                           | 0.00             | 0.00    | ดอลลาร์สหรัฐ      |
