...
**ใบแจ้งหนี้ของลูกค้าสำหรับใบสั่งขาย** คือใบตราที่เกี่ยวข้องกับการขาย และที่ทางองค์กรให้กับลูกค้า ชนิดของใบแจ้งหนี้ของลูกค้านี้ถูกสร้างขึ้นตามใบสั่งขาย ซึ่งรวมรายการใบสั่งและหมายเลขสินค้า ต้องมีการระบุและลงรายการบัญชีหมายเลขสินค้าในบัญชีแยกประเภท รายการสมุดรายวันบัญชีแยกประเภทย่อยไม่พร้อมใช้งานสำหรับใบแจ้งหนี้ของลูกค้าสำหรับใบสั่งขาย 
...
คุณสามารถเลือกใบแจ้งหนี้หลายใบในหน้ารายการ **ใบสั่งขาย** และจากนั้นใช้ **สร้างใบแจ้งหนี้** เพื่อรวม บน**การลงรายการบัญชีใบแจ้งหนี้**คุณสามารถเปลี่ยนหน้า**ใบสั่งโดยสรุป**ตั้งค่าสรุปตามหมายเลขใบสั่ง (มีหลายบันทึกการจัดส่งสำหรับใบสั่งขายใบเดียว) หรือ โดยเรียงตามบัญชีใบแจ้งหนี้ (ถ้ามีใบสั่งขายหลายใบสำหรับบัญชีใบแจ้งหนี้เดียว) ได้ ใช้การ**จัดเรียง**ปุ่มเพื่อรวมบัญชีใบสั่งขายในใบแจ้งหนี้เดียว ตาม**ใบสั่งโดยสรุป**ตั้งค่า
